...
| 名称 | 说明 |
| --- | --- |
| `YhContainerProps` | `YhContainer` props 类型 |
| `YhHeaderProps` | `YhHeader` props 类型 |
| `YhAsideProps` | `YhAside` props 类型 |
| `YhMainProps` | `YhMain` props 类型 |
| `YhFooterProps` | `YhFooter` props 类型 |
| `YhContainerSlots` | `YhContainer` slots 类型 |
| `YhHeaderSlots` | `YhHeader` slots 类型 |
| `YhAsideSlots` | `YhAside` slots 类型 |
| `YhMainSlots` | `YhMain` slots 类型 |
| `YhFooterSlots` | `YhFooter` slots 类型 |
| `YhContainerInstance` | `YhContainer` 实例类型 |
| `YhHeaderInstance` | `YhHeader` 实例类型 |
| `YhAsideInstance` | `YhAside` 实例类型 |
| `YhMainInstance` | `YhMain` 实例类型 |
| `YhFooterInstance` | `YhFooter` 实例类型 |
