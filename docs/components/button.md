...
const tsCircle = `<template>
  <div style="display: flex; gap: 12px; flex-wrap: wrap;">
    <yh-button circle aria-label="默认图标按钮">
      <template #icon>
        <svg viewBox="0 0 1024 1024" width="1em" height="1em"><path fill="currentColor" d="M512 64l512 512-512 512L0 576z"/></svg>
      </template>
    </yh-button>
    <yh-button type="primary" circle aria-label="主要图标按钮">
      <template #icon>
        <svg viewBox="0 0 1024 1024" width="1em" height="1em"><path fill="currentColor" d="M512 64l512 512-512 512L0 576z"/></svg>
      </template>
    </yh-button>
    <yh-button type="success" circle aria-label="成功图标按钮">
      <template #icon>
        <svg viewBox="0 0 1024 1024" width="1em" height="1em"><path fill="currentColor" d="M512 64l512 512-512 512L0 576z"/></svg>
      </template>
    </yh-button>
    <yh-button type="warning" circle aria-label="警告图标按钮">
      <template #icon>
        <svg viewBox="0 0 1024 1024" width="1em" height="1em"><path fill="currentColor" d="M512 64l512 512-512 512L0 576z"/></svg>
      </template>
    </yh-button>
    <yh-button type="danger" circle aria-label="危险图标按钮">
      <template #icon>
        <svg viewBox="0 0 1024 1024" width="1em" height="1em"><path fill="currentColor" d="M512 64l512 512-512 512L0 576z"/></svg>
      </template>
    </yh-button>
    <yh-button type="info" circle aria-label="信息图标按钮">
      <template #icon>
        <svg viewBox="0 0 1024 1024" width="1em" height="1em"><path fill="currentColor" d="M512 64l512 512-512 512L0 576z"/></svg>
      </template>
    </yh-button>
...
| 名称                   | 说明                   |
| ---------------------- | ---------------------- |
| `YhButtonProps`        | `YhButton` props 类型  |
| `YhButtonEmits`        | `YhButton` emits 类型  |
| `YhButtonSlots`        | `YhButton` slots 类型  |
| `YhButtonExpose`       | `YhButton` expose 类型 |
| `YhButtonType`         | 按钮类型联合类型       |
| `YhButtonSize`         | 按钮尺寸联合类型       |
| `YhButtonNativeType`   | 原生按钮类型联合类型   |
| `YhButtonIconPosition` | 图标位置联合类型       |
| `YhButtonInstance`     | `YhButton` 实例类型    |
