...
Rich icon effects showcase, covering common scenarios and multiple icon sets.

## System Action Icons

Common system action icons, suitable for toolbars, menus, and other scenarios.

<DemoBlock title="System Action Icons" :ts-code="tsSystem" :js-code="jsSystem">
  <div class="icon-grid">
...
Direction indicator icons, suitable for navigation, sorting, expand/collapse and other scenarios.

<DemoBlock title="Arrows & Directions" :ts-code="tsArrow" :js-code="jsArrow">
  <div class="icon-grid">
...
Icons used for status feedback, such as success, warning, error, info, etc.

<DemoBlock title="Status & Notifications" :ts-code="tsStatus" :js-code="jsStatus">
  <div class="icon-grid">
...
Icons related to file management and multimedia.

<DemoBlock title="Files & Media" :ts-code="tsFile" :js-code="jsFile">
  <div class="icon-grid">
...
<DemoBlock title="Social & Communication" :ts-code="tsSocial" :js-code="jsSocial">
  <div class="icon-grid">
...
Weather and nature element icons, suitable for weather apps or decorative purposes.

<DemoBlock title="Weather & Nature" :ts-code="tsWeather" :js-code="jsWeather">
  <div class="icon-grid">
...
Commonly used icons for rich text editors.

<DemoBlock title="Editor Icons" :ts-code="tsEditor" :js-code="jsEditor">
  <div class="icon-grid">
...
## Multiple Icon Sets Comparison

Visual comparison of the same semantics across different icon sets.

<DemoBlock title="Multiple Icon Sets Comparison" :ts-code="tsCompare" :js-code="jsCompare">
...
Icon rotation, loading and other animation effects.

<DemoBlock title="Animation Effects" :ts-code="tsAnimation" :js-code="jsAnimation">
  <div class="icon-grid">
...
Showcase of various icon sizes and color combinations.

<DemoBlock title="Size & Color" :ts-code="tsSizeColor" :js-code="jsSizeColor">
