...
```ts
// Defaults to only exporting zhCn and en to support tree-shaking
import { zhCn, en } from '@yh-ui/locale'

// To import other language packs, import from @yh-ui/locale/all:
import { ja, ko, fr, de } from '@yh-ui/locale/all'

// Or import on-demand (recommended for optimal tree-shaking):
// import ja from '@yh-ui/locale/lang/ja'
```
