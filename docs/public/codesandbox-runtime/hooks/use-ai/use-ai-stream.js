...
const claudeParser = (raw) => {
  ...
  for (const line of lines) {
    ...
    try {
      const json = JSON.parse(data);
      if ((json == null ? void 0 : json.type) === "content_block_delta" && ((_a = json == null ? void 0 : json.delta) == null ? void 0 : _a.text)) {
...
const geminiParser = (raw) => {
  ...
  for (const line of lines) {
    ...
    try {
      ...
      const part = (_e = (_d = (_c = (_b = (_a = json == null ? void 0 : json.candidates) == null ? void 0 : _a[0]) == null ? void 0 : _b.content) == null ? void 0 : _c.parts) == null ? void 0 : _d[0]) == null ? void 0 : _e.text;
      if (part) text += part;
    } catch (e) {
    }
  }
  ...
  const fetchStream = async (query, ...args) => {
    ...
    try {
      ...
      if (typeof response === "object" && response !== null && Symbol.asyncIterator in response) {
        try {
          for (var iter = __forAwait(response), more, temp, error; more = !(temp = await iter.next()).done; more = false) {
