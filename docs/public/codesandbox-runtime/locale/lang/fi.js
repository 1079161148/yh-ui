const fi = {
  ...
  yh: {
    ...
    smartaddress: {
      placeholder:
        'Liit\xE4 osoite t\xE4h\xE4n tunnistaaksesi nimen, puhelimen ja sijainnin automaattisesti',
    ...
    ai: {
      ...
      welcome: {
        ...
        description:
          'Voin auttaa sinua koodaamisessa, dokumenttien k\xE4\xE4nt\xE4misess\xE4 tai luovassa kirjoittamisessa. Mit\xE4 voin tehd\xE4 sinulle t\xE4n\xE4\xE4n?'
      },
      action: {
        copy: 'Kopioi',
...
var stdin_default = fi
export { stdin_default as default, fi }
