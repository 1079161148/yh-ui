const he = {
  ...
  yh: {
    ...
    colorpicker: {
      ...
      eyeDropper: '\u9A7B\u8BAC\u9A7B\u8B9F\u8B9B',
      suggestionDark:
        '\u8B9F\u62FD\u4F4F\u8B9F \u8BC7\u8B98\u8C09 \u8B9B\u8B9C\u8B97 \u8B9B\u8B9F\u8B9C\u8B98 \u8B98\u8BAC\u8B9C\u8F6C\u4E13',
      suggestionLight:
        '\u8B9F\u62FD\u4F4F\u8B9F \u7816\u8B9E\u8B9C\u4E13 \u8B9B\u8B9C\u8B97 \u8B9B\u8B9F\u8B9C\u8B98 \u8B98\u8BAC\u8B9C\u8F6C\u4E13',
    ...
    table: {
      ...
      import: {
        ...
        selectFile: '\u8B98\u8B9E\u4E13 \u62FD\u8B9C\u8B98\u6293',
        dragTip:
          '\u8BC7\u8B9E\u6293 \u8B97\u8B9C \u8B99\u4E13\u8B9C\u4E13 \u62FD\u8B9C\u8B98\u6293 \u8BC7\u8BBB\u8B97\u8C09 \u8BC7\u8B9B\u6CE8\u8BC7\u8B97\u8B9B',
        importing: '\u8BEA\u8BAC\u8BAC\u8B98\u8B97...',
        success: '\u8BAC\u8BAC\u8B98\u8B9C\u8B97 \u8B9B\u722A\u8BC7\u8BAC\u8B9E',
        error: '\u8BAC\u8BAC\u8B98\u8B9C\u8B97 \u8C1E\u8BBB\u7816\u8BC7',
        preview:
          '\u8F6C\u722A\u8B9C\u8B99\u8B9B \u8BEA\u62FD\u8B9A\u8BAC\u8BEA\u8B9B \u7816\u8BC7 \u8C1E\u8F6C\u8B9C\u8C1E\u8BAC\u8BD0',
        confirm: '\u8B97\u7816\u4E13 \u8BAC\u8BAC\u8B98\u8B9C\u8B97'
      },
      // 讛讚驻住讛
      printConfig: {
    ...
    upload: {
      ...
      fileTypeError:
        '\u4F4F\u8B9C\u8B99 \u62FD\u8B9C\u8B98\u6293 \u8BC7\u8B97 \u8C1E\u8F6C\u8BEA\u8BB1',
      fileSizeError:
        '\u8B99\u8B9C\u8B9A\u8BC7 \u62FD\u8B9C\u8B98\u6293 \u8B9E\u8B9C\u4E13\u8B99 \u8BEA\u8B9B\u8B99\u8B98\u8B9C\u8BC7',
      fileCountError:
        '\u8BEA\u4F4F\u9A7B\u4E13 \u62FD\u8B98\u722A\u8BAC\u8BD0 \u8B9E\u8B9C\u4E13\u8B99 \u8BEA\u8B9B\u8B99\u8B98\u8B9C\u8BC7'
    },
    // 讟讜驻住
    form: {
    ...
    smartaddress: {
      placeholder:
        '\u8B9B\u8B9A\u8B98\u62FD \u8BBB\u8B97\u8C09 \u8BBB\u8F6C\u8B9C\u8B98\u8F6C, \u8B9D\u8BAC\u8B9B\u8B9C\u8BAC \u8B97\u8B9C\u8B9F\u8B9C\u8BEA\u8B9F\u8BAC \u7816\u8BC7 \u7816\u8BD0, \u8B9F\u8BC7\u9A7B\u8B9C\u8C09 \u8B9C\u8BEA\u8BAC\u62FD\u8B9C\u8BD0',
      parse: '\u9A7B\u6CE8\u8C1E\u8B9C\u8B9E \u8B9E\u8BBB\u8BD0',
    ...
    ai: {
      ...
      welcome: {
        ...
        description:
          '\u8B97\u8C1E\u8BAC \u8BAC\u8BBB\u8B9C\u8BC7 \u8BC7\u6CE8\u8B9D\u8B9C\u4E13 \u8BC7\u8BB1 \u8B98\u8F6C\u8BBB\u8C1E\u8B9C\u8F6C, \u8F6C\u4E13\u8B99\u8B9C\u8BD0 \u8BEA\u4F4F\u8BEA\u8BBB\u8BAC\u8BD0 \u8B97\u8B9C \u8BBB\u8F6C\u8BAC\u8B98\u8B9B \u8BAC\u722A\u8BAC\u4E13\u8F6C\u8BAC\u8F6C. \u8BEA\u8B9B \u8B97\u8C1E\u8BAC \u8BAC\u8BBB\u8B9C\u8BC7 \u8BC7\u6CE8\u7816\u8B9C\u8F6C \u8B98\u7816\u8B98\u8BAC\u8BC7\u8BB1 \u8B9B\u8BAC\u8B9C\u8BD0?'
      },
      action: {
        copy: '\u8B9B\u6CE8\u8F6C\u62FD',
        regenerate: '\u722A\u8B9C\u4E13 \u8BEA\u8B9E\u8B9A\u7816',
      ...
      conversations: {
        ...
        delete: '\u8BEA\u8B9E\u62FD',
        deleteConfirm:
          '\u8BC7\u8B97\u7816\u4E13 \u8BEA\u8B9E\u8BAC\u62FD\u8B9B \u7816\u8BC7 \u8B9B\u7816\u8BAC\u8B9E\u8B9B \u8B9B\u8B9D\u8B9C?'
      },
      attachments: {
        dropTip:
          '\u7816\u8B9E\u4E13\u4E13 \u8BBB\u8B97\u8C09 \u62FD\u8B98\u722A\u8BAC\u8BD0 \u8BBB\u8B9A\u8BAC \u8BC7\u8B9B\u6CE8\u8BC7\u8B9C\u8F6C',
        clickToUpload:
          '\u8BC7\u8B9E\u6293 \u8B97\u8B9C \u8B99\u4E13\u8B9C\u4E13 \u62FD\u8B98\u722A\u8BAC\u8BD0 \u8BBB\u8B9A\u8BAC \u8BC7\u8B9B\u6CE8\u8BC7\u8B9C\u8F6C',
        uploadSuccess: '\u8B9B\u8B9B\u6CE8\u8BC7\u8B97\u8B9B \u8B9B\u722A\u8BC7\u8BAC\u8B9E\u8B9B',
        uploadError: '\u8B9B\u8B9B\u6CE8\u8BC7\u8B97\u8B9B \u8C1E\u8BBB\u7816\u8BC7\u8B9B',
        deleteConfirm:
          '\u8B9B\u8B97\u8BD0 \u8B97\u8F6C\u8B9B \u8B98\u8B9F\u8B9C\u8B9E \u7816\u8B98\u4E13\u722A\u8B9C\u8C1E\u8BB1 \u8BC7\u8BEA\u8B9E\u8B9C\u62FD \u8B97\u8F6C \u8B9B\u62FD\u8B9C\u8B98\u6293 \u8B9B\u8B9D\u8B9B?',
        fileTooLarge:
          '\u8B99\u8B9C\u8B9A\u8BC7 \u8B9B\u62FD\u8B9C\u8B98\u6293 \u8BC7\u8B97 \u8BAC\u8BBB\u8B9C\u8BC7 \u8BC7\u6CE8\u8BC7\u8B9C\u8F6C \u6CE8\u8BC7 {size}',
        invalidFileType:
          '\u4F4F\u8B9C\u8B99 \u62FD\u8B9C\u8B98\u6293 \u8BC7\u8B97 \u8B9E\u8B9C\u62FD\u8BAC'
      },
      mermaid: {
...
var stdin_default = he
export { stdin_default as default, he }
