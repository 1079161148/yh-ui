  ...
  yh: {
    ...
    table: {
      ...
      import: {
        ...
        selectFile: 'Ch\u1ECDn t\u1EC7p',
        dragTip:
          'Nh\u1EA5p ho\u1EB7c k\xE9o t\u1EC7p v\xE0o \u0111\xE2y \u0111\u1EC3 t\u1EA3i l\xEAn',
        importing: '\u0110ang nh\u1EADp...',
    ...
    upload: {
      ...
      dragTip:
        'Th\u1EA3 t\u1EC7p v\xE0o \u0111\xE2y ho\u1EB7c nh\u1EA5p \u0111\u1EC3 t\u1EA3i l\xEAn',
    ...
    smartaddress: {
      placeholder:
        'D\xE1n \u0111\u1ECBa ch\u1EC9 v\xE0o \u0111\xE2y \u0111\u1EC3 t\u1EF1 \u0111\u1ED9ng nh\u1EADn di\u1EC7n t\xEAn, s\u1ED1 \u0111i\u1EC7n tho\u1EA1i v\xE0 v\u1ECB tr\xED',
    ...
    ai: {
      ...
      welcome: {
        ...
        description:
          'T\xF4i c\xF3 th\u1EC3 gi\xFAp b\u1EA1n v\u1EDBi l\u1EADp tr\xECnh, d\u1ECBch t\xE0i li\u1EC7u ho\u1EB7c vi\u1EBFt s\xE1ng t\u1EA1o. T\xF4i c\xF3 th\u1EC3 gi\xFAp g\xEC cho b\u1EA1n h\xF4m nay?'
      },
      action: {
        copy: 'Sao ch\xE9p',
        regenerate: 'T\u1EA1o l\u1EA1i',
      ...
      attachments: {
        ...
        fileTooLarge:
          'K\xEDch th\u01B0\u1EDBc t\u1EC7p kh\xF4ng \u0111\u01B0\u1EE3c v\u01B0\u1EE3t qu\xE1 {size}',
...
var stdin_default = vi
export { stdin_default as default, vi }
