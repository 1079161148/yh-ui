...
const _hoisted_1 = ["id", "value", "placeholder", "disabled", "readonly", "name", "aria-expanded", "aria-controls"];
const _hoisted_2 = ["id"];
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const selectSize = computed(() => props.size || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalSize.value || "default");
    ...
    const filteredOptions = computed(() => {
      ...
      if (props.minTime) {
        ...
        options = options.map((opt) => __spreadProps(__spreadValues({}, opt), {
    ...
    const scrollToSelected = () => {
      ...
      nextTick(() => {
        var _a;
        const selectedEl = (_a = optionsRef.value) == null ? void 0 : _a.querySelector(`.${ns.is("selected", true).slice(1)}`);
      ...
      switch (event.key) {
        case "ArrowDown":
          ...
          if (!visible.value) {
            ...
            while (nextIndex < filteredOptions.value.length && ((_a = filteredOptions.value[nextIndex]) == null ? void 0 : _a.disabled)) {
              nextIndex++;
            }
