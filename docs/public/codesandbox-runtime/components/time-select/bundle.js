// docs/public/codesandbox-runtime/components/time-select/src/time-select.js
import {
...
// docs/public/codesandbox-runtime/components/time-select/src/time-select-meta.js
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const filteredOptions = computed11(() => {
        ...
        if (props.minTime) {
          ...
          options = options.map((opt) =>
            __spreadProps(__spreadValues2({}, opt), {
      ...
      const scrollToSelected = () => {
        ...
        nextTick(() => {
          var _a2
          const selectedEl =
            (_a2 = optionsRef.value) == null
              ? void 0
              : _a2.querySelector(`.${ns.is('selected', true).slice(1)}`)
          ...
          case 'ArrowDown':
            ...
            if (!visible.value) {
              ...
              while (
                ...
                ((_a2 = filteredOptions.value[nextIndex]) == null ? void 0 : _a2.disabled)
              ) {
                nextIndex++
              }
