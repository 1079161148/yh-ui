...
import { renderSlot as _renderSlot, toDisplayString as _toDisplayString, normalizeClass as _normalizeClass, createElementVNode as _createElementVNode, createCommentVNode as _createCommentVNode, normalizeStyle as _normalizeStyle, openBlock as _openBlock, createElementBlock as _createElementBlock, createBlock as _createBlock } from "vue";
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      $setup.isLoading ? _renderSlot(_ctx.$slots, "placeholder", { key: 0 }, () => [
        ...
        src: _ctx.src,
        alt: _ctx.alt,
        class: _normalizeClass([$setup.ns.e("inner"), $setup.preview && $setup.ns.is("preview")]),
      ...
      $setup.preview && $setup.showViewer ? (_openBlock(), _createBlock($setup["YhImageViewer"], {
        key: 3,
      ...
      }, null, 8, ["url-list", "z-index", "initial-index", "infinite", "hide-on-click-modal", "close-on-press-escape", "show-progress", "zoom-rate", "teleported"])) : _createCommentVNode("v-if", true)
    ],
    6
    /* CLASS, STYLE */
  );
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isLoading, error, showViewer, container, isLazy, get viewer() {
      ...
      observer = v;
    }, handleLazyLoad, initLazyLoad, getRoot, stopLazyLoad, initViewerJS, clickHandler, closeViewer, handleSwitch, computed, ref, onMounted, onUnmounted, watch, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
