...
import { renderSlot as _renderSlot, toDisplayString as _toDisplayString, normalizeClass as _normalizeClass2, createElementVNode as _createElementVNode2, createCommentVNode as _createCommentVNode2, normalizeStyle as _normalizeStyle2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, createBlock as _createBlock2 } from "vue";
import { computed as computed12, ref as ref13, onMounted as onMounted4, onUnmounted as onUnmounted5, watch as watch5 } from "vue";
...
var getStyle = (element, styleName) => {
  ...
  try {
    ...
    const computed13 = (_a3 = document.defaultView) == null ? void 0 : _a3.getComputedStyle(element, "");
...
import { computed as computed11, ref as ref12, onMounted as onMounted3, onUnmounted as onUnmounted4, watch as watch4 } from "vue";
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      viewerList = list;
      const nextViewer = new stdin_default3(list, __spreadProps(__spreadValues2({}, props.viewerOptions), {
    ...
    const __returned__ = { props, emit, ns, t, index, scale, rotate, get viewer() {
      ...
      viewerList = v;
    }, transform, handleClose, initViewerJS, handlePrev, handleNext, handleZoomIn, handleZoomOut, handleRotateLeft, handleRotateRight, reset, handleKeyDown, computed: computed11, ref: ref12, onMounted: onMounted3, onUnmounted: onUnmounted4, watch: watch4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    ...
    [
      $setup.isLoading ? _renderSlot(_ctx.$slots, "placeholder", { key: 0 }, () => [
      ...
      ]) : $setup.error ? _renderSlot(_ctx.$slots, "error", { key: 1 }, () => [
        _createElementVNode2(
          "div",
          {
      ...
      ]) : (_openBlock2(), _createElementBlock2("img", {
        key: 2,
        src: _ctx.src,
        alt: _ctx.alt,
        class: _normalizeClass2([$setup.ns.e("inner"), $setup.preview && $setup.ns.is("preview")]),
      ...
      $setup.preview && $setup.showViewer ? (_openBlock2(), _createBlock2($setup["YhImageViewer"], {
        key: 3,
      ...
      }, null, 8, ["url-list", "z-index", "initial-index", "infinite", "hide-on-click-modal", "close-on-press-escape", "show-progress", "zoom-rate", "teleported"])) : _createCommentVNode2("v-if", true)
    ],
    6
    /* CLASS, STYLE */
  );
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      if (props.previewSrcList && props.previewSrcList.length > 0) {
        ...
        document.body.appendChild(list);
        viewerList = list;
        const nextViewer = new stdin_default3(list, __spreadProps2(__spreadValues3({}, props.viewerOptions), {
          hidden: () => {
            if (viewerList) {
              document.body.removeChild(viewerList);
              viewerList = null;
        ...
        const nextViewer = new stdin_default3(imgElement, props.viewerOptions);
        viewer = nextViewer;
        nextViewer.show();
      }
    };
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isLoading, error, showViewer, container, isLazy, get viewer() {
      ...
      observer = v;
    }, handleLazyLoad, initLazyLoad, getRoot, stopLazyLoad, initViewerJS, clickHandler, closeViewer, handleSwitch, computed: computed12, ref: ref13, onMounted: onMounted4, onUnmounted: onUnmounted5, watch: watch5, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
      ...
      return imageProps;
    }, YhImageViewer: stdin_default4, get Viewer() {
      return stdin_default3;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
