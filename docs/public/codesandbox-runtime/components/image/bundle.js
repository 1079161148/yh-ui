...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      viewerList = list;
      const nextViewer = new stdin_default2(list, __spreadProps(__spreadValues2({}, props.viewerOptions), {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      if (props.previewSrcList && props.previewSrcList.length > 0) {
        ...
        document.body.appendChild(list);
        viewerList = list;
        const nextViewer = new stdin_default2(list, __spreadProps2(__spreadValues3({}, props.viewerOptions), {
          hidden: () => {
            if (viewerList) {
              document.body.removeChild(viewerList);
              viewerList = null;
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isLoading, error, showViewer, container, isLazy, get viewer() {
      ...
      return imageProps;
    }, YhImageViewer: stdin_default3, get Viewer() {
      return stdin_default2;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
