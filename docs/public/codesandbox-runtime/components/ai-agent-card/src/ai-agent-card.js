                        ...
                        _createElementVNode(
                          ...
                          [
                            _renderSlot(_ctx.$slots, 'avatar', {}, () => {
                              var _a
                              return [
                                ((_a = _ctx.data.avatar) == null ? void 0 : _a.startsWith('http'))
                                  ? (_openBlock(),
                                    _createElementBlock(
                                      'img',
                                      {
                                  ...
                                  ? (_openBlock(),
                                    _createElementBlock(
                                      ...
                                      [
                                        ...
                                        _createTextVNode(
                                          ' ' +
                                            _toDisplayString($setup.formattedUses) +
                                            ' ' +
                                            _toDisplayString($setup.t('ai.agent.uses')),
                                          1
                                          /* TEXT */
                                        )
                                      ],
                                  ...
                                  ? (_openBlock(),
                                    _createElementBlock(
                                      ...
                                      [
                                        ...
                                        _createTextVNode(
                                          ' ' +
                                            _toDisplayString(_ctx.data.stats.responseTime) +
                                            'ms ',
                                          1
                                          /* TEXT */
                                        )
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const localFavorited = ref(
        (_b = (_a = props.data) == null ? void 0 : _a.favorited) != null ? _b : false
      )
      ...
      const ratingStars = computed(() => {
        ...
        const r =
          (_c =
            (_b2 = (_a2 = props.data) == null ? void 0 : _a2.stats) == null
              ? void 0
              : _b2.rating) != null
            ? _c
            : 0
      ...
      const formattedUses = computed(() => {
        ...
        const u =
          (_c =
            (_b2 = (_a2 = props.data) == null ? void 0 : _a2.stats) == null ? void 0 : _b2.uses) !=
          null
            ? _c
            : 0
