                ...
                _createElementVNode2(
                  'div',
                  {
                    class: _normalizeClass2([
                      $setup.ns.b(),
                      $setup.ns.m(_ctx.layout),
                      $setup.ns.is('selected', _ctx.selected)
                    ]),
                    style: _normalizeStyle2($setup.themeStyle),
                  ...
                  [
                        ...
                        _ctx.favoritable
                          ? (_openBlock3(),
                            _createBlock3(
                              ...
                              {
                                key: 0,
                                content: $setup.localFavorited
                                  ? $setup.t('ai.agent.unfavorite')
                                  : $setup.t('ai.agent.favorite'),
                                placement: 'top'
                              },
                              {
                                default: _withCtx2(() => [
                                  _createElementVNode2(
                                    'button',
                                    {
                                      class: _normalizeClass2([
                                        $setup.ns.e('fav-btn'),
                                        $setup.ns.is('active', $setup.localFavorited)
                                      ]),
                        ...
                        _createElementVNode2(
                          ...
                          [
                            _renderSlot3(_ctx.$slots, 'avatar', {}, () => {
                              var _a2
                              return [
                                ((_a2 = _ctx.data.avatar) == null ? void 0 : _a2.startsWith('http'))
                                  ? (_openBlock3(),
                                    _createElementBlock3(
                                      'img',
                                      {
                    ...
                    _createElementVNode2(
                      ...
                      [
                        ...
                        _ctx.data.capabilities && _ctx.data.capabilities.length > 0
                          ? (_openBlock3(),
                            _createElementBlock3(
                              'div',
                              {
                              ...
                              [
                                    ...
                                    return (
                                      ...
                                      _createElementBlock3(
                                        'span',
                                        {
                                          key: idx,
                                          class: _normalizeClass2([
                                            $setup.ns.e('capability-tag'),
                                            cap.type ? $setup.ns.m(cap.type) : ''
                                          ])
                                        },
                                        [
                                          cap.icon
                                ...
                                _ctx.data.capabilities.length > 4
                                  ? (_openBlock3(),
                                    _createElementBlock3(
                                      'span',
                                      {
                        ...
                        _ctx.showStats && _ctx.data.stats
                          ? (_openBlock3(),
                            _createElementBlock3(
                              'div',
                              {
                              ...
                              [
                                  ...
                                  ? (_openBlock3(),
                                    _createElementBlock3(
                                      ...
                                      [
                                        ...
                                        _createTextVNode(
                                          ' ' +
                                            _toDisplayString2($setup.formattedUses) +
                                            ' ' +
                                            _toDisplayString2($setup.t('ai.agent.uses')),
                                          1
                                          /* TEXT */
                                        )
                                      ],
                                ...
                                _ctx.data.stats.rating !== void 0
                                  ...
                                  : _createCommentVNode3('v-if', true),
                                _ctx.data.stats.responseTime !== void 0
                                  ? (_openBlock3(),
                                    _createElementBlock3(
                                      'span',
                                      {
                                      ...
                                      [
                                        ...
                                        _createTextVNode(
                                          ' ' +
                                            _toDisplayString2(_ctx.data.stats.responseTime) +
                                            'ms ',
                                          1
                                          /* TEXT */
                                        )
...
var __sfc__3 = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const localFavorited = ref13(
        (_b = (_a2 = props.data) == null ? void 0 : _a2.favorited) != null ? _b : false
      )
      ...
      const ratingStars = computed13(() => {
        ...
        const r =
          (_c =
            (_b2 = (_a22 = props.data) == null ? void 0 : _a22.stats) == null
              ? void 0
              : _b2.rating) != null
            ? _c
            : 0
