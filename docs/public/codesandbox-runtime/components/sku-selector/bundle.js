...
// public/codesandbox-runtime/components/sku-selector/src/sku-selector.js
...
// public/codesandbox-runtime/components/sku-selector/src/sku-selector-meta.js
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSkuSelector" }, {
  __name: "sku-selector",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const summaryPrefixText = computed11(() => props.summaryPrefix || t("skuselector.selected"));
    const summaryPlaceholder = computed11(() => t("skuselector.placeholder"));
    const selectedSummary = computed11(() => {
      ...
      const names = props.specs.map((spec) => {
        ...
        return (_b = (_a2 = spec.values.find((v) => v.id === selectedId)) == null ? void 0 : _a2.name) != null ? _b : "";
      }).filter(Boolean);
      return names.length ? `${summaryPrefixText.value}: ${names.join(" / ")}` : "";
    });
    const imgSizePx = computed11(() => `${props.imageSize}px`);
    const __returned__ = { props, emit, ns, t, themeStyle, selectedValueIds, isValueSelectable, selectedSku, toggleValue, handleValueClick, isValueActive, summaryPrefixText, summaryPlaceholder, selectedSummary, imgSizePx, computed: computed11, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useSKU() {
