...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSkuSelector" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, selectedValueIds, isValueSelectable, selectedSku, toggleValue, handleValueClick, isValueActive, selectedSummary, imgSizePx, computed: computed11, get useNamespace() {
      return useNamespace;
