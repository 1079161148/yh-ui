...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSkuSelector" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, selectedValueIds, isValueSelectable, selectedSku, toggleValue, handleValueClick, isValueActive, summaryPrefixText, summaryPlaceholder, selectedSummary, imgSizePx, computed, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useSKU() {
