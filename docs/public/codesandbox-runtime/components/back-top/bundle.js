// docs/public/codesandbox-runtime/components/back-top/src/back-top.js
import {
...
// docs/public/codesandbox-runtime/components/back-top/src/back-top-meta.js
var backTopProps = {
  /** 滚动距离达到此值时才显示，单位 px */
  visibilityHeight: {
    type: Number,
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const easeInOutCubic = (t2) =>
        t2 < 0.5 ? 4 * t2 * t2 * t2 : (t2 - 1) * (2 * t2 - 2) * (2 * t2 - 2) + 1
