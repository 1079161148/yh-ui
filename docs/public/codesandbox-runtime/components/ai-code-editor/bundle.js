...
// public/codesandbox-runtime/components/ai-code-editor/src/ai-code-editor.js
import { ref as ref2, onMounted, onBeforeUnmount, watch, computed as computed2, nextTick } from "vue";
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhAiCodeEditor" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, get monaco() {
      ...
      return useNamespace;
    }, ref: ref2, onMounted, onBeforeUnmount, watch, computed: computed2, nextTick, get aiCodeEditorProps() {
