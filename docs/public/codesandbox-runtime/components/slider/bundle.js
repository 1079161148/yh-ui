// public/codesandbox-runtime/components/slider/src/slider.js
import { createVNode as _createVNode2, normalizeClass as _normalizeClass3, openBlock as _openBlock3, createElementBlock as _createElementBlock3, createCommentVNode as _createCommentVNode3, normalizeStyle as _normalizeStyle3, createElementVNode as _createElementVNode3, normalizeProps as _normalizeProps, guardReactiveProps as _guardReactiveProps, renderSlot as _renderSlot3, withCtx as _withCtx2, createSlots as _createSlots, createBlock as _createBlock2, renderList as _renderList, Fragment as _Fragment, toDisplayString as _toDisplayString3 } from "vue";
import { ref as ref14, computed as computed13, watch as watch4, onMounted as onMounted3, provide as provide2, toRefs } from "vue";
...
// public/codesandbox-runtime/components/slider/src/slider-meta.js
var sliderProps = {
  /** 绑定值 */
  modelValue: {
    type: [Number, Array],
...
// public/codesandbox-runtime/components/slider/src/slider-button.js
...
import { ref as ref12, computed as computed11, onBeforeUnmount as onBeforeUnmount2, inject as inject7 } from "vue";
...
var __sfc__ = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getSliderSize = () => {
      var _a2;
      if (!((_a2 = slider == null ? void 0 : slider.sliderRef) == null ? void 0 : _a2.value)) return 0;
    ...
    const __returned__ = { props, emit, ns, slider, dragging, hovering, isClick, startX, startY, startPosition, newPosition, tooltipVisible, currentPosition, wrapperStyle, displayValue, handleMouseEnter, handleMouseLeave, onButtonDown, onDragStart, onDragging, onDragEnd, getSliderSize, setPosition, getPrecision, ref: ref12, computed: computed11, onBeforeUnmount: onBeforeUnmount2, inject: inject7, get useNamespace() {
      return useNamespace;
    } };
...
// public/codesandbox-runtime/components/input-number/src/input-number.js
import { renderSlot as _renderSlot2, createElementVNode as _createElementVNode2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, normalizeClass as _normalizeClass2, createCommentVNode as _createCommentVNode2, toDisplayString as _toDisplayString2, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock, withModifiers as _withModifiers, normalizeStyle as _normalizeStyle2 } from "vue";
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    ...
    [
      $props.controls && $props.controlsPosition !== "right" ? (_openBlock2(), _createElementBlock2(
        "span",
        {
          key: 0,
          class: _normalizeClass2([$setup.ns.e("decrease"), $setup.ns.is("disabled", $setup.minDisabled || $setup.mergedDisabled)]),
          ...
          $setup.hasPrefix ? (_openBlock2(), _createElementBlock2(
            ...
            [
              _renderSlot2(_ctx.$slots, "prefix", {}, () => [
                ...
                $props.prefixIcon && typeof $props.prefixIcon !== "string" ? (_openBlock2(), _createBlock(_resolveDynamicComponent($props.prefixIcon), { key: 1 })) : _createCommentVNode2("v-if", true)
              ])
            ],
            2
            /* CLASS */
          ...
          $setup.hasSuffix ? (_openBlock2(), _createElementBlock2(
            ...
            [
              ...
              _renderSlot2(_ctx.$slots, "suffix", {}, () => [
                ...
                $props.suffixIcon && typeof $props.suffixIcon !== "string" ? (_openBlock2(), _createBlock(_resolveDynamicComponent($props.suffixIcon), { key: 1 })) : _createCommentVNode2("v-if", true)
              ])
            ],
            2
            /* CLASS */
      ...
      $props.controls && $props.controlsPosition !== "right" ? (_openBlock2(), _createElementBlock2(
        ...
        {
          key: 1,
          class: _normalizeClass2([$setup.ns.e("increase"), $setup.ns.is("disabled", $setup.maxDisabled || $setup.mergedDisabled)]),
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const mergedDisabled = computed12(() => props.disabled || (form == null ? void 0 : form.disabled) || false);
    ...
    const minDisabled = computed12(() => props.modelValue !== void 0 && props.modelValue <= props.min);
    const maxDisabled = computed12(() => props.modelValue !== void 0 && props.modelValue >= props.max);
    ...
    const __returned__ = { props, emit, slots, ns, t, themeStyle, inputRef, inputId, focused, hovering, userInput, validationError, form, formItem, triggerValidate, globalSize, mergedDisabled, mergedSize, numPrecision, getPrecision, toPrecision, displayValue, minDisabled, maxDisabled, showClear, hasPrefix, hasSuffix, inputNumberClasses, validate, setCurrentValue, increase, decrease, handleClear, handleInput, handleChange, handleFocus, handleBlur, handleKeydown, computed: computed12, ref: ref13, useSlots, nextTick, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useId() {
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createElementBlock3(
    ...
    [
      _ctx.showInput && !_ctx.range ? (_openBlock3(), _createElementBlock3(
        "div",
        {
          key: 0,
        ...
        [
          _createVNode2($setup["YhInputNumber"], {
      ...
      _createElementVNode3(
        ...
        [
          ...
          _createVNode2($setup["SliderButton"], {
            ...
            _ctx.$slots.thumb ? {
              name: "thumb",
              fn: _withCtx2((scope) => [
                _renderSlot3(_ctx.$slots, "thumb", _normalizeProps(_guardReactiveProps(scope)))
              ]),
              key: "0"
            } : void 0
          ]), 1032, ["modelValue", "vertical", "disabled", "min", "max", "step", "show-tooltip", "format-tooltip", "tooltip-class", "placement"]),
          _ctx.range ? (_openBlock3(), _createBlock2($setup["SliderButton"], {
            key: 0,
          ...
          ]), 1032, ["modelValue", "vertical", "disabled", "min", "max", "step", "show-tooltip", "format-tooltip", "tooltip-class", "placement"])) : _createCommentVNode3("v-if", true),
          _ctx.showStops ? (_openBlock3(true), _createElementBlock3(
            _Fragment,
            { key: 1 },
            _renderList($setup.stops, (stop, index) => {
              return _openBlock3(), _createElementBlock3(
                "div",
                {
                  ...
                  style: _normalizeStyle3($setup.vertical ? {
                    bottom: stop + "%"
                  } : {
                    left: stop + "%"
                  })
          ...
          $setup.markList.length > 0 ? (_openBlock3(), _createElementBlock3(
            _Fragment,
            { key: 2 },
            [
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const mergedDisabled = computed13(() => props.disabled || (form == null ? void 0 : form.disabled) || false);
    ...
    const __returned__ = { props, vertical, emit, ns, form, formItem, triggerValidate, themeStyle, globalSize, sliderRef, firstValue, secondValue, mergedDisabled, mergedSize, initValues, minValue, maxValue, barSize, barStart, barStyle, stops, markList, sliderClasses, sliderStyle, emitValue, updateValue, handleButtonChange, handleButtonInput, onSliderClick, getPrecision, handleInputChange, ref: ref14, computed: computed13, watch: watch4, onMounted: onMounted3, provide: provide2, toRefs, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useComponentTheme() {
      ...
      return sliderEmits;
    }, SliderButton: stdin_default2, YhInputNumber: stdin_default3 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
