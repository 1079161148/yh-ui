...
// public/codesandbox-runtime/components/time-picker/src/time-picker.js
import { createCommentVNode as _createCommentVNode2, renderSlot as _renderSlot, createElementVNode as _createElementVNode2, normalizeClass as _normalizeClass2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode, Fragment as _Fragment2, withModifiers as _withModifiers, createBlock as _createBlock, createVNode as _createVNode, normalizeStyle as _normalizeStyle, Transition as _Transition, withCtx as _withCtx, Teleport as _Teleport } from "vue";
import { computed as computed12, ref as ref13, nextTick as nextTick2, watch as watch5, onMounted as onMounted4, onBeforeUnmount as onBeforeUnmount2 } from "vue";
...
// public/codesandbox-runtime/components/time-picker/src/time-spinner.js
import { createCommentVNode as _createCommentVNode, createElementVNode as _createElementVNode, openBlock as _openBlock, createElementBlock as _createElementBlock, normalizeClass as _normalizeClass, toDisplayString as _toDisplayString, Fragment as _Fragment, renderList as _renderList } from "vue";
import { ref as ref12, computed as computed11, watch as watch4, nextTick, onMounted as onMounted3 } from "vue";

// public/codesandbox-runtime/components/time-picker/src/time-picker-meta.js
var parseTimeValue = (value, _format = "HH:mm:ss") => {
...
var formatTimeState = (state, format = "HH:mm:ss", use12Hours = false) => {
  if (!state) return "";
  ...
  const mm2 = String(minutes).padStart(2, "0");
  const m2 = String(minutes);
  const ss = String(seconds).padStart(2, "0");
  const s2 = String(seconds);
  let result = format.replace("HH", HH).replace("H", H).replace("mm", mm2).replace("m", m2).replace("ss", ss).replace("s", s2);
  if (use12Hours) {
    result = result.replace("A", suffix.trim()).replace("a", suffix.trim().toLowerCase());
  }
  return result;
};
var generateNumberList = (max, step = 1, disabledList = [], customOptions) => {
  const result = [];
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _createElementVNode(
        ...
        [
          $props.arrowControl ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [
              _createElementVNode(
                "button",
                {
                  ...
                  type: "button",
                  onClick: _cache[0] || (_cache[0] = ($event) => $setup.handleArrowClick("hours", "up"))
                },
                [..._cache[10] || (_cache[10] = [
                  _createElementVNode(
                    "svg",
              ...
              _createElementVNode(
                ...
                _toDisplayString($setup.formatNumber($props.use12Hours ? $props.modelValue.hours % 12 || 12 : $props.modelValue.hours)),
                3
                /* TEXT, CLASS */
              ),
              _createElementVNode(
                "button",
                {
                  class: _normalizeClass($setup.ns.e("arrow")),
                  type: "button",
                  onClick: _cache[1] || (_cache[1] = ($event) => $setup.handleArrowClick("hours", "down"))
                },
                [..._cache[11] || (_cache[11] = [
                  _createElementVNode(
                    "svg",
            ...
            "div",
            {
              ...
              onScroll: _cache[2] || (_cache[2] = ($event) => $setup.handleScroll("hours", $event))
            },
            [
              _createElementVNode(
                "div",
                  ...
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList($setup.hoursList, (item) => {
                      return _openBlock(), _createElementBlock("div", {
                        key: item.value,
                        class: _normalizeClass([$setup.ns.e("item"), $setup.ns.is("selected", $props.use12Hours ? ($props.modelValue.hours % 12 || 12) === item.value : $props.modelValue.hours === item.value), $setup.ns.is("disabled", item.disabled)]),
                        onClick: ($event) => $setup.handleItemClick("hours", item.value, item.disabled)
                      }, _toDisplayString($setup.formatNumber(item.value)), 11, _hoisted_1);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
        ...
        [
          $props.arrowControl ? (_openBlock(), _createElementBlock(
            ...
            [
              _createElementVNode(
                "button",
                {
                  class: _normalizeClass($setup.ns.e("arrow")),
                  type: "button",
                  onClick: _cache[3] || (_cache[3] = ($event) => $setup.handleArrowClick("minutes", "up"))
                },
                [..._cache[12] || (_cache[12] = [
                  _createElementVNode(
                    "svg",
              ...
              _createElementVNode(
                "button",
                {
                  class: _normalizeClass($setup.ns.e("arrow")),
                  type: "button",
                  onClick: _cache[4] || (_cache[4] = ($event) => $setup.handleArrowClick("minutes", "down"))
                },
                [..._cache[13] || (_cache[13] = [
                  _createElementVNode(
                    "svg",
            ...
            "div",
            {
              ...
              ref: "minutesRef",
              class: _normalizeClass($setup.ns.e("list")),
              onScroll: _cache[5] || (_cache[5] = ($event) => $setup.handleScroll("minutes", $event))
            },
            [
              _createElementVNode(
                "div",
                ...
                [
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList($setup.minutesList, (item) => {
                      return _openBlock(), _createElementBlock("div", {
                        key: item.value,
                        class: _normalizeClass([$setup.ns.e("item"), $setup.ns.is("selected", $props.modelValue.minutes === item.value), $setup.ns.is("disabled", item.disabled)]),
                        onClick: ($event) => $setup.handleItemClick("minutes", item.value, item.disabled)
                      }, _toDisplayString($setup.formatNumber(item.value)), 11, _hoisted_2);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
      ...
      $props.showSeconds ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 0 },
        [
          _createElementVNode(
            ...
            [
              $props.arrowControl ? (_openBlock(), _createElementBlock(
                ...
                [
                  _createElementVNode(
                    "button",
                    {
                      class: _normalizeClass($setup.ns.e("arrow")),
                      type: "button",
                      onClick: _cache[6] || (_cache[6] = ($event) => $setup.handleArrowClick("seconds", "up"))
                    },
                    [..._cache[14] || (_cache[14] = [
                      _createElementVNode(
                        "svg",
                  ...
                  _createElementVNode(
                    "button",
                    {
                      class: _normalizeClass($setup.ns.e("arrow")),
                      type: "button",
                      onClick: _cache[7] || (_cache[7] = ($event) => $setup.handleArrowClick("seconds", "down"))
                    },
                    [..._cache[15] || (_cache[15] = [
                      _createElementVNode(
                        "svg",
                ...
                "div",
                {
                  ...
                  ref: "secondsRef",
                  class: _normalizeClass($setup.ns.e("list")),
                  onScroll: _cache[8] || (_cache[8] = ($event) => $setup.handleScroll("seconds", $event))
                },
                [
                  _createElementVNode(
                    "div",
                    ...
                    [
                      (_openBlock(true), _createElementBlock(
                        ...
                        _renderList($setup.secondsList, (item) => {
                          return _openBlock(), _createElementBlock("div", {
                            key: item.value,
                            class: _normalizeClass([$setup.ns.e("item"), $setup.ns.is("selected", $props.modelValue.seconds === item.value), $setup.ns.is("disabled", item.disabled)]),
                            onClick: ($event) => $setup.handleItemClick("seconds", item.value, item.disabled)
                          }, _toDisplayString($setup.formatNumber(item.value)), 11, _hoisted_3);
                        }),
                        128
                        /* KEYED_FRAGMENT */
                      ))
      ...
      $props.use12Hours && !$props.arrowControl ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
          class: _normalizeClass($setup.ns.e("column"))
        ...
        [
          _createElementVNode(
            "div",
            {
              ref: "ampmRef",
              class: _normalizeClass($setup.ns.e("list")),
              onScroll: _cache[9] || (_cache[9] = ($event) => $setup.handleScroll("ampm", $event))
            },
            [
              _createElementVNode(
                "div",
                ...
                [
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList($setup.ampmList, (item) => {
                      return _openBlock(), _createElementBlock("div", {
                        key: item.value,
                        class: _normalizeClass([$setup.ns.e("item"), $setup.ns.is("selected", $setup.currentAmpm === item.value), $setup.ns.is("disabled", item.disabled)]),
                        onClick: ($event) => $setup.handleItemClick("ampm", item.value, item.disabled)
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const hoursRef = ref12();
    const minutesRef = ref12();
    const secondsRef = ref12();
    const ampmRef = ref12();
    const disabledHours = computed11(() => {
      var _a2, _b;
      return ((_b = (_a2 = props.disabledTime) == null ? void 0 : _a2.disabledHours) == null ? void 0 : _b.call(_a2)) || [];
    });
    const disabledMinutes = computed11(() => {
      var _a2, _b;
      return ((_b = (_a2 = props.disabledTime) == null ? void 0 : _a2.disabledMinutes) == null ? void 0 : _b.call(_a2, props.modelValue.hours)) || [];
    });
    const disabledSeconds = computed11(() => {
      var _a2, _b;
      return ((_b = (_a2 = props.disabledTime) == null ? void 0 : _a2.disabledSeconds) == null ? void 0 : _b.call(_a2, props.modelValue.hours, props.modelValue.minutes)) || [];
    });
    const hoursList = computed11(() => {
      const max = props.use12Hours ? 12 : 23;
      const list = generateNumberList(max, props.hourStep, disabledHours.value, props.hourOptions);
      if (props.use12Hours) {
        return list.map((item) => __spreadProps(__spreadValues2({}, item), {
          value: item.value === 0 ? 12 : item.value
        }));
      }
      return list;
    });
    const minutesList = computed11(() => {
      return generateNumberList(59, props.minuteStep, disabledMinutes.value, props.minuteOptions);
    });
    const secondsList = computed11(() => {
      return generateNumberList(59, props.secondStep, disabledSeconds.value, props.secondOptions);
    });
    const ampmList = computed11(() => [
      { value: "AM", label: "AM", disabled: false },
      { value: "PM", label: "PM", disabled: false }
    ]);
    const currentAmpm = computed11(() => props.modelValue.hours >= 12 ? "PM" : "AM");
    ...
    const handleScrollEnd = (type, container) => {
      ...
      if (type === "ampm") {
        ...
        if (newHours !== props.modelValue.hours) {
          const newState = __spreadProps(__spreadValues2({}, props.modelValue), { hours: newHours });
        ...
        if (index >= 0 && index < list.length) {
          ...
          if (item && !item.disabled) {
            ...
            if (props.modelValue[type] !== value) {
              const newState = __spreadProps(__spreadValues2({}, props.modelValue), { [type]: value });
              emit("update:modelValue", newState);
              emit("change", newState);
            }
          }
    ...
    const handleArrowClick = (type, direction) => {
      ...
      let attempts = 0;
      while (((_a2 = list[newIndex]) == null ? void 0 : _a2.disabled) && attempts < list.length) {
    ...
    const handleItemClick = (type, value, disabled) => {
      ...
      if (type === "ampm") {
        ...
        if (props.modelValue[type] !== numValue) {
          const newState = __spreadProps(__spreadValues2({}, props.modelValue), { [type]: numValue });
          emit("update:modelValue", newState);
          emit("change", newState);
        }
      }
    ...
    const __returned__ = { props, emit, ns, hoursRef, minutesRef, secondsRef, ampmRef, ITEM_HEIGHT, disabledHours, disabledMinutes, disabledSeconds, hoursList, minutesList, secondsList, ampmList, currentAmpm, formatNumber, scrollToItem, adjustScrollPosition, handleScrollEnd, get scrollTimer() {
      return scrollTimer;
    }, set scrollTimer(v) {
      scrollTimer = v;
    }, handleScroll, handleArrowClick, handleItemClick, getCurrentIndex, scrollToCurrentValues, ref: ref12, computed: computed11, watch: watch4, nextTick, onMounted: onMounted3, get useNamespace() {
      return useNamespace;
...
var _hoisted_12 = ["id", "value", "placeholder", "disabled", "readonly", "name", "tabindex", "aria-expanded"];
var _hoisted_22 = ["value", "placeholder", "disabled", "readonly", "tabindex"];
var _hoisted_32 = ["value", "placeholder", "disabled", "readonly", "tabindex"];
    ...
    [
      ...
      _createElementVNode2(
        ...
        [
          ...
          _createCommentVNode2(" \u5355\u9009\u8F93\u5165\u6846 "),
          !$props.isRange ? (_openBlock2(), _createElementBlock2("input", {
            key: 0,
            ref: "inputRef",
          ...
          }, null, 42, _hoisted_12)) : (_openBlock2(), _createElementBlock2(
            _Fragment2,
            { key: 1 },
            [
              _createCommentVNode2(" \u8303\u56F4\u9009\u62E9\u8F93\u5165\u6846 "),
              _createElementVNode2("input", {
                ref: "startInputRef",
                class: _normalizeClass2($setup.ns.e("range-input")),
              ...
              _createElementVNode2(
                "span",
                {
                  class: _normalizeClass2($setup.ns.e("range-separator"))
                },
                [
                  _renderSlot(_ctx.$slots, "rangeSeparator", {}, () => [
                    _createTextVNode(
                      _toDisplayString2($props.rangeSeparator),
                      1
                      /* TEXT */
                    )
                  ])
          ...
          _createElementVNode2(
            ...
            [
              ...
              $setup.showClear ? (_openBlock2(), _createElementBlock2(
                "span",
                {
                  key: 0,
              ...
              _createElementVNode2(
                "span",
                {
                  class: _normalizeClass2([$setup.ns.e("icon"), $setup.ns.e("arrow"), {
      ...
      _createCommentVNode2(" \u4E0B\u62C9\u9762\u677F "),
      (_openBlock2(), _createBlock(_Teleport, {
        to: "body",
        ...
        _createVNode(_Transition, {
          ...
          default: _withCtx(() => [
            $setup.visible ? (_openBlock2(), _createElementBlock2(
              ...
              {
                key: 0,
                class: _normalizeClass2([$setup.ns.e("panel"), $props.popperClass]),
              ...
              [
                _createCommentVNode2(" \u5355\u9009\u9762\u677F "),
                !$props.isRange ? (_openBlock2(), _createBlock($setup["TimeSpinner"], {
                  key: 0,
                ...
                }, null, 8, ["modelValue", "show-seconds", "arrow-control", "hour-step", "minute-step", "second-step", "disabled-time", "use12-hours", "hour-options", "minute-options", "second-options"])) : (_openBlock2(), _createElementBlock2(
                  _Fragment2,
                  { key: 1 },
                  [
                    _createCommentVNode2(" \u8303\u56F4\u9009\u62E9\u9762\u677F "),
                    _createElementVNode2(
                      "div",
                      {
                        class: _normalizeClass2($setup.ns.e("range-panel"))
                      },
                      [
                        _createElementVNode2(
                          "div",
                          {
                            class: _normalizeClass2($setup.ns.e("range-panel-item"))
                          },
                          [
                            _createElementVNode2(
                              "div",
                              {
                                class: _normalizeClass2($setup.ns.e("range-panel-title"))
                              },
                              _toDisplayString2($props.startPlaceholder || $setup.t("timepicker.startPlaceholder")),
                              3
                              /* TEXT, CLASS */
                            ),
                        ...
                        _createElementVNode2(
                          "div",
                          {
                            class: _normalizeClass2($setup.ns.e("range-panel-separator"))
                          },
                          [..._cache[6] || (_cache[6] = [
                            _createElementVNode2(
                              "svg",
                        ...
                        _createElementVNode2(
                          ...
                          [
                            _createElementVNode2(
                              ...
                              _toDisplayString2($props.endPlaceholder || $setup.t("timepicker.endPlaceholder")),
                              3
                              /* TEXT, CLASS */
                            ),
                            _createVNode($setup["TimeSpinner"], {
                ...
                _createCommentVNode2(" \u5E95\u90E8\u64CD\u4F5C\u680F "),
                $props.showFooter ? (_openBlock2(), _createElementBlock2(
                  "div",
                  {
                    key: 2,
                  ...
                  [
                    $props.showNow ? (_openBlock2(), _createElementBlock2(
                      "button",
                      {
                        key: 0,
                        type: "button",
                        class: _normalizeClass2($setup.ns.e("footer-btn")),
                        onClick: $setup.handleNow
                      },
                      _toDisplayString2($props.nowText || $setup.t("timepicker.now")),
                      3
                      /* TEXT, CLASS */
                    )) : _createCommentVNode2("v-if", true),
                    _createElementVNode2(
                      "div",
                      {
                        class: _normalizeClass2($setup.ns.e("footer-actions"))
                      },
                      [
                        _createElementVNode2(
                          "button",
                          {
                            type: "button",
                            class: _normalizeClass2([$setup.ns.e("footer-btn"), $setup.ns.e("footer-btn--cancel")]),
                            onClick: $setup.handleCancel
                          },
                          _toDisplayString2($props.cancelText || $setup.t("timepicker.cancel")),
                          3
                          /* TEXT, CLASS */
                        ),
                        _createElementVNode2(
                          ...
                          {
                            type: "button",
                            class: _normalizeClass2([$setup.ns.e("footer-btn"), $setup.ns.e("footer-btn--confirm")]),
                            onClick: $setup.handleConfirm
                          },
                          _toDisplayString2($props.confirmText || $setup.t("timepicker.confirm")),
                          3
                          /* TEXT, CLASS */
                        )
                      ],
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const startInputRef = ref13();
    const endInputRef = ref13();
    const visible = ref13(false);
    const focused = ref13(false);
    const hovering = ref13(false);
    const isClickingPanel = ref13(false);
    const internalTimeState = ref13({ hours: 0, minutes: 0, seconds: 0 });
    const internalStartTimeState = ref13({ hours: 0, minutes: 0, seconds: 0 });
    const internalEndTimeState = ref13({ hours: 0, minutes: 0, seconds: 0 });
    const dropdownStyle = ref13({});
    const parsedValue = computed12(() => {
      if (props.isRange) {
    ...
    const updateDropdownPosition = () => {
      ...
      dropdownStyle.value = __spreadValues3({
        position: "fixed",
        left: `${rect.left}px`,
    ...
    const getDisabledStartTime = (originalConfig) => {
      ...
      return __spreadProps2(__spreadValues3({}, originalConfig), {
        disabledHours: () => {
          var _a2;
          return ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledHours) == null ? void 0 : _a2.call(originalConfig)) || [];
        },
        disabledMinutes: (h2) => {
          var _a2;
          return ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledMinutes) == null ? void 0 : _a2.call(originalConfig, h2)) || [];
        },
        disabledSeconds: (h2, m2) => {
          var _a2;
          return ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledSeconds) == null ? void 0 : _a2.call(originalConfig, h2, m2)) || [];
        }
      });
    };
    const getDisabledEndTime = (originalConfig) => {
      ...
      return __spreadProps2(__spreadValues3({}, originalConfig), {
        disabledHours: () => {
          var _a2;
          const hours = ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledHours) == null ? void 0 : _a2.call(originalConfig)) || [];
        ...
        disabledMinutes: (h2) => {
          var _a2;
          const minutes = ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledMinutes) == null ? void 0 : _a2.call(originalConfig, h2)) || [];
          const startHour = internalStartTimeState.value.hours;
        ...
        disabledSeconds: (h2, m2) => {
          var _a2;
          const seconds = ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledSeconds) == null ? void 0 : _a2.call(originalConfig, h2, m2)) || [];
          const startHour = internalStartTimeState.value.hours;
          const startMin = internalStartTimeState.value.minutes;
          const startSec = internalStartTimeState.value.seconds;
          if (h2 === startHour && m2 === startMin) {
    ...
    const handleConfirm = () => {
      ...
      if (props.isRange) {
        ...
        let finalStart = __spreadValues3({}, internalStartTimeState.value);
        let finalEnd = __spreadValues3({}, internalEndTimeState.value);
        if (startSec > endSec) {
          if (props.orderOnConfirm) {
            finalStart = __spreadValues3({}, internalEndTimeState.value);
            finalEnd = __spreadValues3({}, internalStartTimeState.value);
          } else {
            return;
          }
        }
    ...
    const handleNow = () => {
      ...
      if (props.isRange) {
        internalStartTimeState.value = __spreadValues3({}, now);
        internalEndTimeState.value = __spreadValues3({}, now);
      } else {
        internalTimeState.value = __spreadValues3({}, now);
      }
    };
    ...
    const focus = () => {
      var _a2, _b;
      if (props.isRange) {
        (_a2 = startInputRef.value) == null ? void 0 : _a2.focus();
      } else {
    ...
    const blur = () => {
      var _a2, _b, _c;
      if (props.isRange) {
        (_a2 = startInputRef.value) == null ? void 0 : _a2.blur();
    ...
    const __returned__ = { props, emit, ns, t, inputId, themeStyle, form, formItem, triggerValidate, globalSize, selectSize, wrapperRef, inputRef, startInputRef, endInputRef, visible, focused, hovering, isClickingPanel, internalTimeState, internalStartTimeState, internalEndTimeState, dropdownStyle, parsedValue, displayValue, rangeStartDisplayValue, rangeEndDisplayValue, hasValue, showClear, wrapperClasses, updateDropdownPosition, syncInternalState, getDisabledStartTime, getDisabledEndTime, openPanel, closePanel, handleConfirm, handleCancel, handleNow, handleClear, togglePanel, handleFocus, handleBlur, handlePanelMousedown, handlePanelMouseup, handleMouseEnter, handleMouseLeave, handleKeydown, focus, blur, computed: computed12, ref: ref13, nextTick: nextTick2, watch: watch5, onMounted: onMounted4, onBeforeUnmount: onBeforeUnmount2, get useNamespace() {
      ...
      return useConfig;
    }, TimeSpinner: stdin_default3, get parseTimeValue() {
