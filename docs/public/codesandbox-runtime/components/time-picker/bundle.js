  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getDisabledStartTime = (originalConfig) => {
      ...
      return __spreadProps2(__spreadValues3({}, originalConfig), {
        ...
        disabledMinutes: (h) => {
          var _a2;
          return ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledMinutes) == null ? void 0 : _a2.call(originalConfig, h)) || [];
        },
        disabledSeconds: (h, m) => {
          var _a2;
          return ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledSeconds) == null ? void 0 : _a2.call(originalConfig, h, m)) || [];
        }
      });
    };
    const getDisabledEndTime = (originalConfig) => {
      ...
      return __spreadProps2(__spreadValues3({}, originalConfig), {
        ...
        disabledMinutes: (h) => {
          var _a2;
          const minutes = ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledMinutes) == null ? void 0 : _a2.call(originalConfig, h)) || [];
          const startHour = internalStartTimeState.value.hours;
        ...
        disabledSeconds: (h, m) => {
          var _a2;
          const seconds = ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledSeconds) == null ? void 0 : _a2.call(originalConfig, h, m)) || [];
          const startHour = internalStartTimeState.value.hours;
          const startMin = internalStartTimeState.value.minutes;
    ...
    const __returned__ = { props, emit, ns, t, inputId, themeStyle, form, formItem, triggerValidate, globalSize, selectSize, wrapperRef, inputRef, startInputRef, endInputRef, visible, focused, hovering, isClickingPanel, internalTimeState, internalStartTimeState, internalEndTimeState, dropdownStyle, parsedValue, displayValue, rangeStartDisplayValue, rangeEndDisplayValue, hasValue, showClear, wrapperClasses, updateDropdownPosition, syncInternalState, getDisabledStartTime, getDisabledEndTime, openPanel, closePanel, handleConfirm, handleCancel, handleNow, handleClear, togglePanel, handleFocus, handleBlur, handlePanelMousedown, handlePanelMouseup, handleMouseEnter, handleMouseLeave, handleKeydown, focus, blur, computed: computed12, ref: ref13, nextTick: nextTick2, watch: watch5, onMounted: onMounted4, onBeforeUnmount: onBeforeUnmount2, get useNamespace() {
      ...
      return useConfig;
    }, TimeSpinner: stdin_default2, get parseTimeValue() {
