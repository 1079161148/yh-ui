// docs/public/codesandbox-runtime/components/time-picker/src/time-picker.js
import {
...
// docs/public/codesandbox-runtime/components/time-picker/src/time-spinner.js
import {
...
// docs/public/codesandbox-runtime/components/time-picker/src/time-picker-meta.js
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const disabledHours = computed11(() => {
        var _a2, _b
        return (
          ((_b = (_a2 = props.disabledTime) == null ? void 0 : _a2.disabledHours) == null
            ? void 0
            : _b.call(_a2)) || []
        )
      })
      const disabledMinutes = computed11(() => {
        var _a2, _b
        return (
          ((_b = (_a2 = props.disabledTime) == null ? void 0 : _a2.disabledMinutes) == null
            ? void 0
            : _b.call(_a2, props.modelValue.hours)) || []
        )
      })
      const disabledSeconds = computed11(() => {
        var _a2, _b
        return (
          ((_b = (_a2 = props.disabledTime) == null ? void 0 : _a2.disabledSeconds) == null
            ? void 0
            : _b.call(_a2, props.modelValue.hours, props.modelValue.minutes)) || []
        )
      })
      ...
      const handleScrollEnd = (type, container) => {
        ...
        if (type === 'ampm') {
          ...
          if (newHours !== props.modelValue.hours) {
            const newState = __spreadProps(__spreadValues2({}, props.modelValue), {
              hours: newHours
            })
                  ...
                  [
                    ...
                    _createElementVNode2(
                      'input',
                      {
                        ...
                        placeholder:
                          $props.startPlaceholder || $setup.t('timepicker.startPlaceholder'),
                        disabled: $props.disabled,
                        readonly: !$props.editable,
                        tabindex: $props.tabindex,
                        autocomplete: 'off',
                            ...
                            ? (_openBlock2(),
                              _createBlock(
                                $setup['TimeSpinner'],
                                {
                                  ...
                                  'onUpdate:modelValue':
                                    _cache[0] ||
                                    (_cache[0] = ($event) => ($setup.internalTimeState = $event)),
                                  ...
                                  _createElementVNode2(
                                    ...
                                    [
                                      _createElementVNode2(
                                        ...
                                        [
                                          _createElementVNode2(
                                            ...
                                            {
                                              class: _normalizeClass2(
                                                $setup.ns.e('range-panel-title')
                                              )
                                            },
                                            _toDisplayString2(
                                              $props.startPlaceholder ||
                                                $setup.t('timepicker.startPlaceholder')
                                            ),
                                            3
                                            /* TEXT, CLASS */
                                          ),
                                          _createVNode(
                                            $setup['TimeSpinner'],
                                            {
                                              ...
                                              'onUpdate:modelValue':
                                                _cache[1] ||
                                                (_cache[1] = ($event) =>
                                                  ($setup.internalStartTimeState = $event)),
                                              'show-seconds': $props.showSeconds,
                                              'arrow-control': $props.arrowControl,
                                              'hour-step': $props.hourStep,
                                              'minute-step': $props.minuteStep,
                                              'second-step': $props.secondStep,
                                              'disabled-time': $setup.getDisabledStartTime(
                                                $props.disabledTime
                                              ),
                                              'use12-hours': $props.use12Hours
                                            },
                                      ...
                                      _createElementVNode2(
                                        ...
                                        {
                                          class: _normalizeClass2(
                                            $setup.ns.e('range-panel-separator')
                                          )
                                        },
                                        [
                                          ...(_cache[6] ||
                                          ...
                                          _createElementVNode2(
                                            ...
                                            _toDisplayString2(
                                              $props.endPlaceholder ||
                                                $setup.t('timepicker.endPlaceholder')
                                            ),
                                            3
                                            /* TEXT, CLASS */
                                          ),
                                          _createVNode(
                                            $setup['TimeSpinner'],
                                            {
                                              ...
                                              'onUpdate:modelValue':
                                                _cache[2] ||
                                                (_cache[2] = ($event) =>
                                                  ($setup.internalEndTimeState = $event)),
                                              'show-seconds': $props.showSeconds,
                                              'arrow-control': $props.arrowControl,
                                              'hour-step': $props.hourStep,
                                              'minute-step': $props.minuteStep,
                                              'second-step': $props.secondStep,
                                              'disabled-time': $setup.getDisabledEndTime(
                                                $props.disabledTime
                                              ),
                                              'use12-hours': $props.use12Hours
                                            },
                                  ...
                                  $props.showNow
                                    ? (_openBlock2(),
                                      _createElementBlock2(
                                        ...
                                        _toDisplayString2(
                                          $props.nowText || $setup.t('timepicker.now')
                                        ),
                                        3
                                        /* TEXT, CLASS */
                                      ))
                                    ...
                                    [
                                      _createElementVNode2(
                                        'button',
                                        {
                                          type: 'button',
                                          class: _normalizeClass2([
                                            $setup.ns.e('footer-btn'),
                                            $setup.ns.e('footer-btn--cancel')
                                          ]),
                                          onClick: $setup.handleCancel
                                        },
                                        _toDisplayString2(
                                          $props.cancelText || $setup.t('timepicker.cancel')
                                        ),
                                        3
                                        /* TEXT, CLASS */
                                      ),
                                      _createElementVNode2(
                                        'button',
                                        {
                                          ...
                                          class: _normalizeClass2([
                                            $setup.ns.e('footer-btn'),
                                            $setup.ns.e('footer-btn--confirm')
                                          ]),
                                          onClick: $setup.handleConfirm
                                        },
                                        _toDisplayString2(
                                          $props.confirmText || $setup.t('timepicker.confirm')
                                        ),
                                        3
                                        /* TEXT, CLASS */
                                      )
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const getDisabledStartTime = (originalConfig) => {
        ...
        return __spreadProps2(__spreadValues3({}, originalConfig), {
          disabledHours: () => {
            var _a2
            return (
              ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledHours) == null
                ? void 0
                : _a2.call(originalConfig)) || []
            )
          },
          disabledMinutes: (h) => {
            var _a2
            return (
              ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledMinutes) == null
                ? void 0
                : _a2.call(originalConfig, h)) || []
            )
          },
          disabledSeconds: (h, m) => {
            var _a2
            return (
              ((_a2 = originalConfig == null ? void 0 : originalConfig.disabledSeconds) == null
                ? void 0
                : _a2.call(originalConfig, h, m)) || []
            )
          }
        })
      }
      ...
      const __returned__ = {
        ...
        isClickingPanel,
        internalTimeState,
        internalStartTimeState,
        internalEndTimeState,
        dropdownStyle,
        parsedValue,
        displayValue,
