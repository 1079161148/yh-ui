      ...
      const getDisabledStartTime = (originalConfig) => {
        ...
        return __spreadProps(__spreadValues({}, originalConfig), {
          disabledHours: () => {
            var _a
            return (
              ((_a = originalConfig == null ? void 0 : originalConfig.disabledHours) == null
                ? void 0
                : _a.call(originalConfig)) || []
            )
          },
          disabledMinutes: (h) => {
            var _a
            return (
              ((_a = originalConfig == null ? void 0 : originalConfig.disabledMinutes) == null
                ? void 0
                : _a.call(originalConfig, h)) || []
            )
          },
          disabledSeconds: (h, m) => {
            var _a
            return (
              ((_a = originalConfig == null ? void 0 : originalConfig.disabledSeconds) == null
                ? void 0
                : _a.call(originalConfig, h, m)) || []
            )
          }
        })
      }
