...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const disabledHours = computed(() => {
      var _a, _b;
      return ((_b = (_a = props.disabledTime) == null ? void 0 : _a.disabledHours) == null ? void 0 : _b.call(_a)) || [];
    });
    const disabledMinutes = computed(() => {
      var _a, _b;
      return ((_b = (_a = props.disabledTime) == null ? void 0 : _a.disabledMinutes) == null ? void 0 : _b.call(_a, props.modelValue.hours)) || [];
    });
    const disabledSeconds = computed(() => {
      var _a, _b;
      return ((_b = (_a = props.disabledTime) == null ? void 0 : _a.disabledSeconds) == null ? void 0 : _b.call(_a, props.modelValue.hours, props.modelValue.minutes)) || [];
    });
    ...
    const handleScrollEnd = (type, container) => {
      ...
      if (type === "ampm") {
        ...
        if (newHours !== props.modelValue.hours) {
          const newState = __spreadProps(__spreadValues({}, props.modelValue), { hours: newHours });
    ...
    const handleItemClick = (type, value, disabled) => {
      ...
      if (type === "ampm") {
        ...
        if (props.modelValue[type] !== numValue) {
          const newState = __spreadProps(__spreadValues({}, props.modelValue), { [type]: numValue });
          emit("update:modelValue", newState);
          emit("change", newState);
        }
      }
    ...
    const __returned__ = { props, emit, ns, hoursRef, minutesRef, secondsRef, ampmRef, ITEM_HEIGHT, disabledHours, disabledMinutes, disabledSeconds, hoursList, minutesList, secondsList, ampmList, currentAmpm, formatNumber, scrollToItem, adjustScrollPosition, handleScrollEnd, get scrollTimer() {
      ...
      scrollTimer = v;
    }, handleScroll, handleArrowClick, handleItemClick, getCurrentIndex, scrollToCurrentValues, ref, computed, watch, nextTick, onMounted, get useNamespace() {
      return useNamespace;
