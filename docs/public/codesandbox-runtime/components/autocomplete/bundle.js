...
// public/codesandbox-runtime/components/autocomplete/src/autocomplete.js
...
import { computed as computed11, ref as ref12, watch as watch4, nextTick, useSlots, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2 } from "vue";
...
var _hoisted_1 = ["id", "value", "placeholder", "disabled", "name", "autocomplete", "autofocus", "aria-expanded", "aria-controls", "aria-activedescendant"];
var _hoisted_2 = ["id"];
var _hoisted_3 = ["id", "aria-selected", "onClick", "onMouseenter"];
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const autocompleteSize = computed11(
      () => props.size || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalSize.value || "default"
    );
    const autocompleteDisabled = computed11(() => props.disabled || (form == null ? void 0 : form.disabled) || false);
    ...
    const hasPrefix = computed11(() => !!slots.prefix || !!props.prefixIcon);
    const hasSuffix = computed11(() => !!slots.suffix || !!props.suffixIcon || showClear.value);
    ...
    const handleOutsideClick = (e) => {
      ...
      if (((_a2 = wrapperRef.value) == null ? void 0 : _a2.contains(target)) || ((_b = dropdownRef.value) == null ? void 0 : _b.contains(target))) {
        return;
      }
      visible.value = false;
    };
    ...
    const __returned__ = { props, emit, slots, ns, inputId, t, nextZIndex, themeStyle, form, formItem, triggerValidate, globalSize, autocompleteSize, autocompleteDisabled, inputRef, wrapperRef, dropdownRef, listRef, focused, hovering, visible, loading, suggestions, highlightedIndex, isClickingDropdown, dropdownZIndex, dropdownStyle, get debounceTimer() {
      ...
      debounceTimer = v;
    }, showClear, hasPrefix, hasSuffix, hasPrepend, hasAppend, wrapperClasses, updateDropdownPosition, handleResize, handleScroll, handleOutsideClick, fetchSuggestions, debouncedFetch, handleInput, handleChange, handleFocus, handleBlur, handleMouseEnter, handleMouseLeave, handleClear, handleSelect, handleKeydown, scrollToHighlighted, focus, blur, close, highlight, computed: computed11, ref: ref12, watch: watch4, nextTick, useSlots, onMounted: onMounted3, onBeforeUnmount: onBeforeUnmount2, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useId() {
