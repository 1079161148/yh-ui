// docs/public/codesandbox-runtime/components/autocomplete/src/autocomplete.js
import {
                  ...
                  _withDirectives(
                                              ...
                                              [
                                                _renderSlot(
                                                  ...
                                                  () => [
                                                    _createTextVNode(
                                                      _toDisplayString(
                                                        item[$props.valueKey] || item.value
                                                      ),
                                                      1
                                                      /* TEXT */
                                                    )
                    ...
                    [
                      [
                        _vShow,
                        $setup.visible &&
                          ($setup.suggestions.length > 0 || $setup.loading || $setup.slots.empty)
                      ]
                    ]
                  )
                ]),
...
var __sfc__ = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const autocompleteDisabled = computed11(
