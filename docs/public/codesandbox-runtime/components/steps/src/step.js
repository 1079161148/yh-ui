...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      ((_a = $setup.stepsContext) == null ? void 0 : _a.props.showTimeline) && _ctx.time ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
      ...
      !$setup.isLast ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
        ...
        [
          _createElementVNode(
            "i",
            {
              ...
              style: _normalizeStyle(((_b = $setup.stepsContext) == null ? void 0 : _b.props.showProgress) ? {
              ...
              [
                ...
                (_openBlock(), _createElementBlock(
                  ...
                  [
                    ...
                    _createElementVNode("g", { innerHTML: $setup.statusIconSvg }, null, 8, _hoisted_1)
                  ],
                  2
                  /* CLASS */
                ))
      ...
      _createElementVNode(
        ...
        [
          _createElementVNode(
            "div",
            {
              class: _normalizeClass([$setup.ns.e("title"), $setup.ns.is($setup.currentStatus, true)])
            },
            [
          ...
          _ctx.description || _ctx.$slots.description ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
          ...
          _createCommentVNode(" \u81EA\u5B9A\u4E49\u5185\u5BB9\uFF08\u5EF6\u8FDF\u52A0\u8F7D\u652F\u6301\uFF09 "),
          _ctx.$slots.default && ($setup.hasRendered || !_ctx.lazy) ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 1,
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const stepIndex = computed(() => {
      var _a2;
      return (_a2 = stepsContext == null ? void 0 : stepsContext.steps.value.findIndex((s) => s.uid === uid)) != null ? _a2 : 0;
    });
    const currentStatus = computed(() => {
      var _a2, _b, _c;
      if (props.status) return props.status;
      const active = (_a2 = stepsContext == null ? void 0 : stepsContext.props.active) != null ? _a2 : 0;
      const finishStatus = (_b = stepsContext == null ? void 0 : stepsContext.props.finishStatus) != null ? _b : "finish";
      const processStatus = (_c = stepsContext == null ? void 0 : stepsContext.props.processStatus) != null ? _c : "process";
    ...
    const isActive = computed(() => {
      var _a2;
      return stepIndex.value === ((_a2 = stepsContext == null ? void 0 : stepsContext.props.active) != null ? _a2 : 0);
    });
    ...
    const isLast = computed(() => {
      var _a2;
      const total = (_a2 = stepsContext == null ? void 0 : stepsContext.steps.value.length) != null ? _a2 : 0;
    ...
    const _actualDirection = computed(() => {
      var _a2;
      if (stepsContext == null ? void 0 : stepsContext.isResponsiveVertical.value) return "vertical";
      return (_a2 = stepsContext == null ? void 0 : stepsContext.props.direction) != null ? _a2 : "horizontal";
    });
    ...
    const handleClick = () => {
      stepsContext == null ? void 0 : stepsContext.handleStepClick(stepIndex.value, props.disabled);
    };
    onMounted(() => {
      stepsContext == null ? void 0 : stepsContext.registerStep({
        uid,
        title: props.title,
    ...
    watch(
      ...
      (config) => {
        stepsContext == null ? void 0 : stepsContext.registerStep(__spreadValues({
          uid
        }, config));
      }
    );
    ...
    const stepClass = computed(() => [
      ...
      ns.is("clickable", (stepsContext == null ? void 0 : stepsContext.props.clickable) && !props.disabled),
      ns.is("timeline", stepsContext == null ? void 0 : stepsContext.props.showTimeline),
      ns.is("label-vertical", (stepsContext == null ? void 0 : stepsContext.props.labelPlacement) === "vertical")
    ]);
    const __returned__ = { props, ns, themeStyle, instance, uid, stepsContext, hasRendered, stepIndex, currentStatus, isActive, isLast, progressPercent, _actualDirection, stepStyle, handleClick, statusIconSvg, stepClass, computed, inject, onMounted, onUnmounted, getCurrentInstance, watch, ref, get useNamespace() {
      return useNamespace;
