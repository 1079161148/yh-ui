...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, steps, isResponsiveVertical, checkResponsive, registerStep, unregisterStep, handleStepClick, actualDirection, stepsClass, computed, provide, ref, onMounted, onUnmounted, get useNamespace() {
      return useNamespace;
