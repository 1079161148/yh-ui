// public/codesandbox-runtime/components/steps/src/steps.js
import { renderSlot as _renderSlot, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, openBlock as _openBlock, createElementBlock as _createElementBlock } from "vue";
import { computed as computed2, provide as provide2, ref as ref2, onMounted, onUnmounted } from "vue";
...
// public/codesandbox-runtime/components/steps/src/steps-meta.js
var stepsProps = {
  /** 当前激活步骤 */
  active: {
    type: Number,
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { themeStyle } = useComponentTheme("steps", computed2(() => props.themeOverrides));
    const steps = ref2([]);
    ...
    const __returned__ = { props, emit, ns, themeStyle, steps, isResponsiveVertical, checkResponsive, registerStep, unregisterStep, handleStepClick, actualDirection, stepsClass, computed: computed2, provide: provide2, ref: ref2, onMounted, onUnmounted, get useNamespace() {
      return useNamespace;
