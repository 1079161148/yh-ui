                      ...
                      _createElementBlock(
                        ...
                        [
                          _renderSlot(_ctx.$slots, 'icon', {}, () => [
                            _ctx.icon
                              ? (_openBlock(),
                                _createBlock(_resolveDynamicComponent(_ctx.icon), { key: 0 }))
                              : (_openBlock(),
                                _createElementBlock(
                                  _Fragment,
                                  { key: 1 },
                      ...
                      _createElementVNode(
                        ...
                        [
                          _createElementVNode(
                            ...
                            [
                              _ctx.description || $setup.slots.default
                                ? (_openBlock(),
                                  _createElementBlock(
                                    'p',
                                    {
                              ...
                              _ctx.scrollable && (_ctx.description || $setup.slots.default)
                                ? (_openBlock(),
                                  _createElementBlock(
                                    'p',
                                    {
                        ...
                        [
                          _renderSlot(_ctx.$slots, 'close', {}, () => [
                            _ctx.closeText
                              ...
                              : _ctx.closeIcon
                                ? (_openBlock(),
                                  _createBlock(_resolveDynamicComponent(_ctx.closeIcon), {
                                    key: 1,
                                    style: { width: '16px', height: '16px' }
                                  }))
                                : (_openBlock(),
                                  _createElementBlock('svg', _hoisted_8, [
                                    ...(_cache[0] ||
                                      (_cache[0] = [
                                        _createElementVNode(
                                          'path',
