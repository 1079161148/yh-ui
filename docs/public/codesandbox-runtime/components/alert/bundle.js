// public/codesandbox-runtime/components/alert/src/alert.js
...
import { ref as ref12, computed as computed11, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2, useSlots } from "vue";
...
// public/codesandbox-runtime/components/alert/src/alert-meta.js
var alertTypes = ["success", "info", "warning", "error"];
var alertEffects = ["light", "dark", "outline", "glass"];
var alertProps = {
  /** 标题 */
  title: {
    type: String,
      ...
      $setup.visible ? (_openBlock(), _createElementBlock(
        ...
        [
          ...
          _ctx.closable ? (_openBlock(), _createElementBlock("div", {
            ...
            "aria-label": $setup.t("alert.close"),
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const visible = ref12(true);
    const progress = ref12(100);
    const remainingTime = ref12(props.duration);
    const lastUpdate = ref12(0);
    const isPaused = ref12(false);
    let timer = null;
    let rafId = null;
    ...
    const alertStyle = computed11(() => __spreadProps(__spreadValues2({}, themeStyle.value), {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, slots, visible, progress, remainingTime, lastUpdate, isPaused, get timer() {
      ...
      rafId = v;
    }, updateProgress, alertClass, alertStyle, progressStyle, handleClose, clearAutoClose, handleMouseEnter, handleMouseLeave, ref: ref12, computed: computed11, onMounted: onMounted3, onBeforeUnmount: onBeforeUnmount2, useSlots, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
