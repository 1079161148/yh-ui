...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhProductCard" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, cardRef, get observer() {
      ...
      observer = v;
    }, hasExposed, setupObserver, currentImage, isHovering, videoActive, handleMouseEnter, handleMouseLeave, displayPrice, displayMarketPrice, displayVipPrice, stockStyle, handleAction, handleClick, badgeImageErrors, handleBadgeImageError, ref, computed, onMounted, onUnmounted, watch, get useNamespace() {
      return useNamespace;
