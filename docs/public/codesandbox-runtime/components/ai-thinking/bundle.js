// public/codesandbox-runtime/components/ai-thinking/src/ai-thinking.js
import { normalizeClass as _normalizeClass, createVNode as _createVNode, createElementVNode as _createElementVNode, toDisplayString as _toDisplayString, renderSlot as _renderSlot2, createTextVNode as _createTextVNode, vShow as _vShow, withDirectives as _withDirectives, normalizeStyle as _normalizeStyle, openBlock as _openBlock2, createElementBlock as _createElementBlock2 } from "vue";
...
// public/codesandbox-runtime/components/ai-thinking/src/ai-thinking.js
import { computed as computed12, watch as watch4 } from "vue";
...
// public/codesandbox-runtime/components/ai-thinking/src/ai-thinking-meta.js
var aiThinkingProps = {
  /**
   * @description 思考状态
   */
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    "div",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.m(_ctx.status), $setup.ns.is("expanded", $setup.isExpanded), _ctx.className]),
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isExpanded, displayTitle, statusIcon, toggleExpand, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, computed: computed12, watch: watch4, get YhIcon() {
      return YhIcon;
    }, get aiThinkingProps() {
