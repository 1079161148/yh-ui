...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSubmitBar" }, {
  __name: "submit-bar",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, displayPrice, priceLabel, selectedText, btnText, handleSubmit, handleCheck, computed, get useNamespace() {
      return useNamespace;
