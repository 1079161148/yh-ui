...
// public/codesandbox-runtime/components/submit-bar/src/submit-bar.js
...
// public/codesandbox-runtime/components/submit-bar/src/submit-bar-meta.js
var submitBarProps = {
...
var submitBarEmits = {
  submit: (e) => e instanceof MouseEvent,
  "update:checked": (val) => typeof val === "boolean",
  /** 全选复选框切换 */
  "check-change": (val) => typeof val === "boolean"
};

// public/codesandbox-runtime/components/submit-bar/src/submit-bar.js
var _hoisted_1 = ["aria-checked"];
var _hoisted_2 = ["checked", "indeterminate"];
var _hoisted_3 = ["disabled", "aria-disabled", "aria-busy"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "div",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.is("safe-area", _ctx.safeAreaInsetBottom)]),
    ...
    [
      ...
      _createElementVNode(
        ...
        [
          ...
          _ctx.showCheckbox ? (_openBlock(), _createElementBlock("label", {
            key: 0,
          ...
          _createElementVNode(
            ...
            [
              $setup.selectedText ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  ...
                  _renderSlot(_ctx.$slots, "price", {}, () => [
                    _createElementVNode(
                      ...
                      [
                        ...
                        _ctx.decimalLength > 0 ? (_openBlock(), _createElementBlock(
                          "span",
                          {
                            key: 0,
          ...
          _createElementVNode("button", {
            class: _normalizeClass([$setup.ns.e("btn"), $setup.ns.em("btn", _ctx.buttonType), $setup.ns.is("disabled", _ctx.disabled || _ctx.loading)]),
      ...
      _ctx.safeAreaInsetBottom ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSubmitBar" }, {
  __name: "submit-bar",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const priceLabel = computed11(() => props.label || t("submitbar.total"));
    const selectedText = computed11(() => {
      if (!props.selectedCount) return "";
      return t("submitbar.selected").replace("{count}", String(props.selectedCount));
    });
    const btnText = computed11(() => props.buttonText || t("submitbar.submit"));
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, displayPrice, priceLabel, selectedText, btnText, handleSubmit, handleCheck, computed: computed11, get useNamespace() {
      return useNamespace;
