...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, fields, addField, removeField, validate, resetFields, clearValidate, scrollToField, context, provide, reactive, toRefs, computed, get formProps() {
      return formProps;
    }, get FormContextKey() {
