    ...
    _createElementBlock(
      'div',
      {
        class: _normalizeClass([
          $setup.ns.b(),
          $setup.ns.m($setup.itemSize),
          $setup.ns.is('error', $setup.currentValidateStatus === 'error'),
          $setup.ns.is('validating', $setup.currentValidateStatus === 'validating'),
          $setup.ns.is('success', $setup.currentValidateStatus === 'success'),
          $setup.ns.is('required', $setup.isRequired),
          $setup.ns.is('disabled', $setup.isDisabled)
        ]),
      ...
      [
                  ...
                  return [
                    _createTextVNode(
                      _toDisplayString(_ctx.label) +
                        _toDisplayString(
                          (_a2 = $setup.formContext) == null ? void 0 : _a2.labelSuffix
                        ),
                      1
                      /* TEXT */
                    )
        ...
        _createElementVNode(
          ...
          [
            ...
            ((_a = $setup.formContext) == null ? void 0 : _a.statusIcon) &&
            $setup.currentValidateStatus
              ? (_openBlock(),
                _createElementBlock(
                  'div',
                  {
                    ...
                    class: _normalizeClass([
                      ...
                      $setup.ns.is($setup.currentValidateStatus)
                    ])
                  },
                  [
                    $setup.currentValidateStatus === 'success'
                      ? (_openBlock(),
                      ...
                      : $setup.currentValidateStatus === 'error'
                        ? (_openBlock(),
              ...
              { name: 'yh-fade' },
              {
                default: _withCtx(() => {
                  ...
                  return [
                    $setup.currentValidateStatus === 'error' &&
                    _ctx.showMessage &&
                    ((_b = (_a2 = $setup.formContext) == null ? void 0 : _a2.showMessage) != null
                      ? _b
                      : true)
                      ? (_openBlock(),
                        _createElementBlock(
                          'div',
                          {
                            ...
                            class: _normalizeClass([
                              $setup.ns.e('error'),
                              $setup.ns.is(_ctx.errorPosition)
                            ]),
                            role: 'alert',
                            'aria-live': 'polite'
                          },
  ...
  },
  {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const currentValidateStatus = computed(
        () => props.validateStatus || innerValidateStatus.value
      )
      ...
      const itemSize = computed(
        () =>
          props.size ||
          (formContext == null ? void 0 : formContext.size) ||
          globalSize.value ||
          'default'
      )
      const isDisabled = computed(
        () => props.disabled || (formContext == null ? void 0 : formContext.disabled) || false
      )
