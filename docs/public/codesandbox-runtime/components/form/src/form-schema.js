...
import { renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, createCommentVNode as _createCommentVNode, toDisplayString as _toDisplayString, createElementVNode as _createElementVNode, normalizeClass as _normalizeClass, mergeProps as _mergeProps, withCtx as _withCtx, createVNode as _createVNode, renderSlot as _renderSlot, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock, createSlots as _createSlots, normalizeStyle as _normalizeStyle, vShow as _vShow, withDirectives as _withDirectives, createTextVNode as _createTextVNode, withModifiers as _withModifiers } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createBlock($setup["YhForm"], _mergeProps(_ctx.formProps, {
          ...
          _renderList(_ctx.schema, (item, index) => {
            ...
            return _openBlock(), _createElementBlock(
              ...
              [
                ...
                $setup.isGroup(item) ? (_openBlock(), _createElementBlock("div", _hoisted_2, [
                  _createElementVNode(
                    "fieldset",
                    _mergeProps({
                      class: [$setup.ns.e("group"), {
                        "is-collapsed": $setup.collapsedMap[$setup.getGroupTitle(item)]
                      }]
                    }, { ref_for: true }, $setup.getGroupProps(item)),
                    [
                      $setup.getGroupTitle(item) ? (_openBlock(), _createElementBlock("legend", {
                        key: 0,
                        class: _normalizeClass($setup.ns.e("group-title")),
                        onClick: ($event) => $setup.isGroupCollapsible(item) && $setup.toggleCollapse($setup.getGroupTitle(item))
                      }, [
                        _createElementVNode(
                          "span",
                          _hoisted_4,
                        ...
                        $setup.isGroupCollapsible(item) ? (_openBlock(), _createElementBlock(
                          "span",
                          {
                            key: 0,
                            class: _normalizeClass(["yh-form-schema__collapse-icon", {
                              "is-collapsed": $setup.collapsedMap[$setup.getGroupTitle(item)]
                            }])
                          },
                          [..._cache[0] || (_cache[0] = [
                          ...
                          (_openBlock(true), _createElementBlock(
                            ...
                            _renderList($setup.getGroupItems(item), (subItem) => {
                              ...
                              return _openBlock(), _createElementBlock(
                                ...
                                [
                                  !$setup.isItemHidden(subItem) ? (_openBlock(), _createElementBlock(
                                    "div",
                                    {
                                      key: 0,
                                      class: _normalizeClass(["yh-form-col", subItem.col ? `yh-form-col--${subItem.col}` : "yh-form-col--24"]),
                                      style: _normalizeStyle(subItem.span ? {
                                        gridColumn: `span ${subItem.span}`
                                      } : void 0)
                                    },
                                    [
                                      _createCommentVNode(" \u5206\u9694\u7EBF\u7C7B\u578B "),
                                      subItem.type === "divider" ? (_openBlock(), _createElementBlock(
                                        "div",
                                        {
                                          key: 0,
                                        ...
                                        [
                                          subItem.label ? (_openBlock(), _createElementBlock(
                                            "span",
                                            {
                                              key: 0,
                                              class: _normalizeClass($setup.ns.e("divider-label"))
                                            },
                                            _toDisplayString(subItem.label),
                                            3
                                            /* TEXT, CLASS */
                                          )) : _createCommentVNode("v-if", true)
                                        ],
                                        2
                                        /* CLASS */
                                      )) : subItem.type === "text" ? (_openBlock(), _createElementBlock(
                                        _Fragment,
                                        { key: 1 },
                                        [
                                          _createCommentVNode(" \u7EAF\u6587\u672C\u5C55\u793A "),
                                          _createVNode($setup["YhFormItem"], _mergeProps({
                                            label: subItem.label
                                          }, { ref_for: true }, subItem.formItemProps), {
                                            default: _withCtx(() => [
                                              _createElementVNode(
                                                "span",
                                                {
                                                  class: _normalizeClass($setup.ns.e("text-value"))
                                                },
                                                _toDisplayString($setup.get($setup.localModel, subItem.field)),
                                                3
                                                /* TEXT, CLASS */
                                              )
                                            ]),
                                        ...
                                        [
                                          ...
                                          _createVNode($setup["YhFormItem"], _mergeProps({ ref_for: true }, subItem.formItemProps, {
                                            label: subItem.label,
                                            prop: subItem.field,
                                            required: $setup.resolveRequired(subItem),
                                            rules: $setup.resolveRules(subItem)
                                          }), _createSlots({
                                            default: _withCtx(() => [
                                              _ctx.$slots[`field-${subItem.field}`] ? _renderSlot(_ctx.$slots, `field-${subItem.field}`, {
                                                key: 0,
                                                model: $setup.localModel,
                                                item: subItem,
                                                handleUpdate: $setup.handleUpdate
                                              }) : subItem.render ? (_openBlock(), _createElementBlock(
                                                _Fragment,
                                                { key: 1 },
                                                [
                                                  _createCommentVNode(" render \u51FD\u6570 "),
                                                  (_openBlock(), _createBlock(_resolveDynamicComponent(() => subItem.render($setup.localModel))))
                                                ],
                                                64
                                                /* STABLE_FRAGMENT */
                                              )) : subItem.component ? (_openBlock(), _createElementBlock(
                                                _Fragment,
                                                { key: 2 },
                                                [
                                                  _createCommentVNode(" \u9ED8\u8BA4\u7EC4\u4EF6\u6E32\u67D3 "),
                                                  (_openBlock(), _createBlock(_resolveDynamicComponent($setup.getComponent(subItem.component)), _mergeProps({ ref_for: true }, $setup.resolveProps(subItem), {
                                                    "model-value": $setup.get($setup.localModel, subItem.field),
                                                    "onUpdate:modelValue": (val) => $setup.handleUpdate(subItem.field, val)
                                                  }), _createSlots({
                                                    _: 2
                                                    /* DYNAMIC */
                                                  }, [
                                                    _renderList(subItem.slots, (slotContent, slotName) => {
                                                      return {
                                                        name: slotName,
                                                        fn: _withCtx((slotProps) => [
                                                          String(slotName) !== "label" ? (_openBlock(), _createBlock(
                                                            _resolveDynamicComponent(slotContent),
                                                            _mergeProps({
                                                              key: 0,
                                                              ref_for: true
                                                            }, slotProps),
                                            ...
                                            !_ctx.$slots[`field-${subItem.field}`] && (((_a2 = subItem.slots) == null ? void 0 : _a2.label) || _ctx.$slots[`label-${subItem.field}`]) ? {
                                              name: "label",
                                              fn: _withCtx(() => [
                                                _renderSlot(_ctx.$slots, `label-${subItem.field}`, {
                                                  model: $setup.localModel,
                                                  item: subItem
                                                }, () => {
                                                  var _a3;
                                                  return [
                                                    (_openBlock(), _createBlock(_resolveDynamicComponent((_a3 = subItem.slots) == null ? void 0 : _a3.label), {
                                                      model: $setup.localModel,
                                                      field: subItem.field
                                                    }, null, 8, ["model", "field"]))
                                                  ];
                                                }),
                                                subItem.tooltip ? (_openBlock(), _createElementBlock("span", {
                                                  key: 0,
                                          ...
                                          ]), 1040, ["label", "prop", "required", "rules"])
                                        ],
                                        64
                                        /* STABLE_FRAGMENT */
                                      ))
                  ...
                  { key: 1 },
                  [
                    _createCommentVNode(" ===== \u9876\u5C42\u666E\u901A\u9879\u6E32\u67D3 ===== "),
                    !$setup.isItemHidden(item) ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 0,
                        class: _normalizeClass(["yh-form-col", item.col ? `yh-form-col--${item.col}` : "yh-form-col--24"])
                      },
                      [
                        _createCommentVNode(" \u5206\u9694\u7EBF\u7C7B\u578B "),
                        item.type === "divider" ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
                            class: _normalizeClass($setup.ns.e("divider"))
                          ...
                          2
                          /* CLASS */
                        )) : item.type === "text" ? (_openBlock(), _createElementBlock(
                          _Fragment,
                          { key: 1 },
                          [
                            _createCommentVNode(" \u7EAF\u6587\u672C\u5C55\u793A "),
                            _createVNode($setup["YhFormItem"], _mergeProps({
                              label: item.label
                            }, { ref_for: true }, item.formItemProps), {
                              default: _withCtx(() => [
                                _createElementVNode(
                                  "span",
                                  {
                                  ...
                                  _toDisplayString($setup.getEmptyValue(item)),
                                  3
                                  /* TEXT, CLASS */
                                )
                              ]),
                          ...
                          64
                          /* STABLE_FRAGMENT */
                        )) : item.type === "list" ? (_openBlock(), _createElementBlock(
                          _Fragment,
                          { key: 2 },
                          [
                                  ...
                                  _createElementVNode(
                                    ...
                                    [
                                      (_openBlock(true), _createElementBlock(
                                        _Fragment,
                                        null,
                                        _renderList($setup.get($setup.localModel, item.field) || [], (row, rowIdx) => {
                                          var _a3;
                                          return _openBlock(), _createElementBlock(
                                            "div",
                                            {
                                              key: rowIdx,
                                              class: _normalizeClass($setup.ns.e("list-row"))
                                            },
                                            [
                                              _createElementVNode("div", _hoisted_7, [
                                                (_openBlock(true), _createElementBlock(
                                                  _Fragment,
                                                  null,
                                                  _renderList(item.listSchema, (sub) => {
                                                    return _openBlock(), _createElementBlock(
                                                      "div",
                                                      {
                                                        key: sub.field,
                                                        class: _normalizeClass(["yh-form-col", sub.col ? `yh-form-col--${sub.col}` : "yh-form-col--24"])
                                                      },
                                                      [
                                                        _createVNode($setup["YhFormItem"], {
                                                          label: sub.label,
                                                          prop: `${item.field}.${rowIdx}.${sub.field}`,
                                                          required: $setup.resolveRequired(sub),
                                                          rules: $setup.resolveRules(sub)
                                                        }, {
                                                          default: _withCtx(() => [
                                                            sub.component ? (_openBlock(), _createBlock(_resolveDynamicComponent($setup.getComponent(sub.component)), _mergeProps({
                                                              key: 0,
                                                              ref_for: true
                                                            }, $setup.resolveProps(sub), {
                                                              "model-value": row[sub.field],
                                                              "onUpdate:modelValue": (val) => $setup.handleUpdate(`${item.field}.${rowIdx}.${sub.field}`, val)
                                                            }), null, 16, ["model-value", "onUpdate:modelValue"])) : _renderSlot(_ctx.$slots, `field-${item.field}-${sub.field}`, {
                                                              key: 1,
                                                              row,
                                                              index: rowIdx,
                                                              item: sub
                                              ...
                                              _createVNode($setup["YhButton"], {
                                                type: "danger",
                                                text: "",
                                                class: _normalizeClass($setup.ns.e("list-delete")),
                                                disabled: ((_a3 = item.listProps) == null ? void 0 : _a3.min) !== void 0 && ($setup.get($setup.localModel, item.field) || []).length <= item.listProps.min,
                                                onClick: ($event) => $setup.handleDeleteListItem(item, rowIdx)
                                              }, {
                                                default: _withCtx(() => {
                                                  var _a4;
                                                  return [
                                                    _createTextVNode(
                                                      _toDisplayString(((_a4 = item.listProps) == null ? void 0 : _a4.addButtonText) ? "\u5220\u9664" : "\u5220\u9664"),
                                                      1
                                                      /* TEXT */
                                                    )
                                                  ];
                                      ...
                                      _createVNode($setup["YhButton"], {
                                        class: _normalizeClass($setup.ns.e("list-add")),
                                        disabled: ((_a2 = item.listProps) == null ? void 0 : _a2.max) !== void 0 && ($setup.get($setup.localModel, item.field) || []).length >= item.listProps.max,
                                        onClick: ($event) => $setup.handleAddListItem(item)
                                      }, {
                                        default: _withCtx(() => {
                                          var _a3, _b;
                                          return [
                                            _createTextVNode(
                                              " + " + _toDisplayString((_b = (_a3 = item.listProps) == null ? void 0 : _a3.addButtonText) != null ? _b : "\u6DFB\u52A0\u4E00\u9879"),
                                              1
                                              /* TEXT */
                                            )
                                          ];
                                      ...
                                      _renderSlot(_ctx.$slots, `list-footer-${item.field}`, {
                                        model: $setup.localModel,
                                        item
                                      })
                                    ],
                          ...
                          [
                            _createCommentVNode(" \u666E\u901A\u5B57\u6BB5 "),
                            _createVNode($setup["YhFormItem"], _mergeProps({ ref_for: true }, item.formItemProps, {
                              label: item.label,
                              prop: item.field,
                              ...
                              default: _withCtx(() => [
                                _ctx.$slots[`field-${item.field}`] ? _renderSlot(_ctx.$slots, `field-${item.field}`, {
                                  key: 0,
                                  model: $setup.localModel,
                                  item,
                                  handleUpdate: $setup.handleUpdate
                                }) : item.render ? (_openBlock(), _createElementBlock(
                                  _Fragment,
                                  { key: 1 },
                                  [
                                    _createCommentVNode(" render \u51FD\u6570 "),
                                    (_openBlock(), _createBlock(_resolveDynamicComponent(() => item.render($setup.localModel))))
                                  ],
                                  64
                                  /* STABLE_FRAGMENT */
                                )) : item.component ? (_openBlock(), _createElementBlock(
                                  _Fragment,
                                  { key: 2 },
                                  [
                                    _createCommentVNode(" \u9ED8\u8BA4\u7EC4\u4EF6\u6E32\u67D3 "),
                                    (_openBlock(), _createBlock(_resolveDynamicComponent($setup.getComponent(item.component)), _mergeProps({ ref_for: true }, $setup.resolveProps(item), {
                                      "model-value": $setup.get($setup.localModel, item.field),
                                      "onUpdate:modelValue": (val) => $setup.handleUpdate(item.field, val)
                                    }), _createSlots({
                                      _: 2
                                      /* DYNAMIC */
                                    }, [
                                      _renderList(item.slots, (slotContent, slotName) => {
                                        return {
                                          name: slotName,
                                          fn: _withCtx((slotProps) => [
                                            String(slotName) !== "label" ? (_openBlock(), _createBlock(
                              ...
                              !_ctx.$slots[`field-${item.field}`] && (((_a = item.slots) == null ? void 0 : _a.label) || _ctx.$slots[`label-${item.field}`]) ? {
                                name: "label",
                                fn: _withCtx(() => [
                                  _renderSlot(_ctx.$slots, `label-${item.field}`, {
                                    model: $setup.localModel,
                                    item
                                  }, () => {
                                    var _a2;
                                    return [
                                      (_openBlock(), _createBlock(_resolveDynamicComponent((_a2 = item.slots) == null ? void 0 : _a2.label), {
                                        model: $setup.localModel,
                                        field: item.field
                                      }, null, 8, ["model", "field"]))
                                    ];
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const handleAddListItem = (item) => {
      ...
      const newItem = {};
      (_c = item.listSchema) == null ? void 0 : _c.forEach((sub) => {
    ...
    const __returned__ = { props, emit, ns, formRef, localModel, isGroup, getGroupTitle, getGroupProps, isGroupCollapsible, getGroupItems, optionMap, collapsedMap, loadingMap, initDefaultValues, initAsyncOptions, toggleCollapse, resolveProps, resolveRequired, resolveRules, getComponent, isItemHidden, getEmptyValue, handleAddListItem, handleDeleteListItem, handleUpdate, handleSubmit, footerFormRef, ref, watch, reactive, toRaw, YhForm, YhFormItem, YhButton, get formSchemaProps() {
