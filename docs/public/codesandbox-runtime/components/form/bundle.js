...
// public/codesandbox-runtime/components/form/src/form.js
import { renderSlot as _renderSlot, withModifiers as _withModifiers, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, openBlock as _openBlock, createElementBlock as _createElementBlock } from "vue";
...
// public/codesandbox-runtime/components/form/src/form-meta.js
var formProps = {
  /**
   * 表单数据对象
   */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "form",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.m(_ctx.layout), $setup.ns.m(_ctx.size), $setup.ns.m(`label-${_ctx.labelPosition}`)]),
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const validate = async (propsToValidateOrCb = [], callback) => {
      ...
      const propList = Array.isArray(propsToValidate) ? propsToValidate : propsToValidate ? [propsToValidate] : [];
      const fieldsToValidate = propList.length > 0 ? fields.filter((field) => propList.includes(field.prop)) : fields;
    ...
    const resetFields = (props2 = []) => {
      ...
      const fieldsToReset = propsToReset.length > 0 ? fields.filter((field) => propsToReset.includes(field.prop)) : fields;
    ...
    const context = reactive(__spreadProps(__spreadValues2({}, toRefs(props)), {
      addField,
      removeField
    }));
    ...
    const __returned__ = { props, emit, ns, themeStyle, fields, addField, removeField, validate, resetFields, clearValidate, scrollToField, context, provide: provide2, reactive, toRefs, computed: computed11, get formProps() {
      return formProps;
    }, get FormContextKey() {
