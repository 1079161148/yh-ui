  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      _createElementVNode(
        "div",
        {
          class: _normalizeClass([$setup.ns.b(), $setup.sizeClass, $setup.isHorizontalAudio && $setup.ns.is("horizontal-audio")]),
          style: _normalizeStyle($setup.themeStyle),
          onClick: $setup.handleClick
        },
        [
          _createCommentVNode(" \u56FE\u7247\u7C7B\u578B\uFF1A\u52A0\u8F7D\u65F6\u663E\u793A\u6A21\u7CCA\u56FE\uFF0C\u52A0\u8F7D\u5B8C\u6210\u540E\u8FC7\u6E21\u4E3A\u6E05\u6670 "),
          $setup.showImagePreview ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
              class: _normalizeClass([$setup.ns.e("image-wrapper"), $setup.ns.is("image-loading", _ctx.loading)])
            },
            [
              ...
              }, _ctx.imageProps), null, 16, _hoisted_1),
              ...
              _ctx.mask ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 1,
            ...
            2
            /* CLASS */
          )) : $setup.showVideoPreview ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 1 },
            [
              _createCommentVNode(" \u89C6\u9891\u7C7B\u578B\uFF1A\u4E0E Ant Design X \u4E00\u81F4\uFF0C\u4F7F\u7528\u539F\u751F <video> \u53EF\u76F4\u63A5\u64AD\u653E\uFF1B\u6709 src \u65F6\u5C55\u793A\u64AD\u653E\u5668 "),
              _createElementVNode(
                "div",
                {
                ...
                [
                  _ctx.src ? (_openBlock(), _createElementBlock("video", _mergeProps({
                    key: 0,
                    src: _ctx.src,
                    ...
                    preload: "metadata",
                    playsinline: ""
                  }, _ctx.videoProps), null, 16, _hoisted_2)) : (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 1,
                      class: _normalizeClass([$setup.ns.e("media-placeholder"), $setup.ns.e("media-placeholder--video")])
                    },
                    [
              ...
              _createElementVNode(
                ...
                [
                  ...
                  _ctx.byte !== void 0 ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
            ...
            64
            /* STABLE_FRAGMENT */
          )) : $setup.showAudioPreview ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 2 },
            [
              _createCommentVNode(" \u97F3\u9891\u7C7B\u578B\uFF1A\u6709 src \u65F6\u4F7F\u7528\u6A2A\u5411\u5E03\u5C40\uFF08\u5DE6\u56FE\u6807 + \u53F3\u5185\u5BB9 + \u64AD\u653E\u6761\uFF09\uFF0C\u65E0 src \u65F6\u65B9\u5F62\u5360\u4F4D\u5361\u7247 "),
              _createCommentVNode(" \u6709 src\uFF1A\u7EB5\u5411\u5E03\u5C40\uFF08\u9876\u90E8\u6587\u4EF6\u4FE1\u606F\u884C + \u5E95\u90E8\u5168\u5BBD\u64AD\u653E\u5668\uFF09 "),
              _ctx.src ? (_openBlock(), _createElementBlock(
                ...
                [
                  ...
                  _createElementVNode("audio", _mergeProps({
                    src: _ctx.src,
                    class: $setup.ns.e("media-audio"),
                    controls: ""
                  }, _ctx.audioProps), null, 16, _hoisted_3),
                  _ctx.loading ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
                ...
                { key: 1 },
                [
                  _createCommentVNode(" \u65E0 src\uFF1A\u65B9\u5F62\u5360\u4F4D\u5361\u7247\uFF08\u4E0E\u4E4B\u524D\u4E00\u81F4\uFF09 "),
                  _createElementVNode(
                    "div",
                    {
                      class: _normalizeClass($setup.ns.e("image-wrapper"))
                    ...
                    [
                      _createElementVNode(
                        "div",
                        {
                          class: _normalizeClass([$setup.ns.e("media-placeholder"), $setup.ns.e("media-placeholder--audio")])
                        },
                        [
                          _createVNode($setup["YhIcon"], {
                            name: $setup.fileIcon,
            ...
            [
              ...
              _createElementVNode(
                ...
                [
                  ...
                  _ctx.loading ? (_openBlock(), _createBlock($setup["YhSpin"], { key: 0 })) : (_openBlock(), _createElementBlock(
                    _Fragment,
                    { key: 1 },
                    [
          ...
          _ctx.mask && !$setup.showImagePreview ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 4,
          ...
          _createCommentVNode(" \u6269\u5C55\u63D2\u69FD\uFF08\u7528\u4E8E AiAttachments \u4F20\u5165\u7684\u5220\u9664\u6309\u94AE\u3001\u8FDB\u5EA6\u6761\u7B49\uFF09 "),
          _createElementVNode(
            "div",
            {
      ...
      $setup.showImagePreview && $setup.imageViewerVisible ? (_openBlock(), _createBlock($setup["YhImageViewer"], {
        key: 0,
        "url-list": [_ctx.src || ""],
        onClose: _cache[0] || (_cache[0] = ($event) => $setup.imageViewerVisible = false)
      }, null, 8, ["url-list"])) : _createCommentVNode("v-if", true)
    ],
    64
    /* STABLE_FRAGMENT */
  );
...
import { YhImageViewer } from "../../image/index.js";
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, imageViewerVisible, themeStyle, formatFileSize, iconMap, fileIcon, showImagePreview, showVideoPreview, showAudioPreview, isHorizontalAudio, audioThumbIconSize, nameRef, showNameTooltip, updateNameTooltip, scheduleUpdate, get resizeObserver() {
      ...
      resizeObserver = v;
    }, sizeClass, handleClick, computed, ref, onMounted, onUnmounted, nextTick, watch, get useNamespace() {
      return useNamespace;
