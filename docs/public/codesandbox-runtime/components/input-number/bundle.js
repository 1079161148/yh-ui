...
import { renderSlot as _renderSlot, createElementVNode as _createElementVNode, openBlock as _openBlock, createElementBlock as _createElementBlock, normalizeClass as _normalizeClass, createCommentVNode as _createCommentVNode, toDisplayString as _toDisplayString, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock, withModifiers as _withModifiers, normalizeStyle as _normalizeStyle } from "vue";
import { computed as computed11, ref as ref12, useSlots, nextTick } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      $props.controls && $props.controlsPosition !== "right" ? (_openBlock(), _createElementBlock(
        "span",
        {
          key: 0,
          class: _normalizeClass([$setup.ns.e("decrease"), $setup.ns.is("disabled", $setup.minDisabled || $setup.mergedDisabled)]),
      ...
      $props.controls && $props.controlsPosition !== "right" ? (_openBlock(), _createElementBlock(
        ...
        {
          key: 1,
          class: _normalizeClass([$setup.ns.e("increase"), $setup.ns.is("disabled", $setup.maxDisabled || $setup.mergedDisabled)]),
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const userInput = ref12(null);
    const validationError = ref12("");
    const { form, formItem, validate: triggerValidate } = useFormItem();
    const { globalSize } = useConfig();
    const mergedDisabled = computed11(() => props.disabled || (form == null ? void 0 : form.disabled) || false);
    const mergedSize = computed11(
      () => props.size || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalSize.value || "default"
    );
    const numPrecision = computed11(() => {
    ...
    const minDisabled = computed11(() => props.modelValue !== void 0 && props.modelValue <= props.min);
    const maxDisabled = computed11(() => props.modelValue !== void 0 && props.modelValue >= props.max);
    ...
    const hasPrefix = computed11(() => !!props.prefix || !!props.prefixIcon || !!slots.prefix);
    const hasSuffix = computed11(
      () => !!props.suffix || !!props.suffixIcon || !!slots.suffix || showClear.value
    );
    const inputNumberClasses = computed11(() => [
      ns.b(),
