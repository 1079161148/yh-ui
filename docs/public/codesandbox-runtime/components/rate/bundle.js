...
// public/codesandbox-runtime/components/rate/src/rate.js
import { renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, renderSlot as _renderSlot, createCommentVNode as _createCommentVNode, createElementVNode as _createElementVNode, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, toDisplayString as _toDisplayString } from "vue";
import { computed as computed11, ref as ref12, watch as watch4 } from "vue";
...
// public/codesandbox-runtime/components/rate/src/rate-meta.js
var rateProps = {
  modelValue: {
    type: Number,
    default: 0
...
// public/codesandbox-runtime/components/rate/src/rate.js
var _hoisted_1 = ["onMousemove", "onClick"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "div",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.m($setup.actualSize), $setup.ns.is("disabled", _ctx.disabled)]),
    ...
    [
      (_openBlock(true), _createElementBlock(
        ...
        _renderList(_ctx.max, (item) => {
          return _openBlock(), _createElementBlock("div", {
            key: item,
            class: _normalizeClass([$setup.ns.e("item"), $setup.ns.is("hover", $setup.hoverIndex === item)]),
            ...
            _renderSlot(_ctx.$slots, "icon", {
              ...
              _createCommentVNode(" \u586B\u5145\u5C42\uFF1A\u91D1\u8272\u661F\u661F\uFF08\u5E26\u88C1\u526A\uFF09 "),
              _createElementVNode(
                "div",
                {
      ...
      _ctx.showScore || _ctx.showText ? (_openBlock(), _createElementBlock(
        "span",
        {
          key: 0,
...
var starPath = "M512 747.52l-228.16 119.84 43.52-254.08L142.08 434.24l255.04-37.12L512 166.08l114.88 231.04 255.04 37.12-184.64 179.2 43.52 254.08z";
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const currentValue = ref12(props.modelValue);
    const hoverIndex = ref12(-1);
    const isPointerAtLeftHalf = ref12(props.modelValue !== Math.floor(props.modelValue));
    watch4(
      () => props.modelValue,
      (val) => {
    ...
    const voidColorValue = computed11(() => props.disabled ? props.disabledVoidColor : props.voidColor);
    ...
    const rateText = computed11(() => {
      if (props.showScore) return props.scoreTemplate.replace("{value}", String(currentValue.value));
      if (props.showText) {
        const texts6 = props.texts.length > 0 ? props.texts : tRaw("rate.texts");
        return texts6[Math.ceil(currentValue.value) - 1] || "";
      }
      return "";
    });
    const actualSize = computed11(() => props.size || globalSize.value || "default");
    const iconSize = computed11(() => ({ large: 24, default: 20, small: 16 })[actualSize.value] || 20);
    const __returned__ = { props, emit, ns, tRaw, themeStyle, globalSize, currentValue, hoverIndex, isPointerAtLeftHalf, activeColor, voidColorValue, getStarWidth, handleMouseMove, handleMouseLeave, handleItemClick, rateText, actualSize, iconSize, starPath, computed: computed11, ref: ref12, watch: watch4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useConfig() {
