...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, tRaw, themeStyle, globalSize, currentValue, hoverIndex, isPointerAtLeftHalf, activeColor, voidColorValue, getStarWidth, handleMouseMove, handleMouseLeave, handleItemClick, rateText, actualSize, iconSize, starPath, computed, ref, watch, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useConfig() {
