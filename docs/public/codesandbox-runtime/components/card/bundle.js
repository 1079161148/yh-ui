// public/codesandbox-runtime/components/card/src/card.js
    ...
    [
      ...
      $props.loading ? (_openBlock(), _createElementBlock(
        ...
        [
          ...
          _ctx.$slots.header || $props.header || _ctx.$slots.extra ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, globalSize, themeStyle, cardClasses, headerClasses, bodyClasses, footerClasses, computed: computed3, get useNamespace() {
      return useNamespace;
    }, get useConfig() {
      return useConfig;
