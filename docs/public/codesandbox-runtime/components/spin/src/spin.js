...
import { spinProps, spinEmits } from "./spin-meta.js";
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const gradientStops = computed(() => {
      ...
      if (typeof color === "string") {
        ...
        const matchedColors = (_a = color.match(colorRegex)) == null ? void 0 : _a.filter((c) => !/gradient|deg|to|top|bottom|left|right/i.test(c));
    ...
    const __returned__ = { props, ns, t, gradientId, themeStyle, emit, internalVisible, visible, get timer() {
      ...
      timer = v;
    }, handleShow, handleHide, sizePx, isGradient, gradientStops, spinStyle, spinClasses, ref, watch, computed, useSlots, useId, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
