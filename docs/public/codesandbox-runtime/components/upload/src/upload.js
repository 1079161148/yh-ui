...
import { createCommentVNode as _createCommentVNode, withModifiers as _withModifiers, mergeProps as _mergeProps, createElementVNode as _createElementVNode, renderSlot as _renderSlot, normalizeClass as _normalizeClass, createVNode as _createVNode, openBlock as _openBlock, createElementBlock as _createElementBlock, Fragment as _Fragment, renderList as _renderList, normalizeStyle as _normalizeStyle, createBlock as _createBlock, toDisplayString as _toDisplayString, TransitionGroup as _TransitionGroup, withCtx as _withCtx } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      _createCommentVNode(" Hidden Input moved to top for better focus/click reliability in some browsers "),
      ...
      _createElementVNode(
        ...
        [
          ...
          _ctx.drag ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
            ...
            { key: 1 },
            [
              _createCommentVNode(" If trigger slot exists, it always gets the click handler "),
              _ctx.$slots.trigger ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                2
                /* CLASS */
              )) : _ctx.listType === "picture-card" ? (_openBlock(), _createElementBlock(
                _Fragment,
                { key: 1 },
                [
                  _createCommentVNode(" If picture-card and no trigger slot, use the plus button trigger "),
                  _createElementVNode(
                    "div",
                    {
                      class: _normalizeClass($setup.ns.e("trigger")),
          ...
          _ctx.$slots.tip ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 2,
          ...
          _createCommentVNode(" If trigger slot is used, the default slot can be used for other elements like submit buttons "),
          _ctx.$slots.trigger ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 3,
      ...
      _ctx.showFileList ? (_openBlock(), _createBlock(_TransitionGroup, {
        key: 0,
        name: "yh-list",
        tag: "ul",
                ...
                [
                  _renderSlot(_ctx.$slots, "file", { file }, () => [
                    ...
                    _ctx.listType === "picture-card" ? (_openBlock(), _createElementBlock(
                      ...
                      [
                        file.url ? (_openBlock(), _createElementBlock("img", {
                          key: 0,
                          src: file.url,
                          alt: file.name,
                          crossorigin: _ctx.crossorigin
                        }, null, 8, _hoisted_3)) : _createCommentVNode("v-if", true),
                        _createElementVNode(
                          "div",
                          {
                          ...
                          [
                            ...
                            _ctx.showDownload ? (_openBlock(), _createElementBlock("span", {
                              key: 0,
                            ...
                            !_ctx.disabled ? (_openBlock(), _createElementBlock("span", {
                              key: 1,
                            ...
                            ], 8, _hoisted_6)) : _createCommentVNode("v-if", true)
                          ],
                          2
                          /* CLASS */
                        ),
                      ...
                      [
                        ...
                        _createElementVNode(
                          ...
                          [
                            _ctx.listType === "picture" ? (_openBlock(), _createElementBlock(
                              "div",
                              {
                                key: 0,
                              ...
                              [
                                file.url ? (_openBlock(), _createElementBlock("img", {
                                  ...
                                  crossorigin: _ctx.crossorigin
                                }, null, 10, _hoisted_7)) : (_openBlock(), _createBlock($setup["YhIcon"], {
                                  key: 1,
                                  name: "image",
                                  size: 24,
                            ...
                            _createElementVNode(
                              ...
                              [
                                file.status === "success" ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                  key: 0,
                                  name: "check",
                                  size: 14,
                                ...
                                file.status === "fail" ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                  key: 1,
                                  name: "error",
                                  size: 14,
                                  class: _normalizeClass($setup.ns.e("status-icon")),
                                ...
                                !_ctx.disabled ? (_openBlock(), _createElementBlock(
                                  "div",
                                  {
                                    key: 2,
                                  ...
                                  [
                                    _ctx.showDownload ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                      key: 0,
                                      name: "download",
                                      size: 16,
                            ...
                            _createCommentVNode(" Full width bottom progress for non-card modes "),
                            file.status === "uploading" ? (_openBlock(), _createElementBlock(
                              "div",
                              {
                                key: 1,
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, inputRef, dragOver, get viewer() {
      ...
      viewer = v;
    }, triggerInput, getFileIcon, onInputChange, onDragOver, onDrop, attrAccept, handleFiles, startUpload, ajaxUpload, handleRemove, handlePreview, handleDownload, ref, onBeforeUnmount, computed, get uploadProps() {
      return uploadProps;
    }, get uploadEmits() {
      return uploadEmits;
    }, get useNamespace() {
