...
import { createCommentVNode as _createCommentVNode2, withModifiers as _withModifiers, mergeProps as _mergeProps2, createElementVNode as _createElementVNode, renderSlot as _renderSlot2, normalizeClass as _normalizeClass, createVNode as _createVNode, openBlock as _openBlock2, createElementBlock as _createElementBlock2, Fragment as _Fragment2, renderList as _renderList, normalizeStyle as _normalizeStyle, createBlock as _createBlock2, toDisplayString as _toDisplayString, TransitionGroup as _TransitionGroup, withCtx as _withCtx } from "vue";
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    "div",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.m(_ctx.listType), $setup.ns.m(`pos-${_ctx.triggerPosition}`), {
        [$setup.ns.is("disabled")]: _ctx.disabled
      }]),
      style: _normalizeStyle($setup.themeStyle)
    },
    [
      _createCommentVNode2(" Hidden Input moved to top for better focus/click reliability in some browsers "),
      _createElementVNode("input", _mergeProps2({
        ref: "inputRef",
        type: "file",
      ...
      _createElementVNode(
        ...
        [
          ...
          _ctx.drag ? (_openBlock2(), _createElementBlock2(
            "div",
            {
              key: 0,
              class: _normalizeClass([$setup.ns.e("dragger"), {
              ...
              onDragleave: _cache[1] || (_cache[1] = _withModifiers(($event) => $setup.dragOver = false, ["prevent"])),
            ...
            { key: 1 },
            [
              _createCommentVNode2(" If trigger slot exists, it always gets the click handler "),
              _ctx.$slots.trigger ? (_openBlock2(), _createElementBlock2(
                "div",
                {
                  key: 0,
                ...
                2
                /* CLASS */
              )) : _ctx.listType === "picture-card" ? (_openBlock2(), _createElementBlock2(
                _Fragment2,
                { key: 1 },
                [
                  _createCommentVNode2(" If picture-card and no trigger slot, use the plus button trigger "),
                  _createElementVNode(
                    "div",
                    {
                      class: _normalizeClass($setup.ns.e("trigger")),
          ...
          _ctx.$slots.tip ? (_openBlock2(), _createElementBlock2(
            "div",
            {
              key: 2,
          ...
          _createCommentVNode2(" If trigger slot is used, the default slot can be used for other elements like submit buttons "),
          _ctx.$slots.trigger ? (_openBlock2(), _createElementBlock2(
            "div",
            {
              key: 3,
      ...
      _ctx.showFileList ? (_openBlock2(), _createBlock2(_TransitionGroup, {
        key: 0,
        name: "yh-list",
        tag: "ul",
                ...
                [
                  _renderSlot2(_ctx.$slots, "file", { file }, () => [
                    ...
                    _ctx.listType === "picture-card" ? (_openBlock2(), _createElementBlock2(
                      ...
                      [
                        file.url ? (_openBlock2(), _createElementBlock2("img", {
                          key: 0,
                          src: file.url,
                          alt: file.name,
                          crossorigin: _ctx.crossorigin
                        }, null, 8, _hoisted_3)) : _createCommentVNode2("v-if", true),
                        _createElementVNode(
                          "div",
                          {
                          ...
                          [
                            _createElementVNode("span", {
                              onClick: _withModifiers(($event) => $setup.handlePreview(file), ["stop"])
                            }, [
                              _createVNode($setup["YhIcon"], {
                                name: "eye",
                                size: 18
                            ...
                            _ctx.showDownload ? (_openBlock2(), _createElementBlock2("span", {
                              key: 0,
                              onClick: _withModifiers(($event) => $setup.handleDownload(file), ["stop"])
                            }, [
                              _createVNode($setup["YhIcon"], {
                                name: "download",
                                size: 18
                              })
                            ], 8, _hoisted_5)) : _createCommentVNode2("v-if", true),
                            !_ctx.disabled ? (_openBlock2(), _createElementBlock2("span", {
                              key: 1,
                              onClick: _withModifiers(($event) => $setup.handleRemove(file), ["stop"])
                            }, [
                              _createVNode($setup["YhIcon"], {
                                name: "delete",
                                size: 18
                              })
                            ], 8, _hoisted_6)) : _createCommentVNode2("v-if", true)
                          ],
                          2
                          /* CLASS */
                        ),
                        _createCommentVNode2(" Progress Bar overlay "),
                        file.status === "uploading" ? (_openBlock2(), _createElementBlock2(
                          "div",
                          {
                            key: 1,
                            class: _normalizeClass($setup.ns.e("progress-overlay"))
                          },
                          [
                            _createElementVNode(
                              "div",
                      ...
                      [
                        ...
                        _createElementVNode(
                          ...
                          [
                            _ctx.listType === "picture" ? (_openBlock2(), _createElementBlock2(
                              "div",
                              {
                                key: 0,
                                class: _normalizeClass($setup.ns.e("thumbnail-box"))
                              },
                              [
                                file.url ? (_openBlock2(), _createElementBlock2("img", {
                                  key: 0,
                                  src: file.url,
                                  class: _normalizeClass($setup.ns.e("thumbnail-img")),
                                  crossorigin: _ctx.crossorigin
                                }, null, 10, _hoisted_7)) : (_openBlock2(), _createBlock2($setup["YhIcon"], {
                                  key: 1,
                                  name: "image",
                                  size: 24,
                                  class: _normalizeClass($setup.ns.e("thumbnail-icon"))
                                }, null, 8, ["class"]))
                              ],
                              2
                              /* CLASS */
                            ...
                            _createElementVNode(
                              ...
                              [
                                ...
                                }, _toDisplayString(file.name), 11, _hoisted_8)
                              ],
                              2
                              /* CLASS */
                            ),
                            _createElementVNode(
                              "div",
                              {
                                class: _normalizeClass($setup.ns.e("status-icon-wrapper"))
                              },
                              [
                                file.status === "success" ? (_openBlock2(), _createBlock2($setup["YhIcon"], {
                                  key: 0,
                                  name: "check",
                                  size: 14,
                                  class: _normalizeClass($setup.ns.e("status-icon")),
                                  color: "var(--yh-color-success)"
                                }, null, 8, ["class"])) : _createCommentVNode2("v-if", true),
                                file.status === "fail" ? (_openBlock2(), _createBlock2($setup["YhIcon"], {
                                  key: 1,
                                  name: "error",
                                  size: 14,
                                  class: _normalizeClass($setup.ns.e("status-icon")),
                                ...
                                !_ctx.disabled ? (_openBlock2(), _createElementBlock2(
                                  "div",
                                  {
                                    key: 2,
                                    class: _normalizeClass($setup.ns.e("actions-inline"))
                                  },
                                  [
                                    _ctx.showDownload ? (_openBlock2(), _createBlock2($setup["YhIcon"], {
                                      key: 0,
                                      name: "download",
                                      size: 16,
                                      class: _normalizeClass($setup.ns.e("download-btn")),
                                      onClick: _withModifiers(($event) => $setup.handleDownload(file), ["stop"])
                                    }, null, 8, ["class", "onClick"])) : _createCommentVNode2("v-if", true),
                                    file.status === "fail" ? (_openBlock2(), _createBlock2($setup["YhIcon"], {
                                      key: 1,
                                      name: "refresh",
                                      size: 16,
                                      class: _normalizeClass($setup.ns.e("retry-btn")),
                                      onClick: _withModifiers(($event) => $setup.startUpload(file), ["stop"])
                                    }, null, 8, ["class", "onClick"])) : _createCommentVNode2("v-if", true),
                                    _createVNode($setup["YhIcon"], {
                                      name: "delete",
                                      size: 16,
                            ...
                            _createCommentVNode2(" Full width bottom progress for non-card modes "),
                            file.status === "uploading" ? (_openBlock2(), _createElementBlock2(
                              "div",
                              {
                                key: 1,
                                class: _normalizeClass($setup.ns.e("bottom-progress"))
                              },
                              [
                                _createElementVNode(
                                  "div",
                                  {
                                    class: _normalizeClass($setup.ns.e("bottom-progress-bar")),
                                    style: _normalizeStyle({
                                      width: (file.percentage || 0) + "%"
                                    })
                                  },
        ...
        _: 3
        /* FORWARDED */
      }, 8, ["class"])) : _createCommentVNode2("v-if", true)
    ],
    6
    /* CLASS, STYLE */
  );
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const handlePreview = (file) => {
      ...
      if (isImage) {
        ...
        const nextViewer = new stdin_default4(container, {
          hidden: () => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, inputRef, dragOver, get viewer() {
      return viewer;
    }, set viewer(v) {
      viewer = v;
    }, triggerInput, getFileIcon, onInputChange, onDragOver, onDrop, attrAccept, handleFiles, startUpload, ajaxUpload, handleRemove, handlePreview, handleDownload, ref: ref12, onBeforeUnmount: onBeforeUnmount2, computed: computed12, get uploadProps() {
      return uploadProps;
    }, get uploadEmits() {
      return uploadEmits;
    }, get useNamespace() {
