...
import { createCommentVNode as _createCommentVNode, renderSlot as _renderSlot, normalizeClass as _normalizeClass, openBlock as _openBlock, createElementBlock as _createElementBlock, toDisplayString as _toDisplayString, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock, normalizeStyle as _normalizeStyle, createElementVNode as _createElementVNode, Fragment as _Fragment, withModifiers as _withModifiers } from "vue";
import { computed as computed11, ref as ref12, watch as watch4, nextTick, useSlots, onMounted as onMounted3 } from "vue";
    ...
    [
      ...
      _createElementVNode(
        ...
        [
          ...
          $setup.isTextarea ? (_openBlock(), _createElementBlock("textarea", {
            key: 1,
            ref: "textareaRef",
          ...
          }, null, 46, _hoisted_1)) : (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 2 },
            [
          ...
          $setup.hasSuffix ? (_openBlock(), _createElementBlock(
            ...
            [
              ...
              $setup.showClear && !$setup.isLoading ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 1,
              ...
              $setup.showPasswordIcon ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 2,
                ...
                [
                  $setup.passwordVisible ? (_openBlock(), _createElementBlock("svg", _hoisted_3, [..._cache[3] || (_cache[3] = [
                    _createElementVNode(
                      "path",
                  ...
                  ])])) : (_openBlock(), _createElementBlock("svg", _hoisted_4, [..._cache[4] || (_cache[4] = [
                    _createElementVNode(
                      "path",
          ...
          _createCommentVNode(" \u5B57\u6570\u7EDF\u8BA1 (\u8F93\u5165\u6846\u5185\u90E8\uFF0C\u4EC5\u9488\u5BF9 type=text) "),
          $setup.showWordLimitCount && !$setup.isTextarea ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 4,
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isComposing = ref12(false);
    const passwordVisible = ref12(false);
    const textareaCalcStyle = ref12({});
    const inputOrTextarea = computed11(() => inputRef.value || textareaRef.value);
    const isTextarea = computed11(() => props.type === "textarea");
    const nativeInputValue = computed11(() => {
    ...
    const showPasswordIcon = computed11(
    ...
    const showWordLimitCount = computed11(
      () => props.showWordLimit && !!props.maxlength && (props.type === "text" || props.type === "textarea") && !props.disabled && !props.readonly
    );
    const inputExceed = computed11(
      () => showWordLimitCount.value && textLength.value > Number(props.maxlength)
    );
    const isLoading = computed11(() => props.loading && !props.disabled);
    const hasPrepend = computed11(() => !!slots.prepend);
    const hasAppend = computed11(() => !!slots.append);
    const hasPrefix = computed11(() => !!slots.prefix || !!props.prefixIcon || !!props.prefix);
    const hasSuffix = computed11(
      () => !!slots.suffix || !!props.suffixIcon || !!props.suffix || showClear.value || showPasswordIcon.value || isLoading.value
    );
    const mergedStatus = computed11(() => {
    ...
    const wrapperStyle = computed11(() => __spreadValues2({}, themeStyle.value));
    const inputClasses = computed11(() => [ns.e("inner"), ns.is("disabled", props.disabled)]);
    const textareaStyle = computed11(() => {
    ...
    const __returned__ = { props, emit, slots, ns, t, inputRef, textareaRef, wrapperRef, form, formItem, triggerValidate, themeStyle, globalSize, inputSize, focused, hovering, isComposing, passwordVisible, textareaCalcStyle, inputOrTextarea, isTextarea, nativeInputValue, showClear, showPasswordIcon, textLength, showWordLimitCount, inputExceed, isLoading, hasPrepend, hasAppend, hasPrefix, hasSuffix, mergedStatus, wrapperClasses, wrapperStyle, inputClasses, textareaStyle, setNativeInputValue, handleInput, handleChange, handleFocus, handleBlur, handleMouseEnter, handleMouseLeave, handleClear, handleKeydown, handleKeyup, handlePasswordToggle, handleCompositionStart, handleCompositionUpdate, handleCompositionEnd, focus, blur, select, clear, resizeTextarea, computed: computed11, ref: ref12, watch: watch4, nextTick, useSlots, onMounted: onMounted3, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useLocale() {
