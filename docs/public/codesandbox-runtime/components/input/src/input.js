...
const _hoisted_1 = ["value", "placeholder", "disabled", "readonly", "maxlength", "minlength", "rows", "name", "id", "tabindex", "autocomplete", "autofocus", "aria-label", "inputmode"];
const _hoisted_2 = ["type", "value", "placeholder", "disabled", "readonly", "maxlength", "minlength", "name", "id", "tabindex", "list", "autocomplete", "autofocus", "aria-label", "inputmode", "aria-invalid", "aria-describedby"];
const _hoisted_3 = {
  key: 0,
  viewBox: "0 0 24 24",
  width: "1em",
          ...
          $setup.isTextarea ? (_openBlock(), _createElementBlock("textarea", {
            ...
            [
              ...
              _createElementVNode("input", {
                ...
                "aria-describedby": $setup.mergedStatus === "error" ? (_a = $setup.formItem) == null ? void 0 : _a.errorId : void 0,
                onInput: $setup.handleInput,
                onChange: $setup.handleChange,
                onFocus: $setup.handleFocus,
                onBlur: $setup.handleBlur,
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, slots, ns, t, inputRef, textareaRef, wrapperRef, form, formItem, triggerValidate, themeStyle, globalSize, inputSize, focused, hovering, isComposing, passwordVisible, textareaCalcStyle, inputOrTextarea, isTextarea, nativeInputValue, showClear, showPasswordIcon, textLength, showWordLimitCount, inputExceed, isLoading, hasPrepend, hasAppend, hasPrefix, hasSuffix, mergedStatus, wrapperClasses, wrapperStyle, inputClasses, textareaStyle, setNativeInputValue, handleInput, handleChange, handleFocus, handleBlur, handleMouseEnter, handleMouseLeave, handleClear, handleKeydown, handleKeyup, handlePasswordToggle, handleCompositionStart, handleCompositionUpdate, handleCompositionEnd, focus, blur, select, clear, resizeTextarea, computed, ref, watch, nextTick, useSlots, onMounted, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useLocale() {
