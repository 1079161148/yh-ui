            ...
            _createElementVNode(
              ...
              [
                ...
                _ctx.clearable && $setup.innerValue.length > 0
                  ? (_openBlock(),
                    _createBlock(
                      ...
                      {
                        icon: _withCtx(() => [_createVNode($setup['YhIcon'], { name: 'clean' })]),
                        _: 1
                        /* STABLE */
                      },
                      8,
                ...
                _renderSlot(
                  ...
                  {
                    disabled:
                      !((_a = $setup.innerValue) == null ? void 0 : _a.trim()) || _ctx.disabled,
                  ...
                  () => {
                    ...
                    return [
                      _createVNode(
                        ...
                        {
                          type:
                            ((_a2 = $setup.innerValue) == null ? void 0 : _a2.trim()) &&
                            !_ctx.disabled &&
                            !_ctx.loading
                              ? 'primary'
                              : 'default',
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const handleKeyDown = (e) => {
        ...
        if (e.key === 'Enter' && !e.shiftKey) {
          if (
            !((_a2 = innerValue.value) == null ? void 0 : _a2.trim()) ||
            props.loading ||
            props.disabled
          ) {
            e.preventDefault()
