...
var useZIndex = (zIndexOverrides) => {
  ...
  const initialZIndex = computed(() => {
    ...
    return (_a3 = override != null ? override : unref2(injectedZIndex)) != null
      ? _a3
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const initViewerJS = () => {
        ...
        const nextViewer = new stdin_default4(
          list,
          __spreadProps2(__spreadValues4({}, props.viewerOptions), {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const initViewerJS = () => {
        ...
        if (props.previewSrcList && props.previewSrcList.length > 0) {
          ...
          const nextViewer = new stdin_default4(
            list,
            __spreadProps3(__spreadValues5({}, props.viewerOptions), {
              hidden: () => {
                if (viewerList) {
                  document.body.removeChild(viewerList)
                  viewerList = null
                    ...
                    _createElementVNode4(
                      'div',
                      {
                        ...
                        style: _normalizeStyle4(
                          $props.teleported
                            ? __spreadValues6(
                                __spreadValues6({}, $setup.themeStyle),
                                $setup.dropdownStyle
                              )
                            : $setup.themeStyle
                        ),
  ...
  { name: 'YhMention' },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const filteredOptions = computed15(() => {
        var _a3, _b
        const keyword =
          (_b = (_a3 = triggerPos.value) == null ? void 0 : _a3.keyword) != null ? _b : ''
      ...
      const handleOutsideClick = (e) => {
        ...
        if (
          ((_a3 = wrapperRef.value) == null ? void 0 : _a3.contains(target)) ||
            ...
            for (const node of nodes) {
              if (node.label.toLowerCase().includes(keyword.toLowerCase())) {
                ...
                if (filteredChildren.length > 0) {
                  result.push(
                    __spreadProps4(__spreadValues7({}, node), { children: filteredChildren })
                  )
                }
              }
            }
            ...
            _createElementVNode6(
              ...
              [
                ...
                _renderSlot6(
                  ...
                  {
                    disabled:
                      !((_a3 = $setup.innerValue) == null ? void 0 : _a3.trim()) || _ctx.disabled,
