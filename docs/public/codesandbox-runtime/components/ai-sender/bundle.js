...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      viewerList = list;
      const nextViewer = new stdin_default5(list, __spreadProps2(__spreadValues4({}, props.viewerOptions), {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      if (props.previewSrcList && props.previewSrcList.length > 0) {
        ...
        document.body.appendChild(list);
        viewerList = list;
        const nextViewer = new stdin_default5(list, __spreadProps3(__spreadValues5({}, props.viewerOptions), {
          hidden: () => {
            if (viewerList) {
              document.body.removeChild(viewerList);
              viewerList = null;
