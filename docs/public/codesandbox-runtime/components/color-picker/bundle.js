...
// public/codesandbox-runtime/components/color-picker/src/color-picker.js
import { createElementVNode as _createElementVNode4, openBlock as _openBlock4, createElementBlock as _createElementBlock4, createCommentVNode as _createCommentVNode, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle4, createVNode as _createVNode, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, createBlock as _createBlock, renderList as _renderList, Fragment as _Fragment, withModifiers as _withModifiers, Transition as _Transition, withCtx as _withCtx, Teleport as _Teleport } from "vue";
import { ref as ref15, computed as computed14, watch as watch4, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2 } from "vue";
...
// public/codesandbox-runtime/components/color-picker/src/color-picker-meta.js
...
// public/codesandbox-runtime/components/color-picker/src/sv-panel.js
import { createElementVNode as _createElementVNode, normalizeStyle as _normalizeStyle, openBlock as _openBlock, createElementBlock as _createElementBlock } from "vue";
import { ref as ref12, computed as computed11 } from "vue";
...
var __sfc__ = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const props = __props;
    const emit = __emit;
    const panelRef = ref12();
    const cursorStyle = computed11(() => ({
      left: `${props.s}%`,
      top: `${100 - props.v}%`
    }));
    const backgroundStyle = computed11(() => ({
    ...
    const handleDrag = (event) => {
      ...
      const clientX = (_a2 = event.clientX) != null ? _a2 : event.touches[0].clientX;
    ...
    const __returned__ = { props, emit, panelRef, cursorStyle, backgroundStyle, handleDrag, handleMouseDown, ref: ref12, computed: computed11 };
...
// public/codesandbox-runtime/components/color-picker/src/hue-slider.js
import { normalizeStyle as _normalizeStyle2, createElementVNode as _createElementVNode2, openBlock as _openBlock2, createElementBlock as _createElementBlock2 } from "vue";
import { ref as ref13, computed as computed12 } from "vue";
    ...
    [
      _createElementVNode2(
        "div",
        {
          ...
          style: _normalizeStyle2($setup.handleStyle)
        },
        null,
        4
        /* STYLE */
...
var __sfc__2 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const props = __props;
    const emit = __emit;
    const sliderRef = ref13();
    const handleStyle = computed12(() => ({
    ...
    const __returned__ = { props, emit, sliderRef, handleStyle, handleDrag, handleMouseDown, ref: ref13, computed: computed12 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
...
// public/codesandbox-runtime/components/color-picker/src/alpha-slider.js
import { normalizeStyle as _normalizeStyle3, createElementVNode as _createElementVNode3, openBlock as _openBlock3, createElementBlock as _createElementBlock3 } from "vue";
import { ref as ref14, computed as computed13 } from "vue";
var _hoisted_1 = { class: "yh-color-alpha-slider" };
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createElementBlock3("div", _hoisted_1, [
    _createElementVNode3(
      "div",
      {
        ref: "sliderRef",
        class: "yh-color-alpha-slider__bar",
        style: _normalizeStyle3($setup.backgroundStyle),
        onMousedown: $setup.handleMouseDown
      },
      null,
      36
    ...
    _createElementVNode3(
      "div",
      {
        ...
        style: _normalizeStyle3($setup.handleStyle)
      },
      null,
      4
      /* STYLE */
...
var __sfc__3 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, sliderRef, backgroundStyle, handleStyle, handleDrag, handleMouseDown, ref: ref14, computed: computed13 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
...
// public/codesandbox-runtime/components/color-picker/src/utils.js
...
var parseColor = (color) => {
  ...
  if (color.startsWith("#")) {
    ...
    return __spreadProps(__spreadValues2({}, hsv), { a: 1 });
  }
  ...
  if (matchRgba) {
    ...
    return __spreadProps(__spreadValues2({}, hsv), { a: matchRgba[4] ? parseFloat(matchRgba[4]) : 1 });
  }
  return { h: 0, s: 100, v: 100, a: 1 };
};
var formatColor = (hsv, format) => {
  const rgb = hsvToRgb(hsv.h, hsv.s, hsv.v);
  if (format === "hex") return rgbToHex(rgb.r, rgb.g, rgb.b);
  if (format === "rgb") {
    return hsv.a < 1 ? `rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, ${hsv.a})` : `rgb(${rgb.r}, ${rgb.g}, ${rgb.b})`;
  }
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createElementBlock4(
    ...
    [
      _createElementVNode4(
        ...
        [
          _createElementVNode4(
            ...
            [
              !_ctx.modelValue ? (_openBlock4(), _createElementBlock4("svg", _hoisted_12, [..._cache[4] || (_cache[4] = [
                _createElementVNode4(
                  "path",
                  {
                    fill: "currentColor",
      ...
      (_openBlock4(), _createBlock(_Teleport, { to: "body" }, [
          ...
          default: _withCtx(() => [
            $setup.visible ? (_openBlock4(), _createElementBlock4(
              "div",
              {
                ...
                style: _normalizeStyle4($setup.popperStyle),
              ...
              [
                _createElementVNode4(
                  ...
                  [
                    _createVNode($setup["SVPanel"], {
                      h: $setup.color.h,
                      s: $setup.color.s,
                      v: $setup.color.v,
                      onUpdate: _cache[0] || (_cache[0] = (s2, v) => {
                        $setup.color.s = s2;
                        $setup.color.v = v;
                        $setup.updateColor();
                      })
                    ...
                    _createElementVNode4(
                      ...
                      [
                        _createVNode($setup["HueSlider"], {
                          h: $setup.color.h,
                          onUpdate: _cache[1] || (_cache[1] = (h2) => {
                            $setup.color.h = h2;
                            $setup.updateColor();
                          })
                        }, null, 8, ["h"]),
                        _ctx.showAlpha ? (_openBlock4(), _createBlock($setup["AlphaSlider"], {
                          key: 0,
                          a: $setup.color.a,
                          color: $setup.baseColor,
                          onUpdate: _cache[2] || (_cache[2] = (a) => {
                            $setup.color.a = a;
                            $setup.updateColor();
                          })
                        }, null, 8, ["a", "color"])) : _createCommentVNode("v-if", true)
                      ],
                      2
                      /* CLASS */
                    )
                ...
                _ctx.predefine.length > 0 ? (_openBlock4(), _createElementBlock4(
                  "div",
                  {
                    key: 0,
                ...
                _createElementVNode4(
                  ...
                  [
                    _createElementVNode4(
                      ...
                      [
                        $setup.isEyeDropperSupported ? (_openBlock4(), _createElementBlock4("div", {
                          key: 0,
                        ...
                        ])], 10, _hoisted_4)) : _createCommentVNode("v-if", true),
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const color = ref15(parseColor(props.modelValue));
    const inputValue = ref15(props.modelValue || "");
    const triggerRef = ref15();
    const popperRef = ref15();
    const rgb = computed14(() => hsvToRgb(color.value.h, color.value.s, color.value.v));
    const baseColor = computed14(() => `hsl(${color.value.h}, 100%, 50%)`);
    const currentColor = computed14(() => formatColor(color.value, props.showAlpha ? "rgb" : "hex"));
    const contrastInfo = computed14(() => {
    ...
    const isEyeDropperSupported = ref15(false);
    onMounted3(() => {
    ...
    watch4(visible, (val) => {
      if (val && triggerRef.value) {
        ...
        popperStyle.value = __spreadProps2(__spreadValues3({}, themeStyle.value), {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, visible, color, inputValue, triggerRef, popperRef, rgb, baseColor, currentColor, contrastInfo, updateColor, handleInputChange, handleConfirm, handleClear, isEyeDropperSupported, handleEyeDropper, togglePopper, handleClickOutside, handlePredefineClick, popperStyle, ref: ref15, computed: computed14, watch: watch4, onMounted: onMounted3, onBeforeUnmount: onBeforeUnmount2, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    ...
    }, SVPanel: stdin_default3, HueSlider: stdin_default4, AlphaSlider: stdin_default5, get parseColor() {
      return parseColor;
    }, get formatColor() {
      return formatColor;
    }, get hsvToRgb() {
