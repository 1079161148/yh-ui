      ...
      _createElementVNode(
        ...
        [
          _createElementVNode(
            ...
            [
              !_ctx.hideIcon ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
          ...
          _createCommentVNode(" YH-UI \u81EA\u521B\u9AD8\u7EA7\u529F\u80FD\uFF1A\u4E0D\u518D\u63D0\u793A "),
          _ctx.showDontAskAgain ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
            ...
            [
              _createVNode($setup["YhCheckbox"], {
                ...
                default: _withCtx(() => [
                  _createTextVNode(
                    _toDisplayString(_ctx.dontAskAgainText || $setup.t("popconfirm.dontAskAgain")),
                    1
                    /* TEXT */
                  )
                ]),
          ...
          _createElementVNode(
            ...
            [
              _createCommentVNode(" \u81EA\u521B\u9AD8\u7EA7\u529F\u80FD\uFF1A\u4EA4\u6362\u6309\u94AE\u4F4D\u7F6E "),
              _ctx.swapButtons ? (_openBlock(), _createElementBlock(
                _Fragment,
                { key: 0 },
                [
                  _createVNode($setup["YhButton"], {
                    ...
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString(_ctx.confirmButtonText || $setup.t("popconfirm.confirm")),
                        1
                        /* TEXT */
                      )
                    ]),
                  ...
                  !_ctx.hideCancel ? (_openBlock(), _createBlock($setup["YhButton"], {
                    key: 0,
                    size: "small",
                    ...
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString(_ctx.cancelButtonText || $setup.t("popconfirm.cancel")),
                        1
                        /* TEXT */
                      )
                    ]),
                    _: 1
                    /* STABLE */
                  }, 8, ["type", "disabled"])) : _createCommentVNode("v-if", true)
                ],
                64
                /* STABLE_FRAGMENT */
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, internalVisible, visible, confirmLoading, dontAskAgainChecked, handleConfirm, handleCancel, ref, computed, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get YhButton() {
