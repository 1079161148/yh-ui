...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createBlock(_resolveDynamicComponent($setup.tagName), {
    ...
    default: _withCtx(() => [
      ...
      ])) : $props.code ? (_openBlock(), _createElementBlock("code", _hoisted_2, [
        _renderSlot(_ctx.$slots, "default")
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhTypographyTitle" }, {
  __name: "title",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, tagName, titleClasses, computed, get useNamespace() {
      return useNamespace;
