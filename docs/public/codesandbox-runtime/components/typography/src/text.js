  ...
  return _openBlock(), _createBlock(_resolveDynamicComponent($props.tag), {
    ...
    default: _withCtx(() => [
      $props.mark ? (_openBlock(), _createElementBlock("mark", _hoisted_1, [
        ...
        _renderSlot(_ctx.$slots, "default")
      ])) : $props.keyboard ? (_openBlock(), _createElementBlock("kbd", _hoisted_3, [
        _renderSlot(_ctx.$slots, "default")
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhTypographyText" }, {
  __name: "text",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, textClasses, computed, get useNamespace() {
      return useNamespace;
