...
import { createCommentVNode as _createCommentVNode, renderSlot as _renderSlot, openBlock as _openBlock, createBlock as _createBlock, createVNode as _createVNode, withCtx as _withCtx, normalizeClass as _normalizeClass, createElementBlock as _createElementBlock, toDisplayString as _toDisplayString, createElementVNode as _createElementVNode, renderList as _renderList, Fragment as _Fragment, normalizeStyle as _normalizeStyle, withModifiers as _withModifiers, Transition as _Transition, Teleport as _Teleport, vModelText as _vModelText, withDirectives as _withDirectives, createTextVNode as _createTextVNode } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _ctx.role !== "system" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          _renderSlot(_ctx.$slots, "avatar", {}, () => [
            _ctx.avatar ? (_openBlock(), _createBlock($setup["YhAvatar"], {
              key: 0,
              src: _ctx.avatar,
              crossorigin: "anonymous"
            }, null, 8, ["src"])) : (_openBlock(), _createBlock($setup["YhAvatar"], { key: 1 }, {
              default: _withCtx(() => [
      ...
      _createElementVNode(
        ...
        [
          ...
          _ctx.$slots.header || _ctx.time ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
          ...
          _createElementVNode(
            ...
            [
              _ctx.loading && !_ctx.content ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 0,
                ...
                [
                  ...
                  _ctx.multimodal && _ctx.multimodal.some((m) => m.type === "image") ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
                    ...
                    [
                      (_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(_ctx.multimodal.filter((m) => m.type === "image"), (img, idx) => {
                          return _openBlock(), _createElementBlock(
                            "div",
                            {
                              key: idx,
                  ...
                  _renderSlot(_ctx.$slots, "default", {}, () => [
                    ...
                    _ctx.markdown ? (_openBlock(), _createElementBlock("div", {
                      key: 0,
                      class: _normalizeClass([$setup.ns.e("text"), $setup.ns.e("markdown")]),
                      innerHTML: $setup.parsedContent,
                      onMouseover: $setup.handleCitationHover,
                      onMouseout: $setup.handleCitationLeave
                    }, null, 42, _hoisted_2)) : (_openBlock(), _createElementBlock(
                      _Fragment,
                      { key: 1 },
                      [
                  ...
                  _ctx.structuredData ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 1,
                    ...
                    [
                      ...
                      _createCommentVNode(" eslint-disable vue/no-v-html "),
                      _ctx.structuredData.type === "json" ? (_openBlock(), _createElementBlock(
                        "div",
                        {
                          key: 0,
                        ...
                        [
                          _createElementVNode("pre", _hoisted_3, [
                            _createElementVNode("code", { innerHTML: $setup.jsonHtml }, null, 8, _hoisted_4)
                          ])
                        ],
                        2
                        /* CLASS */
                      )) : _ctx.structuredData.type === "table" ? (_openBlock(), _createElementBlock(
                        _Fragment,
                        { key: 1 },
                        [
                          _createCommentVNode(" eslint-enable vue/no-v-html "),
                            ...
                            [
                              _createElementVNode("table", null, [
                                _createElementVNode("thead", null, [
                                  _ctx.structuredData.data && _ctx.structuredData.data.headers ? (_openBlock(), _createElementBlock("tr", _hoisted_5, [
                                    (_openBlock(true), _createElementBlock(
                                      _Fragment,
                                      null,
                                      _renderList(_ctx.structuredData.data.headers, (h) => {
                                        return _openBlock(), _createElementBlock(
                                          "th",
                                          { key: h },
                                          _toDisplayString(h),
                                ...
                                _ctx.structuredData.data && typeof _ctx.structuredData.data === "object" ? (_openBlock(), _createElementBlock("tbody", _hoisted_6, [
                                  (_openBlock(true), _createElementBlock(
                                    _Fragment,
                                    null,
                                    _renderList(_ctx.structuredData.data.rows, (row, idx) => {
                                      return _openBlock(), _createElementBlock("tr", { key: idx }, [
                                        (_openBlock(true), _createElementBlock(
                                          _Fragment,
                                          null,
                                          _renderList(row, (cell, cIdx) => {
                                            return _openBlock(), _createElementBlock(
                                              "td",
                                              { key: cIdx },
                        ...
                        2112
                        /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
                      )) : _ctx.structuredData.type === "thought-chain" && _ctx.structuredData.data ? (_openBlock(), _createElementBlock(
                        _Fragment,
                        { key: 2 },
                        [
                          _createCommentVNode(" Thought chain: delegate to AiThoughtChain for consistent style "),
                          _createVNode($setup["YhAiThoughtChain"], {
                        ...
                        [
                          ...
                          _createElementVNode(
                            "div",
                            {
                              class: _normalizeClass([$setup.ns.e("chart-viewer")])
                            },
                            [
                              _createElementVNode(
                                "pre",
                                null,
                                _toDisplayString(JSON.stringify(_ctx.structuredData.data, null, 2)),
                                1
                                /* TEXT */
                              )
                            ],
                        ...
                        _renderList(_ctx.multimodal, (asset, idx) => {
                          ...
                          return _openBlock(), _createElementBlock(
                            ...
                            [
                              ...
                              asset.type === "audio" ? (_openBlock(), _createElementBlock(
                                "div",
                                {
                                  key: 0,
                                  class: _normalizeClass([$setup.ns.e("audio-player"), {
                                ...
                                [
                                  ...
                                  _createElementVNode(
                                    "div",
                                    {
                                      class: _normalizeClass([$setup.ns.e("audio-waveform"), {
                                        "is-active": $setup.playingAsset === asset.url
                                      }])
                                    },
                                    [
                                  ...
                                  _createElementVNode(
                                    "span",
                                    {
                                      class: _normalizeClass($setup.ns.e("audio-duration"))
                                    },
                                    _toDisplayString(((_a = asset.extra) == null ? void 0 : _a.duration) || "0:00"),
                                    3
                                    /* TEXT, CLASS */
                                  )
                                ],
                                2
                                /* CLASS */
                              )) : asset.type === "file" ? (_openBlock(), _createElementBlock(
                                _Fragment,
                                { key: 1 },
                                [
                                  ...
                                  _createElementVNode(
                                    "div",
                                    {
                                      class: _normalizeClass($setup.ns.e("file-card"))
                                    },
                                    [
                                      _createElementVNode(
                                        "div",
                                      ...
                                      _createElementVNode(
                                        "div",
                                        {
                                          class: _normalizeClass($setup.ns.e("file-info"))
                                        },
                                        [
                                          _createElementVNode(
                                            "div",
                                            {
                                              class: _normalizeClass($setup.ns.e("file-name"))
                                            },
                                          ...
                                          _createElementVNode(
                                            "div",
                                            {
                                              class: _normalizeClass($setup.ns.e("file-meta"))
                                            },
                                      ...
                                      _createVNode($setup["YhButton"], {
                                        ...
                                        icon: _withCtx(() => [
                                          _createVNode($setup["YhIcon"], { name: "download" })
                                        ]),
                                        _: 1
                                        /* STABLE */
                                      }, 8, ["onClick"])
                  ...
                  _ctx.citations && _ctx.citations.length > 0 ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 3,
                          ...
                          (_openBlock(true), _createElementBlock(
                            ...
                            _renderList(_ctx.citations, (cite, index) => {
                              return _openBlock(), _createElementBlock("a", {
                                ...
                                title: cite.title,
                                onClick: _withModifiers(($event) => $setup.handleCitationClick(cite), ["prevent"])
                              }, [
                                _createElementVNode(
                                  "span",
                                  {
                                    class: _normalizeClass($setup.ns.e("citation-index"))
                                  },
                                ...
                                _createElementVNode(
                                  "span",
                                  {
                                    class: _normalizeClass($setup.ns.e("citation-text"))
                                  },
                                  _toDisplayString(cite.title),
                                  3
                                  /* TEXT, CLASS */
                                ),
                                cite.url ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                  key: 0,
                                  name: "arrow-right",
                                  class: _normalizeClass($setup.ns.e("citation-link-icon"))
      ...
      (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
        _createVNode(_Transition, { name: "yh-fade-in-scale-up" }, {
          default: _withCtx(() => [
            $setup.hoveredCitation ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
                  ...
                  [
                    _createElementVNode(
                      ...
                      [
                        ...
                        _createElementVNode(
                          "span",
                          null,
                          _toDisplayString($setup.hoveredCitation.source || $setup.hoveredCitation.title),
                          1
                          /* TEXT */
                        )
                      ],
                    ...
                    _createElementVNode(
                      ...
                      [
                        ...
                        $setup.hoveredCitation.abstract ? (_openBlock(), _createElementBlock(
                          "p",
                          _hoisted_8,
                        ...
                        $setup.hoveredCitation.publishTime ? (_openBlock(), _createElementBlock(
                          "span",
                          _hoisted_9,
      ...
      (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
        _createVNode(_Transition, { name: "yh-fade-in" }, {
          default: _withCtx(() => [
            $setup.editingCodeBlock ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              ...
              _createElementVNode("div", _hoisted_10, [
                ...
                _createElementVNode("div", _hoisted_12, [
                  ...
                  !$setup.monaco ? _withDirectives((_openBlock(), _createElementBlock(
                    "textarea",
                    {
                      key: 0,
                ...
                _createElementVNode("div", _hoisted_14, [
                  _createVNode($setup["YhButton"], { onClick: $setup.cancelEditCode }, {
...
import {
  aiBubbleProps
} from "./ai-bubble-meta.js";
import { YhAvatar } from "../../avatar/index.js";
import { YhButton } from "../../button/index.js";
import { YhIcon } from "../../icon/index.js";
import { YhAiThoughtChain } from "../../ai-thought-chain/index.js";
      ...
      if (props.onRunCode) {
        try {
          ...
          if (result && Symbol.asyncIterator in result) {
            ...
            try {
              for (var iter = __forAwait(asyncResult), more, temp, error; more = !(temp = await iter.next()).done; more = false) {
  ...
  `;
    ...
    const handleCitationHover = (e) => {
      ...
      if (target && target.classList && target.classList.contains("yh-ai-citation")) {
        ...
        const citation = (_a = props.citations) == null ? void 0 : _a.find(
          (c) => String(c.id) === id
        );
        if (citation) {
    ...
    const getMarkdownInstance = () => {
      ...
      const md = new MarkdownIt({
        ...
        highlight: function(str, lang) {
          ...
          const shouldCollapse = (codeBlockOptions == null ? void 0 : codeBlockOptions.collapsible) && lineCount > ((_a2 = codeBlockOptions == null ? void 0 : codeBlockOptions.collapseLinesThreshold) != null ? _a2 : 10);
    ...
    const __returned__ = { props, ns, t, themeStyle, playingAsset, get audioInstance() {
      ...
      audioInstance = v;
    }, handleAudioToggle, handleDownload, escapeHtml, getFileIcon, _mermaidContainer, mermaidLoading, mermaidError, get mermaidModule() {
      return mermaidModule;
    }, set mermaidModule(v) {
      mermaidModule = v;
    ...
    }, computed, ref, onBeforeUnmount, watchEffect, shallowRef, watch, onMounted, nextTick, get aiBubbleProps() {
