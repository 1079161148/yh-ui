...
// public/codesandbox-runtime/components/image-magnifier/src/image-magnifier.js
import { createCommentVNode as _createCommentVNode, renderSlot as _renderSlot, normalizeClass as _normalizeClass, createElementVNode as _createElementVNode, openBlock as _openBlock, createElementBlock as _createElementBlock, normalizeStyle as _normalizeStyle, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, renderList as _renderList, Fragment as _Fragment, withModifiers as _withModifiers, Teleport as _Teleport, createBlock as _createBlock } from "vue";
import { ref as ref12, computed as computed11, reactive, watch as watch4, onUnmounted as onUnmounted4, nextTick } from "vue";
...
// public/codesandbox-runtime/components/image-magnifier/src/image-magnifier-meta.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      _createCommentVNode(" \u4E3B\u56FE\u533A\u57DF\uFF1A\u70B9\u51FB\u5168\u5C4F\u7ED1\u5B9A\u5728 wrapper \u4E0A\uFF0C\u907F\u514D img pointer-events:none \u5403\u6389\u4E8B\u4EF6 "),
      _createElementVNode(
        "div",
        {
          class: _normalizeClass([$setup.ns.e("image-wrapper"), $setup.ns.is("bordered", $setup.props.border), $setup.ns.is("shadow", $setup.props.shadow)]),
        ...
        [
          ...
          $setup.visible && $setup.isHdLoading ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
          ...
          $setup.visible && $setup.resolvedPosition !== "inside" ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 1,
              class: _normalizeClass([$setup.ns.e("mask"), $setup.ns.is($setup.props.maskShape)]),
          ...
          $setup.visible && $setup.resolvedPosition === "inside" ? (_openBlock(), _createElementBlock(
            ...
            [
              ...
              $setup.props.showMinimap ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
          ...
          !$setup.visible && $setup.props.title ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 3,
      ...
      $setup.galleryImages.length > 1 ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
          ...
          (_openBlock(true), _createElementBlock(
            ...
            _renderList($setup.galleryImages, (img, idx) => {
              return _openBlock(), _createElementBlock("button", {
                key: idx,
                class: _normalizeClass([$setup.ns.e("gallery-item"), $setup.ns.is("active", idx === $setup.currentIndex)]),
                onClick: ($event) => $setup.switchImage(idx),
                type: "button",
                "aria-label": $setup.getSwitchToImageLabel(idx)
              }, [
                _createElementVNode("img", {
                  src: img.src,
                  alt: img.alt || $setup.getGalleryItemAlt(idx)
                }, null, 8, _hoisted_7)
              ], 10, _hoisted_6);
            }),
            128
      ...
      _createCommentVNode(" \u5F53\u524D\u500D\u7387\u663E\u793A (wheelZoom \u5F00\u542F\u65F6) "),
      $setup.props.wheelZoom && $setup.visible ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 2,
      ...
      _createCommentVNode(" \u5168\u5C4F\u5F39\u5C42\uFF1AEsc \u901A\u8FC7 document \u7EA7\u76D1\u542C\u5904\u7406\uFF0C\u4E0D\u4F9D\u8D56\u5143\u7D20\u7126\u70B9 "),
      (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
        $setup.fullscreenVisible ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            ...
            _createElementVNode(
              ...
              [
                _createElementVNode("button", {
                  ...
                  type: "button",
                  "aria-label": $setup.fullscreenCloseLabel
                }, [
                ...
                _createElementVNode(
                  ...
                  [
                    _renderSlot(_ctx.$slots, "fullscreen", {
                      src: $setup.currentZoomSrc,
                      alt: $setup.currentAlt
                    }, () => [
                      _createElementVNode("img", {
                  ...
                  [
                    (_openBlock(true), _createElementBlock(
                      ...
                      _renderList($setup.galleryImages, (img, idx) => {
                        return _openBlock(), _createElementBlock("button", {
                          key: idx,
                          class: _normalizeClass([$setup.ns.e("fullscreen-thumb"), $setup.ns.is("active", idx === $setup.currentIndex)]),
                          onClick: ($event) => $setup.switchImage(idx),
                          type: "button"
                        }, [
                          _createElementVNode("img", {
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhImageMagnifier" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const currentIndex = ref12(props.modelValue);
    watch4(
      () => props.modelValue,
      (val) => {
    ...
    const galleryImages = computed11(() => {
      if (props.images.length > 0) return props.images;
      return [{ src: props.src, zoomSrc: props.zoomSrc, alt: props.alt }];
    });
    const currentImage = computed11(
      () => {
        var _a2;
        return (_a2 = galleryImages.value[currentIndex.value]) != null ? _a2 : galleryImages.value[0];
      }
    );
    const currentSrc = computed11(() => currentImage.value.src);
    const currentZoomSrc = computed11(() => currentImage.value.zoomSrc || currentImage.value.src);
    const currentAlt = computed11(() => currentImage.value.alt || props.alt);
    ...
    const fullscreenCloseLabel = computed11(() => t("imagemagnifier.close"));
    const switchImage = (index) => {
      currentIndex.value = index;
      emit("update:modelValue", index);
      emit("image-change", index);
    };
    const isHdLoaded = ref12(false);
    const isHdLoading = ref12(false);
    ...
    const currentScale = ref12(props.scale);
    watch4(
      () => props.scale,
      (val) => {
    ...
    const resolvedPosition = ref12("right");
    ...
    const addWheelListener = () => {
      var _a2;
      (_a2 = containerRef.value) == null ? void 0 : _a2.addEventListener("wheel", handleWheel, { passive: false });
    };
    const removeWheelListener = () => {
      var _a2;
      (_a2 = containerRef.value) == null ? void 0 : _a2.removeEventListener("wheel", handleWheel);
    };
    watch4(containerRef, (el) => {
      if (el) {
        nextTick(addWheelListener);
      }
    });
    const previewStyle = computed11(() => {
      ...
      return __spreadValues2(__spreadValues2(__spreadProps(__spreadValues2({}, base), {
        top: "0",
        width: `${props.maskWidth * currentScale.value}px`,
        height: `${props.maskHeight * currentScale.value}px`
      }), resolvedPosition.value === "right" ? { left: `calc(100% + ${props.offset}px)` } : {}), resolvedPosition.value === "left" ? { right: `calc(100% + ${props.offset}px)` } : {});
    });
    const largeImageStyle = computed11(() => {
      var _a2, _b, _c, _d;
      const w = (_b = (_a2 = containerRef.value) == null ? void 0 : _a2.offsetWidth) != null ? _b : 0;
      const h2 = (_d = (_c = containerRef.value) == null ? void 0 : _c.offsetHeight) != null ? _d : 0;
      return {
        width: `${w * currentScale.value}px`,
        height: `${h2 * currentScale.value}px`,
    ...
    const minimapIndicatorStyle = computed11(() => {
      if (!containerRef.value) return {};
    ...
    const fullscreenVisible = ref12(false);
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, rootStyle, currentIndex, galleryImages, currentImage, currentSrc, currentZoomSrc, currentAlt, getSwitchToImageLabel, getGalleryItemAlt, fullscreenCloseLabel, switchImage, isHdLoaded, isHdLoading, preloadHdImage, visible, maskPos, largePos, containerRef, currentScale, resolvedPosition, computeSmartPosition, handleMouseEnter, handleMouseLeave, handleMouseMove, handleWheel, addWheelListener, removeWheelListener, previewStyle, largeImageStyle, maskStyle, minimapIndicatorStyle, fullscreenVisible, openFullscreen, closeFullscreen, handleFullscreenKeydown, ref: ref12, computed: computed11, reactive, watch: watch4, onUnmounted: onUnmounted4, nextTick, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
