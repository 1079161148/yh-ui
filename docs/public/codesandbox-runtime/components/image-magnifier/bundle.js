  ...
  { name: 'YhImageMagnifier' },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const currentImage = computed11(() => {
        var _a2
        return (_a2 = galleryImages.value[currentIndex.value]) != null
          ? _a2
      ...
      const getSwitchToImageLabel = (index) =>
      ...
      const addWheelListener = () => {
        var _a2
        ;(_a2 = containerRef.value) == null
          ? void 0
          : _a2.addEventListener('wheel', handleWheel, { passive: false })
      }
      ...
      const largeImageStyle = computed11(() => {
        var _a2, _b, _c, _d
        const w =
          (_b = (_a2 = containerRef.value) == null ? void 0 : _a2.offsetWidth) != null ? _b : 0
        const h =
