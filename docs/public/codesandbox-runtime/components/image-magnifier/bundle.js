...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhImageMagnifier" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const addWheelListener = () => {
      var _a;
      (_a = containerRef.value) == null ? void 0 : _a.addEventListener("wheel", handleWheel, { passive: false });
    };
    ...
    const largeImageStyle = computed2(() => {
      var _a, _b, _c, _d;
      const w = (_b = (_a = containerRef.value) == null ? void 0 : _a.offsetWidth) != null ? _b : 0;
    ...
    const __returned__ = { props, emit, ns, themeStyle, rootStyle, currentIndex, galleryImages, currentImage, currentSrc, currentZoomSrc, currentAlt, switchImage, isHdLoaded, isHdLoading, preloadHdImage, visible, maskPos, largePos, containerRef, currentScale, resolvedPosition, computeSmartPosition, handleMouseEnter, handleMouseLeave, handleMouseMove, handleWheel, addWheelListener, removeWheelListener, previewStyle, largeImageStyle, maskStyle, minimapIndicatorStyle, fullscreenVisible, openFullscreen, closeFullscreen, handleFullscreenKeydown, ref: ref2, computed: computed2, reactive, watch, onUnmounted, nextTick, get useNamespace() {
      return useNamespace;
