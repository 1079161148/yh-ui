// public/codesandbox-runtime/components/empty/src/empty.js
      ...
      _createElementVNode(
        ...
        [
          _renderSlot(_ctx.$slots, "image", {}, () => [
            $props.image ? (_openBlock(), _createElementBlock("img", {
              key: 0,
              src: $props.image,
              alt: $setup.description,
              style: _normalizeStyle($setup.imageStyle)
            }, null, 12, _hoisted_1)) : $props.icon ? (_openBlock(), _createBlock(_resolveDynamicComponent($props.icon), {
              key: 1,
              style: _normalizeStyle($setup.imageStyle)
            }, null, 8, ["style"])) : (_openBlock(), _createElementBlock(
              _Fragment,
              { key: 2 },
              [
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhEmpty" }, {
  __name: "empty",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { t } = useLocale();
    const props = __props;
    const description = computed11(() => props.description || t("empty.description"));
    const ns = useNamespace("empty");
    const { themeStyle } = useComponentTheme("empty", computed11(() => props.themeOverrides));
    const imageStyle = computed11(() => ({
      width: `${props.imageSize}px`,
      height: `${props.imageSize}px`
    }));
    const __returned__ = { t, props, description, ns, themeStyle, imageStyle, computed: computed11, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
