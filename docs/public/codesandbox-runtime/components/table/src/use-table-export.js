...
function useTableExport(data, columns) {
  ...
  function toTXT(config = {}) {
    return toCSV(__spreadProps(__spreadValues({}, config), { separator: "	", bom: config.bom !== false }));
  }
  ...
  function toXLSX(config = {}) {
    ...
    headers.forEach((h, i) => {
      ...
      if ((col == null ? void 0 : col.prop) && ((_a = config.columnWidths) == null ? void 0 : _a[col.prop])) {
