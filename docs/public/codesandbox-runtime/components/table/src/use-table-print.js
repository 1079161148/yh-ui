...
function useTablePrint(data, columns) {
  ...
  async function print(config = {}) {
    ...
    ;(_a = config.afterPrint) == null ? void 0 : _a.call(config)
  }
  async function printMultiple(tables, globalConfig = {}) {
    ...
    tables.forEach((table, tIdx) => {
      const cfg = __spreadValues(__spreadValues({}, globalConfig), table.config)
    ...
    ;(_a = globalConfig.afterPrint) == null ? void 0 : _a.call(globalConfig)
  }
