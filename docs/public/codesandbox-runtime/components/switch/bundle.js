...
// public/codesandbox-runtime/components/switch/src/switch.js
...
// public/codesandbox-runtime/components/switch/src/switch-meta.js
var switchProps = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock("div", {
    ...
    !$setup.props.inlinePrompt && ($setup.props.inactiveIcon || $setup.props.inactiveText) ? (_openBlock(), _createElementBlock(
      "span",
      {
        key: 0,
        class: _normalizeClass([$setup.ns.e("label"), $setup.ns.e("label--left"), $setup.ns.is("active", !$setup.isChecked)])
      },
      [
        _renderSlot(_ctx.$slots, "inactive", {}, () => [
          $setup.props.inactiveIcon ? (_openBlock(), _createBlock(_resolveDynamicComponent($setup.props.inactiveIcon), {
            key: 0,
            class: _normalizeClass($setup.ns.e("icon"))
          }, null, 8, ["class"])) : $setup.props.inactiveText ? (_openBlock(), _createElementBlock(
            "span",
            _hoisted_3,
    ...
    _createElementVNode(
      ...
      [
        ...
        $setup.props.inlinePrompt ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          [
            $setup.isChecked ? _renderSlot(_ctx.$slots, "active", { key: 0 }, () => [
              $setup.props.activeIcon ? (_openBlock(), _createBlock(_resolveDynamicComponent($setup.props.activeIcon), {
                key: 0,
                class: _normalizeClass($setup.ns.e("icon"))
              }, null, 8, ["class"])) : $setup.props.activeText ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 1,
        ...
        _createElementVNode(
          ...
          [
            ...
            $setup.props.loading ? (_openBlock(), _createElementBlock(
              "svg",
              {
                key: 0,
              ...
              [
                ...
                $setup.isChecked ? _renderSlot(_ctx.$slots, "active-action", { key: 0 }, () => [
                  $setup.props.activeActionIcon ? (_openBlock(), _createBlock(_resolveDynamicComponent($setup.props.activeActionIcon), { key: 0 })) : _createCommentVNode("v-if", true)
                ]) : _renderSlot(_ctx.$slots, "inactive-action", { key: 1 }, () => [
                  $setup.props.inactiveActionIcon ? (_openBlock(), _createBlock(_resolveDynamicComponent($setup.props.inactiveActionIcon), { key: 0 })) : _createCommentVNode("v-if", true)
                ])
              ],
              64
              /* STABLE_FRAGMENT */
    ...
    !$setup.props.inlinePrompt && ($setup.props.activeIcon || $setup.props.activeText) ? (_openBlock(), _createElementBlock(
      "span",
      {
        key: 1,
        class: _normalizeClass([$setup.ns.e("label"), $setup.ns.e("label--right"), $setup.ns.is("active", $setup.isChecked)])
      },
      [
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const switchStyle = computed11(() => __spreadProps(__spreadValues2({}, themeStyle.value), {
    ...
    const __returned__ = { props, emit, ns, form, validate, themeStyle, globalSize, inputRef, isChecked, isDisabled, isInteractive, actualWidth, handleClick, handleChange, updateValue, focus, switchStyle, switchClass, coreStyle, computed: computed11, ref: ref12, nextTick, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useConfig() {
