...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const switchStyle = computed(() => __spreadProps(__spreadValues({}, themeStyle.value), {
    ...
    const __returned__ = { props, emit, ns, form, validate, themeStyle, globalSize, inputRef, isChecked, isDisabled, isInteractive, actualWidth, handleClick, handleChange, updateValue, focus, switchStyle, switchClass, coreStyle, computed, ref, nextTick, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useConfig() {
