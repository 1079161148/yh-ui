// docs/public/codesandbox-runtime/components/carousel/src/carousel.js
import {
...
// docs/public/codesandbox-runtime/components/carousel/src/carousel-meta.js
var carouselProps = {
  /** 当前展示索引 */
  currentIndex: {
    type: Number,
...
var CAROUSEL_INJECTION_KEY = Symbol('YhCarousel')
    ...
    _createElementBlock(
      'div',
      {
        ...
        class: _normalizeClass([
          $setup.ns.b(),
          $setup.ns.m($setup.props.direction),
          $setup.ns.m($setup.props.effect),
          {
      ...
      [
        ...
        _createElementVNode(
          'div',
          {
            class: _normalizeClass([
              $setup.ns.e('slides'),
              $setup.ns.is('vertical', $setup.props.direction === 'vertical')
            ]),
        ...
        $setup.props.showDots && $setup.itemCount > 0
          ? _renderSlot(
              _ctx.$slots,
              'dots',
              {
              ...
              () => [
                _createElementVNode(
                  'div',
                  {
                    class: _normalizeClass([
                      $setup.ns.e('dots'),
                      $setup.ns.em('dots', $setup.effectiveDotPlacement),
                      $setup.ns.em('dots', $setup.props.dotType)
                    ])
                  },
                  [
                    (_openBlock(true),
                        ...
                        return (
                          ...
                          _createElementBlock(
                            'div',
                            {
                              key: i,
                              class: _normalizeClass([
                                $setup.ns.e('dots-item'),
                                $setup.ns.is('active', $setup.internalIndex === i - 1)
                              ]),
        ...
        $setup.props.showArrow !== 'never' && $setup.itemCount > 1
          ? _renderSlot(
              _ctx.$slots,
              'arrow',
              {
              ...
              () => [
                _createElementVNode(
                  'div',
                  {
                    class: _normalizeClass([
                      $setup.ns.e('arrow'),
                      $setup.ns.em('arrow', 'prev'),
                      $setup.ns.is(
                        'visible',
                        $setup.props.showArrow === 'always' ||
                          ($setup.props.showArrow === 'hover' && $setup.isHovering)
                      ),
                      $setup.ns.is('vertical', $setup.props.direction === 'vertical')
                    ]),
...
var __sfc__ = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const internalIndex = shallowRef3(props.defaultIndex)
      const prevIndex = shallowRef3(-1)
      const isHovering = shallowRef3(false)
      let itemIdCounter = 0
      const _getStableId = () => `yh-carousel-item-${itemIdCounter++}`
      const itemMap = /* @__PURE__ */ new Map()
      const itemIds = ref12([])
      const itemCount = computed11(() => itemIds.value.length)
      let rafId = null
      const timer = shallowRef3(null)
      const containerRef = shallowRef3(null)
      ...
      const effectiveDotPlacement = computed11(() => props.dotPlacement)
      const dotsAtClass = computed11(() => {
      ...
      provide2(
        ...
        markRaw({
          props,
          itemCount: shallowRef3(itemCount.value),
          // 保持响应但浅层
          currentIndex: internalIndex,
          prevIndex,
          direction: computed11(() => props.direction),
          effect: computed11(() => props.effect),
          shouldRenderItem,
          // 新增：判断是否渲染
          addItem: (id) => {
