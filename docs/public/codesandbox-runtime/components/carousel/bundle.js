...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, _slots, ns, t, themeStyle, internalIndex, prevIndex, isHovering, get itemIdCounter() {
      ...
      wheelRaf = v;
    }, handleWheel, handleDotTrigger, getCurrentIndex, effectiveDotPlacement, dotsAtClass, ref: ref12, computed: computed11, onMounted: onMounted3, onUnmounted: onUnmounted4, watch: watch4, provide: provide2, useSlots, shallowRef: shallowRef3, markRaw, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
