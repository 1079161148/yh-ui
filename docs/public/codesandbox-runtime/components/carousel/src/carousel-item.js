...
import { renderSlot as _renderSlot, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, openBlock as _openBlock, createElementBlock as _createElementBlock, createCommentVNode as _createCommentVNode, createElementVNode as _createElementVNode, Fragment as _Fragment } from "vue";
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.isVisible ? (_openBlock(), _createElementBlock(
    "div",
    {
      key: 0,
    ...
    { key: 1 },
    [
      _createCommentVNode(" \u4E0D\u6E32\u67D3\u65F6\u4F5C\u4E3A\u5360\u4F4D\u7B26\u4FDD\u6301 DOM \u7ED3\u6784 "),
      _createElementVNode(
        "div",
        {
          class: _normalizeClass($setup.itemClasses),
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const active = computed(() => (carouselContext == null ? void 0 : carouselContext.currentIndex.value) === index.value);
    const itemClasses = computed(() => [
      ns.b(),
      (carouselContext == null ? void 0 : carouselContext.effect.value) && ns.is(carouselContext.effect.value),
    ...
    const itemStyle = computed(() => {
      ...
      if (maskEffects.includes(effect.value)) {
        ...
        if (effect.value === "radial") {
          return __spreadProps(__spreadValues({}, baseStyle), { clipPath: `circle(${isTop ? 150 : 0}% at center)` });
        } else if (effect.value === "wave") {
          return __spreadProps(__spreadValues({}, baseStyle), {
            WebkitMaskImage: "linear-gradient(135deg, black 25%, transparent 25%, transparent 50%, black 50%, black 75%, transparent 75%, transparent)",
            maskImage: "linear-gradient(135deg, black 25%, transparent 25%, transparent 50%, black 50%, black 75%, transparent 75%, transparent)",
          ...
          return __spreadProps(__spreadValues({}, baseStyle), {
            WebkitMaskImage: "repeating-linear-gradient(45deg, black 0%, black 5%, transparent 5%, transparent 10%)",
            maskImage: "repeating-linear-gradient(45deg, black 0%, black 5%, transparent 5%, transparent 10%)",
            WebkitMaskSize: "200% 200%",
            maskSize: "200% 200%",
            WebkitMaskPosition: `${isTop ? "0% 0%" : "100% 100%"}`,
            maskPosition: `${isTop ? "0% 0%" : "100% 100%"}`
      ...
      switch (effect.value) {
        ...
        case "cube": {
          ...
          opacity = inStage ? 1 : 0;
          transform = isActive ? `translateZ(${translateZ}px) rotateY(${-rotateY}deg) translateZ(-${translateZ}px)` : `translateZ(${translateZ}px) rotateY(${rotateY}deg) translateZ(-${translateZ}px)`;
          break;
        }
        case "flip": {
    ...
    const __returned__ = { _props, _attrs, ns, carouselContext, index, isVisible, active, itemClasses, itemStyle, get itemId() {
      return itemId;
    }, set itemId(v) {
      itemId = v;
    }, computed, inject, onMounted, onUnmounted, shallowRef, useAttrs, nextTick, get useNamespace() {
      return useNamespace;
