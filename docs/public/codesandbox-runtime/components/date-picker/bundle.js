// docs/public/codesandbox-runtime/components/date-picker/src/date-picker.js
import {
...
// docs/public/codesandbox-runtime/components/date-picker/src/date-table.js
import {
...
// docs/public/codesandbox-runtime/components/dayjs.js
import * as dayjsModule2 from 'dayjs'
var _a2
var dayjs2 =
  'default' in dayjsModule2
    ? (_a2 = dayjsModule2.default) != null
      ? _a2
      : dayjsModule2
    : dayjsModule2
var stdin_default2 = dayjs2

// docs/public/codesandbox-runtime/components/date-picker/src/panel-utils.js
...
stdin_default2.extend(isBetweenPlugin)
stdin_default2.extend(weekOfYearPlugin)
stdin_default2.extend(isoWeekPlugin)
stdin_default2.extend(quarterOfYearPlugin)
stdin_default2.extend(advancedFormatPlugin)
stdin_default2.extend(customParseFormatPlugin)
var DEFAULT_FORMATS = {
  date: 'YYYY-MM-DD',
                                          ...
                                          _createElementBlock(
                                            'span',
                                            {
                                              ...
                                              class: _normalizeClass([
                                                ...
                                                (_a3 = $setup.getCellExtra(cell.date)) == null
                                                  ? void 0
                                                  : _a3.className
                                              ])
                                            },
...
// docs/public/codesandbox-runtime/components/date-picker/src/month-table.js
import {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getCellClasses = (month) => {
      ...
      if (props.rangeState) {
        ...
        const end = to
          ? stdin_default2(to).startOf('month')
          : hovering
            ? stdin_default2(hovering).startOf('month')
            : null
...
// docs/public/codesandbox-runtime/components/date-picker/src/year-table.js
import {
            ...
            return (
              ...
              _createElementBlock3(
                'div',
                {
                  ...
                  onMouseenter: ($event) =>
                    $setup.emit('hover', $setup.dayjs().year(year).startOf('year').toDate())
                },
                [
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getCellClasses = (year) => {
      ...
      if (props.rangeState) {
        ...
        const end = to
          ? stdin_default2(to).startOf('year')
          : hovering
            ? stdin_default2(hovering).startOf('year')
            : null
...
// docs/public/codesandbox-runtime/components/date-picker/src/quarter-table.js
import {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getCellClasses = (quarter) => {
      ...
      const isSelected = (val) => {
        ...
        const d = stdin_default2(val)
        return (
          d.year() === stdin_default2(props.date).year() &&
          Math.floor(d.month() / 3) === quarter - 1
        )
      }
      if (props.selectedDate && !Array.isArray(props.selectedDate)) {
        if (isSelected(props.selectedDate)) {
      ...
      if (props.rangeState) {
        ...
        const start = from
          ? stdin_default2(from)
              .startOf('month')
              .month(Math.floor(stdin_default2(from).month() / 3) * 3)
          : null
        const end = to
          ? stdin_default2(to)
              .startOf('month')
              .month(Math.floor(stdin_default2(to).month() / 3) * 3)
          : hovering
            ? stdin_default2(hovering)
                .startOf('month')
                .month(Math.floor(stdin_default2(hovering).month() / 3) * 3)
            : null
...
// docs/public/codesandbox-runtime/components/date-picker/src/date-picker-meta.js
var datePickerProps = {
  /** 绑定值 */
  modelValue: {
  ...
  return (
    ...
    _createElementBlock5(
      ...
      [
            ...
            _createElementBlock5(
              ...
              [
                _createElementVNode5(
                  ...
                  [
                    _renderSlot2(_ctx.$slots, 'prefix-icon', {}, () => [
                      _ctx.prefixIcon
                        ? (_openBlock5(),
                          _createBlock(_resolveDynamicComponent(_ctx.prefixIcon), { key: 0 }))
                        : (_openBlock5(),
                          _createElementBlock5('svg', _hoisted_15, [
                            ...(_cache[12] ||
                              (_cache[12] = [
                                _createElementVNode5(
                                  'path',
                  ...
                  ? (_openBlock5(),
                    _createElementBlock5(
                      'input',
                      {
                        ...
                        placeholder:
                          (_a3 = _ctx.placeholder) != null
                            ? _a3
                            : $setup.t('datepicker.selectDate'),
                      ...
                      [
                        _createElementVNode5(
                          'input',
                          {
                            ...
                            placeholder:
                              (_b = _ctx.startPlaceholder) != null
                                ? _b
                                : $setup.t('datepicker.startDate'),
                        ...
                        _createElementVNode5(
                          'input',
                          {
                            class: _normalizeClass5($setup.ns.e('range-input')),
                            placeholder:
                              (_c = _ctx.endPlaceholder) != null
                                ? _c
                                : $setup.t('datepicker.endDate'),
                ...
                _createElementVNode5(
                  ...
                  [
                    _ctx.clearable && _ctx.modelValue && $setup.hovering && !_ctx.disabled
                      ? (_openBlock5(),
                        _createElementBlock5(
                          'span',
                          {
                          ...
                          [
                            _renderSlot2(_ctx.$slots, 'clear-icon', {}, () => [
                              _ctx.clearIcon
                                ? (_openBlock5(),
                                  _createBlock(_resolveDynamicComponent(_ctx.clearIcon), {
                                    key: 0
                                  }))
                                : (_openBlock5(),
                                  _createElementBlock5('svg', _hoisted_5, [
                                    ...(_cache[13] ||
                                      (_cache[13] = [
                                        _createElementVNode5(
                                          'path',
        ...
        (_openBlock5(),
        _createBlock(
          _resolveDynamicComponent(_ctx.panelOnly ? 'div' : 'Teleport'),
          {
            to: 'body',
                        ...
                        _createElementBlock5(
                          'div',
                          {
                            ...
                            class: _normalizeClass5([
                              $setup.ns.e('panel'),
                              _ctx.popperClass,
                              $setup.ns.is('plain', _ctx.panelOnly)
                            ]),
                            style: _normalizeStyle(
                              !_ctx.panelOnly && _ctx.teleported ? $setup.dropdownStyle : {}
                            ),
                                ...
                                _createElementVNode5(
                                  ...
                                  [
                                    _createElementVNode5(
                                      ...
                                      {
                                        class: _normalizeClass5([
                                          $setup.ns.e('header-btns'),
                                          $setup.ns.em('header-btns', 'double-left')
                                        ]),
                                        onClick:
                                          _cache[0] || (_cache[0] = ($event) => $setup.moveYear(-1))
                                      },
                                      ' \xAB ',
                                      2
                                      /* CLASS */
                                    ),
                                    $setup.currentView === 'date'
                                      ? (_openBlock5(),
                                        _createElementBlock5(
                                          'button',
                                          {
                                            ...
                                            class: _normalizeClass5([
                                              $setup.ns.e('header-btns'),
                                              $setup.ns.em('header-btns', 'left')
                                            ]),
                                            onClick:
                                              _cache[1] ||
                                              (_cache[1] = ($event) => $setup.moveMonth(-1))
                                          },
                                          ' \u2039 ',
                                          2
                                          /* CLASS */
                                  ...
                                  [
                                      ...
                                      ? (_openBlock5(),
                                        _createElementBlock5(
                                          'button',
                                          {
                                            ...
                                            class: _normalizeClass5([
                                              $setup.ns.e('header-btns'),
                                              $setup.ns.em('header-btns', 'right')
                                            ]),
                                            onClick:
                                              _cache[2] ||
                                              (_cache[2] = ($event) => $setup.moveMonth(1))
                                          },
                                          ' \u203A ',
                                          2
                                          /* CLASS */
                                    ...
                                    _createElementVNode5(
                                      'button',
                                      {
                                        class: _normalizeClass5([
                                          $setup.ns.e('header-btns'),
                                          $setup.ns.em('header-btns', 'double-right')
                                        ]),
                                        onClick:
                                          _cache[3] || (_cache[3] = ($event) => $setup.moveYear(1))
                                      },
                                      ' \xBB ',
                                      2
                                      /* CLASS */
                                  ...
                                  ? (_openBlock5(),
                                    _createBlock(
                                      $setup['DateTable'],
                                      {
                                        ...
                                        onHover:
                                          _cache[4] ||
                                          (_cache[4] = (val) => ($setup.rangeHoverDate = val))
                                      },
                                      {
                                        'date-cell': _withCtx((slotProps) => [
                                          _renderSlot2(
                                            _ctx.$slots,
                                            'date-cell',
                                            _normalizeProps(_guardReactiveProps(slotProps))
                                          )
                                        ]),
                                        _: 3
                                        /* FORWARDED */
                                    ...
                                    ? (_openBlock5(),
                                      _createBlock(
                                        $setup['MonthTable'],
                                        {
                                          ...
                                          onHover:
                                            _cache[5] ||
                                            (_cache[5] = (val) => ($setup.rangeHoverDate = val))
                                        },
                                        null,
                                        8,
                                        [
                                      ...
                                      ? (_openBlock5(),
                                        _createBlock(
                                          $setup['YearTable'],
                                          {
                                            ...
                                            onHover:
                                              _cache[6] ||
                                              (_cache[6] = (val) => ($setup.rangeHoverDate = val))
                                          },
                                          null,
                                          8,
                                          [
                                        ...
                                        ? (_openBlock5(),
                                          _createBlock(
                                            $setup['QuarterTable'],
                                            {
                                              ...
                                              onHover:
                                                _cache[7] ||
                                                (_cache[7] = (val) => ($setup.rangeHoverDate = val))
                                            },
                                            null,
                                            8,
                                            [
                                ...
                                _createElementBlock5(
                                  ...
                                  [
                                    _renderSlot2(_ctx.$slots, 'footer', {}, () => [
                                      _ctx.type.includes('datetime') && !$setup.isRange
                                        ? (_openBlock5(),
                                          _createElementBlock5(
                                            'div',
                                            {
                                            ...
                                            _toDisplayString5(
                                              $setup
                                                .dayjs(
                                                  _ctx.modelValue || /* @__PURE__ */ new Date()
                                                )
                                                .format($setup.props.timeFormat || 'HH:mm:ss')
                                            ),
                                            3
                                            /* TEXT, CLASS */
                                          ))
                                      ...
                                      _createElementVNode5(
                                        ...
                                        [
                                          $setup.isRange || _ctx.type.includes('datetime')
                                            ? (_openBlock5(),
                                              _createElementBlock5(
                                                'button',
                                                {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const parsedSelectedDate = computed15(() => {
        ...
        if (Array.isArray(val)) {
          return val
            .map((v) => (v && v !== '' ? stdin_default2(v).toDate() : null))
            .filter((v) => v !== null)
        }
        const d = stdin_default2(val)
      ...
      const moveYear = (offset) => {
        ...
        innerDate.value = stdin_default2(innerDate.value)
      ...
      const handleSelect = (val) => {
        ...
        if (typeof val === 'number') {
          if (currentView.value === 'year') {
            ...
            targetDate = stdin_default2(innerDate.value)
              .month((val - 1) * 3)
              .toDate()
            performFinalSelect(targetDate)
          }
      ...
      const handleOutsideClick = (e) => {
        ...
        if ((_a3 = wrapperRef.value) == null ? void 0 : _a3.contains(target)) return
      ...
      const __returned__ = {
        ...
        DateTable: stdin_default3,
        MonthTable: stdin_default4,
        YearTable: stdin_default5,
        QuarterTable: stdin_default6,
        get datePickerProps() {
...
export { stdin_default7 as default }
