                          ...
                          _renderSlot(_ctx.$slots, "date-cell", { cell }, () => {
                            ...
                            return [
                              ...
                              $setup.getCellExtra(cell.date) ? (_openBlock(), _createElementBlock(
                                ...
                                {
                                  key: 0,
                                  class: _normalizeClass([$setup.ns.e("cell-extra"), (_a = $setup.getCellExtra(cell.date)) == null ? void 0 : _a.className])
                                },
...
const __sfc__ = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, getCellExtra, rows, weekDays, getCellClasses, handleClick, handleMouseEnter, computed, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
