...
// public/codesandbox-runtime/components/category-nav/src/category-nav.js
...
import { ref as ref12, computed as computed11, nextTick, watch as watch4, onMounted as onMounted3, onUnmounted as onUnmounted4 } from "vue";
...
// public/codesandbox-runtime/components/category-nav/src/category-nav-meta.js
var categoryNavProps = {
  /** 分类数据 */
  categories: {
    type: Array,
    default: () => []
...
var _hoisted_3 = ["aria-selected", "onClick"];
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _createElementVNode("aside", {
        ...
        _ctx.showAll ? (_openBlock(), _createElementBlock("button", {
          key: 0,
          class: _normalizeClass([$setup.ns.e("side-item"), $setup.ns.is("active", $setup.activeId === null)]),
          role: "tab",
        ...
        _ctx.loading ? (_openBlock(), _createElementBlock(
          ...
          _renderList(_ctx.categories, (cat) => {
            return _openBlock(), _createElementBlock("button", {
              key: cat.id,
              class: _normalizeClass([$setup.ns.e("side-item"), $setup.ns.is("active", $setup.activeId === cat.id)]),
              role: "tab",
              "aria-selected": $setup.activeId === cat.id,
              onClick: ($event) => $setup.selectCategory(cat)
            }, [
              cat.badge ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 0,
              ...
              cat.image ? (_openBlock(), _createElementBlock("img", {
                key: 1,
                class: _normalizeClass($setup.ns.e("side-img")),
                src: cat.image,
                alt: cat.name,
                loading: "lazy"
              }, null, 10, _hoisted_4)) : cat.icon ? (_openBlock(), _createElementBlock(
                "i",
                {
                  key: 2,
      ...
      _createElementVNode(
        ...
        [
          ...
          _ctx.loading ? (_openBlock(), _createElementBlock(
                  ...
                  (_openBlock(), _createElementBlock(
                    ...
                    _renderList(9, (i) => {
                      return _createElementVNode(
                        ...
                        {
                          key: i,
                          class: _normalizeClass([$setup.ns.e("sub-item"), $setup.ns.e("skeleton")])
                        },
                        null,
                        2
                        /* CLASS */
            ...
            2
            /* CLASS */
          )) : !_ctx.anchor ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 1 },
            [
              _createCommentVNode(" \u666E\u901A\u89C6\u56FE\uFF1A\u4EC5\u663E\u793A\u5F53\u524D\u6FC0\u6D3B\u7684\u5B50\u5206\u7C7B "),
              $setup.activeCategory ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  class: _normalizeClass($setup.ns.e("section"))
                ...
                [
                  _renderSlot(_ctx.$slots, "section-header", { category: $setup.activeCategory }),
                  _createElementVNode(
                    "div",
                    {
                      class: _normalizeClass($setup.ns.e("sub-grid"))
                    ...
                    [
                      (_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList((_a2 = $setup.activeCategory.children) != null ? _a2 : [], (sub) => {
                          return _openBlock(), _createElementBlock("button", {
                            key: sub.id,
                            class: _normalizeClass([$setup.ns.e("sub-item"), $setup.ns.is("active", $setup.activeSubId === sub.id)]),
                            onClick: ($event) => $setup.selectSub(sub, $setup.activeCategory)
                          }, [
                            sub.image ? (_openBlock(), _createElementBlock("img", {
                              key: 0,
                              class: _normalizeClass($setup.ns.e("sub-img")),
                              src: sub.image,
                              alt: sub.name,
                              loading: "lazy"
                            ...
                            sub.count ? (_openBlock(), _createElementBlock(
                              "span",
                              {
                                key: 1,
                                class: _normalizeClass($setup.ns.e("sub-count"))
                              },
            ...
            { key: 2 },
            [
              _createCommentVNode(" \u951A\u5B9A\u6A21\u5F0F\uFF1A\u6240\u6709\u5206\u7C7B\u7684\u5B50\u9879\u5168\u90E8\u6E32\u67D3\uFF0C\u6EDA\u52A8\u8054\u52A8 "),
              (_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(_ctx.categories, (cat) => {
                  ...
                  return _openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode(
                      ...
                      [
                        _renderSlot(_ctx.$slots, "section-header", { category: cat }, () => [
                          _createElementVNode(
                            "span",
                            null,
                            _toDisplayString(cat.name),
                    ...
                    _createElementVNode(
                      ...
                      [
                        (_openBlock(true), _createElementBlock(
                          _Fragment,
                          null,
                          _renderList((_a22 = cat.children) != null ? _a22 : [], (sub) => {
                            return _openBlock(), _createElementBlock("button", {
                              key: sub.id,
                              class: _normalizeClass([$setup.ns.e("sub-item"), $setup.ns.is("active", $setup.activeSubId === sub.id)]),
                              onClick: ($event) => $setup.selectSub(sub, cat)
                            }, [
                              _renderSlot(_ctx.$slots, "sub-item", {
                                sub,
                                parent: cat
                              }, () => [
                                sub.image ? (_openBlock(), _createElementBlock("img", {
                                  ...
                                  alt: sub.name,
                                  loading: "lazy"
                                }, null, 10, _hoisted_9)) : _createCommentVNode("v-if", true),
                                _createElementVNode(
                                  "span",
                                  {
                                    class: _normalizeClass($setup.ns.e("sub-name"))
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhCategoryNav" }, {
  __name: "category-nav",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { t } = useLocale();
    const activeId = ref12(props.modelValue);
    const activeSubId = ref12(props.subValue);
    watch4(
      () => props.modelValue,
      (v) => {
        activeId.value = v;
    ...
    const sideRef = ref12(null);
    const contentRef = ref12(null);
    const sectionRefs = ref12({});
    const activeCategory = computed11(() => {
      var _a2;
      if (activeId.value === null) return null;
      return (_a2 = props.categories.find((c) => c.id === activeId.value)) != null ? _a2 : null;
    });
    ...
    function initObserver() {
      ...
      observer = new IntersectionObserver((entries) => {
        ...
        if (candidates.length > 0) {
          const topmost = candidates.reduce(
            (prev, curr) => curr.offsetTop < prev.offsetTop ? curr : prev
          );
      ...
      Object.values(sectionRefs.value).forEach((el) => observer == null ? void 0 : observer.observe(el));
    }
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, activeId, activeSubId, sideRef, contentRef, sectionRefs, activeCategory, get isScrollByClick() {
      ...
      observer = v;
    }, scrollSideToActive, selectCategory, selectSub, intersectingMap, initObserver, onContentScroll, setSectionRef, ref: ref12, computed: computed11, nextTick, watch: watch4, onMounted: onMounted3, onUnmounted: onUnmounted4, get useNamespace() {
      return useNamespace;
