                  ...
                  _createElementVNode(
                    ...
                    [
                      (_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList((_a = $setup.activeCategory.children) != null ? _a : [], (sub) => {
                          return _openBlock(), _createElementBlock("button", {
                            key: sub.id,
                    ...
                    _createElementVNode(
                      ...
                      [
                        (_openBlock(true), _createElementBlock(
                          _Fragment,
                          null,
                          _renderList((_a2 = cat.children) != null ? _a2 : [], (sub) => {
                            return _openBlock(), _createElementBlock("button", {
                              key: sub.id,
                              class: _normalizeClass([$setup.ns.e("sub-item"), $setup.ns.is("active", $setup.activeSubId === sub.id)]),
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhCategoryNav" }, {
  __name: "category-nav",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, activeId, activeSubId, sideRef, contentRef, sectionRefs, activeCategory, get isScrollByClick() {
      ...
      observer = v;
    }, scrollSideToActive, selectCategory, selectSub, intersectingMap, initObserver, onContentScroll, setSectionRef, ref, computed, nextTick, watch, onMounted, onUnmounted, get useNamespace() {
      return useNamespace;
