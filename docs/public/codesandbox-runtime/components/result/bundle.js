// docs/public/codesandbox-runtime/components/result/src/result.js
import {
  ...
  return (
    ...
    _createElementBlock(
      ...
      [
        ...
        $props.subTitle || _ctx.$slots['sub-title']
          ? (_openBlock(),
            _createElementBlock(
              'div',
              {
...
var __sfc__ = /* @__PURE__ */ Object.assign(
  { name: 'YhResult' },
  {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const resultTitle = computed11(() => props.title || t(`result.${props.icon}`))
      const iconColorMap = {
      ...
      const iconColor = computed11(() => iconColorMap[props.icon] || iconColorMap.info)
      const iconPaths = {
        success:
          'M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 01-51.7 0L318.5 451.2a8 8 0 016.5-12.6h46.9a32 32 0 0125.7 12.8L454 533.3l171.3-237.6c6-8.3 15.6-13.3 25.7-13.3h46.9a8 8 0 016.5 12.6z',
        warning:
          'M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm-32 232c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v272c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V296zm32 440a48 48 0 110-96 48 48 0 010 96z',
        error:
