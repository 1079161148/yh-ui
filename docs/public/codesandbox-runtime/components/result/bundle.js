...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhResult" }, {
  __name: "result",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { themeStyle } = useComponentTheme("result", computed11(() => props.themeOverrides));
    ...
    const __returned__ = { props, t, ns, themeStyle, resultTitle, iconColorMap, iconColor, iconPaths, computed: computed11, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
