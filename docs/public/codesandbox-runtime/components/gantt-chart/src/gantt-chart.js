...
const _hoisted_6 = ["d"];
const _hoisted_7 = ["onClick", "onDblclick", "onMousedown"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    {
      ref: "ganttRef",
      class: _normalizeClass([$setup.ns.b(), $setup.ns.is("bordered", $props.bordered), $setup.ns.is("loading", $props.loading)]),
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                "span",
                _hoisted_1,
                _toDisplayString($setup.ganttZoomText),
                1
                /* TEXT */
              ),
              ...
              _createVNode($setup["YhRadioGroup"], {
                ...
                default: _withCtx(() => [
                  _createVNode($setup["YhRadioButton"], { value: "day" }, {
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString($setup.t("ganttchart.day")),
                        1
                        /* TEXT */
                      )
                    ]),
                  ...
                  _createVNode($setup["YhRadioButton"], { value: "week" }, {
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString($setup.t("ganttchart.week")),
                        1
                        /* TEXT */
                      )
                    ]),
                  ...
                  _createVNode($setup["YhRadioButton"], { value: "month" }, {
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString($setup.t("ganttchart.month")),
                        1
                        /* TEXT */
                      )
                    ]),
                  ...
                  _createVNode($setup["YhRadioButton"], { value: "year" }, {
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString($setup.t("ganttchart.year")),
                        1
                        /* TEXT */
                      )
                    ]),
          ...
          _createElementVNode(
            ...
            [
                  ...
                  _createElementVNode(
                    ...
                    [
                      (_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList($setup.resolvedColumns, (col) => {
                          return _openBlock(), _createElementBlock(
                            "div",
                            {
                              key: col.prop,
              ...
              _createElementVNode(
                ...
                [
                  $props.virtual ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
                      style: _normalizeStyle({
                          ...
                          (_openBlock(true), _createElementBlock(
                            ...
                            _renderList($setup.resolvedColumns, (col) => {
                              return _openBlock(), _createElementBlock(
                                ...
                                [
                                  _renderSlot(_ctx.$slots, "table-cell", {
                                    row: task,
                                    column: col,
                                    index
                                  }, () => [
                                    col.prop === $setup.resolvedColumns[0].prop ? (_openBlock(), _createElementBlock(
                                      "span",
                                      {
                                        key: 0,
                                      ...
                                      [
                                        (_openBlock(true), _createElementBlock(
                                          _Fragment,
                                          null,
                                          _renderList(task._ancestorHasNext, (hasNext, i) => {
                                            return _openBlock(), _createElementBlock(
                                              "span",
                                              {
                                                key: i,
                                                class: _normalizeClass([$setup.ns.e("tree-indent"), $setup.ns.is("last", !hasNext)])
                                              },
                                              null,
                                              2
                                              /* CLASS */
                                        ...
                                        _createElementVNode(
                                          "span",
                                          {
                                            class: _normalizeClass([$setup.ns.e("tree-indent"), $setup.ns.is("last", task._isLast)])
                                          },
                                          [
                                            _createElementVNode(
                                              "span",
                                              {
                                                class: _normalizeClass($setup.ns.e("tree-content"))
                                              },
                                              [
                                                task._hasChildren ? (_openBlock(), _createElementBlock("span", {
                                                  key: 0,
                                                  class: _normalizeClass([$setup.ns.e("tree-arrow"), $setup.expandedTasks.has(task.id) && "is-expanded"]),
                                                  onClick: _withModifiers(($event) => $setup.toggleExpand(task), ["stop"])
                                                }, [..._cache[3] || (_cache[3] = [
                                                  _createElementVNode(
                                                    "svg",
                                                    {
                                                    ...
                                                    [
                                                      _createElementVNode("path", { d: "M340.864 149.312a30.592 30.592 0 0 0 0 42.752L652.736 512 340.864 831.936a30.592 30.592 0 0 0 0 42.752 29.12 29.12 0 0 0 41.728 0L714.24 533.376a30.592 30.592 0 0 0 0-42.752L382.592 149.312a29.12 29.12 0 0 0-41.728 0z" })
                                                    ],
                                                    -1
                                                    /* CACHED */
                                                  )
                                                ])], 10, _hoisted_3)) : (_openBlock(), _createElementBlock("span", _hoisted_4)),
                                                _createElementVNode(
                                                  "span",
                                                  {
                                                    class: _normalizeClass($setup.ns.e("tree-line"))
                                                  },
                                                  null,
                                                  2
                                                  /* CLASS */
                                    ...
                                    _createVNode($setup["YhTooltip"], {
                                      ...
                                      default: _withCtx(() => [
                                        _createElementVNode(
                                          "span",
                                          {
                                            class: _normalizeClass($setup.ns.e("cell-text"))
                                          },
                      ...
                      (_openBlock(true), _createElementBlock(
                        ...
                        _renderList($setup.bottomHeaders, (th, i) => {
                          return _openBlock(), _createElementBlock(
                            ...
                            {
                              key: i,
                              class: _normalizeClass([$setup.ns.e("timeline-unit"), th.isToday ? $setup.ns.em("timeline-unit", "today") : ""]),
                              style: _normalizeStyle({
                                width: `${th.width}px`
                              })
                            },
                            [
                              th.width > 20 ? (_openBlock(), _createElementBlock(
                                "span",
                                _hoisted_5,
                                _toDisplayString(th.label),
                                1
                ...
                [
                  _createElementVNode(
                    ...
                    [
                      ...
                      $props.showDependencies ? (_openBlock(), _createElementBlock(
                        "svg",
                        {
                          key: 1,
                      ...
                      (_openBlock(true), _createElementBlock(
                        ...
                        _renderList($setup.taskStyles, (ts) => {
                          return _openBlock(), _createBlock($setup["YhTooltip"], {
                            ...
                            placement: "top",
                            class: _normalizeClass([$setup.ns.e("task-wrapper"), $setup.ns.is("milestone", ts.isMilestone), $setup.ns.is("summary", ts.isSummary), ts.task.status ? $setup.ns.e(`task-${ts.task.status}`) : ""]),
                            ...
                            default: _withCtx(() => [
                              _createElementVNode("div", {
                                ...
                                ts.isSummary ? (_openBlock(), _createElementBlock(
                                  "div",
                                  {
                                    key: 0,
                                  ...
                                  [
                                    _createElementVNode(
                                      "div",
                                      {
                                        class: _normalizeClass($setup.ns.e("summary-left"))
                                      },
                                      null,
                                      2
                                      /* CLASS */
                                    ...
                                    _createElementVNode(
                                      "div",
                                      {
                                        class: _normalizeClass($setup.ns.e("summary-right"))
                                      },
                                      null,
                                      2
                                      /* CLASS */
                                  ...
                                  2
                                  /* CLASS */
                                )) : ts.isMilestone ? (_openBlock(), _createElementBlock(
                                  "div",
                                  {
                                    key: 1,
                                    class: _normalizeClass($setup.ns.e("milestone-diamond")),
                                    style: _normalizeStyle({
                                  ...
                                  { key: 2 },
                                  [
                                    ts.task.progress ? (_openBlock(), _createElementBlock(
                                      "div",
                                      {
                                        key: 0,
                                        class: _normalizeClass($setup.ns.e("task-progress")),
                                        style: _normalizeStyle({
                                    ...
                                    _renderSlot(_ctx.$slots, "task-content", {
                                      task: ts.task
                                    }, () => [
                                      _createElementVNode(
                                        "span",
                                        {
                                          class: _normalizeClass($setup.ns.e("task-label"))
                                        },
                                ...
                                !ts.isMilestone && $props.draggable ? (_openBlock(), _createElementBlock(
                                  _Fragment,
                                  { key: 3 },
                                  [
                                    _createElementVNode("div", {
                                      class: _normalizeClass($setup.ns.e("resizer-left")),
                                      onMousedown: _withModifiers(($event) => $setup.onDragStart($event, ts.task, "left"), ["stop"])
                                    }, null, 42, _hoisted_8),
                                    _createElementVNode("div", {
                                      class: _normalizeClass($setup.ns.e("resizer-right")),
                                      onMousedown: _withModifiers(($event) => $setup.onDragStart($event, ts.task, "right"), ["stop"])
                                    }, null, 42, _hoisted_9)
                                  ],
                                  64
                                  /* STABLE_FRAGMENT */
...
import { YhInput } from "../../input/index.js";
import { YhRadioGroup, YhRadioButton } from "../../radio/index.js";
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhGanttChart" }, {
  __name: "gantt-chart",
  props: {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const resolvedColumns = computed(() => {
      var _a, _b;
      const isDefaultNameColumn = props.columns.length === 1 && ((_a = props.columns[0]) == null ? void 0 : _a.prop) === "name" && ((_b = props.columns[0]) == null ? void 0 : _b.width) === 200;
      return isDefaultNameColumn ? [__spreadProps(__spreadValues({}, props.columns[0]), { label: t("ganttchart.taskName") })] : props.columns;
    });
    ...
    const updateSuccessors = (taskId) => {
      ...
      const findAffected = (predId, list) => {
        ...
        list.forEach((t2) => {
          var _a;
          if ((_a = t2.dependencies) == null ? void 0 : _a.includes(predId)) affected2.push(t2);
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, resolvedColumns, ganttSearchPlaceholder, ganttZoomText, ganttMilestoneText, ganttRef, timelineBodyRef, sidebarBodyRef, sidebarHeaderRef, PIXELS_PER_DAY, internalViewModeState, internalViewMode, minPixelsPerDay, minMaxDates, timelineStart, timelineEnd, expandedTasks, searchKeyword, toggleExpand, getFlattenedTasks, visibleAllTasks, scrollTop, viewportHeight, virtualState, renderTasks, totalHeight, resourceLoadMap, totalDays, timelineWidth, topHeaders, bottomHeaders, getTaskPosition, taskStyles, dependenciesLinks, handleBodyScroll, updateSuccessors, activeDragTask, get dragType() {
      ...
      dragInitP = v;
    }, onDragStart, onDragMove, onDragEnd, handleTaskClick, handleTaskDblClick, truncatedTasks, handleMouseEnter, ref, computed, watch, get dayjs() {
      return dayjs;
