...
var __sfc__2 = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const innerClasses = computed12(() => [ns.e('inner')])
      const handleChange = (event) => {
        ...
        if (isGroup.value && checkboxGroup) {
          ...
          ;(_a2 = checkboxGroup.changeEvent) == null
            ? void 0
            : _a2.call(checkboxGroup, currentValue)
        } else {
                ...
                _renderSlot4(
                  ...
                  () => {
                    ...
                    return [
                      $props.node.loading
                        ? (_openBlock4(),
                          _createElementBlock4('svg', _hoisted_2, [
                            ...(_cache[2] ||
                              (_cache[2] = [
                                _createElementVNode2(
                                  'path',
                        ...
                        : !$props.node.isLeaf &&
                            (((_a2 = $props.node.children) == null ? void 0 : _a2.length) ||
                          ...
                          ? (_openBlock4(),
                            _createElementBlock4(
                              ...
                              [
                                $props.node.expanded
                                  ? (_openBlock4(),
                                    _createElementBlock4('svg', _hoisted_3, [
                                      ...(_cache[3] ||
                                        (_cache[3] = [
                                          _createElementVNode2(
                                            'path',
                                  ...
                                  : (_openBlock4(),
                                    _createElementBlock4('svg', _hoisted_4, [
                                      ...(_cache[4] ||
                                        (_cache[4] = [
                                          _createElementVNode2(
                                            'path',
      ...
      const nodeClass = computed14(() => {
        ...
        return [
          ...
          // 支持自定义类名
          {
            ...
            [ns.is('leaf')]:
              props.node.isLeaf || !((_a2 = props.node.children) == null ? void 0 : _a2.length),
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const buildTree = (data, parent = null, level = 0) => {
        ...
        return data.map((item) => {
          var _a2, _b, _c, _d
          const key =
            (_b = (_a2 = item[props.nodeKey]) != null ? _a2 : item.key) != null ? _b : item.id
      ...
      const handleNodeClick = (node, e) => {
        ...
        if (
          ...
          !node.isLeaf &&
          (((_a2 = node.children) == null ? void 0 : _a2.length) || props.lazy)
        ) {
      ...
      const scrollTo = (options) => {
        var _a2
        if (props.virtual) {
          ;(_a2 = innerScrollRef.value) == null
            ? void 0
            : _a2.scrollTo(typeof options === 'number' ? { top: options } : options)
        }
      }
