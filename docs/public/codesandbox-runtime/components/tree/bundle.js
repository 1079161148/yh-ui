...
// public/codesandbox-runtime/components/tree/src/tree.js
import { renderList as _renderList3, Fragment as _Fragment4, openBlock as _openBlock5, createElementBlock as _createElementBlock5, renderSlot as _renderSlot5, withCtx as _withCtx3, createBlock as _createBlock4, normalizeStyle as _normalizeStyle4, createElementVNode as _createElementVNode3, createCommentVNode as _createCommentVNode5, toDisplayString as _toDisplayString3, createTextVNode as _createTextVNode3, normalizeClass as _normalizeClass4 } from "vue";
import { ref as ref13, computed as computed15, provide as provide3, watch as watch5, shallowRef as shallowRef3 } from "vue";
...
// public/codesandbox-runtime/components/tree/src/tree-meta.js
var treeProps = {
  /** 数据源 */
  data: {
    type: Array,
...
var TREE_INJECTION_KEY = Symbol("tree");

// public/codesandbox-runtime/components/tree/src/tree-node.js
import { createCommentVNode as _createCommentVNode4, renderSlot as _renderSlot4, createElementVNode as _createElementVNode2, openBlock as _openBlock4, createElementBlock as _createElementBlock4, Fragment as _Fragment3, normalizeClass as _normalizeClass3, withModifiers as _withModifiers, createBlock as _createBlock3, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode2, normalizeStyle as _normalizeStyle3, renderList as _renderList2, resolveComponent as _resolveComponent, withCtx as _withCtx2, vShow as _vShow, withDirectives as _withDirectives } from "vue";
import { computed as computed14, inject as inject8 } from "vue";
...
import { normalizeClass as _normalizeClass, createElementVNode as _createElementVNode, renderSlot as _renderSlot2, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, openBlock as _openBlock2, createElementBlock as _createElementBlock2, createCommentVNode as _createCommentVNode2, normalizeStyle as _normalizeStyle } from "vue";
import { computed as computed12, ref as ref12, inject as inject7, onMounted as onMounted3, watch as watch4 } from "vue";
...
// public/codesandbox-runtime/components/checkbox/src/checkbox.js
var _hoisted_12 = ["name", "id", "tabindex", "disabled", "checked"];
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, checkboxGroup, themeStyle, inputRef, focused, hovering, globalSize, isGroup, checkboxSize, isDisabled, isLimitDisabled, actualDisabled, isChecked, checkboxClasses, innerClasses, handleChange, handleFocus, handleBlur, focus, blur, computed: computed12, ref: ref12, inject: inject7, onMounted: onMounted3, watch: watch4, get useNamespace() {
      return useNamespace;
    }, get useConfig() {
      return useConfig;
    }, get useComponentTheme() {
...
import { renderSlot as _renderSlot3, renderList as _renderList, Fragment as _Fragment2, openBlock as _openBlock3, createElementBlock as _createElementBlock3, createBlock as _createBlock2, createCommentVNode as _createCommentVNode3, resolveDynamicComponent as _resolveDynamicComponent2, normalizeClass as _normalizeClass2, normalizeStyle as _normalizeStyle2, withCtx as _withCtx } from "vue";
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock3(), _createBlock2(_resolveDynamicComponent2($props.tag), {
    class: _normalizeClass2($setup.groupClasses),
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, formItem, validate, labelId, globalSize, changeEvent, themeStyle, modelValue, size, disabled, min, max, groupClasses, computed: computed13, provide: provide2, toRefs, get useNamespace() {
      ...
      return useConfig;
    }, YhCheckbox: stdin_default4, get checkboxGroupContextKey() {
      return checkboxGroupContextKey;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
var YhCheckbox = withInstall(stdin_default4);
var YhCheckboxGroup = withInstall(stdin_default5);

// public/codesandbox-runtime/components/tree/src/tree-node.js
var _hoisted_13 = ["draggable"];
var _hoisted_2 = {
  key: 0,
  class: "loading-icon",
  viewBox: "0 0 1024 1024",
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock4(), _createElementBlock4(
    "div",
    {
      class: _normalizeClass3($setup.nodeClass),
      role: "treeitem"
    },
    [
      _createElementVNode2("div", {
        class: _normalizeClass3($setup.ns.e("content")),
        style: _normalizeStyle3($setup.nodeStyle),
        ...
        _createCommentVNode4(" \u5C55\u5F00\u56FE\u6807 "),
        _createElementVNode2(
          "span",
          {
            class: _normalizeClass3([$setup.ns.e("expand-icon"), {
          ...
          [
            _renderSlot4(_ctx.$slots, "icon", {
              node: $props.node,
              data: $props.node.rawData
            }, () => {
              var _a2;
              return [
                $props.node.loading ? (_openBlock4(), _createElementBlock4("svg", _hoisted_2, [..._cache[2] || (_cache[2] = [
                  _createElementVNode2(
                    "path",
                    {
                ...
                ])])) : !$props.node.isLeaf && (((_a2 = $props.node.children) == null ? void 0 : _a2.length) || $setup.tree.props.lazy) ? (_openBlock4(), _createElementBlock4(
                  _Fragment3,
                  { key: 1 },
                  [
                    $props.node.expanded ? (_openBlock4(), _createElementBlock4("svg", _hoisted_3, [..._cache[3] || (_cache[3] = [
                      _createElementVNode2(
                        "path",
                        {
                    ...
                    ])])) : (_openBlock4(), _createElementBlock4("svg", _hoisted_4, [..._cache[4] || (_cache[4] = [
                      _createElementVNode2(
                        "path",
                        {
                  ...
                  {
                    key: 2,
                    class: _normalizeClass3($setup.ns.e("expand-placeholder"))
                  },
                  null,
                  2
                  /* CLASS */
        ...
        _createCommentVNode4(" \u5DE6\u4FA7\u590D\u9009\u6846 "),
        $setup.tree.props.showCheckbox && $setup.tree.props.checkboxPosition === "left" ? (_openBlock4(), _createBlock3($setup["YhCheckbox"], {
          key: 0,
        ...
        }, null, 8, ["model-value", "indeterminate", "disabled"])) : _createCommentVNode4("v-if", true),
        _createCommentVNode4(" \u524D\u7F00\u63D2\u69FD "),
        _renderSlot4(_ctx.$slots, "prefix", {
          node: $props.node,
          data: $props.node.rawData
        }),
        _createCommentVNode4(" \u5FEB\u6377\u56FE\u6807 (\u901A\u8FC7 rawData.icon \u6E32\u67D3) "),
        $props.node.icon ? (_openBlock4(), _createBlock3($setup["YhIcon"], {
          key: 1,
          name: $props.node.icon,
          class: _normalizeClass3($setup.ns.e("icon"))
        }, null, 8, ["name", "class"])) : _createCommentVNode4("v-if", true),
        _createCommentVNode4(" \u8282\u70B9\u5185\u5BB9 "),
        _createElementVNode2(
          "span",
          {
          ...
          [
            _renderSlot4(_ctx.$slots, "default", {
              ...
              _createTextVNode2(
                _toDisplayString2($props.node.label),
                1
                /* TEXT */
              )
            ])
        ...
        _createCommentVNode4(" \u540E\u7F00\u63D2\u69FD "),
        _renderSlot4(_ctx.$slots, "suffix", {
          node: $props.node,
          data: $props.node.rawData
        }),
        _createCommentVNode4(" \u53F3\u4FA7\u590D\u9009\u6846 "),
        $setup.tree.props.showCheckbox && $setup.tree.props.checkboxPosition === "right" ? (_openBlock4(), _createBlock3($setup["YhCheckbox"], {
          key: 2,
          "model-value": $props.node.checked,
          indeterminate: $props.node.indeterminate,
          disabled: $props.node.disabled,
      ...
      _createCommentVNode4(" \u5B50\u8282\u70B9 (\u975E\u865A\u62DF\u6EDA\u52A8\u6A21\u5F0F\u4E0B\u9012\u5F52\u6E32\u67D3) "),
      !$setup.tree.props.virtual && $props.node.children && $props.node.children.length > 0 ? _withDirectives((_openBlock4(), _createElementBlock4(
        "div",
        {
          key: 0,
          class: _normalizeClass3($setup.ns.e("children")),
          role: "group"
        },
        [
          (_openBlock4(true), _createElementBlock4(
            _Fragment3,
            null,
            _renderList2($props.node.children, (child) => {
              return _openBlock4(), _createBlock3(_component_yh_tree_node, {
                key: child.key,
                node: child
              }, {
                default: _withCtx2(({ node: childNode, data: childData }) => [
                  _renderSlot4(_ctx.$slots, "default", {
                    node: childNode,
                    data: childData
                  })
                ]),
                icon: _withCtx2(({ node: childNode, data: childData }) => [
                  _renderSlot4(_ctx.$slots, "icon", {
                    node: childNode,
                    data: childData
                  })
                ]),
                prefix: _withCtx2(({ node: childNode, data: childData }) => [
                  _renderSlot4(_ctx.$slots, "prefix", {
                    node: childNode,
                    data: childData
                  })
                ]),
                suffix: _withCtx2(({ node: childNode, data: childData }) => [
                  _renderSlot4(_ctx.$slots, "suffix", {
                    node: childNode,
                    data: childData
                  })
...
var __sfc__4 = /* @__PURE__ */ Object.assign({ name: "YhTreeNode" }, {
  __name: "tree-node",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const tree = inject8(TREE_INJECTION_KEY);
    const nodeStyle = computed14(() => ({
      paddingLeft: `${props.node.level * tree.props.indent}px`
    }));
    const isCurrent = computed14(() => tree.currentNodeKey.value === props.node.key);
    const nodeClass = computed14(() => {
      var _a2;
      return [
        ns.e("node"),
        props.node.class,
        // 支持自定义类名
        {
          ...
          [ns.is("leaf")]: props.node.isLeaf || !((_a2 = props.node.children) == null ? void 0 : _a2.length),
    ...
    const __returned__ = { props, ns, tree, nodeStyle, isCurrent, nodeClass, handleDragStart, handleDragOver, handleDragEnter, handleDragLeave, handleDragEnd, handleDrop, handleExpandClick, handleContentClick, handleCheckChange, computed: computed14, inject: inject8, get useNamespace() {
      return useNamespace;
...
function render5(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock5(), _createElementBlock5(
    "div",
    {
      class: _normalizeClass4([$setup.ns.b(), _ctx.showLine && $setup.ns.m("show-line")]),
      style: _normalizeStyle4($setup.themeStyle),
      role: "tree"
    },
    [
      $setup.props.virtual ? (_openBlock5(), _createElementBlock5(
        "div",
        {
          key: 0,
          ref: "innerScrollRef",
              ...
              _createElementVNode3(
                ...
                [
                  (_openBlock5(true), _createElementBlock5(
                    _Fragment4,
                    null,
                    _renderList3($setup.visibleNodes, (node) => {
                      return _openBlock5(), _createBlock4($setup["TreeNodeComponent"], {
                        key: node.key,
                        node
                      }, {
                        default: _withCtx3(({ node: childNode, data: childData }) => [
                          _renderSlot5(_ctx.$slots, "default", {
                            node: childNode,
                            data: childData
                          })
                        ]),
                        icon: _withCtx3(({ node: childNode, data: childData }) => [
                          _renderSlot5(_ctx.$slots, "icon", {
                            node: childNode,
                            data: childData
                          })
                        ]),
                        prefix: _withCtx3(({ node: childNode, data: childData }) => [
                          _renderSlot5(_ctx.$slots, "prefix", {
                            node: childNode,
                            data: childData
                          })
                        ]),
                        suffix: _withCtx3(({ node: childNode, data: childData }) => [
                          _renderSlot5(_ctx.$slots, "suffix", {
                            node: childNode,
                            data: childData
                          })
                        ]),
      ...
      )) : $setup.treeNodes.length > 0 ? (_openBlock5(true), _createElementBlock5(
        _Fragment4,
        { key: 1 },
        _renderList3($setup.treeNodes, (node) => {
          return _openBlock5(), _createBlock4($setup["TreeNodeComponent"], {
            key: node.key,
            node
          }, {
        ...
        [
          _renderSlot5(_ctx.$slots, "empty", {}, () => [
            _createTextVNode3(
              _toDisplayString3(_ctx.emptyText || $setup.t("tree.emptyText")),
              1
              /* TEXT */
            )
          ])
...
var __sfc__5 = /* @__PURE__ */ Object.assign({ name: "YhTree" }, {
  __name: "tree",
  props: treeProps,
  emits: treeEmits,
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const expandedKeys = ref13(new Set(props.defaultExpandedKeys));
    const checkedKeys = ref13(new Set(props.defaultCheckedKeys));
    const currentNodeKey = ref13(props.currentNodeKey);
    const nodeMap = shallowRef3(/* @__PURE__ */ new Map());
    const treeNodes = ref13([]);
    const scrollTop = ref13(0);
    const handleScroll = (e) => {
      scrollTop.value = e.target.scrollTop;
    };
    const totalHeight = computed15(() => flattenedNodes.value.length * props.itemHeight);
    const startIndex = computed15(() => Math.floor(scrollTop.value / props.itemHeight));
    const visibleCount = computed15(() => Math.ceil(props.height / props.itemHeight));
    const endIndex = computed15(() => startIndex.value + visibleCount.value);
    const visibleNodes = computed15(
      () => flattenedNodes.value.slice(startIndex.value, endIndex.value + 1)
    );
    const offset = computed15(() => startIndex.value * props.itemHeight);
    const buildTree = (data, parent = null, level = 0) => {
      ...
      return data.map((item) => {
        var _a2, _b, _c, _d;
        const key = (_b = (_a2 = item[props.nodeKey]) != null ? _a2 : item.key) != null ? _b : item.id;
        const node = __spreadProps(__spreadValues3({}, item), {
          key,
    ...
    const flattenedNodes = computed15(() => {
      const result = [];
    ...
    const handleNodeClick = (node, e) => {
      ...
      if (props.expandOnClickNode && !node.isLeaf && (((_a2 = node.children) == null ? void 0 : _a2.length) || props.lazy)) {
    ...
    const dragNode = ref13(null);
    const draggingNodeKey = ref13(void 0);
    const dropTargetNodeKey = ref13(void 0);
    const dropPosition = ref13(void 0);
    ...
    const getCurrentNode = () => currentNodeKey.value ? nodeMap.value.get(currentNodeKey.value) : void 0;
    ...
    const innerScrollRef = ref13();
    const scrollTo = (options) => {
      var _a2;
      if (props.virtual) {
        (_a2 = innerScrollRef.value) == null ? void 0 : _a2.scrollTo(typeof options === "number" ? { top: options } : options);
      }
    };
    ...
    const setCheckedNodes = (nodes) => {
      const keys = nodes.map(
        (node) => {
          var _a2, _b;
          return (_b = (_a2 = node[props.nodeKey]) != null ? _a2 : node.key) != null ? _b : node.id;
        }
      );
      setCheckedKeys(keys);
    };
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, expandedKeys, checkedKeys, currentNodeKey, nodeMap, treeNodes, scrollTop, handleScroll, totalHeight, startIndex, visibleCount, endIndex, visibleNodes, offset, buildTree, flattenedNodes, handleNodeClick, handleNodeExpand, handleNodeCheck, setCurrentKey, filter, getCheckedNodes, getCheckedKeys, setCheckedKeys, dragNode, draggingNodeKey, dropTargetNodeKey, dropPosition, handleDragStart, handleDragOver, handleDragEnter, handleDragLeave, handleDragEnd, handleDrop, getNode, getHalfCheckedNodes, getHalfCheckedKeys, getCurrentKey, getCurrentNode, setExpandedKeys, expandNode, collapseNode, setChecked, innerScrollRef, scrollTo, scrollToNode, setCheckedNodes, setData, ref: ref13, computed: computed15, provide: provide3, watch: watch5, shallowRef: shallowRef3, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useComponentTheme() {
      ...
      return TREE_INJECTION_KEY;
    }, TreeNodeComponent: stdin_default6 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
