  ...
  return _withDirectives((_openBlock(), _createElementBlock(
    ...
    [
      _createElementVNode("div", {
        ...
        _createElementVNode(
          ...
          [
            _renderSlot(_ctx.$slots, "icon", {
              ...
              var _a;
              return [
                $props.node.loading ? (_openBlock(), _createElementBlock("svg", _hoisted_2, [..._cache[2] || (_cache[2] = [
                  _createElementVNode(
                    "path",
                    {
                ...
                ])])) : !$props.node.isLeaf && (((_a = $props.node.children) == null ? void 0 : _a.length) || $setup.tree.props.lazy) ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 1 },
                  [
                    $props.node.expanded ? (_openBlock(), _createElementBlock("svg", _hoisted_3, [..._cache[3] || (_cache[3] = [
                      _createElementVNode(
                        "path",
                        {
        ...
        $setup.tree.props.showCheckbox && $setup.tree.props.checkboxPosition === "left" ? (_openBlock(), _createBlock($setup["YhCheckbox"], {
          key: 0,
        ...
        }, null, 8, ["model-value", "indeterminate", "disabled"])) : _createCommentVNode("v-if", true),
        _createCommentVNode(" \u524D\u7F00\u63D2\u69FD "),
        _renderSlot(_ctx.$slots, "prefix", {
          node: $props.node,
          data: $props.node.rawData
        }),
        _createCommentVNode(" \u5FEB\u6377\u56FE\u6807 (\u901A\u8FC7 rawData.icon \u6E32\u67D3) "),
        $props.node.icon ? (_openBlock(), _createBlock($setup["YhIcon"], {
          key: 1,
        ...
        $setup.tree.props.showCheckbox && $setup.tree.props.checkboxPosition === "right" ? (_openBlock(), _createBlock($setup["YhCheckbox"], {
          key: 2,
          "model-value": $props.node.checked,
          indeterminate: $props.node.indeterminate,
          disabled: $props.node.disabled,
      ...
      _createCommentVNode(" \u5B50\u8282\u70B9 (\u975E\u865A\u62DF\u6EDA\u52A8\u6A21\u5F0F\u4E0B\u9012\u5F52\u6E32\u67D3) "),
      !$setup.tree.props.virtual && $props.node.children && $props.node.children.length > 0 ? _withDirectives((_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          (_openBlock(true), _createElementBlock(
            ...
            _renderList($props.node.children, (child) => {
              return _openBlock(), _createBlock(_component_yh_tree_node, {
                key: child.key,
                node: child
              }, {
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhTreeNode" }, {
  __name: "tree-node",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const nodeClass = computed(() => {
      ...
      return [
        ...
        // 支持自定义类名
        {
          ...
          [ns.is("leaf")]: props.node.isLeaf || !((_a = props.node.children) == null ? void 0 : _a.length),
    ...
    const __returned__ = { props, ns, tree, nodeStyle, isCurrent, nodeClass, handleDragStart, handleDragOver, handleDragEnter, handleDragLeave, handleDragEnd, handleDrop, handleExpandClick, handleContentClick, handleCheckChange, computed, inject, get useNamespace() {
      return useNamespace;
