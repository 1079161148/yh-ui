...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      $setup.props.virtual ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          ref: "innerScrollRef",
                ...
                [
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList($setup.visibleNodes, (node) => {
                      return _openBlock(), _createBlock($setup["TreeNodeComponent"], {
                        key: node.key,
                        node
                      }, {
      ...
      )) : $setup.treeNodes.length > 0 ? (_openBlock(true), _createElementBlock(
        _Fragment,
        { key: 1 },
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhTree" }, {
  __name: "tree",
  props: treeProps,
  emits: treeEmits,
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const buildTree = (data, parent = null, level = 0) => {
      ...
      return data.map((item) => {
        var _a, _b, _c, _d;
        const key = (_b = (_a = item[props.nodeKey]) != null ? _a : item.key) != null ? _b : item.id;
    ...
    const handleNodeClick = (node, e) => {
      ...
      if (props.expandOnClickNode && !node.isLeaf && (((_a = node.children) == null ? void 0 : _a.length) || props.lazy)) {
    ...
    const scrollTo = (options) => {
      var _a;
      if (props.virtual) {
        (_a = innerScrollRef.value) == null ? void 0 : _a.scrollTo(typeof options === "number" ? { top: options } : options);
      }
    };
