...
init_dayjs();
import { createCommentVNode as _createCommentVNode2, renderSlot as _renderSlot2, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, normalizeClass as _normalizeClass2, createElementVNode as _createElementVNode2, withCtx as _withCtx2, createVNode as _createVNode, openBlock as _openBlock2, createElementBlock as _createElementBlock2, renderList as _renderList, Fragment as _Fragment, normalizeStyle as _normalizeStyle2 } from "vue";
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    ...
    [
            ...
            [
              _createElementVNode2("thead", null, [
                _createElementVNode2("tr", null, [
                  _ctx.showWeekNumber ? (_openBlock2(), _createElementBlock2(
                    "th",
                    {
                      key: 0,
                  ...
                  (_openBlock2(true), _createElementBlock2(
                    ...
                    _renderList($setup.weekDays, (day, idx) => {
                      return _openBlock2(), _createElementBlock2(
                        ...
                        {
                          key: day,
                          class: _normalizeClass2([$setup.ns.e("weekday"), {
              ...
              _createElementVNode2("tbody", null, [
                (_openBlock2(true), _createElementBlock2(
                  ...
                  _renderList($setup.rows, (row, rowIndex) => {
                    return _openBlock2(), _createElementBlock2("tr", { key: rowIndex }, [
                      _ctx.showWeekNumber ? (_openBlock2(), _createElementBlock2(
                        "td",
                        {
                          key: 0,
                          ...
                          return _openBlock2(), _createElementBlock2("td", {
                            ...
                            _createElementVNode2(
                              ...
                              [
                                ...
                                _createCommentVNode2(" \u5047\u671F/\u8865\u73ED\u6807\u8BB0 "),
                                _ctx.showHoliday && (cell.isHoliday || cell.isWorkday) ? (_openBlock2(), _createElementBlock2(
                                  "div",
                                  {
                                    key: 0,
                                    class: _normalizeClass2([$setup.ns.e("day-badge"), cell.isHoliday ? $setup.ns.em("day-badge", "holiday") : $setup.ns.em("day-badge", "workday")])
                                  },
                                  _toDisplayString(cell.isHoliday ? $setup.t("calendar.holiday") : $setup.t("calendar.workday")),
                                  3
                                  /* TEXT, CLASS */
                                )) : _createCommentVNode2("v-if", true),
                                _createCommentVNode2(" \u81EA\u5B9A\u4E49\u5185\u5BB9\u63D2\u69FD "),
                                _createElementVNode2(
                                  "div",
                                  {
      ...
      _ctx.$slots.footer ? (_openBlock2(), _createElementBlock2(
        "div",
        {
          key: 0,
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const rangeStart = ref13(
      ((_a2 = props.rangeValue) == null ? void 0 : _a2[0]) ? stdin_default(props.rangeValue[0]) : void 0
    );
    const rangeEnd = ref13(
      ((_b = props.rangeValue) == null ? void 0 : _b[1]) ? stdin_default(props.rangeValue[1]) : void 0
    );
    const hoverDate = ref13(void 0);
    const multipleSelected = ref13(((_c = props.multipleValue) == null ? void 0 : _c.map((d2) => stdin_default(d2))) || []);
    ...
    const title = computed12(() => {
      ...
      const calendarLocale = (_a22 = locale143.value.yh) == null ? void 0 : _a22.calendar;
      ...
      const dateLocale = (_b2 = locale143.value.yh) == null ? void 0 : _b2.datepicker;
      if (dateLocale) {
    ...
    const isMultipleSelected = (date) => {
      ...
      return multipleSelected.value.some((d2) => d2.isSame(date, "day"));
    };
      ...
      for (let i = 0; i < 6; i++) {
        ...
        for (let j = 0; j < 7; j++) {
          ...
          const cell = {
            ...
            isRangeStart: props.selectionMode === "range" && ((_a22 = rangeStart.value) == null ? void 0 : _a22.isSame(current, "day")),
    ...
    const selectDate = (cell) => {
      ...
      if (props.selectionMode === "single") {
        ...
        const idx = multipleSelected.value.findIndex((d2) => d2.isSame(date, "day"));
        if (idx > -1) {
        ...
        emit(
          ...
          multipleSelected.value.map((d2) => d2.toDate())
        );
        emit("select", date.toDate(), cell);
      }
    };
    ...
    watch4(
      ...
      (val) => {
        if (val) {
          const d2 = stdin_default(val);
          selectedDate.value = d2;
          displayDate.value = d2;
        }
      }
    );
    watch4(
    ...
    watch4(
      () => props.multipleValue,
      (val) => {
        multipleSelected.value = (val == null ? void 0 : val.map((d2) => stdin_default(d2))) || [];
      }
    );
    onMounted3(() => {
    ...
    const __returned__ = { props, emit, ns, t, locale: locale143, themeStyle, now, displayDate, selectedDate, rangeStart, rangeEnd, hoverDate, multipleSelected, mergedHolidays, monthKeys, title, weekDays, isDateDisabled, isWeekend, isInRange, isMultipleSelected, rows, getDayType, selectDate, handleCellHover, moveMonth, goToday, getSlotData, getCellExtraClass, rootClass, ref: ref13, computed: computed12, watch: watch4, onMounted: onMounted3, get dayjs() {
