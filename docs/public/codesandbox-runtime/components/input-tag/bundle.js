// docs/public/codesandbox-runtime/components/input-tag/src/input-tag.js
import {
...
// docs/public/codesandbox-runtime/components/input-tag/src/input-tag.js
var _hoisted_1 = ['draggable', 'onDragstart', 'onDragover', 'onDrop']
var _hoisted_2 = ['onClick']
var _hoisted_3 = ['value', 'placeholder', 'disabled', 'readonly']
      ...
      [
        ...
        _createElementVNode(
          ...
          [
                  ...
                  () => [
                    _createElementVNode(
                      ...
                      [
                        ...
                        $props.closable && !$props.disabled && !$props.readonly
                          ? (_openBlock(),
                            _createElementBlock(
                              'span',
                              {
            ...
            $props.collapseTags && $setup.collapsedCount > 0
              ? (_openBlock(),
                _createElementBlock(
                  'span',
                  {
                  ...
                  [
                    ...
                    _createVNode(
                      ...
                      {
                        default: _withCtx(() => [
                          $setup.showTooltip && $props.collapseTagsTooltip
                            ? (_openBlock(),
                              _createElementBlock(
                                'div',
                                {
            ...
            _createElementVNode(
              'input',
              {
                ...
                placeholder:
                  $setup.tags.length === 0
                    ? $props.placeholder || $setup.t('inputtag.placeholder')
                    : '',
...
var __sfc__ = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const showTooltip = ref12(false)
      const dragIndex = ref12(null)
      const dragOverIndex = ref12(null)
      const tags = computed11(() => props.modelValue || [])
      ...
      const collapsedTags = computed11(() => {
        if (!props.collapseTags) {
          return []
        }
        return tags.value.slice(props.maxCollapseTags)
      })
      const collapsedCount = computed11(() => collapsedTags.value.length)
      const isMaxReached = computed11(() => {
      ...
      const separators = computed11(() => {
        if (Array.isArray(props.separator)) {
          return props.separator
        }
        return [props.separator]
      })
      const inputTagClasses = computed11(() => [
        ns.b(),
