      ...
      _renderSlot(_ctx.$slots, "default", {}, () => [
        $props.options && $props.options.length ? (_openBlock(true), _createElementBlock(
          ...
          _renderList($props.options, (item) => {
            return _openBlock(), _createBlock($setup["YhCheckbox"], {
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, formItem, validate, labelId, globalSize, changeEvent, themeStyle, modelValue, size, disabled, min, max, groupClasses, computed, provide, toRefs, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useId() {
      ...
      return useConfig;
    }, YhCheckbox, get checkboxGroupContextKey() {
