...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { themeStyle } = useComponentTheme("checkbox", computed(() => props.themeOverrides || (checkboxGroup == null ? void 0 : checkboxGroup.themeOverrides)));
    const inputRef = ref();
    ...
    const __returned__ = { props, emit, ns, checkboxGroup, themeStyle, inputRef, focused, hovering, globalSize, isGroup, checkboxSize, isDisabled, isLimitDisabled, actualDisabled, isChecked, checkboxClasses, innerClasses, handleChange, handleFocus, handleBlur, focus, blur, computed, ref, inject, onMounted, watch, get useNamespace() {
      return useNamespace;
    }, get useConfig() {
      return useConfig;
