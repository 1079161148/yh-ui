// public/codesandbox-runtime/components/price/src/price.js
...
import { ref as ref2, computed, onMounted, watch } from "vue";
...
// public/codesandbox-runtime/components/price/src/price-meta.js
var priceProps = {
  /** 价格数值 */
  value: {
    type: [Number, String],
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "div",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.m($setup.props.size), $setup.ns.is("line-through", $setup.props.lineThrough), $setup.ns.is("bold", $setup.props.bold), $setup.ns.is("split", $setup.props.split), $setup.ns.is("gradient", !!$setup.props.gradient)]),
      style: _normalizeStyle($setup.containerStyle)
    },
    [
      _createCommentVNode(" \u6807\u7B7E\u533A\u57DF "),
      $setup.props.tag || _ctx.$slots.tag ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          class: _normalizeClass([$setup.ns.e("tag"), $setup.ns.em("tag", $setup.props.tagType)])
        },
        [
      ...
      $setup.props.approx ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
      ...
      $setup.props.prefix ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 2,
      ...
      $setup.props.symbolPosition === "before" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 3,
      ...
      _createElementVNode(
        ...
        [
          ...
          $setup.maxParts ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [
              _createElementVNode(
      ...
      $setup.props.symbolPosition === "after" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 4,
          class: _normalizeClass($setup.ns.e("symbol"))
      ...
      $setup.props.unit || _ctx.$slots.unit ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 5,
      ...
      $setup.props.suffix ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 6,
      ...
      _ctx.deleteValue !== void 0 && $setup.deleteParts ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 7,
        ...
        [
          _ctx.deleteLabel ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
          ...
          _createElementVNode(
            "span",
            null,
            _toDisplayString($setup.deleteParts.integer) + _toDisplayString($setup.deleteParts.decimal),
            1
            /* TEXT */
          )
        ],
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhPrice" }, {
  __name: "price",
  props: priceProps,
  setup(__props, { expose: __expose }) {
    ...
    const displayValue = ref2(props.animated ? 0 : Number(props.value));
    const displayMax = ref2(props.animated ? 0 : Number(props.maxValue));
    let rafId = null;
    ...
    const __returned__ = { props, ns, displayValue, displayMax, get rafId() {
      return rafId;
    }, set rafId(v) {
      rafId = v;
    }, startAnimation, triggerAllAnimations, format, getParts, mainParts, maxParts, deleteParts, containerStyle, ref: ref2, computed, onMounted, watch, get useNamespace() {
      return useNamespace;
    }, get priceProps() {
      return priceProps;
    } };
