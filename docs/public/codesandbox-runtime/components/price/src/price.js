...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhPrice" }, {
  __name: "price",
  props: priceProps,
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, displayValue, displayMax, get rafId() {
      ...
      rafId = v;
    }, startAnimation, triggerAllAnimations, format, getParts, mainParts, maxParts, deleteParts, containerStyle, ref, computed, onMounted, watch, get useNamespace() {
      return useNamespace;
    }, get priceProps() {
      return priceProps;
    } };
