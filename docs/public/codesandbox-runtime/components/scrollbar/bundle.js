// public/codesandbox-runtime/components/scrollbar/src/scrollbar.js
import { renderSlot as _renderSlot, resolveDynamicComponent as _resolveDynamicComponent, normalizeClass as _normalizeClass2, normalizeStyle as _normalizeStyle2, withCtx as _withCtx2, openBlock as _openBlock2, createBlock as _createBlock2, createElementVNode as _createElementVNode2, createVNode as _createVNode, Fragment as _Fragment, createElementBlock as _createElementBlock, createCommentVNode as _createCommentVNode } from "vue";
import { computed as computed3, onMounted, onBeforeUnmount as onBeforeUnmount2, provide as provide2, ref as ref3, watch, nextTick } from "vue";

// public/codesandbox-runtime/components/scrollbar/src/scrollbar-meta.js
...
// public/codesandbox-runtime/components/scrollbar/src/thumb.js
import { normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, createElementVNode as _createElementVNode, vShow as _vShow, withDirectives as _withDirectives, Transition as _Transition, withCtx as _withCtx, openBlock as _openBlock, createBlock as _createBlock } from "vue";
import { computed, inject as inject2, onBeforeUnmount, ref as ref2 } from "vue";

// public/codesandbox-runtime/components/scrollbar/src/util.js
var BAR_MAP = {
  vertical: {
    offset: "offsetHeight",
    scroll: "scrollTop",
...
var __sfc__ = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const clickTrackHandler = (e) => {
      var _a;
      if (!thumb.value || !instance.value || !((_a = scrollbar.wrapElement) == null ? void 0 : _a.value)) return;
    ...
    const mouseMoveDocumentHandler = (e) => {
      var _a;
      if (!instance.value || !thumb.value || !((_a = scrollbar.wrapElement) == null ? void 0 : _a.value)) return;
    ...
    const __returned__ = { props, ns, scrollbar, instance, thumb, thumbState, visible, get cursorDown() {
      return cursorDown;
    }, set cursorDown(v) {
      cursorDown = v;
    }, get cursorLeave() {
      ...
      cursorLeave = v;
    }, bar, thumbStyle, clickTrackHandler, clickThumbHandler, startDrag, mouseMoveDocumentHandler, mouseUpDocumentHandler, mouseMoveScrollbarHandler, get timeout() {
      return timeout;
    }, set timeout(v) {
      timeout = v;
    }, computed, inject: inject2, onBeforeUnmount, ref: ref2, get BAR_MAP() {
      return BAR_MAP;
  ...
  return _openBlock2(), _createElementBlock(
    ...
    [
      _createElementVNode2(
        ...
        {
          ref: "wrap",
          class: _normalizeClass2([$setup.ns.e("wrap"), _ctx.native ? "" : $setup.ns.em("wrap", "hidden-native")]),
          style: _normalizeStyle2($setup.wrapStyle),
          onScroll: $setup.handleScroll
        },
        [
          (_openBlock2(), _createBlock2(_resolveDynamicComponent(_ctx.tag), {
            ref: "resize",
      ...
      !_ctx.native ? (_openBlock2(), _createElementBlock(
        _Fragment,
        { key: 0 },
        [
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, scrollbar, wrap, resize, sizeWidth, sizeHeight, moveX, moveY, ratioY, ratioX, horizontalThumb, verticalThumb, wrapStyle, handleScroll, handleMouseEnter, handleMouseLeave, update, get resizeObserver() {
      ...
      resizeObserver = v;
    }, computed: computed3, onMounted, onBeforeUnmount: onBeforeUnmount2, provide: provide2, ref: ref3, watch, nextTick, get scrollbarProps() {
      return scrollbarProps;
    }, get scrollbarEmits() {
      return scrollbarEmits;
    }, get SCROLLBAR_INJECTION_KEY() {
      return SCROLLBAR_INJECTION_KEY;
    }, Thumb: stdin_default, get useNamespace() {
      return useNamespace;
