// docs/public/codesandbox-runtime/components/ai-conversations/src/ai-conversations.js
import {
...
import { ref as ref12, computed as computed11, nextTick } from 'vue'
...
function useVirtualScroll(options) {
  ...
  const overscanRef = computed7(() => {
    var _a2
    return (_a2 = unref6(options.overscan)) != null ? _a2 : 3
  })
...
// docs/public/codesandbox-runtime/components/ai-conversations/src/ai-conversations-meta.js
var aiConversationsProps = {
  /**
...
var _hoisted_3 = ['onBlur', 'onKeydown']
                ...
                _createElementVNode(
                  'div',
                  {
                    ...
                    class: _normalizeClass([
                      $setup.ns.e('list'),
                      $setup.ns.is('virtual', _ctx.virtualScroll)
                    ]),
                    style: _normalizeStyle($setup.listStyle),
                    onScrollPassive:
                      _cache[4] ||
                      (_cache[4] = ($event) =>
                        _ctx.virtualScroll ? $setup.handleVirtualScroll($event) : void 0)
                  },
                  [
                    _createCommentVNode(' \u65F6\u95F4\u5206\u7EC4\u6E32\u67D3 '),
                    $setup.groupedData.length > 0
                      ? (_openBlock(true),
                        _createElementBlock(
                          _Fragment,
                          { key: 0 },
                                    ...
                                    [
                                      _renderSlot(
                                        ...
                                        () => [
                                          _createTextVNode(
                                            _toDisplayString(
                                              $setup.t(`ai.conversations.${group.label}`)
                                            ),
                                            1
                                            /* TEXT */
                                          )
                                              ...
                                              _createElementBlock(
                                                'div',
                                                {
                                                  ...
                                                  class: _normalizeClass([
                                                    ...
                                                    $setup.ns.is(
                                                      'active',
                                                      _ctx.activeId === item.id
                                                    ),
                                                    $setup.ns.is('pinned', !!item.pinned)
                                                  ]),
                                                ...
                                                [
                                                  ...
                                                  _createElementVNode(
                                                    ...
                                                    {
                                                      class: _normalizeClass(
                                                        $setup.ns.e('item-content')
                                                      )
                                                    },
                                                    [
                                                      !$setup.editingId ||
                                                      $setup.editingId !== item.id
                                                        ? (_openBlock(),
                                                          _createElementBlock(
                                                            'span',
                                                            {
                                                            ...
                                                            _createElementBlock(
                                                              'input',
                                                              {
                                                                ...
                                                                'onUpdate:modelValue':
                                                                  _cache[0] ||
                                                                  (_cache[0] = ($event) =>
                                                                    ($setup.editTitle = $event)),
                                                                class: _normalizeClass(
                                                                  $setup.ns.e('input')
                                                                ),
                                                                onBlur: ($event) =>
                                                                  $setup.confirmEdit(item),
                                                                onKeydown: [
                                                                  _withKeys(
                                                                    ($event) =>
                                                                      $setup.confirmEdit(item),
                                                      ...
                                                      item.updatedAt
                                                        ? (_openBlock(),
                                                          _createElementBlock(
                                                            ...
                                                            _toDisplayString(
                                                              $setup.formatTime(item.updatedAt)
                                                            ),
                                                            3
                                                            /* TEXT, CLASS */
                                                          ))
                                                  ...
                                                  !$setup.editingId || $setup.editingId !== item.id
                                                    ? (_openBlock(),
                                                      _createElementBlock(
                                                        'div',
                                                        {
                                                        ...
                                                        [
                                                          ...
                                                          _createElementVNode(
                                                            'span',
                                                            {
                                                              ...
                                                              title: item.pinned
                                                                ? $setup.t('ai.conversations.unpin')
                                                                : $setup.t('ai.conversations.pin'),
                                                              onClick: _withModifiers(
                                                                ($event) => $setup.handlePin(item),
                                                                ['stop']
                                                              )
                                                            },
                                                            [
                      ...
                      : _ctx.data.length > 0 && !$setup.showGroups
                        ? (_openBlock(),
                          _createElementBlock(
                            _Fragment,
                            { key: 1 },
                                                  ...
                                                  return (
                                                    ...
                                                    _createElementBlock(
                                                      'div',
                                                      {
                                                        ...
                                                        style: _normalizeStyle({
                                                          height:
                                                            _ctx.virtualScrollItemHeight + 'px'
                                                        }),
                                                        onClick: ($event) =>
                                                          $setup.handleClick(item)
                                                      },
                                                      [
                                                        item.pinned
                                                          ? (_openBlock(),
                                          ...
                                          return (
                                            ...
                                            _createElementBlock(
                                              'div',
                                              {
                                                ...
                                                class: _normalizeClass([
                                                  $setup.ns.e('item'),
                                                  $setup.ns.is('active', _ctx.activeId === item.id)
                                                ]),
                                                onClick: ($event) => $setup.handleClick(item)
                                              },
                                              [
...
var __sfc__ = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const editingId = ref12(null)
      const editTitle = ref12('')
      const inputRef = ref12()
      const showGroups = computed11(() => props.grouped !== false && !props.virtualScroll)
      const {
        visibleItems,
        totalHeight,
        offsetY,
        ...
        itemHeight: computed11(() => props.virtualScrollItemHeight),
        containerHeight: computed11(() => props.virtualScrollHeight),
        overscan: computed11(() => props.virtualScrollOverscan),
        items: computed11(() => props.data)
      })
      const listStyle = computed11(() => {
      ...
      const startEdit = (item) => {
        ...
        nextTick(() => {
          var _a2
          if ((_a2 = inputRef.value) == null ? void 0 : _a2[0]) inputRef.value[0].focus()
        })
      }
