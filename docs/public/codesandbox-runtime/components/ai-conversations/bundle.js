...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, editingId, editTitle, inputRef, showGroups, visibleItems, totalHeight, offsetY, handleVirtualScroll, scrollToIndex, listStyle, getGroupKey, groupedData, handleCreate, handleClick, handleDelete, handlePin, startEdit, confirmEdit, cancelEdit, formatTime, scrollToItem, ref: ref12, computed: computed11, nextTick, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
