...
const _hoisted_1 = ["id", "value", "placeholder", "disabled", "readonly", "maxlength", "rows", "autofocus", "aria-expanded", "aria-controls", "aria-activedescendant"];
const _hoisted_2 = ["id", "value", "placeholder", "disabled", "readonly", "maxlength", "autofocus", "aria-expanded", "aria-controls", "aria-activedescendant"];
const _hoisted_3 = ["id"];
        ...
        _createVNode(_Transition, {
          ...
          default: _withCtx(() => [
            _withDirectives(_createElementVNode("div", {
              ...
              style: _normalizeStyle($props.teleported ? __spreadValues(__spreadValues({}, $setup.themeStyle), $setup.dropdownStyle) : $setup.themeStyle),
              role: "listbox",
                            ...
                            _renderList(groupOpts, (option) => {
                              ...
                              return _openBlock(), _createElementBlock("div", {
                                ...
                                _renderSlot(_ctx.$slots, "option", {
                                  option,
                                  keyword: (_b = (_a = $setup.triggerPos) == null ? void 0 : _a.keyword) != null ? _b : ""
                                }, () => {
                                  var _a2, _b2;
                                  return [
                                    ...
                                    option.avatar ? (_openBlock(), _createElementBlock("img", {
                                      ...
                                      alt: (_a2 = option.label) != null ? _a2 : option.value
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhMention" }, {
  __name: "mention",
  props: {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const mentionDisabled = computed(() => props.disabled || (form == null ? void 0 : form.disabled) || false);
    const inputRef = ref();
    ...
    const filteredOptions = computed(() => {
      var _a, _b;
      const keyword = (_b = (_a = triggerPos.value) == null ? void 0 : _a.keyword) != null ? _b : "";
    ...
    const selectOption = (option) => {
      ...
      const after = (() => {
        var _a2, _b2, _c, _d;
        const cursor = (_c = (_a2 = inputRef.value) == null ? void 0 : _a2.selectionStart) != null ? _c : ((_b2 = props.modelValue) != null ? _b2 : "").length;
    ...
    const handleOutsideClick = (e) => {
      ...
      if (((_a = wrapperRef.value) == null ? void 0 : _a.contains(target)) || ((_b = dropdownRef.value) == null ? void 0 : _b.contains(target))) return;
      dropdownVisible.value = false;
      triggerPos.value = null;
    };
    const handleResize = () => {
    ...
    const __returned__ = { props, emit, slots, ns, inputId, t, nextZIndex, themeStyle, form, formItem, triggerValidate, globalSize, mentionSize, mentionDisabled, inputRef, wrapperRef, dropdownRef, focused, hovering, dropdownVisible, isClickingDropdown, highlightedIndex, dropdownZIndex, triggerPos, filteredOptions, groupedOptions, wrapperClasses, dropdownStyle, updateDropdownPosition, parseTrigger, get debounceTimer() {
      ...
      debounceTimer = v;
    }, debouncedSearch, handleInput, handleChange, handleFocus, handleBlur, handleKeydown, selectOption, showClear, handleClear, handleOutsideClick, handleResize, insertMention, focus, blur, clear, textLength, ref, computed, watch, nextTick, onMounted, onBeforeUnmount, useSlots, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useId() {
