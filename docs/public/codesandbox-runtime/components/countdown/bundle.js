// public/codesandbox-runtime/components/countdown/src/countdown.js
...
// public/codesandbox-runtime/components/countdown/src/countdown-meta.js
...
function createFormatContext(remain) {
  ...
  return __spreadProps(__spreadValues2({}, units), {
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _createElementVNode(
        ...
        [
          _createCommentVNode(" \u9ED8\u8BA4\u63D2\u69FD\uFF1A\u5B8C\u5168\u81EA\u5B9A\u4E49\u6E32\u67D3 "),
          _renderSlot(_ctx.$slots, "default", {
            ...
            _ctx.flipAnimation ? (_openBlock(true), _createElementBlock(
              _Fragment,
              { key: 0 },
                    ...
                    _createElementVNode(
                      ...
                      [
                        _createElementVNode(
                          ...
                          [
                            _renderSlot(_ctx.$slots, `${digit.key}-cell`, {
                              value: digit.value
                            }, () => [
                              _createElementVNode(
                                "span",
                        ...
                        digit.label ? (_openBlock(), _createElementBlock(
                          "span",
                          {
                            key: 0,
      ...
      _renderSlot(_ctx.$slots, "suffix", {}, () => [
        _ctx.suffix ? (_openBlock(), _createElementBlock(
          "span",
          {
            key: 0,
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const status = ref12("pending");
    const remain = ref12(getInitialRemain());
    const startTime = ref12(0);
    const pausedRemain = ref12(remain.value);
    const hasWarned = ref12(false);
    const rafId = ref12(null);
    const prevUpdateTime = ref12(0);
    const formatContext = computed11(() => createFormatContext(remain.value));
    const displayText = computed11(() => formatCountdown(props.format, formatContext.value));
    const shouldShowDays = computed11(() => {
      if (props.showDays === true) return true;
      if (props.showDays === false) return false;
      return formatContext.value.days > 0;
    });
    const isWarning = computed11(() => {
      if (!props.warningThreshold) return false;
      return remain.value > 0 && remain.value <= props.warningThreshold;
    });
    const isFinished = computed11(() => status.value === "finished");
    ...
    const valueStyleComputed = computed11(() => {
    ...
    function getInitialRemain() {
      var _a2;
      const serverOffset = (_a2 = props.serverTimeOffset) != null ? _a2 : 0;
    ...
    function tick() {
      ...
      const shouldUpdate = now - prevUpdateTime.value >= props.interval || newRemain === 0 || Math.floor(remain.value / props.precision) !== Math.floor(newRemain / props.precision);
      if (shouldUpdate) {
    ...
    const digits = computed11(() => {
      var _a2, _b, _c, _d, _e;
      const ctx = formatContext.value;
      const result = [];
      if (shouldShowDays.value) {
        result.push({ key: "days", value: ctx.DD, label: ((_a2 = props.labels) == null ? void 0 : _a2.days) || t("countdown.days") });
      }
      if (props.showHours) {
        result.push({ key: "hours", value: ctx.HH, label: ((_b = props.labels) == null ? void 0 : _b.hours) || t("countdown.hours") });
      }
      ...
      if (props.showMilliseconds) {
        result.push({
          key: "milliseconds",
          value: ctx.SSS,
          label: ((_e = props.labels) == null ? void 0 : _e.milliseconds) || t("countdown.milliseconds")
        });
      }
      return result;
    });
    const __returned__ = { props, emit, ns, t, themeStyle, status, remain, startTime, pausedRemain, hasWarned, rafId, prevUpdateTime, formatContext, displayText, shouldShowDays, isWarning, isFinished, rootClass, valueStyleComputed, getInitialRemain, tick, start, pause, resume, reset, finish, getRemain, getStatus, digits, ref: ref12, computed: computed11, watch: watch4, onMounted: onMounted3, onUnmounted: onUnmounted4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
