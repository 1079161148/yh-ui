// docs/public/codesandbox-runtime/components/countdown/src/countdown.js
import {
...
// docs/public/codesandbox-runtime/components/countdown/src/countdown-meta.js
      ...
      const digits = computed11(() => {
        ...
        if (shouldShowDays.value) {
          result.push({
            key: 'days',
            value: ctx.DD,
            label: ((_a2 = props.labels) == null ? void 0 : _a2.days) || t('countdown.days')
          })
        }
        if (props.showHours) {
          result.push({
