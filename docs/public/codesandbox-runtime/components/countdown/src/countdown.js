  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const digits = computed(() => {
      ...
      if (shouldShowDays.value) {
        result.push({ key: "days", value: ctx.DD, label: ((_a = props.labels) == null ? void 0 : _a.days) || t("countdown.days") });
      }
      if (props.showHours) {
