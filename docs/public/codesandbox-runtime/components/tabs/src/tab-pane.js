import { renderSlot as _renderSlot, vShow as _vShow, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, withDirectives as _withDirectives, openBlock as _openBlock, createElementBlock as _createElementBlock, createCommentVNode as _createCommentVNode } from "vue";
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.shouldRender ? _withDirectives((_openBlock(), _createElementBlock(
    "div",
    {
      key: 0,
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    onMounted(() => {
      tabsContext == null ? void 0 : tabsContext.registerPane({
    ...
    const __returned__ = { props, ns, themeStyle, tabsContext, hasRendered, isActive, shouldRender, computed, inject, onMounted, onUnmounted, ref, watch, get useNamespace() {
      return useNamespace;
