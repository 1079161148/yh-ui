// public/codesandbox-runtime/components/tabs/src/tabs.js
...
import { ref as ref2, computed as computed2, provide as provide2, watch, onMounted, nextTick } from "vue";
...
// public/codesandbox-runtime/components/tabs/src/tabs-meta.js
var tabsProps = {
  /** 当前激活的标签名 */
  modelValue: {
    type: [String, Number],
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, panes, activeTab, navRef, indicatorRef, registerPane, unregisterPane, activateTab, get hoverTimer() {
      ...
      hoverTimer = v;
    }, handleTabClick, handleTabHover, handleTabRemove, handleTabAdd, updateIndicator, isClosable, isAddable, tabsClass, tabsStyle, ref: ref2, computed: computed2, provide: provide2, watch, onMounted, nextTick, get useNamespace() {
      return useNamespace;
