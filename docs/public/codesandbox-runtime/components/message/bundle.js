// public/codesandbox-runtime/components/message/src/message.js
...
import { computed as computed11, onMounted as onMounted3, ref as ref12, watch as watch4 } from "vue";
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    let timer = null;
    const messageClasses = computed11(() => [
      ns.b(),
      ns.m(props.type),
    ...
    const messageStyles = computed11(() => {
      var _a2;
      const styles = {
        zIndex: props.zIndex
      };
      if ((_a2 = props.placement) == null ? void 0 : _a2.startsWith("top")) {
    ...
    const showRepeatNum = computed11(() => props.grouping && (props.repeatNum || 1) > 1);
    const startTimer = () => {
      if (props.duration > 0) {
        timer = setTimeout(() => {
          close();
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, visible, get timer() {
      ...
      timer = v;
    }, messageClasses, messageStyles, showRepeatNum, startTimer, clearTimer, close, handleMouseEnter, handleMouseLeave, onDestroy, computed: computed11, onMounted: onMounted3, ref: ref12, watch: watch4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
