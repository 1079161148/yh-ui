...
// public/codesandbox-runtime/components/ai-voice-trigger/src/ai-voice-trigger.js
import { createCommentVNode as _createCommentVNode2, normalizeClass as _normalizeClass, createElementVNode as _createElementVNode, renderList as _renderList, Fragment as _Fragment2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, normalizeStyle as _normalizeStyle, toDisplayString as _toDisplayString, createVNode as _createVNode, Transition as _Transition, withCtx as _withCtx, createBlock as _createBlock2, renderSlot as _renderSlot2, createTextVNode as _createTextVNode, Teleport as _Teleport } from "vue";
...
// public/codesandbox-runtime/components/ai-voice-trigger/src/ai-voice-trigger.js
import { computed as computed12, ref as ref12, onBeforeUnmount as onBeforeUnmount2, watch as watch4 } from "vue";

// public/codesandbox-runtime/components/ai-voice-trigger/src/ai-voice-trigger-meta.js
var aiVoiceTriggerProps = {
  /**
   * 是否正在录音
   */
  recording: {
    ...
    _createElementVNode(
      ...
      [
        _createElementVNode(
          ...
          [
            _createCommentVNode2(" Waveform Visualizer "),
            _createVNode(_Transition, { name: "yh-voice-expand" }, {
              default: _withCtx(() => [
                $setup.props.recording || $setup.localRecording ? (_openBlock2(), _createElementBlock2(
                  "div",
                  {
                    key: 0,
                  ...
                  [
                    _createCommentVNode2(" Sphere Visualizer (Pulsing Ball) "),
                    $setup.props.variant === "sphere" ? (_openBlock2(), _createElementBlock2(
                      _Fragment2,
                      { key: 0 },
                      [
                        _createElementVNode(
                      ...
                      { key: 1 },
                      [
                        _createCommentVNode2(" Standard Wave Visualizer "),
                        _createElementVNode(
                          "div",
                          {
                    ...
                    _createCommentVNode2(" Cancel Button "),
                    _createElementVNode(
                      "button",
                      {
            ...
            _createCommentVNode2(" Main Trigger Button "),
            _createElementVNode(
              "button",
              {
              ...
              [
                _createElementVNode(
                  ...
                  [
                    $setup.props.variant === "sphere" && ($setup.props.recording || $setup.localRecording) ? (_openBlock2(), _createElementBlock2(
                      "div",
                      {
                        key: 0,
                      ...
                      2
                      /* CLASS */
                    )) : (_openBlock2(), _createBlock2($setup["YhIcon"], {
                      key: 1,
                ...
                !($setup.props.recording || $setup.localRecording) && $setup.props.variant === "inline" ? (_openBlock2(), _createElementBlock2(
                  "span",
                  {
                    key: 0,
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const localRecording = ref12(props.recording);
    let visualizerTimer = null;
    const simulatedAmplitudes = ref12(Array(20).fill(5));
    watch4(
      () => props.amplitudes,
      (newAmps) => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, localRecording, get visualizerTimer() {
      ...
      return useComponentTheme;
    }, computed: computed12, ref: ref12, onBeforeUnmount: onBeforeUnmount2, watch: watch4, get aiVoiceTriggerProps() {
