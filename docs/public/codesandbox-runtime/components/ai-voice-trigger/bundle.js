        ...
        _createElementVNode(
          'div',
          {
            class: _normalizeClass([
              $setup.ns.b(),
              $setup.ns.m($setup.props.variant),
              $setup.ns.m($setup.props.position),
              $setup.ns.is('recording', $setup.props.recording || $setup.localRecording)
            ]),
            style: _normalizeStyle([
              $setup.props.variant !== 'inline'
                ? {
                    position: $setup.props.teleport ? 'fixed' : 'relative',
                    [$setup.props.position.split('-')[0]]: $setup.props.teleport
                      ? $setup.props.offset[0] + 'px'
                      : 'auto',
                    [$setup.props.position.split('-')[1]]: $setup.props.teleport
                      ? $setup.props.offset[1] + 'px'
                      : 'auto'
                  }
                : {},
              $setup.themeStyle
          ...
          [
            _createElementVNode(
              ...
              [
                ...
                _createVNode(
                  _Transition,
                  { name: 'yh-voice-expand' },
                  {
                    default: _withCtx(() => [
                      $setup.props.recording || $setup.localRecording
                        ? (_openBlock2(),
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const syncAmplitudes = () => {
        if (props.recording || localRecording.value) {
          const hasData =
            props.amplitudes && props.amplitudes.some((a) => a > 6 || (a > 0 && a !== 5))
          if (!hasData) {
