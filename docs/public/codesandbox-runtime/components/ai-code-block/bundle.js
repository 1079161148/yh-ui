...
var __sfc__3 = /* @__PURE__ */ Object.assign({ name: "YhAiCodeEditor" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const forceLayout = () => {
      ...
      const h2 = editorRef.value.clientHeight || editorRef.value.offsetHeight || (typeof props.height === "number" ? props.height : 300);
      editor.layout({ width: w, height: h2 });
      editor.render(true);
    };
...
var YhAiCodeEditor = withInstall(stdin_default6);
var stdin_default7 = YhAiCodeEditor;
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const highlightedCodeLines = computed14(() => {
      ...
      try {
        if (props.highlight) {
          if (props.language && stdin_default5.getLanguage(props.language)) {
            html = stdin_default5.highlight(normalizedCode.value, {
              language: props.language,
              ignoreIllegals: true
            }).value;
          } else {
            html = stdin_default5.highlightAuto(normalizedCode.value).value;
          }
        }
      } catch (err) {
