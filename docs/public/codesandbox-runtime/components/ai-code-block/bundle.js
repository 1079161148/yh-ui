    ...
    _createElementBlock4(
      'div',
      {
        class: _normalizeClass3([
          $setup.ns.b(),
          $setup.ns.is('collapsible', _ctx.collapsible),
          $setup.ns.is('collapsed', $setup.collapsed),
          $setup.ns.is('editing', $setup.isEditing)
        ]),
                ...
                _ctx.showEdit && !$setup.isEditing
                  ? (_openBlock4(),
                    _createBlock3(
                      ...
                      {
                        icon: _withCtx2(() => [_createVNode($setup['YhIcon'], { name: 'edit' })]),
                        default: _withCtx2(() => [
                          _createTextVNode(
                    ...
                    default: _withCtx2(() => [
                      _createTextVNode(
                        ' ' +
                          _toDisplayString(
                            $setup.copied
                              ? $setup.t('ai.codeBlock.copied')
                              : $setup.t('ai.codeBlock.copyCode')
                          ),
                        1
                        /* TEXT */
                      )
              ...
              $setup.isEditing
                ? (_openBlock4(),
                  _createElementBlock4(
                    ...
                    [
                      _createVNode(
                        $setup['YhAiCodeEditor'],
                        {
                          'initial-value': $setup.editCode,
                          modelValue: $setup.editCode,
                          'onUpdate:modelValue':
                            _cache[1] || (_cache[1] = ($event) => ($setup.editCode = $event)),
                          language: _ctx.language,
                          height: 300
                        },
                        null,
                        8,
                        ['initial-value', 'modelValue', 'language']
                      ),
                      _createElementVNode3(
                        'div',
                        {
                    ...
                    [
                                  ...
                                  return (
                                    ...
                                    _createElementBlock4(
                                      'span',
                                      {
                                        key: n,
                                        class: _normalizeClass3([
                                          $setup.ns.e('line-number'),
                                          $setup.ns.is('active', _ctx.highlightLines.includes(n))
                                        ])
                                      },
                                      _toDisplayString(n),
                                      3
                      ...
                      _createElementVNode3(
                        ...
                        [
                          !_ctx.$slots.default
                            ? (_openBlock4(),
                              _createElementBlock4('pre', _hoisted_12, [
                                ...
                                _createElementVNode3(
                                  'code',
                                  {
                                    class: _normalizeClass3([
                                      'hljs',
                                      _ctx.language ? 'language-' + _ctx.language : ''
                                    ]),
                            ...
                            : (_openBlock4(),
                              _createElementBlock4('pre', _hoisted_3, [
                                _createElementVNode3(
                                  'code',
                                  {
                                    class: _normalizeClass3([
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const slotCode = computed14(() => {
        var _a2, _b
        const vnodes =
          (_b = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _b : []
