...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  `;
    ...
    const __returned__ = { props, ns, componentId, themeStyle, percentages, isGradient, getGradientStops, barStyle, getColor, getCircleParams, secondaryBarStyle, content, statusIconSvg, progressClass, computed, useId, get useNamespace() {
      return useNamespace;
