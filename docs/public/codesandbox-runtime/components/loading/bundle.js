        ...
        { name: "yh-loading-fade", appear: true },
        {
          default: () => {
            ...
            return state.visible ? h2(
              ...
              [
                h2("div", { class: "yh-loading-spinner" }, [
                  resolvedOptions.spinner ? typeof resolvedOptions.spinner === "string" ? h2("i", { class: resolvedOptions.spinner }) : isVNode(resolvedOptions.spinner) ? resolvedOptions.spinner : h2(resolvedOptions.spinner) : h2(YhSpin, {
