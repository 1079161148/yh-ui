...
import { createCommentVNode as _createCommentVNode6, normalizeClass as _normalizeClass5, normalizeStyle as _normalizeStyle5, createElementVNode as _createElementVNode5, renderList as _renderList3, Fragment as _Fragment5, openBlock as _openBlock6, createElementBlock as _createElementBlock6, renderSlot as _renderSlot6, mergeProps as _mergeProps2, createVNode as _createVNode3 } from "vue";
import { ref as ref16, computed as computed16, watch as watch6, nextTick as nextTick2, onMounted as onMounted4 } from "vue";
            ...
            [
              _ctx.loading && !_ctx.content ? (_openBlock5(), _createElementBlock5(
                ...
                [
                  ...
                  _ctx.multimodal && _ctx.multimodal.some((m2) => m2.type === "image") ? (_openBlock5(), _createElementBlock5(
                    "div",
                    {
                      key: 0,
                    ...
                    [
                      (_openBlock5(true), _createElementBlock5(
                        _Fragment4,
                        null,
                        _renderList2(_ctx.multimodal.filter((m2) => m2.type === "image"), (img, idx) => {
                          return _openBlock5(), _createElementBlock5(
                            "div",
                            {
                              key: idx,
                                ...
                                _createElementVNode4("thead", null, [
                                  _ctx.structuredData.data && _ctx.structuredData.data.headers ? (_openBlock5(), _createElementBlock5("tr", _hoisted_5, [
                                    (_openBlock5(true), _createElementBlock5(
                                      _Fragment4,
                                      null,
                                      _renderList2(_ctx.structuredData.data.headers, (h2) => {
                                        return _openBlock5(), _createElementBlock5(
                                          "th",
                                          { key: h2 },
      ...
      const md = new stdin_default6({
        ...
        highlight: function(str, lang) {
          ...
          if (hlLang && stdin_default8.getLanguage(hlLang)) {
            try {
              result = stdin_default8.highlight(str, { language: hlLang, ignoreIllegals: true }).value;
            } catch (e) {
            }
          } else {
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock6(), _createElementBlock6(
    "div",
    {
      ...
      ref: "scrollRef",
      onScroll: _cache[0] || (_cache[0] = ($event) => _ctx.virtualScroll ? $setup.onScroll($event) : void 0)
    },
    [
      _createCommentVNode6(" \u865A\u62DF\u6EDA\u52A8\u6A21\u5F0F "),
      _ctx.virtualScroll ? (_openBlock6(), _createElementBlock6(
        _Fragment5,
        { key: 0 },
        [
              ...
              (_openBlock6(true), _createElementBlock6(
                ...
                _renderList3($setup.visibleItems, (item, index) => {
                  return _openBlock6(), _createElementBlock6(
                    ...
                    [
                      _renderSlot6(_ctx.$slots, "bubble", {
                        item,
...
var __sfc__6 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, scrollRef, visibleItems, totalHeight, offsetY, startIndex, onScroll, scrollToIndex, scrollToBottom, ref: ref16, computed: computed16, watch: watch6, nextTick: nextTick2, onMounted: onMounted4, get useNamespace() {
      return useNamespace;
    }, get useVirtualScroll() {
      return useVirtualScroll;
    }, get useComponentTheme() {
      return useComponentTheme;
    }, YhAiBubble: stdin_default9, get aiBubbleListProps() {
