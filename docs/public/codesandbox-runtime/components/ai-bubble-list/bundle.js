  ...
  'public/codesandbox-runtime/dayjs-locale/ar.js'() {
    ...
    locale10 = {
      ...
      preparse: function preparse(string) {
        return string
          .replace(fromArabNumeralsRegex, function (match2) {
      ...
      postformat: function postformat(string) {
        return string
          .replace(toArabNumeralsRegex, function (match2) {
  ...
  'public/codesandbox-runtime/dayjs-locale/ku.js'() {
    ...
    locale77 = {
      ...
      preparse: function preparse4(string) {
        return string
          .replace(/[١٢٣٤٥٦٧٨٩٠]/g, function (match2) {
      ...
      get editorOrigin() {
        ...
        if (editorOrigin == null) {
          editorOrigin = new URL(
            (_a4 = globalThis.WEBCONTAINER_API_IFRAME_URL) != null ? _a4 : DEFAULT_EDITOR_ORIGIN
          ).origin
        }
        return editorOrigin
      },
  ...
  '../node_modules/@webcontainer/api/dist/internal/auth-state.js'() {
    ...
    auth = {
      ...
      async logout({ ignoreRevokeError } = {}) {
        var _a4
        await ((_a4 = authState.tokens) == null
          ? void 0
          : _a4.revoke(authState.clientId, ignoreRevokeError != null ? ignoreRevokeError : false))
        loggedOutListeners.fireEvent()
        broadcastMessage({ type: 'auth-logout' })
      },
      loggedIn() {
...
var init_vendor = __esm({
  '../node_modules/@webcontainer/api/dist/vendor/index.js'() {
    ...
    __export2 = (target, all) => {
      for (var name in all) __defProp6(target, name, { get: all[name], enumerable: true })
    }
    comlink_exports = {}
...
function reloadPreview(preview, hardRefreshTimeout = 200) {
  ...
  ;(_a4 = preview.contentWindow) == null
    ? void 0
    : _a4.postMessage(
        {
...
// public/codesandbox-runtime/components/ai-bubble-list/src/ai-bubble-list.js
import {
...
var useLocale = (localeOverrides) => {
  ...
  const locale143 = computed5(() => {
    var _a4, _b
    return (_b = (_a4 = unref4(localeOverrides)) != null ? _a4 : unref4(globalLocale)) != null
      ? _b
      : zhCn
  })
...
function useVirtualScroll(options) {
  ...
  const overscanRef = computed7(() => {
    var _a4
    return (_a4 = unref6(options.overscan)) != null ? _a4 : 3
  })
...
var YhAvatar = withInstall(stdin_default3)
    ...
    _createBlock2(
      ...
      },
      {
        default: _withCtx(() => [
          ...
          $props.loading
            ? _renderSlot2(_ctx.$slots, 'loading', { key: 0 }, () => [
                ...
                [
                  _renderSlot2(_ctx.$slots, 'icon', {}, () => [
                    $props.icon && typeof $props.icon !== 'string'
                      ? (_openBlock2(),
                        _createBlock2(_resolveDynamicComponent2($props.icon), { key: 0 }))
                      : _createCommentVNode2('v-if', true)
                  ])
                ],
                2
                ...
                [
                  _renderSlot2(_ctx.$slots, 'suffixIcon', {}, () => [
                    $props.suffixIcon && typeof $props.suffixIcon !== 'string'
                      ? (_openBlock2(),
                        _createBlock2(_resolveDynamicComponent2($props.suffixIcon), { key: 0 }))
                      : _createCommentVNode2('v-if', true)
                  ])
                ],
                2
    ...
    _createElementBlock3(
      ...
      [
        ...
        $setup.useIconComponent
          ? (_openBlock3(),
            _createBlock3(_resolveDynamicComponent3(_ctx.icon), {
              key: 0,
...
function StateBlock(src, md, env, tokens) {
  ...
  const s2 = this.src
  for (
    let start = 0, pos = 0, indent = 0, offset = 0, len = s2.length, indent_found = false;
    pos < len;
    pos++
  ) {
...
function link(state, silent) {
  ...
  if (parseReference) {
    ...
    ref17 = state.env.references[normalizeReference(label)]
    if (!ref17) {
      state.pos = oldPos
      return false
    }
...
function image(state, silent) {
  let code2, content, label, pos, ref17, res, title, start
  let href = ''
  const oldPos = state.pos
  const max = state.posMax
...
var MarkdownIt2 =
  'default' in markdown_it_exports
    ? (_a3 = lib_default) != null
      ? _a3
      : markdown_it_exports
    : markdown_it_exports
var stdin_default6 = MarkdownIt2
...
var YhAiThoughtChain = withInstall(stdin_default7)
  ...
  return (
    ...
    _createElementBlock5(
      ...
      [
                  ...
                  : (_openBlock5(),
                    _createElementBlock5(
                      ...
                      [
                        ...
                        _ctx.multimodal && _ctx.multimodal.some((m2) => m2.type === 'image')
                          ? (_openBlock5(),
                            _createElementBlock5(
                              'div',
                              {
                              ...
                              [
                                ...
                                _createElementBlock5(
                                  ...
                                  null,
                                  _renderList2(
                                    _ctx.multimodal.filter((m2) => m2.type === 'image'),
                                    (img, idx) => {
                                      return (
                                        _openBlock5(),
                                        _createElementBlock5(
                                              ...
                                              _createElementVNode4('table', null, [
                                                _createElementVNode4('thead', null, [
                                                  ...
                                                  _ctx.structuredData.data.headers
                                                    ? (_openBlock5(),
                                                      _createElementBlock5('tr', _hoisted_5, [
                                                        (_openBlock5(true),
                                                        _createElementBlock5(
                                                          _Fragment4,
                                                          null,
                                                ...
                                                typeof _ctx.structuredData.data === 'object'
                                                  ? (_openBlock5(),
                                                    _createElementBlock5('tbody', _hoisted_6, [
                                                      (_openBlock5(true),
                                                      _createElementBlock5(
                                                        _Fragment4,
                                                        null,
        ...
        (_openBlock5(),
        _createBlock5(_Teleport, { to: 'body' }, [
          _createVNode2(
            _Transition2,
  ...
  `
      ...
      const jsonHtml = computed15(() => {
        ...
        try {
          ...
          if (stdin_default8.getLanguage('json')) {
            return stdin_default8.highlight(jsonString, {
              language: 'json',
              ignoreIllegals: true
            }).value
          }
      ...
      const handleCitationHover = (e) => {
        ...
        if (target && target.classList && target.classList.contains('yh-ai-citation')) {
          ...
          const citation =
            (_a4 = props.citations) == null ? void 0 : _a4.find((c) => String(c.id) === id)
          if (citation) {
      ...
      const getMarkdownInstance = () => {
        ...
        const md = new stdin_default6({
          ...
          highlight: function (str, lang) {
            ...
            if (hlLang && stdin_default8.getLanguage(hlLang)) {
              try {
                result = stdin_default8.highlight(str, {
                  language: hlLang,
                  ignoreIllegals: true
                }).value
              } catch (e) {}
        ...
        md.block.ruler.before('code', 'mermaid', (state, startLine, _endLine, silent) => {
...
var stdin_default9 = __sfc__5

// public/codesandbox-runtime/components/ai-bubble-list/src/ai-bubble-list-meta.js
var aiBubbleListProps = {
  /**
   * 消息列表
   */
  items: {
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    _createElementBlock6(
      'div',
      {
        class: _normalizeClass5([$setup.ns.b(), $setup.ns.is('virtual', _ctx.virtualScroll)]),
            ...
            _createElementBlock6(
              ...
              [
                _createElementVNode5(
                  'div',
                  {
                    class: _normalizeClass5($setup.ns.e('virtual-phantom')),
                    style: _normalizeStyle5({
                ...
                _createElementVNode5(
                  'div',
                  {
                    class: _normalizeClass5($setup.ns.e('virtual-content')),
                    style: _normalizeStyle5({
                  ...
                  [
                    ...
                    _createElementBlock6(
                      _Fragment5,
                      null,
                      _renderList3($setup.visibleItems, (item, index) => {
                        return (
                          _openBlock6(),
                          _createElementBlock6(
                            'div',
                            {
                              ...
                              class: _normalizeClass5($setup.ns.e('item'))
                            },
                            [
                              _renderSlot6(
                                _ctx.$slots,
                                ...
                                () => [
                                  _createVNode3(
                                    $setup['YhAiBubble'],
                                    _mergeProps2({ ref_for: true }, item),
                                    null,
                                    16
                                    /* FULL_PROPS */
                                  )
                ...
                _createElementVNode5(
                  ...
                  [
                    ...
                    _createElementBlock6(
                      _Fragment5,
                      null,
                      _renderList3(_ctx.items, (item, index) => {
                        return (
                          _openBlock6(),
                          _createElementBlock6(
                            'div',
        ...
        _ctx.loading
          ? (_openBlock6(),
            _createElementBlock6(
              ...
              {
                key: 2,
                class: _normalizeClass5($setup.ns.e('loading'))
              },
              [
                _renderSlot6(_ctx.$slots, 'loading', {}, () => [
                  _createVNode3($setup['YhAiBubble'], {
                    role: 'assistant',
                    loading: '',
                    variant: 'borderless'
                  })
...
__sfc__6.render = render7
var stdin_default10 = __sfc__6
export { stdin_default10 as default }
