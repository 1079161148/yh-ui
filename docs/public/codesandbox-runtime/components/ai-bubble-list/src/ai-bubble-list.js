...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, scrollRef, visibleItems, totalHeight, offsetY, startIndex, onScroll, scrollToIndex, scrollToBottom, ref, computed, watch, nextTick, onMounted, get useNamespace() {
      return useNamespace;
    }, get useVirtualScroll() {
      return useVirtualScroll;
    }, get useComponentTheme() {
      return useComponentTheme;
    }, YhAiBubble, get aiBubbleListProps() {
