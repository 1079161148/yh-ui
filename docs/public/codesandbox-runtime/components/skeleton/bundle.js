// public/codesandbox-runtime/components/skeleton/src/skeleton.js
import { renderSlot as _renderSlot2, createCommentVNode as _createCommentVNode2, createVNode as _createVNode, normalizeClass as _normalizeClass2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, createBlock as _createBlock, renderList as _renderList2, Fragment as _Fragment2, normalizeStyle as _normalizeStyle2, createElementVNode as _createElementVNode2 } from "vue";
...
// public/codesandbox-runtime/components/skeleton/src/skeleton-meta.js
...
// public/codesandbox-runtime/components/skeleton/src/skeleton-item.js
import { renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, renderSlot as _renderSlot, createElementVNode as _createElementVNode, createCommentVNode as _createCommentVNode, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.props.repeat > 1 ? (_openBlock(), _createElementBlock("div", _hoisted_1, [
    (_openBlock(true), _createElementBlock(
      ...
      _renderList($setup.props.repeat, (i) => {
        return _openBlock(), _createElementBlock(
          ...
          [
            _ctx.variant === "image" ? _renderSlot(_ctx.$slots, "image", { key: 0 }, () => [
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, style, classes, computed: computed2, get useNamespace() {
      return useNamespace;
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.uiLoading ? (_openBlock2(), _createElementBlock2(
    "div",
    {
      key: 0,
      ref: "skeletonRef",
    ...
    [
      _renderSlot2(_ctx.$slots, "template", {}, () => [
        ...
        _ctx.avatar ? (_openBlock2(), _createElementBlock2(
          "div",
          {
            key: 0,
        ...
        _createElementVNode2(
          ...
          [
            _ctx.title ? (_openBlock2(), _createBlock($setup["YhSkeletonItem"], {
              key: 0,
              variant: "h3",
              style: { "width": "40%", "margin-bottom": "16px" },
              animated: $setup.isIntersecting && _ctx.animated
            }, null, 8, ["animated"])) : _createCommentVNode2("v-if", true),
            (_openBlock2(true), _createElementBlock2(
              _Fragment2,
              null,
              _renderList2(_ctx.rows, (i) => {
                return _openBlock2(), _createBlock($setup["YhSkeletonItem"], {
                  key: i,
                  variant: "text",
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, uiLoading, get timeout() {
      ...
      timeout = v;
    }, containerClass, isIntersecting, skeletonRef, ref: ref2, watch, onMounted, computed: computed3, get useNamespace() {
      return useNamespace;
    }, get useComponentTheme() {
      return useComponentTheme;
    }, get skeletonProps() {
