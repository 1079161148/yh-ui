    ...
    _createElementBlock(
      ...
      [
        ...
        _createElementVNode(
          ...
          [
            (
              (_b = (_a = $setup.breadcrumbContext) == null ? void 0 : _a.separatorIcon) == null
                ? void 0
                : _b.value
            )
              ? (_openBlock(),
                _createBlock(
                  _resolveDynamicComponent($setup.breadcrumbContext.separatorIcon.value),
                  { key: 0 }
                ))
              : (_openBlock(),
                _createElementBlock(
                  ...
                  [
                    _createTextVNode(
                      _toDisplayString(
                        (_d = (_c = $setup.breadcrumbContext) == null ? void 0 : _c.separator) ==
                          null
                          ? void 0
                          : _d.value
                      ),
...
const __sfc__ = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const breadcrumbContext = inject('breadcrumbProps')
      const { themeStyle } = useComponentTheme(
        ...
        computed(() => {
          ...
          return (
            ...
            ((_a = breadcrumbContext == null ? void 0 : breadcrumbContext.themeOverrides) == null
              ? void 0
              : _a.value)
          )
        })
      ...
      const router = computed(() => {
        var _a
        const globalRouter =
          (_a = instance == null ? void 0 : instance.appContext.config.globalProperties) == null
            ? void 0
            : _a.$router
