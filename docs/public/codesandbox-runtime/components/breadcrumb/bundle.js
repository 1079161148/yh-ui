...
// public/codesandbox-runtime/components/breadcrumb/src/breadcrumb.js
import { renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle } from "vue";
import { provide as provide2, toRefs, useSlots, computed as computed11, h as h2, Fragment } from "vue";
...
// public/codesandbox-runtime/components/breadcrumb/src/breadcrumb-meta.js
var breadcrumbProps = {
  /** 分割符，默认为 / */
  separator: {
    type: String,
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    provide2("breadcrumbProps", toRefs(props));
    const breadcrumbItems = computed11(() => {
      var _a2;
      ...
      const first = items[0];
      const ellipsisItem = h2("span", { class: ns.e("ellipsis"), title: t("breadcrumb.more") }, "...");
      const result = [first, ellipsisItem, ...items.slice(items.length - (props.maxItems - 1))];
      return result;
    });
    const __returned__ = { props, ns, t, slots, themeStyle, breadcrumbItems, provide: provide2, toRefs, useSlots, computed: computed11, h: h2, Fragment, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
