  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    useEventListener(
      ...
      (e) => {
        ...
        if (!((_a = triggerRef.value) == null ? void 0 : _a.contains(target)) && !((_b = popperRef.value) == null ? void 0 : _b.contains(target))) {
          toggleVisible(false);
        }
      }
    );
    ...
    const __returned__ = { props, emit, ns, tooltipId, themeStyle, triggerRef, popperRef, arrowRef, visible, popperStyle, arrowStyle, computedPopperStyle, computedContentStyle, actualPlacement, get cleanup() {
      ...
      hideTimer = v;
    }, showPopper, shouldRender, popperClasses, updatePosition, handleMouseMove, toggleVisible, startAutoUpdate, stopAutoUpdate, triggers, handleTrigger, ref, computed, watch, onMounted, onUnmounted, nextTick, get computePosition() {
