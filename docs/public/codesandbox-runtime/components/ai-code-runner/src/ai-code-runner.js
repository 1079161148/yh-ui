        ...
        _createElementVNode(
          ...
          [
            !$setup.isRunning
              ? (_openBlock(),
                _createBlock(
                  ...
                  {
                    icon: _withCtx(() => [_createVNode($setup['YhIcon'], { name: 'video-play' })]),
                    default: _withCtx(() => [
                      _createTextVNode(
              ...
              : (_openBlock(),
                _createBlock(
                  ...
                  {
                    icon: _withCtx(() => [_createVNode($setup['YhIcon'], { name: 'video-pause' })]),
                    default: _withCtx(() => [
                      _createTextVNode(
            ...
            _createVNode(
              ...
              {
                icon: _withCtx(() => [_createVNode($setup['YhIcon'], { name: 'delete' })]),
                default: _withCtx(() => [
                  _createTextVNode(
            ...
            _createVNode(
              ...
              {
                icon: _withCtx(() => [_createVNode($setup['YhIcon'], { name: 'refresh' })]),
                default: _withCtx(() => [
                  _createTextVNode(
...
const __sfc__ = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const webcontainerInstance = shallowRef(null)
