      ...
      get editorOrigin() {
        ...
        if (editorOrigin == null) {
          editorOrigin = new URL(
            (_a2 = globalThis.WEBCONTAINER_API_IFRAME_URL) != null ? _a2 : DEFAULT_EDITOR_ORIGIN
          ).origin
        }
        return editorOrigin
      },
  ...
  '../node_modules/@webcontainer/api/dist/internal/auth-state.js'() {
    ...
    auth = {
      ...
      async logout({ ignoreRevokeError } = {}) {
        var _a2
        await ((_a2 = authState.tokens) == null
          ? void 0
          : _a2.revoke(authState.clientId, ignoreRevokeError != null ? ignoreRevokeError : false))
        loggedOutListeners.fireEvent()
        broadcastMessage({ type: 'auth-logout' })
      },
      loggedIn() {
...
var init_vendor = __esm({
  '../node_modules/@webcontainer/api/dist/vendor/index.js'() {
    ...
    __export2 = (target, all) => {
      for (var name in all) __defProp5(target, name, { get: all[name], enumerable: true })
    }
    comlink_exports = {}
...
function reloadPreview(preview, hardRefreshTimeout = 200) {
  ...
  ;(_a2 = preview.contentWindow) == null
    ? void 0
    : _a2.postMessage(
        {
        ...
        _createElementVNode2(
          ...
          [
            !$setup.isRunning
              ? (_openBlock3(),
                _createBlock3(
                  ...
                  {
                    icon: _withCtx2(() => [_createVNode($setup['YhIcon'], { name: 'video-play' })]),
                    default: _withCtx2(() => [
                      _createTextVNode(
            ...
            _createVNode(
              ...
              {
                icon: _withCtx2(() => [_createVNode($setup['YhIcon'], { name: 'delete' })]),
                default: _withCtx2(() => [
                  _createTextVNode(
            ...
            _createVNode(
              ...
              {
                icon: _withCtx2(() => [_createVNode($setup['YhIcon'], { name: 'refresh' })]),
                default: _withCtx2(() => [
                  _createTextVNode(
                  ...
                  _createElementBlock3(
                    'div',
                    {
                      ...
                      class: _normalizeClass2([
                        $setup.ns.e('line'),
                        line.includes('[error]') ? $setup.ns.m('error') : ''
                      ])
                    },
...
var __sfc__3 = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const webcontainerInstance = shallowRef3(null)
      ...
      const runCode = async () => {
        ...
        try {
          ...
          if (exitCode === 0) {
            ...
            addOutput(
              `\u6267\u884C\u5931\u8D25\uFF0C\u9000\u51FA\u7801: ${exitCode != null ? exitCode : 'unknown'}`,
              'error'
            )
          }
        } catch (error) {
