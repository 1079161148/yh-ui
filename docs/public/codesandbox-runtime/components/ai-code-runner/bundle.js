    ...
    iframeSettings = {
      get editorOrigin() {
        ...
        if (editorOrigin == null) {
          editorOrigin = new URL((_a2 = globalThis.WEBCONTAINER_API_IFRAME_URL) != null ? _a2 : DEFAULT_EDITOR_ORIGIN).origin;
        }
        return editorOrigin;
      },
  ...
  "../node_modules/@webcontainer/api/dist/internal/auth-state.js"() {
    ...
    auth = {
      ...
      async logout({ ignoreRevokeError } = {}) {
        var _a2;
        await ((_a2 = authState.tokens) == null ? void 0 : _a2.revoke(authState.clientId, ignoreRevokeError != null ? ignoreRevokeError : false));
        loggedOutListeners.fireEvent();
        broadcastMessage({ type: "auth-logout" });
      },
      loggedIn() {
...
var __defProp5, __export2, comlink_exports, proxyMarker, createEndpoint, releaseProxy, throwMarker, isObject, proxyTransferHandler, throwTransferHandler, transferHandlers, transferCache;
...
function reloadPreview(preview, hardRefreshTimeout = 200) {
  ...
  (_a2 = preview.contentWindow) == null ? void 0 : _a2.postMessage({
    ...
    _WebContainer = class _WebContainer {
      ...
      async export(path, options) {
        ...
        const serializeOptions = {
          format: (_a2 = options == null ? void 0 : options.format) != null ? _a2 : "json",
...
Set the 'coep' option to 'require-corp'.`);
    ...
    FSWatcher = class {
      ...
      async _teardown() {
        var _a2;
        await ((_a2 = this._watcher) == null ? void 0 : _a2.close().finally(() => {
          var _a3;
          (_a3 = this._watcher) == null ? void 0 : _a3[comlink_exports.releaseProxy]();
        }));
      }
    };
    WebContainerProcessImpl = class {
      constructor(process, output, stdout, stderr) {
        ...
        this.input = new WritableStream({
          write: (data) => {
            var _a2;
            (_a2 = this._getProcess()) == null ? void 0 : _a2.write(data).catch(() => {
            });
          }
        });
      ...
      kill() {
        var _a2;
        (_a2 = this._process) == null ? void 0 : _a2.kill();
      }
      resize(dimensions) {
        var _a2;
        (_a2 = this._getProcess()) == null ? void 0 : _a2.resize(dimensions);
      }
      async _onExit() {
        var _a2;
        try {
          ...
          (_a2 = this._process) == null ? void 0 : _a2[comlink_exports.releaseProxy]();
          this._process = null;
        }
      }
      _getProcess() {
...
// public/codesandbox-runtime/components/ai-code-runner/src/ai-code-runner.js
import { createVNode as _createVNode, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, withCtx as _withCtx2, openBlock as _openBlock3, createBlock as _createBlock3, createCommentVNode as _createCommentVNode3, normalizeClass as _normalizeClass2, createElementVNode as _createElementVNode2, createElementBlock as _createElementBlock3, renderList as _renderList, Fragment as _Fragment2, normalizeStyle as _normalizeStyle2 } from "vue";
...
// public/codesandbox-runtime/components/ai-code-runner/src/ai-code-runner.js
import { ref as ref13, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2, computed as computed13, watch as watch4, shallowRef as shallowRef3, nextTick } from "vue";
...
// public/codesandbox-runtime/components/ai-code-runner/src/ai-code-runner-meta.js
var aiCodeRunnerProps = {
  /**
   * @description 代码语言
   */
  language: {
...
// public/codesandbox-runtime/components/ai-code-runner/src/webcontainer.js
var getWebContainerInstance = async () => {
  const globalThisAny = globalThis;
  if (!globalThisAny.__webcontainer_promise__) {
    const { WebContainer: WC } = await Promise.resolve().then(() => (init_dist(), dist_exports));
  ...
  return _openBlock3(), _createElementBlock3(
    ...
    [
      _createElementVNode2(
        ...
        [
          !$setup.isRunning ? (_openBlock3(), _createBlock3($setup["YhButton"], {
            key: 0,
            type: "primary",
            size: "small",
            disabled: !_ctx.code,
            ...
            _: 1
            /* STABLE */
          }, 8, ["disabled"])) : (_openBlock3(), _createBlock3($setup["YhButton"], {
            key: 1,
            type: "danger",
            size: "small",
      ...
      _createElementVNode2(
        ...
        {
          ref: "terminalRef",
          class: _normalizeClass2($setup.ns.e("terminal")),
          style: _normalizeStyle2({
            height: $setup.terminalHeight
          })
        },
        [
          $setup.output.length === 0 ? (_openBlock3(), _createElementBlock3(
            "div",
            {
              key: 0,
          ...
          (_openBlock3(true), _createElementBlock3(
            ...
            _renderList($setup.output, (line, index) => {
              return _openBlock3(), _createElementBlock3(
                ...
                {
                  key: index,
                  class: _normalizeClass2([$setup.ns.e("line"), line.includes("[error]") ? $setup.ns.m("error") : ""])
                },
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const webcontainerInstance = shallowRef3(
      null
    );
    const isRunning = ref13(false);
    const output = ref13([]);
    const terminalRef = ref13();
    const terminalHeight = computed13(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, webcontainerInstance, isRunning, output, terminalRef, terminalHeight, addOutput, initWebContainer, runCode, stopCode, clearOutput, reset, get useNamespace() {
      ...
      return useLocale;
    }, ref: ref13, onMounted: onMounted3, onBeforeUnmount: onBeforeUnmount2, computed: computed13, watch: watch4, shallowRef: shallowRef3, nextTick, get YhButton() {
      return YhButton;
    }, get YhIcon() {
      return YhIcon;
