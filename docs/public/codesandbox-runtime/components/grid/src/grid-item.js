...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhGridItem" }, {
  __name: "grid-item",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, gridContext, itemStyle, itemClasses, computed, inject, get useNamespace() {
      return useNamespace;
