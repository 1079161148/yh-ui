...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhGrid" }, {
  __name: "grid",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, ns, themeStyle, resolveGap, computedCols, gridStyle, computed, provide, get useNamespace() {
      return useNamespace;
