...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhLuckyDraw" }, {
  __name: "lucky-draw",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isRotating, wheelRotate, gridActiveIndex, get animationFrameId() {
      ...
      animationFrameId = v;
    }, finalActionText, containerStyle, isPureText, defaultColors, wheelInnerStyle, handleStart, startWheel, startGrid, gridAreas, ref, computed, watch, onUnmounted, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
