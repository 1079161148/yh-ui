// public/codesandbox-runtime/components/lucky-draw/src/lucky-draw.js
...
import { ref as ref12, computed as computed11, watch as watch4, onUnmounted as onUnmounted4 } from "vue";
...
// public/codesandbox-runtime/components/lucky-draw/src/lucky-draw-meta.js
var luckyDrawProps = {
  /** 抽奖类型 */
  type: {
    type: String,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      _ctx.type === "wheel" ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 0 },
        [
          _createCommentVNode(" Dynamic class injection for styling decoupling based on exact content "),
          _createElementVNode(
            "div",
            {
              class: _normalizeClass([$setup.ns.e("wheel-container"), $setup.ns.is("pure-text", $setup.isPureText)])
            },
            [
              _createElementVNode(
                "div",
                {
                  ...
                  style: _normalizeStyle([$setup.wheelInnerStyle, {
                    transform: `rotate(${$setup.wheelRotate}deg)`,
                    transition: $setup.isRotating ? `transform ${_ctx.duration}ms cubic-bezier(0.15, 0, 0, 1.0)` : "none"
                  }])
                },
                [
                          ...
                          _renderSlot(_ctx.$slots, "prize", { prize }, () => [
                            _createElementVNode(
                              ...
                              [
                                ...
                                prize.image ? (_openBlock(), _createElementBlock(
                                  "div",
                                  {
                                    key: 0,
              ...
              !_ctx.hideBtn ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
        ...
        64
        /* STABLE_FRAGMENT */
      )) : _ctx.type === "grid" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
          ...
          (_openBlock(), _createElementBlock(
            ...
            _renderList(8, (idx) => {
              return _createElementVNode(
                ...
                {
                  key: idx,
                  class: _normalizeClass([$setup.ns.e("grid-item"), $setup.ns.is("active", $setup.gridActiveIndex === idx - 1)]),
                  style: _normalizeStyle({
                    "grid-area": $setup.gridAreas[idx - 1]
                  })
                },
                [
                  _ctx.prizes[idx - 1] ? _renderSlot(_ctx.$slots, "prize", {
                    key: 0,
                    prize: _ctx.prizes[idx - 1]
                  }, () => [
                    _ctx.prizes[idx - 1].image ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 0,
                        class: _normalizeClass($setup.ns.e("prize-icon"))
...
var __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhLuckyDraw" }, {
  __name: "lucky-draw",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isRotating = ref12(false);
    const wheelRotate = ref12(0);
    const gridActiveIndex = ref12(-1);
    let animationFrameId = null;
    const finalActionText = computed11(() => {
    ...
    const isPureText = computed11(() => props.prizes.length > 0 && props.prizes.every((p) => !p.image));
    const defaultColors = ["#FFF4EB", "#FFFFFF"];
    const wheelInnerStyle = computed11(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isRotating, wheelRotate, gridActiveIndex, get animationFrameId() {
      return animationFrameId;
    }, set animationFrameId(v) {
      animationFrameId = v;
    }, finalActionText, containerStyle, isPureText, defaultColors, wheelInnerStyle, handleStart, startWheel, startGrid, gridAreas, ref: ref12, computed: computed11, watch: watch4, onUnmounted: onUnmounted4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
