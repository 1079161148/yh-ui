// public/codesandbox-runtime/components/affix/src/affix.js
...
import { ref as ref2, computed as computed2, watch, onMounted, onBeforeUnmount, shallowRef, nextTick } from "vue";
...
// public/codesandbox-runtime/components/affix/src/affix-meta.js
var affixProps = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      _createCommentVNode(" \u4F7F\u7528 Teleport \u89E3\u51B3\u7236\u7EA7 transform \u5BFC\u81F4\u7684\u5B9A\u4F4D\u964D\u7EA7\uFF08\u8D85\u8D8A\u6807\u51C6\u5B9E\u73B0\uFF09 "),
      (_openBlock(), _createBlock(_Teleport, {
        ...
        _createElementVNode(
          ...
          {
            ref: "content",
            class: _normalizeClass([$setup.ns.e("inner"), { [$setup.ns.is("fixed")]: $setup.fixed }]),
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, root, content, target, fixed, _scrollTop, transform, isIntersecting, rootRect, updateRect, update, handleScroll, get io() {
      return io;
    }, set io(v) {
      io = v;
    }, get ro() {
      ...
      ro = v;
    }, initObservers, placeholderStyle, affixStyle, ref: ref2, computed: computed2, watch, onMounted, onBeforeUnmount, shallowRef, nextTick, get useNamespace() {
      return useNamespace;
