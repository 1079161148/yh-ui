...
// public/codesandbox-runtime/components/dropdown/src/dropdown.js
import { renderSlot as _renderSlot4, withCtx as _withCtx3, createVNode as _createVNode2, normalizeClass as _normalizeClass3, withModifiers as _withModifiers, Fragment as _Fragment2, openBlock as _openBlock4, createElementBlock as _createElementBlock4, createCommentVNode as _createCommentVNode4, createBlock as _createBlock4, toDisplayString as _toDisplayString2, createElementVNode as _createElementVNode3, renderList as _renderList, createTextVNode as _createTextVNode, normalizeStyle as _normalizeStyle3 } from "vue";
import { ref as ref14, computed as computed14, provide as provide2, toRef } from "vue";
...
import { createCommentVNode as _createCommentVNode2, renderSlot as _renderSlot2, createElementVNode as _createElementVNode2, normalizeClass as _normalizeClass2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock2, normalizeStyle as _normalizeStyle2, withCtx as _withCtx2 } from "vue";
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createBlock2(_resolveDynamicComponent($props.tag), {
    ref: "buttonRef",
      ...
      !$props.loading && $setup.hasIcon && ($props.iconPosition === "left" || $props.iconPosition === "top") ? (_openBlock2(), _createElementBlock2(
        ...
        [
          _renderSlot2(_ctx.$slots, "icon", {}, () => [
            $props.icon && typeof $props.icon !== "string" ? (_openBlock2(), _createBlock2(_resolveDynamicComponent($props.icon), { key: 0 })) : _createCommentVNode2("v-if", true)
          ])
        ],
        2
        /* CLASS */
      ...
      !$props.loading && $setup.hasSuffixIcon ? (_openBlock2(), _createElementBlock2(
        ...
        [
          _renderSlot2(_ctx.$slots, "suffixIcon", {}, () => [
            $props.suffixIcon && typeof $props.suffixIcon !== "string" ? (_openBlock2(), _createBlock2(_resolveDynamicComponent($props.suffixIcon), { key: 0 })) : _createCommentVNode2("v-if", true)
          ])
        ],
        2
        /* CLASS */
...
import { createCommentVNode as _createCommentVNode3, resolveDynamicComponent as _resolveDynamicComponent2, openBlock as _openBlock3, createBlock as _createBlock3, createElementBlock as _createElementBlock3, Fragment as _Fragment, renderSlot as _renderSlot3, mergeProps as _mergeProps } from "vue";
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createElementBlock3(
    ...
    [
      ...
      $setup.useIconComponent ? (_openBlock3(), _createBlock3(_resolveDynamicComponent2(_ctx.icon), {
        key: 0,
...
// public/codesandbox-runtime/components/dropdown/src/dropdown-meta.js
var dropdownProps = {
  /** 触发方式 */
  trigger: {
    type: String,
...
var DROPDOWN_INJECTION_KEY = Symbol("dropdown");
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createElementBlock4(
    "div",
    {
      class: _normalizeClass3([$setup.ns.b(), $setup.ns.is("disabled", _ctx.disabled), $setup.ns.is("split", _ctx.splitButton)]),
      ...
      _createVNode2($setup["YhTooltip"], {
        ...
        content: _withCtx3(() => [
          _createElementVNode3(
            ...
            [
              _renderSlot4(_ctx.$slots, "dropdown", {}, () => [
                _createCommentVNode4(" \u52A0\u8F7D\u72B6\u6001 "),
                _ctx.loading ? (_openBlock4(), _createElementBlock4(
                  ...
                  [
                    ...
                    _createElementVNode3(
                      "span",
                      null,
                      _toDisplayString2($setup.t("dropdown.loading") || $setup.t("select.loading") || "Loading..."),
                      1
                      /* TEXT */
                    )
                  ],
                  2
                  /* CLASS */
                )) : _ctx.items && _ctx.items.length > 0 ? (_openBlock4(), _createElementBlock4(
                  _Fragment2,
                  { key: 1 },
                  [
                    _createCommentVNode4(" \u5FEB\u6377\u6570\u636E\u6A21\u5F0F "),
                    (_openBlock4(true), _createElementBlock4(
                      ...
                      _renderList(_ctx.items, (item) => {
                        return _openBlock4(), _createElementBlock4(
                          ...
                          [
                            item.divided ? (_openBlock4(), _createElementBlock4(
                              "div",
                              {
                                key: 0,
                                class: _normalizeClass3($setup.ns.e("divider"))
                              },
                              null,
                              2
                              /* CLASS */
                            ...
                            _createElementVNode3("div", {
                              class: _normalizeClass3([$setup.ns.e("item"), item.class, {
                                [$setup.ns.is("disabled")]: item.disabled,
                                [$setup.ns.is("danger")]: item.danger,
                                [$setup.ns.is("checked")]: _ctx.checkable && item.checked
                              }]),
                              onClick: ($event) => !item.disabled && $setup.handleItemClick(item.key)
                            }, [
                              _ctx.checkable ? (_openBlock4(), _createBlock4($setup["YhIcon"], {
                                key: 0,
                                name: item.checked ? "check" : "",
                                class: _normalizeClass3($setup.ns.e("check-icon"))
                              }, null, 8, ["name", "class"])) : _createCommentVNode4("v-if", true),
                              item.icon ? (_openBlock4(), _createBlock4($setup["YhIcon"], {
                                key: 1,
                                name: item.icon,
                                class: _normalizeClass3($setup.ns.e("item-icon"))
                              }, null, 8, ["name", "class"])) : _createCommentVNode4("v-if", true),
                              _createElementVNode3(
                                "span",
                                null,
                                _toDisplayString2(item.label),
                                1
                                /* TEXT */
                              )
                            ], 10, _hoisted_22)
                  ...
                  { key: 2 },
                  [
                    _createCommentVNode4(" \u7A7A\u72B6\u6001 - \u5F53\u65E2\u6CA1\u6709\u63D2\u69FD\u53C8\u6CA1\u6709\u6570\u636E\u65F6\u663E\u793A "),
                    _createElementVNode3(
                      "div",
                      {
                      ...
                      [
                        _renderSlot4(_ctx.$slots, "empty", {}, () => [
                          _createTextVNode(
                            _toDisplayString2(_ctx.emptyText || $setup.t("select.noData")),
                            1
                            /* TEXT */
                          )
                        ])
        ...
        default: _withCtx3(() => [
          _ctx.splitButton ? (_openBlock4(), _createElementBlock4(
            _Fragment2,
            { key: 0 },
            [
              ...
              _createVNode2($setup["YhButton"], {
                ...
                size: _ctx.size,
                plain: _ctx.plain,
                class: _normalizeClass3($setup.ns.e("caret-button")),
                ...
                _: 1
                /* STABLE */
              }, 8, ["type", "size", "plain", "class"])
            ],
            64
            /* STABLE_FRAGMENT */
          )) : (_openBlock4(), _createElementBlock4("div", {
            key: 1,
            class: _normalizeClass3($setup.ns.e("trigger")),
            tabindex: _ctx.disabled ? void 0 : _ctx.tabindex
          }, [
            _renderSlot4(_ctx.$slots, "default"),
            _ctx.showArrow ? (_openBlock4(), _createBlock4($setup["YhIcon"], {
              key: 0,
              name: "arrow-down",
              class: _normalizeClass3([$setup.ns.e("icon"), {
                [$setup.ns.is("active")]: $setup.visible
        ...
        _: 3
        /* FORWARDED */
      }, 8, ["visible", "trigger", "placement", "disabled", "show-after", "hide-after", "z-index", "teleported", "popper-class", "popper-style", "offset", "show-arrow"])
    ],
    38
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const internalVisible = ref14(false);
    const visible = computed14({
    ...
    const tooltipRef = ref14(null);
    const popperStyle = computed14(() => {
      const styles = __spreadValues5({}, themeStyle.value);
      Object.assign(styles, props.popperStyle);
      if (props.maxHeight) {
    ...
    provide2(DROPDOWN_INJECTION_KEY, {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, internalVisible, visible, tooltipRef, popperStyle, handleItemClick, handleShow, handleHide, handleButtonClick, handleDropdownClick, handleKeydown, ref: ref14, computed: computed14, provide: provide2, toRef, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useComponentTheme() {
