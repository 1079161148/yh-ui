                ...
                [
                  _renderSlot2(_ctx.$slots, 'icon', {}, () => [
                    $props.icon && typeof $props.icon !== 'string'
                      ? (_openBlock2(),
                        _createBlock2(_resolveDynamicComponent($props.icon), { key: 0 }))
                      : _createCommentVNode2('v-if', true)
                  ])
                ],
                2
                ...
                [
                  _renderSlot2(_ctx.$slots, 'suffixIcon', {}, () => [
                    $props.suffixIcon && typeof $props.suffixIcon !== 'string'
                      ? (_openBlock2(),
                        _createBlock2(_resolveDynamicComponent($props.suffixIcon), { key: 0 }))
                      : _createCommentVNode2('v-if', true)
                  ])
                ],
                2
    ...
    _createElementBlock3(
      ...
      [
        ...
        $setup.useIconComponent
          ? (_openBlock3(),
            _createBlock3(_resolveDynamicComponent2(_ctx.icon), {
              key: 0,
                              ...
                              _createElementVNode3(
                                ...
                                [
                                  _renderSlot4(_ctx.$slots, 'empty', {}, () => [
                                    _createTextVNode(
                                      _toDisplayString2(
                                        _ctx.emptyText || $setup.t('select.noData')
                                      ),
                                      1
                                      /* TEXT */
                                    )
                  ...
                  _createElementBlock4(
                    ...
                    [
                      _createVNode2(
                        ...
                        {
                          default: _withCtx3(() => [_renderSlot4(_ctx.$slots, 'default')]),
                          _: 3
                          /* FORWARDED */
                        },
                        8,
