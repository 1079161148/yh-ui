...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    "div",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.is("disabled", _ctx.disabled), $setup.ns.is("split", _ctx.splitButton)]),
    ...
    [
      _createVNode($setup["YhTooltip"], {
                ...
                _ctx.loading ? (_openBlock(), _createElementBlock(
                  ...
                  [
                    ...
                    _createElementVNode(
                      "span",
                      null,
                      _toDisplayString($setup.t("dropdown.loading") || $setup.t("select.loading") || "Loading..."),
                      1
                      /* TEXT */
                    )
                  ],
                  2
                  /* CLASS */
                )) : _ctx.items && _ctx.items.length > 0 ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 1 },
                  [
                    ...
                    (_openBlock(true), _createElementBlock(
                      ...
                      _renderList(_ctx.items, (item) => {
                        return _openBlock(), _createElementBlock(
                          ...
                          [
                            item.divided ? (_openBlock(), _createElementBlock(
                              "div",
                              {
                                key: 0,
                            ...
                            _createElementVNode("div", {
                              class: _normalizeClass([$setup.ns.e("item"), item.class, {
                  ...
                  { key: 2 },
                  [
                    _createCommentVNode(" \u7A7A\u72B6\u6001 - \u5F53\u65E2\u6CA1\u6709\u63D2\u69FD\u53C8\u6CA1\u6709\u6570\u636E\u65F6\u663E\u793A "),
                    _createElementVNode(
                      "div",
                      {
        ...
        default: _withCtx(() => [
          _ctx.splitButton ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [
            ...
            _renderSlot(_ctx.$slots, "default"),
            _ctx.showArrow ? (_openBlock(), _createBlock($setup["YhIcon"], {
              key: 0,
              name: "arrow-down",
              class: _normalizeClass([$setup.ns.e("icon"), {
                [$setup.ns.is("active")]: $setup.visible
...
import { dropdownProps, dropdownEmits, DROPDOWN_INJECTION_KEY } from "./dropdown-meta.js";
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, internalVisible, visible, tooltipRef, popperStyle, handleItemClick, handleShow, handleHide, handleButtonClick, handleDropdownClick, handleKeydown, ref, computed, provide, toRef, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
