  ...
  setup(__props, { expose: __expose }) {
    ...
    const MessageContent = () => {
      ...
      if (dangerouslyUseHTMLString) {
        return h2("div", { class: ns.e("html"), innerHTML: message });
      }
      return h2("span", message);
    };
    ...
    const __returned__ = { ns, t, DEFAULT_OPTIONS, props, themeStyle, visible, boxRef, inputRef, confirmRef, state, shouldLockScroll, isDragging, transform, onMousedown, get isMousedownOnWrapper() {
      ...
      _callback = v;
    }, setCallback, doClose, onKeydown, MessageContent, boxStyle, exposed, getStatusIcon, ref: ref14, reactive, computed: computed14, watch: watch5, h: h2, onMounted: onMounted4, onUnmounted: onUnmounted4, markRaw, nextTick: nextTick2, shallowReactive, get useNamespace() {
      return useNamespace;
    }, get useScrollLock() {
