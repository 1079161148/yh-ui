                    ...
                    _renderSlot2(_ctx.$slots, 'prefix', {}, () => [
                      ...
                      $props.prefix
                        ...
                        : $props.prefixIcon && typeof $props.prefixIcon !== 'string'
                          ? (_openBlock2(),
                            _createBlock2(
                              _resolveDynamicComponent2($props.prefixIcon),
                              {
                                key: 1,
                      ...
                      ? (_openBlock2(),
                        _createElementBlock2(
                          ...
                          [
                            $setup.passwordVisible
                              ? (_openBlock2(),
                                _createElementBlock2('svg', _hoisted_3, [
                                  ...(_cache[3] ||
                                    (_cache[3] = [
                                      _createElementVNode2(
                                        'path',
                    ...
                    _renderSlot2(_ctx.$slots, 'suffix', {}, () => [
                      ...
                      $props.suffix
                        ...
                        : $props.suffixIcon && typeof $props.suffixIcon !== 'string'
                          ? (_openBlock2(),
                            _createBlock2(
                              _resolveDynamicComponent2($props.suffixIcon),
                              {
                                key: 1,
                                class: _normalizeClass2($setup.ns.e('icon'))
                              },
  ...
  },
  {
    ...
    setup(__props, { expose: __expose }) {
        ...
        async (val) => {
          ...
          if (val && state.options.autofocus !== false) {
            ...
            if (state.options.type === 'prompt') {
              ;(_b = (_a2 = inputRef.value) == null ? void 0 : _a2.focus) == null
                ? void 0
                : _b.call(_a2)
            } else {
      ...
      const open = (options) => {
        const _a2 = options,
          { appContext } = _a2,
          rest = __objRest(_a2, ['appContext'])
        state.options = __spreadProps2(
          __spreadValues5(__spreadValues5({}, DEFAULT_OPTIONS), rest),
          {
