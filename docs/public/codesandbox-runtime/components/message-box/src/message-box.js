...
import { normalizeClass as _normalizeClass, openBlock as _openBlock, createElementBlock as _createElementBlock, createCommentVNode as _createCommentVNode, toDisplayString as _toDisplayString, createElementVNode as _createElementVNode, createVNode as _createVNode, resolveDynamicComponent as _resolveDynamicComponent, normalizeProps as _normalizeProps, guardReactiveProps as _guardReactiveProps, createBlock as _createBlock, mergeProps as _mergeProps, withKeys as _withKeys, vShow as _vShow, withDirectives as _withDirectives, Transition as _Transition, withCtx as _withCtx, createTextVNode as _createTextVNode, normalizeStyle as _normalizeStyle } from "vue";
      ...
      $setup.visible ? (_openBlock(), _createElementBlock(
        ...
        [
          _createElementVNode(
            ...
            {
              ref: "boxRef",
              class: _normalizeClass([$setup.ns.b(), $setup.state.options.customClass, {
            ...
            [
              $setup.state.options.glass ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
              ...
              _createElementVNode(
                ...
                [
                  _createElementVNode(
                    ...
                    _toDisplayString($setup.state.options.title || $setup.t("messagebox.title")),
                    3
                    /* TEXT, CLASS */
                  ),
                  $setup.state.options.showClose !== false ? (_openBlock(), _createElementBlock("button", {
                    key: 0,
              ...
              _createElementVNode(
                ...
                [
                  $setup.state.options.iconType || $setup.state.options.icon ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
                      class: _normalizeClass([$setup.ns.e("status"), $setup.ns.is($setup.state.options.iconType || "")])
                    },
                    [
                      $setup.state.options.icon ? (_openBlock(), _createBlock(
                        _resolveDynamicComponent(typeof $setup.state.options.icon === "string" ? $setup.YhIcon : $setup.state.options.icon),
                        _normalizeProps(_mergeProps({ key: 0 }, typeof $setup.state.options.icon === "string" ? {
                          name: $setup.state.options.icon
                        } : {})),
                        null,
                        16
                        /* FULL_PROPS */
                      )) : $setup.state.options.iconType ? (_openBlock(), _createBlock($setup["YhIcon"], {
                        key: 1,
                      ...
                      }, null, 8, ["svg", "view-box"])) : _createCommentVNode("v-if", true)
                    ],
                    2
                    /* CLASS */
                  )) : _createCommentVNode("v-if", true),
              ...
              $setup.state.options.type === "prompt" ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 1,
              ...
              _createElementVNode(
                ...
                [
                  $setup.state.options.showCancelButton !== false ? (_openBlock(), _createBlock($setup["YhButton"], {
                    key: 0,
                    size: "small",
                    ...
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString($setup.state.options.cancelButtonText || $setup.t("messagebox.cancel")),
                        1
                        /* TEXT */
                      )
                    ]),
                    _: 1
                    /* STABLE */
                  }, 8, ["round", "loading", "disabled"])) : _createCommentVNode("v-if", true),
                  $setup.state.options.showConfirmButton !== false ? (_openBlock(), _createBlock($setup["YhButton"], {
                    key: 1,
                    ref: "confirmRef",
                    type: "primary",
                    size: "small",
                    ...
                    default: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString($setup.state.options.confirmButtonText || $setup.t("messagebox.confirm")),
                        1
                        /* TEXT */
                      )
                    ]),
                    _: 1
                    /* STABLE */
                  }, 8, ["loading", "disabled", "round"])) : _createCommentVNode("v-if", true)
                ],
                2
                /* CLASS */
              )
...
import { YhIcon, IconClose, IconSuccess, IconWarning, IconError, IconInfo } from "../../icon/index.js";
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const open = (options) => {
      const _a = options, { appContext } = _a, rest = __objRest(_a, ["appContext"]);
    ...
    const __returned__ = { ns, t, DEFAULT_OPTIONS, props, themeStyle, visible, boxRef, inputRef, confirmRef, state, shouldLockScroll, isDragging, transform, onMousedown, get isMousedownOnWrapper() {
      ...
      _callback = v;
    }, setCallback, doClose, onKeydown, MessageContent, boxStyle, exposed, getStatusIcon, ref, reactive, computed, watch, h, onMounted, onUnmounted, markRaw, nextTick, shallowReactive, get useNamespace() {
      return useNamespace;
    }, get useScrollLock() {
