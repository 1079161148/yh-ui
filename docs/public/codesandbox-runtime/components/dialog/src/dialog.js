                                  ...
                                  _createElementVNode(
                                    ...
                                    [
                                      ...
                                      typeof _ctx.title === 'string'
                                        ...
                                        : _ctx.title
                                          ? (_openBlock(),
                                            _createBlock(_resolveDynamicComponent(_ctx.title), {
                                              key: 2
                                            }))
                                          : _createCommentVNode('v-if', true)
                                    ],
                                          ...
                                          _createElementBlock(
                                            ...
                                            [
                                              typeof _ctx.content === 'string'
                                                ...
                                                : (_openBlock(),
                                                  _createBlock(
                                                    _resolveDynamicComponent(_ctx.content),
                                                    { key: 1 }
                                                  ))
                                            ],
                                            64
                                ...
                                _createElementBlock(
                                  ...
                                  [
                                    _renderSlot(_ctx.$slots, 'footer', {}, () => [
                                      _ctx.action
                                        ? (_openBlock(),
                                          _createBlock(_resolveDynamicComponent(_ctx.action), {
                                            key: 0
                                          }))
                                        : _ctx.showFooter
                                          ? (_openBlock(),
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const style = computed(() => {
        ...
        return __spreadValues(
          __spreadValues(__spreadValues({}, themeVars.value), styles),
