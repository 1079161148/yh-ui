    ...
    _createBlock3(
      ...
      },
      {
        default: _withCtx2(() => [
          ...
          $props.loading
            ? _renderSlot3(_ctx.$slots, 'loading', { key: 0 }, () => [
                ...
                [
                  _renderSlot3(_ctx.$slots, 'icon', {}, () => [
                    $props.icon && typeof $props.icon !== 'string'
                      ? (_openBlock3(),
                        _createBlock3(_resolveDynamicComponent2($props.icon), { key: 0 }))
                      : _createCommentVNode3('v-if', true)
                  ])
                ],
                2
                ...
                [
                  _renderSlot3(_ctx.$slots, 'suffixIcon', {}, () => [
                    $props.suffixIcon && typeof $props.suffixIcon !== 'string'
                      ? (_openBlock3(),
                        _createBlock3(_resolveDynamicComponent2($props.suffixIcon), { key: 0 }))
                      : _createCommentVNode3('v-if', true)
                  ])
                ],
                2
                      ...
                      [
                        _createElementVNode3(
                          ...
                          [
                                  ...
                                  _createElementVNode3(
                                    ...
                                    [
                                        ...
                                        ? (_openBlock4(),
                                          _createBlock4(
                                            $setup['YhIcon'],
                                            {
                                              ...
                                              name: $setup.typeIcon,
                                              class: _normalizeClass3([
                                                $setup.ns.e('type-icon'),
                                                $setup.ns.em('type-icon', _ctx.type)
                                              ])
                                            },
                                            null,
                                            8,
                                      ...
                                      typeof _ctx.title === 'string'
                                        ...
                                        : _ctx.title
                                          ? (_openBlock4(),
                                            _createBlock4(_resolveDynamicComponent3(_ctx.title), {
                                              key: 2
                                            }))
                                          : _createCommentVNode4('v-if', true)
                                    ],
                            ...
                            _createElementVNode3(
                              ...
                              [
                                _ctx.loading
                                  ...
                                  : _createCommentVNode4('v-if', true),
                                !_ctx.destroyOnClose || !$setup.closed
                                  ? _renderSlot4(_ctx.$slots, 'default', { key: 1 }, () => [
                                      _ctx.content
                                        ? (_openBlock4(),
                                          _createElementBlock4(
                                            _Fragment3,
                                            ...
                                            [
                                              typeof _ctx.content === 'string'
                                                ...
                                                : (_openBlock4(),
                                                  _createBlock4(
                                                    _resolveDynamicComponent3(_ctx.content),
                                                    { key: 1 }
                                                  ))
                                            ],
                                            64
                            ...
                            _ctx.$slots.footer || _ctx.action || _ctx.showFooter
                              ? (_openBlock4(),
                                _createElementBlock4(
                                  'div',
                                  {
                                  ...
                                  [
                                    _renderSlot4(_ctx.$slots, 'footer', {}, () => [
                                      _ctx.action
                                        ? (_openBlock4(),
                                          _createBlock4(_resolveDynamicComponent3(_ctx.action), {
                                            key: 0
                                          }))
                                        : _ctx.showFooter
                                          ? (_openBlock4(),
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const style = computed14(() => {
        ...
        return __spreadValues5(
          __spreadValues5(__spreadValues5({}, themeVars.value), styles),
