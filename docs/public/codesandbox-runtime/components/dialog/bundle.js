...
// public/codesandbox-runtime/components/dialog/src/dialog.js
import { createCommentVNode as _createCommentVNode4, renderSlot as _renderSlot4, normalizeClass as _normalizeClass3, openBlock as _openBlock4, createBlock as _createBlock4, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode2, Fragment as _Fragment3, createElementBlock as _createElementBlock4, resolveDynamicComponent as _resolveDynamicComponent3, normalizeStyle as _normalizeStyle3, createElementVNode as _createElementVNode3, createVNode as _createVNode2, withCtx as _withCtx3, vShow as _vShow, withModifiers as _withModifiers, withDirectives as _withDirectives, Transition as _Transition2, Teleport as _Teleport } from "vue";
import { ref as ref14, watch as watch5, computed as computed14, nextTick } from "vue";
...
import { createCommentVNode as _createCommentVNode3, renderSlot as _renderSlot3, createElementVNode as _createElementVNode2, normalizeClass as _normalizeClass2, openBlock as _openBlock3, createElementBlock as _createElementBlock3, resolveDynamicComponent as _resolveDynamicComponent2, createBlock as _createBlock3, normalizeStyle as _normalizeStyle2, withCtx as _withCtx2 } from "vue";
import { computed as computed13, ref as ref13, useSlots as useSlots3 } from "vue";
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createBlock3(_resolveDynamicComponent2($props.tag), {
    ref: "buttonRef",
    ...
    default: _withCtx2(() => [
      _createCommentVNode3(" 1. \u52A0\u8F7D\u56FE\u6807 (\u4F18\u5148\u7EA7\u6700\u9AD8\uFF0C\u5B58\u5728\u65F6\u901A\u5E38\u9690\u85CF\u539F\u56FE\u6807) "),
      $props.loading ? _renderSlot3(_ctx.$slots, "loading", { key: 0 }, () => [
      ...
      _createCommentVNode3(" 2. \u524D\u7F6E/\u4E0A\u7F6E\u56FE\u6807 "),
      !$props.loading && $setup.hasIcon && ($props.iconPosition === "left" || $props.iconPosition === "top") ? (_openBlock3(), _createElementBlock3(
        "span",
        {
          key: 1,
        ...
        [
          _renderSlot3(_ctx.$slots, "icon", {}, () => [
            $props.icon && typeof $props.icon !== "string" ? (_openBlock3(), _createBlock3(_resolveDynamicComponent2($props.icon), { key: 0 })) : _createCommentVNode3("v-if", true)
          ])
        ],
        2
        /* CLASS */
      )) : _createCommentVNode3("v-if", true),
      _createCommentVNode3(" 3. \u5185\u5BB9\u533A "),
      ...
      _createCommentVNode3(" 4. \u540E\u7F6E/\u4E0B\u7F6E\u56FE\u6807 "),
      !$props.loading && $setup.hasIcon && ($props.iconPosition === "right" || $props.iconPosition === "bottom") ? (_openBlock3(), _createElementBlock3(
        "span",
        {
          key: 3,
          class: _normalizeClass2($setup.ns.e("icon"))
      ...
      _createCommentVNode3(" 5. \u72EC\u7ACB\u7684\u540E\u7F00\u56FE\u6807\uFF08suffixIcon \u63D2\u69FD\uFF09 "),
      !$props.loading && $setup.hasSuffixIcon ? (_openBlock3(), _createElementBlock3(
        "span",
        {
          key: 4,
        ...
        [
          _renderSlot3(_ctx.$slots, "suffixIcon", {}, () => [
            $props.suffixIcon && typeof $props.suffixIcon !== "string" ? (_openBlock3(), _createBlock3(_resolveDynamicComponent2($props.suffixIcon), { key: 0 })) : _createCommentVNode3("v-if", true)
          ])
        ],
        2
        /* CLASS */
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const actualSize = computed13(() => props.size || globalSize.value || "default");
    const buttonRef = ref13();
    const hasIcon = computed13(() => props.icon || slots.icon);
    const hasSuffixIcon = computed13(() => props.suffixIcon || slots.suffixIcon);
    const isVertical = computed13(() => props.iconPosition === "top" || props.iconPosition === "bottom");
    const buttonClasses = computed13(() => [
      ns.b(),
    ...
    const buttonStyles = computed13(() => {
      const base = themeStyle.value;
      if (!props.color) return base;
      const color = props.color;
      return __spreadProps(__spreadValues4({}, base), {
    ...
    const __returned__ = { props, emit, slots, ns, globalSize, themeStyle, actualSize, buttonRef, hasIcon, hasSuffixIcon, isVertical, buttonClasses, buttonStyles, handleClick, computed: computed13, ref: ref13, useSlots: useSlots3, get useNamespace() {
      return useNamespace;
    }, get useConfig() {
      return useConfig;
    }, get useComponentTheme() {
...
var YhButton = withInstall(stdin_default5);

// public/codesandbox-runtime/components/dialog/src/dialog-meta.js
var dialogProps = {
  /** 是否显示 */
  modelValue: {
    type: Boolean,
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createBlock4(_Teleport, { to: _ctx.teleportTo }, [
    _createVNode2(_Transition2, {
      name: $setup.ns.b("fade"),
      onAfterLeave: $setup.afterLeave
    }, {
      default: _withCtx3(() => [
        $setup.rendered ? _withDirectives((_openBlock4(), _createElementBlock4(
          "div",
          {
            key: 0,
          ...
          [
            _createElementVNode3("div", {
              ...
              class: _normalizeClass3($setup.dialogClasses),
              style: _normalizeStyle3($setup.style),
              tabindex: "-1"
            }, [
              _createCommentVNode4(" \u5934\u90E8 "),
              _createElementVNode3(
                "div",
                {
                  ref: "headerRef",
                  class: _normalizeClass3($setup.headerClasses),
                  style: _normalizeStyle3($setup.headerStyle),
                ...
                [
                  _renderSlot4(_ctx.$slots, "header", {}, () => [
                    _createElementVNode3("div", {
                      id: $setup.dialogId,
                      class: _normalizeClass3([$setup.ns.e("title"), _ctx.titleClass]),
                      style: _normalizeStyle3(_ctx.titleStyle)
                    }, [
                      _ctx.showIcon && $setup.typeIcon ? (_openBlock4(), _createBlock4($setup["YhIcon"], {
                        key: 0,
                        name: $setup.typeIcon,
                        class: _normalizeClass3([$setup.ns.e("type-icon"), $setup.ns.em("type-icon", _ctx.type)])
                      }, null, 8, ["name", "class"])) : _createCommentVNode4("v-if", true),
                      typeof _ctx.title === "string" ? (_openBlock4(), _createElementBlock4(
                        _Fragment3,
                        { key: 1 },
                        [
                          _createTextVNode2(
                        ...
                        64
                        /* STABLE_FRAGMENT */
                      )) : _ctx.title ? (_openBlock4(), _createBlock4(_resolveDynamicComponent3(_ctx.title), { key: 2 })) : _createCommentVNode4("v-if", true)
                    ], 14, _hoisted_22)
                  ]),
                  _ctx.showClose ? (_openBlock4(), _createElementBlock4(
                    "button",
                    {
                      key: 0,
                      class: _normalizeClass3($setup.ns.e("headerbtn")),
                      type: "button",
                      onClick: $setup.handleClose
                    },
                    [
                      _createVNode2($setup["YhIcon"], { name: _ctx.closeIcon }, null, 8, ["name"])
                    ],
                    2
                    /* CLASS */
              ...
              _createCommentVNode4(" \u4E3B\u4F53 "),
              _createElementVNode3(
                "div",
                {
                  class: _normalizeClass3([$setup.ns.e("body"), _ctx.contentClass]),
                  style: _normalizeStyle3([_ctx.contentStyle, $setup.contentBodyStyle])
                },
                [
                  _ctx.loading ? (_openBlock4(), _createElementBlock4(
                    "div",
                    {
                      key: 0,
                  ...
                  !_ctx.destroyOnClose || !$setup.closed ? _renderSlot4(_ctx.$slots, "default", { key: 1 }, () => [
                    _ctx.content ? (_openBlock4(), _createElementBlock4(
                      _Fragment3,
                      { key: 0 },
                      [
                        typeof _ctx.content === "string" ? (_openBlock4(), _createElementBlock4(
                          _Fragment3,
                          { key: 0 },
                          [
                            _createTextVNode2(
                          ...
                          64
                          /* STABLE_FRAGMENT */
                        )) : (_openBlock4(), _createBlock4(_resolveDynamicComponent3(_ctx.content), { key: 1 }))
                      ],
                      64
                      /* STABLE_FRAGMENT */
                    )) : _createCommentVNode4("v-if", true)
              ...
              _createCommentVNode4(" \u5E95\u90E8 "),
              _ctx.$slots.footer || _ctx.action || _ctx.showFooter ? (_openBlock4(), _createElementBlock4(
                "div",
                {
                  key: 0,
                  class: _normalizeClass3([$setup.footerClasses, _ctx.actionClass]),
                  style: _normalizeStyle3([_ctx.actionStyle, $setup.footerStyle])
                },
                [
                  _renderSlot4(_ctx.$slots, "footer", {}, () => [
                    _ctx.action ? (_openBlock4(), _createBlock4(_resolveDynamicComponent3(_ctx.action), { key: 0 })) : _ctx.showFooter ? (_openBlock4(), _createElementBlock4(
                      _Fragment3,
                      { key: 1 },
                      [
                        _createVNode2($setup["YhButton"], { onClick: $setup.handleCancel }, {
                          default: _withCtx3(() => [
                            _createTextVNode2(
                              _toDisplayString2(_ctx.cancelText || $setup.t("dialog.cancel")),
                              1
                              /* TEXT */
                            )
                          ]),
                        ...
                        _createVNode2($setup["YhButton"], {
                          ...
                          default: _withCtx3(() => [
                            _createTextVNode2(
                              _toDisplayString2(_ctx.confirmText || $setup.t("dialog.confirm")),
                              1
                              /* TEXT */
                            )
                          ]),
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const closed = ref14(true);
    const dialogRef = ref14(null);
    const headerRef = ref14(null);
    const rendered = ref14(false);
    useScrollLock(computed14(() => props.modelValue && props.lockScroll));
    const offset = ref14({ x: 0, y: 0 });
    ...
    const style = computed14(() => {
      ...
      return __spreadValues5(__spreadValues5(__spreadValues5({}, themeVars.value), styles), typeof props.style === "string" ? parseStyle(props.style) : props.style);
    });
    ...
    const typeIcon = computed14(() => typeIconMap[props.type] || "");
    const dialogClasses = computed14(() => [
      ns.b(),
      props.customClass,
      {
    ...
    const headerClasses = computed14(() => [
      ns.e("header"),
      {
        [ns.em("header", "center")]: props.headerAlignCenter || props.center
      }
    ]);
    const headerStyle = computed14(() => {
    ...
    const contentBodyStyle = computed14(() => {
      const styles = {};
    ...
    const footerClasses = computed14(() => [
      ns.e("footer"),
      {
        [ns.em("footer", "center")]: props.footerAlignCenter || props.center
      }
    ]);
    const footerStyle = computed14(() => {
      const styles = {};
      ...
      async (val) => {
        ...
        if (val) {
          ...
          if (props.autoFocus && dialogRef.value) {
            ...
            (_a2 = dialogRef.value) == null ? void 0 : _a2.focus();
          }
          emit("opened");
        } else {
          visible.value = false;
    ...
    }, handleWrapperMouseDown, handleWrapperClick, afterLeave, ref: ref14, watch: watch5, computed: computed14, nextTick, get useNamespace() {
      return useNamespace;
