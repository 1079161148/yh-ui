...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const highlightedCode = computed14(() => {
      ...
      if (lang && stdin_default5.getLanguage(lang)) {
        try {
          return stdin_default5.highlight(content, { language: lang, ignoreIllegals: true }).value;
        } catch (e) {
          return content;
        }
      }
      return stdin_default5.highlightAuto(content).value;
    });
