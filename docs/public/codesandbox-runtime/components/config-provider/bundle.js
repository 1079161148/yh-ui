// docs/public/codesandbox-runtime/components/config-provider/src/config-provider.js
import {
  defineComponent,
  provide as provide2,
  renderSlot,
...
// docs/public/codesandbox-runtime/theme/tokens/index.js
var colorTokens = {
  primary: {
    DEFAULT: '#409eff',
    light: {
...
// docs/public/codesandbox-runtime/theme/theme.js
...
var ThemeManager = class {
  ...
  getThemeStyles(colors = {}) {
    const styles = {}
    const themeColors = __spreadValues(
...
export { configProviderProps, stdin_default2 as default }
