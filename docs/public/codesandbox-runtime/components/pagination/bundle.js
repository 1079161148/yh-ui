// docs/public/codesandbox-runtime/components/pagination/src/pagination.js
import {
...
// docs/public/codesandbox-runtime/components/pagination/src/pagination-meta.js
var paginationProps = {
  /**
   * @description 当前页码
   * @default 1
              ...
              return (
                ...
                _createElementBlock(
                  ...
                  [
                          ...
                          [
                            _renderSlot(_ctx.$slots, 'next-icon', {}, () => [
                              _ctx.nextText
                                ...
                                : (_openBlock(),
                                  _createElementBlock('svg', _hoisted_7, [
                                    ...(_cache[7] ||
                                      (_cache[7] = [
                                        _createElementVNode(
                                          'path',
                    ...
                    item === 'slot'
                      ? _renderSlot(_ctx.$slots, 'default', { key: 6 })
                      : _createCommentVNode('v-if', true)
                  ],
                  64
                  /* STABLE_FRAGMENT */
