...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { t } = useLocale();
    const { themeStyle } = useComponentTheme("pagination", computed11(() => props.themeOverrides));
    const pageCount = computed11(() => {
      if (props.total > 0) {
        return Math.max(1, Math.ceil(props.total / props.pageSize));
      }
      return 1;
    });
    const internalCurrentPage = ref12(props.currentPage);
    watch4(() => props.currentPage, (val) => {
      internalCurrentPage.value = val;
    });
    const pagers = computed11(() => {
    ...
    const jumpValue = ref12(internalCurrentPage.value);
    watch4(internalCurrentPage, (val) => {
      jumpValue.value = val;
    });
    const handleJump = () => {
    ...
    const paginationClasses = computed11(() => [
      ns.b(),
    ...
    const layoutComponents = computed11(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, pageCount, internalCurrentPage, pagers, handleCurrentChange, handlePrev, handleNext, handleSizeChange, jumpValue, handleJump, paginationClasses, layoutComponents, computed: computed11, ref: ref12, watch: watch4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
