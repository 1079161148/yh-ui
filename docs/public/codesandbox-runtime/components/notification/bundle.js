// public/codesandbox-runtime/components/notification/src/notification.js
...
import { computed as computed11, onMounted as onMounted3, ref as ref12, watch as watch4, isVNode } from "vue";
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    let timer = null;
    const notificationClasses = computed11(() => [
      ns.b(),
      ns.m(props.position),
      props.type && ns.m(props.type),
      props.customClass
    ]);
    const notificationStyles = computed11(() => {
      const styles = {};
    ...
    const positionClass = computed11(() => {
      return props.position;
    });
    const iconName = computed11(() => {
    ...
    const renderMessage = computed11(() => {
    ...
    const isMessageVNode = computed11(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, visible, get timer() {
      ...
      timer = v;
    }, notificationClasses, notificationStyles, positionClass, iconName, renderMessage, isMessageVNode, startTimer, clearTimer, close, handleClick, handleMouseEnter, handleMouseLeave, onDestroy, computed: computed11, onMounted: onMounted3, ref: ref12, watch: watch4, isVNode, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
