// docs/public/codesandbox-runtime/components/notification/src/notification.js
import {
          ...
          _withDirectives(
            _createElementVNode(
              ...
              [
                ...
                $props.type || $props.icon || _ctx.$slots.icon
                  ? (_openBlock(),
                    _createElementBlock(
                      'div',
                      {
                              ...
                              _createElementBlock(
                                'span',
                                {
                                  ...
                                  class: _normalizeClass(
                                    $setup.ns.em('icon', $props.type || 'default')
                                  )
                                },
                                [
                                  $props.type === 'success'
                    ...
                    _createElementVNode(
                      ...
                      [
                        _renderSlot(_ctx.$slots, 'default', {}, () => [
                          ...
                          $setup.isMessageVNode
                            ? (_openBlock(),
                              _createBlock(
                                _resolveDynamicComponent($setup.renderMessage),
                                {
                                  key: 0,
