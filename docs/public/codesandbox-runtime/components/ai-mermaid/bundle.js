...
// public/codesandbox-runtime/components/ai-mermaid/src/ai-mermaid.js
import { createCommentVNode as _createCommentVNode3, renderSlot as _renderSlot3, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode2, normalizeClass as _normalizeClass2, createElementVNode as _createElementVNode2, openBlock as _openBlock3, createElementBlock as _createElementBlock3, createVNode as _createVNode2, renderList as _renderList2, Fragment as _Fragment3, normalizeStyle as _normalizeStyle2 } from "vue";
import { ref as ref13, computed as computed13, watch as watch5, shallowRef as shallowRef3 } from "vue";
...
// public/codesandbox-runtime/components/ai-mermaid/src/ai-mermaid-meta.js
var aiMermaidProps = {
  /** Mermaid 代码内容 */
  code: {
    type: String,
...
import { ref as ref12, watch as watch4, computed as computed12, useSlots as useSlots2, useId } from "vue";
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, ns, t, gradientId, themeStyle, emit, internalVisible, visible, get timer() {
      ...
      timer = v;
    }, handleShow, handleHide, sizePx, isGradient, gradientStops, spinStyle, spinClasses, ref: ref12, watch: watch4, computed: computed12, useSlots: useSlots2, useId, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useComponentTheme() {
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createElementBlock3(
    "div",
    {
      class: _normalizeClass2([$setup.ns.b(), _ctx.className]),
      style: _normalizeStyle2([$setup.themeStyle, _ctx.style])
    },
    [
      _createCommentVNode3(" \u5934\u90E8\u533A\u57DF "),
      _ctx.header || _ctx.$slots.header ? (_openBlock3(), _createElementBlock3(
        "div",
        {
          key: 0,
        ...
        [
          _createElementVNode2(
            "div",
            {
              class: _normalizeClass2($setup.ns.e("header-content"))
            },
            [
              _renderSlot3(_ctx.$slots, "header", {}, () => [
                _createTextVNode2(
                  _toDisplayString2(_ctx.header),
                  1
                  /* TEXT */
                )
              ])
          ...
          _createElementVNode2(
            "div",
            {
              class: _normalizeClass2($setup.ns.e("extra"))
            },
            [
              _renderSlot3(_ctx.$slots, "extra")
            ],
            2
            /* CLASS */
          )
      ...
      _createElementVNode2(
        ...
        [
          _createElementVNode2(
            "div",
            {
              class: _normalizeClass2($setup.ns.e("render-tabs"))
            },
            [
              _createElementVNode2(
                "button",
                {
                  class: _normalizeClass2([$setup.ns.e("render-tab"), $setup.renderType === "image" && $setup.ns.is("active")]),
                  onClick: _cache[0] || (_cache[0] = ($event) => $setup.handleRenderTypeChange("image"))
                },
                [
                  _createVNode2($setup["YhIcon"], { name: "image" }),
                  _createElementVNode2(
                    "span",
                    null,
                    _toDisplayString2($setup.t("ai.mermaid.image")),
                    1
                    /* TEXT */
                  )
                ],
              ...
              _createElementVNode2(
                "button",
                {
                  class: _normalizeClass2([$setup.ns.e("render-tab"), $setup.renderType === "code" && $setup.ns.is("active")]),
                  onClick: _cache[1] || (_cache[1] = ($event) => $setup.handleRenderTypeChange("code"))
                },
                [
                  _createVNode2($setup["YhIcon"], { name: "code" }),
                  _createElementVNode2(
                    "span",
                    null,
                    _toDisplayString2($setup.t("ai.mermaid.code")),
                    1
                    /* TEXT */
                  )
                ],
          ...
          $setup.actionButtons.length > 0 ? (_openBlock3(), _createElementBlock3(
            "div",
            {
              key: 0,
              class: _normalizeClass2($setup.ns.e("action-buttons"))
            },
            [
              (_openBlock3(true), _createElementBlock3(
                _Fragment3,
                null,
                _renderList2($setup.actionButtons, (btn) => {
                  return _openBlock3(), _createElementBlock3("button", {
                    key: btn.key,
                    class: _normalizeClass2($setup.ns.e("action-btn")),
                    title: btn.label,
                    onClick: btn.onClick
                  }, [
      ...
      _createElementVNode2(
        ...
        [
          ...
          $setup.isLoading ? (_openBlock3(), _createElementBlock3(
            "div",
            {
              key: 0,
              class: _normalizeClass2($setup.ns.e("loading"))
            },
            [
            ...
            2
            /* CLASS */
          )) : $setup.errorMessage ? (_openBlock3(), _createElementBlock3(
            _Fragment3,
            { key: 1 },
            [
              _createCommentVNode3(" \u9519\u8BEF\u72B6\u6001 "),
              _createElementVNode2(
                "div",
                {
                ...
                [
                  ...
                  _createElementVNode2(
                    "span",
                    null,
                    _toDisplayString2($setup.errorMessage),
                    1
                    /* TEXT */
                  ),
                  _createElementVNode2(
                    ...
                    _toDisplayString2($setup.t("ai.mermaid.retry")),
                    1
                    /* TEXT */
                  )
                ],
          ...
          _createCommentVNode3(" \u4EE3\u7801\u6A21\u5F0F "),
          $setup.renderType === "code" ? (_openBlock3(), _createElementBlock3(
            "div",
            {
              key: 2,
              class: _normalizeClass2($setup.ns.e("code"))
            },
            [
              _createElementVNode2("pre", null, [
                _createElementVNode2(
                  "code",
                  null,
                  _toDisplayString2(_ctx.code),
                  1
                  /* TEXT */
                )
              ])
            ...
            2
            /* CLASS */
          )) : $setup.renderType === "image" ? (_openBlock3(), _createElementBlock3(
            _Fragment3,
            { key: 3 },
            [
              _createCommentVNode3(" \u56FE\u7247\u6A21\u5F0F "),
              _createCommentVNode3(" eslint-disable vue/no-v-html "),
              _createElementVNode2("div", {
                ref: "graphContainerRef",
                class: _normalizeClass2($setup.ns.e("graph")),
                style: _normalizeStyle2($setup.transformStyle),
                innerHTML: $setup.svgContent
              }, null, 14, _hoisted_22)
            ],
            2112
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const mermaidModule = shallowRef3(null);
    const svgContent = ref13("");
    const errorMessage = ref13(null);
    const isLoading = ref13(false);
    const renderType = ref13("image");
    const zoomLevel = ref13(1);
    const graphContainerRef = ref13(null);
...
${processedCode}`;
    ...
    const handleDownload = () => {
      var _a2;
      const el = (_a2 = graphContainerRef.value) == null ? void 0 : _a2.querySelector("svg");
      if (!el) return;
      try {
    ...
    const transformStyle = computed13(() => ({
      transform: `scale(${zoomLevel.value})`,
      transformOrigin: "top left"
    }));
    const actionButtons = computed13(() => {
