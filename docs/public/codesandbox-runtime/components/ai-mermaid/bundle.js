              ...
              [
                _createElementVNode2(
                  'button',
                  {
                    class: _normalizeClass2([
                      $setup.ns.e('render-tab'),
                      $setup.renderType === 'image' && $setup.ns.is('active')
                    ]),
                    onClick:
                      _cache[0] || (_cache[0] = ($event) => $setup.handleRenderTypeChange('image'))
                  },
                  [
                ...
                _createElementVNode2(
                  'button',
                  {
                    class: _normalizeClass2([
                      $setup.ns.e('render-tab'),
                      $setup.renderType === 'code' && $setup.ns.is('active')
                    ]),
                    onClick:
                      _cache[1] || (_cache[1] = ($event) => $setup.handleRenderTypeChange('code'))
                  },
                  [
      ...
      const actionButtons = computed13(() => {
        ...
        if (enableZoom) {
          buttons.push(
            {
              key: 'zoom-in',
              label: t('ai.mermaid.zoomIn'),
              icon: 'zoom-in',
              onClick: handleZoomIn
            },
            {
              key: 'zoom-out',
              label: t('ai.mermaid.zoomOut'),
              icon: 'zoom-out',
