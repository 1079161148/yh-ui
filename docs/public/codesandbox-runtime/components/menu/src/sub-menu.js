import { createCommentVNode as _createCommentVNode, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, resolveDynamicComponent as _resolveDynamicComponent, createBlock as _createBlock, renderSlot as _renderSlot, createElementVNode as _createElementVNode, normalizeClass as _normalizeClass, withCtx as _withCtx, createVNode as _createVNode, normalizeStyle as _normalizeStyle, vShow as _vShow, withDirectives as _withDirectives, Transition as _Transition } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    "li",
    {
      class: _normalizeClass([$setup.ns.b(), $setup.ns.is("opened", $setup.isOpened), $setup.ns.is("active", $setup.isActive), $setup.ns.is("disabled", _ctx.disabled), $setup.ns.is("popup", $setup.isPopup)]),
      role: "menuitem",
    ...
    [
      ...
      $setup.isPopup ? (_openBlock(), _createBlock($setup["YhTooltip"], {
        key: 0,
            ...
            _createElementVNode(
              ...
              [
                _createVNode($setup["YhTooltip"], {
                  disabled: ((_a2 = $setup.menu) == null ? void 0 : _a2.collapse.value) || !$setup.isTitleOverflow,
                  placement: "top",
                  effect: "dark",
                  "show-after": 200,
                  "show-arrow": true,
                  ...
                  content: _withCtx(() => [
                    _createElementVNode("div", _hoisted_1, [
                      $setup.renderLabelContent ? (_openBlock(), _createElementBlock(
                        _Fragment,
                        { key: 0 },
                        [
                          typeof $setup.renderLabelContent === "string" ? (_openBlock(), _createElementBlock(
                            _Fragment,
                            { key: 0 },
                            [
                              _createTextVNode(
                            ...
                            64
                            /* STABLE_FRAGMENT */
                          )) : (_openBlock(), _createBlock(_resolveDynamicComponent($setup.renderLabelContent), { key: 1 }))
                        ],
                        64
                        /* STABLE_FRAGMENT */
                ...
                _createVNode($setup["YhIcon"], {
                  ...
                  class: _normalizeClass([$setup.ns.e("icon-arrow"), {
        ...
        _: 3
        /* FORWARDED */
      }, 8, ["visible", "placement", "z-index", "teleported", "popper-class", "popper-style", "offset", "effect", "persistent"])) : (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 1 },
        [
  ...
  setup(__props, { expose: __expose }) {
    ...
    const titleStyle = computed(() => {
      ...
      if ((menu == null ? void 0 : menu.mode.value) === "vertical" && !menu.collapse.value) {
        ...
        const indent = isRoot ? (_b = (_a = menu.rootIndent.value) != null ? _a : menu.indent.value) != null ? _b : 32 : (_c = menu.indent.value) != null ? _c : 32;
    ...
    const mergedShowTimeout = computed(() => {
      var _a, _b;
      return (_b = (_a = props.showTimeout) != null ? _a : menu == null ? void 0 : menu.showTimeout.value) != null ? _b : 300;
    });
    const mergedHideTimeout = computed(() => {
      var _a, _b;
      return (_b = (_a = props.hideTimeout) != null ? _a : menu == null ? void 0 : menu.hideTimeout.value) != null ? _b : 300;
    });
    const mergedPopperOffset = computed(() => {
      var _a, _b;
      return (_b = (_a = props.popperOffset) != null ? _a : menu == null ? void 0 : menu.popperOffset.value) != null ? _b : 6;
    });
    ...
    const __returned__ = { props, ns, menu, parentSubMenu, level, indexPath, opened, isOpened, isPopup, titleStyle, popperPlacement, get showTimer() {
      ...
      observer = v;
    }, handleMouseEnterHeader, renderLabelContent, ref, inject, computed, unref, provide, onMounted, onBeforeUnmount, get useNamespace() {
      return useNamespace;
    }, get YhIcon() {
      return YhIcon;
    }, get YhTooltip() {
