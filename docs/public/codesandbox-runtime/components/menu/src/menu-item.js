...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock("li", {
    ...
    _createVNode($setup["YhTooltip"], {
      ...
      disabled: ((_a = $setup.menu) == null ? void 0 : _a.collapse.value) ? false : !$setup.isOverflow,
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const isActive = computed(() => (menu == null ? void 0 : menu.activeIndex.value) === props.index);
    ...
    const __returned__ = { props, ns, menu, subMenu, indexPath, isActive, itemStyle, handleClick, contentRef, isOverflow, checkOverflow, get observer() {
      ...
      observer = v;
    }, handleMouseEnter, renderLabelContent, inject, computed, ref, onMounted, get useNamespace() {
      return useNamespace;
    }, get YhTooltip() {
      return YhTooltip;
    }, get menuItemProps() {
