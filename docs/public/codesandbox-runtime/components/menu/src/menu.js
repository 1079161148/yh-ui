...
import { renderSlot as _renderSlot, renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, createBlock as _createBlock, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle } from "vue";
      ...
      _renderSlot(_ctx.$slots, "default", {}, () => [
        (_openBlock(true), _createElementBlock(
          ...
          _renderList(_ctx.options, (item) => {
            return _openBlock(), _createBlock($setup["YhMenuRecursiveItem"], {
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getMenuItemKey = (item) => {
      var _a2, _b;
      const value = (_b = (_a2 = item[props.keyField || "key"]) != null ? _a2 : item.index) != null ? _b : item.key;
    ...
    const __returned__ = { props, emit, ns, themeStyle, activeIndex, openedMenus, menuStyle, getMenuItemKey, menuClass, handleSelect, handleOpen, handleClose, ref, computed, provide, toRef, watch, get useNamespace() {
      return useNamespace;
