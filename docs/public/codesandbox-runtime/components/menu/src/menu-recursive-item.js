import { createCommentVNode as _createCommentVNode, renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, resolveComponent as _resolveComponent, createBlock as _createBlock, withCtx as _withCtx, createVNode as _createVNode, toDisplayString as _toDisplayString, createElementVNode as _createElementVNode, createSlots as _createSlots } from "vue";
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      $props.item.group ? (_openBlock(), _createBlock($setup["YhMenuItemGroup"], {
        key: 0,
        ...
        default: _withCtx(() => [
          (_openBlock(true), _createElementBlock(
            ...
            _renderList($props.item.children, (child, idx) => {
              return _openBlock(), _createBlock(_component_yh_menu_recursive_item, {
        ...
        _: 1
        /* STABLE */
      }, 8, ["title"])) : $props.item.children && $props.item.children.length > 0 ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 1 },
        [
          _createCommentVNode(" \u5B50\u83DC\u5355\u6A21\u5F0F "),
          _createVNode($setup["YhSubMenu"], {
            ...
            $props.item.icon ? {
              ...
              fn: _withCtx(() => [
                ...
                _createElementVNode(
                  "span",
                  null,
                  _toDisplayString($props.item[$setup.labelField] || $props.item.label),
                  1
                  /* TEXT */
                )
              ]),
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { menu, keyField, labelField, inject, unref, get YhIcon() {
      return YhIcon;
    }, YhMenuItem, YhSubMenu, YhMenuItemGroup, get MENU_INJECTION_KEY() {
