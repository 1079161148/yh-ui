...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { themeStyle } = useComponentTheme("radio", computed(() => props.themeOverrides || (radioGroup == null ? void 0 : radioGroup.themeOverrides)));
    const inputRef = ref();
    ...
    const __returned__ = { props, emit, ns, radioGroup, themeStyle, inputRef, focused, hovering, isGroup, radioSize, isDisabled, radioName, isChecked, radioClasses, innerClasses, handleChange, handleFocus, handleBlur, focus, blur, computed, ref, inject, get useNamespace() {
      return useNamespace;
