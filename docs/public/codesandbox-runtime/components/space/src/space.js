...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSpace" }, {
  __name: "space",
  props: {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const spaceStyle = computed(() => __spreadValues(__spreadValues(__spreadProps(__spreadValues({}, themeStyle.value), {
      display: "inline-flex",
    ...
    const __returned__ = { props, slots, ns, themeStyle, sizeMap, resolveSize, gapStyle, spaceStyle, flattenVNodes, children, showSpacer, computed, useSlots, Fragment, Comment, Text, get useNamespace() {
      return useNamespace;
