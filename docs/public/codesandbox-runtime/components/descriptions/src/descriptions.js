...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, slots, ns, themeStyle, getFlattenChildren, rows, getStyle, getClassName, descriptionsClasses, computed, useSlots, Fragment, provide, get useNamespace() {
      return useNamespace;
