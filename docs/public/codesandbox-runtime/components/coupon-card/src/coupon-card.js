...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _createElementVNode(
        ...
        [
                ...
                [
                  _createElementVNode(
                    ...
                    [
                      ...
                      $setup.selectable ? (_openBlock(), _createElementBlock(
                        "div",
                        {
                          key: 0,
                  ...
                  _renderSlot(_ctx.$slots, "description", {}, () => [
                    $setup.description ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 0,
                  ...
                  $setup.percent !== void 0 ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
                    ...
                    [
                      ...
                      $setup.percentText ? (_openBlock(), _createElementBlock(
                        "div",
                        {
                          key: 0,
                  ...
                  _createElementVNode(
                    ...
                    [
                      _renderSlot(_ctx.$slots, "action", {}, () => [
                        $setup.finalActionText ? (_openBlock(), _createBlock($setup["YhButton"], {
                          key: 0,
                          type: "primary",
                          size: "small",
                          ...
                          _: 1
                          /* STABLE */
                        }, 8, ["disabled", "class"])) : _createCommentVNode("v-if", true)
                      ])
                    ],
                    2
                    /* CLASS */
          ...
          _renderSlot(_ctx.$slots, "badge", {}, () => [
            $setup.badge ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
                class: _normalizeClass([$setup.ns.e("badge"), $setup.ns.em("badge", $setup.badgeType)])
              },
          ...
          $setup.statusSealText ? _renderSlot(_ctx.$slots, "seal", {
            key: 0,
            status: $setup.status
          }, () => [
            _createElementVNode(
      ...
      $setup.rules || _ctx.$slots.rules ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          class: _normalizeClass([$setup.ns.e("rules"), $setup.ns.is("expanded", $setup.rulesExpanded)])
        },
        [
          _createElementVNode(
            "div",
...
import { YhCheckbox } from "../../checkbox/index.js";
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhCouponCard" }, {
  __name: "coupon-card",
