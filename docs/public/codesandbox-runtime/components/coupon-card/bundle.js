...
// public/codesandbox-runtime/components/coupon-card/src/coupon-card.js
import { createCommentVNode as _createCommentVNode4, toDisplayString as _toDisplayString2, normalizeClass as _normalizeClass4, createElementVNode as _createElementVNode3, renderSlot as _renderSlot4, createVNode as _createVNode, withModifiers as _withModifiers, openBlock as _openBlock4, createElementBlock as _createElementBlock4, normalizeStyle as _normalizeStyle4, createTextVNode as _createTextVNode2, withCtx as _withCtx3, createBlock as _createBlock3, vShow as _vShow, withDirectives as _withDirectives } from "vue";
import { computed as computed14, toRefs as toRefs2, ref as ref14 } from "vue";
...
// public/codesandbox-runtime/components/coupon-card/src/coupon-card-meta.js
var couponCardProps = {
  /** 标题 */
  title: {
    type: String,
...
// public/codesandbox-runtime/components/coupon-card/src/coupon-card.js
var _hoisted_12 = { style: { "white-space": "pre-wrap" } };
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createElementBlock4(
    "div",
    {
      class: _normalizeClass4([$setup.ns.b(), $setup.ns.is($setup.status), $setup.ns.m($setup.variant), $setup.ns.is("selectable", $setup.selectable), $setup.ns.is("selected", $setup.selected)]),
      style: _normalizeStyle4($setup.themeStyle),
      onClick: $setup.handleCardClick
    },
    [
      _createCommentVNode4(" \u4E3B\u4F53\u5185\u5BB9\u533A\u57DF\u5305\u88F9 "),
      _createElementVNode3(
        "div",
        {
          class: _normalizeClass4($setup.ns.e("content"))
        },
        [
          _createCommentVNode4(" \u5DE6\u4FA7\u91D1\u989D\u533A\u57DF "),
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass4($setup.ns.e("amount-side"))
            },
            [
              _createElementVNode3(
                "div",
                {
                  class: _normalizeClass4($setup.ns.e("amount"))
                },
                [
                  _createElementVNode3(
                    "span",
                    {
                      class: _normalizeClass4($setup.ns.e("symbol"))
                    },
                    _toDisplayString2($setup.symbol),
                    3
                    /* TEXT, CLASS */
                  ),
                  _createElementVNode3(
                    "span",
                    null,
                    _toDisplayString2($setup.amount),
                    1
                    /* TEXT */
                  )
                ],
              ...
              _createElementVNode3(
                "div",
                {
                  class: _normalizeClass4($setup.ns.e("threshold"))
                },
                _toDisplayString2($setup.thresholdText),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          _createCommentVNode4(" \u53F3\u4FA7\u5185\u5BB9\u533A\u57DF "),
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass4($setup.ns.e("main-side"))
            },
            [
              _createElementVNode3(
                "div",
                {
                  class: _normalizeClass4($setup.ns.e("info"))
                },
                [
                  _createElementVNode3(
                    "div",
                    {
                      class: _normalizeClass4($setup.ns.e("title-row"))
                    },
                    [
                      _renderSlot4(_ctx.$slots, "title", {}, () => [
                        _createElementVNode3(
                          ...
                          _toDisplayString2($setup.title),
                          3
                          /* TEXT, CLASS */
                        )
                      ]),
                      $setup.selectable ? (_openBlock4(), _createElementBlock4(
                        "div",
                        {
                          key: 0,
                          class: _normalizeClass4($setup.ns.e("checkbox")),
                          onClick: _cache[0] || (_cache[0] = _withModifiers(() => {
                          }, ["stop"]))
                        },
                        [
                          _createVNode($setup["YhCheckbox"], {
                  ...
                  _renderSlot4(_ctx.$slots, "description", {}, () => [
                    $setup.description ? (_openBlock4(), _createElementBlock4(
                      "div",
                      {
                        key: 0,
                        class: _normalizeClass4($setup.ns.e("description"))
                      },
                      _toDisplayString2($setup.description),
                      3
                      /* TEXT, CLASS */
                    )) : _createCommentVNode4("v-if", true)
                  ]),
                  _createCommentVNode4(" \u75AF\u62A2\u8FDB\u5EA6\u6761 "),
                  $setup.percent !== void 0 ? (_openBlock4(), _createElementBlock4(
                    "div",
                    {
                      key: 0,
                      class: _normalizeClass4($setup.ns.e("progress"))
                    },
                    [
                      _createElementVNode3(
                        "div",
                        {
                          class: _normalizeClass4($setup.ns.e("progress-bar"))
                        },
                        [
                          _createElementVNode3(
                            "div",
                            {
                              class: _normalizeClass4($setup.ns.e("progress-inner")),
                      ...
                      $setup.percentText ? (_openBlock4(), _createElementBlock4(
                        "div",
                        {
                          key: 0,
                          class: _normalizeClass4($setup.ns.e("progress-text"))
                        },
                        _toDisplayString2($setup.percentText),
                        3
                        /* TEXT, CLASS */
                      )) : _createCommentVNode4("v-if", true)
                    ],
              ...
              _createElementVNode3(
                ...
                [
                  _createElementVNode3(
                    "div",
                    {
                      class: _normalizeClass4($setup.ns.e("valid-period"))
                    },
                    _toDisplayString2($setup.validPeriod),
                    3
                    /* TEXT, CLASS */
                  ),
                  _createElementVNode3(
                    "div",
                    {
                      class: _normalizeClass4($setup.ns.e("action-area")),
                      onClick: _cache[1] || (_cache[1] = _withModifiers(() => {
                      }, ["stop"]))
                    },
                    [
                      _renderSlot4(_ctx.$slots, "action", {}, () => [
                        $setup.finalActionText ? (_openBlock4(), _createBlock3($setup["YhButton"], {
                          key: 0,
                          type: "primary",
                          size: "small",
                          disabled: !$setup.isAvailable,
                          class: _normalizeClass4($setup.ns.e("action-btn")),
                          onClick: $setup.handleActionClick
                        }, {
                          default: _withCtx3(() => [
                            _createTextVNode2(
                              _toDisplayString2($setup.finalActionText),
                              1
                              /* TEXT */
                            )
                          ]),
                          _: 1
                          /* STABLE */
                        }, 8, ["disabled", "class"])) : _createCommentVNode4("v-if", true)
                      ])
                    ],
                    2
                    /* CLASS */
          ...
          _createCommentVNode4(" \u6D6E\u52A8\u89D2\u6807 "),
          _renderSlot4(_ctx.$slots, "badge", {}, () => [
            $setup.badge ? (_openBlock4(), _createElementBlock4(
              "div",
              {
                key: 0,
                class: _normalizeClass4([$setup.ns.e("badge"), $setup.ns.em("badge", $setup.badgeType)])
              },
              _toDisplayString2($setup.badge),
              3
              /* TEXT, CLASS */
            )) : _createCommentVNode4("v-if", true)
          ]),
          _createCommentVNode4(" \u72B6\u6001\u6C34\u5370 "),
          $setup.statusSealText ? _renderSlot4(_ctx.$slots, "seal", {
            key: 0,
            status: $setup.status
          }, () => [
            _createElementVNode3(
              "div",
              {
                class: _normalizeClass4([$setup.ns.e("seal"), $setup.ns.is($setup.status)])
              },
              _toDisplayString2($setup.statusSealText),
              3
              /* TEXT, CLASS */
            )
          ]) : _createCommentVNode4("v-if", true)
      ...
      _createCommentVNode4(" \u5E95\u90E8\u4F7F\u7528\u89C4\u5219\u5C55\u5F00\u533A "),
      $setup.rules || _ctx.$slots.rules ? (_openBlock4(), _createElementBlock4(
        "div",
        {
          key: 0,
          class: _normalizeClass4([$setup.ns.e("rules"), $setup.ns.is("expanded", $setup.rulesExpanded)])
        },
        [
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass4($setup.ns.e("rules-trigger")),
              onClick: _cache[2] || (_cache[2] = _withModifiers(($event) => $setup.rulesExpanded = !$setup.rulesExpanded, ["stop"]))
            },
            [
              _createElementVNode3(
                "span",
                null,
                _toDisplayString2($setup.finalRuleTitle),
                1
                /* TEXT */
              ),
              (_openBlock4(), _createElementBlock4(
                "svg",
                {
                  class: _normalizeClass4($setup.ns.e("rules-icon")),
                  viewBox: "0 0 1024 1024",
                  width: "12",
                  height: "12"
                },
          ...
          _createCommentVNode4(" \u6298\u53E0\u9762\u677F\u5185\u5BB9 "),
          _withDirectives(_createElementVNode3(
            "div",
            {
              class: _normalizeClass4($setup.ns.e("rules-content"))
            },
            [
              _renderSlot4(_ctx.$slots, "rules", {}, () => [
                _createElementVNode3(
                  "div",
                  _hoisted_12,
                  _toDisplayString2($setup.rules),
                  1
                  /* TEXT */
                )
              ])
...
var __sfc__4 = /* @__PURE__ */ Object.assign({ name: "YhCouponCard" }, {
  __name: "coupon-card",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const rulesExpanded = ref14(false);
    ...
    const isAvailable = computed14(() => status.value === "available");
    const isUsed = computed14(() => status.value === "used");
    const isExpired = computed14(() => status.value === "expired");
    const thresholdText = computed14(() => {
    ...
    const __returned__ = { props, emit, title, description, amount, symbol, threshold, validPeriod, status, actionText, selectable, selected, variant, badge, badgeType, percent, percentText, rules, ruleTitle, rulesExpanded, ns, t, themeStyle, isAvailable, isUsed, isExpired, thresholdText, statusSealText, finalActionText, finalRuleTitle, handleActionClick, handleCardClick, handleCheckChange, computed: computed14, toRefs: toRefs2, ref: ref14, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, get useComponentTheme() {
