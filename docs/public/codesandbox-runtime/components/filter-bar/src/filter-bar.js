                ...
                _createElementVNode(
                  ...
                  [
                    _renderSlot(_ctx.$slots, "panel-content", {
                      ...
                      var _a;
                      return [
                        ((_a = $setup.panelFilter.options) == null ? void 0 : _a.length) ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
...
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhFilterBar" }, {
  __name: "filter-bar",
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function resetPanel() {
      if (panelFilter.value) {
        ...
        tempPanelValue.value = __spreadProps(__spreadValues({}, tempPanelValue.value), { [key]: null });
    ...
    function toggleOption(item, option) {
      ...
      if (item.type === "checkbox") {
        ...
        tempPanelValue.value = __spreadProps(__spreadValues({}, tempPanelValue.value), { [key]: arr.length ? arr : null });
      } else {
        const newVal = currentVal === option.value ? null : option.value;
        tempPanelValue.value = __spreadProps(__spreadValues({}, tempPanelValue.value), { [key]: newVal });
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, innerSort, handleSortClick, isPanelOpen, panelFilter, tempPanelValue, innerFilterValue, openFilterPanel, closePanel, confirmPanel, resetPanel, resetAll, toggleOption, isOptionSelected, activeFilterCount, barRef, isStuck, get observer() {
      ...
      observer = v;
    }, handleViewToggle, ref, computed, watch, onMounted, onUnmounted, get useNamespace() {
      return useNamespace;
