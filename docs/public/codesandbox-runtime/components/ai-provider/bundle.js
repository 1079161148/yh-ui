// public/codesandbox-runtime/components/ai-provider/src/ai-provider.js
import { renderSlot as _renderSlot } from "vue";
import { provide } from "vue";

// public/codesandbox-runtime/components/ai-provider/src/ai-provider-meta.js
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  props: {
    ...
    typewriter: { type: Object, required: false, default: () => ({ enabled: true, charsPerFrame: 1 }) },
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, interceptors, config, provide, get AI_PROVIDER_KEY() {
