...
import { createCommentVNode as _createCommentVNode2, renderList as _renderList2, Fragment as _Fragment2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, toDisplayString as _toDisplayString2, normalizeClass as _normalizeClass2, createElementVNode as _createElementVNode2, withModifiers as _withModifiers2, renderSlot as _renderSlot2, createTextVNode as _createTextVNode2, withCtx as _withCtx2, createVNode as _createVNode, vShow as _vShow, normalizeStyle as _normalizeStyle2, withDirectives as _withDirectives, Transition as _Transition, Teleport as _Teleport, createBlock as _createBlock2 } from "vue";
import { computed as computed12, ref as ref13, watch as watch5, nextTick, provide as provide2, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2 } from "vue";
...
import { renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, createCommentVNode as _createCommentVNode, createElementVNode as _createElementVNode, normalizeClass as _normalizeClass, withModifiers as _withModifiers, renderSlot as _renderSlot, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, normalizeStyle as _normalizeStyle, withCtx as _withCtx, createBlock as _createBlock } from "vue";
import { computed as computed11, ref as ref12, watch as watch4, defineComponent, h as h2 } from "vue";
    ...
    [
      (_openBlock(true), _createElementBlock(
        ...
        _renderList($setup.menus, (colMenu, colLevel) => {
          return _openBlock(), _createBlock($setup["CascaderMenu"], {
            key: colLevel,
            menu: colMenu,
            level: colLevel,
            ...
            default: _withCtx(({ option, level: menuLevel, startIndex, idx }) => [
              (_openBlock(), _createElementBlock("div", {
                ...
                class: _normalizeClass([$setup.ns.e("node"), $setup.ns.is("expanded", $setup.isExpanded(option, menuLevel)), $setup.ns.is("checked", $props.isChecked($setup.getPath(option, menuLevel))), $setup.ns.is("disabled", option[$props.config.disabled]), $setup.ns.is("selectable", $setup.isSelectable(option))]),
                style: _normalizeStyle($props.virtual ? {
                  position: "absolute",
                ...
                $props.isMultiple && $setup.isSelectable(option) ? (_openBlock(), _createElementBlock("span", {
                  key: 0,
                  class: _normalizeClass($setup.ns.e("checkbox")),
                  onClick: _withModifiers(($event) => $setup.handleCheckboxClick(option, menuLevel, $event), ["stop"])
                }, [
                  _createElementVNode(
                    "span",
                    {
                      class: _normalizeClass([$setup.ns.e("checkbox-inner"), $setup.ns.is("checked", $props.isChecked($setup.getPath(option, menuLevel)))])
                    },
                    [
                      $props.isChecked($setup.getPath(option, menuLevel)) ? (_openBlock(), _createElementBlock("svg", _hoisted_3, [..._cache[1] || (_cache[1] = [
                        _createElementVNode(
                          "path",
                          {
                            fill: "currentColor",
                ...
                $setup.hasChildren(option) ? (_openBlock(), _createElementBlock(
                  "span",
                  {
                    key: 1,
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, CascaderMenu, menus, isExpanded, hasChildren, isLeaf, isSelectable, getPath, handleCheckboxClick, handleClick, handleMouseEnter, computed: computed11, ref: ref12, watch: watch4, defineComponent, h: h2, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    } };
    ...
    [
      ...
      _createElementVNode2(
        ...
        [
          ...
          $setup.isMultiple ? (_openBlock2(), _createElementBlock2(
            _Fragment2,
            { key: 0 },
            [
              (_openBlock2(true), _createElementBlock2(
                ...
                _renderList2($setup.displayTags, (tag) => {
                  return _openBlock2(), _createElementBlock2(
                    ...
                    {
                      key: tag.path.join(","),
                      class: _normalizeClass2([$setup.ns.e("tag"), $props.tagType ? `yh-tag--${$props.tagType}` : ""])
                    },
                    [
                      _createElementVNode2(
                        "span",
              ...
              $setup.collapsedCount > 0 ? (_openBlock2(), _createElementBlock2(
                "span",
                {
                  key: 0,
          ...
          !$setup.isMultiple && $setup.hasValue && !$setup.query ? (_openBlock2(), _createElementBlock2(
            "span",
            {
              key: 1,
      ...
      (_openBlock2(), _createBlock2(_Teleport, {
        ...
        _createVNode(_Transition, {
          ...
          default: _withCtx2(() => [
            _withDirectives(_createElementVNode2(
              "div",
              {
                ref: "dropdownRef",
              ...
              [
                ...
                $props.filterable && $setup.query && $setup.filteredSuggestions.length > 0 ? (_openBlock2(), _createElementBlock2(
                  "div",
                  {
                    key: 0,
                    ...
                    (_openBlock2(true), _createElementBlock2(
                      ...
                      _renderList2($setup.filteredSuggestions, (suggestion) => {
                        return _openBlock2(), _createElementBlock2("div", {
                          ...
                          class: _normalizeClass2([$setup.ns.e("suggestion"), $setup.ns.is("checked", $setup.isChecked(suggestion.path))]),
                          onClick: _withModifiers2(($event) => $setup.handleSelectSuggestion(suggestion), ["stop"])
                        }, _toDisplayString2(suggestion.labels.join($props.separator)), 11, _hoisted_32);
                      }),
                      128
                      /* KEYED_FRAGMENT */
                    ))
                  ...
                  [
                    ...
                    _createVNode($setup["CascaderPanel"], {
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const config = computed12(() => {
      ...
      return __spreadProps(__spreadValues2(__spreadValues2({}, defaultCascaderConfig), props.props), {
        // 直接属性覆盖
