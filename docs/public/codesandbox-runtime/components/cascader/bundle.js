...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, CascaderMenu, menus, isExpanded, hasChildren, isLeaf, isSelectable, getPath, handleCheckboxClick, handleClick, handleMouseEnter, computed: computed11, ref: ref12, watch: watch4, defineComponent, h, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    } };
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { t } = useLocale();
    const inputId = useId();
    const { themeStyle } = useComponentTheme("cascader", computed12(() => props.themeOverrides));
    const { form, formItem, validate: triggerValidate } = useFormItem();
    const { globalSize } = useConfig();
    const cascaderSize = computed12(() => props.size || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalSize.value || "default");
