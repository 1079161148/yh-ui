    ...
    [
      ...
      _createElementVNode(
        ...
        [
          ...
          $setup.isMultiple ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [
          ...
          !$setup.isMultiple && $setup.hasValue && !$setup.query ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 1,
          ...
          default: _withCtx(() => [
            _withDirectives(_createElementVNode(
              ...
              [
                ...
                $props.filterable && $setup.query && $setup.filteredSuggestions.length > 0 ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                    ...
                    (_openBlock(true), _createElementBlock(
                      ...
                      _renderList($setup.filteredSuggestions, (suggestion) => {
                        return _openBlock(), _createElementBlock("div", {
                          ...
                          class: _normalizeClass([$setup.ns.e("suggestion"), $setup.ns.is("checked", $setup.isChecked(suggestion.path))]),
                          onClick: _withModifiers(($event) => $setup.handleSelectSuggestion(suggestion), ["stop"])
                        }, _toDisplayString(suggestion.labels.join($props.separator)), 11, _hoisted_3);
                      }),
                      128
                      /* KEYED_FRAGMENT */
                    ))
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const cascaderSize = computed(() => props.size || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalSize.value || "default");
    const config = computed(() => {
      var _a, _b, _c, _d, _e, _f;
      return __spreadProps(__spreadValues(__spreadValues({}, defaultCascaderConfig), props.props), {
        // 直接属性覆盖
        multiple: props.multiple || ((_a = props.props) == null ? void 0 : _a.multiple) || false,
      ...
      if (isMultiple.value) {
        ...
        if (values && Array.isArray(values)) {
          for (const path of values) {
            ...
            if (node && (!leafOnly || !((_a = node[config.value.children]) == null ? void 0 : _a.length))) {
              nodes.push(node);
            }
          }
        }
