...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, CascaderMenu, menus, isExpanded, hasChildren, isLeaf, isSelectable, getPath, handleCheckboxClick, handleClick, handleMouseEnter, computed, ref, watch, defineComponent, h, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    } };
