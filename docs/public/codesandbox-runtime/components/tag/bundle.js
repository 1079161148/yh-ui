// public/codesandbox-runtime/components/tag/src/tag.js
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, slots, ns, globalSize, themeStyle, isEditing, editValue, inputRef, hasIcon, hasSuffixIcon, tagClasses, tagStyle, handleClick, handleClose, startEdit, handleEditInput, handleEditConfirm, handleEditKeydown, computed: computed3, ref: ref2, nextTick, useSlots, get useNamespace() {
      return useNamespace;
    }, get useConfig() {
      return useConfig;
