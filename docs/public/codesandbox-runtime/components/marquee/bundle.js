// public/codesandbox-runtime/components/marquee/src/marquee.js
...
// public/codesandbox-runtime/components/marquee/src/marquee-meta.js
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { themeStyle } = useComponentTheme("marquee", computed2(() => props.themeOverrides));
    ...
    const __returned__ = { props, emit, ns, themeStyle, containerRef, contentRef, cloneCount, isReady, isHidden, isLoopPaused, computedDuration, marqueeStyle, overlayStyle, calculateClones, handleAnimationIteration, ref: ref2, computed: computed2, onMounted, onUnmounted, watch, nextTick, get useNamespace() {
      return useNamespace;
