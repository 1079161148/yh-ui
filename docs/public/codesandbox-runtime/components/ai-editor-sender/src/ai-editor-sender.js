import { createCommentVNode as _createCommentVNode, renderSlot as _renderSlot, renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, normalizeClass as _normalizeClass, createVNode as _createVNode, toDisplayString as _toDisplayString, createElementVNode as _createElementVNode, vModelText as _vModelText, withDirectives as _withDirectives, withCtx as _withCtx, createBlock as _createBlock, normalizeStyle as _normalizeStyle, Transition as _Transition, Teleport as _Teleport } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _ctx.attachments.length > 0 || _ctx.$slots.header ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          class: _normalizeClass([$setup.ns.e("header"), $setup.ns.is("empty", _ctx.attachments.length === 0 && !_ctx.$slots.header)])
        },
        [
      ...
      (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
        _createVNode(_Transition, { name: "yh-fade-in-scale-up" }, {
          default: _withCtx(() => [
            $setup.showCommandPanel && _ctx.enableCommands ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
              ...
              [
                _createElementVNode(
                  ...
                  [
                    $setup.commandSearchText ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 0,
                    ...
                    _createElementVNode(
                      ...
                      [
                            ...
                            return _openBlock(), _createElementBlock(
                              ...
                              [
                                _createElementVNode("div", {
                                  class: _normalizeClass([$setup.ns.e("command-item"), $setup.ns.is("selected", $setup.selectedCommandIndex === index), $setup.ns.is("disabled", command.disabled), $setup.ns.is("parent", !!((_a = command.children) == null ? void 0 : _a.length))]),
                                  onClick: ($event) => $setup.selectCommand(command),
                                  onMouseenter: ($event) => $setup.selectedCommandIndex = index
                                }, [
                                  _ctx.showCommandIcon ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                    key: 0,
                                  ...
                                  _createElementVNode(
                                    "div",
                                    {
                                      class: _normalizeClass($setup.ns.e("command-content"))
                                    },
                                    [
                                      _createElementVNode(
                                        "span",
                                      ...
                                      _ctx.showCommandDescription && command.description ? (_openBlock(), _createElementBlock(
                                        "span",
                                        {
                                          key: 0,
                                  ...
                                  ((_b = command.children) == null ? void 0 : _b.length) ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                    key: 1,
                                    name: "chevron-right",
                                    class: _normalizeClass($setup.ns.e("command-arrow"))
                                  }, null, 8, ["class"])) : _createCommentVNode("v-if", true)
                                ], 42, _hoisted_2),
                                _createCommentVNode(" \u5D4C\u5957\u5B50\u547D\u4EE4 "),
                                $setup.showCascadePanel && ((_c = $setup.currentCascadeParent) == null ? void 0 : _c.id) === command.id ? (_openBlock(true), _createElementBlock(
                                  _Fragment,
                                  { key: 0 },
                                  _renderList($setup.cascadeCommands, (child, childIndex) => {
                                    return _openBlock(), _createElementBlock("div", {
                                      key: `${command.id}-${child.id}`,
                                      class: _normalizeClass([$setup.ns.e("command-item"), $setup.ns.e("command-cascade-item"), $setup.ns.is("selected", $setup.selectedCommandIndex === $setup.filteredCommands.length + childIndex), $setup.ns.is("disabled", child.disabled)]),
                                      ...
                                      _createElementVNode(
                                        ...
                                        [
                                          ...
                                          _ctx.showCommandDescription && child.description ? (_openBlock(), _createElementBlock(
                                            "span",
                                            {
                                              key: 0,
                                              class: _normalizeClass($setup.ns.e("command-desc"))
                        ...
                        $setup.filteredCommands.length === 0 ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, textareaRef, localValue, isFocused, showCommandPanel, commandSearchText, filteredCommands, selectedCommandIndex, cascadeCommands, currentCascadeParent, showCascadePanel, cascadePosition, innerValue, autoResize, handleInput, handleKeyDown, checkCommandTrigger, filterCommands, getAllVisibleCommands, navigateCommands, selectCommand, openCascadePanel, insertCommandToText, hideCommandPanel, handleSend, handleRemoveAttachment, commandPanelStyle, getCommandIcon, get useNamespace() {
      return useNamespace;
    }, ref, computed, watch, nextTick, get aiEditorSenderProps() {
