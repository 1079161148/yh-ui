// public/codesandbox-runtime/components/ai-editor-sender/src/ai-editor-sender.js
import { createCommentVNode as _createCommentVNode3, renderSlot as _renderSlot3, renderList as _renderList, Fragment as _Fragment2, openBlock as _openBlock3, createElementBlock as _createElementBlock3, normalizeClass as _normalizeClass2, createVNode as _createVNode, toDisplayString as _toDisplayString, createElementVNode as _createElementVNode2, vModelText as _vModelText, withDirectives as _withDirectives, withCtx as _withCtx2, createBlock as _createBlock3, normalizeStyle as _normalizeStyle2, Transition as _Transition, Teleport as _Teleport } from "vue";
...
// public/codesandbox-runtime/components/ai-editor-sender/src/ai-editor-sender.js
import { ref as ref3, computed as computed5, watch, nextTick } from "vue";

// public/codesandbox-runtime/components/ai-editor-sender/src/ai-editor-sender-meta.js
var aiEditorSenderProps = {
  modelValue: {
    type: String,
    default: ""
  },
...
var YhButton = withInstall(stdin_default);
...
import { computed as computed4, useSlots as useSlots2 } from "vue";
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { themeStyle } = useComponentTheme(
      "icon",
      computed4(() => props.themeOverrides)
    );
    const iconStyle = computed4(() => {
    ...
    const iconClass = computed4(() => [
      ns.b(),
      {
        [ns.m("spin")]: props.spin
      }
    ]);
    const svgContent = computed4(() => {
      if (props.svg) {
        return props.svg;
      }
      if (props.name) {
    ...
    const hasSlot = computed4(() => !!slots.default);
    const useIconComponent = computed4(() => {
      return props.icon && !("__svg" in props.icon);
    });
    const __returned__ = { props, slots, ns, themeStyle, iconStyle, iconClass, svgContent, viewBox, hasSlot, useIconComponent, computed: computed4, useSlots: useSlots2, get iconProps() {
      return iconProps;
    }, get getIcon() {
      return getIcon;
    }, get useNamespace() {
...
// public/codesandbox-runtime/components/ai-editor-sender/src/ai-editor-sender.js
var _hoisted_12 = ["placeholder", "disabled", "maxlength", "rows"];
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createElementBlock3(
    "div",
    {
      class: _normalizeClass2([$setup.ns.b(), $setup.ns.is("disabled", _ctx.disabled), $setup.ns.is("loading", _ctx.loading), $setup.ns.is("focused", $setup.isFocused)]),
      style: _normalizeStyle2($setup.themeStyle)
    },
    [
      _createCommentVNode3(" Header (Attachments bar) "),
      _ctx.attachments.length > 0 || _ctx.$slots.header ? (_openBlock3(), _createElementBlock3(
        "div",
        {
          key: 0,
          class: _normalizeClass2([$setup.ns.e("header"), $setup.ns.is("empty", _ctx.attachments.length === 0 && !_ctx.$slots.header)])
        },
        [
            ...
            (_openBlock3(true), _createElementBlock3(
              ...
              _renderList(_ctx.attachments, (item, index) => {
                return _openBlock3(), _createElementBlock3(
                  ...
                  {
                    key: index,
                    class: _normalizeClass2($setup.ns.e("attachment"))
                  },
                  [
                    _createVNode($setup["YhIcon"], {
                      name: item.url ? "image" : "document",
                      class: _normalizeClass2($setup.ns.e("attachment-icon"))
                    }, null, 8, ["name", "class"]),
                    ...
                    _createVNode($setup["YhIcon"], {
                      name: "close",
                      class: _normalizeClass2($setup.ns.e("attachment-remove")),
      ...
      _createCommentVNode3(" Body (Textarea) "),
      _createElementVNode2(
        "div",
        {
        ...
        [
          _withDirectives(_createElementVNode2("textarea", {
            ref: "textareaRef",
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.innerValue = $event),
            class: _normalizeClass2($setup.ns.e("textarea")),
      ...
      _createCommentVNode3(" Footer (Toolbar & Actions) "),
      _createElementVNode2(
        "div",
        {
        ...
        [
          _createCommentVNode3(" Toolbar (Shortcuts) "),
          _createElementVNode2(
            "div",
            {
              class: _normalizeClass2($setup.ns.e("toolbar"))
            },
            [
          ...
          _createElementVNode2(
            ...
            [
              _ctx.showWordLimit && _ctx.maxLength ? (_openBlock3(), _createElementBlock3(
                "span",
                {
                  key: 0,
                  class: _normalizeClass2($setup.ns.e("word-limit"))
                },
              ...
              _renderSlot3(_ctx.$slots, "submit", {
                submit: $setup.handleSend,
                disabled: !$setup.innerValue.trim() || _ctx.disabled || _ctx.loading,
                loading: _ctx.loading
              }, () => [
                _createVNode($setup["YhButton"], {
                  type: $setup.innerValue.trim() && !_ctx.disabled && !_ctx.loading ? "primary" : "default",
                  class: _normalizeClass2($setup.ns.e("send-btn")),
                  ...
                  icon: _withCtx2(() => [
                    _createVNode($setup["YhIcon"], { name: "send" })
                  ]),
                  _: 1
                  /* STABLE */
      ...
      _createCommentVNode3(" Command Panel "),
      (_openBlock3(), _createBlock3(_Teleport, { to: "body" }, [
        _createVNode(_Transition, { name: "yh-fade-in-scale-up" }, {
          default: _withCtx2(() => [
            $setup.showCommandPanel && _ctx.enableCommands ? (_openBlock3(), _createElementBlock3(
              "div",
              {
                key: 0,
                class: _normalizeClass2($setup.ns.e("command-panel-wrapper"))
              },
              [
                _createElementVNode2(
                  "div",
                  {
                    class: _normalizeClass2($setup.ns.e("command-panel")),
                    style: _normalizeStyle2($setup.commandPanelStyle)
                  },
                  [
                    $setup.commandSearchText ? (_openBlock3(), _createElementBlock3(
                      "div",
                      {
                        key: 0,
                        class: _normalizeClass2($setup.ns.e("command-search"))
                      },
                      [
                    ...
                    _createElementVNode2(
                      "div",
                      {
                        class: _normalizeClass2($setup.ns.e("command-list"))
                      },
                      [
                        _createCommentVNode3(" \u4E3B\u547D\u4EE4\u5217\u8868 "),
                        (_openBlock3(true), _createElementBlock3(
                          _Fragment2,
                          null,
                            ...
                            return _openBlock3(), _createElementBlock3(
                              ...
                              [
                                _createElementVNode2("div", {
                                  class: _normalizeClass2([$setup.ns.e("command-item"), $setup.ns.is("selected", $setup.selectedCommandIndex === index), $setup.ns.is("disabled", command.disabled), $setup.ns.is("parent", !!((_a = command.children) == null ? void 0 : _a.length))]),
                                  onClick: ($event) => $setup.selectCommand(command),
                                  onMouseenter: ($event) => $setup.selectedCommandIndex = index
                                }, [
                                  _ctx.showCommandIcon ? (_openBlock3(), _createBlock3($setup["YhIcon"], {
                                    key: 0,
                                    name: $setup.getCommandIcon(command),
                                    class: _normalizeClass2($setup.ns.e("command-icon"))
                                  }, null, 8, ["name", "class"])) : _createCommentVNode3("v-if", true),
                                  _createElementVNode2(
                                    "div",
                                    {
                                      class: _normalizeClass2($setup.ns.e("command-content"))
                                    },
                                    [
                                      _createElementVNode2(
                                        "span",
                                        {
                                          class: _normalizeClass2($setup.ns.e("command-label"))
                                        },
                                        _toDisplayString(command.label),
                                        3
                                        /* TEXT, CLASS */
                                      ),
                                      _ctx.showCommandDescription && command.description ? (_openBlock3(), _createElementBlock3(
                                        "span",
                                        {
                                          key: 0,
                                          class: _normalizeClass2($setup.ns.e("command-desc"))
                                        },
                                  ...
                                  ((_b = command.children) == null ? void 0 : _b.length) ? (_openBlock3(), _createBlock3($setup["YhIcon"], {
                                    key: 1,
                                    name: "chevron-right",
                                    class: _normalizeClass2($setup.ns.e("command-arrow"))
                                  }, null, 8, ["class"])) : _createCommentVNode3("v-if", true)
                                ], 42, _hoisted_2),
                                _createCommentVNode3(" \u5D4C\u5957\u5B50\u547D\u4EE4 "),
                                $setup.showCascadePanel && ((_c = $setup.currentCascadeParent) == null ? void 0 : _c.id) === command.id ? (_openBlock3(true), _createElementBlock3(
                                  _Fragment2,
                                  { key: 0 },
                                  _renderList($setup.cascadeCommands, (child, childIndex) => {
                                    return _openBlock3(), _createElementBlock3("div", {
                                      key: `${command.id}-${child.id}`,
                                      class: _normalizeClass2([$setup.ns.e("command-item"), $setup.ns.e("command-cascade-item"), $setup.ns.is("selected", $setup.selectedCommandIndex === $setup.filteredCommands.length + childIndex), $setup.ns.is("disabled", child.disabled)]),
                                      onClick: ($event) => $setup.selectCommand(child),
                                      onMouseenter: ($event) => $setup.selectedCommandIndex = $setup.filteredCommands.length + childIndex
                                    }, [
                                      _ctx.showCommandIcon ? (_openBlock3(), _createBlock3($setup["YhIcon"], {
                                        key: 0,
                                        name: $setup.getCommandIcon(child),
                                        class: _normalizeClass2($setup.ns.e("command-icon"))
                                      }, null, 8, ["name", "class"])) : _createCommentVNode3("v-if", true),
                                      _createElementVNode2(
                                        "div",
                                        ...
                                        [
                                          ...
                                          _ctx.showCommandDescription && child.description ? (_openBlock3(), _createElementBlock3(
                                            "span",
                                            {
                                              key: 0,
                                              class: _normalizeClass2($setup.ns.e("command-desc"))
                                            },
                                            _toDisplayString(child.description),
                                            3
                                            /* TEXT, CLASS */
                                          )) : _createCommentVNode3("v-if", true)
                                        ],
                        ...
                        $setup.filteredCommands.length === 0 ? (_openBlock3(), _createElementBlock3(
                          "div",
                          {
                            key: 0,
                            class: _normalizeClass2($setup.ns.e("command-empty"))
                          },
                          [
                            _createVNode($setup["YhIcon"], { name: "search" }),
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const textareaRef = ref3();
    const localValue = ref3(props.modelValue);
    const isFocused = ref3(false);
    const showCommandPanel = ref3(false);
    const commandSearchText = ref3("");
    const filteredCommands = ref3([]);
    const selectedCommandIndex = ref3(0);
    const cascadeCommands = ref3([]);
    const currentCascadeParent = ref3(null);
    const showCascadePanel = ref3(false);
    const cascadePosition = ref3({ top: 0, left: 0 });
    watch(
      () => props.modelValue,
      (val) => {
    ...
    const filterCommands = (keyword) => {
      ...
      filteredCommands.value = props.commands.filter((cmd) => {
        ...
        if ((_a = cmd.keywords) == null ? void 0 : _a.some((k) => k.toLowerCase().includes(lowerKeyword))) return true;
        return false;
      });
    };
    const getAllVisibleCommands = () => {
      ...
      if ((_b = (_a = currentCascadeParent.value) == null ? void 0 : _a.children) == null ? void 0 : _b.length) {
    ...
    const navigateCommands = (direction) => {
      ...
      selectedCommandIndex.value = (selectedCommandIndex.value + direction + commands.length) % commands.length;
    };
    ...
    const insertCommandToText = (command) => {
      ...
      if (cursorPos !== -1) {
        ...
        const after = localValue.value.slice(cursorPos).replace(props.commandTrigger + commandSearchText.value, "");
    ...
    const commandPanelStyle = computed5(() => ({
      width: typeof props.commandPanelWidth === "number" ? props.commandPanelWidth + "px" : props.commandPanelWidth,
    ...
    const __returned__ = { props, emit, ns, themeStyle, textareaRef, localValue, isFocused, showCommandPanel, commandSearchText, filteredCommands, selectedCommandIndex, cascadeCommands, currentCascadeParent, showCascadePanel, cascadePosition, innerValue, autoResize, handleInput, handleKeyDown, checkCommandTrigger, filterCommands, getAllVisibleCommands, navigateCommands, selectCommand, openCascadePanel, insertCommandToText, hideCommandPanel, handleSend, handleRemoveAttachment, commandPanelStyle, getCommandIcon, get useNamespace() {
      return useNamespace;
    }, ref: ref3, computed: computed5, watch, nextTick, get aiEditorSenderProps() {
