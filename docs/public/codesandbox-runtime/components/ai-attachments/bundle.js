    ...
    _createElementBlock2(
      ...
      [
        $setup.visible && $setup.isGradient
          ? (_openBlock2(),
            _createElementBlock2('svg', _hoisted_12, [
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const gradientStops = computed12(() => {
        ...
        if (typeof color === 'string') {
          ...
          const matchedColors =
            (_a3 = color.match(colorRegex)) == null
              ? void 0
              : _a3.filter((c) => !/gradient|deg|to|top|bottom|left|right/i.test(c))
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const initViewerJS = () => {
        ...
        const nextViewer = new stdin_default4(
          list,
          __spreadProps(__spreadValues4({}, props.viewerOptions), {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      useEventListener(
        ...
        (e) => {
          ...
          if (
            !((_a3 = triggerRef.value) == null ? void 0 : _a3.contains(target)) &&
                      ...
                      [
                        ...
                        _createElementVNode5(
                          ...
                          [
                            ...
                            _ctx.loading
                              ? (_openBlock6(), _createBlock6($setup['YhSpin'], { key: 0 }))
                              : (_openBlock6(),
                                _createElementBlock6(
                                  _Fragment4,
                                  { key: 1 },
    ...
    _createElementBlock7(
      'div',
      {
        ...
        style: _normalizeStyle6([
          $setup.themeStyle,
          $setup.props.overflow === 'scrollY' && $setup.props.scrollMaxHeight
            ? {
      ...
      [
                      ...
                      _createElementBlock7(
                        'div',
                        {
                          ...
                          class: _normalizeClass6([
                            $setup.ns.e('item'),
                            $setup.ns.is('error', item.status === 'error')
                          ])
                        },
                        [
                          _renderSlot6(
                            ...
                            () => [
                              _createVNode4(
                                $setup['YhAiFileCard'],
                                {
                                  ...
                                  description:
                                    item.status === 'error' ? item.error : item.description,
                                          ...
                                          _createElementBlock7(
                                            ...
                                            [
                                              _createElementVNode6(
                                                ...
                                                {
                                                  class: _normalizeClass6(
                                                    $setup.ns.e('progress-text')
                                                  )
                                                },
                                                _toDisplayString5(
                                                  (_a3 = item.percent) != null ? _a3 : 0
                                                ) + '%',
                                                3
                                                /* TEXT, CLASS */
                                              ),
                                          ...
                                          _createElementBlock7(
                                            'button',
                                            {
                                              ...
                                              onClick: _withModifiers(
                                                ($event) => $setup.handleDelete(item, index),
                                                ['stop']
                                              )
                                            },
                                ...
                                1032,
                                ['name', 'byte', 'type', 'icon', 'src', 'description', 'loading']
                              )
                            ]
                          )
                        ],
        ...
        !_ctx.hideUpload && $setup.canUpload
          ? (_openBlock7(),
            _createElementBlock7(
              'div',
              {
                ...
                class: _normalizeClass6([
                  $setup.ns.e('upload'),
                  $setup.ns.is('dragging', $setup.isDragging)
                ]),
                      ...
                      _createElementVNode6(
                        ...
                        [
                          _createElementVNode6(
                            ...
                            _toDisplayString5(
                              $setup.isDragging
                                ? $setup.computedDropPlaceholder.title
                                : $setup.computedPlaceholder.title
                            ),
                            3
                            /* TEXT, CLASS */
                          ),
                          $setup.computedPlaceholder.description
                            ? (_openBlock7(),
                              _createElementBlock7(
                                'div',
                                {
                  ...
                  _createElementVNode6(
                    ...
                    [
                      ...
                      _createElementVNode6(
                        ...
                        _toDisplayString5(
                          $setup.computedDropPlaceholder.title || $setup.t('ai.attachments.dropTip')
                        ),
                        3
                        /* TEXT, CLASS */
                      )
        ...
        for (const file of validFiles) {
          ...
          if (props.httpRequest) {
            try {
              ...
              if (index !== -1) {
                internalItems.value[index] = __spreadProps3(
                  __spreadValues7({}, internalItems.value[index]),
                  {
                    status: 'done',
                    percent: 100
                  }
