...
// public/codesandbox-runtime/components/ai-attachments/src/ai-attachments.js
import { createCommentVNode as _createCommentVNode7, renderList as _renderList2, Fragment as _Fragment5, openBlock as _openBlock7, createElementBlock as _createElementBlock7, renderSlot as _renderSlot6, toDisplayString as _toDisplayString5, normalizeClass as _normalizeClass6, createElementVNode as _createElementVNode6, normalizeStyle as _normalizeStyle6, createVNode as _createVNode4, withModifiers as _withModifiers, withCtx as _withCtx4 } from "vue";
import { ref as ref17, computed as computed17, watch as watch9 } from "vue";
...
// public/codesandbox-runtime/components/ai-attachments/src/ai-attachments-meta.js
var aiAttachmentsProps = {
  /** 附件列表 */
  items: {
    type: Array,
    default: () => []
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, slots, ns, themeStyle, iconStyle, iconClass, svgContent, viewBox, hasSlot, useIconComponent, computed: computed11, useSlots, get iconProps() {
      return iconProps;
    }, get getIcon() {
      return getIcon;
    }, get useNamespace() {
...
// public/codesandbox-runtime/components/ai-file-card/index.js
var YhAiFileCard = withInstall(stdin_default9);
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock7(), _createElementBlock7(
    "div",
    {
      class: _normalizeClass6([$setup.ns.b(), $setup.overflowClass]),
      style: _normalizeStyle6([$setup.themeStyle, $setup.props.overflow === "scrollY" && $setup.props.scrollMaxHeight ? {
    ...
    [
      _createCommentVNode7(" \u6587\u4EF6\u5217\u8868 "),
      $setup.internalItems.length > 0 ? (_openBlock7(), _createElementBlock7(
        "div",
        {
          key: 0,
          ref: "listContainerRef",
          class: _normalizeClass6($setup.ns.e("list")),
          style: _normalizeStyle6(_ctx.listStyle)
        },
        [
          (_openBlock7(true), _createElementBlock7(
            _Fragment5,
            null,
            _renderList2($setup.internalItems, (item, index) => {
              return _openBlock7(), _createElementBlock7(
                "div",
                {
                  key: item.uid || index,
                  class: _normalizeClass6([$setup.ns.e("item"), $setup.ns.is("error", item.status === "error")])
                },
                [
                  _renderSlot6(_ctx.$slots, "file-item", {
                    item,
                    index
                  }, () => [
                    _createVNode4($setup["YhAiFileCard"], {
                      name: item.name,
                      byte: item.byte,
                      type: item.type,
                      ...
                      default: _withCtx4(() => {
                        var _a3;
                        return [
                          _createCommentVNode7(" \u4E0A\u4F20\u8FDB\u5EA6\uFF08\u8FDB\u5EA6\u6761 + \u767E\u5206\u6BD4\uFF09 "),
                          item.status === "uploading" ? (_openBlock7(), _createElementBlock7(
                            "div",
                            {
                              key: 0,
                              class: _normalizeClass6($setup.ns.e("progress-wrap"))
                            },
                            [
                              _createElementVNode6(
                                "span",
                                {
                                  class: _normalizeClass6($setup.ns.e("progress-text"))
                                },
                                _toDisplayString5((_a3 = item.percent) != null ? _a3 : 0) + "%",
                                3
                                /* TEXT, CLASS */
                              ),
                              _createElementVNode6(
                                "div",
                                {
                                  class: _normalizeClass6($setup.ns.e("progress"))
                                },
                                [
                                  _createElementVNode6(
                                    "div",
                          ...
                          _createCommentVNode7(" \u5220\u9664\u6309\u94AE "),
                          item.status !== "uploading" ? (_openBlock7(), _createElementBlock7("button", {
                            key: 1,
                            class: _normalizeClass6($setup.ns.e("delete-btn")),
                            onClick: _withModifiers(($event) => $setup.handleDelete(item, index), ["stop"])
                          }, [
                            _createVNode4($setup["YhIcon"], { name: "close" })
                          ], 10, _hoisted_17)) : _createCommentVNode7("v-if", true)
                        ];
                      }),
                      _: 2
                      /* DYNAMIC */
      ...
      _createCommentVNode7(" \u4E0A\u4F20\u6309\u94AE / \u5360\u4F4D\u7B26 "),
      !_ctx.hideUpload && $setup.canUpload ? (_openBlock7(), _createElementBlock7(
        "div",
        {
          key: 1,
          class: _normalizeClass6([$setup.ns.e("upload"), $setup.ns.is("dragging", $setup.isDragging)]),
          onClick: $setup.triggerUpload
        },
        [
          _renderSlot6(_ctx.$slots, "upload-button", { canUpload: $setup.canUpload }, () => [
            _createElementVNode6(
              "div",
              {
                class: _normalizeClass6($setup.ns.e("upload-content"))
              },
              [
                ...
                _createElementVNode6(
                  "div",
                  {
                    class: _normalizeClass6($setup.ns.e("upload-text"))
                  },
                  [
                    _createElementVNode6(
                      "div",
                      {
                        class: _normalizeClass6($setup.ns.e("upload-title"))
                      },
                      _toDisplayString5($setup.isDragging ? $setup.computedDropPlaceholder.title : $setup.computedPlaceholder.title),
                      3
                      /* TEXT, CLASS */
                    ),
                    $setup.computedPlaceholder.description ? (_openBlock7(), _createElementBlock7(
                      "div",
                      {
                        key: 0,
                        class: _normalizeClass6($setup.ns.e("upload-description"))
                      },
                      _toDisplayString5($setup.computedPlaceholder.description),
                      3
                      /* TEXT, CLASS */
                    )) : _createCommentVNode7("v-if", true)
                  ],
      ...
      _createCommentVNode7(" \u62D6\u62FD\u906E\u7F69 "),
      $setup.isDragging ? (_openBlock7(), _createElementBlock7(
        "div",
        {
          key: 2,
          class: _normalizeClass6($setup.ns.e("drop-mask"))
        },
        [
          _renderSlot6(_ctx.$slots, "drop-area", {}, () => [
            _createElementVNode6(
              "div",
              {
                class: _normalizeClass6($setup.ns.e("drop-content"))
              },
              [
                _createVNode4($setup["YhIcon"], {
                ...
                _createElementVNode6(
                  "div",
                  {
                    class: _normalizeClass6($setup.ns.e("drop-text"))
                  },
                  _toDisplayString5($setup.computedDropPlaceholder.title || $setup.t("ai.attachments.dropTip")),
                  3
                  /* TEXT, CLASS */
                )
              ],
      ...
      _createCommentVNode7(" \u6EDA\u52A8\u6309\u94AE "),
      $setup.showScrollButtons ? (_openBlock7(), _createElementBlock7(
        "button",
        {
          key: 3,
          class: _normalizeClass6([$setup.ns.e("scroll-btn"), $setup.ns.e("scroll-prev")]),
          onClick: $setup.scrollLeft
        },
        [
          _createVNode4($setup["YhIcon"], { name: "arrow-left" })
        ],
        2
        /* CLASS */
      )) : _createCommentVNode7("v-if", true),
      $setup.showScrollButtons ? (_openBlock7(), _createElementBlock7(
        ...
        {
          key: 4,
          class: _normalizeClass6([$setup.ns.e("scroll-btn"), $setup.ns.e("scroll-next")]),
          onClick: $setup.scrollRight
        },
        [
          _createVNode4($setup["YhIcon"], { name: "arrow-right" })
        ],
        2
        /* CLASS */
      )) : _createCommentVNode7("v-if", true),
      _createCommentVNode7(" \u9690\u85CF\u7684\u6587\u4EF6\u8F93\u5165 "),
      _createElementVNode6("input", {
        ref: "fileInputRef",
        type: "file",
        class: _normalizeClass6($setup.ns.e("file-input")),
        multiple: "",
...
var __sfc__7 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const internalItems = ref17([...props.items]);
    watch9(
      () => props.items,
      (newItems) => {
    ...
    const computedPlaceholder = computed17(() => {
      return normalizePlaceholder(props.placeholder);
    });
    const computedDropPlaceholder = computed17(() => {
    ...
    const overflowClass = computed17(() => {
    ...
    function getItemIcon(item) {
      ...
      const ext = (_a3 = (item.name || "").split(".").pop()) == null ? void 0 : _a3.toLowerCase();
      return ext ? extensionIconMap[ext] : void 0;
    }
    const fileInputRef = ref17(null);
    const isDragging = ref17(false);
    const dragCounter = ref17(0);
      ...
      for (const file of validFiles) {
        ...
        if (props.httpRequest) {
          try {
            ...
            if (index !== -1) {
              internalItems.value[index] = __spreadProps3(__spreadValues7({}, internalItems.value[index]), {
                status: "done",
                percent: 100
              });
            }
    ...
    const listContainerRef = ref17(null);
    const scrollLeft = () => {
