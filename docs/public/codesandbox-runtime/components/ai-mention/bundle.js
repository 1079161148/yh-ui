...
import { createVNode as _createVNode2, normalizeClass as _normalizeClass2, createElementVNode as _createElementVNode2, toDisplayString as _toDisplayString2, openBlock as _openBlock3, createElementBlock as _createElementBlock3, createCommentVNode as _createCommentVNode3, normalizeProps as _normalizeProps, guardReactiveProps as _guardReactiveProps, renderSlot as _renderSlot3, mergeProps as _mergeProps2, withCtx as _withCtx2, renderList as _renderList2, createSlots as _createSlots, Fragment as _Fragment3, withModifiers as _withModifiers2, createBlock as _createBlock3, normalizeStyle as _normalizeStyle2, Transition as _Transition2, Teleport as _Teleport2 } from "vue";
...
var YhMention = withInstall(stdin_default2);

// public/codesandbox-runtime/components/icon/src/icon.js
import { createCommentVNode as _createCommentVNode2, resolveDynamicComponent as _resolveDynamicComponent2, openBlock as _openBlock2, createBlock as _createBlock2, createElementBlock as _createElementBlock2, Fragment as _Fragment2, renderSlot as _renderSlot2, mergeProps as _mergeProps } from "vue";
  ...
  return _openBlock3(), _createElementBlock3(
    ...
    [
      _createVNode2($setup["YhMention"], _mergeProps2({ ref: "mentionRef" }, _ctx.$attrs, {
        ...
        option: _withCtx2(({ option }) => [
          _createElementVNode2(
            "div",
            {
              class: _normalizeClass2($setup.ns.e("option-item"))
            },
            [
              _createElementVNode2(
                "div",
                {
                  class: _normalizeClass2([$setup.ns.e("option-icon"), $setup.asAiMentionOption(option).type ? $setup.ns.em("option-icon", $setup.asAiMentionOption(option).type) : ""])
                },
                [
              ...
              _createElementVNode2(
                "div",
                {
                  class: _normalizeClass2($setup.ns.e("option-info"))
                },
                [
                  _createElementVNode2(
                    "div",
                    {
                      class: _normalizeClass2($setup.ns.e("option-label"))
                    },
                    _toDisplayString2($setup.asAiMentionOption(option).label || $setup.asAiMentionOption(option).value),
                    3
                    /* TEXT, CLASS */
                  ),
                  $setup.asAiMentionOption(option).description ? (_openBlock3(), _createElementBlock3(
                    "div",
                    {
                      key: 0,
                      class: _normalizeClass2($setup.ns.e("option-desc"))
                    },
                    _toDisplayString2($setup.asAiMentionOption(option).description),
                    3
                    /* TEXT, CLASS */
              ...
              $setup.asAiMentionOption(option).type ? (_openBlock3(), _createElementBlock3(
                "div",
                {
                  key: 0,
                  class: _normalizeClass2([$setup.ns.e("option-tag"), $setup.ns.em("option-tag", $setup.asAiMentionOption(option).type)])
                },
                _toDisplayString2($setup.t(`ai.mention.${$setup.asAiMentionOption(option).type}`) || $setup.asAiMentionOption(option).type),
                3
                /* TEXT, CLASS */
              )) : _createCommentVNode3("v-if", true)
            ],
        ...
        _renderList2($setup.forwardedSlotNames, (name) => {
          return {
            name,
            fn: _withCtx2((slotProps) => [
              _renderSlot3(_ctx.$slots, name, _normalizeProps(_guardReactiveProps(slotProps)))
            ])
          };
        })
      ]), 1040, ["model-value", "options", "triggers", "type", "placeholder", "disabled", "size", "loading", "filter-option", "maxlength", "rows"]),
      _createCommentVNode3(" \u6587\u4EF6\u6811\u9762\u677F "),
      (_openBlock3(), _createBlock3(_Teleport2, { to: "body" }, [
        _createVNode2(_Transition2, { name: "yh-fade-in-scale-up" }, {
          default: _withCtx2(() => [
            $setup.showFileTree ? (_openBlock3(), _createElementBlock3(
              "div",
              {
                key: 0,
                class: _normalizeClass2($setup.ns.e("file-tree-panel")),
                style: _normalizeStyle2($setup.fileTreePanelStyle)
              },
              [
                _createElementVNode2(
                  "div",
                  {
                    class: _normalizeClass2($setup.ns.e("file-tree-header"))
                  },
                  [
                    _createVNode2($setup["YhIcon"], {
                    ...
                    _createElementVNode2(
                      "span",
                      null,
                      _toDisplayString2($setup.getTypeLabel($setup.currentFileType)),
                      1
                      /* TEXT */
                    ),
                    _createElementVNode2(
                      "span",
                      {
                        class: _normalizeClass2($setup.ns.e("file-tree-count"))
                      },
                      _toDisplayString2($setup.fileTreeData.length),
                      3
                      /* TEXT, CLASS */
                    )
                  ],
                ...
                _createElementVNode2(
                  "div",
                  {
                    class: _normalizeClass2($setup.ns.e("file-tree-content"))
                  },
                  [
                    _createElementVNode2(
                      "div",
                      {
                        class: _normalizeClass2($setup.ns.e("file-tree-list"))
                      },
                      [
                            ...
                            return _openBlock3(), _createElementBlock3(
                              ...
                              [
                                _createElementVNode2("div", {
                                  class: _normalizeClass2([$setup.ns.e("file-tree-node"), $setup.ns.is("folder", node.isFolder), $setup.ns.is("expanded", $setup.isFolderExpanded(node.key))]),
                                  onClick: ($event) => $setup.handleFileSelect(node)
                                }, [
                                  node.isFolder ? (_openBlock3(), _createElementBlock3("span", {
                                    key: 0,
                                    class: _normalizeClass2($setup.ns.e("folder-toggle")),
                                  ...
                                  ], 10, _hoisted_22)) : (_openBlock3(), _createElementBlock3(
                                    "span",
                                    {
                                      key: 1,
                                      class: _normalizeClass2($setup.ns.e("file-tree-indent"))
                                    },
                                    null,
                                    2
                                    /* CLASS */
                                  )),
                                  _ctx.showFileIcon ? (_openBlock3(), _createBlock3($setup["YhIcon"], {
                                    key: 2,
                                    name: $setup.getFileIcon(node),
                                    class: _normalizeClass2($setup.ns.e("file-tree-icon"))
                                  }, null, 8, ["name", "class"])) : _createCommentVNode3("v-if", true),
                                  _createElementVNode2(
                                    "span",
                                    {
                                      class: _normalizeClass2($setup.ns.e("file-tree-label"))
                                    },
                                    _toDisplayString2(node.label),
                                    3
                                    /* TEXT, CLASS */
                                  ),
                                  _ctx.showFileSize && !node.isFolder ? (_openBlock3(), _createElementBlock3(
                                    "span",
                                    {
                                      key: 3,
                                      class: _normalizeClass2($setup.ns.e("file-tree-size"))
                                    },
                                    _toDisplayString2($setup.formatFileSizeFn(node.size)),
                                    3
                                    /* TEXT, CLASS */
                                  )) : _createCommentVNode3("v-if", true),
                                  _ctx.showModifiedTime && !node.isFolder ? (_openBlock3(), _createElementBlock3(
                                    "span",
                                    {
                                      key: 4,
                                      class: _normalizeClass2($setup.ns.e("file-tree-time"))
                                    },
                                    _toDisplayString2($setup.formatTimeFn(node.modifiedAt)),
                                    3
                                    /* TEXT, CLASS */
                                  )) : _createCommentVNode3("v-if", true)
                                ], 10, _hoisted_13),
                                node.isFolder && node.children && $setup.isFolderExpanded(node.key) ? (_openBlock3(true), _createElementBlock3(
                                  _Fragment3,
                                  { key: 0 },
                                  _renderList2(node.children, (child) => {
                                    return _openBlock3(), _createElementBlock3("div", {
                                      key: child.key,
                                      class: _normalizeClass2([$setup.ns.e("file-tree-node"), $setup.ns.e("file-tree-child"), $setup.ns.is("folder", child.isFolder)]),
                                      ...
                                      _createElementVNode2(
                                        ...
                                        _toDisplayString2(child.label),
                                        3
                                        /* TEXT, CLASS */
                                      ),
                                      _ctx.showFileSize && !child.isFolder ? (_openBlock3(), _createElementBlock3(
                                        "span",
                                        {
                                          key: 1,
                                          class: _normalizeClass2($setup.ns.e("file-tree-size"))
                                        },
                                        _toDisplayString2($setup.formatFileSizeFn(child.size)),
                                        3
                                        /* TEXT, CLASS */
                                      )) : _createCommentVNode3("v-if", true),
                                      _ctx.showModifiedTime && !child.isFolder ? (_openBlock3(), _createElementBlock3(
                                        "span",
                                        {
                                          key: 2,
                                          class: _normalizeClass2($setup.ns.e("file-tree-time"))
                                        },
                                        _toDisplayString2($setup.formatTimeFn(child.modifiedAt)),
                                        3
                                        /* TEXT, CLASS */
                                      )) : _createCommentVNode3("v-if", true)
                                    ], 10, _hoisted_32);
                        ...
                        $setup.fileTreeData.length === 0 && !$setup.fileTreeLoading ? (_openBlock3(), _createElementBlock3(
                          "div",
                          {
                            key: 0,
                            class: _normalizeClass2($setup.ns.e("file-tree-empty"))
                          },
                          [
                            ...
                            _createElementVNode2(
                              "span",
                              null,
                              _toDisplayString2($setup.t("ai.mention.noFiles")),
                              1
                              /* TEXT */
                            )
                          ],
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const forwardedSlotNames = computed13(() => Object.keys(slots));
    const ns = useNamespace("ai-mention");
    const { t } = useLocale();
    const { themeStyle } = useComponentTheme("ai-mention", props.themeOverrides);
    const mentionRef = ref13(null);
    const fileTreeData = ref13([]);
    const fileTreeLoading = ref13(false);
    const expandedFolders = ref13(/* @__PURE__ */ new Set());
    const currentFileType = ref13(null);
    let searchDebounceTimer = null;
    const filteredOptions = computed13(() => {
    ...
    const fileTreePanelStyle = computed13(() => ({
      position: "fixed",
      top: "200px",
      left: "100px",
      width: "320px",
    ...
    const loadFileTree = async (type, keyword = "") => {
      ...
      try {
        ...
        if (props.fileTreeExpandedLevel > 0) {
          nodes.forEach((node) => {
            var _a2;
            if (node.isFolder && ((_a2 = node.children) == null ? void 0 : _a2.length)) {
          ...
          for (const node of nodes) {
            if (node.label.toLowerCase().includes(keyword.toLowerCase())) {
              ...
              if (filteredChildren.length > 0) {
                result.push(__spreadProps(__spreadValues4({}, node), { children: filteredChildren }));
              }
            }
          }
          return result;
    ...
    const getFileIcon = (node) => {
      ...
      const ext = ((_a2 = node.path.split(".").pop()) == null ? void 0 : _a2.toLowerCase()) || "";
      const iconMap = {
        pdf: "file-pdf",
        doc: "file-word",
        docx: "file-word",
    ...
    __expose({
      focus: () => {
        var _a2;
        return (_a2 = mentionRef.value) == null ? void 0 : _a2.focus();
      },
      blur: () => {
        var _a2;
        return (_a2 = mentionRef.value) == null ? void 0 : _a2.blur();
      },
      clear: () => {
        var _a2;
        return (_a2 = mentionRef.value) == null ? void 0 : _a2.clear();
      },
      getRef: () => {
        var _a2;
        return (_a2 = mentionRef.value) == null ? void 0 : _a2.ref;
      },
      insertMention: (option, trigger) => {
        var _a2;
        return (_a2 = mentionRef.value) == null ? void 0 : _a2.insertMention(option, trigger);
      },
      refreshFileTree,
    ...
    const __returned__ = { props, emit, slots, forwardedSlotNames, ns, t, themeStyle, mentionRef, fileTreeData, fileTreeLoading, expandedFolders, currentFileType, get searchDebounceTimer() {
      ...
      return useLocale;
    }, computed: computed13, ref: ref13, useSlots: useSlots3, get aiMentionProps() {
