...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      _createVNode($setup["YhMention"], _mergeProps({ ref: "mentionRef" }, _ctx.$attrs, {
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode(
                "div",
                {
                  class: _normalizeClass([$setup.ns.e("option-icon"), $setup.asAiMentionOption(option).type ? $setup.ns.em("option-icon", $setup.asAiMentionOption(option).type) : ""])
                },
                [
              ...
              _createElementVNode(
                ...
                [
                  _createElementVNode(
                    ...
                    _toDisplayString($setup.asAiMentionOption(option).label || $setup.asAiMentionOption(option).value),
                    3
                    /* TEXT, CLASS */
                  ),
                  $setup.asAiMentionOption(option).description ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
              ...
              $setup.asAiMentionOption(option).type ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  class: _normalizeClass([$setup.ns.e("option-tag"), $setup.ns.em("option-tag", $setup.asAiMentionOption(option).type)])
                },
                _toDisplayString($setup.t(`ai.mention.${$setup.asAiMentionOption(option).type}`) || $setup.asAiMentionOption(option).type),
                3
                /* TEXT, CLASS */
              )) : _createCommentVNode("v-if", true)
            ],
      ...
      (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
        _createVNode(_Transition, { name: "yh-fade-in-scale-up" }, {
          default: _withCtx(() => [
            $setup.showFileTree ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
                  ...
                  [
                    _createElementVNode(
                      ...
                      [
                            ...
                            return _openBlock(), _createElementBlock(
                              ...
                              [
                                _createElementVNode("div", {
                                  class: _normalizeClass([$setup.ns.e("file-tree-node"), $setup.ns.is("folder", node.isFolder), $setup.ns.is("expanded", $setup.isFolderExpanded(node.key))]),
                                  onClick: ($event) => $setup.handleFileSelect(node)
                                }, [
                                  node.isFolder ? (_openBlock(), _createElementBlock("span", {
                                    key: 0,
                                    class: _normalizeClass($setup.ns.e("folder-toggle")),
                                    onClick: _withModifiers(($event) => $setup.toggleFolder(node.key), ["stop"])
                                  }, [
                                    _createVNode($setup["YhIcon"], {
                                      name: $setup.isFolderExpanded(node.key) ? "chevron-down" : "chevron-right"
                                    }, null, 8, ["name"])
                                  ], 10, _hoisted_2)) : (_openBlock(), _createElementBlock(
                                    "span",
                                    {
                                      key: 1,
                                      class: _normalizeClass($setup.ns.e("file-tree-indent"))
                                    },
                                    null,
                                    2
                                    /* CLASS */
                                  )),
                                  _ctx.showFileIcon ? (_openBlock(), _createBlock($setup["YhIcon"], {
                                    key: 2,
                                    name: $setup.getFileIcon(node),
                                    class: _normalizeClass($setup.ns.e("file-tree-icon"))
                                  }, null, 8, ["name", "class"])) : _createCommentVNode("v-if", true),
                                  _createElementVNode(
                                    "span",
                                    {
                                      class: _normalizeClass($setup.ns.e("file-tree-label"))
                                    },
                                    _toDisplayString(node.label),
                                    3
                                    /* TEXT, CLASS */
                                  ),
                                  _ctx.showFileSize && !node.isFolder ? (_openBlock(), _createElementBlock(
                                    "span",
                                    {
                                      key: 3,
                                      class: _normalizeClass($setup.ns.e("file-tree-size"))
                                    },
                                    _toDisplayString($setup.formatFileSizeFn(node.size)),
                                    3
                                    /* TEXT, CLASS */
                                  )) : _createCommentVNode("v-if", true),
                                  _ctx.showModifiedTime && !node.isFolder ? (_openBlock(), _createElementBlock(
                                    "span",
                                    {
                                      key: 4,
                                      class: _normalizeClass($setup.ns.e("file-tree-time"))
                                    },
                                    _toDisplayString($setup.formatTimeFn(node.modifiedAt)),
                                    3
                                    /* TEXT, CLASS */
                                  )) : _createCommentVNode("v-if", true)
                                ], 10, _hoisted_1),
                                node.isFolder && node.children && $setup.isFolderExpanded(node.key) ? (_openBlock(true), _createElementBlock(
                                  _Fragment,
                                  { key: 0 },
                                  _renderList(node.children, (child) => {
                                    return _openBlock(), _createElementBlock("div", {
                                      key: child.key,
                                      class: _normalizeClass([$setup.ns.e("file-tree-node"), $setup.ns.e("file-tree-child"), $setup.ns.is("folder", child.isFolder)]),
                                      ...
                                      _ctx.showFileSize && !child.isFolder ? (_openBlock(), _createElementBlock(
                                        "span",
                                        {
                                          key: 1,
                                          class: _normalizeClass($setup.ns.e("file-tree-size"))
                                        },
                                        _toDisplayString($setup.formatFileSizeFn(child.size)),
                                        3
                                        /* TEXT, CLASS */
                                      )) : _createCommentVNode("v-if", true),
                                      _ctx.showModifiedTime && !child.isFolder ? (_openBlock(), _createElementBlock(
                                        "span",
                                        {
                                          key: 2,
                                          class: _normalizeClass($setup.ns.e("file-tree-time"))
                                        },
                                        _toDisplayString($setup.formatTimeFn(child.modifiedAt)),
                                        3
                                        /* TEXT, CLASS */
                                      )) : _createCommentVNode("v-if", true)
                                    ], 10, _hoisted_3);
                        ...
                        $setup.fileTreeData.length === 0 && !$setup.fileTreeLoading ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
...
import {
  aiMentionProps,
  aiMentionEmits
} from "./ai-mention-meta.js";
import { YhMention } from "../../mention/index.js";
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
          ...
          for (const node of nodes) {
            if (node.label.toLowerCase().includes(keyword.toLowerCase())) {
              ...
              if (filteredChildren.length > 0) {
                result.push(__spreadProps(__spreadValues({}, node), { children: filteredChildren }));
              }
            }
          }
          return result;
    ...
    const __returned__ = { props, emit, slots, forwardedSlotNames, ns, t, themeStyle, mentionRef, fileTreeData, fileTreeLoading, expandedFolders, currentFileType, get searchDebounceTimer() {
      ...
      return useLocale;
    }, computed, ref, useSlots, get aiMentionProps() {
