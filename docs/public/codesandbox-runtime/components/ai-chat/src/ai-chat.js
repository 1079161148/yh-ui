...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _ctx.$slots.header || $setup.props.messages.length > 0 ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          _renderSlot(_ctx.$slots, "header", {}, () => [
            _createElementVNode(
              ...
              [
                $setup.props.messages.length > 0 ? (_openBlock(), _createBlock($setup["YhButton"], {
                  key: 0,
                  size: "small",
                  text: "",
      ...
      _createElementVNode(
        "div",
        {
          ...
          ref: "contentRef",
          style: _normalizeStyle($setup.virtualScrollEnabled ? {
        ...
        [
          $setup.props.messages.length === 0 && $setup.props.suggestions.length > 0 ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
            ...
            [
              (_openBlock(true), _createElementBlock(
                ...
                _renderList($setup.props.suggestions, (suggestion, idx) => {
                  return _openBlock(), _createBlock($setup["YhButton"], {
                    key: idx,
                    plain: "",
                    round: "",
          ...
          $setup.virtualScrollEnabled ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 1,
                ...
                [
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList($setup.visibleItems, (msg, index) => {
                      return _renderSlot(_ctx.$slots, "message", {
              ...
              (_openBlock(true), _createElementBlock(
                ...
                _renderList($setup.props.messages, (msg, index) => {
                  return _renderSlot(_ctx.$slots, "message", {
                    ...
                    _createCommentVNode(" We use the powerful markdown rendering by default on the bubbles inside AiChat "),
                    _createVNode($setup["YhAiBubble"], {
                      content: msg.content,
                      role: msg.role,
                      loading: msg.status === "generating" || msg.status === "loading",
          ...
          $setup.props.loading && (!$setup.props.messages.length || $setup.props.messages[$setup.props.messages.length - 1].role !== "assistant" || $setup.props.messages[$setup.props.messages.length - 1].status !== "generating" && $setup.props.messages[$setup.props.messages.length - 1].status !== "loading") ? _renderSlot(_ctx.$slots, "loading", { key: 3 }, () => [
            _createVNode($setup["YhAiBubble"], {
              role: "assistant",
              loading: "",
              typing: "",
...
import { aiChatProps, aiChatEmits } from "./ai-chat-meta.js";
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, contentRef, virtualScrollEnabled, visibleItems, totalHeight, offsetY, startIndex, onScroll, scrollToIndex, scrollToBottom, handleSend, handleClear, get useNamespace() {
      ...
      return useLocale;
    }, ref, watch, nextTick, computed, YhAiSender, YhAiBubble, get YhButton() {
      return YhButton;
    }, get YhIcon() {
      return YhIcon;
    }, get aiChatProps() {
