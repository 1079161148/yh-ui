...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      viewerList = list2;
      const nextViewer = new stdin_default4(list2, __spreadProps2(__spreadValues5({}, props.viewerOptions), {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      if (props.previewSrcList && props.previewSrcList.length > 0) {
        ...
        document.body.appendChild(list2);
        viewerList = list2;
        const nextViewer = new stdin_default4(list2, __spreadProps3(__spreadValues6({}, props.viewerOptions), {
          hidden: () => {
            if (viewerList) {
              document.body.removeChild(viewerList);
              viewerList = null;
...
var stdin_default10 = __sfc__8;

// public/codesandbox-runtime/components/avatar/index.js
var YhAvatar = withInstall(stdin_default10);
...
var stdin_default11 = MarkdownIt2;
...
var stdin_default12 = __sfc__9;

// public/codesandbox-runtime/components/ai-thought-chain/index.js
var YhAiThoughtChain = withInstall(stdin_default12);
            ...
            [
              _ctx.loading && !_ctx.content ? (_openBlock10(), _createElementBlock10(
                ...
                [
                  ...
                  _ctx.multimodal && _ctx.multimodal.some((m) => m.type === "image") ? (_openBlock10(), _createElementBlock10(
                    "div",
                    {
                      key: 0,
                    ...
                    [
                      (_openBlock10(true), _createElementBlock10(
                        _Fragment8,
                        null,
                        _renderList5(_ctx.multimodal.filter((m) => m.type === "image"), (img, idx) => {
                          return _openBlock10(), _createElementBlock10(
                            "div",
                            {
                              key: idx,
                                ...
                                _createElementVNode9("thead", null, [
                                  _ctx.structuredData.data && _ctx.structuredData.data.headers ? (_openBlock10(), _createElementBlock10("tr", _hoisted_53, [
                                    (_openBlock10(true), _createElementBlock10(
                                      _Fragment8,
                                      null,
                                      _renderList5(_ctx.structuredData.data.headers, (h) => {
                                        return _openBlock10(), _createElementBlock10(
                                          "th",
                                          { key: h },
                                          _toDisplayString6(h),
  ...
  `;
    ...
    const jsonHtml = computed20(() => {
      ...
      try {
        ...
        if (stdin_default13.getLanguage("json")) {
          return stdin_default13.highlight(jsonString, {
            language: "json",
            ignoreIllegals: true
          }).value;
        }
    ...
    const getMarkdownInstance = () => {
      ...
      const md = new stdin_default11({
        ...
        highlight: function(str, lang) {
          ...
          if (hlLang && stdin_default13.getLanguage(hlLang)) {
            try {
              result = stdin_default13.highlight(str, { language: hlLang, ignoreIllegals: true }).value;
            } catch (e) {
            }
          } else {
...
var __sfc__11 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, contentRef, virtualScrollEnabled, visibleItems, totalHeight, offsetY, startIndex, onScroll, scrollToIndex, scrollToBottom, handleSend, handleClear, get useNamespace() {
      ...
      return useLocale;
    }, ref: ref21, watch: watch10, nextTick: nextTick4, computed: computed21, YhAiSender: stdin_default9, YhAiBubble: stdin_default14, get YhButton() {
      return YhButton;
    }, get YhIcon() {
      return YhIcon;
    }, get aiChatProps() {
...
var stdin_default15 = __sfc__11;
export {
  stdin_default15 as default
};
