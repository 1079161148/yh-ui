  ...
  "public/codesandbox-runtime/dayjs-locale/ar.js"() {
    ...
    locale10 = {
      ...
      preparse: function preparse(string) {
        return string.replace(fromArabNumeralsRegex, function(match2) {
          return numberMap[match2];
        }).replace(fromArabComaRegex, ",");
      },
      postformat: function postformat(string) {
        return string.replace(toArabNumeralsRegex, function(match2) {
...
var init_be = __esm({
  "public/codesandbox-runtime/dayjs-locale/be.js"() {
    ...
    months2 = function months3(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT.test(format2)) {
    ...
    monthsShort = function monthsShort2(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT.test(format2)) {
  ...
  "public/codesandbox-runtime/dayjs-locale/bn-bd.js"() {
    ...
    locale16 = {
      ...
      preparse: function preparse2(string) {
        return string.replace(/[১২৩৪৫৬৭৮৯০]/g, function(match2) {
          return numberMap2[match2];
        });
      },
      postformat: function postformat2(string) {
        return string.replace(/\d/g, function(match2) {
          return symbolMap2[match2];
        });
      },
  ...
  "public/codesandbox-runtime/dayjs-locale/bn.js"() {
    ...
    locale17 = {
      ...
      preparse: function preparse3(string) {
        return string.replace(/[১২৩৪৫৬৭৮৯০]/g, function(match2) {
          return numberMap3[match2];
        });
      },
      postformat: function postformat3(string) {
        return string.replace(/\d/g, function(match2) {
          return symbolMap3[match2];
        });
      },
...
function mutation(text2, number) {
  if (number === 2) {
...
function relativeTimeWithTense(number, withoutSuffix, key, isFuture) {
  ...
  if (withoutSuffix) {
    return (format2[key][2] ? format2[key][2] : format2[key][1]).replace("%d", number);
  }
  return (isFuture ? format2[key][0] : format2[key][1]).replace("%d", number);
}
...
function relativeTimeFormatter5(number, withoutSuffix, key) {
  var text2 = texts4[key + (number === 2 ? "2" : "")] || texts4[key];
  return text2.replace("%d", number);
}
...
var init_hr = __esm({
  "public/codesandbox-runtime/dayjs-locale/hr.js"() {
    ...
    months4 = function months5(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT2.test(format2)) {
...
function resolveTemplate(key, number, isFuture, withoutSuffix) {
  ...
  var text2 = unitText[index];
  return key.length === 1 ? text2 : "%d " + text2;
}
  ...
  "public/codesandbox-runtime/dayjs-locale/ku.js"() {
    ...
    locale77 = {
      ...
      preparse: function preparse4(string) {
        return string.replace(/[١٢٣٤٥٦٧٨٩٠]/g, function(match2) {
          return arabicToEnglishNumbersMap[match2];
        }).replace(/،/g, ",");
      },
      postformat: function postformat4(string) {
        return string.replace(/\d/g, function(match2) {
          return englishToArabicNumbersMap[match2];
        }).replace(/,/g, "\u060C");
      },
...
var init_lt = __esm({
  "public/codesandbox-runtime/dayjs-locale/lt.js"() {
    ...
    months7 = function months8(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT3.test(format2)) {
...
var init_pl = __esm({
  "public/codesandbox-runtime/dayjs-locale/pl.js"() {
    ...
    months9 = function months10(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT4.test(format2)) {
...
function relativeTimeWithPlural2(number, withoutSuffix, key) {
  ...
  return number + " " + plural4(format2[key], +number);
}
...
var init_ru = __esm({
  "public/codesandbox-runtime/dayjs-locale/ru.js"() {
    ...
    months11 = function months12(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT5.test(format2)) {
    ...
    monthsShort3 = function monthsShort4(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT5.test(format2)) {
...
function relativeTimeWithPlural3(number, withoutSuffix, key) {
  ...
  return number + " " + plural6(format2[key], +number);
}
...
var init_uk = __esm({
  "public/codesandbox-runtime/dayjs-locale/uk.js"() {
    ...
    months13 = function months14(dayjsInstance, format2) {
      if (MONTHS_IN_FORMAT6.test(format2)) {
    ...
    iframeSettings = {
      get editorOrigin() {
        ...
        if (editorOrigin == null) {
          editorOrigin = new URL((_a5 = globalThis.WEBCONTAINER_API_IFRAME_URL) != null ? _a5 : DEFAULT_EDITOR_ORIGIN).origin;
        }
        return editorOrigin;
      },
  ...
  "../node_modules/@webcontainer/api/dist/internal/auth-state.js"() {
    ...
    auth = {
      ...
      async logout({ ignoreRevokeError } = {}) {
        var _a5;
        await ((_a5 = authState.tokens) == null ? void 0 : _a5.revoke(authState.clientId, ignoreRevokeError != null ? ignoreRevokeError : false));
        loggedOutListeners.fireEvent();
        broadcastMessage({ type: "auth-logout" });
      },
      loggedIn() {
...
var __defProp10, __export2, comlink_exports, proxyMarker, createEndpoint, releaseProxy, throwMarker, isObject2, proxyTransferHandler, throwTransferHandler, transferHandlers, transferCache;
...
function reloadPreview(preview, hardRefreshTimeout = 200) {
  ...
  (_a5 = preview.contentWindow) == null ? void 0 : _a5.postMessage({
...
function fromBinaryString(s2) {
  const encoded = new Uint8Array(s2.length);
  for (let i = 0; i < s2.length; i++) {
    encoded[i] = s2[i].charCodeAt(0);
  }
  return encoded;
}
var binaryDecoder;
    ...
    _WebContainer = class _WebContainer {
      ...
      async export(path, options) {
        ...
        const serializeOptions = {
          format: (_a5 = options == null ? void 0 : options.format) != null ? _a5 : "json",
...
Set the 'coep' option to 'require-corp'.`);
    ...
    FSWatcher = class {
      ...
      async _teardown() {
        var _a5;
        await ((_a5 = this._watcher) == null ? void 0 : _a5.close().finally(() => {
          var _a6;
          (_a6 = this._watcher) == null ? void 0 : _a6[comlink_exports.releaseProxy]();
        }));
      }
    };
    WebContainerProcessImpl = class {
      constructor(process, output, stdout, stderr) {
        ...
        this.input = new WritableStream({
          write: (data) => {
            var _a5;
            (_a5 = this._getProcess()) == null ? void 0 : _a5.write(data).catch(() => {
            });
          }
        });
      ...
      kill() {
        var _a5;
        (_a5 = this._process) == null ? void 0 : _a5.kill();
      }
      resize(dimensions) {
        var _a5;
        (_a5 = this._getProcess()) == null ? void 0 : _a5.resize(dimensions);
      }
      async _onExit() {
        var _a5;
        try {
          ...
          (_a5 = this._process) == null ? void 0 : _a5[comlink_exports.releaseProxy]();
          this._process = null;
        }
      }
      _getProcess() {
...
// public/codesandbox-runtime/components/ai-chat/src/ai-chat.js
import { createCommentVNode as _createCommentVNode11, renderSlot as _renderSlot10, createVNode as _createVNode6, toDisplayString as _toDisplayString7, createTextVNode as _createTextVNode2, normalizeClass as _normalizeClass10, withCtx as _withCtx7, openBlock as _openBlock11, createBlock as _createBlock11, createElementVNode as _createElementVNode10, createElementBlock as _createElementBlock11, renderList as _renderList6, Fragment as _Fragment9, normalizeStyle as _normalizeStyle10 } from "vue";
...
var useZIndex = (zIndexOverrides) => {
  ...
  const initialZIndex = computed(() => {
    ...
    return (_a5 = override != null ? override : unref2(injectedZIndex)) != null ? _a5 : defaultInitialZIndex;
  });
...
var useLocale = (localeOverrides) => {
  ...
  const locale143 = computed5(() => {
    var _a5, _b;
    return (_b = (_a5 = unref4(localeOverrides)) != null ? _a5 : unref4(globalLocale)) != null ? _b : zhCn;
  });
...
function useVirtualScroll(options) {
  ...
  const scrollTop = ref4(0);
  const itemsRef = computed7(() => {
    return Array.isArray(options.items) ? options.items : options.items.value;
  });
  const itemHeightRef = computed7(() => unref6(options.itemHeight));
  const containerHeightRef = computed7(() => unref6(options.containerHeight));
  const overscanRef = computed7(() => {
    var _a5;
    return (_a5 = unref6(options.overscan)) != null ? _a5 : 3;
  });
  const totalHeight = computed7(() => itemsRef.value.length * itemHeightRef.value);
  const startIndex = computed7(() => {
  ...
  const visibleItems = computed7(() => {
    return itemsRef.value.slice(startIndex.value, endIndex.value);
  });
  const offsetY = computed7(() => startIndex.value * itemHeightRef.value);
...
// public/codesandbox-runtime/components/ai-chat/src/ai-chat.js
import { ref as ref21, watch as watch10, nextTick as nextTick4, computed as computed21 } from "vue";
...
var getStyle = (element, styleName) => {
  ...
  try {
    ...
    const computed22 = (_a5 = document.defaultView) == null ? void 0 : _a5.getComputedStyle(element, "");
    return computed22 ? computed22[styleName] : "";
  } catch (e) {
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const buttonStyles = computed11(() => {
      ...
      return __spreadProps(__spreadValues3({}, base2), {
...
var _hoisted_7 = ["title", "aria-label"];
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initViewerJS = () => {
      ...
      viewerList = list2;
      const nextViewer = new stdin_default5(list2, __spreadProps2(__spreadValues5({}, props.viewerOptions), {
    ...
    [
      $setup.isLoading ? _renderSlot3(_ctx.$slots, "placeholder", { key: 0 }, () => [
        _createElementVNode3(
          ...
          _toDisplayString($setup.t("image.loading")),
          3
          /* TEXT, CLASS */
        )
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const initLazyLoad = () => {
      ...
      if (!isLoading.value && !error2.value) return;
    ...
    const initViewerJS = () => {
      ...
      if (props.previewSrcList && props.previewSrcList.length > 0) {
        ...
        document.body.appendChild(list2);
        viewerList = list2;
        const nextViewer = new stdin_default5(list2, __spreadProps3(__spreadValues6({}, props.viewerOptions), {
          hidden: () => {
            if (viewerList) {
              document.body.removeChild(viewerList);
              viewerList = null;
        ...
        const nextViewer = new stdin_default5(imgElement, props.viewerOptions);
        viewer = nextViewer;
        nextViewer.show();
      }
    };
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isLoading, error: error2, showViewer, container, isLazy, get viewer() {
      return viewer;
    }, set viewer(v) {
      viewer = v;
    }, get viewerList() {
      ...
      return imageProps;
    }, YhImageViewer: stdin_default6, get Viewer() {
      return stdin_default5;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
var YhImage = withInstall(stdin_default7);
var YhImageViewer = withInstall(stdin_default6);
...
var _hoisted_22 = ["id", "value", "placeholder", "disabled", "readonly", "maxlength", "autofocus", "aria-expanded", "aria-controls", "aria-activedescendant"];
var _hoisted_32 = ["id"];
var _hoisted_42 = ["id", "aria-selected", "aria-disabled", "onClick", "onMouseenter"];
        ...
        _createVNode(_Transition, {
          ...
          default: _withCtx2(() => [
            _withDirectives(_createElementVNode4("div", {
              ...
              style: _normalizeStyle4($props.teleported ? __spreadValues7(__spreadValues7({}, $setup.themeStyle), $setup.dropdownStyle) : $setup.themeStyle),
              role: "listbox",
                            ...
                            _renderList(groupOpts, (option) => {
                              ...
                              return _openBlock5(), _createElementBlock5("div", {
                                ...
                                _renderSlot4(_ctx.$slots, "option", {
                                  option,
                                  keyword: (_b = (_a5 = $setup.triggerPos) == null ? void 0 : _a5.keyword) != null ? _b : ""
                                }, () => {
                                  var _a22, _b2;
                                  return [
                                    ...
                                    }, null, 10, _hoisted_52)) : _createCommentVNode5("v-if", true),
                                    _createElementVNode4(
                                      "div",
                                      {
...
var __sfc__5 = /* @__PURE__ */ Object.assign({ name: "YhMention" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const filteredOptions = computed15(() => {
      var _a5, _b;
      const keyword = (_b = (_a5 = triggerPos.value) == null ? void 0 : _a5.keyword) != null ? _b : "";
      return props.options.filter((opt) => {
        ...
        const text2 = ((_a22 = opt.label) != null ? _a22 : opt.value).toLowerCase();
        return text2.includes(keyword.toLowerCase());
      });
    });
    const groupedOptions = computed15(() => {
      ...
      for (const opt of filteredOptions.value) {
        const g = (_a5 = opt.group) != null ? _a5 : "";
        if (!map2.has(g)) map2.set(g, []);
        map2.get(g).push(opt);
      }
      return map2;
    });
    ...
    const selectOption = (option) => {
      ...
      const before = ((_a5 = props.modelValue) != null ? _a5 : "").substring(0, index);
      const after = (() => {
        var _a22, _b2, _c, _d;
    ...
    const handleOutsideClick = (e) => {
      ...
      if (((_a5 = wrapperRef.value) == null ? void 0 : _a5.contains(target)) || ((_b = dropdownRef.value) == null ? void 0 : _b.contains(target))) return;
      dropdownVisible.value = false;
      triggerPos.value = null;
    };
    const handleResize = () => {
    ...
    const insertMention = (option, trigger) => {
      var _a5, _b, _c, _d, _e;
      const t2 = (_a5 = trigger != null ? trigger : props.triggers[0]) != null ? _a5 : "@";
      const label = (_b = option.label) != null ? _b : option.value;
    ...
    const focus = () => {
      var _a5;
      return (_a5 = inputRef.value) == null ? void 0 : _a5.focus();
    };
    const blur = () => {
      var _a5;
      return (_a5 = inputRef.value) == null ? void 0 : _a5.blur();
    };
    ...
    const textLength = computed15(() => {
      var _a5;
      return ((_a5 = props.modelValue) != null ? _a5 : "").length;
    });
...
var YhMention = withInstall(stdin_default8);
                            ...
                            return _openBlock6(), _createElementBlock6(
                              ...
                              [
                                _createElementVNode5("div", {
                                  ...
                                  ], 10, _hoisted_23)) : (_openBlock6(), _createElementBlock6(
                                    "span",
                                    {
                                      key: 1,
...
var __sfc__6 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const loadFileTree = async (type, keyword = "") => {
      ...
      try {
        ...
        if (props.fileTreeExpandedLevel > 0) {
          nodes.forEach((node) => {
            var _a5;
            if (node.isFolder && ((_a5 = node.children) == null ? void 0 : _a5.length)) {
              expandedFolders.value.add(node.key);
            }
          });
        }
      } catch (error2) {
        console.error("Failed to load file tree:", error2);
        fileTreeData.value = [];
      } finally {
          ...
          for (const node of nodes) {
            if (node.label.toLowerCase().includes(keyword.toLowerCase())) {
              ...
              if (filteredChildren.length > 0) {
                result.push(__spreadProps4(__spreadValues8({}, node), { children: filteredChildren }));
              }
            }
          }
          return result;
    ...
    const getFileIcon = (node) => {
      ...
      const ext = ((_a5 = node.path.split(".").pop()) == null ? void 0 : _a5.toLowerCase()) || "";
      const iconMap = {
        pdf: "file-pdf",
        doc: "file-word",
        docx: "file-word",
    ...
    __expose({
      focus: () => {
        var _a5;
        return (_a5 = mentionRef.value) == null ? void 0 : _a5.focus();
      },
      blur: () => {
        var _a5;
        return (_a5 = mentionRef.value) == null ? void 0 : _a5.blur();
      },
      clear: () => {
        var _a5;
        return (_a5 = mentionRef.value) == null ? void 0 : _a5.clear();
      },
      getRef: () => {
        var _a5;
        return (_a5 = mentionRef.value) == null ? void 0 : _a5.ref;
      },
      insertMention: (option, trigger) => {
        var _a5;
        return (_a5 = mentionRef.value) == null ? void 0 : _a5.insertMention(option, trigger);
      },
      refreshFileTree,
...
var stdin_default9 = __sfc__6;

// public/codesandbox-runtime/components/ai-mention/index.js
var YhAiMention = withInstall(stdin_default9);
                      ...
                      _createElementVNode6(
                        ...
                        [
                          _createElementVNode6("div", {
                            ...
                            title: file.name
                          }, _toDisplayString4(file.name), 11, _hoisted_24),
          ...
          _createElementVNode6(
            ...
            [
              ...
              _renderSlot6(_ctx.$slots, "submit", {
                disabled: !((_a5 = $setup.innerValue) == null ? void 0 : _a5.trim()) || _ctx.disabled,
...
var __sfc__7 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const localValue = ref17((_a5 = props.modelValue) != null ? _a5 : "");
...
var stdin_default10 = __sfc__7;

// public/codesandbox-runtime/components/ai-bubble/src/ai-bubble.js
import { createCommentVNode as _createCommentVNode10, renderSlot as _renderSlot9, openBlock as _openBlock10, createBlock as _createBlock10, createVNode as _createVNode5, withCtx as _withCtx6, normalizeClass as _normalizeClass9, createElementBlock as _createElementBlock10, toDisplayString as _toDisplayString6, createElementVNode as _createElementVNode9, renderList as _renderList5, Fragment as _Fragment8, normalizeStyle as _normalizeStyle9, withModifiers as _withModifiers4, Transition as _Transition5, Teleport as _Teleport4, vModelText as _vModelText, withDirectives as _withDirectives2, createTextVNode as _createTextVNode } from "vue";
import {
...
import { createCommentVNode as _createCommentVNode8, normalizeClass as _normalizeClass7, normalizeStyle as _normalizeStyle7, openBlock as _openBlock8, createElementBlock as _createElementBlock8, resolveDynamicComponent as _resolveDynamicComponent4, createBlock as _createBlock8, Fragment as _Fragment6, renderSlot as _renderSlot7, createElementVNode as _createElementVNode7 } from "vue";
import { computed as computed18, ref as ref18 } from "vue";
...
var _hoisted_25 = ["src", "srcset", "alt", "crossorigin"];
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock8(), _createElementBlock8("span", {
    class: _normalizeClass7($setup.avatarClasses),
    style: _normalizeStyle7($setup.avatarStyle),
    role: "img",
    "aria-label": $props.alt
  }, [
    _createCommentVNode8(" \u56FE\u7247\u6A21\u5F0F "),
    $setup.showImg ? (_openBlock8(), _createElementBlock8("img", {
      key: 0,
      src: $props.src,
      srcset: $props.srcSet,
      alt: $props.alt,
      style: _normalizeStyle7({ objectFit: $props.fit }),
      class: _normalizeClass7($setup.ns.e("img")),
      crossorigin: $setup.props.crossorigin,
      onError: $setup.handleError
    }, null, 46, _hoisted_25)) : $props.icon && !_ctx.$slots.default ? (_openBlock8(), _createElementBlock8(
      _Fragment6,
      { key: 1 },
      [
        _createCommentVNode8(" \u56FE\u6807\u6A21\u5F0F "),
        (_openBlock8(), _createBlock8(_resolveDynamicComponent4($props.icon), {
          class: _normalizeClass7($setup.ns.e("icon"))
        }, null, 8, ["class"]))
      ],
      2112
      /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
      ...
      { key: 2 },
      [
        _createCommentVNode8(" \u9ED8\u8BA4\u63D2\u69FD\uFF08\u6587\u5B57/\u81EA\u5B9A\u4E49\uFF09 "),
        _renderSlot7(_ctx.$slots, "default", {}, () => [
          _createElementVNode7(
            "span",
            {
              class: _normalizeClass7($setup.ns.e("text"))
            },
            "?",
            2
            /* CLASS */
...
var __sfc__8 = /* @__PURE__ */ Object.assign({ name: "YhAvatar" }, {
  __name: "avatar",
  props: {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { themeStyle } = useComponentTheme(
      "avatar",
      computed18(() => props.themeOverrides)
    );
    const imgError = ref18(false);
    const sizeMap = {
      large: 56,
      default: 40,
      small: 28
    };
    const avatarSize = computed18(() => {
      var _a5;
      if (typeof props.size === "number") return `${props.size}px`;
      return `${(_a5 = sizeMap[props.size]) != null ? _a5 : 40}px`;
    });
    const avatarStyle = computed18(() => {
      const style = __spreadProps5(__spreadValues9({}, themeStyle.value), {
      ...
      return __spreadValues9(__spreadValues9({}, style), typeof props.style === "object" ? props.style : {});
    });
    const avatarClasses = computed18(() => [
      ns.b(),
      ns.m(props.shape),
      typeof props.size === "string" && ns.m(props.size),
      ns.is("image", !!props.src && !imgError.value)
    ]);
    const showImg = computed18(() => props.src && !imgError.value);
    const handleError = (event) => {
      imgError.value = true;
      emit("error", event);
    };
    const __returned__ = { props, emit, ns, themeStyle, imgError, sizeMap, avatarSize, avatarStyle, avatarClasses, showImg, handleError, computed: computed18, ref: ref18, get useNamespace() {
      return useNamespace;
    }, get useComponentTheme() {
      return useComponentTheme;
    } };
...
__sfc__8.render = render8;
var stdin_default11 = __sfc__8;

// public/codesandbox-runtime/components/avatar/index.js
var YhAvatar = withInstall(stdin_default11);

// public/codesandbox-runtime/components/ai-thought-chain/src/ai-thought-chain.js
import { createCommentVNode as _createCommentVNode9, normalizeClass as _normalizeClass8, normalizeStyle as _normalizeStyle8, createElementVNode as _createElementVNode8, openBlock as _openBlock9, createElementBlock as _createElementBlock9, renderList as _renderList4, Fragment as _Fragment7, createVNode as _createVNode4, createBlock as _createBlock9, toDisplayString as _toDisplayString5, withModifiers as _withModifiers3, Transition as _Transition4, withCtx as _withCtx5, renderSlot as _renderSlot8 } from "vue";
import { ref as ref19, computed as computed19, watch as watch8 } from "vue";
...
function link(state, silent) {
  ...
  if (parseReference) {
    ...
    ref22 = state.env.references[normalizeReference(label)];
    if (!ref22) {
      state.pos = oldPos;
      return false;
    }
...
function image(state, silent) {
  let code2, content, label, pos, ref22, res, title, start;
  let href = "";
  const oldPos = state.pos;
  const max = state.posMax;
...
var _a4;
var MarkdownIt2 = "default" in markdown_it_exports ? (_a4 = lib_default) != null ? _a4 : markdown_it_exports : markdown_it_exports;
var stdin_default12 = MarkdownIt2;
...
// public/codesandbox-runtime/components/ai-thought-chain/src/ai-thought-chain.js
var _hoisted_18 = ["draggable", "onDragstart", "onDragover", "onDrop"];
...
function render9(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock9(), _createElementBlock9(
    "div",
    {
      class: _normalizeClass8([$setup.ns.b(), $setup.ns.is("expanded", $setup.isExpanded), $setup.ns.is("thinking", $setup.currentStatus === "thinking" || $setup.currentStatus === "loading"), $setup.ns.is("timeline", $setup.itemsToUse && $setup.itemsToUse.length > 0), $setup.ns.is("draggable", _ctx.draggable), _ctx.className]),
      style: _normalizeStyle8([$setup.themeStyle, _ctx.style])
    },
    [
      _createCommentVNode9(" \u8FDB\u5EA6\u6761 "),
      _ctx.showProgress && $setup.itemsToUse && $setup.itemsToUse.length > 0 ? (_openBlock9(), _createElementBlock9(
        "div",
        {
          key: 0,
          class: _normalizeClass8($setup.ns.e("progress-bar"))
        },
        [
          _createElementVNode8(
            "div",
            {
              class: _normalizeClass8($setup.ns.e("progress-fill")),
      ...
      _createCommentVNode9(" \u591A\u8282\u70B9\u65F6\u95F4\u8F74\u6A21\u5F0F "),
      $setup.itemsToUse && $setup.itemsToUse.length > 0 ? (_openBlock9(), _createElementBlock9(
        _Fragment7,
        { key: 1 },
        [
          (_openBlock9(true), _createElementBlock9(
            _Fragment7,
            null,
            _renderList4($setup.itemsToUse, (item, index) => {
              return _openBlock9(), _createElementBlock9("div", {
                key: item.id || index,
                class: _normalizeClass8([$setup.ns.e("item"), $setup.ns.is("last", index === _ctx.items.length - 1), $setup.ns.is("active", item.status === "thinking" || item.status === "loading"), $setup.ns.is("drag-over", $setup.dragOverIndex === index), $setup.ns.is("dragging", $setup.draggedIndex === index)]),
                ...
                _createElementVNode8(
                  "div",
                  {
                    class: _normalizeClass8($setup.ns.e("item-dot-wrapper"))
                  },
                  [
                    _createElementVNode8(
                      "div",
                      {
                        class: _normalizeClass8([$setup.ns.e("item-dot"), $setup.ns.m(_ctx.dotSize), $setup.ns.m(item.status || "none")])
                      },
                      [
                        _createVNode4($setup["YhIcon"], {
                          name: item.icon || $setup.getStatusIcon(item.status),
                          class: _normalizeClass8({
                    ...
                    index < _ctx.items.length - 1 ? (_openBlock9(), _createElementBlock9(
                      "div",
                      {
                        key: 0,
                        class: _normalizeClass8([$setup.ns.e("item-line"), {
                ...
                _createElementVNode8(
                  "div",
                  {
                    class: _normalizeClass8($setup.ns.e("item-main"))
                  },
                  [
                    _createElementVNode8("div", {
                      class: _normalizeClass8($setup.ns.e("item-header")),
                      onClick: ($event) => $setup.toggleItemExpand(index)
                    }, [
                      _createCommentVNode9(" \u62D6\u62FD\u624B\u67C4 "),
                      _ctx.draggable ? (_openBlock9(), _createBlock9($setup["YhIcon"], {
                        key: 0,
                        name: "rank",
                        class: _normalizeClass8($setup.ns.e("drag-handle"))
                      }, null, 8, ["class"])) : _createCommentVNode9("v-if", true),
                      _createElementVNode8(
                        "span",
                        {
                          class: _normalizeClass8($setup.ns.e("item-title"))
                        },
                        _toDisplayString5(item.title),
                        3
                        /* TEXT, CLASS */
                      ),
                      _createCommentVNode9(" \u8282\u70B9\u8FDB\u5EA6 "),
                      item.progress !== void 0 ? (_openBlock9(), _createElementBlock9(
                        "span",
                        {
                          key: 1,
                          class: _normalizeClass8($setup.ns.e("item-progress"))
                        },
                        _toDisplayString5(item.progress) + "% ",
                        3
                        /* TEXT, CLASS */
                      )) : _createCommentVNode9("v-if", true),
                      _createCommentVNode9(" \u64CD\u4F5C\u6309\u94AE "),
                      _ctx.editable ? (_openBlock9(), _createElementBlock9(
                        "div",
                        {
                          key: 2,
                          class: _normalizeClass8($setup.ns.e("item-actions")),
                          onClick: _cache[0] || (_cache[0] = _withModifiers3(() => {
                          }, ["stop"]))
                        },
                        [
                          _createVNode4($setup["YhIcon"], {
                            name: "delete",
                            class: _normalizeClass8($setup.ns.e("action-icon")),
                      ...
                      item.content || item.description ? (_openBlock9(), _createBlock9($setup["YhIcon"], {
                        key: 3,
                        name: "arrow-down",
                        class: _normalizeClass8([$setup.ns.e("item-arrow"), {
                          "is-expanded": $setup.itemExpandedStates[index]
                        }])
                      }, null, 8, ["class"])) : _createCommentVNode9("v-if", true)
                    ], 10, _hoisted_26),
                    _createCommentVNode9(" \u5185\u5BB9\u533A\u57DF "),
                    _createVNode4(
                      _Transition4,
                      { name: "yh-ai-thought-collapse" },
                      {
                        default: _withCtx5(() => [
                          $setup.itemExpandedStates[index] && (item.content || item.description) ? (_openBlock9(), _createElementBlock9("div", {
                            key: 0,
                            class: _normalizeClass8($setup.ns.e("item-content")),
                            onClick: ($event) => $setup.handleItemClick(item, index)
                          }, [
                            _createCommentVNode9(" \u652F\u6301 Markdown\uFF1A\u5185\u5BB9\u6765\u81EA renderMarkdown\uFF0C\u4EC5\u7528\u4E8E\u53D7\u63A7\u7684\u601D\u7EF4\u94FE\u8282\u70B9 "),
                            _createCommentVNode9(" eslint-disable vue/no-v-html "),
                            _ctx.markdown ? (_openBlock9(), _createElementBlock9("div", {
                              key: 0,
                              class: _normalizeClass8($setup.ns.e("item-text")),
                              innerHTML: $setup.renderMarkdown(item.content || item.description || "")
                            }, null, 10, _hoisted_43)) : (_openBlock9(), _createElementBlock9(
                              _Fragment7,
                              { key: 1 },
                              [
                                _createCommentVNode9(" eslint-enable vue/no-v-html "),
                                _createCommentVNode9(" \u7EAF\u6587\u672C "),
                                _createElementVNode8(
                                  "div",
                                  {
                                    class: _normalizeClass8($setup.ns.e("item-text"))
                                  },
                                  _toDisplayString5(item.content || item.description),
                                  3
                                  /* TEXT, CLASS */
                                )
                              ],
                          ...
                          ], 10, _hoisted_35)) : _createCommentVNode9("v-if", true)
                        ]),
                        _: 2
                        /* DYNAMIC */
                      },
          ...
          _createCommentVNode9(" \u6DFB\u52A0\u8282\u70B9\u6309\u94AE "),
          _ctx.editable ? (_openBlock9(), _createElementBlock9(
            "div",
            {
              key: 0,
              class: _normalizeClass8($setup.ns.e("add-node")),
              onClick: _cache[1] || (_cache[1] = ($event) => $setup.handleAddNode(_ctx.items.length))
            },
            [
              _createVNode4($setup["YhIcon"], { name: "plus" }),
              _createElementVNode8(
                "span",
                null,
                _toDisplayString5($setup.t("ai.thoughtChain.addNode")),
                1
                /* TEXT */
              )
            ],
        ...
        64
        /* STABLE_FRAGMENT */
      )) : (_openBlock9(), _createElementBlock9(
        _Fragment7,
        { key: 2 },
        [
          _createCommentVNode9(" \u5355\u8282\u70B9/\u4F20\u7EDF\u6A21\u5F0F "),
          _createElementVNode8(
            "div",
            {
              class: _normalizeClass8($setup.ns.e("header")),
            ...
            [
              _createElementVNode8(
                "div",
                {
                  class: _normalizeClass8($setup.ns.e("icon"))
                },
                [
                  _createVNode4($setup["YhIcon"], {
                    name: $setup.getStatusIcon($setup.currentStatus),
                    class: _normalizeClass8([$setup.ns.e("status-icon"), {
              ...
              _createElementVNode8(
                "div",
                {
                  class: _normalizeClass8($setup.ns.e("title"))
                },
                _toDisplayString5($setup.displayTitle),
                3
                /* TEXT, CLASS */
              ),
              _createVNode4($setup["YhIcon"], {
                name: "arrow-down",
                class: _normalizeClass8([$setup.ns.e("arrow"), {
          ...
          _createVNode4(_Transition4, { name: "yh-ai-thought-collapse" }, {
            default: _withCtx5(() => [
              $setup.isExpanded ? (_openBlock9(), _createElementBlock9(
                "div",
                {
                  key: 0,
                  class: _normalizeClass8($setup.ns.e("content"))
                },
                [
                  _renderSlot8(_ctx.$slots, "default", {}, () => [
                    _createElementVNode8(
                      "div",
                      {
                        class: _normalizeClass8($setup.ns.e("text"))
                      },
                      _toDisplayString5(_ctx.content),
                      3
                      /* TEXT, CLASS */
                    )
                  ])
...
var __sfc__9 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isExpanded = ref19(false);
    const md = new stdin_default12({
      html: false,
      linkify: true,
      typographer: true
    });
    const itemExpandedStates = ref19([]);
    const internalItems = ref19([]);
    const draggedIndex = ref19(null);
    const dragOverIndex = ref19(null);
    const itemsToUse = computed19(() => {
    ...
    const currentProgress = computed19(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isExpanded, md, itemExpandedStates, internalItems, draggedIndex, dragOverIndex, itemsToUse, ensureInternalItems, currentProgress, currentStatus, displayTitle, renderMarkdown, getStatusIcon, toggleExpand, toggleItemExpand, handleItemClick, handleDeleteNode, handleAddNode, handleDragStart, handleDragOver, handleDragLeave, handleDrop, handleDragEnd, get useNamespace() {
      ...
      return useLocale;
    }, ref: ref19, computed: computed19, watch: watch8, get YhIcon() {
      return YhIcon;
    }, get MarkdownIt() {
      return stdin_default12;
...
__sfc__9.render = render9;
var stdin_default13 = __sfc__9;

// public/codesandbox-runtime/components/ai-thought-chain/index.js
var YhAiThoughtChain = withInstall(stdin_default13);
...
var hljs = {
  ...
  highlight(code2, _options) {
    return render10(code2);
  },
  highlightAuto(code2) {
    return render10(code2);
  }
};
var stdin_default14 = hljs;
...
function render11(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock10(), _createElementBlock10(
    "div",
    {
      class: _normalizeClass9($setup.classes),
      style: _normalizeStyle9($setup.themeStyle)
    },
    [
      _createCommentVNode10(" Avatar "),
      _ctx.role !== "system" ? (_openBlock10(), _createElementBlock10(
        "div",
        {
          key: 0,
          class: _normalizeClass9($setup.ns.e("avatar"))
        },
        [
          _renderSlot9(_ctx.$slots, "avatar", {}, () => [
            _ctx.avatar ? (_openBlock10(), _createBlock10($setup["YhAvatar"], {
              key: 0,
              src: _ctx.avatar,
              crossorigin: "anonymous"
            }, null, 8, ["src"])) : (_openBlock10(), _createBlock10($setup["YhAvatar"], { key: 1 }, {
              default: _withCtx6(() => [
                _createVNode5($setup["YhIcon"], {
      ...
      _createCommentVNode10(" Content Wrapper "),
      _createElementVNode9(
        "div",
        {
          class: _normalizeClass9($setup.ns.e("content-wrapper"))
        },
        [
          _createCommentVNode10(" Header "),
          _ctx.$slots.header || _ctx.time ? (_openBlock10(), _createElementBlock10(
            "div",
            {
              key: 0,
              class: _normalizeClass9($setup.ns.e("header"))
            },
            [
              _renderSlot9(_ctx.$slots, "header", {}, () => [
                _ctx.time ? (_openBlock10(), _createElementBlock10(
                  "span",
                  {
                    key: 0,
                    class: _normalizeClass9($setup.ns.e("time"))
                  },
                  _toDisplayString6(_ctx.time),
                  3
                  /* TEXT, CLASS */
                )) : _createCommentVNode10("v-if", true)
              ])
          ...
          _createCommentVNode10(" Body "),
          _createElementVNode9(
            "div",
            {
              class: _normalizeClass9([$setup.ns.e("body"), $setup.ns.is("typing", _ctx.loading)])
            },
            [
              _ctx.loading && !_ctx.content ? (_openBlock10(), _createElementBlock10(
                "span",
                {
                  key: 0,
                  class: _normalizeClass9($setup.ns.e("typing-indicator"))
                },
                [..._cache[2] || (_cache[2] = [
                  _createElementVNode9(
                    "span",
                ...
                2
                /* CLASS */
              )) : (_openBlock10(), _createElementBlock10(
                _Fragment8,
                { key: 1 },
                [
                  _createCommentVNode10(" Multimodal: Images (Above text) "),
                  _ctx.multimodal && _ctx.multimodal.some((m2) => m2.type === "image") ? (_openBlock10(), _createElementBlock10(
                    "div",
                    {
                      key: 0,
                      class: _normalizeClass9($setup.ns.e("image-grid"))
                    },
                    [
                      (_openBlock10(true), _createElementBlock10(
                        _Fragment8,
                        null,
                        _renderList5(_ctx.multimodal.filter((m2) => m2.type === "image"), (img, idx) => {
                          return _openBlock10(), _createElementBlock10(
                            "div",
                            {
                              key: idx,
                              class: _normalizeClass9($setup.ns.e("image-item"))
                            },
                            [
                              _createElementVNode9("img", {
                                src: img.url,
                                alt: img.title,
                                loading: "lazy",
                                crossorigin: "anonymous"
                  ...
                  _renderSlot9(_ctx.$slots, "default", {}, () => [
                    _createCommentVNode10(" eslint-disable vue/no-v-html "),
                    _ctx.markdown ? (_openBlock10(), _createElementBlock10("div", {
                      key: 0,
                      class: _normalizeClass9([$setup.ns.e("text"), $setup.ns.e("markdown")]),
                      innerHTML: $setup.parsedContent,
                      onMouseover: $setup.handleCitationHover,
                      onMouseout: $setup.handleCitationLeave
                    }, null, 42, _hoisted_27)) : (_openBlock10(), _createElementBlock10(
                      _Fragment8,
                      { key: 1 },
                      [
                        _createCommentVNode10(" eslint-enable vue/no-v-html "),
                        _createElementVNode9(
                          "div",
                          {
                            class: _normalizeClass9($setup.ns.e("text"))
                          },
                          _toDisplayString6(_ctx.content),
                          3
                          /* TEXT, CLASS */
                        )
                      ],
                  ...
                  _createCommentVNode10(" Structured Data Display (Below main text) "),
                  _ctx.structuredData ? (_openBlock10(), _createElementBlock10(
                    "div",
                    {
                      key: 1,
                      class: _normalizeClass9($setup.ns.e("structured-data"))
                    },
                    [
                      _createCommentVNode10(" JSON pretty view "),
                      _createCommentVNode10(" eslint-disable vue/no-v-html "),
                      _ctx.structuredData.type === "json" ? (_openBlock10(), _createElementBlock10(
                        "div",
                        {
                          key: 0,
                          class: _normalizeClass9([$setup.ns.e("json-viewer")])
                        },
                        [
                          _createElementVNode9("pre", _hoisted_36, [
                            _createElementVNode9("code", { innerHTML: $setup.jsonHtml }, null, 8, _hoisted_44)
                          ])
                        ],
                        2
                        /* CLASS */
                      )) : _ctx.structuredData.type === "table" ? (_openBlock10(), _createElementBlock10(
                        _Fragment8,
                        { key: 1 },
                        [
                          _createCommentVNode10(" eslint-enable vue/no-v-html "),
                          _createCommentVNode10(" Table view "),
                          _createElementVNode9(
                            "div",
                            {
                              class: _normalizeClass9([$setup.ns.e("table-viewer")])
                            },
                            [
                              _createElementVNode9("table", null, [
                                _createElementVNode9("thead", null, [
                                  _ctx.structuredData.data && _ctx.structuredData.data.headers ? (_openBlock10(), _createElementBlock10("tr", _hoisted_53, [
                                    (_openBlock10(true), _createElementBlock10(
                                      _Fragment8,
                                      null,
                                      _renderList5(_ctx.structuredData.data.headers, (h2) => {
                                        return _openBlock10(), _createElementBlock10(
                                          "th",
                                          { key: h2 },
                                          _toDisplayString6(h2),
                                          1
                                          /* TEXT */
                                        );
                                      }),
                                ...
                                _ctx.structuredData.data && typeof _ctx.structuredData.data === "object" ? (_openBlock10(), _createElementBlock10("tbody", _hoisted_62, [
                                  (_openBlock10(true), _createElementBlock10(
                                    _Fragment8,
                                    null,
                                    _renderList5(_ctx.structuredData.data.rows, (row, idx) => {
                                      return _openBlock10(), _createElementBlock10("tr", { key: idx }, [
                                        (_openBlock10(true), _createElementBlock10(
                                          _Fragment8,
                                          null,
                                          _renderList5(row, (cell, cIdx) => {
                                            return _openBlock10(), _createElementBlock10(
                                              "td",
                                              { key: cIdx },
                                              _toDisplayString6(cell),
                                              1
                                              /* TEXT */
                                            );
                                          }),
                        ...
                        2112
                        /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
                      )) : _ctx.structuredData.type === "thought-chain" && _ctx.structuredData.data ? (_openBlock10(), _createElementBlock10(
                        _Fragment8,
                        { key: 2 },
                        [
                          _createCommentVNode10(" Thought chain: delegate to AiThoughtChain for consistent style "),
                          _createVNode5($setup["YhAiThoughtChain"], {
                        ...
                        { key: 3 },
                        [
                          _createCommentVNode10(" Fallback: raw JSON "),
                          _createElementVNode9(
                            "div",
                            {
                              class: _normalizeClass9([$setup.ns.e("chart-viewer")])
                            },
                            [
                              _createElementVNode9(
                                "pre",
                                null,
                                _toDisplayString6(JSON.stringify(_ctx.structuredData.data, null, 2)),
                                1
                                /* TEXT */
                              )
                            ],
                  ...
                  _createCommentVNode10(" Multimodal: Audio/Files (Below text) "),
                  _ctx.multimodal && _ctx.multimodal.some((m2) => m2.type !== "image") ? (_openBlock10(), _createElementBlock10(
                    "div",
                    {
                      key: 2,
                      class: _normalizeClass9($setup.ns.e("multimodal-assets"))
                    },
                    [
                      (_openBlock10(true), _createElementBlock10(
                        _Fragment8,
                        null,
                        _renderList5(_ctx.multimodal, (asset, idx) => {
                          var _a5;
                          return _openBlock10(), _createElementBlock10(
                            _Fragment8,
                            { key: idx },
                            [
                              _createCommentVNode10(" Audio Player "),
                              asset.type === "audio" ? (_openBlock10(), _createElementBlock10(
                                "div",
                                {
                                  key: 0,
                                  class: _normalizeClass9([$setup.ns.e("audio-player"), {
                                    "is-active": $setup.playingAsset === asset.url
                                  }])
                                },
                                [
                                  _createVNode5($setup["YhButton"], {
                                    circle: "",
                                    size: "small",
                                  ...
                                  _createElementVNode9(
                                    "div",
                                    {
                                      class: _normalizeClass9([$setup.ns.e("audio-waveform"), {
                                        "is-active": $setup.playingAsset === asset.url
                                      }])
                                    },
                                    [
                                  ...
                                  _createElementVNode9(
                                    "span",
                                    {
                                      class: _normalizeClass9($setup.ns.e("audio-duration"))
                                    },
                                    _toDisplayString6(((_a5 = asset.extra) == null ? void 0 : _a5.duration) || "0:00"),
                                    3
                                    /* TEXT, CLASS */
                                  )
                                ],
                                2
                                /* CLASS */
                              )) : asset.type === "file" ? (_openBlock10(), _createElementBlock10(
                                _Fragment8,
                                { key: 1 },
                                [
                                  _createCommentVNode10(" File/Table Card "),
                                  _createElementVNode9(
                                    "div",
                                    {
                                      class: _normalizeClass9($setup.ns.e("file-card"))
                                    },
                                    [
                                      _createElementVNode9(
                                        "div",
                                        {
                                          class: _normalizeClass9($setup.ns.e("file-icon"))
                                        },
                                        [
                                          _createVNode5($setup["YhIcon"], {
                                      ...
                                      _createElementVNode9(
                                        "div",
                                        {
                                          class: _normalizeClass9($setup.ns.e("file-info"))
                                        },
                                        [
                                          _createElementVNode9(
                                            "div",
                                            {
                                              class: _normalizeClass9($setup.ns.e("file-name"))
                                            },
                                            _toDisplayString6(asset.title),
                                            3
                                            /* TEXT, CLASS */
                                          ),
                                          _createElementVNode9(
                                            "div",
                                            {
                                              class: _normalizeClass9($setup.ns.e("file-meta"))
                                            },
                                            _toDisplayString6(asset.size),
                                            3
                                            /* TEXT, CLASS */
                                          )
                                        ],
                                      ...
                                      _createVNode5($setup["YhButton"], {
                                        ...
                                        icon: _withCtx6(() => [
                                          _createVNode5($setup["YhIcon"], { name: "download" })
                                        ]),
                                        _: 1
                                        /* STABLE */
                                      }, 8, ["onClick"])
                  ...
                  _createCommentVNode10(" Citations "),
                  _ctx.citations && _ctx.citations.length > 0 ? (_openBlock10(), _createElementBlock10(
                    "div",
                    {
                      key: 3,
                      class: _normalizeClass9($setup.ns.e("citations"))
                    },
                    [
                      _createElementVNode9(
                        "div",
                        {
                          class: _normalizeClass9($setup.ns.e("citations-title"))
                        },
                        [
                          _createVNode5($setup["YhIcon"], { name: "document" }),
                          _createElementVNode9(
                            "span",
                            null,
                            _toDisplayString6($setup.t("ai.bubble.citations")),
                            1
                            /* TEXT */
                          ),
                          _createElementVNode9(
                            "span",
                            {
                              class: _normalizeClass9($setup.ns.e("citations-count"))
                            },
                            _toDisplayString6(_ctx.citations.length),
                            3
                            /* TEXT, CLASS */
                          )
                        ],
                      ...
                      _createElementVNode9(
                        "div",
                        {
                          class: _normalizeClass9($setup.ns.e("citations-list"))
                        },
                        [
                          (_openBlock10(true), _createElementBlock10(
                            _Fragment8,
                            null,
                            _renderList5(_ctx.citations, (cite, index) => {
                              return _openBlock10(), _createElementBlock10("a", {
                                key: index,
                                href: cite.url,
                                target: "_blank",
                                class: _normalizeClass9($setup.ns.e("citation-item")),
                                title: cite.title,
                                onClick: _withModifiers4(($event) => $setup.handleCitationClick(cite), ["prevent"])
                              }, [
                                _createElementVNode9(
                                  "span",
                                  {
                                    class: _normalizeClass9($setup.ns.e("citation-index"))
                                  },
                                  _toDisplayString6(cite.id || index + 1),
                                  3
                                  /* TEXT, CLASS */
                                ),
                                _createElementVNode9(
                                  "span",
                                  {
                                    class: _normalizeClass9($setup.ns.e("citation-text"))
                                  },
                                  _toDisplayString6(cite.title),
                                  3
                                  /* TEXT, CLASS */
                                ),
                                cite.url ? (_openBlock10(), _createBlock10($setup["YhIcon"], {
                                  key: 0,
                                  name: "arrow-right",
                                  class: _normalizeClass9($setup.ns.e("citation-link-icon"))
                                }, null, 8, ["class"])) : _createCommentVNode10("v-if", true)
                              ], 10, _hoisted_72);
                            }),
                            128
                            /* KEYED_FRAGMENT */
          ...
          _createCommentVNode10(" Footer "),
          _ctx.$slots.footer ? (_openBlock10(), _createElementBlock10(
            "div",
            {
              key: 1,
              class: _normalizeClass9($setup.ns.e("footer"))
            },
            [
              _renderSlot9(_ctx.$slots, "footer")
            ],
            2
            /* CLASS */
          )) : _createCommentVNode10("v-if", true)
      ...
      _createCommentVNode10(" Floating Citation Tooltip "),
      (_openBlock10(), _createBlock10(_Teleport4, { to: "body" }, [
        _createVNode5(_Transition5, { name: "yh-fade-in-scale-up" }, {
          default: _withCtx6(() => [
            $setup.hoveredCitation ? (_openBlock10(), _createElementBlock10(
              "div",
              {
                key: 0,
                class: _normalizeClass9($setup.ns.e("citation-tooltip-wrapper")),
                style: _normalizeStyle9($setup.citationTooltipStyle),
              ...
              [
                _createElementVNode9(
                  "div",
                  {
                    class: _normalizeClass9($setup.ns.e("citation-tooltip"))
                  },
                  [
                    _createElementVNode9(
                      "div",
                      {
                        class: _normalizeClass9($setup.ns.e("citation-tooltip-header"))
                      },
                      [
                        _createVNode5($setup["YhIcon"], {
                        ...
                        _createElementVNode9(
                          "span",
                          null,
                          _toDisplayString6($setup.hoveredCitation.source || $setup.hoveredCitation.title),
                          1
                          /* TEXT */
                        )
                      ],
                    ...
                    _createElementVNode9(
                      "div",
                      {
                        class: _normalizeClass9($setup.ns.e("citation-tooltip-body"))
                      },
                      [
                        _createElementVNode9(
                          "h4",
                          null,
                          _toDisplayString6($setup.hoveredCitation.title),
                          1
                          /* TEXT */
                        ),
                        $setup.hoveredCitation.abstract ? (_openBlock10(), _createElementBlock10(
                          "p",
                          _hoisted_82,
                          _toDisplayString6($setup.hoveredCitation.abstract),
                          1
                          /* TEXT */
                        )) : _createCommentVNode10("v-if", true),
                        $setup.hoveredCitation.publishTime ? (_openBlock10(), _createElementBlock10(
                          "span",
                          _hoisted_92,
                          _toDisplayString6($setup.hoveredCitation.publishTime),
                          1
                          /* TEXT */
                        )) : _createCommentVNode10("v-if", true)
                      ],
      ...
      _createCommentVNode10(" Code Edit Modal "),
      (_openBlock10(), _createBlock10(_Teleport4, { to: "body" }, [
        _createVNode5(_Transition5, { name: "yh-fade-in" }, {
          default: _withCtx6(() => [
            $setup.editingCodeBlock ? (_openBlock10(), _createElementBlock10("div", {
              key: 0,
              class: "code-edit-modal-overlay",
              onClick: _withModifiers4($setup.cancelEditCode, ["self"])
            }, [
              _createElementVNode9("div", _hoisted_10, [
                _createElementVNode9("div", _hoisted_11, [
                  _cache[3] || (_cache[3] = _createElementVNode9(
                    "h3",
                    null,
                    "Edit Code",
                    -1
                  ...
                  _createVNode5($setup["YhButton"], {
                    ...
                    default: _withCtx6(() => [
                      _createVNode5($setup["YhIcon"], { name: "close" })
                    ]),
                    _: 1
                    /* STABLE */
                  })
                ]),
                _createElementVNode9("div", _hoisted_122, [
                  _createElementVNode9(
                    "div",
                    _hoisted_132,
                    null,
                  ...
                  !$setup.monaco ? _withDirectives2((_openBlock10(), _createElementBlock10(
                    "textarea",
                    {
                      key: 0,
                ...
                _createElementVNode9("div", _hoisted_142, [
                  _createVNode5($setup["YhButton"], { onClick: $setup.cancelEditCode }, {
                    default: _withCtx6(() => [..._cache[4] || (_cache[4] = [
                      _createTextVNode(
                        "Cancel",
                        -1
                        /* CACHED */
                  ...
                  _createVNode5($setup["YhButton"], {
                    ...
                    default: _withCtx6(() => [..._cache[5] || (_cache[5] = [
                      _createTextVNode(
                        "Save",
                        -1
                        /* CACHED */
...
var __sfc__10 = /* @__PURE__ */ Object.assign({
  name: "YhAiBubble"
}, {
  __name: "ai-bubble",
  props: aiBubbleProps,
  setup(__props, { expose: __expose }) {
    ...
    const { themeStyle } = useComponentTheme(
      "ai-bubble",
      computed20(() => props.themeOverrides)
    );
    const playingAsset = ref20(null);
    ...
    const getFileIcon = (url = "") => {
      var _a5;
      const ext = ((_a5 = url.split(".").pop()) == null ? void 0 : _a5.toLowerCase()) || "";
      switch (ext) {
        case "pdf":
          return "file-pdf";
        case "xlsx":
    ...
    const _mermaidContainer = ref20(null);
    const mermaidLoading = ref20(false);
    const mermaidError = ref20(null);
    ...
    const expandedCodeBlocks = ref20(/* @__PURE__ */ new Set());
    const copiedCodeBlocks = ref20(/* @__PURE__ */ new Set());
    const editingCodeBlock = ref20(null);
    const editCodeContent = ref20("");
    const runningCodeBlock = ref20(null);
    const codeOutput = ref20({});
    let webContainerInstance = null;
    const monaco = shallowRef3(null);
    const monacoEditor = shallowRef3(null);
    const monacoContainer = ref20(null);
    ...
    const openCodeEditor = async (code2, id, lang) => {
      ...
      const m2 = await loadMonaco();
      if (!container || !m2) return;
      if (monacoEditor.value) {
        monacoEditor.value.dispose();
        monacoEditor.value = null;
      }
      monacoEditor.value = m2.editor.create(container, {
        value: code2,
    ...
    const runCodeInBrowser = (code2, id) => {
      ...
      try {
        ...
        const _originalConsole = __spreadValues10({}, console);
...
Remote Error: ${error2}`);
    ...
    const runCode = async (code2, lang, id) => {
      ...
      if (props.onRunCode) {
        ...
        const runtime = ((_a5 = mdOptions.codeBlock) == null ? void 0 : _a5.runtime) || "browser";
    ...
    const parsedContent = ref20(props.content);
    let renderRafId = null;
    let streamTimer = null;
    let streamPosition = 0;
    let streamBuffer = "";
    const streamingCodeBlocks = ref20(/* @__PURE__ */ new Set());
  ...
  `;
    ...
    const _structuredDataRef = ref20(null);
    const _renderStructuredData = computed20(() => {
    ...
    const jsonHtml = computed20(() => {
      ...
      try {
        ...
        if (stdin_default14.getLanguage("json")) {
          return stdin_default14.highlight(jsonString, {
            language: "json",
            ignoreIllegals: true
          }).value;
        }
    ...
    const hoveredCitation = ref20(null);
    const citationTooltipStyle = ref20({
      top: "0px",
      left: "0px",
      position: "fixed",
      transform: "",
    ...
    const handleCitationHover = (e) => {
      ...
      if (target && target.classList && target.classList.contains("yh-ai-citation")) {
        ...
        const citation = (_a5 = props.citations) == null ? void 0 : _a5.find(
          (c) => String(c.id) === id
        );
        if (citation) {
    ...
    const getMarkdownOptions = () => {
      var _a5;
      return __spreadProps6(__spreadValues10({
        mermaid: true,
        latex: true,
        filePreview: true,
        linkify: true,
        ...
        }, ((_a5 = props.markdownOptions) == null ? void 0 : _a5.codeBlock) || {})
      });
    };
    const getMarkdownInstance = () => {
      ...
      const mdOptions = getMarkdownOptions();
      const md = new stdin_default12({
        html: (_a5 = mdOptions.html) != null ? _a5 : false,
        ...
        highlight: function(str, lang) {
          ...
          if (hlLang && stdin_default14.getLanguage(hlLang)) {
            try {
              result = stdin_default14.highlight(str, { language: hlLang, ignoreIllegals: true }).value;
            } catch (e) {
            }
          } else {
    ...
    const __returned__ = { props, ns, t, themeStyle, playingAsset, get audioInstance() {
      ...
      return useComponentTheme;
    }, computed: computed20, ref: ref20, onBeforeUnmount: onBeforeUnmount3, watchEffect, shallowRef: shallowRef3, watch: watch9, onMounted: onMounted6, nextTick: nextTick3, get aiBubbleProps() {
      ...
      return stdin_default14;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
__sfc__10.render = render11;
var stdin_default15 = __sfc__10;

// public/codesandbox-runtime/components/ai-chat/src/ai-chat-meta.js
var aiChatProps = {
  /**
   * @description 消息列表
   */
...
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock11(), _createElementBlock11(
    "div",
    {
      class: _normalizeClass10($setup.ns.b()),
      style: _normalizeStyle10($setup.themeStyle)
    },
    [
      _createCommentVNode11(" Header Tools (optional) "),
      _ctx.$slots.header || $setup.props.messages.length > 0 ? (_openBlock11(), _createElementBlock11(
        "div",
        {
          key: 0,
          class: _normalizeClass10($setup.ns.e("header"))
        },
        [
          _renderSlot10(_ctx.$slots, "header", {}, () => [
            _createElementVNode10(
              "div",
              {
                class: _normalizeClass10($setup.ns.e("header-tools"))
              },
              [
                $setup.props.messages.length > 0 ? (_openBlock11(), _createBlock11($setup["YhButton"], {
                  key: 0,
                  size: "small",
                  text: "",
                  class: _normalizeClass10($setup.ns.e("clear-btn")),
                  onClick: $setup.handleClear
                }, {
                  icon: _withCtx7(() => [
                    _createVNode6($setup["YhIcon"], { name: "delete" })
                  ]),
                  default: _withCtx7(() => [
                    _createTextVNode2(
                      " " + _toDisplayString7($setup.t("common.clear")),
                      1
                      /* TEXT */
                    )
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["class"])) : _createCommentVNode11("v-if", true)
              ],
              2
              /* CLASS */
            )
      ...
      _createCommentVNode11(" Messages List "),
      _createElementVNode10(
        "div",
        {
          class: _normalizeClass10($setup.ns.e("content")),
          ref: "contentRef",
          style: _normalizeStyle10($setup.virtualScrollEnabled ? {
            height: $setup.props.virtualHeight + "px",
            overflow: "auto"
          } : {}),
          onScroll: _cache[0] || (_cache[0] = ($event) => $setup.virtualScrollEnabled ? $setup.onScroll($event) : void 0)
        },
        [
          $setup.props.messages.length === 0 && $setup.props.suggestions.length > 0 ? (_openBlock11(), _createElementBlock11(
            "div",
            {
              key: 0,
              class: _normalizeClass10($setup.ns.e("suggestions"))
            },
            [
              (_openBlock11(true), _createElementBlock11(
                _Fragment9,
                null,
                _renderList6($setup.props.suggestions, (suggestion, idx) => {
                  return _openBlock11(), _createBlock11($setup["YhButton"], {
                    key: idx,
                    plain: "",
                    round: "",
          ...
          _createCommentVNode11(" Virtual Scroll Mode "),
          $setup.virtualScrollEnabled ? (_openBlock11(), _createElementBlock11(
            "div",
            {
              key: 1,
              style: _normalizeStyle10({
              ...
              _createElementVNode10(
                ...
                [
                  (_openBlock11(true), _createElementBlock11(
                    _Fragment9,
                    null,
                    _renderList6($setup.visibleItems, (msg, index) => {
                      return _renderSlot10(_ctx.$slots, "message", {
                        key: msg.id || $setup.startIndex + index,
                        message: msg,
                        index: $setup.startIndex + index
                      }, () => [
                        _createVNode6($setup["YhAiBubble"], {
                          content: msg.content,
                          role: msg.role,
                          ...
                          time: msg.time,
                          markdown: true
                        }, null, 8, ["content", "role", "loading", "variant", "time"])
                      ]);
                    }),
                    128
                    /* KEYED_FRAGMENT */
            ...
            { key: 2 },
            [
              _createCommentVNode11(" Normal Mode "),
              (_openBlock11(true), _createElementBlock11(
                _Fragment9,
                null,
                _renderList6($setup.props.messages, (msg, index) => {
                  return _renderSlot10(_ctx.$slots, "message", {
                    key: msg.id || index,
                    message: msg,
                    index
                  }, () => [
                    _createCommentVNode11(" We use the powerful markdown rendering by default on the bubbles inside AiChat "),
                    _createVNode6($setup["YhAiBubble"], {
                      content: msg.content,
                      role: msg.role,
                      loading: msg.status === "generating" || msg.status === "loading",
          ...
          _createCommentVNode11(" Loading Placeholder "),
          $setup.props.loading && (!$setup.props.messages.length || $setup.props.messages[$setup.props.messages.length - 1].role !== "assistant" || $setup.props.messages[$setup.props.messages.length - 1].status !== "generating" && $setup.props.messages[$setup.props.messages.length - 1].status !== "loading") ? _renderSlot10(_ctx.$slots, "loading", { key: 3 }, () => [
            _createVNode6($setup["YhAiBubble"], {
              role: "assistant",
              loading: "",
              typing: "",
      ...
      _createCommentVNode11(" Footer Input Bar "),
      _createElementVNode10(
        "div",
        {
          class: _normalizeClass10($setup.ns.e("footer"))
        },
        [
          _renderSlot10(_ctx.$slots, "sender", {}, () => [
            _createVNode6($setup["YhAiSender"], {
              loading: $setup.props.loading,
...
var __sfc__11 = /* @__PURE__ */ Object.assign({
  name: "YhAiChat"
}, {
  __name: "ai-chat",
  props: aiChatProps,
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const contentRef = ref21();
    const virtualScrollEnabled = computed21(() => props.virtualScroll && props.messages.length > 50);
    const { visibleItems, totalHeight, offsetY, startIndex, onScroll, scrollToIndex } = useVirtualScroll({
      items: computed21(() => props.messages),
    ...
    watch10(() => props.messages, scrollToBottom, { deep: true });
    watch10(() => props.loading, scrollToBottom);
    const handleSend = (text2) => {
      emit("send", text2);
    };
    const handleClear = () => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, contentRef, virtualScrollEnabled, visibleItems, totalHeight, offsetY, startIndex, onScroll, scrollToIndex, scrollToBottom, handleSend, handleClear, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, ref: ref21, watch: watch10, nextTick: nextTick4, computed: computed21, YhAiSender: stdin_default10, YhAiBubble: stdin_default15, get YhButton() {
      return YhButton;
    }, get YhIcon() {
      return YhIcon;
    }, get aiChatProps() {
...
__sfc__11.render = render12;
var stdin_default16 = __sfc__11;
export {
  stdin_default16 as default
};
