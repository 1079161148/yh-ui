      ...
      get editorOrigin() {
        ...
        if (editorOrigin == null) {
          editorOrigin = new URL(
            (_a5 = globalThis.WEBCONTAINER_API_IFRAME_URL) != null ? _a5 : DEFAULT_EDITOR_ORIGIN
          ).origin
        }
        return editorOrigin
      },
  ...
  '../node_modules/@webcontainer/api/dist/internal/auth-state.js'() {
    ...
    auth = {
      ...
      async logout({ ignoreRevokeError } = {}) {
        var _a5
        await ((_a5 = authState.tokens) == null
          ? void 0
          : _a5.revoke(authState.clientId, ignoreRevokeError != null ? ignoreRevokeError : false))
        loggedOutListeners.fireEvent()
        broadcastMessage({ type: 'auth-logout' })
      },
      loggedIn() {
...
var init_vendor = __esm({
  '../node_modules/@webcontainer/api/dist/vendor/index.js'() {
    ...
    __export2 = (target, all) => {
      for (var name in all) __defProp10(target, name, { get: all[name], enumerable: true })
    }
    comlink_exports = {}
...
function reloadPreview(preview, hardRefreshTimeout = 200) {
  ...
  ;(_a5 = preview.contentWindow) == null
    ? void 0
    : _a5.postMessage(
        {
  ...
  for (const name of Object.keys(tree)) {
    ...
    if ('file' in entry) {
      ...
      const stringContents =
        typeof contents === 'string' ? contents : binaryDecoder.decode(contents)
...
function serverFactory(options) {
  if (cachedServerPromise != null) {
    if (options.coep !== cachedBootOptions.coep) {
      ...
      console.warn(
        `First boot had 'coep: ${cachedBootOptions.coep}', new settings will not take effect!`
      )
    }
  ...
  '../node_modules/@webcontainer/api/dist/index.js'() {
    ...
    _WebContainer = class _WebContainer {
      ...
      constructor(_instance, fs, previewScript, _runtimeInfo) {
        ...
        if (authState.initialized) {
          this._unsubscribeFromTokenChangedListener = addAccessTokenChangedListener(
            (accessToken) => {
...
Set the 'coep' option to 'require-corp'.`)
        ...
        if (
          (workdirName == null ? void 0 : workdirName.includes('/')) ||
          workdirName === '..' ||
          workdirName === '.'
        ) {
...
var useZIndex = (zIndexOverrides) => {
  ...
  const initialZIndex = computed(() => {
    ...
    return (_a5 = override != null ? override : unref2(injectedZIndex)) != null
      ? _a5
...
var useLocale = (localeOverrides) => {
  ...
  const locale = computed5(() => {
    var _a5, _b
    return (_b = (_a5 = unref4(localeOverrides)) != null ? _a5 : unref4(globalLocale)) != null
      ? _b
      : zhCn
  })
...
var getStyle = (element, styleName) => {
  ...
  try {
    ...
    const computed22 =
      (_a5 = document.defaultView) == null ? void 0 : _a5.getComputedStyle(element, '')
    ...
    _createElementBlock2(
      ...
      [
        ...
        $setup.useIconComponent
          ? (_openBlock2(),
            _createBlock2(_resolveDynamicComponent2(_ctx.icon), {
              key: 0,
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const initViewerJS = () => {
        ...
        viewerList = list2
        const nextViewer = new stdin_default4(
          list2,
          __spreadProps2(__spreadValues5({}, props.viewerOptions), {
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    _createElementBlock4(
      ...
      [
        $setup.isLoading
          ? _renderSlot3(_ctx.$slots, 'placeholder', { key: 0 }, () => [
          ...
          : $setup.error
            ? _renderSlot3(_ctx.$slots, 'error', { key: 1 }, () => [
                _createElementVNode3(
                  'div',
                  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const initViewerJS = () => {
        ...
        if (props.previewSrcList && props.previewSrcList.length > 0) {
          ...
          const nextViewer = new stdin_default4(
            list2,
            __spreadProps3(__spreadValues6({}, props.viewerOptions), {
              hidden: () => {
                if (viewerList) {
                  document.body.removeChild(viewerList)
                  viewerList = null
...
import {
  ...
  resolveDynamicComponent as _resolveDynamicComponent3,
              ...
              [
                _renderSlot4(_ctx.$slots, 'prefix', {}, () => [
                  $props.prefixIcon && typeof $props.prefixIcon !== 'string'
                    ? (_openBlock5(),
                      _createBlock5(
                        _resolveDynamicComponent3($props.prefixIcon),
                        {
                          key: 0,
              ...
              [
                ...
                _renderSlot4(_ctx.$slots, 'suffix', {}, () => [
                  $props.suffixIcon && typeof $props.suffixIcon !== 'string'
                    ? (_openBlock5(),
                      _createBlock5(
                        _resolveDynamicComponent3($props.suffixIcon),
                        {
                          key: 0,
                          class: _normalizeClass4($setup.ns.e('icon'))
                        },
                    ...
                    _createElementVNode4(
                      'div',
                      {
                        ...
                        style: _normalizeStyle4(
                          $props.teleported
                            ? __spreadValues7(
                                __spreadValues7({}, $setup.themeStyle),
                                $setup.dropdownStyle
                              )
                            : $setup.themeStyle
                        ),
...
var __sfc__5 = /* @__PURE__ */ Object.assign(
  { name: 'YhMention' },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const mentionDisabled = computed15(
      ...
      const filteredOptions = computed15(() => {
        var _a5, _b
        const keyword =
          (_b = (_a5 = triggerPos.value) == null ? void 0 : _a5.keyword) != null ? _b : ''
      ...
      const handleOutsideClick = (e) => {
        ...
        if (
          ((_a5 = wrapperRef.value) == null ? void 0 : _a5.contains(target)) ||
  ...
  return (
    ...
    _createElementBlock6(
      ...
      [
        _createVNode2(
          $setup['YhMention'],
          _mergeProps2({ ref: 'mentionRef' }, _ctx.$attrs, {
            ...
            for (const node of nodes) {
              if (node.label.toLowerCase().includes(keyword.toLowerCase())) {
                ...
                if (filteredChildren.length > 0) {
                  result.push(
                    __spreadProps4(__spreadValues8({}, node), { children: filteredChildren })
                  )
                }
              }
            }
  ...
  return (
    ...
    _createElementBlock7(
      ...
      [
        ...
        _createVNode3(
          _Transition3,
          { name: 'yh-zoom-in-bottom' },
          {
            default: _withCtx4(() => [
              $setup.showCommands && $setup.filteredCommands.length > 0
                ? (_openBlock7(),
                  _createElementBlock7(
                    'div',
                    {
                            ...
                            _createElementBlock7(
                              'div',
                              {
                                ...
                                class: _normalizeClass6([
                                  ...
                                  $setup.ns.is('active', index === $setup.selectedCommandIndex)
                                ]),
        ...
        _createElementVNode6(
          ...
          [
            ...
            _ctx.attachments && _ctx.attachments.length > 0
              ? (_openBlock7(),
                _createElementBlock7(
                  'div',
                  {
                        ...
                        return (
                          ...
                          _createElementBlock7(
                            'div',
                            {
                              key: file.id,
                              class: _normalizeClass6([
                                $setup.ns.e('attachment-item'),
                                $setup.ns.is(file.status || 'success')
                              ])
                            },
                            [
                              _createElementVNode6(
                                  ...
                                  file.type.startsWith('image/')
                                    ? (_openBlock7(),
                                      _createBlock7(
                                        ...
                                        null,
                                        8,
                                        ['src', 'alt', 'preview-src-list']
                                      ))
                                    : (_openBlock7(),
                                      _createBlock7($setup['YhIcon'], {
                                        key: 1,
                                        name: 'document'
                                      }))
                                ],
                                    ...
                                    ? (_openBlock7(),
                                      _createElementBlock7(
                                        'div',
                                        {
                                          key: 0,
                                          class: _normalizeClass6(
                                            $setup.ns.e('attachment-progress')
                                          )
                                        },
                                        [
                                          _createElementVNode6(
              ...
              [
                _createVNode3(
                  $setup['YhAiMention'],
                  {
                    ...
                    placeholder:
                      _ctx.placeholder === 'Send a message...'
                        ? $setup.t('ai.sender.placeholder')
                        : _ctx.placeholder,
                  ...
                  null,
                  8,
                  ['modelValue', 'class', 'placeholder', 'disabled', 'max-length', 'options']
                )
              ],
              2
              /* CLASS */
                ...
                _ctx.showWordLimit && _ctx.maxLength
                  ? (_openBlock7(),
                    _createElementBlock7(
                      ...
                      _toDisplayString4($setup.innerValue.length) +
                        ' / ' +
                        _toDisplayString4(_ctx.maxLength),
                      3
                      /* TEXT, CLASS */
                    ))
                  : _createCommentVNode7('v-if', true)
            ...
            _createElementVNode6(
              ...
              [
                ...
                _ctx.clearable && $setup.innerValue.length > 0
                  ? (_openBlock7(),
                    _createBlock7(
                      $setup['YhButton'],
                      {
                      ...
                      {
                        icon: _withCtx4(() => [_createVNode3($setup['YhIcon'], { name: 'clean' })]),
                        _: 1
                        /* STABLE */
                      },
                      8,
                ...
                _renderSlot6(
                  ...
                  {
                    disabled:
                      !((_a5 = $setup.innerValue) == null ? void 0 : _a5.trim()) || _ctx.disabled,
                  ...
                  () => {
                    ...
                    return [
                      _createVNode3(
                        ...
                        {
                          type:
                            ((_a22 = $setup.innerValue) == null ? void 0 : _a22.trim()) &&
                            !_ctx.disabled &&
                            !_ctx.loading
                              ? 'primary'
                              : 'default',
                          ...
                          disabled:
                            !((_b = $setup.innerValue) == null ? void 0 : _b.trim()) ||
                            _ctx.disabled,
                          loading: _ctx.loading,
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const filteredCommands = computed17(() => {
        ...
        return props.commands.filter(
          (cmd) =>
            cmd.key.toLowerCase().includes(search) || cmd.label.toLowerCase().includes(search)
        )
      })
      const autoResize = () => {
        var _a22
      ...
      const handleKeyDown = (e) => {
        ...
        if (e.key === 'Enter' && !e.shiftKey) {
          if (
            !((_a22 = innerValue.value) == null ? void 0 : _a22.trim()) ||
            props.loading ||
            props.disabled
          ) {
            e.preventDefault()
...
var __defNormalProp9 = (obj, key, value) =>
  key in obj
    ? __defProp9(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues9 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp9.call(b, prop)) __defNormalProp9(a, prop, b[prop])
            ...
            ? (_openBlock8(),
              _createElementBlock8(
                ...
                [
                  ...
                  (_openBlock8(),
                  _createBlock8(
                    _resolveDynamicComponent4($props.icon),
                    {
...
var __sfc__8 = /* @__PURE__ */ Object.assign(
  { name: 'YhAvatar' },
  {
    __name: 'avatar',
    props: {
...
function isHexadecimalCharacter(code2) {
  return (
    (code2 >= CharCodes.UPPER_A && code2 <= CharCodes.UPPER_F) ||
    (code2 >= CharCodes.LOWER_A && code2 <= CharCodes.LOWER_F)
  )
}
function isAsciiAlphaNumeric(code2) {
  return (
    (code2 >= CharCodes.UPPER_A && code2 <= CharCodes.UPPER_Z) ||
    (code2 >= CharCodes.LOWER_A && code2 <= CharCodes.LOWER_Z) ||
    isNumber(code2)
  )
}
...
var _a4
var MarkdownIt2 =
  'default' in markdown_it_exports
    ? (_a4 = lib_default) != null
      ? _a4
      : markdown_it_exports
    : markdown_it_exports
    ...
    _createElementBlock9(
      'div',
      {
        class: _normalizeClass8([
          ...
          $setup.ns.is(
            'thinking',
            $setup.currentStatus === 'thinking' || $setup.currentStatus === 'loading'
          ),
          $setup.ns.is('timeline', $setup.itemsToUse && $setup.itemsToUse.length > 0),
          $setup.ns.is('draggable', _ctx.draggable),
          _ctx.className
        ]),
      ...
      [
        ...
        _ctx.showProgress && $setup.itemsToUse && $setup.itemsToUse.length > 0
          ? (_openBlock9(),
            _createElementBlock9(
              'div',
              {
        ...
        $setup.itemsToUse && $setup.itemsToUse.length > 0
          ? (_openBlock9(),
            _createElementBlock9(
              _Fragment7,
              { key: 1 },
                    ...
                    return (
                      ...
                      _createElementBlock9(
                        'div',
                        {
                          ...
                          class: _normalizeClass8([
                            $setup.ns.e('item'),
                            $setup.ns.is('last', index === _ctx.items.length - 1),
                            $setup.ns.is(
                              'active',
                              item.status === 'thinking' || item.status === 'loading'
                            ),
                            $setup.ns.is('drag-over', $setup.dragOverIndex === index),
                            $setup.ns.is('dragging', $setup.draggedIndex === index)
                          ]),
                            ...
                            [
                              _createElementVNode8(
                                'div',
                                {
                                  class: _normalizeClass8([
                                    $setup.ns.e('item-dot'),
                                    $setup.ns.m(_ctx.dotSize),
                                    $setup.ns.m(item.status || 'none')
                                  ])
                                },
                                [
                                  _createVNode4(
                          ...
                          _createElementVNode8(
                            ...
                            [
                                        ...
                                        [
                                          _createVNode4(
                                            $setup['YhIcon'],
                                            {
                                              ...
                                              onClick: ($event) =>
                                                $setup.handleDeleteNode(item, index)
                                            },
                                            null,
                                            8,
                                            ['class', 'onClick']
                              ...
                              _createVNode4(
                                ...
                                {
                                  default: _withCtx5(() => [
                                    $setup.itemExpandedStates[index] &&
                                    (item.content || item.description)
                                      ? (_openBlock9(),
                                        _createElementBlock9(
                                          'div',
                                              ...
                                              ? (_openBlock9(),
                                                _createElementBlock9(
                                                  'div',
                                                  {
                                                    key: 0,
                                                    class: _normalizeClass8(
                                                      $setup.ns.e('item-text')
                                                    ),
                                                    innerHTML: $setup.renderMarkdown(
                                                      item.content || item.description || ''
                                                    )
                                                  },
                                                  null,
                  ...
                  ? (_openBlock9(),
                    _createElementBlock9(
                      'div',
                      {
                        ...
                        onClick:
                          _cache[1] ||
                          (_cache[1] = ($event) => $setup.handleAddNode(_ctx.items.length))
                      },
                      [
                        ...
                        _createVNode4(
                          $setup['YhIcon'],
                          {
                            ...
                            class: _normalizeClass8([
                              ...
                              {
                                'is-loading':
                                  $setup.currentStatus === 'thinking' ||
                                  $setup.currentStatus === 'loading'
                              }
                            ])
                          },
                          null,
...
var __defNormalProp10 = (obj, key, value) =>
  key in obj
    ? __defProp11(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues10 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp10.call(b, prop)) __defNormalProp10(a, prop, b[prop])
  ...
  return (
    ...
    _createElementBlock10(
      ...
      [
                                              ...
                                              _createElementVNode9('table', null, [
                                                _createElementVNode9('thead', null, [
                                                  ...
                                                  _ctx.structuredData.data.headers
                                                    ? (_openBlock10(),
                                                      _createElementBlock10('tr', _hoisted_53, [
                                                        (_openBlock10(true),
                                                        _createElementBlock10(
                                                          _Fragment8,
                                                          null,
                                                ...
                                                typeof _ctx.structuredData.data === 'object'
                                                  ? (_openBlock10(),
                                                    _createElementBlock10('tbody', _hoisted_62, [
                                                      (_openBlock10(true),
                                                      _createElementBlock10(
                                                        _Fragment8,
                                                        null,
        ...
        (_openBlock10(),
        _createBlock10(_Teleport4, { to: 'body' }, [
          _createVNode5(
            _Transition5,
            { name: 'yh-fade-in-scale-up' },
            {
  ...
  },
  {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const initWebContainer = async () => {
        ...
        try {
          const { WebContainer: WebContainer2 } = await Promise.resolve().then(
            () => (init_dist(), dist_exports)
          )
        ...
        if (props.onRunCode) {
          try {
            ...
            if (result && Symbol.asyncIterator in result) {
              ...
              try {
                for (
                  var iter = __forAwait(asyncResult), more, temp, error2;
  ...
  `
      ...
      const handleCitationHover = (e) => {
        ...
        if (target && target.classList && target.classList.contains('yh-ai-citation')) {
          ...
          const citation =
            (_a5 = props.citations) == null ? void 0 : _a5.find((c) => String(c.id) === id)
          if (citation) {
        ...
        const md = new stdin_default11({
          ...
          highlight: function (str, lang) {
            ...
            if (hlLang && stdin_default13.getLanguage(hlLang)) {
              try {
                result = stdin_default13.highlight(str, {
                  language: hlLang,
                  ignoreIllegals: true
                }).value
              } catch (e) {}
      ...
      const __returned__ = {
        ...
        watchEffect,
        shallowRef: shallowRef3,
        watch: watch9,
        onMounted: onMounted6,
        nextTick: nextTick3,
        get aiBubbleProps() {
        ...
        _createElementVNode10(
          ...
          [
            ...
            (!$setup.props.messages.length ||
              ...
              ? _renderSlot10(_ctx.$slots, 'loading', { key: 3 }, () => [
...
var __sfc__11 = /* @__PURE__ */ Object.assign(
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const virtualScrollEnabled = computed21(
        () => props.virtualScroll && props.messages.length > 50
      )
      ...
      const __returned__ = {
        ...
        nextTick: nextTick4,
        computed: computed21,
        YhAiSender: stdin_default9,
        YhAiBubble: stdin_default14,
        get YhButton() {
          return YhButton
        },
        get YhIcon() {
...
export { stdin_default15 as default }
