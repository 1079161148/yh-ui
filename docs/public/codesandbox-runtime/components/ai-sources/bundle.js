...
// public/codesandbox-runtime/components/ai-sources/src/ai-sources.js
import { createCommentVNode as _createCommentVNode4, renderList as _renderList, Fragment as _Fragment3, openBlock as _openBlock4, createElementBlock as _createElementBlock4, createBlock as _createBlock4, toDisplayString as _toDisplayString3, createTextVNode as _createTextVNode2, normalizeClass as _normalizeClass3, createElementVNode as _createElementVNode3, createVNode as _createVNode3, withCtx as _withCtx3, normalizeStyle as _normalizeStyle3, withModifiers as _withModifiers2, renderSlot as _renderSlot4 } from "vue";
...
// public/codesandbox-runtime/components/ai-sources/src/ai-sources.js
import { ref as ref14, computed as computed14 } from "vue";

// public/codesandbox-runtime/components/ai-sources/src/ai-sources-meta.js
var aiSourcesProps = {
  /**
   * @description 引用来源列表
   */
...
var YhTooltip = withInstall(stdin_default4);

// public/codesandbox-runtime/components/drawer/src/drawer.js
import { createCommentVNode as _createCommentVNode3, normalizeClass as _normalizeClass2, openBlock as _openBlock3, createElementBlock as _createElementBlock3, renderSlot as _renderSlot3, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode, Fragment as _Fragment2, resolveDynamicComponent as _resolveDynamicComponent2, createBlock as _createBlock3, createElementVNode as _createElementVNode2, createVNode as _createVNode2, normalizeStyle as _normalizeStyle2, vShow as _vShow2, withModifiers as _withModifiers, withDirectives as _withDirectives2, Transition as _Transition2, withCtx as _withCtx2, Teleport as _Teleport2 } from "vue";
import { ref as ref13, computed as computed13, watch as watch5, onMounted as onMounted4, onBeforeUnmount as onBeforeUnmount2, nextTick as nextTick2 } from "vue";
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock3(), _createBlock3(_Teleport2, {
    to: _ctx.teleportTo,
    ...
    _createVNode2(_Transition2, {
      ...
      default: _withCtx2(() => [
        $setup.rendered ? _withDirectives2((_openBlock3(), _createElementBlock3(
          "div",
          {
            key: 0,
            class: _normalizeClass2([$setup.ns.e("wrapper"), _ctx.modalClass, {
          ...
          [
            _withDirectives2(_createElementVNode2(
              ...
              {
                ref: "drawerRef",
                class: _normalizeClass2([$setup.ns.b(), $setup.ns.m(_ctx.placement), {
                ...
                style: _normalizeStyle2([$setup.drawerStyles, {
              ...
              [
                _createCommentVNode3(" Resizable Handle "),
                _ctx.resizable ? (_openBlock3(), _createElementBlock3(
                  "div",
                  {
                    key: 0,
                    class: _normalizeClass2([$setup.ns.e("handle"), $setup.ns.em("handle", _ctx.placement)]),
                ...
                _ctx.showHeader ? (_openBlock3(), _createElementBlock3(
                  "div",
                  {
                    ...
                    style: _normalizeStyle2(_ctx.titleStyle)
                  },
                  [
                    _renderSlot3(_ctx.$slots, "header", {}, () => [
                      _createElementVNode2(
                        ...
                        [
                          typeof _ctx.title === "string" ? (_openBlock3(), _createElementBlock3(
                            _Fragment2,
                            { key: 0 },
                            [
                              _createTextVNode(
                            ...
                            64
                            /* STABLE_FRAGMENT */
                          )) : _ctx.title ? (_openBlock3(), _createBlock3(_resolveDynamicComponent2(_ctx.title), { key: 1 })) : _renderSlot3(_ctx.$slots, "title", { key: 2 })
                        ],
                        2
                        /* CLASS */
                      )
                    ]),
                    _ctx.showClose ? (_openBlock3(), _createElementBlock3("button", {
                      key: 0,
                      type: "button",
                      class: _normalizeClass2($setup.ns.e("close")),
                      "aria-label": $setup.t("dialog.close"),
                      onClick: _cache[0] || (_cache[0] = ($event) => $setup.handleClose())
                    }, [
                      _renderSlot3(_ctx.$slots, "close-icon", {}, () => [
                ...
                _createElementVNode2(
                  "div",
                  {
                    ...
                    style: _normalizeStyle2(_ctx.contentStyle)
                  },
                  [
                ...
                _ctx.showFooter ? (_openBlock3(), _createElementBlock3(
                  "div",
                  {
                    key: 2,
                    class: _normalizeClass2($setup.ns.e("footer")),
                    style: _normalizeStyle2(_ctx.footerStyle)
                  },
                  [
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const drawerRef = ref13(null);
    const rendered = ref13(false);
    const drawerZIndex = ref13(props.zIndex || nextZIndex());
    const currentSize = ref13(props.size);
    ...
    const isHorizontal = computed13(() => ["left", "right"].includes(props.placement));
    const drawerStyles = computed13(() => {
      const baseStyle = typeof props.drawerStyle === "object" ? props.drawerStyle : {};
      const styles = __spreadValues4(__spreadValues4({}, themeStyle.value), baseStyle);
    ...
    useScrollLock(computed13(() => props.modelValue && props.lockScroll));
    watch5(
      () => props.modelValue,
      (val) => {
        if (val) {
    ...
    const __returned__ = { props, emit, ns, t, nextZIndex, themeStyle, drawerRef, rendered, drawerZIndex, currentSize, titleId, bodyId, isHorizontal, drawerStyles, handleClose, onAfterLeave, get startPos() {
      ...
      startSize = v;
    }, handleResizeStart, handleResizeMove, handleResizeEnd, handleKeyDown, ref: ref13, computed: computed13, watch: watch5, onMounted: onMounted4, onBeforeUnmount: onBeforeUnmount2, nextTick: nextTick2, get drawerProps() {
      return drawerProps;
    }, get drawerEmits() {
      return drawerEmits;
    }, get YhIcon() {
...
// public/codesandbox-runtime/components/drawer/index.js
var YhDrawer = withInstall(stdin_default5);
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createElementBlock4(
    "div",
    {
      class: _normalizeClass3([$setup.ns.b(), $setup.ns.m(_ctx.mode)]),
      style: _normalizeStyle3($setup.themeStyle)
    },
    [
      _createCommentVNode4(" \u2500\u2500 badge \u6A21\u5F0F\uFF1A\u4EC5\u663E\u793A\u89D2\u6807 \u2500\u2500 "),
      _ctx.mode === "badge" ? (_openBlock4(), _createElementBlock4(
        _Fragment3,
        { key: 0 },
        [
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass3($setup.ns.e("badge-row"))
            },
            [
              (_openBlock4(true), _createElementBlock4(
                ...
                _renderList(_ctx.sources, (source) => {
                  return _openBlock4(), _createBlock4(
                    $setup["YhTooltip"],
                    {
                      key: source.id,
                      placement: "top",
                    ...
                    },
                    {
                      content: _withCtx3(() => [
                        _createElementVNode3(
                          "div",
                          {
                            class: _normalizeClass3($setup.ns.e("tooltip-content"))
                          },
                          [
                            _createElementVNode3(
                              "div",
                              {
                                class: _normalizeClass3($setup.ns.e("tooltip-header"))
                              },
                              [
                                _createElementVNode3(
                                  "div",
                                  {
                                    class: _normalizeClass3($setup.ns.e("tooltip-title-wrap"))
                                  },
                                  [
                                    ...
                                    _createElementVNode3(
                                      "span",
                                      {
                                        class: _normalizeClass3($setup.ns.e("tooltip-title"))
                                      },
                                      _toDisplayString3(source.title),
                                      3
                                      /* TEXT, CLASS */
                                    )
                                  ],
                            ...
                            source.excerpt ? (_openBlock4(), _createElementBlock4(
                              "p",
                              {
                                key: 0,
                                class: _normalizeClass3($setup.ns.e("tooltip-excerpt"))
                              },
                              _toDisplayString3(source.excerpt),
                              3
                              /* TEXT, CLASS */
                            )) : _createCommentVNode4("v-if", true),
                            source.source ? (_openBlock4(), _createElementBlock4(
                              "div",
                              {
                                key: 1,
                                class: _normalizeClass3($setup.ns.e("tooltip-source"))
                              },
                              [
                                _createVNode3($setup["YhIcon"], { name: "globe" }),
                                _createTextVNode2(
                                  " " + _toDisplayString3(source.source),
                                  1
                                  /* TEXT */
                                )
                              ],
                      ...
                      default: _withCtx3(() => [
                        _createElementVNode3("button", {
                          class: _normalizeClass3($setup.ns.e("badge")),
                          onClick: ($event) => $setup.openDrawer(source)
                        }, [
                          _ctx.showFileType ? (_openBlock4(), _createBlock4($setup["YhIcon"], {
                            key: 0,
                            name: $setup.getFileIcon(source.fileType)
                          }, null, 8, ["name"])) : _createCommentVNode4("v-if", true),
                          _createTextVNode2(
                            " " + _toDisplayString3(source.id),
                            1
                            /* TEXT */
                          )
                        ], 10, _hoisted_14)
          ...
          _createCommentVNode4(" \u62BD\u5C49\uFF1A\u6765\u6E90\u8BE6\u60C5 "),
          _createVNode3($setup["YhDrawer"], {
            modelValue: $setup.drawerVisible,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.drawerVisible = $event),
            ...
            title: _withCtx3(() => [
              _createElementVNode3(
                "div",
                {
                  class: _normalizeClass3($setup.ns.e("drawer-title-wrap"))
                },
                [
                  _createVNode3($setup["YhIcon"], { name: "document" }),
                  _createElementVNode3(
                    "span",
                    null,
                    _toDisplayString3($setup.t("ai.sources.drawerTitle")),
                    1
                    /* TEXT */
                  )
                ],
            ...
            default: _withCtx3(() => [
              _createElementVNode3(
                "div",
                {
                  class: _normalizeClass3($setup.ns.e("drawer-content"))
                },
                [
                  (_openBlock4(true), _createElementBlock4(
                    _Fragment3,
                    ...
                    _renderList(_ctx.sources, (source) => {
                      ...
                      return _openBlock4(), _createElementBlock4("div", {
                        ...
                        class: _normalizeClass3([$setup.ns.e("source-card"), $setup.ns.is("active", ((_a2 = $setup.activeSource) == null ? void 0 : _a2.id) === source.id), $setup.ns.is("highlighted", $setup.highlightedSourceId === source.id)]),
                        onClick: ($event) => $setup.handleClick(source)
                      }, [
                        _createElementVNode3(
                          "div",
                          {
                            class: _normalizeClass3($setup.ns.e("card-header"))
                          },
                          [
                            _createElementVNode3(
                              "div",
                              {
                                class: _normalizeClass3($setup.ns.e("card-title-row"))
                              },
                              [
                                _createVNode3($setup["YhIcon"], {
                                  name: $setup.getFileIcon(source.fileType),
                                  class: _normalizeClass3($setup.ns.e("file-icon"))
                                }, null, 8, ["name", "class"]),
                                _createElementVNode3(
                                  "span",
                                  {
                                    class: _normalizeClass3($setup.ns.e("card-title"))
                                  },
                                  _toDisplayString3(source.title),
                                  3
                                  /* TEXT, CLASS */
                            ...
                            _createElementVNode3(
                              "div",
                              {
                                class: _normalizeClass3($setup.ns.e("card-meta"))
                              },
                              [
                                source.source ? (_openBlock4(), _createElementBlock4(
                                  "span",
                                  {
                                    key: 0,
                                    class: _normalizeClass3($setup.ns.e("source-name"))
                                  },
                                  _toDisplayString3(source.source),
                                  3
                                  /* TEXT, CLASS */
                                )) : _createCommentVNode4("v-if", true),
                                _ctx.showScore && source.score !== void 0 ? (_openBlock4(), _createElementBlock4(
                                  "span",
                                  {
                                    key: 1,
                                    class: _normalizeClass3($setup.ns.e("score-badge")),
                                    style: _normalizeStyle3({
                                      color: $setup.scoreColor(source.score)
                                    })
                                  },
                                  _toDisplayString3(Math.round(source.score * 100)) + "% " + _toDisplayString3($setup.t("ai.sources.relevant")),
                                  7
                                  /* TEXT, CLASS, STYLE */
                                )) : _createCommentVNode4("v-if", true)
                              ],
                        ...
                        source.excerpt ? (_openBlock4(), _createElementBlock4(
                          ...
                          {
                            key: 0,
                            class: _normalizeClass3($setup.ns.e("excerpt"))
                          },
                          _toDisplayString3(source.excerpt),
                          3
                          /* TEXT, CLASS */
                        )) : _createCommentVNode4("v-if", true),
                        source.url ? (_openBlock4(), _createElementBlock4("button", {
                          key: 1,
                          class: _normalizeClass3($setup.ns.e("open-btn")),
                          onClick: ($event) => $setup.handleOpen($event, source)
                        }, [
                          _createVNode3($setup["YhIcon"], { name: "arrow-right" }),
                          _createTextVNode2(
                            " " + _toDisplayString3($setup.t("ai.sources.viewOriginal")),
                            1
                            /* TEXT */
                          )
                        ], 10, _hoisted_32)) : _createCommentVNode4("v-if", true)
                      ], 10, _hoisted_22);
                    }),
                    128
                    /* KEYED_FRAGMENT */
            ...
            _: 1
            /* STABLE */
          }, 8, ["modelValue", "title", "theme-overrides"])
        ],
        64
        /* STABLE_FRAGMENT */
      )) : _ctx.mode === "inline" ? (_openBlock4(), _createElementBlock4(
        _Fragment3,
        { key: 1 },
        [
          _createCommentVNode4(" \u2500\u2500 inline \u6A21\u5F0F\uFF1A\u5185\u8054\u6C14\u6CE1\u5217\u8868 \u2500\u2500 "),
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass3($setup.ns.e("inline-header"))
            },
            [
              _createVNode3($setup["YhIcon"], { name: "document" }),
              _createElementVNode3(
                "span",
                null,
                _toDisplayString3(_ctx.sources.length) + " " + _toDisplayString3($setup.t("ai.sources.references")),
                1
                /* TEXT */
              )
            ],
          ...
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass3($setup.ns.e("inline-list"))
            },
            [
              (_openBlock4(true), _createElementBlock4(
                _Fragment3,
                ...
                _renderList($setup.visibleSources, (source) => {
                  return _openBlock4(), _createBlock4($setup["YhTooltip"], {
                    key: source.id,
                    placement: "top",
                    effect: "light",
                          ...
                          _createElementVNode3(
                            ...
                            [
                              ...
                              _ctx.showScore && source.score !== void 0 ? (_openBlock4(), _createElementBlock4(
                                ...
                                {
                                  key: 0,
                                  class: _normalizeClass3($setup.ns.e("tooltip-score")),
                                  style: _normalizeStyle3({
                                    color: $setup.scoreColor(source.score)
                                  })
                                },
                                _toDisplayString3(Math.round(source.score * 100)) + "% ",
                                7
                                /* TEXT, CLASS, STYLE */
                              )) : _createCommentVNode4("v-if", true)
                            ],
                    ...
                    default: _withCtx3(() => [
                      _createElementVNode3("div", {
                        class: _normalizeClass3([$setup.ns.e("inline-item"), $setup.ns.is("highlighted", $setup.highlightedSourceId === source.id)]),
                        ref_for: true,
                        ref: (el) => $setup.sourceRefs[source.id] = el,
                        onClick: ($event) => $setup.handleClick(source)
                      }, [
                        _createElementVNode3(
                          "span",
                          {
                            class: _normalizeClass3($setup.ns.e("inline-index"))
                          },
                          _toDisplayString3(source.id),
                          3
                          /* TEXT, CLASS */
                        ...
                        _createElementVNode3(
                          "span",
                          {
                            class: _normalizeClass3($setup.ns.e("inline-title"))
                          },
                          _toDisplayString3(source.title),
                          3
                          /* TEXT, CLASS */
                        ...
                        _ctx.showScore && source.score !== void 0 ? (_openBlock4(), _createElementBlock4(
                          ...
                          {
                            key: 1,
                            class: _normalizeClass3($setup.ns.e("inline-score")),
                            style: _normalizeStyle3({
                              color: $setup.scoreColor(source.score)
                            })
                          },
                        ...
                        source.url ? (_openBlock4(), _createElementBlock4("button", {
                          key: 2,
                          class: _normalizeClass3($setup.ns.e("inline-open")),
                          onClick: _withModifiers2(($event) => $setup.handleOpen($event, source), ["stop"])
                        }, [
                          _createVNode3($setup["YhIcon"], { name: "launch" })
                        ], 10, _hoisted_5)) : _createCommentVNode4("v-if", true)
                      ], 10, _hoisted_4)
                    ]),
                    _: 2
                    /* DYNAMIC */
              ...
              _createCommentVNode4(" \u5C55\u5F00\u66F4\u591A "),
              !$setup.isExpanded && _ctx.sources.length > _ctx.maxVisible ? (_openBlock4(), _createElementBlock4(
                "button",
                {
                  key: 0,
                  class: _normalizeClass3($setup.ns.e("expand-btn")),
                  onClick: _cache[1] || (_cache[1] = ($event) => $setup.isExpanded = true)
                },
                [
                  _createTextVNode2(
                    " +" + _toDisplayString3(_ctx.sources.length - _ctx.maxVisible) + " " + _toDisplayString3($setup.t("ai.sources.more")) + " ",
                    1
                    /* TEXT */
                  ),
                  _createVNode3($setup["YhIcon"], { name: "arrow-down" })
                ],
                2
                /* CLASS */
              )) : _createCommentVNode4("v-if", true)
        ...
        { key: 2 },
        [
          _createCommentVNode4(" \u2500\u2500 card \u6A21\u5F0F\uFF1A\u5B8C\u6574\u5361\u7247\u5217\u8868 \u2500\u2500 "),
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass3($setup.ns.e("card-list-header"))
            },
            [
              _createVNode3($setup["YhIcon"], { name: "document" }),
              _createElementVNode3(
                "span",
                null,
                _toDisplayString3($setup.t("ai.sources.referencedSources")),
                1
                /* TEXT */
              ),
              _createElementVNode3(
                "span",
                {
                  class: _normalizeClass3($setup.ns.e("count-badge"))
                },
                _toDisplayString3(_ctx.sources.length),
                3
                /* TEXT, CLASS */
              )
            ],
          ...
          _createElementVNode3(
            "div",
            {
              class: _normalizeClass3($setup.ns.e("card-list"))
            },
            [
              (_openBlock4(true), _createElementBlock4(
                _Fragment3,
                ...
                _renderList($setup.visibleSources, (source) => {
                  return _openBlock4(), _createElementBlock4("div", {
                    ...
                    ref_for: true,
                    ref: (el) => $setup.sourceRefs[source.id] = el,
                    class: _normalizeClass3([$setup.ns.e("source-card"), $setup.ns.is("highlighted", $setup.highlightedSourceId === source.id)]),
                    onClick: ($event) => $setup.handleClick(source)
                  }, [
                    _createElementVNode3(
                      "div",
                    ...
                    ], 10, _hoisted_7)) : _createCommentVNode4("v-if", true)
                  ], 10, _hoisted_6);
                }),
                128
                /* KEYED_FRAGMENT */
              ...
              !$setup.isExpanded && _ctx.sources.length > _ctx.maxVisible ? (_openBlock4(), _createElementBlock4(
                "button",
                {
                  key: 0,
                  class: _normalizeClass3($setup.ns.e("expand-btn")),
                  onClick: _cache[2] || (_cache[2] = ($event) => $setup.isExpanded = true)
                },
                [
                  _createTextVNode2(
                    _toDisplayString3($setup.t("ai.sources.showAll")) + " (" + _toDisplayString3(_ctx.sources.length) + ") ",
                    1
                    /* TEXT */
                  ),
                  _createVNode3($setup["YhIcon"], { name: "arrow-down" })
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const drawerVisible = ref14(false);
    const activeSource = ref14(null);
    const highlightedSourceId = ref14(null);
    const sourceRefs = ref14({});
    const fileTypeIcons = {
      web: "globe",
      pdf: "file-pdf",
      doc: "file-word",
    ...
    const getFileIcon = (type) => {
      var _a2;
      return (_a2 = fileTypeIcons[type != null ? type : "default"]) != null ? _a2 : fileTypeIcons.default;
    };
    ...
    const visibleSources = computed14(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isExpanded, drawerVisible, activeSource, highlightedSourceId, sourceRefs, fileTypeIcons, getFileIcon, scoreColor, visibleSources, handleClick, handleOpen, openDrawer, scrollToSource, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    }, ref: ref14, computed: computed14, get aiSourcesProps() {
