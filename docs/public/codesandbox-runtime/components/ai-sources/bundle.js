                                ...
                                ? (_openBlock3(),
                                  _createElementBlock3(
                                    'div',
                                    {
                                      ...
                                      class: _normalizeClass2([
                                        $setup.ns.e('handle'),
                                        $setup.ns.em('handle', _ctx.placement)
                                      ]),
                                          ...
                                          [
                                            typeof _ctx.title === 'string'
                                              ...
                                              : _ctx.title
                                                ? (_openBlock3(),
                                                  _createBlock3(
                                                    _resolveDynamicComponent2(_ctx.title),
                                                    { key: 1 }
                                                  ))
                                                : _renderSlot3(_ctx.$slots, 'title', { key: 2 })
                                          ],
                                          2
                                          /* CLASS */
                                        )
                                        ...
                                        ? (_openBlock3(),
                                          _createElementBlock3(
                                            'button',
                                            {
                                              ...
                                              onClick:
                                                _cache[0] ||
                                                (_cache[0] = ($event) => $setup.handleClose())
                                            },
                                            [
                                ...
                                _createElementBlock4(
                                  'div',
                                  {
                                    ...
                                    class: _normalizeClass3([
                                      ...
                                      $setup.ns.is(
                                        'active',
                                        ((_a2 = $setup.activeSource) == null ? void 0 : _a2.id) ===
                                          source.id
                                      ),
                                      $setup.ns.is(
                                        'highlighted',
                    ...
                    [
                      ...
                      _createElementVNode3(
                        ...
                        _toDisplayString3(_ctx.sources.length) +
                          ' ' +
                          _toDisplayString3($setup.t('ai.sources.references')),
                        1
                        /* TEXT */
                      )
                    ],
                        ...
                        ? (_openBlock4(),
                          _createElementBlock4(
                            ...
                            [
                              _createTextVNode2(
                                ' +' +
                                  _toDisplayString3(_ctx.sources.length - _ctx.maxVisible) +
                                  ' ' +
                                  _toDisplayString3($setup.t('ai.sources.more')) +
                                  ' ',
                                1
                                /* TEXT */
                              ),
                                        ...
                                        _ctx.showScore && source.score !== void 0
                                          ? (_openBlock4(),
                                            _createElementBlock4(
                                              ...
                                              _toDisplayString3(Math.round(source.score * 100)) +
                                                '% ' +
                                                _toDisplayString3($setup.t('ai.sources.relevant')),
                                              7
                                              /* TEXT, CLASS, STYLE */
                                            ))
                                          : _createCommentVNode4('v-if', true)
                      ...
                      !$setup.isExpanded && _ctx.sources.length > _ctx.maxVisible
                        ? (_openBlock4(),
                          _createElementBlock4(
                            ...
                            [
                              _createTextVNode2(
                                _toDisplayString3($setup.t('ai.sources.showAll')) +
                                  ' (' +
                                  _toDisplayString3(_ctx.sources.length) +
                                  ') ',
                                1
  ...
  },
  {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const getFileIcon = (type) => {
        var _a2
        return (_a2 = fileTypeIcons[type != null ? type : 'default']) != null
          ? _a2
...
export { stdin_default5 as default }
