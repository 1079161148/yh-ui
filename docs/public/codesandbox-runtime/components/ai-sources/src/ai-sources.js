import { createCommentVNode as _createCommentVNode, renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, createBlock as _createBlock, toDisplayString as _toDisplayString, createTextVNode as _createTextVNode, normalizeClass as _normalizeClass, createElementVNode as _createElementVNode, createVNode as _createVNode, withCtx as _withCtx, normalizeStyle as _normalizeStyle, withModifiers as _withModifiers, renderSlot as _renderSlot } from "vue";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      _createCommentVNode(" \u2500\u2500 badge \u6A21\u5F0F\uFF1A\u4EC5\u663E\u793A\u89D2\u6807 \u2500\u2500 "),
      _ctx.mode === "badge" ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 0 },
        [
          _createElementVNode(
                    ...
                    },
                    {
                      content: _withCtx(() => [
                        _createElementVNode(
                          ...
                          [
                            _createElementVNode(
                              ...
                              [
                                _createElementVNode(
                                  "div",
                                  {
                                    class: _normalizeClass($setup.ns.e("tooltip-title-wrap"))
                                  },
                                  [
                            ...
                            source.excerpt ? (_openBlock(), _createElementBlock(
                              "p",
                              {
                                key: 0,
                            ...
                            source.source ? (_openBlock(), _createElementBlock(
                              "div",
                              {
                                key: 1,
                      ...
                      default: _withCtx(() => [
                        _createElementVNode("button", {
                          ...
                          _ctx.showFileType ? (_openBlock(), _createBlock($setup["YhIcon"], {
                            key: 0,
                            name: $setup.getFileIcon(source.fileType)
                  ...
                  (_openBlock(true), _createElementBlock(
                    ...
                    _renderList(_ctx.sources, (source) => {
                      ...
                      return _openBlock(), _createElementBlock("div", {
                        ...
                        class: _normalizeClass([$setup.ns.e("source-card"), $setup.ns.is("active", ((_a = $setup.activeSource) == null ? void 0 : _a.id) === source.id), $setup.ns.is("highlighted", $setup.highlightedSourceId === source.id)]),
                          ...
                          [
                            ...
                            _createElementVNode(
                              ...
                              [
                                ...
                                _ctx.showScore && source.score !== void 0 ? (_openBlock(), _createElementBlock(
                                  "span",
                                  {
                                    key: 1,
                                  ...
                                  _toDisplayString(Math.round(source.score * 100)) + "% " + _toDisplayString($setup.t("ai.sources.relevant")),
                                  7
                                  /* TEXT, CLASS, STYLE */
                                )) : _createCommentVNode("v-if", true)
                              ],
                        ...
                        source.url ? (_openBlock(), _createElementBlock("button", {
                          key: 1,
        ...
        64
        /* STABLE_FRAGMENT */
      )) : _ctx.mode === "inline" ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 1 },
        [
          _createCommentVNode(" \u2500\u2500 inline \u6A21\u5F0F\uFF1A\u5185\u8054\u6C14\u6CE1\u5217\u8868 \u2500\u2500 "),
          _createElementVNode(
            "div",
            {
            ...
            [
              ...
              _createElementVNode(
                "span",
                null,
                _toDisplayString(_ctx.sources.length) + " " + _toDisplayString($setup.t("ai.sources.references")),
                1
                /* TEXT */
              )
            ],
          ...
          _createElementVNode(
            ...
            [
                  ...
                  return _openBlock(), _createBlock($setup["YhTooltip"], {
                          ...
                          _createElementVNode(
                            ...
                            [
                              ...
                              _ctx.showScore && source.score !== void 0 ? (_openBlock(), _createElementBlock(
                                ...
                                {
                                  key: 0,
                                  class: _normalizeClass($setup.ns.e("tooltip-score")),
                                  style: _normalizeStyle({
                                    color: $setup.scoreColor(source.score)
                                  })
                                },
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("div", {
                        class: _normalizeClass([$setup.ns.e("inline-item"), $setup.ns.is("highlighted", $setup.highlightedSourceId === source.id)]),
                        ref_for: true,
                        ref: (el) => $setup.sourceRefs[source.id] = el,
                        onClick: ($event) => $setup.handleClick(source)
                      }, [
                        ...
                        source.url ? (_openBlock(), _createElementBlock("button", {
                          ...
                          onClick: _withModifiers(($event) => $setup.handleOpen($event, source), ["stop"])
                        }, [
              ...
              !$setup.isExpanded && _ctx.sources.length > _ctx.maxVisible ? (_openBlock(), _createElementBlock(
                "button",
                {
                  key: 0,
                ...
                [
                  _createTextVNode(
                    " +" + _toDisplayString(_ctx.sources.length - _ctx.maxVisible) + " " + _toDisplayString($setup.t("ai.sources.more")) + " ",
                    1
                    /* TEXT */
                  ),
        ...
        { key: 2 },
        [
          _createCommentVNode(" \u2500\u2500 card \u6A21\u5F0F\uFF1A\u5B8C\u6574\u5361\u7247\u5217\u8868 \u2500\u2500 "),
          _createElementVNode(
            "div",
            {
          ...
          _createElementVNode(
            ...
            [
              (_openBlock(true), _createElementBlock(
                ...
                _renderList($setup.visibleSources, (source) => {
                  return _openBlock(), _createElementBlock("div", {
                    ...
                    ref_for: true,
                    ref: (el) => $setup.sourceRefs[source.id] = el,
                    class: _normalizeClass([$setup.ns.e("source-card"), $setup.ns.is("highlighted", $setup.highlightedSourceId === source.id)]),
                    onClick: ($event) => $setup.handleClick(source)
                  }, [
                    _createElementVNode(
                      "div",
                    ...
                    ], 10, _hoisted_7)) : _createCommentVNode("v-if", true)
                  ], 10, _hoisted_6);
                }),
                128
                /* KEYED_FRAGMENT */
              ...
              !$setup.isExpanded && _ctx.sources.length > _ctx.maxVisible ? (_openBlock(), _createElementBlock(
                ...
                [
                  _createTextVNode(
                    _toDisplayString($setup.t("ai.sources.showAll")) + " (" + _toDisplayString(_ctx.sources.length) + ") ",
                    1
                    /* TEXT */
                  ),
                  _createVNode($setup["YhIcon"], { name: "arrow-down" })
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getFileIcon = (type) => {
      var _a;
      return (_a = fileTypeIcons[type != null ? type : "default"]) != null ? _a : fileTypeIcons.default;
    };
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isExpanded, drawerVisible, activeSource, highlightedSourceId, sourceRefs, fileTypeIcons, getFileIcon, scoreColor, visibleSources, handleClick, handleOpen, openDrawer, scrollToSource, get useNamespace() {
      ...
      return useLocale;
    }, ref, computed, get aiSourcesProps() {
