import { renderSlot as _renderSlot, withCtx as _withCtx, createSlots as _createSlots, createVNode as _createVNode, createElementVNode as _createElementVNode, normalizeClass as _normalizeClass, openBlock as _openBlock, createElementBlock as _createElementBlock, toDisplayString as _toDisplayString, createCommentVNode as _createCommentVNode, normalizeStyle as _normalizeStyle } from "vue";
    ...
    [
      _createVNode($setup["TransferPanel"], {
        ...
        _ctx.$slots["left-empty"] ? {
          name: "empty",
          fn: _withCtx(() => [
            _renderSlot(_ctx.$slots, "left-empty")
          ]),
          key: "2"
        } : void 0,
        _ctx.$slots["left-footer"] ? {
          name: "footer",
          fn: _withCtx(() => [
            _renderSlot(_ctx.$slots, "left-footer")
          ]),
          key: "3"
        } : void 0
        ...
        [
          _renderSlot(_ctx.$slots, "buttons", {
            ...
            _createElementVNode("button", {
              type: "button",
              class: _normalizeClass([$setup.ns.e("button"), {
              ...
              $props.buttonTexts && $props.buttonTexts[0] ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 0,
            ...
            _createElementVNode("button", {
              ...
              $props.buttonTexts && $props.buttonTexts[1] ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 0,
                  class: _normalizeClass($setup.ns.e("button__text"))
      ...
      _createVNode($setup["TransferPanel"], {
        ...
        _ctx.$slots["right-empty"] ? {
          name: "empty",
          fn: _withCtx(() => [
            _renderSlot(_ctx.$slots, "right-empty")
          ]),
          key: "2"
        } : void 0,
        _ctx.$slots["right-footer"] ? {
          name: "footer",
          fn: _withCtx(() => [
            _renderSlot(_ctx.$slots, "right-footer")
          ]),
          key: "3"
        } : void 0
      ]), 1032, ["data", "checked", "title", "filterable", "filter-placeholder", "filter-method", "disabled", "size", "props", "render-content", "virtual", "item-height", "height", "show-all-checkbox", "empty-text"])
...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const rightData = computed(() => {
      ...
      return ((_a = props.modelValue) != null ? _a : []).map((key) => dataMap.get(key)).filter((item) => item !== void 0);
    });
    const leftTitle = computed(() => {
      var _a;
      return props.leftTitle || ((_a = props.titles) == null ? void 0 : _a[0]) || t("transfer.titles.0");
    });
    const rightTitle = computed(() => {
      var _a;
      return props.rightTitle || ((_a = props.titles) == null ? void 0 : _a[1]) || t("transfer.titles.1");
    });
    ...
    const moveToLeft = () => {
      ...
      const newValue = ((_a = props.modelValue) != null ? _a : []).filter((key) => !movedKeysSet.has(key));
      emit("update:modelValue", newValue);
    ...
    const __returned__ = { props, emit, ns, t, globalSize, themeStyle, leftPanelRef, rightPanelRef, leftChecked, rightChecked, keyProp, getKey, targetKeys, leftData, rightData, leftTitle, rightTitle, leftEmptyText, rightEmptyText, filterPlaceholder, canMoveToRight, canMoveToLeft, containerClasses, moveToRight, moveToLeft, handleLeftCheckedChange, handleRightCheckedChange, clearLeftChecked, clearRightChecked, computed, ref, watch, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
