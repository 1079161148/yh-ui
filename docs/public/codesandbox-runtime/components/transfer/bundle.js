// public/codesandbox-runtime/components/transfer/src/transfer.js
import { renderSlot as _renderSlot2, withCtx as _withCtx, createSlots as _createSlots, createVNode as _createVNode, createElementVNode as _createElementVNode2, normalizeClass as _normalizeClass2, openBlock as _openBlock2, createElementBlock as _createElementBlock2, toDisplayString as _toDisplayString2, createCommentVNode as _createCommentVNode2, normalizeStyle as _normalizeStyle2 } from "vue";
...
// public/codesandbox-runtime/components/transfer/src/transfer-panel.js
...
// public/codesandbox-runtime/components/transfer/src/transfer-meta.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
        ...
        [
          _renderSlot(_ctx.$slots, "header", {}, () => [
            _createElementVNode(
              "div",
              {
                class: _normalizeClass([$setup.ns.e("check-all"), {
              ...
              [
                _createElementVNode(
                  "span",
                  {
                    class: _normalizeClass([$setup.ns.e("item-checkbox"), {
                  ...
                  [
                    ...
                    $setup.isAllChecked ? (_openBlock(), _createElementBlock(
                      "svg",
                      {
                        key: 0,
                    ...
                    $setup.isIndeterminate && !$setup.isAllChecked ? (_openBlock(), _createElementBlock(
                      "svg",
                      {
                        key: 1,
                        class: _normalizeClass($setup.ns.e("item-checkbox__icon")),
            ...
            _createElementVNode(
              ...
              [
                ...
                _createElementVNode(
                  ...
                  _toDisplayString($setup.totalCheckedCount > 0 ? $setup.t("transfer.hasCheckedFormat", {
      ...
      $props.filterable ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          _withDirectives(_createElementVNode("input", {
            ...
            placeholder: $props.filterPlaceholder || $setup.t("transfer.filterPlaceholder"),
      ...
      _createElementVNode(
        ...
        [
          ...
          $setup.filteredData.length === 0 ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
                            ...
                            _renderList($setup.displayItems, (item) => {
                              return _openBlock(), _createElementBlock("li", {
                                ...
                                _createElementVNode(
                                  ...
                                  [
                                    $setup.isChecked($setup.getKey(item)) ? (_openBlock(), _createElementBlock(
                                      "svg",
                                      {
                                        key: 0,
                                        class: _normalizeClass($setup.ns.e("item-checkbox__icon")),
                                ...
                                _createElementVNode(
                                  ...
                                  [
                                    _renderSlot(_ctx.$slots, "default", { option: item }, () => [
                                      _createTextVNode(
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, query, scrollTop, virtualWrapperRef, keyProp, labelProp, disabledProp, getKey, getLabel, isItemDisabled, filteredData, checkableData, checkedKeys, isChecked, isAllChecked, isIndeterminate, totalCheckedCount, virtualConfig, displayItems, handleVirtualScroll, handleCheck, handleItemClick, handleCheckAll, clearChecked, computed: computed11, ref: ref12, watch: watch4, provide: provide2, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    ...
    [
      _createVNode($setup["TransferPanel"], {
        ref: "leftPanelRef",
        data: $setup.leftData,
        ...
        _ctx.$slots["left-header"] ? {
          name: "header",
          fn: _withCtx(() => [
            _renderSlot2(_ctx.$slots, "left-header")
          ]),
          key: "0"
        } : void 0,
        _ctx.$slots.default ? {
        ...
        _ctx.$slots["left-empty"] ? {
          name: "empty",
          fn: _withCtx(() => [
            _renderSlot2(_ctx.$slots, "left-empty")
          ]),
          key: "2"
        } : void 0,
        _ctx.$slots["left-footer"] ? {
          name: "footer",
          fn: _withCtx(() => [
            _renderSlot2(_ctx.$slots, "left-footer")
          ]),
          key: "3"
        } : void 0
      ]), 1032, ["data", "checked", "title", "filterable", "filter-placeholder", "filter-method", "disabled", "size", "props", "render-content", "virtual", "item-height", "height", "show-all-checkbox", "empty-text"]),
      _createElementVNode2(
        ...
        [
          _renderSlot2(_ctx.$slots, "buttons", {
            ...
            _createElementVNode2("button", {
              type: "button",
              class: _normalizeClass2([$setup.ns.e("button"), {
              ...
              $props.buttonTexts && $props.buttonTexts[0] ? (_openBlock2(), _createElementBlock2(
                "span",
                {
                  key: 0,
            ...
            _createElementVNode2("button", {
              ...
              $props.buttonTexts && $props.buttonTexts[1] ? (_openBlock2(), _createElementBlock2(
                "span",
                {
                  key: 0,
                  class: _normalizeClass2($setup.ns.e("button__text"))
      ...
      _createVNode($setup["TransferPanel"], {
        ...
        _ctx.$slots["right-header"] ? {
          name: "header",
          fn: _withCtx(() => [
            _renderSlot2(_ctx.$slots, "right-header")
          ]),
          key: "0"
        } : void 0,
        _ctx.$slots.default ? {
        ...
        _ctx.$slots["right-empty"] ? {
          name: "empty",
          fn: _withCtx(() => [
            _renderSlot2(_ctx.$slots, "right-empty")
          ]),
          key: "2"
        } : void 0,
        _ctx.$slots["right-footer"] ? {
          name: "footer",
          fn: _withCtx(() => [
            _renderSlot2(_ctx.$slots, "right-footer")
          ]),
          key: "3"
        } : void 0
      ]), 1032, ["data", "checked", "title", "filterable", "filter-placeholder", "filter-method", "disabled", "size", "props", "render-content", "virtual", "item-height", "height", "show-all-checkbox", "empty-text"])
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { themeStyle } = useComponentTheme("transfer", computed12(() => props.themeOverrides));
    ...
    const rightData = computed12(() => {
      ...
      return ((_a2 = props.modelValue) != null ? _a2 : []).map((key) => dataMap.get(key)).filter((item) => item !== void 0);
    });
    const leftTitle = computed12(() => {
      var _a2;
      return props.leftTitle || ((_a2 = props.titles) == null ? void 0 : _a2[0]) || t("transfer.titles.0");
    });
    const rightTitle = computed12(() => {
      var _a2;
      return props.rightTitle || ((_a2 = props.titles) == null ? void 0 : _a2[1]) || t("transfer.titles.1");
    });
    const leftEmptyText = computed12(() => props.leftEmptyText || props.emptyText || t("transfer.noData"));
    const rightEmptyText = computed12(() => props.rightEmptyText || props.emptyText || t("transfer.noData"));
    const filterPlaceholder = computed12(() => props.filterPlaceholder || t("transfer.filterPlaceholder"));
    ...
    const moveToLeft = () => {
      ...
      const newValue = ((_a2 = props.modelValue) != null ? _a2 : []).filter((key) => !movedKeysSet.has(key));
      emit("update:modelValue", newValue);
    ...
    const __returned__ = { props, emit, ns, t, globalSize, themeStyle, leftPanelRef, rightPanelRef, leftChecked, rightChecked, keyProp, getKey, targetKeys, leftData, rightData, leftTitle, rightTitle, leftEmptyText, rightEmptyText, filterPlaceholder, canMoveToRight, canMoveToLeft, containerClasses, moveToRight, moveToLeft, handleLeftCheckedChange, handleRightCheckedChange, clearLeftChecked, clearRightChecked, computed: computed12, ref: ref13, watch: watch5, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
