...
import { createCommentVNode as _createCommentVNode5, vModelText as _vModelText, normalizeClass as _normalizeClass4, createElementVNode as _createElementVNode5, withDirectives as _withDirectives4, toDisplayString as _toDisplayString4, openBlock as _openBlock5, createElementBlock as _createElementBlock5, renderSlot as _renderSlot5, createTextVNode as _createTextVNode4, renderList as _renderList4, Fragment as _Fragment5, createBlock as _createBlock4, withCtx as _withCtx4, createVNode as _createVNode3, normalizeStyle as _normalizeStyle4 } from "vue";
...
var DEFAULT_PROVINCE_KW = ["\u7701", "\u81EA\u6CBB\u533A", "\u7279\u522B\u884C\u653F\u533A", "Province", "State"];
var DEFAULT_CITY_KW = ["\u5E02", "\u5DDE", "\u76DF", "City", "Prefecture"];
var DEFAULT_DISTRICT_KW = ["\u533A", "\u53BF", "\u65D7", "District", "County", "Township"];
var DEFAULT_STREET_KW = ["\u8857\u9053", "\u9547", "\u4E61", "\u6751", "Street", "Road", "Ave", "Lane"];
...
function parseByDelimiter(text, result, options) {
  const segments = text.split(/[,，]/).map((s2) => s2.trim()).filter(Boolean);
...
import { computed as computed11, ref as ref12, nextTick, provide as provide2, watch as watch4, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2 } from "vue";
...
var _hoisted_2 = ["id", "value", "placeholder", "disabled", "readonly", "aria-expanded", "aria-controls"];
var _hoisted_3 = ["id"];
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const selectedLabels = computed11(() => {
      ...
      return opt ? opt[props.labelKey || "label"] || opt.label : String((_a2 = props.modelValue) != null ? _a2 : "");
    });
...
import { createCommentVNode as _createCommentVNode2, renderSlot as _renderSlot2, vShow as _vShow2, createElementVNode as _createElementVNode2, withDirectives as _withDirectives2, Fragment as _Fragment2, openBlock as _openBlock2, createElementBlock as _createElementBlock2 } from "vue";
import { computed as computed12, inject as inject7, onMounted as onMounted4, onBeforeUnmount as onBeforeUnmount3, useSlots } from "vue";
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    _Fragment2,
    null,
    [
      _createCommentVNode2(" \u8FD9\u4E2A\u7EC4\u4EF6\u5728 Select \u5185\u90E8\u662F\u4EE5\u6570\u636E\u5F62\u5F0F\u5B58\u5728\u7684\uFF0C\u5176 template \u4EC5\u4F5C\u4E3A slot \u5185\u5BB9\u5BB9\u5668 "),
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, select, slots, optionData, computed: computed12, inject: inject7, onMounted: onMounted4, onBeforeUnmount: onBeforeUnmount3, useSlots, get SelectContextKey() {
      return SelectContextKey;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
var YhSelect = withInstall(stdin_default3);
var YhOption = withInstall(stdin_default4);

// public/codesandbox-runtime/components/cascader/src/cascader.js
import { createCommentVNode as _createCommentVNode4, renderList as _renderList3, Fragment as _Fragment4, openBlock as _openBlock4, createElementBlock as _createElementBlock4, toDisplayString as _toDisplayString3, normalizeClass as _normalizeClass3, createElementVNode as _createElementVNode4, withModifiers as _withModifiers3, renderSlot as _renderSlot4, createTextVNode as _createTextVNode3, withCtx as _withCtx3, createVNode as _createVNode2, vShow as _vShow3, normalizeStyle as _normalizeStyle3, withDirectives as _withDirectives3, Transition as _Transition2, Teleport as _Teleport2, createBlock as _createBlock3 } from "vue";
import { computed as computed14, ref as ref14, watch as watch6, nextTick as nextTick2, provide as provide3, onMounted as onMounted5, onBeforeUnmount as onBeforeUnmount4 } from "vue";
...
import { renderList as _renderList2, Fragment as _Fragment3, openBlock as _openBlock3, createElementBlock as _createElementBlock3, createCommentVNode as _createCommentVNode3, createElementVNode as _createElementVNode3, normalizeClass as _normalizeClass2, withModifiers as _withModifiers2, renderSlot as _renderSlot3, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode2, normalizeStyle as _normalizeStyle2, withCtx as _withCtx2, createBlock as _createBlock2 } from "vue";
import { computed as computed13, ref as ref13, watch as watch5, defineComponent, h as h2 } from "vue";
    ...
    [
      (_openBlock3(true), _createElementBlock3(
        ...
        _renderList2($setup.menus, (colMenu, colLevel) => {
          return _openBlock3(), _createBlock2($setup["CascaderMenu"], {
            key: colLevel,
            menu: colMenu,
            level: colLevel,
            ...
            default: _withCtx2(({ option, level: menuLevel, startIndex, idx }) => [
              (_openBlock3(), _createElementBlock3("div", {
                key: option[$props.config.value],
                class: _normalizeClass2([$setup.ns.e("node"), $setup.ns.is("expanded", $setup.isExpanded(option, menuLevel)), $setup.ns.is("checked", $props.isChecked($setup.getPath(option, menuLevel))), $setup.ns.is("disabled", option[$props.config.disabled]), $setup.ns.is("selectable", $setup.isSelectable(option))]),
                style: _normalizeStyle2($props.virtual ? {
                  position: "absolute",
                ...
                onMousedown: _cache[0] || (_cache[0] = _withModifiers2(() => {
                }, ["prevent"])),
                ...
                $props.isMultiple && $setup.isSelectable(option) ? (_openBlock3(), _createElementBlock3("span", {
                  key: 0,
                  class: _normalizeClass2($setup.ns.e("checkbox")),
                  onClick: _withModifiers2(($event) => $setup.handleCheckboxClick(option, menuLevel, $event), ["stop"])
                }, [
                  _createElementVNode3(
                    "span",
                    {
                      class: _normalizeClass2([$setup.ns.e("checkbox-inner"), $setup.ns.is("checked", $props.isChecked($setup.getPath(option, menuLevel)))])
                    },
                    [
                      $props.isChecked($setup.getPath(option, menuLevel)) ? (_openBlock3(), _createElementBlock3("svg", _hoisted_32, [..._cache[1] || (_cache[1] = [
                        _createElementVNode3(
                          "path",
                          {
                            fill: "currentColor",
                ...
                ], 10, _hoisted_22)) : _createCommentVNode3("v-if", true),
                ...
                $setup.hasChildren(option) ? (_openBlock3(), _createElementBlock3(
                  "span",
                  {
                    key: 1,
            ...
            _: 3
            /* FORWARDED */
          }, 8, ["menu", "level", "virtual", "item-height"]);
        }),
        128
        /* KEYED_FRAGMENT */
      ))
...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
      ...
      setup(menuProps, { slots }) {
        ...
        return () => h2(
          ...
          [
            ...
            // 空状态处理
            menuProps.menu.length === 0 ? h2("div", { class: ns.e("empty") }, t("cascader.noData")) : null
          ]
        );
      }
    });
    ...
    const __returned__ = { props, emit, ns, t, CascaderMenu, menus, isExpanded, hasChildren, isLeaf, isSelectable, getPath, handleCheckboxClick, handleClick, handleMouseEnter, computed: computed13, ref: ref13, watch: watch5, defineComponent, h: h2, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    } };
    ...
    [
      ...
      _createElementVNode4(
        ...
        [
          ...
          $setup.isMultiple ? (_openBlock4(), _createElementBlock4(
            _Fragment4,
            { key: 0 },
            [
              (_openBlock4(true), _createElementBlock4(
                ...
                _renderList3($setup.displayTags, (tag) => {
                  return _openBlock4(), _createElementBlock4(
                    ...
                    {
                      key: tag.path.join(","),
                      class: _normalizeClass3([$setup.ns.e("tag"), $props.tagType ? `yh-tag--${$props.tagType}` : ""])
                    },
                    [
                      _createElementVNode4(
                        "span",
              ...
              $setup.collapsedCount > 0 ? (_openBlock4(), _createElementBlock4(
                "span",
                {
                  key: 0,
          ...
          _createElementVNode4("input", {
            ...
            value: $props.filterable ? $setup.query : "",
            placeholder: $setup.hasValue ? "" : $props.placeholder || $setup.t("cascader.placeholder"),
            disabled: $props.disabled,
            readonly: !$props.filterable,
            autocomplete: "off",
            role: "combobox",
          ...
          !$setup.isMultiple && $setup.hasValue && !$setup.query ? (_openBlock4(), _createElementBlock4(
            "span",
            {
              key: 1,
          ...
          _createElementVNode4(
            ...
            [
              ...
              $setup.showClear ? (_openBlock4(), _createElementBlock4(
                "span",
                {
                  key: 0,
              ...
              _createElementVNode4(
                "span",
                {
                  class: _normalizeClass3([$setup.ns.e("icon"), $setup.ns.e("arrow"), {
                    "is-reverse": $setup.visible
                  }])
                },
                [..._cache[2] || (_cache[2] = [
      ...
      (_openBlock4(), _createBlock3(_Teleport2, {
        to: "body",
        disabled: !$props.teleported
      }, [
        _createVNode2(_Transition2, {
          name: $setup.ns.b("dropdown"),
          persisted: ""
        }, {
          default: _withCtx3(() => [
            _withDirectives3(_createElementVNode4(
              "div",
              {
                ref: "dropdownRef",
              ...
              [
                ...
                $props.filterable && $setup.query && $setup.filteredSuggestions.length > 0 ? (_openBlock4(), _createElementBlock4(
                  "div",
                  {
                    key: 0,
                    ...
                    (_openBlock4(true), _createElementBlock4(
                      ...
                      _renderList3($setup.filteredSuggestions, (suggestion) => {
                        return _openBlock4(), _createElementBlock4("div", {
                          ...
                          class: _normalizeClass3([$setup.ns.e("suggestion"), $setup.ns.is("checked", $setup.isChecked(suggestion.path))]),
                          onClick: _withModifiers3(($event) => $setup.handleSelectSuggestion(suggestion), ["stop"])
                        }, _toDisplayString3(suggestion.labels.join($props.separator)), 11, _hoisted_33);
                      }),
                      128
                      /* KEYED_FRAGMENT */
                    ))
                  ...
                  [
                    ...
                    _createVNode2($setup["CascaderPanel"], {
                      ...
                      _: 3
                      /* FORWARDED */
                    }, 8, ["options", "expanded-path", "config", "is-multiple", "virtual", "item-height"])
                  ],
                  2112
                  /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
                ))
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  emits: ["update:modelValue", "change", "focus", "blur", "clear", "expand-change", "visible-change"],
  setup(__props, { expose: __expose, emit: __emit }) {
    const props = __props;
    const emit = __emit;
    const ns = useNamespace("cascader");
    ...
    const config = computed14(() => {
      ...
      return __spreadProps2(__spreadValues3(__spreadValues3({}, defaultCascaderConfig), props.props), {
        // 直接属性覆盖
        multiple: props.multiple || ((_a2 = props.props) == null ? void 0 : _a2.multiple) || false,
        checkStrictly: props.checkStrictly || ((_b = props.props) == null ? void 0 : _b.checkStrictly) || false,
        expandTrigger: props.expandTrigger || ((_c = props.props) == null ? void 0 : _c.expandTrigger) || "click",
        emitPath: (_f = (_e = props.emitPath) != null ? _e : (_d = props.props) == null ? void 0 : _d.emitPath) != null ? _f : true
      });
    });
    ...
    const showClear = computed14(() => {
      ...
      if (isMultiple.value) {
        ...
        return props.modelValue !== void 0 && props.modelValue !== null && (Array.isArray(props.modelValue) ? props.modelValue.length > 0 : true);
      }
    });
    ...
    const filteredSuggestions = computed14(() => {
      ...
      const traverse = (options, path, labels) => {
        ...
        for (const option of options) {
          ...
          const matches = props.filterMethod ? props.filterMethod(option, query.value) : fullPathLabel.includes(keyword);
      ...
      if (isMultiple.value) {
        ...
        if (values && Array.isArray(values)) {
          for (const path of values) {
            ...
            if (node && (!leafOnly || !((_a2 = node[config.value.children]) == null ? void 0 : _a2.length))) {
              nodes.push(node);
            }
          }
        }
        ...
        if (value) {
          ...
          if (path) {
            const node = findNode(props.options || [], path, 0);
            if (node && (!leafOnly || !((_b = node[config.value.children]) == null ? void 0 : _b.length))) {
              nodes.push(node);
            }
          }
        }
    ...
    const __returned__ = { props, emit, ns, t, inputId, themeStyle, form, formItem, triggerValidate, globalSize, cascaderSize, config, wrapperRef, inputRef, dropdownRef, visible, focused, hovering, query, expandedPath, isClickingDropdown, dropdownStyle, updateDropdownPosition, isMultiple, getPathLabels, findPathByValue, presentText, presentTags, displayTags, collapsedCount, showClear, hasValue, filteredSuggestions, wrapperClasses, handleExpand, handleCheck, isChecked, handleRemoveTag, handleClear, toggleDropdown, handleSelectSuggestion, handleInput, handleFocus, handleBlur, handleDropdownMousedown, handleDropdownMouseup, handleMouseEnter, handleMouseLeave, getCheckedNodes, focus, blur, computed: computed14, ref: ref14, watch: watch6, nextTick: nextTick2, provide: provide3, onMounted: onMounted5, onBeforeUnmount: onBeforeUnmount4, get useNamespace() {
      return useNamespace;
    }, get useFormItem() {
      return useFormItem;
    }, get useId() {
...
var YhCascader = withInstall(stdin_default6);
var YhCascaderPanel = withInstall(stdin_default5);
...
function render5(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock5(), _createElementBlock5(
    ...
    [
      ...
      _ctx.showParser ? (_openBlock5(), _createElementBlock5(
        "div",
        {
          key: 0,
        ...
        [
          _withDirectives4(_createElementVNode5("textarea", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.rawText = $event),
          ...
          _createElementVNode5(
            ...
            [
              $setup.parseTip ? (_openBlock5(), _createElementBlock5(
                "span",
                {
                  key: 0,
                  class: _normalizeClass4([$setup.ns.e("parser-tip"), $setup.ns.is("success", $setup.parseStatus === "success"), $setup.ns.is("error", $setup.parseStatus === "error")])
                },
              ...
              _createElementVNode5("button", {
                ...
                _renderSlot5(_ctx.$slots, "parse-icon", {}, () => [
                  _cache[12] || (_cache[12] = _createTextVNode4(
                    "\u2726",
                    -1
                    /* CACHED */
                  ))
      ...
      _createElementVNode5(
        "div",
        {
          class: _normalizeClass4([$setup.ns.e("fields"), $setup.ns.is("top", _ctx.labelPlacement === "top")])
        },
        [
          _createCommentVNode5(" \u59D3\u540D "),
          _ctx.showName ? (_openBlock5(), _createElementBlock5(
            "div",
            {
              key: 0,
            ...
            [
              _createElementVNode5(
                "label",
                {
                  class: _normalizeClass4([$setup.ns.e("label"), $setup.ns.is("required", _ctx.required)])
                },
              ...
              _createElementVNode5("input", {
                ...
                onInput: _cache[1] || (_cache[1] = (e) => $setup.updateField("name", e.target.value))
              }, null, 42, _hoisted_34)
            ],
            2
            /* CLASS */
          ...
          _ctx.showPhone ? (_openBlock5(), _createElementBlock5(
            "div",
            {
              key: 1,
              class: _normalizeClass4($setup.ns.e("field"))
            ...
            [
              ...
              _createElementVNode5("input", {
                ...
                onInput: _cache[2] || (_cache[2] = (e) => $setup.updateField("phone", e.target.value))
              }, null, 42, _hoisted_42)
            ],
            2
            /* CLASS */
          )) : _createCommentVNode5("v-if", true),
          _createCommentVNode5(" \u7701/\u5E02/\u533A \u4E09\u4E2A\u4E0B\u62C9\uFF08\u5F53\u524D\u7B80\u5316\u4E3A input\uFF0C\u53EF\u7531\u5916\u90E8\u63D2\u69FD\u66FF\u6362\u4E3A Cascader\uFF09 "),
          _createElementVNode5(
            "div",
            {
            ...
            [
              ...
              _renderSlot5(_ctx.$slots, "region", {
                value: $setup.innerVal,
                update: $setup.updateField
              }, () => [
                _createCommentVNode5(" \u8F93\u5165\u6846\u6A21\u5F0F "),
                _ctx.regionType === "input" ? (_openBlock5(), _createElementBlock5(
                  "div",
                  {
                    key: 0,
                  ...
                  [
                    _createElementVNode5("input", {
                      ...
                      onInput: _cache[3] || (_cache[3] = (e) => $setup.updateField("province", e.target.value))
                    }, null, 42, _hoisted_52),
                    _createElementVNode5("input", {
                      class: _normalizeClass4($setup.ns.e("input")),
                      ...
                      onInput: _cache[4] || (_cache[4] = (e) => $setup.updateField("city", e.target.value))
                    }, null, 42, _hoisted_62),
                    _createElementVNode5("input", {
                      class: _normalizeClass4($setup.ns.e("input")),
                      ...
                      onInput: _cache[5] || (_cache[5] = (e) => $setup.updateField("district", e.target.value))
                    }, null, 42, _hoisted_7)
                  ],
                  2
                  /* CLASS */
                )) : _ctx.regionType === "select" ? (_openBlock5(), _createElementBlock5(
                  _Fragment5,
                  { key: 1 },
                  [
                    ...
                    _createElementVNode5(
                      ...
                      [
                        _createVNode3($setup["YhSelect"], {
                          "model-value": $setup.innerVal.province,
                          disabled: _ctx.disabled,
                          placeholder: $setup.t("smartaddress.province"),
                          style: { "flex": "1", "min-width": "0" },
                          "onUpdate:modelValue": _cache[6] || (_cache[6] = (val) => {
                          ...
                          default: _withCtx4(() => [
                            (_openBlock5(true), _createElementBlock5(
                              ...
                              _renderList4($setup.provinceOptions, (opt) => {
                                return _openBlock5(), _createBlock4($setup["YhOption"], {
                                  key: opt.value,
                                  label: opt.label,
                                  value: opt.value
                                }, null, 8, ["label", "value"]);
                        ...
                        _createVNode3($setup["YhSelect"], {
                          ...
                          placeholder: $setup.t("smartaddress.city"),
                          style: { "flex": "1", "min-width": "0" },
                          "onUpdate:modelValue": _cache[7] || (_cache[7] = (val) => {
                        ...
                        _createVNode3($setup["YhSelect"], {
                          ...
                          placeholder: $setup.t("smartaddress.district"),
                          style: { "flex": "1", "min-width": "0" },
                          "onUpdate:modelValue": _cache[8] || (_cache[8] = (val) => $setup.updateField("district", val))
                        }, {
                          default: _withCtx4(() => [
                            (_openBlock5(true), _createElementBlock5(
                              _Fragment5,
                  ...
                  2112
                  /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
                )) : _ctx.regionType === "cascader" ? (_openBlock5(), _createElementBlock5(
                  _Fragment5,
                  { key: 2 },
                  [
                    ...
                    _createElementVNode5(
                      ...
                      [
                        _createVNode3($setup["YhCascader"], {
                          modelValue: $setup.regionCascaderValue,
                          "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => $setup.regionCascaderValue = $event),
          ...
          _ctx.showStreet ? (_openBlock5(), _createElementBlock5(
            "div",
            {
              key: 2,
              class: _normalizeClass4($setup.ns.e("field"))
            ...
            [
              ...
              _createElementVNode5("input", {
                ...
                onInput: _cache[10] || (_cache[10] = (e) => $setup.updateField("street", e.target.value))
              }, null, 42, _hoisted_8)
            ],
            2
            /* CLASS */
          ...
          _createElementVNode5(
            ...
            [
              ...
              _createElementVNode5("input", {
                ...
                onInput: _cache[11] || (_cache[11] = (e) => $setup.updateField("detail", e.target.value))
              }, null, 42, _hoisted_9)
            ],
            2
            /* CLASS */
...
var __sfc__5 = /* @__PURE__ */ Object.assign({ name: "YhSmartAddress" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function handleParse() {
      ...
      const result = props.parser ? props.parser(rawText.value) : parseAddress(rawText.value, parseOptions);
      ...
      const provinceChildren = (provinceMatch == null ? void 0 : provinceMatch[props.childrenField]) || [];
    ...
    const districtOptions = computed15(() => {
      ...
      if (provinceChildren.length) {
        ...
        if (cityChildren.length) {
          return cityChildren.map((d2) => ({
            label: d2[props.labelField] || "",
            value: d2[props.valueField] || ""
          }));
        }
      }
      return [];
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, tRaw, rawText, parseStatus, parseTip, getValueByLabel, handleParse, innerVal, updateField, provinceOptions, cityOptions, districtOptions, cascaderOptions, regionCascaderValue, placeholder, btnText, ref: ref15, computed: computed15, reactive, get useNamespace() {
      return useNamespace;
    }, get useComponentTheme() {
      return useComponentTheme;
    }, get useLocale() {
