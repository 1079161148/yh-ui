...
var __sfc__3 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, t, CascaderMenu, menus, isExpanded, hasChildren, isLeaf, isSelectable, getPath, handleCheckboxClick, handleClick, handleMouseEnter, computed: computed13, ref: ref13, watch: watch5, defineComponent, h, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
    } };
...
var __sfc__4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { t } = useLocale();
    const inputId = useId();
    const { themeStyle } = useComponentTheme("cascader", computed14(() => props.themeOverrides));
    const { form, formItem, validate: triggerValidate } = useFormItem();
    const { globalSize } = useConfig();
    const cascaderSize = computed14(() => props.size || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalSize.value || "default");
