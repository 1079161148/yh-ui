...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _ctx.showParser ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          ...
          _createElementVNode(
            ...
            [
              $setup.parseTip ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 0,
                  class: _normalizeClass([$setup.ns.e("parser-tip"), $setup.ns.is("success", $setup.parseStatus === "success"), $setup.ns.is("error", $setup.parseStatus === "error")])
                },
      ...
      _createElementVNode(
        "div",
        {
          class: _normalizeClass([$setup.ns.e("fields"), $setup.ns.is("top", _ctx.labelPlacement === "top")])
        },
        [
          _createCommentVNode(" \u59D3\u540D "),
          _ctx.showName ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
            ...
            [
              _createElementVNode(
                "label",
                {
                  class: _normalizeClass([$setup.ns.e("label"), $setup.ns.is("required", _ctx.required)])
                },
          ...
          _ctx.showPhone ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 1,
              class: _normalizeClass($setup.ns.e("field"))
          ...
          _createCommentVNode(" \u7701/\u5E02/\u533A \u4E09\u4E2A\u4E0B\u62C9\uFF08\u5F53\u524D\u7B80\u5316\u4E3A input\uFF0C\u53EF\u7531\u5916\u90E8\u63D2\u69FD\u66FF\u6362\u4E3A Cascader\uFF09 "),
          _createElementVNode(
            "div",
            {
            ...
            [
              ...
              _renderSlot(_ctx.$slots, "region", {
                value: $setup.innerVal,
                update: $setup.updateField
              }, () => [
                _createCommentVNode(" \u8F93\u5165\u6846\u6A21\u5F0F "),
                _ctx.regionType === "input" ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                  ...
                  2
                  /* CLASS */
                )) : _ctx.regionType === "select" ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 1 },
                  [
                          ...
                          default: _withCtx(() => [
                            (_openBlock(true), _createElementBlock(
                              ...
                              _renderList($setup.provinceOptions, (opt) => {
                                return _openBlock(), _createBlock($setup["YhOption"], {
                                  key: opt.value,
                                  label: opt.label,
                                  value: opt.value
                                }, null, 8, ["label", "value"]);
                ...
                )) : _ctx.regionType === "cascader" ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 2 },
                  [
          ...
          _ctx.showStreet ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 2,
              class: _normalizeClass($setup.ns.e("field"))
...
import { YhSelect, YhOption } from "../../select/index.js";
import { YhCascader } from "../../cascader/index.js";
const __sfc__ = /* @__PURE__ */ Object.assign({ name: "YhSmartAddress" }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, ns, themeStyle, t, tRaw, rawText, parseStatus, parseTip, getValueByLabel, handleParse, innerVal, updateField, provinceOptions, cityOptions, districtOptions, cascaderOptions, regionCascaderValue, placeholder, btnText, ref, computed, reactive, get useNamespace() {
      return useNamespace;
