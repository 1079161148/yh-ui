...
const __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, _types, themeStyle, slots, ns, hasDefaultSlot, content, isShow, badgeClasses, contentClasses, contentStyles, computed, useSlots, get useNamespace() {
      return useNamespace;
