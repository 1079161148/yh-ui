    ...
    _createElementBlock(
      'div',
      {
        ...
        class: _normalizeClass([
          ...
          $setup.ns.is('refreshing', $setup.isRefreshing)
        ]),
      ...
      [
        ...
        ($props.loading && $props.items.length === 0) || $props.items.length > 0
          ? (_openBlock(true),
            _createElementBlock(
              _Fragment,
              { key: 0 },
                                  ...
                                  return (
                                    ...
                                    _createElementBlock(
                                      'div',
                                      {
                                        ...
                                        class: _normalizeClass([
                                          $setup.ns.e('item'),
                                          $setup.ns.em('item', $props.animation ? 'animated' : '')
                                        ]),
                                        style: _normalizeStyle(
                                          $props.animation
                                            ? {
