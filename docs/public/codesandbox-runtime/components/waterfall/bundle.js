...
// public/codesandbox-runtime/components/waterfall/src/waterfall.js
...
import { ref as ref12, computed as computed11, onMounted as onMounted3, onBeforeUnmount as onBeforeUnmount2, nextTick, watch as watch4 } from "vue";
...
var __sfc__ = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const containerRef = ref12();
    const containerWidth = ref12(0);
    const BREAKPOINTS = {
      xs: 0,
      sm: 576,
      md: 768,
    ...
    const isRefreshing = computed11(() => props.loading && props.items && props.items.length > 0);
    const minContainerHeight = ref12("auto");
    watch4(
      () => props.loading,
      (val) => {
    ...
    const __returned__ = { props, ns, t, themeStyle, containerRef, containerWidth, BREAKPOINTS, currentCols, columnsData, get resizeObserver() {
      ...
      resizeObserver = v;
    }, updateWidth, handleImageLoad, isRefreshing, minContainerHeight, ref: ref12, computed: computed11, onMounted: onMounted3, onBeforeUnmount: onBeforeUnmount2, nextTick, watch: watch4, get useNamespace() {
      return useNamespace;
    }, get useLocale() {
      return useLocale;
