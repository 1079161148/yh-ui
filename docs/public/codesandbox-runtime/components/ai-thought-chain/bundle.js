...
import { createCommentVNode as _createCommentVNode2, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, createElementVNode as _createElementVNode, openBlock as _openBlock2, createElementBlock as _createElementBlock2, renderList as _renderList, Fragment as _Fragment2, createVNode as _createVNode, createBlock as _createBlock2, toDisplayString as _toDisplayString, withModifiers as _withModifiers, Transition as _Transition, withCtx as _withCtx, renderSlot as _renderSlot2 } from "vue";
...
// public/codesandbox-runtime/components/ai-thought-chain/src/ai-thought-chain.js
import { ref as ref12, computed as computed12, watch as watch4 } from "vue";
...
function link(state, silent) {
  ...
  if (parseReference) {
    ...
    ref13 = state.env.references[normalizeReference(label)];
    if (!ref13) {
      state.pos = oldPos;
      return false;
    }
...
function image(state, silent) {
  let code2, content, label, pos, ref13, res, title, start;
  let href = "";
  const oldPos = state.pos;
  const max = state.posMax;
...
var stdin_default4 = MarkdownIt2;
...
// public/codesandbox-runtime/components/ai-thought-chain/src/ai-thought-chain.js
var _hoisted_12 = ["draggable", "onDragstart", "onDragover", "onDrop"];
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock2(), _createElementBlock2(
    ...
    [
      _createCommentVNode2(" \u8FDB\u5EA6\u6761 "),
      _ctx.showProgress && $setup.itemsToUse && $setup.itemsToUse.length > 0 ? (_openBlock2(), _createElementBlock2(
        "div",
        {
          key: 0,
      ...
      _createCommentVNode2(" \u591A\u8282\u70B9\u65F6\u95F4\u8F74\u6A21\u5F0F "),
      $setup.itemsToUse && $setup.itemsToUse.length > 0 ? (_openBlock2(), _createElementBlock2(
        _Fragment2,
        { key: 1 },
        [
              ...
              return _openBlock2(), _createElementBlock2("div", {
                ...
                _createElementVNode(
                  ...
                  [
                    ...
                    index < _ctx.items.length - 1 ? (_openBlock2(), _createElementBlock2(
                      "div",
                      {
                        key: 0,
                ...
                _createElementVNode(
                  ...
                  [
                    _createElementVNode("div", {
                      ...
                      _createCommentVNode2(" \u62D6\u62FD\u624B\u67C4 "),
                      _ctx.draggable ? (_openBlock2(), _createBlock2($setup["YhIcon"], {
                        key: 0,
                        name: "rank",
                      ...
                      _createCommentVNode2(" \u8282\u70B9\u8FDB\u5EA6 "),
                      item.progress !== void 0 ? (_openBlock2(), _createElementBlock2(
                        "span",
                        {
                          key: 1,
                      ...
                      _createCommentVNode2(" \u64CD\u4F5C\u6309\u94AE "),
                      _ctx.editable ? (_openBlock2(), _createElementBlock2(
                        "div",
                        {
                          key: 2,
                      ...
                      item.content || item.description ? (_openBlock2(), _createBlock2($setup["YhIcon"], {
                        key: 3,
                        name: "arrow-down",
                    ...
                    _createVNode(
                      ...
                      { name: "yh-ai-thought-collapse" },
                      {
                        default: _withCtx(() => [
                          ...
                          ], 10, _hoisted_3)) : _createCommentVNode2("v-if", true)
                        ]),
                        _: 2
                        /* DYNAMIC */
                      },
        ...
        [
          ...
          _createVNode(_Transition, { name: "yh-ai-thought-collapse" }, {
            default: _withCtx(() => [
              $setup.isExpanded ? (_openBlock2(), _createElementBlock2(
                "div",
                {
                  key: 0,
...
var __sfc__2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isExpanded = ref12(false);
    const md = new stdin_default4({
      html: false,
      linkify: true,
      typographer: true
    });
    const itemExpandedStates = ref12([]);
    const internalItems = ref12([]);
    const draggedIndex = ref12(null);
    const dragOverIndex = ref12(null);
    const itemsToUse = computed12(() => {
    ...
    const currentProgress = computed12(() => {
    ...
    const __returned__ = { props, emit, ns, t, themeStyle, isExpanded, md, itemExpandedStates, internalItems, draggedIndex, dragOverIndex, itemsToUse, ensureInternalItems, currentProgress, currentStatus, displayTitle, renderMarkdown, getStatusIcon, toggleExpand, toggleItemExpand, handleItemClick, handleDeleteNode, handleAddNode, handleDragStart, handleDragOver, handleDragLeave, handleDrop, handleDragEnd, get useNamespace() {
      ...
      return useLocale;
    }, ref: ref12, computed: computed12, watch: watch4, get YhIcon() {
      return YhIcon;
    }, get MarkdownIt() {
