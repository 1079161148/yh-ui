...
.yh-color-picker__trigger:hover {
  border-color: var(--yh-color-primary, #6366f1);
}

.yh-color-picker.is-disabled {
  cursor: not-allowed;
  opacity: 0.6;
}
.yh-color-picker.is-disabled .yh-color-picker .yh-color-picker__trigger {
  background-color: var(--yh-fill-color-light);
  border-color: var(--yh-border-color-lighter);
}

.yh-color-picker--large .yh-color-picker__trigger {
  height: 40px;
  width: 70px;
}

.yh-color-picker--small .yh-color-picker__trigger {
  height: 24px;
  width: 45px;
}

.yh-color-picker__color {
  flex: 1;
  height: 100%;
  border-radius: 2px;
  display: flex;
...
.yh-color-picker__color .yh-color-picker__empty {
  color: #ccc;
  font-size: 14px;
}

.yh-color-picker__icon {
  margin-left: 4px;
...
.yh-color-picker__panel {
  width: 280px; /* 拓宽面板，解决挤压问题 */
  padding: 16px;
  background: #fff;
  border-radius: 12px;
  box-shadow:
...
.yh-color-picker__main {
  margin-bottom: 16px;
  position: relative;
}

.yh-color-picker__contrast-advisor {
  position: absolute;
  top: 8px;
  right: 8px;
...
.yh-color-picker__predefine-item {
  width: 24px;
  height: 24px;
  border-radius: 4px;
  cursor: pointer;
...
.yh-color-picker__predefine-item:hover {
  transform: scale(1.15);
}

.yh-color-picker__footer {
  margin-top: 16px;
  padding-top: 16px;
  border-top: 1px solid var(--yh-border-color-lighter);
  display: flex;
  flex-direction: column; /* 垂直排版避免横向挤压 */
  gap: 12px;
}

.yh-color-picker__tools {
  display: flex;
  align-items: center;
  gap: 8px;
  width: 100%;
...
.yh-color-picker__value {
  flex: 1;
  height: 28px;
  padding: 0 8px;
  font-size: 12px;
  font-family: var(--yh-font-family-mono, monospace);
...
.yh-color-picker__value:focus {
  border-color: var(--yh-color-primary);
  background: #fff;
}

.yh-color-picker__btns {
  display: flex;
...
.yh-color-picker__btn-clear:hover {
  color: var(--yh-color-primary);
  border-color: var(--yh-color-primary-light-7);
}

.yh-color-picker__btn-confirm {
  padding: 5px 16px;
  font-size: 12px;
  border-radius: 4px;
  cursor: pointer;
...
.yh-color-picker__btn-confirm:hover {
  background: var(--yh-color-primary-light-3);
  border-color: var(--yh-color-primary-light-3);
}
