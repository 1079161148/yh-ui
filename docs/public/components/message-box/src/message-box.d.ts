...
export interface MessageBoxHandler {
    (options: MessageBoxOptions | string | VNode, appContext?: AppContext | null): Promise<{
        value?: string;
        action: MessageBoxAction;
    }>;
    alert: (message: string | VNode, title?: string | MessageBoxOptions, options?: MessageBoxOptions, appContext?: AppContext | null) => Promise<void>;
    confirm: (message: string | VNode, title?: string | MessageBoxOptions, options?: MessageBoxOptions, appContext?: AppContext | null) => Promise<MessageBoxAction>;
    prompt: (message: string | VNode, title?: string | MessageBoxOptions, options?: MessageBoxOptions, appContext?: AppContext | null) => Promise<{
        value: string;
        action: 'confirm';
    }>;
