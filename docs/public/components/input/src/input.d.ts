 ...
 * 输入框类型
 */
export declare const inputTypes: readonly ["text", "password", "textarea", "number", "email", "url", "tel", "search"];
/**
 * 输入框尺寸
 */
export declare const inputSizes: readonly ["large", "default", "small"];
/**
 * 输入框视觉变体 (Feature 1: Variant)
 */
export declare const inputVariants: readonly ["default", "filled", "borderless", "underlined"];
/**
 * 输入框独立状态 (Feature 3: Status)
 */
export declare const inputStatuses: readonly ["", "success", "warning", "error"];
