...
exports.aiArtifactsProps = exports.aiArtifactsEmits = void 0;
const aiArtifactsProps = exports.aiArtifactsProps = {
  /**
   * 是否显示侧边栏
   */
  visible: {
...
const aiArtifactsEmits = exports.aiArtifactsEmits = {
