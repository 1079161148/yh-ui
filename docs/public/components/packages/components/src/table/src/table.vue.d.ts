...
declare const __VLS_component: import('vue').DefineComponent<
  ...
  import('vue').ComponentOptionsMixin,
  {
    ...
    'sort-change': (_params: { column: TableColumn; prop: string; order: SortOrder }) => void
    ...
    'row-click': (
      _row: Record<string, unknown>,
      _column: TableColumn<Record<string, unknown>>,
      _event: MouseEvent
    ) => void
    'row-dblclick': (
      _row: Record<string, unknown>,
  ...
  > &
    Readonly<{
      ...
      'onColumn-resize'?:
        | ((_column: TableColumn<Record<string, unknown>>, _width: number) => any)
        | undefined
      'onSort-change'?:
        | ((_params: { column: TableColumn; prop: string; order: SortOrder }) => any)
        | undefined
      ...
      'onSelection-change'?:
        | ((_selectedRows: Record<string, unknown>[], _selectedRowKeys: (string | number)[]) => any)
        | undefined
      'onRow-click'?:
        | ((
            _row: Record<string, unknown>,
      ...
      'onCell-dblclick'?:
        ...
        | undefined
      'onHeader-click'?:
        | ((_column: TableColumn<Record<string, unknown>>, _event: MouseEvent) => any)
        | undefined
      'onHeader-contextmenu'?:
        | ((_column: TableColumn<Record<string, unknown>>, _event: MouseEvent) => any)
        | undefined
      'onColumn-visible-change'?:
        | ((_columns: TableColumn<Record<string, unknown>>[]) => any)
        | undefined
