 ...
 * 计算列宽度
 */
export declare const calculateColumnWidth: (
  column: TableColumn,
 ...
 * 多列排序
 */
export declare const multiColumnSort: <T extends Record<string, unknown>>(
  data: T[],
  sortStates: Array<{
    prop: string
    order: SortOrder
 ...
 * 默认筛选方法
 */
export declare const defaultFilterMethod: <T>(
  value: unknown,
  row: T,
 ...
 * 多值筛选
 */
export declare const multiValueFilter: <T extends Record<string, unknown>>(
  data: T[],
 ...
 * 树形数据展平
 */
export declare const flattenTreeData: <T extends Record<string, unknown>>(
  data: T[],
 ...
 * 获取所有树节点 key
 */
export declare const getAllTreeKeys: <T extends Record<string, unknown>>(
  data: T[],
  childrenKey: string | undefined,
  rowKey: RowKey
) => Array<string | number>
 ...
 * 合并单元格计算
 */
export declare const calculateSpan: (
 ...
 * 节流函数
 */
export declare const throttle: <T extends (...args: Parameters<T>) => void>(
  fn: T,
  delay: number
 ...
 * 防抖函数
 */
export declare const debounce: <T extends (...args: Parameters<T>) => void>(
  fn: T,
  delay: number
) => (...args: Parameters<T>) => void
/**
 ...
 * 格式化单元格内容
 */
export declare const formatCellValue: <T extends Record<string, unknown>>(
  row: T,
  column: TableColumn<T>,
  rowIndex: number
) => string
 ...
 * 计算固定列样式
 */
export declare const getFixedStyle: (
  column: TableColumn,
  columns: TableColumn[],
 ...
 * 导出为 CSV
 */
export declare const exportToCSV: (
