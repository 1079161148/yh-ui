...
export declare const tableProps: {
  ...
  readonly headerRowClassName: {
    readonly type: PropType<string | ((params: { rowIndex: number }) => string)>
  }
  /** 表头行样式 */
  readonly headerRowStyle: {
    readonly type: PropType<CSSProperties | ((params: { rowIndex: number }) => CSSProperties)>
  }
  /** 表头单元格类名 */
...
export declare const tableEmits: {
  ...
  /** 分页变化 */
  readonly 'page-change': (_params: { currentPage: number; pageSize: number }) => boolean
  /** 选择变化 */
  readonly 'selection-change': (
  ...
  /** 展开变化 */
  readonly 'expand-change': (
    _row: Record<string, unknown>,
    _expandedRows: Record<string, unknown>[]
  ) => boolean
  /** 行点击 */
  readonly 'row-click': (
    _row: Record<string, unknown>,
  ...
  /** 行双击 */
  readonly 'row-dblclick': (
    _row: Record<string, unknown>,
    _column: TableColumn,
    _event: MouseEvent
  ) => boolean
  /** 行右键 */
  readonly 'row-contextmenu': (
    _row: Record<string, unknown>,
    _column: TableColumn,
    _event: MouseEvent
  ) => boolean
  ...
  /** 滚动事件 */
  readonly scroll: (_params: { scrollTop: number; scrollLeft: number; isEnd: boolean }) => boolean
  /** 拖拽结束 */
