...
declare var __VLS_17: `label-${string}`,
  __VLS_18: {
    model: Record<string, unknown>
    item: FormSchemaItem
  },
  __VLS_25: `field-${string}`,
  __VLS_26: {
    model: Record<string, unknown>
    item: FormSchemaItem
    handleUpdate: (field: string, val: unknown) => void
  },
  __VLS_62: `field-${string}-${string}`,
  __VLS_63: {
    row: Record<string, unknown>
    index: number
    item: FormSchemaItem
  },
  __VLS_80: `list-footer-${string}`,
  __VLS_81: {
    model: Record<string, unknown>
    item: FormSchemaItem
  },
  __VLS_87: `label-${string}`,
  __VLS_88: {
    model: Record<string, unknown>
    item: FormSchemaItem
  },
  __VLS_95: `field-${string}`,
  __VLS_96: {
    model: Record<string, unknown>
    item: FormSchemaItem
    handleUpdate: (field: string, val: unknown) => void
    ...
    formRef: {
      validate: (
        props?:
          ...
          | undefined,
        callback?: ((isValid: boolean, invalidFields?: Record<string, unknown>) => void) | undefined
