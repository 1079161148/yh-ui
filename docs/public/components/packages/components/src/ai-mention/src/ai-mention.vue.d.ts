...
declare const __VLS_component: import('vue').DefineComponent<
  import('vue').ExtractPropTypes<{
    ...
    readonly filterOption: {
      readonly type: import('vue').PropType<
        ((keyword: string, option: import('../..').MentionOption) => boolean) | false
      >
  ...
  > &
    Readonly<{
      ...
      'onFile-load'?:
        | ((_type: 'table' | 'document' | 'knowledge' | 'file', _nodes: AiMentionFileNode[]) => any)
        | undefined
    ...
    }>,
  {
    ...
    readonly filterOption:
      | false
      | ((keyword: string, option: import('../..').MentionOption) => boolean)
