    ...
    new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<
        ...
        import('vue').ExtractPropTypes<{
          ...
          readonly filterOption: {
            readonly type: import('vue').PropType<
              ((keyword: string, option: import('../index.js').MentionOption) => boolean) | false
            >
      ...
      > &
        Readonly<{
          ...
          onSelect?:
            | ((option: import('./index.js').AiMentionOption, trigger: string) => any)
            | undefined
          ...
          'onFile-load'?:
            | ((
                _type: 'table' | 'document' | 'knowledge' | 'file',
                _nodes: import('./index.js').AiMentionFileNode[]
              ) => any)
            | undefined
          'onFile-select'?:
            | ((
                node: import('./index.js').AiMentionFileNode,
                option: import('./index.js').AiMentionOption
              ) => any)
            | undefined
        }>,
      {
      ...
      import('vue').PublicProps,
      {
        ...
        readonly filterOption:
          | false
          | ((keyword: string, option: import('../index.js').MentionOption) => boolean)
