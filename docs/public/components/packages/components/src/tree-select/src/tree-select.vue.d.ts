...
declare const __VLS_component: import('vue').DefineComponent<
  import('vue').ExtractPropTypes<{
    ...
    readonly filterNodeMethod: import('vue').PropType<
      (value: string, data: import('./tree-select').TreeOption, node: TreeSelectNode) => boolean
    >
    ...
    readonly load: import('vue').PropType<
      (
        node: import('./tree-select').TreeOption,
        resolve: (data: import('./tree-select').TreeOption[]) => void
      ) => void
    >
    readonly virtual: {
      readonly type: BooleanConstructor
  ...
  import('vue').ComponentOptionsMixin,
  {
    ...
    check: (
      _data: import('./tree-select').TreeOption,
      _info: import('./tree-select').TreeCheckedInfo
    ) => void
    'visible-change': (_visible: boolean) => void
    'node-click': (
      _data: import('./tree-select').TreeOption,
      _node: TreeSelectNode,
      _e: MouseEvent
    ) => void
    'check-change': (
      _data: import('./tree-select').TreeOption,
