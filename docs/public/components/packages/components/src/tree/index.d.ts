    ...
    new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<
      ...
      > &
        Readonly<{
          onCheck?:
            | ((
                _node: import('./index.js').TreeNode,
                _checked: boolean,
                _checkedKeys: (string | number)[]
              ) => any)
            | undefined
          'onNode-click'?:
            | ((_node: import('./index.js').TreeNode, _e: MouseEvent) => any)
            | undefined
          'onCurrent-change'?: ((_node: import('./index.js').TreeNode | null) => any) | undefined
          'onNode-expand'?:
            | ((_node: import('./index.js').TreeNode, _expanded: boolean) => any)
            | undefined
          'onNode-drag-start'?:
            | ((_node: import('./index.js').TreeNode, _e: DragEvent) => any)
            | undefined
          'onNode-drag-end'?:
            | ((
                _node: import('./index.js').TreeNode,
                _dropNode: import('./index.js').TreeNode | null,
                _position: 'inner' | 'after' | 'before',
                _e: DragEvent
              ) => any)
            | undefined
          'onNode-drag-over'?:
          ...
          'onNode-drop'?:
            | ((
                _node: import('./index.js').TreeNode,
                _dropNode: import('./index.js').TreeNode,
                _position: 'inner' | 'after' | 'before',
                _e: DragEvent
              ) => any)
            | undefined
