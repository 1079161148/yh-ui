...
declare const __VLS_component: import('vue').DefineComponent<
  import('vue').ExtractPropTypes<{
    ...
    readonly httpRequest: {
      readonly type: import('vue').PropType<
        (options: UploadRequestOptions) => Promise<unknown> | void
      >
    }
    readonly beforeUpload: {
      readonly type: import('vue').PropType<
        (file: UploadRawFile) => boolean | Promise<boolean | Blob>
      >
    }
  ...
  > &
    Readonly<{
      onProgress?:
        | ((_evt: UploadProgressEvent, _file: UploadFile, _fileList: UploadFile[]) => any)
        | undefined
      onPreview?: ((_file: UploadFile) => any) | undefined
      onError?: ((_error: Error, _file: UploadFile, _fileList: UploadFile[]) => any) | undefined
      onSuccess?:
        | ((_response: unknown, _file: UploadFile, _fileList: UploadFile[]) => any)
        | undefined
