...
export declare const YhMention: import('@yh-ui/utils').SFCWithInstall<
  {
    new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<
      Readonly<import('./index.js').MentionProps> &
        Readonly<{
          onInput?: ((value: string) => any) | undefined
          onSearch?: ((keyword: string, trigger: string) => any) | undefined
          onSelect?:
            | ((option: import('./index.js').MentionOption, trigger: string) => any)
            | undefined
  ...
  > &
    ...
    (new () => {
      $slots: {
        ...
        option?: (props: { option: import('./index.js').MentionOption; keyword: string }) => any
      }
    })
> &
