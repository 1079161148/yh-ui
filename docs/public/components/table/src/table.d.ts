 ...
 */
import type { ExtractPropTypes, PropType, InjectionKey, CSSProperties, VNode, Component, VNodeChild } from 'vue';
...
export interface TableSortConfig {
    ...
    /** 自定义排序方法合集 */
    sortMethods?: Record<string, (a: Record<string, unknown>, b: Record<string, unknown>, order: SortOrder) => number>;
}
...
export declare const tableProps: {
    ...
    /** 是否显示边框 */
    readonly border: {
        readonly type: PropType<boolean | "full" | "outer" | "inner" | "none">;
    ...
    /** 排序配置 */
    readonly sortConfig: {
        readonly type: PropType<TableSortConfig>;
    };
    /** 筛选配置 */
    readonly filterConfig: {
        readonly type: PropType<TableFilterConfig>;
    };
    /** 分页配置 */
    readonly pagination: {
        readonly type: PropType<boolean | TablePaginationConfig>;
        readonly default: false;
    };
    /** 选择配置 */
    readonly selectionConfig: {
        readonly type: PropType<TableSelectionConfig>;
    };
    /** 展开配置 */
    readonly expandConfig: {
        readonly type: PropType<TableExpandConfig>;
    };
    /** 树形配置 */
    readonly treeConfig: {
        readonly type: PropType<TableTreeConfig>;
    };
    /** 虚拟滚动配置 */
    readonly virtualConfig: {
        readonly type: PropType<TableVirtualConfig>;
    };
    /** 拖拽配置 */
    readonly dragConfig: {
        readonly type: PropType<TableDragConfig>;
    };
    /** 汇总配置 */
    readonly summaryConfig: {
        readonly type: PropType<TableSummaryConfig>;
    };
    /** 工具栏配置 */
    readonly toolbarConfig: {
        readonly type: PropType<TableToolbarConfig>;
    };
    /** 空状态配置 */
    readonly emptyConfig: {
        readonly type: PropType<TableEmptyConfig>;
    };
    /** 加载配置 */
    readonly loading: {
        readonly type: PropType<boolean | TableLoadingConfig>;
        readonly default: false;
    };
    /** 行配置 */
    readonly rowConfig: {
        readonly type: PropType<TableRowConfig>;
    };
    /** 表头配置 */
    readonly headerConfig: {
        readonly type: PropType<TableHeaderConfig>;
    };
    /** 右键菜单配置 */
    readonly contextMenuConfig: {
        readonly type: PropType<TableContextMenuConfig>;
    };
    /** 表格布局 */
    ...
    readonly rowClassName: {
        readonly type: PropType<string | ((params: {
            row: Record<string, unknown>;
            rowIndex: number;
        }) => string)>;
    };
    /** 行样式 */
    readonly rowStyle: {
        readonly type: PropType<CSSProperties | ((params: {
            row: Record<string, unknown>;
            rowIndex: number;
        }) => CSSProperties)>;
    };
    ...
    /** 懒加载方法 */
    readonly loadMethod: {
        readonly type: PropType<(row: Record<string, unknown>) => Promise<Record<string, unknown>[]>>;
    };
    /** 是否可调整列宽 */
    readonly resizable: {
        readonly type: BooleanConstructor;
...
export declare const tableEmits: {
    /** 排序变化 */
    readonly 'sort-change': (_params: {
        column: TableColumn;
        prop: string;
        order: SortOrder;
    }) => boolean;
    /** 筛选变化 */
    readonly 'filter-change': (_filters: Record<string, unknown[]>) => boolean;
    /** 分页变化 */
    readonly 'page-change': (_params: {
        currentPage: number;
        pageSize: number;
    }) => boolean;
    /** 选择变化 */
    readonly 'selection-change': (_selectedRows: Record<string, unknown>[], _selectedRowKeys: Array<string | number>) => boolean;
    /** 当前行变化 */
    readonly 'current-change': (_currentRow: Record<string, unknown> | null, _oldRow: Record<string, unknown> | null) => boolean;
    /** 展开变化 */
    readonly 'expand-change': (_row: Record<string, unknown>, _expandedRows: Record<string, unknown>[]) => boolean;
    /** 行点击 */
    readonly 'row-click': (_row: Record<string, unknown>, _column: TableColumn, _event: MouseEvent) => boolean;
    /** 行双击 */
    readonly 'row-dblclick': (_row: Record<string, unknown>, _column: TableColumn, _event: MouseEvent) => boolean;
    /** 行右键 */
    readonly 'row-contextmenu': (_row: Record<string, unknown>, _column: TableColumn, _event: MouseEvent) => boolean;
    /** 单元格点击 */
    readonly 'cell-click': (_row: Record<string, unknown>, _column: TableColumn, _cell: HTMLElement, _event: MouseEvent) => boolean;
    /** 单元格双击 */
    readonly 'cell-dblclick': (_row: Record<string, unknown>, _column: TableColumn, _cell: HTMLElement, _event: MouseEvent) => boolean;
    /** 表头点击 */
    readonly 'header-click': (_column: TableColumn, _event: MouseEvent) => boolean;
    /** 表头右键 */
    readonly 'header-contextmenu': (_column: TableColumn, _event: MouseEvent) => boolean;
    /** 全选 */
    readonly 'select-all': (_selection: Record<string, unknown>[]) => boolean;
    /** 选择行 */
    readonly select: (_selection: Record<string, unknown>[], _row: Record<string, unknown>) => boolean;
    /** 滚动事件 */
    readonly scroll: (_params: {
        scrollTop: number;
        scrollLeft: number;
        isEnd: boolean;
    }) => boolean;
    /** 拖拽结束 */
    readonly 'drag-end': (_params: {
        type: "row" | "column";
        oldIndex: number;
        newIndex: number;
        data: unknown[];
    ...
    /** 列宽变化 */
    readonly 'column-resize': (_column: TableColumn, _width: number) => boolean;
    /** 列可见性变化 */
    readonly 'column-visible-change': (_columns: TableColumn[]) => boolean;
    /** 数据更新 */
    readonly 'update:data': (_data: Record<string, unknown>[]) => boolean;
    /** 当前行 key 更新 */
    readonly 'update:currentRowKey': (_key: string | number | undefined) => boolean;
};
