...
exports.tableProps = exports.tableEmits = exports.tableContextKey = void 0;
...
const tableEmits = exports.tableEmits = {
  /** 排序变化 */
...
const tableContextKey = exports.tableContextKey = Symbol("tableContextKey");