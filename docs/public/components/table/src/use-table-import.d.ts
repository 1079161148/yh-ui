...
export declare function useTableImport(data: Ref<Record<string, unknown>[]>, columns: Ref<TableColumn[]>): {
    importFile: (file: File, config?: ImportConfig) => Promise<Record<string, unknown>[]>;
    importData: (content: string | Record<string, unknown>[], config?: ImportConfig) => Promise<Record<string, unknown>[]>;
