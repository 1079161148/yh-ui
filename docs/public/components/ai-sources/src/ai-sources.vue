...
const getFileIcon = (type) => fileTypeIcons[type ?? "default"] ?? fileTypeIcons.default;
      ...
      >
        ...
        <div :class="ns.e('drawer-content')">
          <div
            v-for="source in sources"
            :key="source.id"
            :ref="el => sourceRefs[source.id] = el"
            :class="[ns.e('source-card'), ns.is('active', activeSource?.id === source.id), ns.is('highlighted', highlightedSourceId === source.id)]"
...
.yh-ai-sources--badge .yh-ai-sources__badge-row {
  display: flex;
  flex-wrap: wrap;
  gap: 4px;
}

.yh-ai-sources__badge {
  display: inline-flex;
  align-items: center;
  gap: 3px;
  padding: 2px 7px;
...
.yh-ai-sources__badge .yh-icon {
  font-size: 11px;
}
.yh-ai-sources__badge:hover {
  background: var(--yh-color-primary);
  color: #fff;
  border-color: var(--yh-color-primary);
}

.yh-ai-sources__drawer {
  position: fixed;
  top: 0;
  right: 0;
  height: 100%;
...
.yh-ai-sources__drawer-close:hover {
  background: var(--yh-fill-color);
  color: var(--yh-text-color-primary);
}

.yh-ai-sources__drawer-content {
  flex: 1;
  overflow-y: auto;
  padding: 12px;
  display: flex;
...
.yh-ai-sources--inline {
  display: flex;
  flex-direction: column;
  gap: 8px;
}

.yh-ai-sources__inline-header {
  display: flex;
  align-items: center;
  gap: 6px;
  font-size: 12px;
...
.yh-ai-sources__inline-list {
  display: flex;
  flex-direction: column;
  gap: 4px;
}

.yh-ai-sources__inline-item {
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 6px 10px;
...
.yh-ai-sources__inline-item:hover {
  background: var(--yh-fill-color-light);
}

.yh-ai-sources__inline-index {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: 18px;
...
.yh-ai-sources__file-icon {
  font-size: 13px;
  color: var(--yh-text-color-secondary);
  flex-shrink: 0;
}

.yh-ai-sources__inline-title {
  flex: 1;
  font-size: 13px;
  color: var(--yh-text-color-primary);
  overflow: hidden;
...
.yh-ai-sources__inline-score {
  font-size: 11px;
  font-weight: 600;
  flex-shrink: 0;
}

.yh-ai-sources__inline-open {
  display: flex;
  align-items: center;
  padding: 2px 4px;
  border: none;
...
.yh-ai-sources__inline-item:hover .yh-ai-sources__inline-open {
  opacity: 1;
}
.yh-ai-sources__inline-open:hover {
  color: var(--yh-color-primary);
  background: var(--yh-color-primary-light-9);
}

.yh-ai-sources__tooltip-content {
  width: 280px;
  max-width: 90vw;
  /* Redundant styles removed to rely on YhTooltip base styles */
}

.yh-ai-sources__tooltip-header {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 8px;
...
.yh-ai-sources__tooltip-title-wrap {
  display: flex;
  align-items: center;
  gap: 6px;
  min-width: 0;
...
.yh-ai-sources__tooltip-score {
  font-size: 11px;
  font-weight: 600;
  white-space: nowrap;
}

.yh-ai-sources__tooltip-excerpt {
  font-size: 12px;
...
.yh-ai-sources__card-list-header {
  display: flex;
  align-items: center;
  gap: 8px;
  font-size: 13px;
...
.yh-ai-sources__card-list {
  display: flex;
  flex-direction: column;
  gap: 8px;
}

.yh-ai-sources__source-card {
  padding: 12px 14px;
...
.yh-ai-sources__source-card:hover {
  border-color: var(--yh-color-primary-light-5);
  background: var(--yh-color-primary-light-9);
}
.yh-ai-sources__source-card.is-active {
  border-color: var(--yh-color-primary-light-5);
  background: var(--yh-color-primary-light-9);
}
.yh-ai-sources__source-card.is-highlighted {
  border-color: var(--yh-color-primary) !important;
  background-color: var(--yh-color-primary-light-9) !important;
  box-shadow: 0 0 0 2px var(--yh-color-primary-light-8) !important;
  animation: yh-source-highlight-pulse 2s ease-in-out;
}

.yh-ai-sources__card-header {
  display: flex;
  flex-direction: column;
  gap: 4px;
  margin-bottom: 6px;
...
.yh-ai-sources__card-title-row {
  display: flex;
  align-items: center;
  gap: 6px;
}

.yh-ai-sources__card-title {
  font-size: 13px;
  font-weight: 600;
  color: var(--yh-text-color-primary);
  overflow: hidden;
...
.yh-ai-sources__card-meta {
  display: flex;
  align-items: center;
  gap: 8px;
}

.yh-ai-sources__source-name {
  font-size: 11px;
  color: var(--yh-text-color-secondary);
}

.yh-ai-sources__score-badge {
  font-size: 11px;
  font-weight: 600;
}

.yh-ai-sources__excerpt {
  font-size: 12px;
  color: var(--yh-text-color-regular);
  line-height: 1.6;
  margin: 0 0 8px;
...
.yh-ai-sources__open-btn:hover {
  background: var(--yh-color-primary-light-8);
}

.yh-ai-sources__expand-btn {
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
.yh-ai-sources__expand-btn:hover {
  border-color: var(--yh-color-primary);
  color: var(--yh-color-primary);
  background: var(--yh-color-primary-light-9);
}

@keyframes yh-source-highlight-pulse {
  0% {
    transform: scale(1);
  }
  10% {
