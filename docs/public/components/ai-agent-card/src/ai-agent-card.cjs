...
exports.aiAgentCardProps = exports.aiAgentCardEmits = void 0;
const aiAgentCardProps = exports.aiAgentCardProps = {
  /**
...
const aiAgentCardEmits = exports.aiAgentCardEmits = {
  /** 点击整个卡片 */
  click: data => !!data,
  /** 点击使用 / 调用按钮 */
  use: data => !!data,
