...
.yh-affix {
  position: relative;
  --yh-affix-z-index: var(--yh-z-index-fixed);
  --yh-affix-shadow: var(--yh-shadow-md);
  --yh-affix-transition-duration: var(--yh-duration-base);
  --yh-affix-transition-timing: cubic-bezier(0.4, 0, 0.2, 1);
}
.yh-affix__inner {
  transition: all var(--yh-affix-transition-duration) var(--yh-affix-transition-timing);
}
.yh-affix__inner.is-fixed {
  box-shadow: var(--yh-affix-shadow);
  z-index: var(--yh-affix-z-index);
}

:root.dark .yh-affix,
html.dark .yh-affix,
body.dark .yh-affix {
  --yh-affix-shadow: var(--yh-shadow-lg);
}
</style>
