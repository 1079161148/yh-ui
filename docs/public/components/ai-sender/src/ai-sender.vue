...
<template>
  <div
    :class="[ns.b(), ns.is('disabled', disabled), ns.is('loading', loading), ns.is('focused', isFocused)]"
    :style="themeStyle"
...
.yh-ai-sender {
  --yh-ai-sender-bg: var(--yh-ai-sender-bg-color, var(--yh-bg-color-overlay));
  --yh-ai-sender-border-color: var(--yh-ai-sender-border-color, var(--yh-border-color));
  --yh-ai-sender-focus-border-color: var(
    --yh-ai-sender-focus-border-color,
    var(--yh-color-primary)
  );
  --yh-ai-sender-border-radius: var(--yh-ai-sender-border-radius, 16px);
  --yh-ai-sender-shadow: var(--yh-ai-sender-box-shadow, 0 4px 16px rgba(0, 0, 0, 0.08));
  --yh-ai-sender-focus-shadow: var(
    --yh-ai-sender-focus-box-shadow,
    0 6px 20px rgba(var(--yh-color-primary-rgb), 0.15)
  );
  width: 100%;
  position: relative;
  border-radius: var(--yh-ai-sender-border-radius);
  background-color: var(--yh-ai-sender-bg);
  box-shadow: var(--yh-ai-sender-shadow);
  border: 1px solid var(--yh-ai-sender-border-color);
  transition: all 0.3s ease;
}
.yh-ai-sender.is-focused {
  border-color: var(--yh-ai-sender-focus-border-color);
  box-shadow: var(--yh-ai-sender-focus-shadow);
}

.yh-ai-sender.is-disabled {
  background-color: var(--yh-fill-color-light);
  opacity: 0.7;
  cursor: not-allowed;
}

.yh-ai-sender__input-wrapper {
  display: flex;
  flex-wrap: wrap;
...
.yh-ai-sender__attachment-item.is-uploading {
  opacity: 0.8;
}

.yh-ai-sender__attachment-item:hover {
  background: var(--yh-fill-color-lighter);
}
.yh-ai-sender__attachment-item:hover .yh-ai-sender__attachment-remove {
  opacity: 1;
}

.yh-ai-sender__attachment-preview {
  width: 32px;
  height: 32px;
  border-radius: 4px;
  overflow: hidden;
...
.yh-ai-sender__attachment-preview img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}
.yh-ai-sender__attachment-preview .yh-icon {
  font-size: 18px;
  color: var(--yh-text-color-secondary);
}

.yh-ai-sender__attachment-info {
  flex: 1;
  min-width: 0;
}

.yh-ai-sender__attachment-name {
  font-size: 12px;
...
.yh-ai-sender__attachment-progress {
  width: 100%;
  height: 2px;
...
.yh-ai-sender__progress-bar {
  height: 100%;
  background: var(--yh-color-primary);
  transition: width 0.3s;
}

.yh-ai-sender__attachment-remove {
  position: absolute;
  top: -8px;
  right: -8px;
  width: 18px;
  height: 18px;
  border-radius: 50%;
  background: var(--yh-text-color-regular);
  color: #fff;
  display: flex;
  align-items: center;
  justify-content: center;
...
.yh-ai-sender__attachment-remove .yh-icon {
  font-size: 10px;
}
.yh-ai-sender__attachment-remove:hover {
  background: var(--yh-color-danger);
  transform: scale(1.1);
}

.yh-ai-sender__prefix {
  display: flex;
  align-items: center;
  padding-bottom: 4px;
}

.yh-ai-sender__textarea-container {
  flex: 1;
  display: flex;
...
.yh-ai-sender__textarea::placeholder {
  color: var(--yh-text-color-placeholder);
}
.yh-ai-sender__textarea:disabled {
  cursor: not-allowed;
}

.yh-ai-sender__suffix {
  display: flex;
  flex-direction: column;
  align-items: center;
...
.yh-ai-sender__word-limit {
  font-size: 12px;
  color: var(--yh-text-color-placeholder);
}

.yh-ai-sender__clear-icon {
  color: var(--yh-text-color-placeholder);
  cursor: pointer;
  transition: color 0.2s;
  font-size: 16px;
}
.yh-ai-sender__clear-icon:hover {
  color: var(--yh-text-color-regular);
}

.yh-ai-sender__actions {
  display: flex;
  justify-content: flex-end;
  align-items: center;
  gap: 8px;
...
.yh-ai-sender__send-btn {
  transition: transform 0.2s cubic-bezier(0.34, 1.56, 0.64, 1);
}
.yh-ai-sender__send-btn:not(:disabled):hover {
  transform: scale(1.05);
}
.yh-ai-sender__send-btn:active {
  transform: scale(0.95);
}

.yh-ai-sender__command-panel {
  position: absolute;
  bottom: calc(100% + 8px);
  left: 0;
  right: 0;
  ...
  animation: yh-fade-in-up 0.3s cubic-bezier(0.23, 1, 0.32, 1);
}

.yh-ai-sender__command-item {
  display: flex;
  align-items: center;
  gap: 12px;
  padding: 8px 12px;
...
.yh-ai-sender__command-item.is-active {
  background: var(--yh-fill-color-light);
}
.yh-ai-sender__command-item.is-active .yh-ai-sender__command-label {
  color: var(--yh-color-primary);
}

.yh-ai-sender__command-item:hover {
  background: var(--yh-fill-color-lighter);
}

.yh-ai-sender__command-icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 28px;
...
.yh-ai-sender__command-info {
  flex: 1;
  min-width: 0;
}

.yh-ai-sender__command-label {
  font-size: 14px;
  font-weight: 600;
  color: var(--yh-text-color-primary);
  line-height: 1.4;
...
.yh-ai-sender__drag-overlay {
  ...
  align-items: center;
  justify-content: center;
  background: rgba(var(--yh-color-primary-rgb), 0.1);
  backdrop-filter: blur(4px);
  border: 2px dashed var(--yh-color-primary);
  border-radius: 12px;
  transition: all 0.3s ease;
  pointer-events: none;
}

.yh-ai-sender__drag-message {
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 12px;
...
.yh-ai-sender__drag-message .yh-icon {
  font-size: 32px;
}

@keyframes yh-sender-fade-in {
  from {
    opacity: 0;
    transform: translateY(10px);
  }
