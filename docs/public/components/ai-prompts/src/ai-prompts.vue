...
.yh-ai-prompts__header {
  font-size: var(--yh-ai-prompts-header-font-size, 14px);
  font-weight: 500;
...
.yh-ai-prompts__item {
  ...
  padding: 12px 16px;
  border: 1px solid var(--yh-ai-prompts-border-color, var(--yh-border-color));
  border-radius: var(--yh-ai-prompts-border-radius, var(--yh-border-radius-base));
  background-color: var(--yh-ai-prompts-bg-color, var(--yh-bg-color));
  cursor: pointer;
  transition: all var(--yh-transition-duration);
  min-height: var(--yh-ai-prompts-item-min-height, 48px);
}
.yh-ai-prompts__item:hover {
  border-color: var(--yh-ai-prompts-active-border-color, var(--yh-color-primary));
  background-color: var(--yh-ai-prompts-item-hover-bg-color, var(--yh-color-primary-light-9));
  color: var(--yh-ai-prompts-hover-text-color, var(--yh-color-primary));
}
.yh-ai-prompts__item:hover .yh-ai-prompts__arrow {
  transform: translateX(4px);
  opacity: 1;
}

.yh-ai-prompts__item-inner {
  display: flex;
  align-items: center;
  width: 100%;
  gap: 12px;
...
.yh-ai-prompts__icon {
  ...
  font-size: var(--yh-ai-prompts-icon-size, 20px);
  color: var(--yh-ai-prompts-icon-color, var(--yh-color-primary));
}

.yh-ai-prompts__arrow {
  display: flex;
  align-items: center;
...
.yh-ai-prompts--horizontal .yh-ai-prompts__list {
  flex-direction: row;
  flex-wrap: wrap;
}
.yh-ai-prompts--horizontal .yh-ai-prompts__item {
  flex: 1;
  min-width: 200px;
}

.yh-ai-prompts--vertical .yh-ai-prompts__list {
  flex-direction: column;
}
.yh-ai-prompts--vertical .yh-ai-prompts__item {
  width: 100%;
}

.yh-ai-prompts--waterfall .yh-ai-prompts__list {
  flex-direction: row;
  flex-wrap: wrap;
}
.yh-ai-prompts--waterfall .yh-ai-prompts__item {
  width: auto;
  min-width: fit-content;
  max-width: 100%;
}
.yh-ai-prompts--waterfall .yh-ai-prompts__text {
  white-space: nowrap;
  overflow: hidden;
