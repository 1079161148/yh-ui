...
const markList = computed(() => {
  ...
  return marksKeys.map((key) => {
    ...
    return {
      ...
      label: typeof mark === "string" ? { label: mark, style: void 0 } : mark ?? { label: "", style: void 0 }
    };
  });
});
...
.yh-slider {
  --yh-slider-main-color: var(--yh-color-primary);
  --yh-slider-main-color-rgb: 64, 158, 255;
  --yh-slider-secondary-color: var(--yh-color-primary);
  --yh-slider-bg-color: var(--yh-border-color-light);
  --yh-slider-hover-bg-color: var(--yh-border-color-dark);
  --yh-slider-button-size: 16px;
  --yh-slider-button-border: 2px;
  --yh-slider-runway-height: 6px;
  --yh-slider-transition: var(--yh-transition-base);
  display: inline-flex;
  align-items: center;
  width: 100%;
  height: var(--yh-slider-height, 32px);
  position: relative;
  user-select: none;
  box-sizing: border-box;
}
.yh-slider.is-vertical {
  display: inline-flex;
  width: auto;
  height: 100%;
...
.yh-slider.is-vertical .yh-slider__runway {
  width: var(--yh-slider-runway-height);
  height: 100%;
  flex: 1;
  margin: 0;
  position: relative;
...
.yh-slider.is-vertical .yh-slider__button-wrapper {
  left: 50%;
...
.yh-slider.is-vertical .yh-slider__bar {
  width: 100%;
  height: auto;
  left: 0;
  bottom: 0;
  top: auto;
  background: linear-gradient(to top, var(--yh-slider-main-color), var(--yh-slider-secondary-color));
}

.yh-slider.is-vertical .yh-slider__stop {
  left: 50%;
  top: auto;
  transform: translate(-50%, 50%);
}

.yh-slider.is-vertical .yh-slider__marks {
  position: absolute;
  left: 18px;
  top: 0;
  bottom: 0;
...
.yh-slider.is-vertical .yh-slider__mark-text {
  left: 0;
  top: auto;
...
.yh-slider.is-vertical .yh-slider__input {
  margin-right: 0;
  margin-top: 20px;
  width: 50px;
}
...
.yh-slider__runway {
  flex: 1;
  height: var(--yh-slider-runway-height);
  background-color: var(--yh-slider-bg-color);
  border-radius: 3px;
  position: relative;
  cursor: pointer;
  vertical-align: middle;
}
.yh-slider__runway:hover {
  background-color: var(--yh-slider-hover-bg-color);
}

.yh-slider.is-disabled .yh-slider__runway {
  cursor: not-allowed;
  background-color: var(--yh-fill-color-light);
}
.yh-slider.is-disabled .yh-slider__runway:hover {
  background-color: var(--yh-fill-color-light);
}

.yh-slider.is-disabled .yh-slider__bar {
  background: var(--yh-text-color-placeholder);
  box-shadow: none;
}

.yh-slider.is-disabled .yh-slider__button {
  border-color: var(--yh-text-color-placeholder);
  background-color: var(--yh-bg-color);
  cursor: not-allowed;
}
.yh-slider.is-disabled .yh-slider__button:hover {
  transform: none;
  box-shadow: none;
}

.yh-slider.is-disabled .yh-slider__button-wrapper {
  cursor: not-allowed;
}
...
.yh-slider__bar {
  ...
  background: linear-gradient(90deg, var(--yh-slider-main-color), var(--yh-slider-secondary-color));
  box-shadow: 0 4px 12px rgba(var(--yh-slider-main-color-rgb, 64, 158, 255), 0.2);
  transition: width var(--yh-duration-base), left var(--yh-duration-base), height var(--yh-duration-base), bottom var(--yh-duration-base);
}

.yh-slider__button-wrapper {
  position: absolute;
  top: 50%;
  transform: translate(-50%, -50%);
  width: 24px;
  ...
  z-index: 10;
  cursor: grab;
  transition: left var(--yh-duration-base), bottom var(--yh-duration-base);
}
.yh-slider__button-wrapper:active {
  cursor: grabbing;
}
.yh-slider__button-wrapper.is-dragging {
  z-index: 11;
}

.yh-slider__button {
  width: var(--yh-slider-button-size);
  height: var(--yh-slider-button-size);
  border: var(--yh-slider-button-border) solid var(--yh-slider-main-color);
  background-color: var(--yh-bg-color);
  border-radius: 50%;
  transition: var(--yh-slider-transition);
  box-shadow: var(--yh-shadow-sm);
}
.yh-slider__button.is-hover {
  transform: scale(1.2);
  box-shadow: 0 0 0 6px rgba(var(--yh-slider-main-color-rgb, 64, 158, 255), 0.15);
}

.yh-slider__button.is-dragging {
  transform: scale(1.2);
  box-shadow: 0 0 0 6px rgba(var(--yh-slider-main-color-rgb, 64, 158, 255), 0.15);
}
...
.yh-slider__tooltip-arrow {
  position: absolute;
  top: 100%;
  left: 50%;
  transform: translateX(-50%);
  border: 5px solid transparent;
  border-top-color: var(--yh-text-color-primary);
}

.yh-slider--large {
  --yh-slider-height: 48px;
  --yh-slider-runway-height: 10px;
  --yh-slider-button-size: 24px;
}

.yh-slider--small {
  --yh-slider-height: 24px;
  --yh-slider-runway-height: 4px;
  --yh-slider-button-size: 12px;
}
