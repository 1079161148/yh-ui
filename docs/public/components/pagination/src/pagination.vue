...
const emit = defineEmits(["update:currentPage", "update:pageSize", "current-change", "size-change", "prev-click", "next-click"]);
    ...
    <template v-for="item in layoutComponents" :key="item">
      ...
      <div v-if="item === 'sizes'" :class="ns.e('sizes')">
        <yh-select :model-value="pageSize" :disabled="disabled" :size="small ? 'small' : 'default'"
          @update:model-value="val => handleSizeChange(Number(val))">
...
.yh-pagination {
  ...
  --yh-pagination-border-radius: 2px;
  --yh-pagination-btn-width: 32px;
  --yh-pagination-btn-height: 32px;
  --yh-pagination-btn-bg-color: transparent;
  ...
  flex-wrap: nowrap;
  color: var(--yh-pagination-text-color);
  font-size: var(--yh-pagination-font-size);
  user-select: none;
  gap: 8px;
...
.yh-pagination, .yh-pagination * {
  box-sizing: border-box;
}
.yh-pagination.is-small {
  --yh-pagination-font-size: 12px;
  --yh-pagination-btn-width: 24px;
  --yh-pagination-btn-height: 24px;
  gap: 4px;
}
.yh-pagination__total {
  display: inline-flex;
  align-items: center;
  ...
  height: var(--yh-pagination-btn-height);
  white-space: nowrap;
  vertical-align: middle;
  flex-shrink: 0;
}

.yh-pagination__sizes {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  margin: 0;
...
.yh-pagination__sizes .yh-select {
  width: 110px;
  margin: 0 !important;
}

.yh-pagination__pager {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  margin: 0;
...
.yh-pagination__item {
  ...
  align-items: center;
  justify-content: center;
  min-width: var(--yh-pagination-btn-width);
  height: var(--yh-pagination-btn-height);
  margin: 0;
  padding: 0 4px;
  background-color: var(--yh-pagination-btn-bg-color);
  border: 1px solid var(--yh-border-color-lighter);
  border-radius: var(--yh-pagination-border-radius);
  cursor: pointer;
  font-weight: normal;
  transition: all 0.2s;
  color: inherit;
...
.yh-pagination__item:hover {
  color: var(--yh-pagination-btn-hover-color);
  border-color: var(--yh-pagination-btn-hover-color);
}
.yh-pagination__item.is-active {
  color: var(--yh-pagination-item-active-color);
  background-color: var(--yh-pagination-item-active-bg-color);
  border-color: var(--yh-pagination-item-active-bg-color);
  font-weight: bold;
  cursor: default;
}
...
.yh-pagination__jumper .yh-input {
  width: 50px !important;
  margin: 0 4px !important;
}
.yh-pagination__jumper .yh-input input {
  padding: 0 !important;
  text-align: center;
}

.yh-pagination .yh-select,
.yh-pagination .yh-input,
.yh-pagination .yh-button {
  margin: 0 !important;
  vertical-align: middle;
}
.yh-pagination .yh-pagination__prev, .yh-pagination .yh-pagination__next {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: var(--yh-pagination-btn-width);
...
.yh-pagination .yh-pagination__prev svg, .yh-pagination .yh-pagination__next svg {
  display: block;
  width: 14px;
  height: 14px;
  margin: 0;
}
.yh-pagination .yh-pagination__prev:hover:not(:disabled), .yh-pagination .yh-pagination__next:hover:not(:disabled) {
  color: var(--yh-pagination-btn-hover-color);
  border-color: var(--yh-pagination-btn-hover-color);
}
.yh-pagination .yh-pagination__prev:disabled, .yh-pagination .yh-pagination__next:disabled {
  color: var(--yh-text-color-placeholder);
  background-color: var(--yh-fill-color-light);
  cursor: not-allowed;
}
.yh-pagination:not(.is-background) .yh-pagination__item {
  background-color: transparent;
  border: 1px solid var(--yh-border-color-lighter);
  color: var(--yh-text-color-regular);
}
.yh-pagination:not(.is-background) .yh-pagination__item:not(.is-active):hover {
  color: var(--yh-pagination-btn-hover-color);
  border-color: var(--yh-pagination-btn-hover-color);
}
.yh-pagination:not(.is-background) .yh-pagination__item.is-active {
...
.yh-pagination:not(.is-background) .yh-pagination__prev, .yh-pagination:not(.is-background) .yh-pagination__next {
  background-color: transparent;
  border: 1px solid var(--yh-border-color-lighter);
}
.yh-pagination:not(.is-background) .yh-pagination__prev:not(:disabled):hover, .yh-pagination:not(.is-background) .yh-pagination__next:not(:disabled):hover {
  color: var(--yh-pagination-btn-hover-color);
  border-color: var(--yh-pagination-btn-hover-color);
}
.yh-pagination.is-background .yh-pagination__item {
  background-color: var(--yh-fill-color-light);
  border: none;
  color: var(--yh-text-color-regular);
}
.yh-pagination.is-background .yh-pagination__item:not(.is-active):hover {
  background-color: var(--yh-fill-color-darker);
  color: var(--yh-color-primary);
}
.yh-pagination.is-background .yh-pagination__item.is-active {
  background-color: var(--yh-pagination-item-active-bg-color);
  color: #ffffff;
  border: none;
  font-weight: bold;
...
.yh-pagination.is-background .yh-pagination__prev, .yh-pagination.is-background .yh-pagination__next {
  background-color: var(--yh-fill-color-light);
  border: none;
}
.yh-pagination.is-background .yh-pagination__prev:not(:disabled):hover, .yh-pagination.is-background .yh-pagination__next:not(:disabled):hover {
  background-color: var(--yh-fill-color-darker);
  color: var(--yh-pagination-btn-hover-color);
}

.yh-pagination.is-background .yh-pagination__more {
  background-color: var(--yh-fill-color-light);
  border-radius: var(--yh-pagination-border-radius);
}

.yh-pagination.is-circle .yh-pagination__item, .yh-pagination.is-circle .yh-pagination__prev, .yh-pagination.is-circle .yh-pagination__next {
  border-radius: 50% !important;
}

.yh-pagination.is-disabled {
  opacity: 0.5;
  cursor: not-allowed;
}
.yh-pagination.is-disabled .yh-pagination__item, .yh-pagination.is-disabled .yh-pagination__prev, .yh-pagination.is-disabled .yh-pagination__next, .yh-pagination.is-disabled .yh-pagination__more {
