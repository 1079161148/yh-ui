...
.yh-button {
  /* 基础变量与默认行为 */
  --yh-button-height: var(--yh-component-size-default);
  --yh-button-bg-color: var(--yh-fill-color-blank);
  ...
  --yh-button-hover-border-color: var(--yh-color-primary-light-8);
  --yh-button-active-bg-color: var(--yh-color-primary-light-8);
  ...
  height: var(--yh-button-height);
  padding: var(--yh-button-padding, 0 var(--yh-component-size-default-padding));
  font-size: var(--yh-button-font-size, var(--yh-component-size-default-font));
  ...
  border: var(--yh-border-width) var(--yh-border-style) var(--yh-button-border-color);
  border-radius: var(--yh-radius-base);
  outline: none;
  transition: var(--yh-transition-fast);
}
.yh-button:hover, .yh-button:focus {
...
.yh-button:active {
  ...
  color: var(--yh-button-active-text-color, var(--yh-button-hover-text-color));
}
.yh-button {
  /* 自定义颜色反馈 */
}
.yh-button.is-custom-color:hover, .yh-button.is-custom-color:focus {
  filter: brightness(1.1);
}
.yh-button.is-custom-color:active {
  filter: brightness(0.9);
}
.yh-button.is-custom-color.is-plain:hover {
  background-color: var(--yh-button-border-color) !important;
}

.yh-button {
  /* 垂直布局 */
}
.yh-button.is-vertical {
  flex-direction: column;
  height: auto;
  padding: 12px;
  gap: 4px;
}
.yh-button.is-vertical .yh-button__icon {
  margin: 0;
  font-size: 1.5em;
}
...
.yh-button.is-disabled {
  cursor: not-allowed !important;
  opacity: 0.5;
  pointer-events: none;
}

.yh-button.is-loading {
...
.yh-button.is-text:hover, .yh-button.is-text:focus {
  background-color: transparent;
...
.yh-button--primary {
  --yh-button-bg-color: var(--yh-color-primary);
  --yh-button-text-color: var(--yh-color-white, #ffffff);
  --yh-button-border-color: var(--yh-color-primary);
  --yh-button-hover-bg-color: var(--yh-color-primary-light-3);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-primary-light-3);
  --yh-button-active-bg-color: var(--yh-color-primary-dark-2);
  --yh-button-active-border-color: var(--yh-color-primary-dark-2);
}
.yh-button--primary.is-plain {
  --yh-button-bg-color: var(--yh-color-primary-light-9);
  --yh-button-text-color: var(--yh-color-primary);
  --yh-button-border-color: var(--yh-color-primary-light-5);
  --yh-button-hover-bg-color: var(--yh-color-primary);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-primary);
}

.yh-button--primary {
  /* 针对 Text 和 Link 模式的颜色覆盖 */
}
.yh-button--primary.is-text {
  --yh-button-text-color: var(--yh-color-primary);
  --yh-button-hover-text-color: var(--yh-color-primary-light-3);
  --yh-button-active-text-color: var(--yh-color-primary-dark-2);
}

.yh-button--primary.is-link {
  --yh-button-text-color: var(--yh-color-primary);
  --yh-button-hover-text-color: var(--yh-color-primary-light-3);
  --yh-button-active-text-color: var(--yh-color-primary-dark-2);
}
...
.yh-button--success {
  --yh-button-bg-color: var(--yh-color-success);
  --yh-button-text-color: var(--yh-color-white, #ffffff);
  --yh-button-border-color: var(--yh-color-success);
  --yh-button-hover-bg-color: var(--yh-color-success-light-3);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-success-light-3);
  --yh-button-active-bg-color: var(--yh-color-success-dark-2);
  --yh-button-active-border-color: var(--yh-color-success-dark-2);
}
.yh-button--success.is-plain {
  --yh-button-bg-color: var(--yh-color-success-light-9);
  --yh-button-text-color: var(--yh-color-success);
  --yh-button-border-color: var(--yh-color-success-light-5);
  --yh-button-hover-bg-color: var(--yh-color-success);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-success);
}

.yh-button--success {
  /* 针对 Text 和 Link 模式的颜色覆盖 */
}
.yh-button--success.is-text {
  --yh-button-text-color: var(--yh-color-success);
  --yh-button-hover-text-color: var(--yh-color-success-light-3);
  --yh-button-active-text-color: var(--yh-color-success-dark-2);
}

.yh-button--success.is-link {
  --yh-button-text-color: var(--yh-color-success);
  --yh-button-hover-text-color: var(--yh-color-success-light-3);
  --yh-button-active-text-color: var(--yh-color-success-dark-2);
}
...
.yh-button--warning {
  --yh-button-bg-color: var(--yh-color-warning);
  --yh-button-text-color: var(--yh-color-white, #ffffff);
  --yh-button-border-color: var(--yh-color-warning);
  --yh-button-hover-bg-color: var(--yh-color-warning-light-3);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-warning-light-3);
  --yh-button-active-bg-color: var(--yh-color-warning-dark-2);
  --yh-button-active-border-color: var(--yh-color-warning-dark-2);
}
.yh-button--warning.is-plain {
  --yh-button-bg-color: var(--yh-color-warning-light-9);
  --yh-button-text-color: var(--yh-color-warning);
  --yh-button-border-color: var(--yh-color-warning-light-5);
  --yh-button-hover-bg-color: var(--yh-color-warning);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-warning);
}

.yh-button--warning {
  /* 针对 Text 和 Link 模式的颜色覆盖 */
}
.yh-button--warning.is-text {
  --yh-button-text-color: var(--yh-color-warning);
  --yh-button-hover-text-color: var(--yh-color-warning-light-3);
  --yh-button-active-text-color: var(--yh-color-warning-dark-2);
}

.yh-button--warning.is-link {
  --yh-button-text-color: var(--yh-color-warning);
  --yh-button-hover-text-color: var(--yh-color-warning-light-3);
  --yh-button-active-text-color: var(--yh-color-warning-dark-2);
}
...
.yh-button--danger {
  --yh-button-bg-color: var(--yh-color-danger);
  --yh-button-text-color: var(--yh-color-white, #ffffff);
  --yh-button-border-color: var(--yh-color-danger);
  --yh-button-hover-bg-color: var(--yh-color-danger-light-3);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-danger-light-3);
  --yh-button-active-bg-color: var(--yh-color-danger-dark-2);
  --yh-button-active-border-color: var(--yh-color-danger-dark-2);
}
.yh-button--danger.is-plain {
  --yh-button-bg-color: var(--yh-color-danger-light-9);
  --yh-button-text-color: var(--yh-color-danger);
  --yh-button-border-color: var(--yh-color-danger-light-5);
  --yh-button-hover-bg-color: var(--yh-color-danger);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-danger);
}

.yh-button--danger {
  /* 针对 Text 和 Link 模式的颜色覆盖 */
}
.yh-button--danger.is-text {
  --yh-button-text-color: var(--yh-color-danger);
  --yh-button-hover-text-color: var(--yh-color-danger-light-3);
  --yh-button-active-text-color: var(--yh-color-danger-dark-2);
}

.yh-button--danger.is-link {
  --yh-button-text-color: var(--yh-color-danger);
  --yh-button-hover-text-color: var(--yh-color-danger-light-3);
  --yh-button-active-text-color: var(--yh-color-danger-dark-2);
}
...
.yh-button--info {
  --yh-button-bg-color: var(--yh-color-info);
  --yh-button-text-color: var(--yh-color-white, #ffffff);
  --yh-button-border-color: var(--yh-color-info);
  --yh-button-hover-bg-color: var(--yh-color-info-light-3);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-info-light-3);
  --yh-button-active-bg-color: var(--yh-color-info-dark-2);
  --yh-button-active-border-color: var(--yh-color-info-dark-2);
}
.yh-button--info.is-plain {
  --yh-button-bg-color: var(--yh-color-info-light-9);
  --yh-button-text-color: var(--yh-color-info);
  --yh-button-border-color: var(--yh-color-info-light-5);
  --yh-button-hover-bg-color: var(--yh-color-info);
  --yh-button-hover-text-color: var(--yh-color-white, #ffffff);
  --yh-button-hover-border-color: var(--yh-color-info);
}

.yh-button--info {
  /* 针对 Text 和 Link 模式的颜色覆盖 */
}
.yh-button--info.is-text {
  --yh-button-text-color: var(--yh-color-info);
  --yh-button-hover-text-color: var(--yh-color-info-light-3);
  --yh-button-active-text-color: var(--yh-color-info-dark-2);
}

.yh-button--info.is-link {
  --yh-button-text-color: var(--yh-color-info);
  --yh-button-hover-text-color: var(--yh-color-info-light-3);
  --yh-button-active-text-color: var(--yh-color-info-dark-2);
}
...
.yh-button--large {
  --yh-button-height: var(--yh-component-size-large);
  --yh-button-padding: 0 19px;
  --yh-button-font-size: var(--yh-component-size-large-font);
}
.yh-button--small {
  --yh-button-height: var(--yh-component-size-small);
  --yh-button-padding: 0 11px;
  --yh-button-font-size: var(--yh-component-size-small-font);
}
.yh-button.is-round {
...
.yh-button.is-circle {
  border-radius: var(--yh-radius-circle) !important;
  width: var(--yh-button-height);
  padding: 0;
  flex-shrink: 0;
}
...
.yh-button__loading-icon {
  display: inline-flex;
}

.yh-button__loading-svg {
  width: 1em;
  height: 1em;
  fill: currentColor;
  animation: yh-rotate 1.5s linear infinite;
}
