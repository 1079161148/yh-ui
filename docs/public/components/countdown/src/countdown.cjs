...
exports.calculateRemain = calculateRemain;
exports.countdownProps = exports.countdownEmits = void 0;
exports.createFormatContext = createFormatContext;
exports.formatCountdown = formatCountdown;
exports.isTargetTimestamp = isTargetTimestamp;
exports.padZero = padZero;
exports.parseTimeUnits = parseTimeUnits;
const countdownProps = exports.countdownProps = {
  /**
...
const TIME_CONSTANTS = exports.TIME_CONSTANTS = {
  /** 毫秒/秒 */
  SECOND: 1e3,
  /** 毫秒/分 */
  MINUTE: 60 * 1e3,
