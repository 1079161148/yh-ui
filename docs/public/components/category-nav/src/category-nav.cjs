...
exports.categoryNavProps = exports.categoryNavEmits = void 0;
const categoryNavProps = exports.categoryNavProps = {
  /** 分类数据 */
  categories: {
    type: Array,
    default: () => []
...
const categoryNavEmits = exports.categoryNavEmits = {
