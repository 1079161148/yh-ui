    ...
    <main ref="contentRef" :class="ns.e('content')" role="tabpanel" @scroll="onContentScroll">
      ...
      <template v-else>
        <div
          v-for="cat in categories"
          :key="cat.id"
          :ref="el => setSectionRef(el, cat.id)"
          :class="ns.e('section')"
          :data-id="cat.id"
        >
...
.yh-category-nav {
  --yh-category-nav-side-width: 84px;
  --yh-category-nav-side-bg: var(--yh-fill-color-lighter);
  --yh-category-nav-side-active-bg: var(--yh-bg-color);
  --yh-category-nav-side-active-color: var(--yh-color-primary);
  --yh-category-nav-side-active-indicator: 3px solid var(--yh-color-primary);
  --yh-category-nav-content-bg: var(--yh-bg-color);
  --yh-category-nav-sub-image-size: 64px;
  --yh-category-nav-columns: 3;
  --yh-category-nav-section-title-color: var(--yh-text-color-secondary);
  --yh-category-nav-sub-active-color: var(--yh-color-primary);
  --yh-category-nav-height: 100%;
  display: flex;
  height: var(--yh-category-nav-height);
  overflow: hidden;
  background: var(--yh-category-nav-content-bg);
}
.yh-category-nav__side {
  position: relative;
  width: var(--yh-category-nav-side-width);
  flex-shrink: 0;
  background: var(--yh-category-nav-side-bg);
  overflow-y: auto;
  scrollbar-width: none;
  -ms-overflow-style: none;
  border-right: 1px solid var(--yh-border-color-lighter);
}
.yh-category-nav__side::-webkit-scrollbar {
  display: none;
}

.yh-category-nav__side-item {
  position: relative;
  display: flex;
...
.yh-category-nav__side-item.is-active {
  background: var(--yh-category-nav-side-active-bg);
  color: var(--yh-category-nav-side-active-color);
  font-weight: 600;
}
.yh-category-nav__side-item.is-active::before {
  content: "";
  position: absolute;
  left: 0;
  top: 20%;
  ...
  background: var(--yh-category-nav-side-active-color, var(--yh-color-primary));
}

.yh-category-nav__badge {
  position: absolute;
  top: 4px;
  right: 4px;
  min-width: 16px;
...
.yh-category-nav__side-icon {
  font-size: 22px;
  color: inherit;
}

.yh-category-nav__side-name {
  font-size: var(--yh-font-size-xs);
  line-height: 1.3;
  word-break: break-all;
}

.yh-category-nav__content {
  flex: 1;
  overflow-y: auto;
  background: var(--yh-category-nav-content-bg);
  scrollbar-width: thin;
  scrollbar-color: var(--yh-border-color-lighter) transparent;
}
.yh-category-nav__content::-webkit-scrollbar {
  width: 4px;
}
.yh-category-nav__content::-webkit-scrollbar-thumb {
  background: var(--yh-border-color-lighter);
  border-radius: 2px;
}

.yh-category-nav__section {
  padding: 10px 12px 0;
}

.yh-category-nav__section-title {
  padding: 4px 0 8px;
  font-size: var(--yh-font-size-sm);
  font-weight: 600;
  color: var(--yh-category-nav-section-title-color);
  display: flex;
  align-items: center;
  gap: 6px;
}
.yh-category-nav__section-title::before {
  content: "";
  width: 3px;
  height: 14px;
  border-radius: 2px;
...
.yh-category-nav__sub-grid {
  display: grid;
  grid-template-columns: repeat(var(--yh-category-nav-columns), 1fr);
  gap: 8px;
  padding-bottom: 10px;
}

.yh-category-nav__sub-item {
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 5px;
  ...
  background: transparent;
  cursor: pointer;
  transition: background var(--yh-transition-base), border-color var(--yh-transition-base);
}
.yh-category-nav__sub-item:hover {
  background: var(--yh-fill-color-light);
}
.yh-category-nav__sub-item.is-active {
  border-color: var(--yh-category-nav-sub-active-color);
  background: var(--yh-color-primary-light-9);
}

.yh-category-nav__sub-img {
  width: var(--yh-category-nav-sub-image-size);
  height: var(--yh-category-nav-sub-image-size);
  object-fit: cover;
  border-radius: var(--yh-radius-base);
  background: var(--yh-fill-color-light);
}

.yh-category-nav__sub-name {
  font-size: var(--yh-font-size-xs);
  color: var(--yh-text-color-regular);
  text-align: center;
  line-height: 1.3;
...
.yh-category-nav__sub-count {
  font-size: 10px;
  color: var(--yh-text-color-disabled);
}

.yh-category-nav__empty {
  text-align: center;
...
.yh-category-nav__skeleton {
  background: linear-gradient(90deg, var(--yh-fill-color-lighter) 25%, var(--yh-fill-color-light) 50%, var(--yh-fill-color-lighter) 75%);
  background-size: 200% 100%;
  animation: yh-category-nav-shimmer 1.5s infinite;
  border-radius: var(--yh-radius-base);
  border: none !important;
}
.yh-category-nav__skeleton.yh-category-nav__side-item {
  height: 48px;
  width: calc(100% - 16px);
  margin: 8px auto;
}
.yh-category-nav__skeleton.yh-category-nav__sub-item {
  height: 80px;
  width: 100%;
}

@keyframes yh-category-nav-shimmer {
  to {
