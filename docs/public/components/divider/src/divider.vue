...
.yh-divider {
  --yh-divider-border-color: var(--yh-border-color-lighter, #dcdfe6);
  --yh-divider-border-width: 1px;
  --yh-divider-border-style: solid;
  --yh-divider-margin-horizontal: 24px 0;
  --yh-divider-margin-vertical: 0 8px;
  --yh-divider-text-color: var(--yh-text-color-primary, #303133);
  display: flex;
  align-items: center;
  white-space: nowrap;
}
.yh-divider--horizontal {
  display: flex;
  width: 100%;
  margin: var(--yh-divider-margin-horizontal);
}
.yh-divider--horizontal::before, .yh-divider--horizontal::after {
  content: "";
  flex: 1;
  border-top: var(--yh-divider-border-width) var(--yh-divider-border-style) var(--yh-divider-border-color);
}
...
.yh-divider--vertical {
  ...
  width: 0;
  min-height: 1em;
  margin: var(--yh-divider-margin-vertical);
  vertical-align: middle;
  position: relative;
  border-left: var(--yh-divider-border-width) var(--yh-divider-border-style) var(--yh-divider-border-color);
}

.yh-divider--content-left::before {
  flex: 0 0 5%;
}

.yh-divider--content-right::after {
  flex: 0 0 5%;
}
...
.yh-divider__text {
  padding: 0 16px;
  font-weight: 500;
  color: var(--yh-divider-text-color);
  font-size: 14px;
  white-space: nowrap;
}
</style>
