...
.yh-alert.is-center .yh-alert__icon {
  margin-right: 8px;
}
.yh-alert.is-with-description {
  padding: 16px;
  align-items: flex-start;
}
.yh-alert.is-with-description .yh-alert__icon {
  font-size: 24px;
  margin-right: 12px;
}
.yh-alert.is-with-description .yh-alert__title {
  font-weight: 700;
  margin-bottom: 4px;
  font-size: 16px;
}
...
.yh-alert--success--outline {
  background-color: transparent;
  border-color: var(--yh-color-success);
}

.yh-alert--success--dark {
  background-color: var(--yh-color-success);
  color: #fff;
}
.yh-alert--success--dark .yh-alert__description {
  color: rgba(255, 255, 255, 0.9);
}

.yh-alert--success--glass {
  background: rgba(var(--yh-color-success-light-9), 0.7);
  backdrop-filter: blur(10px);
  border: 1px solid rgba(var(--yh-color-success), 0.2);
  box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.05);
}

.yh-alert--success .yh-alert__progress-bar {
  background-color: var(--yh-color-success);
  opacity: 0.3;
}
.yh-alert--success {
...
.yh-alert--success .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-success-light-9), transparent);
}
.yh-alert--success .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-success-light-9), transparent);
}
.yh-alert--success.yh-alert--dark .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-success), transparent);
}
.yh-alert--success.yh-alert--dark .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-success), transparent);
}
...
.yh-alert--info--outline {
  background-color: transparent;
  border-color: var(--yh-color-info);
}
...
.yh-alert--info--dark .yh-alert__description {
  color: rgba(255, 255, 255, 0.9);
}

.yh-alert--info--glass {
  background: rgba(var(--yh-color-info-light-9), 0.7);
  backdrop-filter: blur(10px);
  border: 1px solid rgba(var(--yh-color-info), 0.2);
  box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.05);
}

.yh-alert--info .yh-alert__progress-bar {
  background-color: var(--yh-color-info);
  opacity: 0.3;
}
.yh-alert--info {
...
.yh-alert--info .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-info-light-9), transparent);
}
.yh-alert--info .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-info-light-9), transparent);
}
.yh-alert--info.yh-alert--dark .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-info), transparent);
}
.yh-alert--info.yh-alert--dark .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-info), transparent);
}
...
.yh-alert--warning--outline {
  background-color: transparent;
  border-color: var(--yh-color-warning);
}

.yh-alert--warning--dark {
  background-color: var(--yh-color-warning);
  color: #fff;
}
.yh-alert--warning--dark .yh-alert__description {
  color: rgba(255, 255, 255, 0.9);
}

.yh-alert--warning--glass {
  background: rgba(var(--yh-color-warning-light-9), 0.7);
  backdrop-filter: blur(10px);
  border: 1px solid rgba(var(--yh-color-warning), 0.2);
  box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.05);
}

.yh-alert--warning .yh-alert__progress-bar {
  background-color: var(--yh-color-warning);
  opacity: 0.3;
}
.yh-alert--warning {
...
.yh-alert--warning .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-warning-light-9), transparent);
}
.yh-alert--warning .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-warning-light-9), transparent);
}
.yh-alert--warning.yh-alert--dark .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-warning), transparent);
}
.yh-alert--warning.yh-alert--dark .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-warning), transparent);
}
...
.yh-alert--error--dark .yh-alert__description {
  color: rgba(255, 255, 255, 0.9);
}

.yh-alert--error--glass {
  background: rgba(var(--yh-color-danger-light-9), 0.7);
  backdrop-filter: blur(10px);
  border: 1px solid rgba(var(--yh-color-danger), 0.2);
  box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.05);
}

.yh-alert--error .yh-alert__progress-bar {
  background-color: var(--yh-color-danger);
  opacity: 0.3;
}
.yh-alert--error {
...
.yh-alert--error .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-danger-light-9), transparent);
}
.yh-alert--error .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-danger-light-9), transparent);
}
.yh-alert--error.yh-alert--dark .yh-alert__description-wrapper::before {
  background: linear-gradient(to right, var(--yh-color-danger), transparent);
}
.yh-alert--error.yh-alert--dark .yh-alert__description-wrapper::after {
  background: linear-gradient(to left, var(--yh-color-danger), transparent);
}
...
.yh-alert.is-scrollable .yh-alert__description-content {
  display: inline-flex;
  animation: yh-alert-marquee-endless var(--yh-alert-scroll-speed, 15s) linear infinite;
  will-change: transform;
  padding-left: 20px; /* 给起始位置一点呼吸空间 */
}
.yh-alert.is-scrollable .yh-alert__description {
  white-space: nowrap;
  padding-right: 50px; /* 两个拷贝之间的间距 */
  display: inline-block;
  backface-visibility: hidden;
  transform: translateZ(0);
}
.yh-alert.is-scrollable.is-pause-on-hover:hover .yh-alert__description-content {
...
.yh-alert__close:hover {
  opacity: 1;
}

.yh-alert__progress-track {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
.yh-alert__progress-bar {
  height: 100%;
  width: 100%;
}

@keyframes yh-alert-marquee-endless {
  0% {
...
.yh-alert-fade-enter-active,
.yh-alert-fade-leave-active {
  transition: all 0.3s cubic-bezier(0.55, 0, 0.1, 1);
}

.yh-alert-fade-enter-from,
.yh-alert-fade-leave-to {
  opacity: 0;
