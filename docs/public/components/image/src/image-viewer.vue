...
.yh-image__inner.is-preview {
  cursor: pointer;
}

.yh-image__placeholder {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 100%;
  height: 100%;
  background-color: var(--yh-image-placeholder-bg-color);
  color: var(--yh-image-placeholder-text-color);
  font-size: 14px;
  vertical-align: middle;
}
...
.yh-image__error {
  ...
  width: 100%;
  height: 100%;
  background-color: var(--yh-image-error-bg-color);
  color: var(--yh-image-error-text-color);
  font-size: 14px;
  vertical-align: middle;
}
...
.yh-viewer__mask {
  ...
  top: 0;
  left: 0;
  background: var(--yh-image-viewer-mask-bg-color);
}
...
.yh-viewer__btn {
  ...
  user-select: none;
  color: var(--yh-image-viewer-btn-color);
  background-color: var(--yh-image-viewer-btn-bg-color);
  border: none;
  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
}
.yh-viewer__btn:hover {
  opacity: 1;
  transform: scale(1.1);
  background-color: var(--yh-image-viewer-btn-hover-bg-color);
}
...
.yh-viewer__actions-inner i {
  cursor: pointer;
  display: flex;
  transition: color 0.2s;
}
.yh-viewer__actions-inner i:hover {
