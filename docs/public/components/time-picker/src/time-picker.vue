...
:root {
  --yh-time-picker-width: 220px;
  --yh-time-picker-range-width: 360px;
  --yh-time-picker-active-color: var(--yh-color-primary);
  --yh-time-picker-active-bg: var(--yh-color-primary-light-9);
  --yh-time-picker-hover-bg: var(--yh-fill-color-light);
  --yh-time-picker-panel-bg: var(--yh-bg-color);
  --yh-time-picker-border-radius: var(--yh-radius-md);
}

.yh-time-picker {
  position: relative;
  display: inline-flex;
  width: var(--yh-time-picker-width);
  font-size: 14px;
  line-height: 1.5;
  cursor: pointer;
}
.yh-time-picker--large {
  width: 240px;
  font-size: 16px;
}
.yh-time-picker--large .yh-time-picker__wrapper {
  padding: 10px 12px;
}
...
.yh-time-picker--small {
  width: 180px;
  font-size: 12px;
}
.yh-time-picker--small .yh-time-picker__wrapper {
  padding: 4px 8px;
}
...
.yh-time-picker.is-range {
  width: var(--yh-time-picker-range-width);
}
.yh-time-picker.is-range .yh-time-picker__wrapper {
  justify-content: space-between;
}

.yh-time-picker.is-disabled {
  cursor: not-allowed;
}
.yh-time-picker.is-disabled .yh-time-picker__wrapper {
...
.yh-time-picker__wrapper:hover {
  border-color: var(--yh-border-color-hover);
}

.yh-time-picker__prefix {
  display: flex;
  align-items: center;
  margin-right: 8px;
...
.yh-time-picker__range-separator {
  display: inline-flex;
  align-items: center;
  padding: 0 8px;
...
.yh-time-picker__clear {
  cursor: pointer;
}
.yh-time-picker__clear:hover {
  color: var(--yh-text-color-regular);
}

.yh-time-picker__arrow {
  transition: transform 0.2s;
}
.yh-time-picker__arrow.is-reverse {
  transform: rotate(180deg);
}

.yh-time-picker__panel {
  position: absolute;
  z-index: var(--yh-z-index-popup);
  min-width: 200px;
  padding: 8px 0;
  background-color: var(--yh-bg-color);
  border-radius: var(--yh-border-radius-base);
...
.yh-time-picker__range-panel {
  display: flex;
  align-items: flex-start;
  padding: 0 8px;
}

.yh-time-picker__range-panel-item {
  flex: 1;
}

.yh-time-picker__range-panel-title {
  padding: 8px 0;
  font-size: 12px;
  font-weight: 500;
  color: var(--yh-text-color-secondary);
...
.yh-time-picker__range-panel-separator {
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 60px 16px 0;
...
.yh-time-picker__range-panel-separator svg {
  width: 16px;
  height: 16px;
}

.yh-time-picker__footer {
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 8px 12px;
...
.yh-time-picker__footer-actions {
  display: flex;
  gap: 8px;
}

.yh-time-picker__footer-btn {
  padding: 6px 16px;
  font-size: 13px;
  font-weight: 500;
  line-height: 1.5;
...
.yh-time-picker__footer-btn:hover {
  color: var(--yh-color-primary);
}
.yh-time-picker__footer-btn--cancel {
  border-color: var(--yh-border-color);
  background-color: var(--yh-bg-color);
}
.yh-time-picker__footer-btn--cancel:hover {
  border-color: var(--yh-color-primary);
  color: var(--yh-color-primary);
}

.yh-time-picker__footer-btn--confirm {
...
.yh-time-picker__footer-btn--confirm:hover {
  background-color: var(--yh-color-primary-light-3) !important;
  border-color: var(--yh-color-primary-light-3) !important;
  color: var(--yh-color-white) !important;
  box-shadow: var(--yh-shadow-md);
  transform: translateY(-1px);
}
.yh-time-picker__footer-btn--confirm:active {
  background-color: var(--yh-color-primary-dark-2) !important;
