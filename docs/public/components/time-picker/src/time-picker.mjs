export const parseTimeValue = (value, _format = "HH:mm:ss") => {
...
export const formatTimeState = (state, format = "HH:mm:ss", use12Hours = false) => {
  if (!state) return "";
...
export const timeStateToDate = (state) => {
  const date = /* @__PURE__ */ new Date();
  date.setHours(state.hours, state.minutes, state.seconds, 0);
  return date;
};
export const generateNumberList = (max, step = 1, disabledList = [], customOptions) => {
  const result = [];
...
export const isTimeStateEqual = (a, b) => {
