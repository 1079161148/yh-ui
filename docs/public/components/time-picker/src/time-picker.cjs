...
exports.timeStateToDate = exports.parseTimeValue = exports.isTimeStateEqual = exports.getCurrentTimeState = exports.generateNumberList = exports.formatTimeState = void 0;
...
exports.getCurrentTimeState = getCurrentTimeState;