 ...
 * 格式化 TimeState 为字符串
 */
export declare const formatTimeState: (state: TimeState | null, format?: string, use12Hours?: boolean) => string;
/**
 ...
 * 生成数字列表
 */
export declare const generateNumberList: (max: number, step?: number, disabledList?: number[], customOptions?: number[]) => Array<{
    value: number;
    disabled: boolean;
}>;
/**
