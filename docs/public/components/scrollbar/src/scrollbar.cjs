...
exports.scrollbarProps = exports.scrollbarEmits = exports.SCROLLBAR_INJECTION_KEY = void 0;
const SCROLLBAR_INJECTION_KEY = exports.SCROLLBAR_INJECTION_KEY = Symbol("scrollbarContext");
