...
export declare const mentionPlacements: readonly ["top", "bottom"];
export declare const mentionSizes: readonly ["large", "default", "small"];
export declare const mentionSplits: readonly ["@", "#", "$", "/", ":"];
