...
const IconSuccess = exports.IconSuccess = {
  name: "success",
  viewBox: "0 0 24 24",
...
const IconEyeOff = exports.IconEyeOff = {
  name: "eye-off",
  viewBox: "0 0 24 24",
...
const IconCalendar = exports.IconCalendar = {
  name: "calendar",
  viewBox: "0 0 24 24",
...
const IconTime = exports.IconTime = {
  name: "time",
  viewBox: "0 0 24 24",
...
const IconUser = exports.IconUser = {
  name: "user",
  viewBox: "0 0 24 24",
...
const IconSettings = exports.IconSettings = {
  name: "settings",
  viewBox: "0 0 24 24",
...
const IconSetting = exports.IconSetting = {
  name: "setting",
  viewBox: "0 0 24 24",
  svg: IconSettings.svg
};
const IconHome = exports.IconHome = {
  name: "home",
  viewBox: "0 0 24 24",
  svg: '<path fill="currentColor" d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>'
};
const IconImage = exports.IconImage = {
  name: "image",
  viewBox: "0 0 24 24",
...
const IconDocument = exports.IconDocument = {
  name: "document",
  viewBox: "0 0 24 24",
...
const IconRefresh = exports.IconRefresh = {
  name: "refresh",
  viewBox: "0 0 24 24",
...
const IconDownload = exports.IconDownload = {
  name: "download",
  viewBox: "0 0 24 24",
  svg: '<path fill="currentColor" d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>'
};
const IconFilePdf = exports.IconFilePdf = {
  name: "file-pdf",
  viewBox: "0 0 24 24",
...
const IconFileExcel = exports.IconFileExcel = {
  name: "file-excel",
  viewBox: "0 0 24 24",
...
const IconFileWord = exports.IconFileWord = {
  name: "file-word",
  viewBox: "0 0 24 24",
  svg: '<path fill="currentColor" d="M21.17 3.25Q21.5 3.25 21.76 3.5 22 3.74 22 4.08V19.92Q22 20.26 21.76 20.5 21.5 20.75 21.17 20.75H7.83Q7.5 20.75 7.24 20.5 7 20.26 7 19.92V17H2.83Q2.5 17 2.24 16.76 2 16.5 2 16.17V7.83Q2 7.5 2.24 7.24 2.5 7 2.83 7H7V4.08Q7 3.74 7.24 3.5 7.5 3.25 7.83 3.25H21.17M7 13.06L8.18 15.28L10.14 15.28L8.59 12.19L10.11 9.22L8.12 9.22L7 11.24L5.87 9.22L3.89 9.22L5.41 12.19L3.86 15.28L5.82 15.28L7 13.06M20.5 19.25V4.75H8.5V7H9.17Q9.5 7 9.76 7.24 10 7.5 10 7.83V16.17Q10 16.5 9.76 16.76 9.5 17 9.17 17H8.5V19.25H20.5Z"/>'
};
const IconFileVideo = exports.IconFileVideo = {
  name: "file-video",
  viewBox: "0 0 24 24",
...
const IconFileAudio = exports.IconFileAudio = {
  name: "file-audio",
  viewBox: "0 0 24 24",
...
const IconFileTxt = exports.IconFileTxt = {
  name: "file-txt",
  viewBox: "0 0 24 24",
  svg: '<path fill="currentColor" d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>'
};
const IconAttachment = exports.IconAttachment = {
  name: "attachment",
  viewBox: "0 0 24 24",
...
const IconEdit = exports.IconEdit = {
  name: "edit",
  viewBox: "0 0 24 24",
...
const IconCopy = exports.IconCopy = {
  name: "copy",
  viewBox: "0 0 24 24",
