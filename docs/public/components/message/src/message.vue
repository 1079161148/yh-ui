...
.yh-message--top-right {
  left: auto;
  right: 16px;
  transform: none;
}

.yh-message--bottom-left {
  left: 16px;
  transform: none;
}

.yh-message--bottom-right {
  left: auto;
  right: 16px;
  transform: none;
}

.yh-message.is-center {
  justify-content: center;
  text-align: center;
}
.yh-message.is-center .yh-message__content {
  justify-content: center;
}
.yh-message.is-center .yh-message__text {
  text-align: center;
}

.yh-message.is-closable {
  padding-right: 42px;
}
...
.yh-message__icon svg {
  width: 18px;
  height: 18px;
  vertical-align: middle;
}
.yh-message__icon--success {
  color: var(--yh-color-success);
}

.yh-message__icon--warning {
  color: var(--yh-color-warning);
}

.yh-message__icon--info {
  color: var(--yh-color-info);
}

.yh-message__icon--error {
...
.yh-message__close:hover {
  color: var(--yh-message-close-hover-color);
}
.yh-message__close svg {
  width: 100%;
  height: 100%;
}
...
.yh-message--success .yh-message__text {
...
.yh-message--warning .yh-message__text {
...
.yh-message--info .yh-message__text {
