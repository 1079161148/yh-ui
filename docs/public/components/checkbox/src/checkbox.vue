...
<template>
  <label :class="checkboxClasses" :style="themeStyle" @mouseenter="hovering = true" @mouseleave="hovering = false">
    <span :class="[ns.e('input'), ns.is('disabled', actualDisabled), ns.is('checked', isChecked), ns.is('indeterminate', props.indeterminate)]">
...
.yh-checkbox {
  ...
  --yh-checkbox-checked-icon-color: var(--yh-color-white, #fff);
