...
export declare const YhFormItem: import("@yh-ui/utils").SFCWithInstall<{
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<Readonly<import("vue").ExtractPropTypes<{
        ...
        readonly rules: {
            readonly type: import("vue").PropType<import("./index.js").FormRule | import("./index.js").FormRule[]>;
...
export declare const YhFormSchema: import("@yh-ui/utils").SFCWithInstall<{
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<Readonly<import("vue").ExtractPropTypes<{
        ...
        formRef: import("vue").Ref<import("./src/form").FormInstance | undefined, import("./src/form").FormInstance | undefined>;
    }, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {} & {
    ...
    $slots: {
        ...
        [x: `field-${string}-${string}`]: ((props: {
            row: Record<string, unknown>;
            index: number;
            item: import("./index.js").FormSchemaItem;
        }) => any) | undefined;
    } & {
        [x: `list-footer-${string}`]: ((props: {
            model: Record<string, unknown>;
            item: import("./index.js").FormSchemaItem;
        }) => any) | undefined;
    } & {
