...
export declare const formSchemaProps: {
     ...
     */
    readonly schema: {
        readonly type: PropType<FormSchema>;
        readonly required: true;
     ...
     */
    readonly formProps: {
        readonly type: PropType<Partial<FormProps>>;
        readonly default: () => {};
    };
    /**
     * 栅格间距（px）
...
export interface FormSchemaInstance {
    /** 触发校验，支持指定字段 */
    validate: (fields?: string | string[], callback?: (isValid: boolean, invalidFields?: Record<string, unknown>) => void) => Promise<boolean>;
