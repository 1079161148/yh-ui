...
<template>
  <div
    :class="[ns.b(), ns.is('collapsible', collapsible), ns.is('collapsed', collapsed), ns.is('editing', isEditing)]"
    :style="themeStyle"
  >
...
.yh-ai-code-block {
  --yh-ai-code-block-bg: #282c34;
  --yh-ai-code-block-header-bg: #21252b;
  --yh-ai-code-block-border-color: #181a1f;
  --yh-ai-code-block-color: #abb2bf;
  --yh-ai-code-block-lang-color: #828997;
  --yh-ai-code-block-border-radius: 8px;
  --yh-ai-code-block-shadow: 0 4px 12px rgba(0, 0, 0, 0.15);
  margin: 16px 0;
  border-radius: var(--yh-ai-code-block-border-radius);
  overflow: hidden;
  background-color: var(--yh-ai-code-block-bg);
  color: var(--yh-ai-code-block-color);
...
.yh-ai-code-block__header {
  ...
  align-items: center;
  padding: 8px 16px;
  background-color: var(--yh-ai-code-block-header-bg);
  border-bottom: 1px solid var(--yh-ai-code-block-border-color);
  user-select: none;
}

.yh-ai-code-block.is-collapsible .yh-ai-code-block__header {
  cursor: pointer;
}
.yh-ai-code-block.is-collapsible .yh-ai-code-block__header:hover {
  background-color: var(--yh-ai-code-block-border-color);
}

.yh-ai-code-block__header-left {
  display: flex;
  align-items: center;
  gap: 8px;
}

.yh-ai-code-block__collapse-icon {
  font-size: 14px;
  color: var(--yh-ai-code-block-lang-color);
  transition: transform 0.3s;
}

.yh-ai-code-block__lang {
  font-size: 12px;
  color: var(--yh-ai-code-block-lang-color);
...
.yh-ai-code-block__actions .yh-button {
  --yh-button-text-color: #828997;
  --yh-button-hover-text-color: #c8cdd4;
  --yh-button-active-text-color: #fff;
  --yh-button-bg-color: transparent;
  --yh-button-hover-bg-color: rgba(255, 255, 255, 0.08);
  --yh-button-active-bg-color: rgba(255, 255, 255, 0.12);
}
.yh-ai-code-block__actions .yh-button .yh-icon-video-play {
...
.yh-ai-code-block__body::-webkit-scrollbar {
  height: 8px;
  width: 8px;
}
.yh-ai-code-block__body::-webkit-scrollbar-thumb {
...
.yh-ai-code-block__line-numbers {
  ...
  padding: 16px 0;
  background-color: var(--yh-ai-code-block-header-bg);
  border-right: 1px solid var(--yh-ai-code-block-border-color);
  user-select: none;
  text-align: right;
  min-width: 40px;
  flex-shrink: 0;
...
.yh-ai-code-block__line-number {
  padding: 0 10px;
  color: #4b5263;
  font-size: 12px;
  line-height: 1.6;
}
.yh-ai-code-block__line-number.is-active {
  color: #abb2bf;
...
.yh-ai-code-block__content code {
  display: block;
  font-family: inherit;
  color: inherit;
}
.yh-ai-code-block__content .hljs {
  padding: 0;
...
.yh-ai-code-block__line.is-active {
  background-color: rgba(255, 255, 255, 0.05);
  border-left: 2px solid var(--yh-color-primary);
  padding-left: 14px;
}
...
.yh-ai-code-block__editor-actions {
  display: flex;
  justify-content: flex-end;
  margin-top: 12px;
  padding-top: 12px;
  border-top: 1px solid var(--yh-ai-code-block-border-color);
}

.yh-ai-code-block.is-editing .yh-ai-code-block__body {
  display: block;
