...
.yh-infinite-scroll.is-horizontal {
  flex-direction: row;
}

.yh-infinite-scroll__content {
  flex: 1;
  min-width: 0;
  min-height: 0;
}

.yh-infinite-scroll__placeholder {
  display: flex;
  align-items: center;
...
.yh-infinite-scroll__error:hover {
  opacity: 0.7;
}

.yh-infinite-scroll__text {
  display: inline-block;
  line-height: 1.5;
}

.yh-infinite-scroll.is-horizontal .yh-infinite-scroll__placeholder {
  min-height: auto;
  min-width: 50px;
  padding: 16px 8px;
  flex-direction: column;
}
.yh-infinite-scroll.is-horizontal .yh-infinite-scroll__loading {
  flex-direction: column;
}
