...
<template>
  <div
    ref="containerRef"
    :class="[ns.b(), ns.m(props.direction), ns.m(props.effect), {
  ...
  >
    ...
    >
      <div
        :class="[ns.e('arrow'), ns.em('arrow', 'prev'), ns.is('visible', props.showArrow === 'always' || props.showArrow === 'hover' && isHovering), ns.is('vertical', props.direction === 'vertical')]"
      ...
      <div
        :class="[ns.e('arrow'), ns.em('arrow', 'next'), ns.is('visible', props.showArrow === 'always' || props.showArrow === 'hover' && isHovering), ns.is('vertical', props.direction === 'vertical')]"
...
/* Dot Type: Line 支持 */
.yh-carousel__dots--line .yh-carousel__dots-item {
  width: 24px;
  height: 4px;
  border-radius: 2px;
...
.yh-carousel__dots--line .yh-carousel__dots-item.is-active {
  width: 32px;
...
.yh-carousel__dots--left.yh-carousel__dots--line .yh-carousel__dots-item,
.yh-carousel__dots--right.yh-carousel__dots--line .yh-carousel__dots-item {
  width: 4px;
  height: 24px;
  border-radius: 2px;
}
.yh-carousel__dots--left.yh-carousel__dots--line .yh-carousel__dots-item.is-active,
.yh-carousel__dots--right.yh-carousel__dots--line .yh-carousel__dots-item.is-active {
  width: 4px;
  height: 32px;
}
</style>
