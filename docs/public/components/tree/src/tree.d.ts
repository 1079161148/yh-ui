...
export declare const treeEmits: {
    ...
    'node-drag-end': (_node: TreeNode, _dropNode: TreeNode | null, _position: "before" | "after" | "inner", _e: DragEvent) => boolean;
    ...
    'node-drop': (_node: TreeNode, _dropNode: TreeNode, _position: "before" | "after" | "inner", _e: DragEvent) => boolean;
