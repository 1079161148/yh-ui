...
exports.treeProps = exports.treeEmits = exports.TREE_INJECTION_KEY = void 0;
const treeProps = exports.treeProps = {
  /** 数据源 */
  data: {
    type: Array,
    default: () => []
...
const treeEmits = exports.treeEmits = {
...
const TREE_INJECTION_KEY = exports.TREE_INJECTION_KEY = Symbol("tree");