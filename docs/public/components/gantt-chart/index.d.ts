...
export declare const YhGanttChart: import('@yh-ui/utils').SFCWithInstall<
  {
    new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<
      Readonly<import('./index.js').GanttChartProps> &
        Readonly<{
          ...
          'onTask-click'?:
            | ((task: import('./index.js').GanttTask, event: MouseEvent) => any)
            | undefined
          'onTask-dblclick'?:
            | ((task: import('./index.js').GanttTask, event: MouseEvent) => any)
            | undefined
          ...
          'onDependency-click'?:
            | ((
                from: import('./index.js').GanttTask,
                to: import('./index.js').GanttTask,
                event: MouseEvent
              ) => any)
            | undefined
        }>,
  ...
  > &
    ...
    (new () => {
      $slots: {
        ...
        'task-content'?: (props: { task: import('./index.js').GanttTask }) => any
      }
    })
> &
