...
.yh-ai-thinking__header:hover {
  color: var(--yh-color-primary);
}

.yh-ai-thinking__icon-wrapper {
  margin-right: 8px;
  display: flex;
  align-items: center;
...
.yh-ai-thinking__status-icon {
  font-size: 16px;
  color: var(--yh-color-primary);
}
.yh-ai-thinking__status-icon.is-loading {
  animation: yh-spin 1.2s linear infinite;
}

.yh-ai-thinking__title {
  font-weight: 500;
  flex: 1;
  margin-right: 8px;
}

.yh-ai-thinking__arrow {
  font-size: 12px;
  color: var(--yh-text-color-secondary);
  transition: transform 0.3s;
}
.yh-ai-thinking__arrow.is-expanded {
  transform: rotate(180deg);
}

.yh-ai-thinking__body {
  padding: 0 12px 12px;
  animation: yh-fade-in 0.3s ease;
}

.yh-ai-thinking__content {
  font-size: 13px;
  color: var(--yh-text-color-secondary);
  line-height: 1.6;
