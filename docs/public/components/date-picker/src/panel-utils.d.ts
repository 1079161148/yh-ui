...
export type CalendarCellType = 'prev-month' | 'current-month' | 'next-month' | 'today' | 'selected' | 'range' | 'range-start' | 'range-end' | 'week';
 ...
 * 生成日历矩阵
 */
export declare const generateCalendar: (date: Date, firstDayOfWeek?: number, disabledDate?: (date: Date) => boolean) => CalendarCell[][];
/**
