 ...
 * 穿梭框尺寸
 */
export declare const transferSizes: readonly ["large", "default", "small"];
 ...
 * 自定义渲染函数
 */
export type TransferRenderContent = (h: typeof import('vue').h, data: TransferData) => VNode | string;
/**
 * 过滤方法
 */
...
export declare const transferPanelContextKey: InjectionKey<TransferPanelContext>;
