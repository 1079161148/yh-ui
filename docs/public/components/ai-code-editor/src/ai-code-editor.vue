...
const getTargetValue = () => {
  return (props.initialValue !== void 0 && props.initialValue !== null ? props.initialValue : props.modelValue) ?? "";
};
const createEditor = () => {
...
<template>
  <div :class="ns.b()" :style="themeStyle">
    <div ref="editorRef" :class="ns.e('container')" :style="{
  height: editorHeight
}" />
  </div>
</template>
...
.yh-ai-code-editor__container {
  width: 100%;
}
.yh-ai-code-editor__container :deep(.monaco-editor) {
  width: 100% !important;
  height: 100% !important;
}
.yh-ai-code-editor__container :deep(.monaco-editor .overflow-guard) {
  width: 100% !important;
  height: 100% !important;
}
.yh-ai-code-editor__container :deep(.monaco-editor-background),
.yh-ai-code-editor__container :deep(.monaco-editor .margin),
.yh-ai-code-editor__container :deep(.monaco-editor .inputarea.ime-input) {
