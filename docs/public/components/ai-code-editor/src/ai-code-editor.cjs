...
exports.aiCodeEditorProps = exports.aiCodeEditorEmits = void 0;
const aiCodeEditorProps = exports.aiCodeEditorProps = {
  /**
   * @description 代码语言
   */
  language: {
...
const aiCodeEditorEmits = exports.aiCodeEditorEmits = {
