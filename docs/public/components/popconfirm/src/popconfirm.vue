...
<template>
  ...
  width: typeof width === 'number' ? `${width}px` : width
      ...
      >
        <div :class="ns.e('main')">
          <div v-if="!hideIcon" :class="ns.e('icon')" :style="{
  color: iconColor
}">
            <slot name="icon">
              <!-- 支持旧版图标名称 -->
...
.yh-popconfirm__popper {
  /* 与 Popover 空间感保持绝对对齐 */
  border-radius: 12px !important;
  box-shadow: 0 12px 32px -4px rgba(0, 0, 0, 0.1), 0 4px 20px rgba(0, 0, 0, 0.05) !important;
  padding: 0 !important;
  min-width: 200px;
  overflow: visible !important;
}
.yh-popconfirm__popper .yh-popconfirm__content {
  padding: 20px 24px;
}
.yh-popconfirm__popper .yh-popconfirm__content .yh-popconfirm__main {
  display: flex;
  gap: 16px;
  align-items: flex-start;
}
.yh-popconfirm__popper .yh-popconfirm__content .yh-popconfirm__icon {
  font-size: 20px;
  line-height: 1.4;
  flex-shrink: 0;
}
.yh-popconfirm__popper .yh-popconfirm__content .yh-popconfirm__inner {
  flex: 1;
  min-width: 0;
}
.yh-popconfirm__popper .yh-popconfirm__content .yh-popconfirm__title {
  font-size: 15px;
  font-weight: 700;
  margin-bottom: 6px;
  line-height: 1.4;
...
.yh-popconfirm__popper .yh-popconfirm__content .yh-popconfirm__description {
  font-size: 14px;
  line-height: 1.62;
  opacity: 0.88;
}
...
.yh-popconfirm__popper .yh-popconfirm__content .yh-popconfirm__footer {
  margin-top: 20px;
  display: flex;
...
.yh-popconfirm__popper .yh-tooltip__content {
  padding: 0 !important;
}
