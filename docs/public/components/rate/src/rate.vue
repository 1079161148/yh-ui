...
<template>
  ...
  width: iconSize + 'px'
    ...
    <span v-if="showScore || showText" :class="ns.e('text')" :style="{
  color: textColor
}">
      {{ rateText }}
    </span>
...
.yh-rate {
  --yh-rate-void-color: #c6d1de;
  --yh-rate-fill-color: #f7ba2a;
  --yh-rate-disabled-void-color: #eff2f7;
  --yh-rate-text-color: #1f2d3d;
  --yh-rate-font-size: 14px;
  --yh-rate-icon-margin: 6px;
  display: inline-flex;
  align-items: center;
  line-height: normal;
}
.yh-rate__item {
  ...
  margin-right: var(--yh-rate-icon-margin);
  cursor: pointer;
  vertical-align: middle;
  transition: transform 0.2s cubic-bezier(0.175, 0.885, 0.32, 1.275);
}
.yh-rate__item:last-child {
  margin-right: 0;
}
.yh-rate__item.is-hover {
...
.yh-rate__star-icon {
  ...
  width: 100%;
  height: 100%;
  color: var(--yh-rate-void-color);
}
.yh-rate__star-icon.is-void {
  color: var(--yh-rate-void-color);
}

.yh-rate__star-content {
  position: absolute;
  top: 0;
  left: 0;
  height: 100%;
  ...
  color: var(--yh-rate-fill-color);
}
.yh-rate__star-content .yh-rate__star-icon {
  height: 100%;
  max-width: none;
  color: inherit;
}
...
.yh-rate__text {
  margin-left: 10px;
  font-size: var(--yh-rate-font-size);
  color: var(--yh-rate-text-color);
}

.yh-rate.is-disabled {
  opacity: 0.8;
  --yh-rate-void-color: var(--yh-rate-disabled-void-color);
}
.yh-rate.is-disabled .yh-rate__item {
  cursor: not-allowed;
}
.yh-rate.is-disabled .yh-rate__item.is-hover {
  transform: none;
}
</style>
