  ...
  >
    ...
    >
      <template v-if="splitButton">
        ...
        >
          <YhIcon name="arrow-down" :class="[ns.e('icon'), {
  [ns.is('active')]: visible
}]" />
        </YhButton>
      </template>
      <template v-else>
        <div :class="ns.e('trigger')" :tabindex="disabled ? void 0 : tabindex">
          <slot />
          <YhIcon
            v-if="showArrow"
            name="arrow-down"
...
.yh-dropdown.is-disabled {
  cursor: not-allowed;
  opacity: 0.5;
}

.yh-dropdown__trigger {
  display: inline-flex;
  align-items: center;
  gap: 6px;
  cursor: pointer;
...
.yh-dropdown__trigger:hover {
  color: var(--yh-color-primary-light-3);
}
.yh-dropdown__trigger:focus-visible {
  box-shadow: 0 0 0 2px var(--yh-color-primary-light-5);
...
.yh-dropdown__icon.is-active {
  transform: rotate(180deg);
}

.yh-dropdown__icon.yh-icon {
  color: var(--yh-color-primary);
}

.yh-dropdown__trigger:hover .yh-dropdown__icon.yh-icon {
  color: var(--yh-color-primary-light-3);
}

.yh-dropdown .yh-button .yh-dropdown__icon.yh-icon {
  color: inherit;
}
.yh-dropdown > .yh-tooltip {
  display: inline-flex;
  align-items: stretch;
}
.yh-dropdown__caret-button {
  padding: 0 12px !important;
  min-width: auto !important;
  margin-left: 0 !important;
  border-top-left-radius: 0 !important;
  border-bottom-left-radius: 0 !important;
  border-left: 1px solid var(--yh-color-primary-light-5) !important;
}
.yh-dropdown__caret-button.yh-button--primary:not(.is-plain) {
  border-left-color: rgba(255, 255, 255, 0.5) !important;
}
.yh-dropdown__caret-button.is-plain {
  border-left-color: var(--yh-color-primary-light-5) !important;
}

.yh-dropdown > .yh-tooltip > .yh-button:first-child,
.yh-dropdown > .yh-button:first-child {
...
.yh-dropdown__item > span {
  display: inline-flex;
  align-items: center;
}
.yh-dropdown__item:hover {
  background: var(--yh-color-primary-light-9);
  color: var(--yh-color-primary);
}
.yh-dropdown__item:active {
  background: var(--yh-color-primary-light-8);
}
.yh-dropdown__item.is-disabled {
  cursor: not-allowed;
  color: var(--yh-text-color-placeholder);
}
.yh-dropdown__item.is-disabled:hover {
  background: transparent;
  color: var(--yh-text-color-placeholder);
}

.yh-dropdown__item.is-danger {
  color: var(--yh-color-danger);
}
.yh-dropdown__item.is-danger:hover {
  background: var(--yh-color-danger-light-9);
  color: var(--yh-color-danger);
}
.yh-dropdown__item.is-danger:active {
  background: var(--yh-color-danger-light-8);
}

.yh-dropdown__item.is-checked {
  color: var(--yh-color-primary);
  font-weight: 500;
}

.yh-dropdown__item-icon {
  font-size: 16px;
  flex-shrink: 0;
  line-height: 1;
  display: inline-flex;
...
.yh-dropdown__divider {
  height: 1px;
  margin: 6px 12px;
  background: var(--yh-border-color-light);
}

.yh-dropdown__loading {
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
:root.dark .yh-dropdown,
html.dark .yh-dropdown,
body.dark .yh-dropdown {
  color: var(--yh-text-color-primary);
}
:root.dark .yh-dropdown .yh-dropdown__popper,
html.dark .yh-dropdown .yh-dropdown__popper,
body.dark .yh-dropdown .yh-dropdown__popper {
  background: var(--yh-bg-color-overlay);
  box-shadow: var(--yh-shadow-xl);
}
:root.dark .yh-dropdown .yh-dropdown__item,
html.dark .yh-dropdown .yh-dropdown__item,
body.dark .yh-dropdown .yh-dropdown__item {
  color: var(--yh-text-color-primary);
}
:root.dark .yh-dropdown .yh-dropdown__item:hover,
html.dark .yh-dropdown .yh-dropdown__item:hover,
body.dark .yh-dropdown .yh-dropdown__item:hover {
  background: var(--yh-color-primary-light-9);
}
:root.dark .yh-dropdown .yh-dropdown__item:active,
html.dark .yh-dropdown .yh-dropdown__item:active,
body.dark .yh-dropdown .yh-dropdown__item:active {
  background: var(--yh-color-primary-light-8);
}
:root.dark .yh-dropdown .yh-dropdown__divider,
html.dark .yh-dropdown .yh-dropdown__divider,
body.dark .yh-dropdown .yh-dropdown__divider {
  background: var(--yh-border-color);
}

.yh-dropdown-fade-enter-active,
.yh-dropdown-fade-leave-active {
  transition: opacity 0.2s cubic-bezier(0.23, 1, 0.32, 1), transform 0.2s cubic-bezier(0.23, 1, 0.32, 1);
}

.yh-dropdown-fade-enter-from,
.yh-dropdown-fade-leave-to {
  opacity: 0;
