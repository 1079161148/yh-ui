    ...
    new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<
      ...
      > &
        Readonly<{
          ...
          'onRemove-attachment'?:
            | ((_index: number, _item: import('./index.js').AiEditorAttachmentItem) => any)
            | undefined
          'onCommand-select'?:
            | ((
                _command: import('./index.js').AiCommandItem,
                _parentCommand?: import('./index.js').AiCommandItem | undefined
              ) => any)
            | undefined
          ...
          'onCommand-cascade'?:
            | ((
                _command: import('./index.js').AiCommandItem,
                _parentCommand: import('./index.js').AiCommandItem
              ) => any)
            | undefined
        }>,
      {
      ...
      import('vue').ComponentOptionsMixin,
      {
        ...
        'remove-attachment': (
          _index: number,
          _item: import('./index.js').AiEditorAttachmentItem
        ) => void
        'command-select': (
          _command: import('./index.js').AiCommandItem,
          _parentCommand?: import('./index.js').AiCommandItem | undefined
  ...
  > &
    ...
    (new () => {
      $slots: {
        ...
        submit?: (props: { submit: () => void; disabled: boolean; loading: boolean }) => any
      }
    })
> &
