      ...
      <div :class="ns.e('nav-wrap')">
        <div :class="ns.e('nav-list')">
          <div
            v-for="pane in panes"
            :key="pane.name"
            :class="[ns.e('item'), ns.is('active', activeTab === pane.name), ns.is('disabled', pane.disabled), ns.is('closable', pane.closable !== false && isClosable)]"
            role="tab"
...
.yh-tabs {
  --yh-tabs-header-height: 40px;
  --yh-tabs-active-color: var(--yh-color-primary);
  --yh-tabs-text-color: var(--yh-text-color-primary);
  --yh-tabs-disabled-color: var(--yh-text-color-disabled);
  --yh-tabs-border-color: var(--yh-border-color-light);
  --yh-tabs-indicator-width: 40px;
  --yh-tabs-indicator-height: 20px;
  display: flex;
...
.yh-tabs__item {
  ...
  gap: 6px;
  height: var(--yh-tabs-header-height);
  padding: 0 20px;
  box-sizing: border-box;
  font-size: var(--yh-font-size-base);
  color: var(--yh-tabs-text-color);
  cursor: pointer;
  user-select: none;
  transition: color var(--yh-duration-fast), background-color var(--yh-duration-fast);
}
.yh-tabs__item:hover:not(.is-disabled) {
  color: var(--yh-tabs-active-color);
}
.yh-tabs__item.is-active {
  color: var(--yh-tabs-active-color);
  font-weight: 500;
}
.yh-tabs__item.is-disabled {
  color: var(--yh-tabs-disabled-color);
  cursor: not-allowed;
}
...
.yh-tabs__add {
  ...
  align-items: center;
  justify-content: center;
  width: var(--yh-tabs-header-height);
  height: var(--yh-tabs-header-height);
  color: var(--yh-text-color-secondary);
  cursor: pointer;
...
.yh-tabs__indicator {
  ...
  left: 0;
  height: 2px;
  background-color: var(--yh-tabs-active-color);
  transition: transform var(--yh-duration-base), width var(--yh-duration-base);
  border-radius: 1px;
}
...
.yh-tabs--line .yh-tabs__nav {
  border-bottom: 1px solid var(--yh-tabs-border-color);
}

.yh-tabs--card .yh-tabs__nav {
  border-bottom: 1px solid var(--yh-tabs-border-color);
}

.yh-tabs--card .yh-tabs__item {
  border: 1px solid transparent;
  border-bottom: none;
  border-radius: var(--yh-radius-base) var(--yh-radius-base) 0 0;
  margin-bottom: -1px;
}
.yh-tabs--card .yh-tabs__item.is-active {
  border-color: var(--yh-tabs-border-color);
  background-color: var(--yh-bg-color);
}

.yh-tabs--card .yh-tabs__indicator {
  display: none;
}

.yh-tabs--border-card {
  border: 1px solid var(--yh-tabs-border-color);
  border-radius: var(--yh-radius-base);
  box-shadow: var(--yh-shadow-sm);
}
.yh-tabs--border-card .yh-tabs__nav {
  background-color: var(--yh-fill-color-light);
  border-bottom: 1px solid var(--yh-tabs-border-color);
}

.yh-tabs--border-card .yh-tabs__item {
  margin: -1px 0 0 -1px;
  border: 1px solid transparent;
}
.yh-tabs--border-card .yh-tabs__item.is-active {
  background-color: var(--yh-bg-color);
  border-color: var(--yh-tabs-border-color);
  border-bottom-color: transparent;
}

.yh-tabs--border-card .yh-tabs__indicator {
  display: none;
}

.yh-tabs--border-card .yh-tabs__content {
  padding: 16px;
}

.yh-tabs--segment .yh-tabs__nav {
  background-color: var(--yh-fill-color-light);
  border-radius: var(--yh-radius-md);
  padding: 4px;
}

.yh-tabs--segment .yh-tabs__item {
  border-radius: var(--yh-radius-base);
  height: calc(var(--yh-tabs-header-height) - 8px);
}
.yh-tabs--segment .yh-tabs__item.is-active {
  background-color: var(--yh-bg-color);
  box-shadow: var(--yh-shadow-sm);
}

.yh-tabs--segment .yh-tabs__indicator {
  display: none;
}
...
.yh-tabs--left .yh-tabs__nav {
  flex-direction: column;
  border-right: 1px solid var(--yh-tabs-border-color);
  border-bottom: none;
}

.yh-tabs--left .yh-tabs__nav-list {
  flex-direction: column;
}

.yh-tabs--left .yh-tabs__item {
  justify-content: flex-start;
}

.yh-tabs--left .yh-tabs__indicator {
  top: 0;
  right: 0;
  left: auto;
  bottom: auto;
...
.yh-tabs--right .yh-tabs__nav {
  flex-direction: column;
  border-left: 1px solid var(--yh-tabs-border-color);
  border-bottom: none;
}

.yh-tabs--right .yh-tabs__nav-list {
  flex-direction: column;
}

.yh-tabs--right .yh-tabs__item {
  justify-content: flex-start;
}

.yh-tabs--right .yh-tabs__indicator {
  top: 0;
  left: 0;
  bottom: auto;
  width: 2px;
...
.yh-tabs--right .yh-tabs__content {
  padding: 0 16px;
}
...
.yh-tabs--bottom .yh-tabs__nav {
  border-top: 1px solid var(--yh-tabs-border-color);
  border-bottom: none;
}

.yh-tabs--bottom .yh-tabs__indicator {
  top: 0;
  bottom: auto;
}

.yh-tabs.is-stretch .yh-tabs__nav-list {
  display: flex;
  width: 100%;
}

.yh-tabs.is-stretch .yh-tabs__item {
  flex: 1;
}
</style>
