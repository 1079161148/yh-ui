...
exports.tabsTypes = exports.tabsProps = exports.tabsPositions = exports.tabsEmits = exports.TABS_INJECTION_KEY = void 0;
const tabsTypes = exports.tabsTypes = ["line", "card", "border-card", "segment"];
const tabsPositions = exports.tabsPositions = ["top", "right", "bottom", "left"];
const tabsProps = exports.tabsProps = {
  /** 当前激活的标签名 */
  modelValue: {
    type: [String, Number],
    default: ""
...
const TABS_INJECTION_KEY = exports.TABS_INJECTION_KEY = Symbol("yhTabs");