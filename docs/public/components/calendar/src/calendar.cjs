...
exports.calendarProps = exports.calendarEmits = exports.DEFAULT_CHINA_HOLIDAYS_2026 = exports.CALENDAR_INJECTION_KEY = void 0;
...
const CALENDAR_INJECTION_KEY = exports.CALENDAR_INJECTION_KEY = Symbol("calendar");
const DEFAULT_CHINA_HOLIDAYS_2026 = exports.DEFAULT_CHINA_HOLIDAYS_2026 = {
  // 元旦
  "2026-01-01": {
    name: "\u5143\u65E6",
    isOffDay: true
