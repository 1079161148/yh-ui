...
export type AutocompletePlacement = 'top' | 'top-start' | 'top-end' | 'bottom' | 'bottom-start' | 'bottom-end';
...
export interface AutocompleteProps {
    ...
    /** 获取建议的方法 */
    fetchSuggestions?: (query: string, callback: (suggestions: AutocompleteSuggestion[]) => void) => void;
    /** 是否在聚焦时触发建议 */
