...
<template>
  ...
  backgroundColor: defineBackgroundColor
      ...
      >
        ...
        ></div>
        <div
          :class="[ns.e('inner'), ns.is('indeterminate', indeterminate), ns.is('striped', striped), ns.is('striped-flow', stripedFlow)]"
          :style="barStyle"
        >
  ...
  left: `${100 / steps * step}%`
    ...
    <!-- 环形/仪表盘进度条 -->
    <div v-else :class="ns.e('circle')" :style="{
  height: `${width}px`,
  width: `${width}px`
}">
      ...
      >
        <slot name="default" :percentage="percentages[0]">
          <i
            ...
            :style="{
  color: getColor(percentages[0], 0)
}"
          ></i>
          <!-- eslint-disable vue/no-v-html -->
          <svg
  ...
  verticalAlign: 'middle'
    ...
    <div
      ...
      :class="ns.e('text')"
      :style="{
  fontSize: `${Math.max(12, strokeWidth * 0.8)}px`
}"
    >
      <slot name="default" :percentage="percentages[0]">
        <i
