...
exports.ptBr = exports.default = void 0;
  ...
  yh: {
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Posso ajud\xE1-lo com programa\xE7\xE3o, tradu\xE7\xE3o de documentos ou reda\xE7\xE3o criativa. O que posso fazer por voc\xEA hoje?"
      },
      action: {
        copy: "Copiar",
