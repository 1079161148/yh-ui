...
exports.nbNo = exports.default = void 0;
  ...
  yh: {
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Jeg kan hjelpe deg med koding, oversetting av dokumenter eller kreativ skriving. Hva kan jeg gj\xF8re for deg i dag?"
      },
      action: {
        copy: "Kopier",
