...
exports.lv = exports.default = void 0;
const lv = exports.lv = {
  name: "lv",
  yh: {
    // Kopīgs
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Es varu pal\u012Bdz\u0113t jums ar programm\u0113\u0161anu, dokumentu tulko\u0161anu vai rado\u0161o rakst\u012B\u0161anu. Ko es varu dar\u012Bt jums \u0161odien?"
      },
      action: {
        copy: "Kop\u0113t",
