...
exports.ms = exports.default = void 0;
const ms = exports.ms = {
  name: "ms",
  yh: {
    // Umum
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Saya boleh membantu anda dengan pengkodan, penterjemahan dokumen atau penulisan kreatif. Apa yang boleh saya lakukan untuk anda hari ini?"
      },
      action: {
        copy: "Salin",
