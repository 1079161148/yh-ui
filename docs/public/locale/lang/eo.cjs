...
exports.eo = exports.default = void 0;
const eo = exports.eo = {
  name: "eo",
  yh: {
    // Komuna
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Mi povas helpi vin kun kodado, tradukado de dokumentoj a\u016D kreiva skribado. Kion mi povas fari por vi hodia\u016D?"
      },
      action: {
        copy: "Kopii",
        regenerate: "Regeneri",
