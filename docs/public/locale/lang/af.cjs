...
module.exports = exports.af = void 0;
const af = exports.af = {
  name: "af",
  yh: {
    // Algemeen
    ...
    table: {
      ...
      import: {
        ...
        selectFile: "Kies l\xEAer",
        dragTip: "Klik of sleep l\xEAer hierheen om op te laai",
        importing: "Importeer...",
    ...
    upload: {
      ...
      tip: "Klik of sleep l\xEAer na hierdie area om <em>op te laai</em>",
      dragTip: "Los l\xEAer hier of klik om op te laai",
      uploading: "Laai op...",
      success: "Oplaai suksesvol",
      error: "Oplaai het misluk",
      retry: "Probeer weer",
      cancel: "Kanselleer oplaai",
      fileTypeError: "L\xEAertipe word nie ondersteun nie",
      fileSizeError: "L\xEAergrootte oorskry limiet",
      fileCountError: "L\xEAertelling oorskry limiet"
    },
    // Vorm
    form: {
    ...
    ai: {
      ...
      sender: {
        ...
        dragTip: "Laat los om l\xEAers op te laai"
      },
      thoughtChain: {
      ...
      welcome: {
        ...
        description: "Ek kan jou help met kodering, dokumentvertaling of kreatiewe skryfwerk. Waarmee kan ek jou vandag help?"
      },
      action: {
        copy: "Kopieer",
