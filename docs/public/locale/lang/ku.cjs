...
exports.ku = exports.default = void 0;
const ku = exports.ku = {
  name: "ku",
  yh: {
    // Giştî
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Ez dikarim al\xEE te bikim bi kodkirin, wergerandina belgeyan an niv\xEEsandin\xEA \xE7\xEAkirin. Ez \xE7i dikarim ji te re \xEEro bikim?"
      },
      action: {
        copy: "Kop\xEE",
