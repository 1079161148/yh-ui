...
exports.sl = exports.default = void 0;
const sl = exports.sl = {
  name: "sl",
  yh: {
    // Splošno
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Lahko vam pomagam s kodiranjem, prevajanjem dokumentov ali ustvarjalnim pisanjem. Kaj lahko danes naredim za vas?"
      },
      action: {
        copy: "Kopiraj",
