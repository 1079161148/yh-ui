...
exports.sk = exports.default = void 0;
const sk = exports.sk = {
  name: "sk",
  yh: {
    // Všeobecné
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "M\xF4\u017Eem v\xE1m pom\xF4c\u0165 s programovan\xEDm, prekladom dokumentov alebo kreat\xEDvnym p\xEDsan\xEDm. \u010Co pre v\xE1s dnes m\xF4\u017Eem urobi\u0165?"
      },
      action: {
        copy: "Kop\xEDrova\u0165",
