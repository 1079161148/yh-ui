...
exports.it = exports.default = void 0;
const it = exports.it = {
  name: "it",
  yh: {
    // Comune
    ...
    colorpicker: {
      ...
      suggestionDark: "Testo bianco \xE8 migliore",
      suggestionLight: "Testo nero \xE8 migliore",
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Posso aiutarti con la programmazione, la traduzione di documenti o la scrittura creativa. Cosa posso fare per te oggi?"
      },
      action: {
        copy: "Copia",
        regenerate: "Rigenera",
