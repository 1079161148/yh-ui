...
exports.tk = exports.default = void 0;
const tk = exports.tk = {
  name: "tk",
  yh: {
    // Umumy
    ...
    table: {
      ...
      import: {
        ...
        dragTip: "\xDD\xFCklemek \xFC\xE7in fa\xFDly \u015Fu \xFDere basy\u0148 \xFDa-da s\xFC\xFD\xFC\u0148",
    ...
    upload: {
      ...
      dragTip: "Fa\xFDly \u015Fu \xFDere go\xFDu\u0148 \xFDa-da \xFD\xFCklemek \xFC\xE7in basy\u0148",
    ...
    infinitescroll: {
      ...
      error: "\xDD\xFCkleme \xFDal\u0148y\u015Flygy, t\xE4zeden synany\u015Fmak \xFC\xE7in basy\u0148",
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Kodlamada, resminamalary terjime etmekde \xFDa-da d\xF6rediji \xFDazuwda size k\xF6mek edip bilerin. Bu g\xFCn size n\xE4me edip bilerin?"
      },
      action: {
        copy: "G\xF6\xE7\xFCr",
