...
exports.eu = exports.default = void 0;
const eu = exports.eu = {
  name: "eu",
  yh: {
    // Orokorra
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Lagun zaitzaket programming, dokumentuen itzulpena edo idazketa sortzailean. Zer egin dezaket gaur zuretzat?"
      },
      action: {
        copy: "Kopiatu",
