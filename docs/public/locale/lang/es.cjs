...
exports.es = exports.default = void 0;
const es = exports.es = {
  name: "es",
  yh: {
    common: {
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Puedo ayudarte con programaci\xF3n, traducci\xF3n de documentos o escritura creativa. \xBFQu\xE9 puedo hacer por ti hoy?"
      },
      action: {
        copy: "Copiar",
