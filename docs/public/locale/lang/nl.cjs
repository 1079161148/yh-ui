...
exports.nl = exports.default = void 0;
const nl = exports.nl = {
  name: "nl",
  yh: {
    // Algemeen
    ...
    ai: {
      ...
      welcome: {
        ...
        description: "Ik kan je helpen met programmeren, documenten vertalen of creatief schrijven. Wat kan ik vandaag voor je doen?"
      },
      action: {
        copy: "Kopi\xEBren",
