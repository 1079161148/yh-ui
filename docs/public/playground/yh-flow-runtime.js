...
var Iw = (e, a, n) =>
  a in e ? Pw(e, a, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[a] = n)
...
import {
  ...
  createTextVNode as Gw,
  normalizeProps as mc,
  guardReactiveProps as pc,
  getCurrentInstance as Jw
} from 'vue'
function A(e, a) {
...
function ix(e, a, n = /* @__PURE__ */ new Set(), r = /* @__PURE__ */ new Set()) {
  ...
  for (const s of o)
    ...
    } else if (ix(e, s.target, n, r)) return !0
  return (r.delete(a), !1)
}
function n3(e, a) {
...
function Y3(e) {
  return (a) => {
    ...
    for (const n of e) {
      const r = Pd(a.source, n.source),
        o = Pd(a.target, n.target),
...
async function xx(e, a) {
  const { imageType: n, imageQuality: r, pixelRatio: o, backgroundColor: s } = a,
    t = await Promise.resolve().then(() => ZT),
...
const Id = 'http://www.omg.org/spec/BPMN/20100524/MODEL',
  ...
  Sx = 'http://www.omg.org/spec/BPMN/20100524/DC',
  Dx = {
...
function I3(e, a = {}) {
  ...
  for (const M of h) {
    ...
    const T = _.get(w),
      ...
      F = (T == null ? void 0 : T.height) || 80,
      B = { label: L || w }
    ;(D === 'userTask' &&
      ((B.assignee = M.getAttribute('assignee') || ''),
      (B.candidateUsers = M.getAttribute('candidateUsers') || '')),
      D === 'serviceTask' && (B.implementation = M.getAttribute('delegateExpression') || ''))
    const $ = {
      id: w,
      type: Y,
      position: k,
...
const Px = ['width', 'height'],
  Ix = ['width', 'height', 'viewBox'],
  Nx = ['fill', 'stroke', 'stroke-width'],
  Ox = {
    key: 0,
      ...
      const p = () => {
          ...
          for (let x = 0; x < k.length; x++) {
            ...
            ;(j.position.x < S && (S = j.position.x),
              j.position.y < F && (F = j.position.y),
              j.position.x + G > B && (B = j.position.x + G),
              j.position.y + z > $ && ($ = j.position.y + z))
          }
          return S === 1 / 0
            ? { minX: 0, minY: 0, maxX: 1, maxY: 1 }
            : { minX: S, minY: F, maxX: B, maxY: $ }
        },
        v = (k) => (k - f) * _ + h,
        g = (k) => (k - m) * _ + y,
        M = () => {
          ...
          const F = p()
          ;((f = F.minX), (m = F.minY))
          const B = F.maxX - F.minX || 1,
            $ = F.maxY - F.minY || 1,
            x = 4
          if (
            ((_ = Math.min((o.value - x * 2) / B, (s.value - x * 2) / $)),
            (h = (o.value - B * _) / 2),
            (y = (s.value - $ * _) / 2),
        ...
        w = (k) => {
          ...
          if (!S || !_) return
          const F = u.$el,
            B = (F == null ? void 0 : F.clientWidth) || 800,
            $ = (F == null ? void 0 : F.clientHeight) || 600,
            x = -k.x / k.zoom,
            j = -k.y / k.zoom,
            G = B / k.zoom,
            z = $ / k.zoom,
  ...
  Fx = /* @__PURE__ */ ue(zx, [['__scopeId', 'data-v-c1fc9228']]),
  Bx = {
    enabled: !0,
    nodeColor: () => '#fff',
    nodeStrokeColor: () => '#999',
...
const bc = {
  ...
  Jx = Symbol('configProviderContextKey'),
  Ux = () => {
    const e = Od(Jx, null),
      a = J(() => {
        const o = De(e)
...
const Zx = /* @__PURE__ */ Object.assign({
  ...
  n1 = (e) => {
    ...
    const o = (i) => {
      const u = i.split('.'),
        l = [n.value.yh, bc.yh, Gx.yh]
      for (const d of l) {
        let c = d
        for (const _ of u)
          if (c && typeof c == 'object') c = c[_]
          else {
            c = void 0
            break
          }
  ...
  _1 = /* @__PURE__ */ ue(c1, [['__scopeId', 'data-v-0b42efde']]),
  f1 = {
    enabled: !0,
...
const m1 = ['width', 'height'],
  ...
  h1 = /* @__PURE__ */ ue(p1, [['__scopeId', 'data-v-f22cccfe']]),
  v1 = {
    enabled: !0,
    type: 'dots',
    color: '#e5e5e5',
...
const y1 = {
  ...
  Y1 = /* @__PURE__ */ ue(b1, [['__scopeId', 'data-v-8f2975ee']]),
  w1 = {
    enabled: !0,
    snapToGrid: !0,
    gridSize: 15,
...
async function T1(e, a, n) {
  const r = await Promise.resolve().then(() => Fz),
    o = r.default || r,
      ...
      a.enabled &&
        ((r.groupSelectedNodes = (o = 'Group') => {
          ...
          const t = r.nodes.value.map((c) => c.id),
            i = q1(a.groupIdPrefix, t),
            u = C1(s, a.paddingX, a.paddingY),
            l = {}
          s.forEach((c) => {
...
const K3 = {
  ...
  P1 = ['data-handle-id', 'data-handle-type', 'data-handle-position'],
  I1 = /* @__PURE__ */ ie({
    __name: 'BaseNode',
    props: {
      id: {},
  ...
  Z3 = /* @__PURE__ */ ue(I1, [['__scopeId', 'data-v-068cd406']]),
  N1 = {
    key: 1,
  ...
  Q3 = /* @__PURE__ */ ue(O1, [['__scopeId', 'data-v-67bca1f5']]),
  z1 = {
    key: 0,
  ...
  eF = /* @__PURE__ */ ue(F1, [['__scopeId', 'data-v-29b9773e']]),
  B1 = { class: 'flow-group-header' },
  G1 = { class: 'flow-group-label' },
  J1 = { class: 'flow-group-content' },
  U1 = /* @__PURE__ */ ie({
    __name: 'GroupNode',
    props: {
      id: {},
        ...
        return (
          ...
          E(
            ...
            [
              ...
              b('div', J1, [it(r.$slots, 'default', {}, void 0, !0)])
            ],
            6
            /* CLASS, STYLE */
          )
  ...
  tF = /* @__PURE__ */ ue(U1, [['__scopeId', 'data-v-594387f4']]),
  W1 = /* @__PURE__ */ ie({
    __name: 'CustomNode',
    props: {
      id: {},
  ...
  rF = /* @__PURE__ */ ue(W1, [['__scopeId', 'data-v-68714fae']]),
  V1 = ['onMousedown'],
  K1 = /* @__PURE__ */ ie({
    __name: 'NodeResizer',
    props: {
  ...
  nF = /* @__PURE__ */ ue(K1, [['__scopeId', 'data-v-a0e3f161']]),
  X1 = { class: 'default-toolbar' },
  Z1 = /* @__PURE__ */ ie({
    __name: 'NodeToolbar',
    props: {
      nodeId: {},
  ...
  aF = /* @__PURE__ */ ue(Z1, [['__scopeId', 'data-v-978b7d5a']]),
  Q1 = { class: 'yh-flow-node-diamond__content' },
  eL = { class: 'yh-flow-node-diamond__label' },
  tL = {
    key: 0,
  ...
  sL = /* @__PURE__ */ ue(oL, [['__scopeId', 'data-v-3c748647']]),
  iL = { class: 'yh-flow-node-database__body' },
  uL = { class: 'yh-flow-node-database__label' },
  lL = {
    key: 0,
    class: 'flow-handle position-top',
    'data-handle-type': 'target',
  ...
  mL = /* @__PURE__ */ ue(fL, [['__scopeId', 'data-v-cb2bef3f']]),
  pL = { class: 'bpmn-start-event-label' },
  hL = {
    key: 0,
  ...
  yL = /* @__PURE__ */ ue(vL, [['__scopeId', 'data-v-392a3802']]),
  gL = { class: 'bpmn-end-event-label' },
  ML = {
    key: 0,
  ...
  YL = /* @__PURE__ */ ue(bL, [['__scopeId', 'data-v-bffae76f']]),
  wL = {
    key: 0,
    class: 'bpmn-handle bpmn-handle-target',
    'data-handle-type': 'target',
  ...
  SL = /* @__PURE__ */ ue(kL, [['__scopeId', 'data-v-ca562524']]),
  DL = {
    key: 0,
    class: 'bpmn-handle bpmn-handle-target',
    'data-handle-type': 'target',
  ...
  jL = /* @__PURE__ */ ue(HL, [['__scopeId', 'data-v-a8938e02']]),
  EL = {
    key: 0,
    class: 'bpmn-handle bpmn-handle-target',
    'data-handle-type': 'target',
  ...
  RL = /* @__PURE__ */ ue(AL, [['__scopeId', 'data-v-8d8bbd20']]),
  PL = {
    key: 0,
    class: 'bpmn-handle bpmn-handle-target',
    'data-handle-type': 'target',
  ...
  zL = /* @__PURE__ */ ue(OL, [['__scopeId', 'data-v-2bc3a60e']]),
  FL = {
    key: 0,
    class: 'bpmn-handle bpmn-handle-target',
    'data-handle-type': 'target',
  ...
  UL = /* @__PURE__ */ ue(JL, [['__scopeId', 'data-v-948f521d']]),
  WL = {
    key: 0,
    class: 'bpmn-handle bpmn-handle-target',
    'data-handle-type': 'target',
  ...
  ZL = /* @__PURE__ */ ue(XL, [['__scopeId', 'data-v-57d60355']]),
  rt = {
    StartEvent: 'bpmn-start',
    EndEvent: 'bpmn-end',
    Task: 'bpmn-task',
...
function oF() {
  ;($e({ type: rt.StartEvent, component: yL }),
    $e({ type: rt.EndEvent, component: YL }),
    $e({ type: rt.Task, component: SL }),
    $e({ type: rt.ServiceTask, component: jL }),
    $e({ type: rt.UserTask, component: RL }),
    $e({ type: rt.ExclusiveGateway, component: zL }),
    $e({ type: rt.ParallelGateway, component: UL }),
    $e({ type: rt.InclusiveGateway, component: ZL }))
}
const QL = {
    key: 0,
  ...
  ek = { class: 'ai-node-header' },
  tk = { class: 'ai-node-title' },
  rk = { class: 'ai-node-body' },
  nk = { class: 'ai-node-model' },
  ak = {
    key: 1,
  ...
  sk = /* @__PURE__ */ ue(ok, [['__scopeId', 'data-v-6a45f3e9']]),
  ik = {
    key: 0,
    class: 'ai-handle ai-handle-target',
    'data-handle-type': 'target',
  ...
  uk = { class: 'ai-node-header' },
  lk = { class: 'ai-node-title' },
  dk = { class: 'ai-node-body' },
  ck = { class: 'ai-node-preview' },
  _k = {
    key: 1,
    class: 'ai-handle ai-handle-source',
    'data-handle-type': 'source',
  ...
  mk = /* @__PURE__ */ ue(fk, [['__scopeId', 'data-v-accac64d']]),
  pk = {
    key: 0,
    class: 'ai-handle ai-handle-target',
    'data-handle-type': 'target',
  ...
  vk = { class: 'ai-node-title' },
  yk = { class: 'ai-node-body' },
  gk = { class: 'ai-node-tools' },
  Mk = {
    key: 1,
    class: 'ai-handle ai-handle-source',
    'data-handle-type': 'source',
  ...
  Yk = /* @__PURE__ */ ue(bk, [['__scopeId', 'data-v-6f2a727b']]),
  wk = {
    key: 0,
    class: 'ai-handle ai-handle-target',
    'data-handle-type': 'target',
  ...
  xk = { class: 'ai-node-header' },
  Lk = { class: 'ai-node-title' },
  kk = { class: 'ai-node-body' },
  Sk = { class: 'ai-node-tool-name' },
  Dk = {
    key: 1,
    class: 'ai-handle ai-handle-source',
    'data-handle-type': 'source',
  ...
  $k = /* @__PURE__ */ ue(Tk, [['__scopeId', 'data-v-14c6f30f']]),
  Hk = {
    key: 0,
    class: 'ai-handle ai-handle-target',
    'data-handle-type': 'target',
  ...
  Ik = /* @__PURE__ */ ue(Pk, [['__scopeId', 'data-v-a8d72181']]),
  Nk = {
    key: 0,
    class: 'ai-handle ai-handle-source',
    'data-handle-type': 'source',
  ...
  zk = /* @__PURE__ */ ue(Ok, [['__scopeId', 'data-v-8093cf3c']]),
  Fk = {
    key: 0,
    class: 'ai-handle ai-handle-target',
    'data-handle-type': 'target',
  ...
  Gk = /* @__PURE__ */ ue(Bk, [['__scopeId', 'data-v-83555e5c']]),
  Jk = {
    key: 0,
    class: 'ai-handle ai-handle-target',
    'data-handle-type': 'target',
  ...
  Uk = { class: 'ai-node-header' },
  Wk = { class: 'ai-node-title' },
  Vk = { class: 'ai-node-body' },
  Kk = { class: 'ai-node-memory' },
  Xk = {
    key: 1,
    class: 'ai-handle ai-handle-source',
    'data-handle-type': 'source',
  ...
  Qk = /* @__PURE__ */ ue(Zk, [['__scopeId', 'data-v-8db793a7']]),
  nt = {
    LLM: 'ai-llm',
    Prompt: 'ai-prompt',
    Agent: 'ai-agent',
...
function sF() {
  ;($e({ type: nt.LLM, component: sk }),
    $e({ type: nt.Prompt, component: mk }),
    $e({ type: nt.Agent, component: Yk }),
    $e({ type: nt.Tool, component: $k }),
    $e({ type: nt.Condition, component: Ik }),
    $e({ type: nt.Start, component: zk }),
    $e({ type: nt.End, component: Gk }),
    $e({ type: nt.Memory, component: Qk }))
}
const eS = ['d'],
  tS = ['d'],
  rS = ['x', 'y'],
  nS = { class: 'flow-edge-label' },
  aS = /* @__PURE__ */ ie({
    __name: 'BaseEdge',
    props: {
      id: {},
  ...
  iF = /* @__PURE__ */ ue(aS, [['__scopeId', 'data-v-37f87f1e']]),
  oS = ['d'],
  sS = ['x', 'y'],
  iS = { class: 'flow-edge-label' },
  uS = /* @__PURE__ */ ie({
    __name: 'SmoothEdge',
    props: {
      sourceX: {},
  ...
  uF = /* @__PURE__ */ ue(uS, [['__scopeId', 'data-v-3ae148d5']]),
  lS = ['d'],
  dS = ['x', 'y'],
  cS = { class: 'flow-edge-label' },
  _S = /* @__PURE__ */ ie({
    __name: 'StepEdge',
    props: {
      sourceX: {},
  ...
  lF = /* @__PURE__ */ ue(_S, [['__scopeId', 'data-v-11cb7800']]),
  fS = ['d'],
  mS = ['x', 'y'],
  pS = { class: 'flow-edge-label' },
  hS = /* @__PURE__ */ ie({
    __name: 'BezierEdge',
    props: {
      sourceX: {},
  ...
  dF = /* @__PURE__ */ ue(hS, [['__scopeId', 'data-v-5753d51f']]),
  vS = ['id'],
  yS = ['stdDeviation'],
  gS = ['id'],
  MS = ['stop-color'],
  ...
  cF = /* @__PURE__ */ ue(AS, [['__scopeId', 'data-v-bf3b4bf1']]),
  RS = {
    class: 'yh-flow-edges',
    style: {
      overflow: 'visible',
  ...
  PS = ['id'],
  IS = ['x', 'y', 'width'],
  NS = ['data-edge-id', 'onClick', 'onDblclick', 'onContextmenu'],
  OS = ['d'],
  zS = ['d', 'stroke', 'stroke-width', 'mask'],
  FS = ['x', 'y'],
  BS = {
    style: {
      width: '100%',
  ...
  JS = /* @__PURE__ */ ue(GS, [['__scopeId', 'data-v-607ce8de']]),
  US = {
  ...
  t0 = { class: 'yh-flow-nodes' },
  r0 = ['id', 'onMousedown', 'onClick', 'onDblclick', 'onContextmenu'],
  n0 = ['data-handle-id', 'onMousedown'],
  a0 = ['data-handle-id', 'onMousedown'],
  o0 = { class: 'yh-flow-node__content' },
  Lc = 3,
  s0 = /* @__PURE__ */ ie({
    __name: 'NodeRenderer',
    props: {
    ...
    setup(e, { emit: a }) {
      const n = e,
          ...
          return Y === 'diamond'
            ...
            : Y === 'database'
              ...
              : n.nodeTypes && n.nodeTypes[Y]
                ? n.nodeTypes[Y]
                : ((T = Pg(Y)) == null ? void 0 : T.component) ||
                  ((k = fx(Y)) == null ? void 0 : k.component)
        },
        ...
        p = (Y, T) => {
          ...
          let G = [T.id]
          ;((x || F) && j.length > 0 && (G = [T.id, ...j.map((z) => z.id)]),
            G.forEach($),
            (_.value = Array.from(B)),
        ...
        v = (Y) => {
          ...
          if (!m.value && Math.abs(T) < Lc && Math.abs(k) < Lc) return
          if (!m.value) {
            m.value = !0
            const B = h.value
          ...
          const S = (Y.clientX - d.value.x) / n.transform.zoom,
            F = (Y.clientY - d.value.y) / n.transform.zoom
          _.value.forEach((B) => {
            const $ = f.value.get(B)
            if ($) {
              const x = {
  ...
  i0 = /* @__PURE__ */ ue(s0, [['__scopeId', 'data-v-94f30314']]),
  u0 = /* @__PURE__ */ ie({
    __name: 'SelectionBox',
    props: {
      selectionRect: {},
  ...
  l0 = /* @__PURE__ */ ue(u0, [['__scopeId', 'data-v-8a84ee03']]),
  d0 = {
    key: 0,
    class: 'node-edit-panel'
  },
  c0 = { class: 'panel-content' },
  _0 = { class: 'form-group' },
  f0 = { class: 'form-group' },
  m0 = { class: 'form-group' },
  p0 = { class: 'size-inputs' },
  h0 = { class: 'form-group' },
  v0 = { class: 'color-picker-row' },
  y0 = ['value'],
  g0 = { class: 'color-value' },
  M0 = { class: 'form-group' },
  b0 = { class: 'color-picker-row' },
  Y0 = ['value'],
  w0 = { class: 'color-value' },
  x0 = { class: 'form-group' },
  L0 = ['value'],
  k0 = { class: 'form-group' },
  S0 = { class: 'color-picker-row' },
  D0 = ['value'],
  T0 = { class: 'color-value' },
  $0 = { class: 'form-group' },
  H0 = { class: 'color-picker-row' },
  j0 = ['value'],
  E0 = { class: 'color-value' },
  C0 = /* @__PURE__ */ ie({
                          ...
                          b('div', m0, [
                            ...
                            b('div', p0, [
                              je(
                                ...
                                [[Pe, o.value.width, void 0, { number: !0 }]]
                              ),
                              h[11] ||
                                (h[11] = b(
                                  'span',
                              ...
                              je(
                                ...
                                [[Pe, o.value.height, void 0, { number: !0 }]]
                              )
                            ])
                          ]),
                          b('div', h0, [
  ...
  q0 = /* @__PURE__ */ ue(C0, [['__scopeId', 'data-v-3542b442']]),
  A0 = {
    key: 0,
    class: 'ai-node-edit-panel'
  },
  R0 = { class: 'panel-header' },
  P0 = { class: 'panel-title' },
  I0 = { key: 0 },
  N0 = { key: 1 },
  O0 = { key: 2 },
  z0 = { key: 3 },
  ...
  eD = ['value'],
  tD = { class: 'form-group' },
  rD = { class: 'status-badges' },
  nD = {
    key: 0,
    class: 'form-group'
  },
  aD = { class: 'stream-preview' },
  oD = { class: 'stream-text' },
  sD = {
    key: 1,
    class: 'form-group'
  },
  ...
  mD = ['value'],
  pD = { class: 'form-group' },
  hD = { class: 'size-inputs' },
  vD = { class: 'form-group' },
  yD = { class: 'color-picker' },
  gD = ['onClick'],
  MD = { class: 'form-group' },
  bD = { class: 'color-picker' },
  YD = ['onClick'],
  wD = /* @__PURE__ */ ie({
    ...
    setup(e, { emit: a }) {
      ...
      const h = ($, x) => {
        ...
        B = ['#ddd', '#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#06b6d4']
      return ($, x) => (
        H(),
        Ve(Ua, { to: 'body' }, [
          We(
  ...
  xD = /* @__PURE__ */ ue(wD, [['__scopeId', 'data-v-71c97ea4']]),
  LD = {
    key: 0,
    class: 'edge-edit-panel'
  },
  kD = { class: 'panel-content' },
  SD = { class: 'form-group' },
  DD = { class: 'form-group' },
  TD = ['value'],
  $D = { class: 'form-group' },
  HD = { class: 'checkbox-label' },
  jD = { class: 'form-group' },
  ED = { class: 'color-picker-row' },
  CD = ['value'],
  ...
  JD = /* @__PURE__ */ ue(GD, [['__scopeId', 'data-v-c6ec35b4']])
class UD {
  constructor() {
...
const VD = {
    ...
    setup(e, { expose: a, emit: n }) {
      ...
      const r = (C, N, X) => {
        ...
        le = (C) => {
          var N, X
          if (B.value) {
            const Q = C.clientX - $.value.x,
              ve = C.clientY - $.value.y
        ...
        be = (C, N) => {
          ...
          ;(X || D.clearSelection(),
            ...
            s('nodeClick', { node: N, nativeEvent: C }),
            f.emit('node:click', { node: N, nativeEvent: C }))
        },
        Se = (C) => {
        ...
        _e = (C, N) => {
          ;(s('nodeDblClick', { node: N, nativeEvent: C }),
            f.emit('node:dblclick', { node: N, nativeEvent: C }),
            _.value || ((q.value = !1), (se.value = N), (ne.value = !0)))
        },
        Ue = (C, N) => {
          ;(s('nodeContextMenu', { node: N, nativeEvent: C }),
            f.emit('node:contextmenu', { node: N, nativeEvent: C }))
        },
        fe = (C, N) => {
          ;(T.push({ nodes: l.value, edges: d.value }),
            (j.value = N.id),
            (G.value = { ...N.position }),
            s('nodeDragStart', { node: N, nativeEvent: C }),
            f.emit('node:dragstart', { node: N, nativeEvent: C }))
        },
        Ze = (C, N, X) => {
          const Q = k.getAlignmentSnap(N.id, X)
          ;(L.updateNodePosition(N.id, Q, { dragging: !0 }),
            (G.value = Q),
            s('nodeDrag', { node: N, nativeEvent: C, position: Q }),
            f.emit('node:drag', { node: N, nativeEvent: C, position: Q }),
        ...
        Qe = (C, N) => {
          ;(L.updateNodePosition(N.id, N.position, { dragging: !1 }),
            (j.value = null),
            (G.value = null),
            s('nodeDragEnd', { node: N, nativeEvent: C }),
            f.emit('node:dragend', { node: N, nativeEvent: C }),
            s('update:nodes', l.value),
        ...
        mo = (C, N) => {
          ;(console.log('Edge click:', N.id),
            ...
            s('edgeClick', { edge: N, nativeEvent: C }),
            _.value || ((ne.value = !1), (O.value = N), (q.value = !0)),
            f.emit('edge:click', { edge: N, nativeEvent: C }))
        },
        ft = (C, N) => {
          ;(console.log('Edge dblclick:', N.id),
            s('edgeDblClick', { edge: N, nativeEvent: C }),
            f.emit('edge:dblclick', { edge: N, nativeEvent: C }),
            _.value || ((ne.value = !1), (O.value = N), (q.value = !0)))
        },
        Be = (C, N) => {
          ;(s('edgeContextMenu', { edge: N, nativeEvent: C }),
            f.emit('edge:contextmenu', { edge: N, nativeEvent: C }))
        },
        Te = (C, N, X) => {
          var Re
          if (_.value) return
                ...
                b(
                  ...
                  [
                    ...
                    We(
                      ...
                      {
                        edge: $t((de) => [it(C.$slots, 'edge', mc(pc(de)), void 0, !0)]),
                        _: 3
                        /* FORWARDED */
                      },
                      8,
                    ...
                    We(
                      ...
                      {
                        node: $t((de) => [it(C.$slots, 'node', mc(pc(de)), void 0, !0)]),
                        _: 3
                        /* FORWARDED */
                      },
                      8,
  ...
  _F = /* @__PURE__ */ ue(XD, [['__scopeId', 'data-v-43f1653b']]),
  ZD = ['width', 'height'],
  QD = ['cx', 'cy', 'fill'],
  eT = ['d', 'stroke'],
  tT = ['fill'],
  rT = /* @__PURE__ */ ie({
    ...
    setup(e, { expose: a }) {
      var _
      const n = e,
        o = `yh-bg-pattern-${((_ = Jw()) == null ? void 0 : _.uid) ?? Math.random().toString(36).slice(2)}`,
        s = ee(),
        t = ee(),
        i = ee(),
        u = ee(),
  ...
  fF = /* @__PURE__ */ ue(rT, [['__scopeId', 'data-v-f7d7420a']])
function nT(e, a) {
...
function oT(e) {
  const a = Fa(e, 'border-left-width'),
    n = Fa(e, 'border-right-width')
  return e.clientWidth + a + n
}
function sT(e) {
  const a = Fa(e, 'border-top-width'),
    n = Fa(e, 'border-bottom-width')
  return e.clientHeight + a + n
}
function Gd(e, a = {}) {
  const n = a.width || oT(e),
    r = a.height || sT(e)
...
const qe = 16384
function uT(e) {
  ;(e.width > qe || e.height > qe) &&
    (e.width > qe && e.height > qe
      ? e.width > e.height
        ? ((e.height *= qe / e.width), (e.width = qe))
        : ((e.width *= qe / e.height), (e.height = qe))
      : e.width > qe
        ? ((e.height *= qe / e.width), (e.width = qe))
        : ((e.width *= qe / e.height), (e.height = qe)))
}
...
const Sc = 'application/font-woff',
  Dc = 'image/jpeg',
  hT = {
    woff: Sc,
    woff2: Sc,
...
async function Ud(e, a, n) {
  ...
  try {
    const s = await Wg(
      e,
      n.fetchRequestInit,
      ({ res: t, result: i }) => (a || (a = t.headers.get('Content-Type') || ''), yT(i))
    )
    o = gT(s, a)
  } catch (s) {
...
const LT = (e) => e.tagName != null && e.tagName.toUpperCase() === 'SLOT',
  Vg = (e) => e.tagName != null && e.tagName.toUpperCase() === 'SVG'
async function kT(e, a, n) {
  var r, o
  if (Vg(a)) return a
  let s = []
  return (
    LT(e) && e.assignedNodes
  ...
  const r = /url\(["']?([^"')]+)["']?\)/g,
    s = (n.match(/url\([^)]+\)/g) || []).map(async (t) => {
      ...
      return (
        ...
        Wg(i, a.fetchRequestInit, ({ result: u }) => ((n = n.replace(t, `url(${u})`)), [t, u]))
      )
    })
...
function FT(e) {
  return e
    ...
    .filter((a) => Xg(a.style.getPropertyValue('src')))
}
...
async function tM(e, a) {
  ...
  return (
    await Promise.all(
      n
        .filter((s) => r.has(eM(s.style.fontFamily)))
        .map((s) => {
...
function ew() {
  ...
  function Ue(fe, Ze, Qe, mo, ft, Be) {
    var Te,
      ...
      st = Ze & D,
      zt = Ze & Y
    if ((Qe && (Te = ft ? Qe(fe, mo, ft, Be) : Qe(fe)), Te !== void 0)) return Te
    if (!v(fe)) return fe
    var Ft = h(fe)
    if (Ft) {
      ...
      if (et == z || et == T || (Bt && !ft)) {
        if (((Te = st || Bt ? {} : m(fe)), !mt)) return st ? u(fe, o(Te, fe)) : i(fe, r(Te, fe))
      } else {
...
function EN() {
  ...
  function w(L, D, Y, T, k, S, F) {
    switch (Y) {
      ...
      case m:
        var $ = T & t
        if ((B || (B = s), L.size != D.size && !$)) return !1
        var x = F.get(L)
        if (x) return x == D
        ;((T |= i), F.set(L, D))
...
function qN() {
  ...
  function m(h, y, p, v, g, M) {
    ...
    if (!(p & u)) {
      var F = T && f.call(h, '__wrapped__'),
        B = k && f.call(y, '__wrapped__')
      if (F || B) {
        var $ = F ? h.value() : h,
          x = B ? y.value() : y
  ...
  function r(p, v) {
    ...
    function M(w, L) {
      var D = 0,
        ...
        k = e.last(L)
      return (
        e.forEach(L, function (S, F) {
          var B = s(p, S),
            $ = B ? p.node(B).order : T
          ;(B || S === k) &&
            (e.forEach(L.slice(Y, F + 1), function (x) {
  ...
  function o(p, v) {
    ...
    function M(L, D, Y, T, k) {
      ...
      e.forEach(e.range(D, Y), function (F) {
        ;((S = L[F]),
          p.node(S).dummy &&
            e.forEach(p.predecessors(S), function (B) {
              var $ = p.node(B)
...
function Pz() {
  ...
  function y(q, O) {
    ;(e.forEach(q.nodes(), function (U) {
      ...
      (q.graph().width = O.graph().width),
      (q.graph().height = O.graph().height))
  }
  ...
  function F(q) {
    ...
    ;(e.forEach(q.nodes(), function (U) {
      var V = q.node(U)
      V.borderTop &&
        ((V.minRank = q.node(V.borderTop).rank),
        (V.maxRank = q.node(V.borderBottom).rank),
        (O = e.max(O, V.maxRank)))
    }),
      (q.graph().maxRank = O))
  }
  ...
  function z(q) {
    ;(e.forEach(q.nodes(), function (O) {
      if (q.children(O).length) {
        var U = q.node(O),
          V = q.node(U.borderTop),
          oe = q.node(U.borderBottom),
          ce = q.node(e.last(U.borderLeft)),
          le = q.node(e.last(U.borderRight))
    ...
    e.forEach(q.edges(), function (O) {
      if (O.v === O.w) {
        ...
        ;(U.selfEdges || (U.selfEdges = []),
          U.selfEdges.push({ e: O, label: q.edge(O) }),
          q.removeEdge(O))
      }
    })
  }
