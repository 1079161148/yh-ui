...
var Iw = (e, a, n) => a in e ? Rw(e, a, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[a] = n;
var ye = (e, a, n) => Iw(e, typeof a != "symbol" ? a + "" : a, n);
import { inject as Od, provide as Eg, ref as ee, computed as J, shallowRef as qa, defineComponent as ie, onMounted as jt, onBeforeUnmount as zd, watch as Le, openBlock as H, createElementBlock as E, withModifiers as we, normalizeStyle as re, normalizeClass as te, createCommentVNode as P, createElementVNode as b, markRaw as Ja, unref as De, Fragment as pe, renderList as ke, nextTick as Pw, toDisplayString as ae, renderSlot as it, createBlock as Ve, Teleport as Ua, useCssVars as Nw, onUnmounted as Ow, mergeProps as Tt, resolveDynamicComponent as Ca, createVNode as We, Transition as Bd, withCtx as $t, withDirectives as je, withKeys as Fd, vModelText as Ie, vModelSelect as zw, vModelCheckbox as Bw, createTextVNode as Fw, normalizeProps as mc, guardReactiveProps as pc, getCurrentInstance as Gw } from "vue";
function A(e, a) {
...
function Vw(e, a = {}) {
  ...
  return {
    ...
    fitView: (g, M, w = {}) => {
      ...
      const S = T - D + L * 2, B = k - Y + L * 2, F = g.width / S, $ = g.height / B, x = Math.min(F, $, 1), j = (g.width - S * x) / 2 - D * x + L * x, G = (g.height - B * x) / 2 - Y * x + L * x;
      i({ x: j, y: G, zoom: x });
    },
    center: (g, M, w = {}) => {
      if (M.length === 0) return;
      ...
      let D = 0, Y = 0;
      for (const S of M) {
        const B = S.width || 200, F = S.height || 50;
        D += S.position.x + B / 2, Y += S.position.y + F / 2;
      }
...
function Kw(e, a) {
  ...
  return {
    ...
    updateNodePosition: (p, v, g) => {
      let M = v;
      r && (M = Ww(v, o)), n.value = n.value.map((L) => L.id === p ? { ...L, position: M, dragging: (g == null ? void 0 : g.dragging) ?? !1 } : L);
...
function Qw(e, a, n = {}) {
  const { maxHistory: r = 50, onHistoryChange: o } = n, s = qa([]), t = ee(-1), i = J(() => t.value > 0), u = J(() => t.value < s.value.length - 1);
  return {
    canUndo: i,
    canRedo: u,
    undo: () => {
...
function bz(e) {
  return (a) => {
    if (!e || e.length === 0)
      return !0;
    for (const n of e) {
      const r = Id(a.source, n.source), o = Id(a.target, n.target), s = yc(a.sourceHandle, n.sourceHandle), t = yc(a.targetHandle, n.targetHandle);
      if (r && o && s && t)
        return !0;
    }
    return !1;
...
function Hz() {
  Et.clear(), qt.clear(), ut.clear(), Wa.clear();
}
class jz {
  constructor() {
    ye(this, "_nodes", qa([]));
...
async function w1(e, a) {
  const { imageType: n, imageQuality: r, pixelRatio: o, backgroundColor: s } = a, t = await Promise.resolve().then(() => XT), i = typeof t.toPng == "function" ? t : t.default, u = {
    backgroundColor: s,
    pixelRatio: o
  };
  let l, d = n;
  ...
  const c = M1[d], _ = await Y1(l), f = Math.round(e.offsetWidth * o), m = Math.round(e.offsetHeight * o);
  return {
    dataUrl: l,
    blob: _,
    width: f,
...
const Pd = "http://www.omg.org/spec/BPMN/20100524/MODEL", Mc = "http://www.omg.org/spec/BPMN/20100524/DI", k1 = "http://www.omg.org/spec/BPMN/20100524/DC", S1 = {
...
<bpmn:definitions xmlns:bpmn="${Pd}" xmlns:bpmndi="${Mc}" xmlns:dc="${k1}" xmlns:di="${Mc}" id="definitions_${r}" targetNamespace="http://bpmn.io/schema/bpmn">
...
function Iz(e, a = {}) {
  ...
  const h = ((M) => {
    ...
    return w.forEach((D) => {
      const Y = [];
      Y.push(...Array.from(M.getElementsByTagNameNS(Pd, D))), Y.push(...Array.from(M.getElementsByTagName(D)).filter((T) => !T.prefix)), Y.length === 0 && Y.push(...Array.from(M.querySelectorAll(`[localName="${D}"]`))), L.push(...Y);
    }), L;
  })(i), y = /* @__PURE__ */ new Map();
  let p = n.y;
  for (const M of h) {
    const w = M.getAttribute("id"), L = M.getAttribute("name") || "", D = M.localName, Y = D1[D];
    if (!Y || !w) continue;
    const T = _.get(w), k = T ? { x: T.x, y: T.y } : { x: n.x, y: n.y + p }, S = (T == null ? void 0 : T.width) || 100, B = (T == null ? void 0 : T.height) || 80, F = { label: L || w };
    D === "userTask" && (F.assignee = M.getAttribute("assignee") || "", F.candidateUsers = M.getAttribute("candidateUsers") || ""), D === "serviceTask" && (F.implementation = M.getAttribute("delegateExpression") || "");
    const $ = {
      id: w,
      type: Y,
      position: k,
  ...
  const v = [
    ...Array.from(i.getElementsByTagNameNS(Pd, "sequenceFlow")),
  ...
  return _.size === 0 && H1(o, s, r), { nodes: o, edges: s, processId: d, processName: c };
}
function H1(e, a, n) {
...
class E1 {
  constructor(a = {}) {
    ...
    this.options = {
      variableEvaluator: a.variableEvaluator || j1,
...
const Ng = Symbol("yh-flow-context");
function A1(e) {
  e && Eg(Ng, e);
}
function Ct() {
...
const R1 = ["width", "height"], I1 = ["width", "height", "viewBox"], P1 = ["fill", "stroke", "stroke-width"], N1 = {
  key: 0,
  ...
  setup(e, { emit: a }) {
    const n = e, r = a, o = J(() => n.width || 200), s = J(() => n.height || 150), t = ee(), i = ee(), u = Ct(), l = u.nodes, d = u.edges, c = u.viewport;
    let _ = 1, f = 0, m = 0, h = 0, y = 0;
    const p = () => {
      const k = l.value;
      if (!k.length) return { minX: 0, minY: 0, maxX: 1, maxY: 1 };
      let S = 1 / 0, B = 1 / 0, F = -1 / 0, $ = -1 / 0;
      for (let x = 0; x < k.length; x++) {
        const j = k[x];
        if (j.hidden) continue;
        const G = j.width || 120, z = j.height || 50;
        j.position.x < S && (S = j.position.x), j.position.y < B && (B = j.position.y), j.position.x + G > F && (F = j.position.x + G), j.position.y + z > $ && ($ = j.position.y + z);
      }
      return S === 1 / 0 ? { minX: 0, minY: 0, maxX: 1, maxY: 1 } : { minX: S, minY: B, maxX: F, maxY: $ };
      ...
      const B = p();
      f = B.minX, m = B.minY;
      const F = B.maxX - B.minX || 1, $ = B.maxY - B.minY || 1, x = 4;
      if (_ = Math.min((o.value - x * 2) / F, (s.value - x * 2) / $), h = (o.value - F * _) / 2, y = (s.value - $ * _) / 2, S.clearRect(0, 0, o.value, s.value), !l.value.length) {
        w(c.value);
        return;
      }
      ...
      S.strokeStyle = z, S.lineWidth = 1.2, S.globalAlpha = 0.5, S.beginPath(), d.value.forEach((K) => {
        ...
        const se = Math.max((K.width || 120) * _, 3), C = Math.max((K.height || 50) * _, 3), O = v(K.position.x), U = g(K.position.y);
        if (S.fillRect(O, U, se, C), n.nodeStrokeWidth || n.nodeStrokeColor) {
          let V = "#94a3b8";
          n.nodeStrokeColor && (V = typeof n.nodeStrokeColor == "function" ? n.nodeStrokeColor(K) : n.nodeStrokeColor), S.strokeStyle = V, S.lineWidth = n.nodeStrokeWidth || 0.5, S.strokeRect(O, U, se, C);
        }
      }), S.globalAlpha = 1, w(c.value);
    }, w = (k) => {
      const S = i.value;
      if (!S || !_) return;
      const B = u.$el, F = (B == null ? void 0 : B.clientWidth) || 800, $ = (B == null ? void 0 : B.clientHeight) || 600, x = -k.x / k.zoom, j = -k.y / k.zoom, G = F / k.zoom, z = $ / k.zoom, W = (x - f) * _ + h, Z = (j - m) * _ + y, K = Math.max(G * _, 2), ne = Math.max(z * _, 2);
    ...
    const D = (k) => {
      ...
      if (!S) return;
      const B = k.clientX - S.left, F = k.clientY - S.top, $ = (B - h) / _ + f, x = (F - y) / _ + m, j = c.value.zoom, G = u.$el, z = (G == null ? void 0 : G.clientWidth) || 800, W = (G == null ? void 0 : G.clientHeight) || 600, Z = z / 2 - $ * j, K = W / 2 - x * j;
      ...
      var S;
      if (n.interactive && !L) {
        const B = (S = t.value) == null ? void 0 : S.getBoundingClientRect();
        if (B) {
          const F = k.clientX - B.left, $ = k.clientY - B.top, x = (F - h) / _ + f, j = ($ - y) / _ + m, G = c.value.zoom, z = u.$el, W = (z == null ? void 0 : z.clientWidth) || 800, Z = (z == null ? void 0 : z.clientHeight) || 600, K = W / 2 - x * G, ne = Z / 2 - j * G;
    ...
    return jt(M), zd(Y), Le([l, d], M, { deep: !0, flush: "post" }), Le(c, (k) => w(k), { flush: "sync" }), (k, S) => (H(), E(
      ...
      [
        ...
        P(" Layout Controls (optional) "),
        n.showLayoutControls ? (H(), E("div", N1, [
          b(
            "button",
            {
              class: te(["layout-btn", { active: n.layoutType === "dagre" }]),
              title: "Dagre Layout",
              onClick: S[0] || (S[0] = we((B) => r("layoutChange", "dagre"), ["stop"]))
            },
            " D ",
            2
            /* CLASS */
          ...
          b(
            "button",
            {
              ...
              title: "ELK Layout",
              onClick: S[1] || (S[1] = we((B) => r("layoutChange", "elk"), ["stop"]))
            },
            " E ",
            2
            /* CLASS */
          ...
          b(
            "button",
            {
              ...
              title: "Force Layout",
              onClick: S[2] || (S[2] = we((B) => r("layoutChange", "force"), ["stop"]))
            },
            " F ",
            2
            /* CLASS */
          ...
          b(
            "button",
            {
              ...
              title: "Top to Bottom",
              onClick: S[3] || (S[3] = we((B) => r("directionChange", "TB"), ["stop"]))
            },
            " TB ",
            2
            /* CLASS */
          ...
          b(
            "button",
            {
              ...
              title: "Left to Right",
              onClick: S[4] || (S[4] = we((B) => r("directionChange", "LR"), ["stop"]))
            },
            " LR ",
            2
            /* CLASS */
  ...
  for (const [r, o] of a)
    n[r] = o;
  return n;
}, z1 = /* @__PURE__ */ ue(O1, [["__scopeId", "data-v-c1fc9228"]]), B1 = {
  enabled: !0,
  nodeColor: () => "#fff",
  nodeStrokeColor: () => "#999",
  nodeStrokeWidth: 1,
...
var Zt = { exports: {} }, U1 = Zt.exports, bc;
function I() {
  return bc || (bc = 1, (function(e, a) {
    (function(n, r) {
      ...
      var D = "$isDayjsObject", Y = function($) {
        ...
        return j.date = $, j.args = arguments, new B(j);
      }, S = M;
      ...
      var B = (function() {
        ...
        return x.parse = function(j) {
          ...
          }, se = this.$W, C = this.$M, O = this.$D, U = "set" + (this.$u ? "UTC" : "");
          switch (Z) {
            case f:
              return W ? K(1, 0) : K(31, 11);
            case c:
              return W ? K(1, C) : K(0, C + 1);
            case d:
              var V = this.$locale().weekStart || 0, oe = (se < V ? se + 7 : se) - V;
              return K(W ? O - oe : O + (6 - oe), C);
            case l:
            case m:
              return ne(U + "Hours", 0);
            case u:
          ...
          var z, W = this;
          j = Number(j);
          var Z = S.p(G), K = function(C) {
            var O = k(W);
            return S.w(O.date(O.date() + Math.round(C * j)), W);
          };
          ...
          var W = j || "YYYY-MM-DDTHH:mm:ssZ", Z = S.z(this), K = this.$H, ne = this.$m, se = this.$M, C = z.weekdays, O = z.months, U = z.meridiem, V = function(le, he, Ae, be) {
            ...
            return he || (function(Ae) {
              switch (Ae) {
                ...
                case "d":
                  return String(G.$W);
                case "dd":
                  return V(z.weekdaysMin, G.$W, C, 2);
                case "ddd":
                  return V(z.weekdaysShort, G.$W, C, 3);
                case "dddd":
                  return C[G.$W];
                case "H":
                  return String(K);
          ...
          var W, Z = this, K = S.p(G), ne = k(j), se = (ne.utcOffset() - this.utcOffset()) * r, C = this - ne, O = function() {
            return S.m(Z, ne);
          };
          switch (K) {
            case f:
      ...
      return k.prototype = F, [["$ms", s], ["$s", t], ["$m", i], ["$H", u], ["$W", l], ["$M", c], ["$y", f], ["$D", m]].forEach((function($) {
        F[$[1]] = function(x) {
          return this.$g(x, $[0], $[1]);
        };
      })), k.extend = function($, x) {
        return $.$i || ($(x, B, k), $.$i = !0), k;
...
var Og = I();
const zg = /* @__PURE__ */ R(Og), W1 = /* @__PURE__ */ A({
  __proto__: null,
  default: zg
}, [Og]), xt = zg ?? W1;
var Qt = { exports: {} }, V1 = Qt.exports, Yc;
function K1() {
...
K1();
const X1 = /* @__PURE__ */ Object.assign({
  "../../../../node_modules/dayjs/locale/af.js": () => Promise.resolve().then(() => t$),
  "../../../../node_modules/dayjs/locale/am.js": () => Promise.resolve().then(() => o$),
  "../../../../node_modules/dayjs/locale/ar-dz.js": () => Promise.resolve().then(() => l$),
  "../../../../node_modules/dayjs/locale/ar-iq.js": () => Promise.resolve().then(() => f$),
  "../../../../node_modules/dayjs/locale/ar-kw.js": () => Promise.resolve().then(() => v$),
  "../../../../node_modules/dayjs/locale/ar-ly.js": () => Promise.resolve().then(() => b$),
  "../../../../node_modules/dayjs/locale/ar-ma.js": () => Promise.resolve().then(() => L$),
  "../../../../node_modules/dayjs/locale/ar-sa.js": () => Promise.resolve().then(() => T$),
  "../../../../node_modules/dayjs/locale/ar-tn.js": () => Promise.resolve().then(() => E$),
  "../../../../node_modules/dayjs/locale/ar.js": () => Promise.resolve().then(() => R$),
  "../../../../node_modules/dayjs/locale/az.js": () => Promise.resolve().then(() => O$),
  "../../../../node_modules/dayjs/locale/be.js": () => Promise.resolve().then(() => G$),
  "../../../../node_modules/dayjs/locale/bg.js": () => Promise.resolve().then(() => V$),
  "../../../../node_modules/dayjs/locale/bi.js": () => Promise.resolve().then(() => Q$),
  "../../../../node_modules/dayjs/locale/bm.js": () => Promise.resolve().then(() => nH),
  "../../../../node_modules/dayjs/locale/bn-bd.js": () => Promise.resolve().then(() => iH),
  "../../../../node_modules/dayjs/locale/bn.js": () => Promise.resolve().then(() => cH),
  "../../../../node_modules/dayjs/locale/bo.js": () => Promise.resolve().then(() => pH),
  "../../../../node_modules/dayjs/locale/br.js": () => Promise.resolve().then(() => gH),
  "../../../../node_modules/dayjs/locale/bs.js": () => Promise.resolve().then(() => wH),
  "../../../../node_modules/dayjs/locale/ca.js": () => Promise.resolve().then(() => SH),
  "../../../../node_modules/dayjs/locale/cs.js": () => Promise.resolve().then(() => HH),
  "../../../../node_modules/dayjs/locale/cv.js": () => Promise.resolve().then(() => CH),
  "../../../../node_modules/dayjs/locale/cy.js": () => Promise.resolve().then(() => PH),
  "../../../../node_modules/dayjs/locale/da.js": () => Promise.resolve().then(() => BH),
  "../../../../node_modules/dayjs/locale/de-at.js": () => Promise.resolve().then(() => UH),
  "../../../../node_modules/dayjs/locale/de-ch.js": () => Promise.resolve().then(() => XH),
  "../../../../node_modules/dayjs/locale/de.js": () => Promise.resolve().then(() => tj),
  "../../../../node_modules/dayjs/locale/dv.js": () => Promise.resolve().then(() => oj),
  "../../../../node_modules/dayjs/locale/el.js": () => Promise.resolve().then(() => lj),
  "../../../../node_modules/dayjs/locale/en-au.js": () => Promise.resolve().then(() => fj),
  "../../../../node_modules/dayjs/locale/en-ca.js": () => Promise.resolve().then(() => vj),
  "../../../../node_modules/dayjs/locale/en-gb.js": () => Promise.resolve().then(() => bj),
  "../../../../node_modules/dayjs/locale/en-ie.js": () => Promise.resolve().then(() => Lj),
  "../../../../node_modules/dayjs/locale/en-il.js": () => Promise.resolve().then(() => Tj),
  "../../../../node_modules/dayjs/locale/en-in.js": () => Promise.resolve().then(() => Ej),
  "../../../../node_modules/dayjs/locale/en-nz.js": () => Promise.resolve().then(() => Rj),
  "../../../../node_modules/dayjs/locale/en-sg.js": () => Promise.resolve().then(() => Oj),
  "../../../../node_modules/dayjs/locale/en-tt.js": () => Promise.resolve().then(() => Gj),
  "../../../../node_modules/dayjs/locale/eo.js": () => Promise.resolve().then(() => Vj),
  "../../../../node_modules/dayjs/locale/es-do.js": () => Promise.resolve().then(() => Qj),
  "../../../../node_modules/dayjs/locale/es-mx.js": () => Promise.resolve().then(() => n2),
  "../../../../node_modules/dayjs/locale/es-pr.js": () => Promise.resolve().then(() => i2),
  "../../../../node_modules/dayjs/locale/es-us.js": () => Promise.resolve().then(() => c2),
  "../../../../node_modules/dayjs/locale/es.js": () => Promise.resolve().then(() => p2),
  "../../../../node_modules/dayjs/locale/et.js": () => Promise.resolve().then(() => g2),
  "../../../../node_modules/dayjs/locale/eu.js": () => Promise.resolve().then(() => w2),
  "../../../../node_modules/dayjs/locale/fa.js": () => Promise.resolve().then(() => S2),
  "../../../../node_modules/dayjs/locale/fi.js": () => Promise.resolve().then(() => H2),
  "../../../../node_modules/dayjs/locale/fo.js": () => Promise.resolve().then(() => C2),
  "../../../../node_modules/dayjs/locale/fr-ca.js": () => Promise.resolve().then(() => P2),
  "../../../../node_modules/dayjs/locale/fr-ch.js": () => Promise.resolve().then(() => B2),
  "../../../../node_modules/dayjs/locale/fr.js": () => Promise.resolve().then(() => U2),
  "../../../../node_modules/dayjs/locale/fy.js": () => Promise.resolve().then(() => X2),
  "../../../../node_modules/dayjs/locale/ga.js": () => Promise.resolve().then(() => tE),
  "../../../../node_modules/dayjs/locale/gd.js": () => Promise.resolve().then(() => oE),
  "../../../../node_modules/dayjs/locale/gl.js": () => Promise.resolve().then(() => lE),
  "../../../../node_modules/dayjs/locale/gom-latn.js": () => Promise.resolve().then(() => fE),
  "../../../../node_modules/dayjs/locale/gu.js": () => Promise.resolve().then(() => vE),
  "../../../../node_modules/dayjs/locale/he.js": () => Promise.resolve().then(() => bE),
  "../../../../node_modules/dayjs/locale/hi.js": () => Promise.resolve().then(() => LE),
  "../../../../node_modules/dayjs/locale/hr.js": () => Promise.resolve().then(() => TE),
  "../../../../node_modules/dayjs/locale/ht.js": () => Promise.resolve().then(() => EE),
  "../../../../node_modules/dayjs/locale/hu.js": () => Promise.resolve().then(() => RE),
  "../../../../node_modules/dayjs/locale/hy-am.js": () => Promise.resolve().then(() => OE),
  "../../../../node_modules/dayjs/locale/id.js": () => Promise.resolve().then(() => GE),
  "../../../../node_modules/dayjs/locale/is.js": () => Promise.resolve().then(() => VE),
  "../../../../node_modules/dayjs/locale/it-ch.js": () => Promise.resolve().then(() => QE),
  "../../../../node_modules/dayjs/locale/it.js": () => Promise.resolve().then(() => nq),
  "../../../../node_modules/dayjs/locale/ja.js": () => Promise.resolve().then(() => iq),
  "../../../../node_modules/dayjs/locale/jv.js": () => Promise.resolve().then(() => cq),
  "../../../../node_modules/dayjs/locale/ka.js": () => Promise.resolve().then(() => pq),
  "../../../../node_modules/dayjs/locale/kk.js": () => Promise.resolve().then(() => gq),
  "../../../../node_modules/dayjs/locale/km.js": () => Promise.resolve().then(() => wq),
  "../../../../node_modules/dayjs/locale/kn.js": () => Promise.resolve().then(() => Sq),
  "../../../../node_modules/dayjs/locale/ko.js": () => Promise.resolve().then(() => Hq),
  "../../../../node_modules/dayjs/locale/ku.js": () => Promise.resolve().then(() => Cq),
  "../../../../node_modules/dayjs/locale/ky.js": () => Promise.resolve().then(() => Pq),
  "../../../../node_modules/dayjs/locale/lb.js": () => Promise.resolve().then(() => Bq),
  "../../../../node_modules/dayjs/locale/lo.js": () => Promise.resolve().then(() => Uq),
  "../../../../node_modules/dayjs/locale/lt.js": () => Promise.resolve().then(() => Xq),
  "../../../../node_modules/dayjs/locale/lv.js": () => Promise.resolve().then(() => tC),
  "../../../../node_modules/dayjs/locale/me.js": () => Promise.resolve().then(() => oC),
  "../../../../node_modules/dayjs/locale/mi.js": () => Promise.resolve().then(() => lC),
  "../../../../node_modules/dayjs/locale/mk.js": () => Promise.resolve().then(() => fC),
  "../../../../node_modules/dayjs/locale/ml.js": () => Promise.resolve().then(() => vC),
  "../../../../node_modules/dayjs/locale/mn.js": () => Promise.resolve().then(() => bC),
  "../../../../node_modules/dayjs/locale/mr.js": () => Promise.resolve().then(() => LC),
  "../../../../node_modules/dayjs/locale/ms-my.js": () => Promise.resolve().then(() => TC),
  "../../../../node_modules/dayjs/locale/ms.js": () => Promise.resolve().then(() => EC),
  "../../../../node_modules/dayjs/locale/mt.js": () => Promise.resolve().then(() => RC),
  "../../../../node_modules/dayjs/locale/my.js": () => Promise.resolve().then(() => OC),
  "../../../../node_modules/dayjs/locale/nb.js": () => Promise.resolve().then(() => GC),
  "../../../../node_modules/dayjs/locale/ne.js": () => Promise.resolve().then(() => VC),
  "../../../../node_modules/dayjs/locale/nl-be.js": () => Promise.resolve().then(() => QC),
  "../../../../node_modules/dayjs/locale/nl.js": () => Promise.resolve().then(() => nA),
  "../../../../node_modules/dayjs/locale/nn.js": () => Promise.resolve().then(() => iA),
  "../../../../node_modules/dayjs/locale/oc-lnc.js": () => Promise.resolve().then(() => cA),
  "../../../../node_modules/dayjs/locale/pa-in.js": () => Promise.resolve().then(() => pA),
  "../../../../node_modules/dayjs/locale/pl.js": () => Promise.resolve().then(() => gA),
  "../../../../node_modules/dayjs/locale/pt-br.js": () => Promise.resolve().then(() => wA),
  "../../../../node_modules/dayjs/locale/pt.js": () => Promise.resolve().then(() => SA),
  "../../../../node_modules/dayjs/locale/rn.js": () => Promise.resolve().then(() => HA),
  "../../../../node_modules/dayjs/locale/ro.js": () => Promise.resolve().then(() => CA),
  "../../../../node_modules/dayjs/locale/ru.js": () => Promise.resolve().then(() => PA),
  "../../../../node_modules/dayjs/locale/rw.js": () => Promise.resolve().then(() => BA),
  "../../../../node_modules/dayjs/locale/sd.js": () => Promise.resolve().then(() => UA),
  "../../../../node_modules/dayjs/locale/se.js": () => Promise.resolve().then(() => XA),
  "../../../../node_modules/dayjs/locale/si.js": () => Promise.resolve().then(() => tR),
  "../../../../node_modules/dayjs/locale/sk.js": () => Promise.resolve().then(() => oR),
  "../../../../node_modules/dayjs/locale/sl.js": () => Promise.resolve().then(() => lR),
  "../../../../node_modules/dayjs/locale/sq.js": () => Promise.resolve().then(() => fR),
  "../../../../node_modules/dayjs/locale/sr-cyrl.js": () => Promise.resolve().then(() => vR),
  "../../../../node_modules/dayjs/locale/sr.js": () => Promise.resolve().then(() => bR),
  "../../../../node_modules/dayjs/locale/ss.js": () => Promise.resolve().then(() => LR),
  "../../../../node_modules/dayjs/locale/sv-fi.js": () => Promise.resolve().then(() => TR),
  "../../../../node_modules/dayjs/locale/sv.js": () => Promise.resolve().then(() => ER),
  "../../../../node_modules/dayjs/locale/sw.js": () => Promise.resolve().then(() => RR),
  "../../../../node_modules/dayjs/locale/ta.js": () => Promise.resolve().then(() => OR),
  "../../../../node_modules/dayjs/locale/te.js": () => Promise.resolve().then(() => GR),
  "../../../../node_modules/dayjs/locale/tet.js": () => Promise.resolve().then(() => VR),
  "../../../../node_modules/dayjs/locale/tg.js": () => Promise.resolve().then(() => QR),
  "../../../../node_modules/dayjs/locale/th.js": () => Promise.resolve().then(() => nI),
  "../../../../node_modules/dayjs/locale/tk.js": () => Promise.resolve().then(() => iI),
  "../../../../node_modules/dayjs/locale/tl-ph.js": () => Promise.resolve().then(() => cI),
  "../../../../node_modules/dayjs/locale/tlh.js": () => Promise.resolve().then(() => pI),
  "../../../../node_modules/dayjs/locale/tr.js": () => Promise.resolve().then(() => gI),
  "../../../../node_modules/dayjs/locale/tzl.js": () => Promise.resolve().then(() => wI),
  "../../../../node_modules/dayjs/locale/tzm-latn.js": () => Promise.resolve().then(() => SI),
  "../../../../node_modules/dayjs/locale/tzm.js": () => Promise.resolve().then(() => HI),
  "../../../../node_modules/dayjs/locale/ug-cn.js": () => Promise.resolve().then(() => CI),
  "../../../../node_modules/dayjs/locale/uk.js": () => Promise.resolve().then(() => PI),
  "../../../../node_modules/dayjs/locale/ur.js": () => Promise.resolve().then(() => BI),
  "../../../../node_modules/dayjs/locale/uz-latn.js": () => Promise.resolve().then(() => UI),
  "../../../../node_modules/dayjs/locale/uz.js": () => Promise.resolve().then(() => XI),
  "../../../../node_modules/dayjs/locale/vi.js": () => Promise.resolve().then(() => tP),
  "../../../../node_modules/dayjs/locale/x-pseudo.js": () => Promise.resolve().then(() => oP),
  "../../../../node_modules/dayjs/locale/yo.js": () => Promise.resolve().then(() => lP),
  "../../../../node_modules/dayjs/locale/zh-cn.js": () => Promise.resolve().then(() => fP),
  "../../../../node_modules/dayjs/locale/zh-hk.js": () => Promise.resolve().then(() => vP),
  "../../../../node_modules/dayjs/locale/zh-tw.js": () => Promise.resolve().then(() => bP),
  "../../../../node_modules/dayjs/locale/zh.js": () => Promise.resolve().then(() => LP)
}), wc = /* @__PURE__ */ new Set(["en"]), Z1 = {
  "zh-cn": "zh-cn",
  "zh-tw": "zh-tw",
  "zh-hk": "zh-hk",
  "zh-mo": "zh-tw",
  ...
  const a = `../../../../node_modules/dayjs/locale/${e}.js`, n = X1[a];
  if (n)
    return await n(), !0;
  try {
    return await import(
...
}, ex = (e) => Z1[e.toLowerCase()] || "en", tx = async (e) => {
  const a = ex(e);
  if (wc.has(a)) {
    xt.locale(a);
    return;
  ...
  const { globalLocale: a } = J1(), n = J(() => De(e) ?? De(a) ?? F1), r = J(() => n.value.name);
  return Le(
    r,
    (t) => {
      tx(t);
    ...
    t: (t, i) => {
      ...
      return typeof l != "string" ? t : i ? l.replace(/\{(\w+)\}/g, (d, c) => {
        const _ = i[c];
...
}, nx = ["title"], ax = ["title"], ox = {
  key: 2,
  class: "yh-flow-controls__divider"
}, sx = ["title"], ix = ["title"], ux = {
  key: 0,
  viewBox: "0 0 24 24",
  width: "16",
  height: "16"
  ...
  setup(e) {
    ...
    return (u, l) => (H(), E(
      ...
      [
        ...
        e.showZoom && e.showFitView ? (H(), E("div", ox)) : P("v-if", !0),
...
}), cx = /* @__PURE__ */ ue(dx, [["__scopeId", "data-v-0b42efde"]]), _x = {
  enabled: !0,
...
const fx = ["width", "height"], mx = /* @__PURE__ */ ie({
  __name: "Background",
  props: {
    type: {},
    color: {},
  ...
  setup(e) {
    const a = e, n = ee(), r = ee(2e3), o = ee(2e3), s = Ct(), t = s.viewport, i = J(() => ({
...
}), px = /* @__PURE__ */ ue(mx, [["__scopeId", "data-v-f22cccfe"]]), hx = {
  enabled: !0,
  type: "dots",
  color: "#e5e5e5",
  gap: 20
...
}, yx = ["y1", "x2", "y2"], gx = ["x1", "x2", "y2"], Mx = /* @__PURE__ */ ie({
  __name: "AlignmentLines",
  props: {
    snapThreshold: {}
  },
  setup(e) {
    const a = e, n = Ct(), r = n.nodes, o = n.draggingNodeId, s = n.draggingPosition, t = J(() => {
      var c;
    ...
    return (c, _) => De(o) && De(s) ? (H(), E("svg", vx, [
      P(" Horizontal alignment lines "),
      (H(!0), E(
        pe,
        null,
...
}), bx = /* @__PURE__ */ ue(Mx, [["__scopeId", "data-v-8f2975ee"]]), Yx = {
  enabled: !0,
  snapToGrid: !0,
  gridSize: 15,
  snapThreshold: 10,
  ...
  return {
    ...
    install(n) {
      a.enabled && (a.exportJson && (n.exportJson = () => JSON.stringify(
        ...
        var _;
        const o = Lx(a, r), s = o.container ?? n.$el;
        if (!s)
        ...
        let c = null;
        try {
          t === "full" && (c = { ...n.getViewport() }, (_ = n.fitView) == null || _.call(n, { padding: d }), await Pw());
          const f = kx(a, o), m = await w1(s, f);
          return i && x1(m.dataUrl, l, m.extension), u && await L1(m.blob), m;
        } finally {
          c && n.setViewport(c);
        }
      }));
...
async function Dx(e, a, n) {
  const r = await Promise.resolve().then(() => z3), o = r.default || r, s = r.graphlib || o.graphlib, t = new s.Graph();
  return t.setGraph({
    rankdir: n.direction,
    ...
    install(n) {
      a.enabled && (n.applyLayout = async (r) => {
        ...
        try {
          let i;
          if (o.type === "dagre")
            i = await Dx(s, t, o), console.log("[Layout Plugin] Dagre layout applied successfully");
          else if (o.type === "elk")
            i = await Tx(s, t, o), console.log("[Layout Plugin] ELK layout applied successfully");
          else if (o.type === "force")
            i = await $x(s, t, o, n), console.log("[Layout Plugin] Force layout applied asynchronously");
          else if (o.type === "grid")
            i = Hx(s, t, o), console.log("[Layout Plugin] Grid layout applied successfully");
          else {
...
function Fg(e = {}) {
  const a = { ...jx, ...e }, n = /* @__PURE__ */ new Map();
  return {
    id: "node-group",
    name: "NodeGroup",
    version: "1.0.0",
    ...
    install(r) {
      a.enabled && (r.groupSelectedNodes = (o = "Group") => {
        ...
        const t = r.nodes.value.map((c) => c.id), i = qx(a.groupIdPrefix, t), u = Ex(s, a.paddingX, a.paddingY), l = {};
        s.forEach((c) => {
...
function Gg(e = {}) {
  const a = { ...Cx, ...e }, n = ee([]), r = ee(-1), o = J(() => r.value > 0), s = J(() => r.value < n.value.length - 1), t = J(() => n.value.length);
  let i = null, u = null;
  const l = () => {
...
function Wz(e) {
  return [
    ...
    Ia(e == null ? void 0 : e.controls),
    Pa(e == null ? void 0 : e.grid),
...
const Vz = {
  ...
  historyChange: (e) => !!e,
  viewportChange: (e) => !!e
}, Rx = ["data-handle-id", "data-handle-type", "data-handle-position"], Ix = /* @__PURE__ */ ie({
  __name: "BaseNode",
  props: {
    id: {},
    type: {},
...
}), Xz = /* @__PURE__ */ ue(Ix, [["__scopeId", "data-v-068cd406"]]), Px = {
  key: 1,
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          ...
          e.connectable ? (H(), E("div", Px)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), Zz = /* @__PURE__ */ ue(Nx, [["__scopeId", "data-v-67bca1f5"]]), Ox = {
  key: 0,
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", Ox)) : P("v-if", !0),
          b(
            "div",
            {
              class: "flow-node-label",
...
}), Qz = /* @__PURE__ */ ue(zx, [["__scopeId", "data-v-29b9773e"]]), Bx = { class: "flow-group-header" }, Fx = { class: "flow-group-label" }, Gx = { class: "flow-group-content" }, Jx = /* @__PURE__ */ ie({
  __name: "GroupNode",
  props: {
    id: {},
    type: {},
...
}), eB = /* @__PURE__ */ ue(Jx, [["__scopeId", "data-v-594387f4"]]), Ux = /* @__PURE__ */ ie({
  __name: "CustomNode",
  props: {
    id: {},
    type: {},
...
}), tB = /* @__PURE__ */ ue(Ux, [["__scopeId", "data-v-68714fae"]]), Wx = ["onMousedown"], Vx = /* @__PURE__ */ ie({
  __name: "NodeResizer",
  props: {
    nodeId: {},
  ...
  setup(e, { emit: a }) {
    const n = e, r = Ct(), o = a, s = J(() => n.selected), t = ["n", "s", "e", "w", "ne", "nw", "se", "sw"];
...
}), rB = /* @__PURE__ */ ue(Vx, [["__scopeId", "data-v-a0e3f161"]]), Kx = { class: "default-toolbar" }, Xx = /* @__PURE__ */ ie({
  __name: "NodeToolbar",
  props: {
    nodeId: {},
    selected: { type: Boolean },
...
}), nB = /* @__PURE__ */ ue(Xx, [["__scopeId", "data-v-978b7d5a"]]), Zx = { class: "yh-flow-node-diamond__content" }, Qx = { class: "yh-flow-node-diamond__label" }, eL = {
  key: 0,
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          P(" Decision Node (Diamond shape using CSS transform) "),
          b("div", Zx, [
            b(
              "div",
              {
            ...
            P(" Handles "),
            e.connectable ? (H(), E("div", eL)) : P("v-if", !0),
            e.connectable ? (H(), E("div", tL)) : P("v-if", !0),
            e.connectable ? (H(), E("div", rL)) : P("v-if", !0),
            e.connectable ? (H(), E("div", nL)) : P("v-if", !0)
          ])
        ],
        6
        /* CLASS, STYLE */
...
}), oL = /* @__PURE__ */ ue(aL, [["__scopeId", "data-v-3c748647"]]), sL = { class: "yh-flow-node-database__body" }, iL = { class: "yh-flow-node-database__label" }, uL = {
  key: 0,
  class: "flow-handle position-top",
  "data-handle-type": "target",
  "data-handle-position": "top"
        ...
        [
          b(
            ...
            [
              ...
              P(" Handles "),
              e.connectable ? (H(), E("div", uL)) : P("v-if", !0),
              e.connectable ? (H(), E("div", lL)) : P("v-if", !0),
              e.connectable ? (H(), E("div", dL)) : P("v-if", !0),
              e.connectable ? (H(), E("div", cL)) : P("v-if", !0)
            ],
            4
            /* STYLE */
          )
...
}), fL = /* @__PURE__ */ ue(_L, [["__scopeId", "data-v-cb2bef3f"]]), mL = { class: "bpmn-start-event-label" }, pL = {
  key: 0,
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          ...
          e.connectable ? (H(), E("div", pL)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), vL = /* @__PURE__ */ ue(hL, [["__scopeId", "data-v-392a3802"]]), yL = { class: "bpmn-end-event-label" }, gL = {
  key: 0,
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          ...
          e.connectable ? (H(), E("div", gL)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), bL = /* @__PURE__ */ ue(ML, [["__scopeId", "data-v-bffae76f"]]), YL = {
  key: 0,
  class: "bpmn-handle bpmn-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, wL = { class: "bpmn-task-label" }, xL = {
  key: 1,
  class: "bpmn-handle bpmn-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", YL)) : P("v-if", !0),
          b(
            "span",
            wL,
          ...
          e.connectable ? (H(), E("div", xL)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), kL = /* @__PURE__ */ ue(LL, [["__scopeId", "data-v-ca562524"]]), SL = {
  key: 0,
  class: "bpmn-handle bpmn-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, DL = { class: "bpmn-task-label" }, TL = {
  key: 1,
  class: "bpmn-handle bpmn-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", SL)) : P("v-if", !0),
          o[0] || (o[0] = b(
            "span",
            {
...
}), HL = /* @__PURE__ */ ue($L, [["__scopeId", "data-v-a8938e02"]]), jL = {
  key: 0,
  class: "bpmn-handle bpmn-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, EL = { class: "bpmn-task-label" }, qL = {
  key: 1,
  class: "bpmn-handle bpmn-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", jL)) : P("v-if", !0),
          o[0] || (o[0] = b(
            "span",
            {
          ...
          e.connectable ? (H(), E("div", qL)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), AL = /* @__PURE__ */ ue(CL, [["__scopeId", "data-v-8d8bbd20"]]), RL = {
  key: 0,
  class: "bpmn-handle bpmn-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
  ...
  setup(e) {
    ...
    return (r, o) => (H(), E(
      ...
      [
        ...
        e.connectable ? (H(), E("div", RL)) : P("v-if", !0),
        e.connectable ? (H(), E("div", IL)) : P("v-if", !0),
        e.connectable ? (H(), E("div", PL)) : P("v-if", !0)
      ],
      6
      /* CLASS, STYLE */
...
}), OL = /* @__PURE__ */ ue(NL, [["__scopeId", "data-v-2bc3a60e"]]), zL = {
  key: 0,
  class: "bpmn-handle bpmn-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
  ...
  setup(e) {
    ...
    return (r, o) => (H(), E(
      ...
      [
        ...
        e.connectable ? (H(), E("div", zL)) : P("v-if", !0),
        e.connectable ? (H(), E("div", BL)) : P("v-if", !0),
        e.connectable ? (H(), E("div", FL)) : P("v-if", !0)
      ],
      6
      /* CLASS, STYLE */
    ));
  }
}), JL = /* @__PURE__ */ ue(GL, [["__scopeId", "data-v-948f521d"]]), UL = {
  key: 0,
  class: "bpmn-handle bpmn-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
  ...
  setup(e) {
    ...
    return (r, o) => (H(), E(
      ...
      [
        ...
        e.connectable ? (H(), E("div", UL)) : P("v-if", !0),
        e.connectable ? (H(), E("div", WL)) : P("v-if", !0),
        e.connectable ? (H(), E("div", VL)) : P("v-if", !0)
      ],
      6
      /* CLASS, STYLE */
    ));
  }
}), XL = /* @__PURE__ */ ue(KL, [["__scopeId", "data-v-57d60355"]]), rt = {
  StartEvent: "bpmn-start",
  EndEvent: "bpmn-end",
  Task: "bpmn-task",
  ServiceTask: "bpmn-service-task",
...
function aB() {
  $e({ type: rt.StartEvent, component: vL }), $e({ type: rt.EndEvent, component: bL }), $e({ type: rt.Task, component: kL }), $e({ type: rt.ServiceTask, component: HL }), $e({ type: rt.UserTask, component: AL }), $e({ type: rt.ExclusiveGateway, component: OL }), $e({ type: rt.ParallelGateway, component: JL }), $e({ type: rt.InclusiveGateway, component: XL });
}
const ZL = {
  key: 0,
  ...
  "data-handle-type": "target",
  "data-handle-position": "left"
}, QL = { class: "ai-node-header" }, ek = { class: "ai-node-title" }, tk = { class: "ai-node-body" }, rk = { class: "ai-node-model" }, nk = {
  key: 1,
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          ...
          e.connectable ? (H(), E("div", nk)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), ok = /* @__PURE__ */ ue(ak, [["__scopeId", "data-v-6a45f3e9"]]), sk = {
  key: 0,
  class: "ai-handle ai-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, ik = { class: "ai-node-header" }, uk = { class: "ai-node-title" }, lk = { class: "ai-node-body" }, dk = { class: "ai-node-preview" }, ck = {
  key: 1,
  class: "ai-handle ai-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", sk)) : P("v-if", !0),
          b("div", ik, [
            o[0] || (o[0] = b(
              "span",
              { class: "ai-node-icon" },
          ...
          e.connectable ? (H(), E("div", ck)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), fk = /* @__PURE__ */ ue(_k, [["__scopeId", "data-v-accac64d"]]), mk = {
  key: 0,
  class: "ai-handle ai-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, pk = { class: "ai-node-header" }, hk = { class: "ai-node-title" }, vk = { class: "ai-node-body" }, yk = { class: "ai-node-tools" }, gk = {
  key: 1,
  class: "ai-handle ai-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", mk)) : P("v-if", !0),
          b("div", pk, [
            o[0] || (o[0] = b(
              "span",
              { class: "ai-node-icon" },
          ...
          e.connectable ? (H(), E("div", gk)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), bk = /* @__PURE__ */ ue(Mk, [["__scopeId", "data-v-6f2a727b"]]), Yk = {
  key: 0,
  class: "ai-handle ai-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, wk = { class: "ai-node-header" }, xk = { class: "ai-node-title" }, Lk = { class: "ai-node-body" }, kk = { class: "ai-node-tool-name" }, Sk = {
  key: 1,
  class: "ai-handle ai-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", Yk)) : P("v-if", !0),
          b("div", wk, [
            o[0] || (o[0] = b(
              "span",
              { class: "ai-node-icon" },
...
}), Tk = /* @__PURE__ */ ue(Dk, [["__scopeId", "data-v-14c6f30f"]]), $k = {
  key: 0,
  class: "ai-handle ai-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, Hk = { class: "ai-node-header" }, jk = { class: "ai-node-title" }, Ek = { class: "ai-node-body" }, qk = { class: "ai-node-condition" }, Ck = {
  key: 1,
  class: "ai-handle ai-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          e.connectable ? (H(), E("div", $k)) : P("v-if", !0),
          b("div", Hk, [
            o[0] || (o[0] = b(
              "span",
              { class: "ai-node-icon" },
          ...
          e.connectable ? (H(), E("div", Ck)) : P("v-if", !0),
          e.connectable ? (H(), E("div", Ak)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), Ik = /* @__PURE__ */ ue(Rk, [["__scopeId", "data-v-a8d72181"]]), Pk = {
  key: 0,
  class: "ai-handle ai-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
  ...
  setup(e) {
    ...
    return (r, o) => (H(), E(
      ...
      [
        ...
        e.connectable ? (H(), E("div", Pk)) : P("v-if", !0)
      ],
      6
      /* CLASS, STYLE */
    ));
  }
}), Ok = /* @__PURE__ */ ue(Nk, [["__scopeId", "data-v-8093cf3c"]]), zk = {
  key: 0,
  class: "ai-handle ai-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
  ...
  setup(e) {
    ...
    return (r, o) => (H(), E(
      ...
      [
        ...
        e.connectable ? (H(), E("div", zk)) : P("v-if", !0)
      ],
      6
      /* CLASS, STYLE */
    ));
  }
}), Fk = /* @__PURE__ */ ue(Bk, [["__scopeId", "data-v-83555e5c"]]), Gk = {
  key: 0,
  class: "ai-handle ai-handle-target",
  "data-handle-type": "target",
  "data-handle-position": "left"
}, Jk = { class: "ai-node-header" }, Uk = { class: "ai-node-title" }, Wk = { class: "ai-node-body" }, Vk = { class: "ai-node-memory" }, Kk = {
  key: 1,
  class: "ai-handle ai-handle-source",
  "data-handle-type": "source",
  "data-handle-position": "right"
    ...
    return (r, o) => {
      ...
      return H(), E(
        ...
        [
          ...
          e.connectable ? (H(), E("div", Kk)) : P("v-if", !0)
        ],
        6
        /* CLASS, STYLE */
      );
...
}), Zk = /* @__PURE__ */ ue(Xk, [["__scopeId", "data-v-8db793a7"]]), nt = {
  LLM: "ai-llm",
  Prompt: "ai-prompt",
  Agent: "ai-agent",
  Tool: "ai-tool",
...
function oB() {
  $e({ type: nt.LLM, component: ok }), $e({ type: nt.Prompt, component: fk }), $e({ type: nt.Agent, component: bk }), $e({ type: nt.Tool, component: Tk }), $e({ type: nt.Condition, component: Ik }), $e({ type: nt.Start, component: Ok }), $e({ type: nt.End, component: Fk }), $e({ type: nt.Memory, component: Zk });
}
const Qk = ["d"], eS = ["d"], tS = ["x", "y"], rS = { class: "flow-edge-label" }, nS = /* @__PURE__ */ ie({
  __name: "BaseEdge",
  props: {
    id: {},
    sourceX: {},
...
}), sB = /* @__PURE__ */ ue(nS, [["__scopeId", "data-v-37f87f1e"]]), aS = ["d"], oS = ["x", "y"], sS = { class: "flow-edge-label" }, iS = /* @__PURE__ */ ie({
  __name: "SmoothEdge",
  props: {
    sourceX: {},
    sourceY: {},
...
}), iB = /* @__PURE__ */ ue(iS, [["__scopeId", "data-v-3ae148d5"]]), uS = ["d"], lS = ["x", "y"], dS = { class: "flow-edge-label" }, cS = /* @__PURE__ */ ie({
  __name: "StepEdge",
  props: {
    sourceX: {},
    sourceY: {},
...
}), uB = /* @__PURE__ */ ue(cS, [["__scopeId", "data-v-11cb7800"]]), _S = ["d"], fS = ["x", "y"], mS = { class: "flow-edge-label" }, pS = /* @__PURE__ */ ie({
  __name: "BezierEdge",
  props: {
    sourceX: {},
    sourceY: {},
...
}), lB = /* @__PURE__ */ ue(pS, [["__scopeId", "data-v-5753d51f"]]), hS = ["id"], vS = ["stdDeviation"], yS = ["id"], gS = ["stop-color"], MS = ["stop-color"], bS = ["d"], YS = ["d", "filter"], wS = ["d"], xS = ["d"], LS = ["id", "d"], kS = ["fill"], SS = ["dur", "begin"], DS = ["href"], TS = ["d"], $S = ["x", "y"], HS = { class: "flow-data-flow-label" }, jS = ["transform"], ES = ["fill"], qS = ["fill"], CS = /* @__PURE__ */ ie({
  __name: "DataFlowEdge",
  props: {
    edge: {},
    path: {},
  ...
  setup(e) {
    ...
    const a = e, n = J(() => {
      var F;
      return ((F = a.edge) == null ? void 0 : F.data) ?? {};
      ...
      var F;
      return ((F = a.edge) == null ? void 0 : F.selected) ?? !1;
    }), l = J(() => {
      var F;
      return ((F = a.edge) == null ? void 0 : F.animated) ?? !1;
    }), d = J(() => {
      var F;
      return ((F = a.edge) == null ? void 0 : F.label) ?? "";
    }), c = J(() => {
      var F;
      return ((F = a.edge) == null ? void 0 : F.id) ?? "";
    ...
    return jt(() => {
      ...
      [
        ...
        P(" ⑤ particles 模式：粒子沿路径流动 "),
        o.value === "particles" && w.value ? (H(), E(
          pe,
          { key: 3 },
          [
            P(" 供 animateMotion 引用的命名路径（不可见） "),
            b("path", {
              id: g.value,
              d: e.path,
              fill: "none",
...
}), dB = /* @__PURE__ */ ue(CS, [["__scopeId", "data-v-bf3b4bf1"]]), AS = {
  class: "yh-flow-edges",
  style: { overflow: "visible", position: "absolute", top: "0", left: "0", width: "100%", height: "100%", "pointer-events": "none", "z-index": "5" }
}, RS = ["id"], IS = ["x", "y", "width"], PS = ["data-edge-id", "onClick", "onDblclick", "onContextmenu"], NS = ["d"], OS = ["d", "stroke", "stroke-width", "mask"], zS = ["x", "y"], BS = { style: { width: "100%", height: "100%", display: "flex", "align-items": "center", "justify-content": "center" } }, FS = /* @__PURE__ */ ie({
  __name: "EdgeRenderer",
  props: {
    edges: {},
    nodes: {},
  ...
  setup(e, { emit: a }) {
    const n = e, r = (u) => {
      var l;
      return n.edgeTypes && n.edgeTypes[u] ? n.edgeTypes[u] : (l = l1(u || "default")) == null ? void 0 : l.component;
    }, o = a, s = J(() => {
      ...
      for (const c of n.edges) {
        ...
        const m = c.sourceHandle || "right", h = c.targetHandle || "left", y = yt(_, m, c.sourceHandle), p = yt(f, h, c.targetHandle), v = {
          ...
          sourcePosition: m,
          targetPosition: h
        }, g = c.type || "bezier", M = Cg(g, v), w = o1({ ...v, type: g }), D = (c.label || "").replace(/<[^>]*>/g, ""), Y = Math.min(D.length * 7, 120), T = ((l = c.style) == null ? void 0 : l.stroke) || (c.selected ? "var(--flow-edge-selected-stroke, #3b82f6)" : "var(--flow-edge-stroke, #b1b1b7)"), k = ((d = c.style) == null ? void 0 : d.strokeWidth) ?? 1.5;
        u.push({
          edge: c,
          style: c.style,
          path: M,
    ...
    return (u, l) => (H(), E("svg", AS, [
      b("defs", null, [
        P(" Dynamic masks to create a true gap in the line behind the label "),
        (H(!0), E(
          pe,
          null,
      ...
      (H(!0), E(
        ...
        ke(i.value, (d) => (H(), E("g", {
          ...
          it(u.$slots, "edge", Tt({ ref_for: !0 }, d), () => [
            P(" Automatic Custom Edge Component "),
            r(d.edge.type || "default") ? (H(), Ve(
              Ca(r(d.edge.type || "default")),
              Tt({
                key: 0,
                ref_for: !0
              }, d),
...
}), GS = /* @__PURE__ */ ue(FS, [["__scopeId", "data-v-607ce8de"]]), JS = {
...
}, US = ["onMousedown"], WS = ["cx", "cy"], VS = ["cx", "cy"], KS = ["onMousedown"], XS = ["cx", "cy"], ZS = ["cx", "cy"], QS = /* @__PURE__ */ ie({
    ...
    return (t, i) => (H(), E("svg", JS, [
      (H(!0), E(
        ...
        ke(s.value, (u) => (H(), E("g", {
          ...
          P(" Source Handle with interaction overlay "),
          ...
          P(" Target Handle with interaction overlay "),
...
}), e0 = { class: "yh-flow-nodes" }, t0 = ["id", "onMousedown", "onClick", "onDblclick", "onContextmenu"], r0 = ["data-handle-id", "onMousedown"], n0 = ["data-handle-id", "onMousedown"], a0 = { class: "yh-flow-node__content" }, xc = 3, o0 = /* @__PURE__ */ ie({
  __name: "NodeRenderer",
  props: {
    nodes: {},
    nodeTypes: { default: () => ({}) },
  ...
  setup(e, { emit: a }) {
    const n = e, r = a, o = (Y) => {
      var T, k;
      return Y === "diamond" ? oL : Y === "database" ? fL : n.nodeTypes && n.nodeTypes[Y] ? n.nodeTypes[Y] : ((T = Rg(Y)) == null ? void 0 : T.component) || ((k = _1(Y)) == null ? void 0 : k.component);
      ...
      const B = T.selected, F = /* @__PURE__ */ new Set(), $ = (z) => {
        F.has(z) || (F.add(z), n.nodes.forEach((W) => {
          W.parentId === z && $(W.id);
        }));
      }, x = Y.shiftKey || Y.metaKey || Y.ctrlKey, j = n.nodes.filter((z) => z.selected && z.id !== T.id);
      let G = [T.id];
      (x || B) && j.length > 0 && (G = [T.id, ...j.map((z) => z.id)]), G.forEach($), _.value = Array.from(F), f.value = /* @__PURE__ */ new Map(), _.value.forEach((z) => {
      ...
      if (!m.value && Math.abs(T) < xc && Math.abs(k) < xc)
        return;
      if (!m.value) {
        m.value = !0;
        const F = h.value;
        F && r("node-drag-start", Y, F);
      }
      const S = (Y.clientX - d.value.x) / n.transform.zoom, B = (Y.clientY - d.value.y) / n.transform.zoom;
      _.value.forEach((F) => {
        const $ = f.value.get(F);
        if ($) {
          const x = {
        ...
        ke(s.value, (k) => (H(), E("div", {
          ...
          b("div", a0, [
            it(Y.$slots, "node", { node: k }, () => {
              var S;
              return [
                P(" Automatic Custom Node Component "),
                o(k.type) ? (H(), Ve(Ca(o(k.type)), Tt({
                  key: 0,
                  ref_for: !0
...
}), s0 = /* @__PURE__ */ ue(o0, [["__scopeId", "data-v-94f30314"]]), i0 = /* @__PURE__ */ ie({
  __name: "SelectionBox",
  props: {
    selectionRect: {},
    transform: {}
...
}), u0 = /* @__PURE__ */ ue(i0, [["__scopeId", "data-v-8a84ee03"]]), l0 = {
  key: 0,
  class: "node-edit-panel"
}, d0 = { class: "panel-content" }, c0 = { class: "form-group" }, _0 = { class: "form-group" }, f0 = { class: "form-group" }, m0 = { class: "size-inputs" }, p0 = { class: "form-group" }, h0 = { class: "color-picker-row" }, v0 = ["value"], y0 = { class: "color-value" }, g0 = { class: "form-group" }, M0 = { class: "color-picker-row" }, b0 = ["value"], Y0 = { class: "color-value" }, w0 = { class: "form-group" }, x0 = ["value"], L0 = { class: "form-group" }, k0 = { class: "color-picker-row" }, S0 = ["value"], D0 = { class: "color-value" }, T0 = { class: "form-group" }, $0 = { class: "color-picker-row" }, H0 = ["value"], j0 = { class: "color-value" }, E0 = /* @__PURE__ */ ie({
  ...
  setup(e, { emit: a }) {
    ...
    return (m, h) => (H(), Ve(Ua, { to: "body" }, [
      We(Bd, { name: "slide-fade" }, {
        default: $t(() => {
          var y, p, v;
          return [
            e.visible && e.node ? (H(), E("div", l0, [
...
}), q0 = /* @__PURE__ */ ue(E0, [["__scopeId", "data-v-3542b442"]]), C0 = {
  key: 0,
  class: "ai-node-edit-panel"
}, A0 = { class: "panel-header" }, R0 = { class: "panel-title" }, I0 = { key: 0 }, P0 = { key: 1 }, N0 = { key: 2 }, O0 = { key: 3 }, z0 = { key: 4 }, B0 = { key: 5 }, F0 = { key: 6 }, G0 = { class: "panel-content" }, J0 = { class: "form-group" }, U0 = { class: "form-group" }, W0 = ["value"], V0 = ["value"], K0 = { class: "form-group" }, X0 = ["value"], Z0 = { class: "form-group" }, Q0 = ["value"], eD = { class: "form-group" }, tD = { class: "status-badges" }, rD = {
  key: 0,
  class: "form-group"
}, nD = { class: "stream-preview" }, aD = { class: "stream-text" }, oD = {
  key: 1,
  class: "form-group"
}, sD = {
  key: 2,
  class: "form-group"
}, iD = { class: "tools-checkboxes" }, uD = ["checked", "onChange"], lD = {
  key: 3,
  class: "form-group"
}, dD = {
  key: 4,
  ...
  key: 5,
  class: "form-group"
}, _D = ["value"], fD = ["value"], mD = { class: "form-group" }, pD = { class: "size-inputs" }, hD = { class: "form-group" }, vD = { class: "color-picker" }, yD = ["onClick"], gD = { class: "form-group" }, MD = { class: "color-picker" }, bD = ["onClick"], YD = /* @__PURE__ */ ie({
      ...
      We(Bd, { name: "slide-fade" }, {
        default: $t(() => [
          e.visible && e.node ? (H(), E("div", C0, [
            b("div", A0, [
              b("span", R0, [
                t.value ? (H(), E("span", I0, "🧠 LLM 配置")) : i.value ? (H(), E("span", P0, "💬 提示词配置")) : u.value ? (H(), E("span", N0, "🤖 Agent 配置")) : l.value ? (H(), E("span", O0, "🔧 工具配置")) : d.value ? (H(), E("span", z0, "🔀 条件配置")) : c.value ? (H(), E("span", B0, "💾 记忆配置")) : (H(), E("span", F0, "编辑节点"))
              ]),
              b("button", {
                class: "close-btn",
                onClick: T
            ...
            b("div", G0, [
              ...
              t.value ? (H(), E(
                ...
                [
                  ...
                  P(" 流式输出预览 "),
                  o.value.status === "running" ? (H(), E("div", rD, [
                    x[12] || (x[12] = b(
                      "label",
                      null,
                      "流式输出",
...
}), wD = /* @__PURE__ */ ue(YD, [["__scopeId", "data-v-71c97ea4"]]), xD = {
  key: 0,
  class: "edge-edit-panel"
}, LD = { class: "panel-content" }, kD = { class: "form-group" }, SD = { class: "form-group" }, DD = ["value"], TD = { class: "form-group" }, $D = { class: "checkbox-label" }, HD = { class: "form-group" }, jD = { class: "color-picker-row" }, ED = ["value"], qD = { class: "color-value" }, CD = { class: "form-group" }, AD = ["value"], RD = { class: "form-group" }, ID = { class: "color-picker-row" }, PD = ["value"], ND = { class: "color-value" }, OD = { class: "form-group" }, zD = { class: "color-picker-row" }, BD = { class: "color-value" }, FD = /* @__PURE__ */ ie({
  ...
  setup(e, { emit: a }) {
    ...
    const s = () => {
      ...
      ].forEach((p) => m.set(p.value, p)), d1().forEach((p) => {
...
}), GD = /* @__PURE__ */ ue(FD, [["__scopeId", "data-v-c6ec35b4"]]);
class JD {
  constructor() {
...
const WD = {
  ...
  setup(e, { expose: a, emit: n }) {
    ...
    const r = (q, N, X) => {
      const Q = gc(q, N, X);
      return Q.isValid ? o.connectionValidator && !o.connectionValidator(X) ? { isValid: !1, message: "Connection not allowed by custom validator" } : !o.noCycleValidation && u1(d.value, {
        source: X.source,
        target: X.target
      }) ? { isValid: !1, message: "Connection would create a cycle" } : { isValid: !0 } : Q;
    }, o = e, s = n, t = ee(), i = ee(800), u = ee(600), l = ee(o.nodes || []), d = ee(o.edges || []), c = qa(o.modelValue || { x: 0, y: 0, zoom: 1 }), _ = ee(o.readonly || !1), f = UD(), m = new Ax(), h = ee(o.snapThreshold ?? 10), y = Vw(c, {
      minZoom: o.minZoom || 0.1,
      maxZoom: o.maxZoom || 5,
      zoomStep: o.zoomStep || 0.1
    }), p = ee([]), v = J(
      () => p.value.filter((q) => !q.id.includes("minimap") && !q.id.includes("controls"))
    ), g = J(
      () => p.value.filter((q) => q.id.includes("minimap") || q.id.includes("controls"))
    ), M = (q) => {
      m.register(q), p.value = m.getPlugins();
    }, w = (q) => {
      m.unregister(q), p.value = m.getPlugins();
    }, L = Kw(c, {
      nodes: l,
      ...
      onHistoryChange: (q, N) => {
        s("historyChange", { canUndo: q, canRedo: N });
      }
    }), k = t1({
      nodes: l,
      ...
      const q = 100, N = {
        x: -c.value.x / c.value.zoom - q,
        y: -c.value.y / c.value.zoom - q,
        width: i.value / c.value.zoom + q * 2,
        height: u.value / c.value.zoom + q * 2
      };
      ...
      transformOrigin: "0 0"
    })), F = ee(!1), $ = ee({ x: 0, y: 0 }), x = ee(!1), j = ee(null), G = ee(null), z = ee(!1), W = ee(null), Z = ee({ x: 0, y: 0 }), K = ee(null), ne = ee(!1), se = ee(null), C = ee(!1), O = ee(null), U = J(() => !z.value || !W.value ? null : {
      path: V.value,
      tx: Z.value.x,
      ty: Z.value.y
    }), V = J(() => W.value ? Cg("bezier", {
      ...
      var Q;
      q.preventDefault();
      const N = q.deltaY > 0 ? 0.9 : 1.1, X = (Q = t.value) == null ? void 0 : Q.getBoundingClientRect();
      ...
      if (!X) return;
      const Q = q.clientX - X.left, ve = q.clientY - X.top;
      if (q.altKey && o.selectable && !_.value) {
        const Me = {
          x: (Q - c.value.x) / c.value.zoom,
          y: (ve - c.value.y) / c.value.zoom
        };
        x.value = !0, Y.startSelection(Me.x, Me.y), Y.clearSelection();
      } else _.value || (F.value = !0, $.value = { x: q.clientX, y: q.clientY });
    }, le = (q) => {
      var N, X;
      if (F.value) {
        const Q = q.clientX - $.value.x, ve = q.clientY - $.value.y;
        y.pan(Q, ve), $.value = { x: q.clientX, y: q.clientY };
      }
      if (x.value) {
        const Q = (N = t.value) == null ? void 0 : N.getBoundingClientRect();
        if (Q) {
          const ve = q.clientX - Q.left, de = q.clientY - Q.top, me = {
      ...
      var N, X, Q, ve;
      if (F.value = !1, x.value && (x.value = !1, Y.endSelection()), z.value && W.value) {
        const de = (N = t.value) == null ? void 0 : N.getBoundingClientRect();
        if (de) {
          const me = q.clientX - de.left, Me = q.clientY - de.top, He = {
            x: (me - c.value.x) / c.value.zoom,
            y: (Me - c.value.y) / c.value.zoom
          }, Re = Ae(He);
          if (Re) {
            const Wt = K.value ? K.value.handleType === "source" ? Re.id : K.value.edge.source : W.value.nodeId, _c = K.value ? K.value.handleType === "target" ? Re.id : K.value.edge.target : Re.id, Aw = l.value.find((Ye) => Ye.id === Wt), fc = r(
              Aw,
      ...
      for (const N of l.value) {
        ...
        if (q.x >= N.position.x && q.x <= N.position.x + X && q.y >= N.position.y && q.y <= N.position.y + Q && W.value && N.id !== W.value.nodeId)
          return N;
      }
      return null;
    }, be = (q, N) => {
      const X = q.shiftKey || q.metaKey || q.ctrlKey;
      X || D.clearSelection(), L.selectNode(N.id, !0, X), s("nodeClick", { node: N, nativeEvent: q }), f.emit("node:click", { node: N, nativeEvent: q });
    }, Se = (q) => {
      const N = l.value.find((X) => X.id === q);
      N && (N.selected = !N.selected);
    }, _e = (q, N) => {
      s("nodeDblClick", { node: N, nativeEvent: q }), f.emit("node:dblclick", { node: N, nativeEvent: q }), _.value || (C.value = !1, se.value = N, ne.value = !0);
    }, Ue = (q, N) => {
      s("nodeContextMenu", { node: N, nativeEvent: q }), f.emit("node:contextmenu", { node: N, nativeEvent: q });
    }, fe = (q, N) => {
      T.push({ nodes: l.value, edges: d.value }), j.value = N.id, G.value = { ...N.position }, s("nodeDragStart", { node: N, nativeEvent: q }), f.emit("node:dragstart", { node: N, nativeEvent: q });
    }, Ze = (q, N, X) => {
      const Q = k.getAlignmentSnap(N.id, X);
      L.updateNodePosition(N.id, Q, { dragging: !0 }), G.value = Q, s("nodeDrag", { node: N, nativeEvent: q, position: Q }), f.emit("node:drag", { node: N, nativeEvent: q, position: Q }), s("update:nodes", l.value);
    }, Qe = (q, N) => {
      L.updateNodePosition(N.id, N.position, { dragging: !1 }), j.value = null, G.value = null, s("nodeDragEnd", { node: N, nativeEvent: q }), f.emit("node:dragend", { node: N, nativeEvent: q }), s("update:nodes", l.value), s("update:edges", d.value);
    }, mo = (q, N) => {
      console.log("Edge click:", N.id), q.stopPropagation(), !q.ctrlKey && !q.metaKey && !q.shiftKey && d.value.forEach((X) => {
        X.id !== N.id && (X.selected = !1);
      }), N.selected = !N.selected, s("edgeClick", { edge: N, nativeEvent: q }), _.value || (ne.value = !1, O.value = N, C.value = !0), f.emit("edge:click", { edge: N, nativeEvent: q });
    }, ft = (q, N) => {
      console.log("Edge dblclick:", N.id), s("edgeDblClick", { edge: N, nativeEvent: q }), f.emit("edge:dblclick", { edge: N, nativeEvent: q }), _.value || (ne.value = !1, O.value = N, C.value = !0);
    }, Fe = (q, N) => {
      s("edgeContextMenu", { edge: N, nativeEvent: q }), f.emit("edge:contextmenu", { edge: N, nativeEvent: q });
    }, Te = (q, N, X) => {
      var Re;
      if (_.value) return;
      ...
      se.value && (T.push({ nodes: l.value, edges: d.value }), L.updateNode(se.value.id, q), se.value = l.value.find((N) => {
        var X;
      ...
      O.value && (T.push({ nodes: l.value, edges: d.value }), D.updateEdge(O.value.id, q), O.value = d.value.find((N) => {
        var X;
        return N.id === ((X = O.value) == null ? void 0 : X.id);
      }) || null, s("update:edges", d.value));
    }, et = () => {
      C.value = !1, O.value = null;
    }, Ft = () => l.value, Gt = () => d.value, po = (q, N) => {
      f.on(q, N);
    }, Jt = (q, N) => {
      f.off(q, N);
    }, Ge = (q, N) => {
      ...
      getEdge: D.getEdge,
      setViewport: (q) => y.setViewport(q.x, q.y, q.zoom),
      fitView: (q) => y.fitView(
      ...
      off: Jt,
      emit: Ge,
      isValidConnection: (q) => gc(
        l.value.find((N) => N.id === q.source),
        l.value.find((N) => N.id === q.target),
        q
      ).isValid,
      getNodes: Ft,
      getEdges: Gt,
      getViewport: () => c.value,
      screenToCanvas: (q, N) => Ht(q, N, c.value),
      canvasToScreen: (q, N) => Aa(q, N, c.value),
      // ============================================
      // New 5-star feature methods
      // ============================================
      createNodeFromTemplate: (q, N, X, Q) => c1(q, N, X, Q),
      exportFlowData: (q) => v1(l.value, d.value, q),
      importFlowData: (q) => y1(q),
      isNestedNode: (q) => f1(q),
      getNodeChildren: (q) => m1(q, l.value),
      getNodeParent: (q) => p1(q, l.value),
      get $el() {
        return t.value;
      },
      draggingNodeId: j,
    ...
    Le(
      [l, d],
      ([q, N]) => {
        const X = q.filter((me) => me.selected), Q = N.filter((me) => me.selected), ve = new Set(X.map((me) => me.id)), de = new Set(Q.map((me) => me.id));
        for (const me of ve)
          if (!ho.value.has(me)) {
            const Me = q.find((He) => He.id === me);
        ...
        f.emit("selection:change", { selectedNodes: X, selectedEdges: Q }), s("selectionChange", { selectedNodes: X, selectedEdges: Q }), s("update:nodes", q), s("update:edges", N), ho.value = ve, vo.value = de;
      },
      { deep: !0 }
    ), Le(
      c,
      (q) => {
        s("update:modelValue", q), s("viewportChange", q), f.emit("viewport:change", { transform: q });
      },
      { deep: !0 }
    );
    let Ut;
    return jt(() => {
      ...
      ), o.showControls && M(Ia({})), o.showMinimap && M(
        Ra({
      ...
      return H(), E(
        ...
        [
          P(" Plugin Components (Background, etc.) "),
          (H(!0), E(
            pe,
            null,
            ke(v.value, (de) => (H(), E(
          ...
          b(
            ...
            [
              ...
              We(GS, {
                ...
                edge: $t((de) => [
                  it(q.$slots, "edge", mc(pc(de)), void 0, !0)
                ]),
                _: 3
                /* FORWARDED */
              }, 8, ["edges", "nodes", "edge-types", "transform", "connecting-edge", "updating-edge-id"]),
              P(" Edge Handles (for updating/reconnecting edges) "),
              We(QS, {
                edges: d.value || [],
                nodes: l.value || [],
                onEdgeUpdateStart: Te
              ...
              We(s0, {
                ...
                node: $t((de) => [
                  it(q.$slots, "node", mc(pc(de)), void 0, !0)
                ]),
                _: 3
                /* FORWARDED */
          ...
          P(" UI Overlay Plugin Components (Controls, Minimap, etc.) "),
          (H(!0), E(
            pe,
            null,
            ke(g.value, (de) => (H(), E(
          ...
          P(" Node Edit Panel "),
          P(" AI 工作流节点使用 AI 配置面板 "),
          (ve = (Q = se.value) == null ? void 0 : Q.type) != null && ve.startsWith("ai-") ? (H(), Ve(wD, {
            key: 1,
            node: se.value,
            visible: ne.value,
            onUpdate: st,
...
}), cB = /* @__PURE__ */ ue(KD, [["__scopeId", "data-v-43f1653b"]]), XD = ["width", "height"], ZD = ["cx", "cy", "fill"], QD = ["d", "stroke"], eT = ["fill"], tT = /* @__PURE__ */ ie({
  ...
  setup(e, { expose: a }) {
    var _;
    const n = e, o = `yh-bg-pattern-${((_ = Gw()) == null ? void 0 : _.uid) ?? Math.random().toString(36).slice(2)}`, s = ee(), t = ee(), i = ee(), u = ee(), d = n.gap || 20;
    function c(f) {
      const m = t.value;
      if (!m) return;
            ...
            b("defs", null, [
              b("pattern", {
                ...
                e.type === "dots" ? (H(), E("circle", {
                  ...
                  r: "1",
                  fill: e.color || "#b1b1b7"
                }, null, 8, ZD)) : e.type === "grid" ? (H(), E("path", {
                  key: 1,
                  ref_key: "gridPathRef",
                  ref: u,
...
}), _B = /* @__PURE__ */ ue(tT, [["__scopeId", "data-v-f7d7420a"]]);
function rT(e, a) {
  if (e.match(/^[a-z]+:\/\//i))
    return e;
  if (e.match(/^\/\//))
...
function aT(e) {
  const a = Ba(e, "border-left-width"), n = Ba(e, "border-right-width");
  return e.clientWidth + a + n;
}
function oT(e) {
  const a = Ba(e, "border-top-width"), n = Ba(e, "border-bottom-width");
  return e.clientHeight + a + n;
}
function Gd(e, a = {}) {
  const n = a.width || aT(e), r = a.height || oT(e);
...
async function dT(e, a, n) {
  const r = "http://www.w3.org/2000/svg", o = document.createElementNS(r, "svg"), s = document.createElementNS(r, "foreignObject");
  return o.setAttribute("width", `${a}`), o.setAttribute("height", `${n}`), o.setAttribute("viewBox", `0 0 ${a} ${n}`), s.setAttribute("width", "100%"), s.setAttribute("height", "100%"), s.setAttribute("x", "0"), s.setAttribute("y", "0"), s.setAttribute("externalResourcesRequired", "true"), o.appendChild(s), s.appendChild(e), lT(o);
}
const Ee = (e, a) => {
  if (e instanceof a)
    return !0;
...
function fT(e, a, n, r) {
  const o = `.${e}:${a}`, s = n.cssText ? cT(n) : _T(n, r);
...
function Lc(e, a, n, r) {
  ...
  i.appendChild(fT(t, n, o, r)), a.appendChild(i);
}
function mT(e, a, n) {
  Lc(e, a, ":before", n), Lc(e, a, ":after", n);
}
const kc = "application/font-woff", Sc = "image/jpeg", pT = {
  woff: kc,
  woff2: kc,
...
async function Ud(e, a, n) {
  const r = gT(e, a, n.includeQueryParams);
  if (Mo[r] != null)
    return Mo[r];
  n.cacheBust && (e += (/\?/.test(e) ? "&" : "?") + (/* @__PURE__ */ new Date()).getTime());
  let o;
  try {
    const s = await Ug(e, n.fetchRequestInit, ({ res: t, result: i }) => (a || (a = t.headers.get("Content-Type") || ""), vT(i)));
    o = yT(s, a);
  } catch (s) {
...
async function MT(e) {
  const a = e.toDataURL();
  return a === "data:," ? e.cloneNode(!1) : Fa(a);
}
...
async function wT(e, a) {
  return Ee(e, HTMLCanvasElement) ? MT(e) : Ee(e, HTMLVideoElement) ? bT(e, a) : Ee(e, HTMLIFrameElement) ? YT(e, a) : e.cloneNode(Wg(e));
}
const xT = (e) => e.tagName != null && e.tagName.toUpperCase() === "SLOT", Wg = (e) => e.tagName != null && e.tagName.toUpperCase() === "SVG";
async function LT(e, a, n) {
  var r, o;
  if (Wg(a))
    return a;
  let s = [];
  return xT(e) && e.assignedNodes ? s = at(e.assignedNodes()) : Ee(e, HTMLIFrameElement) && (!((r = e.contentDocument) === null || r === void 0) && r.body) ? s = at(e.contentDocument.body.childNodes) : s = at(((o = e.shadowRoot) !== null && o !== void 0 ? o : e).childNodes), s.length === 0 || Ee(e, HTMLVideoElement) || await s.reduce((t, i) => t.then(() => Va(i, n)).then((u) => {
    u && a.appendChild(u);
  }), Promise.resolve()), a;
}
function kT(e, a, n) {
  ...
  o.cssText ? (r.cssText = o.cssText, r.transformOrigin = o.transformOrigin) : Jg(n).forEach((s) => {
...
function TT(e, a, n) {
  return Ee(a, Element) && (kT(e, a, n), mT(e, a, n), ST(e, a), DT(e, a)), a;
}
...
async function Va(e, a, n) {
  return !n && a.filter && !a.filter(e) ? null : Promise.resolve(e).then((r) => wT(r, a)).then((r) => LT(e, r, a)).then((r) => TT(e, r, a)).then((r) => $T(r, a));
}
const Vg = /url\((['"]?)([^'"]+?)\1\)/g, HT = /url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g, jT = /src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;
function ET(e) {
...
function qT(e) {
  const a = [];
  return e.replace(Vg, (n, r, o) => (a.push(o), n)), a.filter((n) => !Nd(n));
}
async function CT(e, a, n, r, o) {
  try {
    const s = n ? rT(a, n) : a, t = Jd(a);
    let i;
    return o || (i = await Ud(s, t, r)), e.replace(ET(a), `$1${i}$3`);
  } catch {
  }
  return e;
}
function AT(e, { preferredFontFormat: a }) {
  return a ? e.replace(jT, (n) => {
    for (; ; ) {
      const [r, , o] = HT.exec(n) || [];
      if (!o)
        return "";
...
async function Xg(e, a, n) {
  if (!Kg(e))
    return e;
  const r = AT(e, n);
  return qT(r).reduce((s, t) => s.then((i) => CT(i, t, a, n)), Promise.resolve(r));
}
...
async function Zg(e, a) {
  Ee(e, Element) && (await RT(e, a), await IT(e, a), await PT(e, a));
}
function NT(e, a) {
  const { style: n } = e;
...
async function $c(e, a) {
  ...
  const r = /url\(["']?([^"')]+)["']?\)/g, s = (n.match(/url\([^)]+\)/g) || []).map(async (t) => {
    let i = t.replace(r, "$1");
    return i.startsWith("https://") || (i = new URL(i, e.url).href), Ug(i, a.fetchRequestInit, ({ result: u }) => (n = n.replace(t, `url(${u})`), [t, u]));
  });
      ...
      try {
        at(o.cssRules || []).forEach((s, t) => {
          if (s.type === CSSRule.IMPORT_RULE) {
            let i = t + 1;
            const u = s.href, l = Tc(u).then((d) => $c(d, a)).then((d) => Hc(d).forEach((c) => {
              try {
        ...
        o.href != null && r.push(Tc(o.href).then((i) => $c(i, a)).then((i) => Hc(i).forEach((u) => {
...
function zT(e) {
  return e.filter((a) => a.type === CSSRule.FONT_FACE_RULE).filter((a) => Kg(a.style.getPropertyValue("src")));
}
async function BT(e, a) {
  if (e.ownerDocument == null)
    throw new Error("Provided element is not within a Document");
  const n = at(e.ownerDocument.styleSheets), r = await OT(n, a);
  return zT(r);
}
function Qg(e) {
...
async function eM(e, a) {
  const n = await BT(e, a), r = FT(e);
  return (await Promise.all(n.filter((s) => r.has(Qg(s.style.fontFamily))).map((s) => {
...
async function tM(e, a = {}) {
  ...
  return await GT(o, a), await Zg(o, a), NT(o, a), await dT(o, n, r);
}
async function At(e, a = {}) {
  const { width: n, height: r } = Gd(e, a), o = await tM(e, a), s = await Fa(o), t = document.createElement("canvas"), i = t.getContext("2d"), u = a.pixelRatio || sT(), l = a.canvasWidth || n, d = a.canvasHeight || r;
  return t.width = l * u, t.height = d * u, a.skipAutoScale || iT(t), t.style.width = `${l}`, t.style.height = `${d}`, a.backgroundColor && (i.fillStyle = a.backgroundColor, i.fillRect(0, 0, t.width, t.height)), i.drawImage(s, 0, 0, t.width, t.height), t;
}
...
var er = { exports: {} }, ZT = er.exports, jc;
function QT() {
...
var rM = QT();
const e$ = /* @__PURE__ */ R(rM), t$ = /* @__PURE__ */ A({
  __proto__: null,
  default: e$
}, [rM]);
var tr = { exports: {} }, r$ = tr.exports, Ec;
function n$() {
...
var nM = n$();
const a$ = /* @__PURE__ */ R(nM), o$ = /* @__PURE__ */ A({
  __proto__: null,
  default: a$
}, [nM]);
var rr = { exports: {} }, s$ = rr.exports, qc;
function i$() {
...
var aM = i$();
const u$ = /* @__PURE__ */ R(aM), l$ = /* @__PURE__ */ A({
  __proto__: null,
  default: u$
}, [aM]);
var nr = { exports: {} }, d$ = nr.exports, Cc;
function c$() {
...
var oM = c$();
const _$ = /* @__PURE__ */ R(oM), f$ = /* @__PURE__ */ A({
  __proto__: null,
  default: _$
}, [oM]);
var ar = { exports: {} }, m$ = ar.exports, Ac;
function p$() {
...
var sM = p$();
const h$ = /* @__PURE__ */ R(sM), v$ = /* @__PURE__ */ A({
  __proto__: null,
  default: h$
}, [sM]);
var or = { exports: {} }, y$ = or.exports, Rc;
function g$() {
...
var iM = g$();
const M$ = /* @__PURE__ */ R(iM), b$ = /* @__PURE__ */ A({
  __proto__: null,
  default: M$
}, [iM]);
var sr = { exports: {} }, Y$ = sr.exports, Ic;
function w$() {
...
var uM = w$();
const x$ = /* @__PURE__ */ R(uM), L$ = /* @__PURE__ */ A({
  __proto__: null,
  default: x$
}, [uM]);
var ir = { exports: {} }, k$ = ir.exports, Pc;
function S$() {
...
var lM = S$();
const D$ = /* @__PURE__ */ R(lM), T$ = /* @__PURE__ */ A({
  __proto__: null,
  default: D$
}, [lM]);
var ur = { exports: {} }, $$ = ur.exports, Nc;
function H$() {
...
var dM = H$();
const j$ = /* @__PURE__ */ R(dM), E$ = /* @__PURE__ */ A({
  __proto__: null,
  default: j$
}, [dM]);
var lr = { exports: {} }, q$ = lr.exports, Oc;
function C$() {
...
var cM = C$();
const A$ = /* @__PURE__ */ R(cM), R$ = /* @__PURE__ */ A({
  __proto__: null,
  default: A$
}, [cM]);
var dr = { exports: {} }, I$ = dr.exports, zc;
function P$() {
...
var _M = P$();
const N$ = /* @__PURE__ */ R(_M), O$ = /* @__PURE__ */ A({
  __proto__: null,
  default: N$
}, [_M]);
var cr = { exports: {} }, z$ = cr.exports, Bc;
function B$() {
  return Bc || (Bc = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var fM = B$();
const F$ = /* @__PURE__ */ R(fM), G$ = /* @__PURE__ */ A({
  __proto__: null,
  default: F$
}, [fM]);
var _r = { exports: {} }, J$ = _r.exports, Fc;
function U$() {
...
var mM = U$();
const W$ = /* @__PURE__ */ R(mM), V$ = /* @__PURE__ */ A({
  __proto__: null,
  default: W$
}, [mM]);
var fr = { exports: {} }, K$ = fr.exports, Gc;
function X$() {
...
var pM = X$();
const Z$ = /* @__PURE__ */ R(pM), Q$ = /* @__PURE__ */ A({
  __proto__: null,
  default: Z$
}, [pM]);
var mr = { exports: {} }, eH = mr.exports, Jc;
function tH() {
  return Jc || (Jc = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var hM = tH();
const rH = /* @__PURE__ */ R(hM), nH = /* @__PURE__ */ A({
  __proto__: null,
  default: rH
}, [hM]);
var pr = { exports: {} }, aH = pr.exports, Uc;
function oH() {
...
var vM = oH();
const sH = /* @__PURE__ */ R(vM), iH = /* @__PURE__ */ A({
  __proto__: null,
  default: sH
}, [vM]);
var hr = { exports: {} }, uH = hr.exports, Wc;
function lH() {
...
var yM = lH();
const dH = /* @__PURE__ */ R(yM), cH = /* @__PURE__ */ A({
  __proto__: null,
  default: dH
}, [yM]);
var vr = { exports: {} }, _H = vr.exports, Vc;
function fH() {
...
var gM = fH();
const mH = /* @__PURE__ */ R(gM), pH = /* @__PURE__ */ A({
  __proto__: null,
  default: mH
}, [gM]);
var yr = { exports: {} }, hH = yr.exports, Kc;
function vH() {
...
var MM = vH();
const yH = /* @__PURE__ */ R(MM), gH = /* @__PURE__ */ A({
  __proto__: null,
  default: yH
}, [MM]);
...
var bM = bH();
const YH = /* @__PURE__ */ R(bM), wH = /* @__PURE__ */ A({
  __proto__: null,
  default: YH
}, [bM]);
var Mr = { exports: {} }, xH = Mr.exports, Zc;
function LH() {
  return Zc || (Zc = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var YM = LH();
const kH = /* @__PURE__ */ R(YM), SH = /* @__PURE__ */ A({
  __proto__: null,
  default: kH
}, [YM]);
var br = { exports: {} }, DH = br.exports, Qc;
function TH() {
  return Qc || (Qc = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var wM = TH();
const $H = /* @__PURE__ */ R(wM), HH = /* @__PURE__ */ A({
  __proto__: null,
  default: $H
}, [wM]);
var Yr = { exports: {} }, jH = Yr.exports, e_;
function EH() {
...
var xM = EH();
const qH = /* @__PURE__ */ R(xM), CH = /* @__PURE__ */ A({
  __proto__: null,
  default: qH
}, [xM]);
var wr = { exports: {} }, AH = wr.exports, t_;
function RH() {
...
var LM = RH();
const IH = /* @__PURE__ */ R(LM), PH = /* @__PURE__ */ A({
  __proto__: null,
  default: IH
}, [LM]);
var xr = { exports: {} }, NH = xr.exports, r_;
function OH() {
...
var kM = OH();
const zH = /* @__PURE__ */ R(kM), BH = /* @__PURE__ */ A({
  __proto__: null,
  default: zH
}, [kM]);
var Lr = { exports: {} }, FH = Lr.exports, n_;
function GH() {
...
var SM = GH();
const JH = /* @__PURE__ */ R(SM), UH = /* @__PURE__ */ A({
  __proto__: null,
  default: JH
}, [SM]);
var kr = { exports: {} }, WH = kr.exports, a_;
function VH() {
...
var DM = VH();
const KH = /* @__PURE__ */ R(DM), XH = /* @__PURE__ */ A({
  __proto__: null,
  default: KH
}, [DM]);
var Sr = { exports: {} }, ZH = Sr.exports, o_;
function QH() {
...
var TM = QH();
const ej = /* @__PURE__ */ R(TM), tj = /* @__PURE__ */ A({
  __proto__: null,
  default: ej
}, [TM]);
var Dr = { exports: {} }, rj = Dr.exports, s_;
function nj() {
...
var $M = nj();
const aj = /* @__PURE__ */ R($M), oj = /* @__PURE__ */ A({
  __proto__: null,
  default: aj
}, [$M]);
var Tr = { exports: {} }, sj = Tr.exports, i_;
function ij() {
...
var HM = ij();
const uj = /* @__PURE__ */ R(HM), lj = /* @__PURE__ */ A({
  __proto__: null,
  default: uj
}, [HM]);
var $r = { exports: {} }, dj = $r.exports, u_;
function cj() {
...
var jM = cj();
const _j = /* @__PURE__ */ R(jM), fj = /* @__PURE__ */ A({
  __proto__: null,
  default: _j
}, [jM]);
var Hr = { exports: {} }, mj = Hr.exports, l_;
function pj() {
...
var EM = pj();
const hj = /* @__PURE__ */ R(EM), vj = /* @__PURE__ */ A({
  __proto__: null,
  default: hj
}, [EM]);
var jr = { exports: {} }, yj = jr.exports, d_;
function gj() {
...
var qM = gj();
const Mj = /* @__PURE__ */ R(qM), bj = /* @__PURE__ */ A({
  __proto__: null,
  default: Mj
}, [qM]);
var Er = { exports: {} }, Yj = Er.exports, c_;
function wj() {
...
var CM = wj();
const xj = /* @__PURE__ */ R(CM), Lj = /* @__PURE__ */ A({
  __proto__: null,
  default: xj
}, [CM]);
var qr = { exports: {} }, kj = qr.exports, __;
function Sj() {
...
var AM = Sj();
const Dj = /* @__PURE__ */ R(AM), Tj = /* @__PURE__ */ A({
  __proto__: null,
  default: Dj
}, [AM]);
var Cr = { exports: {} }, $j = Cr.exports, f_;
function Hj() {
...
var RM = Hj();
const jj = /* @__PURE__ */ R(RM), Ej = /* @__PURE__ */ A({
  __proto__: null,
  default: jj
}, [RM]);
var Ar = { exports: {} }, qj = Ar.exports, m_;
function Cj() {
...
var IM = Cj();
const Aj = /* @__PURE__ */ R(IM), Rj = /* @__PURE__ */ A({
  __proto__: null,
  default: Aj
}, [IM]);
var Rr = { exports: {} }, Ij = Rr.exports, p_;
function Pj() {
...
var PM = Pj();
const Nj = /* @__PURE__ */ R(PM), Oj = /* @__PURE__ */ A({
  __proto__: null,
  default: Nj
}, [PM]);
var Ir = { exports: {} }, zj = Ir.exports, h_;
function Bj() {
...
var NM = Bj();
const Fj = /* @__PURE__ */ R(NM), Gj = /* @__PURE__ */ A({
  __proto__: null,
  default: Fj
}, [NM]);
var Pr = { exports: {} }, Jj = Pr.exports, v_;
function Uj() {
...
var OM = Uj();
const Wj = /* @__PURE__ */ R(OM), Vj = /* @__PURE__ */ A({
  __proto__: null,
  default: Wj
}, [OM]);
var Nr = { exports: {} }, Kj = Nr.exports, y_;
function Xj() {
...
var zM = Xj();
const Zj = /* @__PURE__ */ R(zM), Qj = /* @__PURE__ */ A({
  __proto__: null,
  default: Zj
}, [zM]);
var Or = { exports: {} }, e2 = Or.exports, g_;
function t2() {
...
var BM = t2();
const r2 = /* @__PURE__ */ R(BM), n2 = /* @__PURE__ */ A({
  __proto__: null,
  default: r2
}, [BM]);
var zr = { exports: {} }, a2 = zr.exports, M_;
function o2() {
  return M_ || (M_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var FM = o2();
const s2 = /* @__PURE__ */ R(FM), i2 = /* @__PURE__ */ A({
  __proto__: null,
  default: s2
}, [FM]);
var Br = { exports: {} }, u2 = Br.exports, b_;
function l2() {
...
var GM = l2();
const d2 = /* @__PURE__ */ R(GM), c2 = /* @__PURE__ */ A({
  __proto__: null,
  default: d2
}, [GM]);
var Fr = { exports: {} }, _2 = Fr.exports, Y_;
function f2() {
  return Y_ || (Y_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var JM = f2();
const m2 = /* @__PURE__ */ R(JM), p2 = /* @__PURE__ */ A({
  __proto__: null,
  default: m2
}, [JM]);
var Gr = { exports: {} }, h2 = Gr.exports, w_;
function v2() {
...
var UM = v2();
const y2 = /* @__PURE__ */ R(UM), g2 = /* @__PURE__ */ A({
  __proto__: null,
  default: y2
}, [UM]);
var Jr = { exports: {} }, M2 = Jr.exports, x_;
function b2() {
...
var WM = b2();
const Y2 = /* @__PURE__ */ R(WM), w2 = /* @__PURE__ */ A({
  __proto__: null,
  default: Y2
}, [WM]);
var Ur = { exports: {} }, x2 = Ur.exports, L_;
function L2() {
  return L_ || (L_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var VM = L2();
const k2 = /* @__PURE__ */ R(VM), S2 = /* @__PURE__ */ A({
  __proto__: null,
  default: k2
}, [VM]);
var Wr = { exports: {} }, D2 = Wr.exports, k_;
function T2() {
...
var KM = T2();
const $2 = /* @__PURE__ */ R(KM), H2 = /* @__PURE__ */ A({
  __proto__: null,
  default: $2
}, [KM]);
var Vr = { exports: {} }, j2 = Vr.exports, S_;
function E2() {
  return S_ || (S_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var XM = E2();
const q2 = /* @__PURE__ */ R(XM), C2 = /* @__PURE__ */ A({
  __proto__: null,
  default: q2
}, [XM]);
var Kr = { exports: {} }, A2 = Kr.exports, D_;
function R2() {
  return D_ || (D_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var ZM = R2();
const I2 = /* @__PURE__ */ R(ZM), P2 = /* @__PURE__ */ A({
  __proto__: null,
  default: I2
}, [ZM]);
var Xr = { exports: {} }, N2 = Xr.exports, T_;
function O2() {
  return T_ || (T_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var QM = O2();
const z2 = /* @__PURE__ */ R(QM), B2 = /* @__PURE__ */ A({
  __proto__: null,
  default: z2
}, [QM]);
var Zr = { exports: {} }, F2 = Zr.exports, $_;
function G2() {
...
var eb = G2();
const J2 = /* @__PURE__ */ R(eb), U2 = /* @__PURE__ */ A({
  __proto__: null,
  default: J2
}, [eb]);
var Qr = { exports: {} }, W2 = Qr.exports, H_;
function V2() {
  return H_ || (H_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var tb = V2();
const K2 = /* @__PURE__ */ R(tb), X2 = /* @__PURE__ */ A({
  __proto__: null,
  default: K2
}, [tb]);
var en = { exports: {} }, Z2 = en.exports, j_;
function Q2() {
...
var rb = Q2();
const eE = /* @__PURE__ */ R(rb), tE = /* @__PURE__ */ A({
  __proto__: null,
  default: eE
}, [rb]);
var tn = { exports: {} }, rE = tn.exports, E_;
function nE() {
  return E_ || (E_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var nb = nE();
const aE = /* @__PURE__ */ R(nb), oE = /* @__PURE__ */ A({
  __proto__: null,
  default: aE
}, [nb]);
var rn = { exports: {} }, sE = rn.exports, q_;
function iE() {
...
var ab = iE();
const uE = /* @__PURE__ */ R(ab), lE = /* @__PURE__ */ A({
  __proto__: null,
  default: uE
}, [ab]);
var nn = { exports: {} }, dE = nn.exports, C_;
function cE() {
  return C_ || (C_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var ob = cE();
const _E = /* @__PURE__ */ R(ob), fE = /* @__PURE__ */ A({
  __proto__: null,
  default: _E
}, [ob]);
var an = { exports: {} }, mE = an.exports, A_;
function pE() {
  return A_ || (A_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var sb = pE();
const hE = /* @__PURE__ */ R(sb), vE = /* @__PURE__ */ A({
  __proto__: null,
  default: hE
}, [sb]);
var on = { exports: {} }, yE = on.exports, R_;
function gE() {
  return R_ || (R_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var ib = gE();
const ME = /* @__PURE__ */ R(ib), bE = /* @__PURE__ */ A({
  __proto__: null,
  default: ME
}, [ib]);
var sn = { exports: {} }, YE = sn.exports, I_;
function wE() {
  return I_ || (I_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var ub = wE();
const xE = /* @__PURE__ */ R(ub), LE = /* @__PURE__ */ A({
  __proto__: null,
  default: xE
}, [ub]);
var un = { exports: {} }, kE = un.exports, P_;
function SE() {
  return P_ || (P_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var lb = SE();
const DE = /* @__PURE__ */ R(lb), TE = /* @__PURE__ */ A({
  __proto__: null,
  default: DE
}, [lb]);
var ln = { exports: {} }, $E = ln.exports, N_;
function HE() {
  return N_ || (N_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var db = HE();
const jE = /* @__PURE__ */ R(db), EE = /* @__PURE__ */ A({
  __proto__: null,
  default: jE
}, [db]);
var dn = { exports: {} }, qE = dn.exports, O_;
function CE() {
  return O_ || (O_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var cb = CE();
const AE = /* @__PURE__ */ R(cb), RE = /* @__PURE__ */ A({
  __proto__: null,
  default: AE
}, [cb]);
var cn = { exports: {} }, IE = cn.exports, z_;
function PE() {
...
var _b = PE();
const NE = /* @__PURE__ */ R(_b), OE = /* @__PURE__ */ A({
  __proto__: null,
  default: NE
}, [_b]);
var _n = { exports: {} }, zE = _n.exports, B_;
function BE() {
  return B_ || (B_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var fb = BE();
const FE = /* @__PURE__ */ R(fb), GE = /* @__PURE__ */ A({
  __proto__: null,
  default: FE
}, [fb]);
var fn = { exports: {} }, JE = fn.exports, F_;
function UE() {
  return F_ || (F_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var mb = UE();
const WE = /* @__PURE__ */ R(mb), VE = /* @__PURE__ */ A({
  __proto__: null,
  default: WE
}, [mb]);
var mn = { exports: {} }, KE = mn.exports, G_;
function XE() {
  return G_ || (G_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var pb = XE();
const ZE = /* @__PURE__ */ R(pb), QE = /* @__PURE__ */ A({
  __proto__: null,
  default: ZE
}, [pb]);
var pn = { exports: {} }, eq = pn.exports, J_;
function tq() {
  return J_ || (J_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var hb = tq();
const rq = /* @__PURE__ */ R(hb), nq = /* @__PURE__ */ A({
  __proto__: null,
  default: rq
}, [hb]);
var hn = { exports: {} }, aq = hn.exports, U_;
function oq() {
  return U_ || (U_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var vb = oq();
const sq = /* @__PURE__ */ R(vb), iq = /* @__PURE__ */ A({
  __proto__: null,
  default: sq
}, [vb]);
var vn = { exports: {} }, uq = vn.exports, W_;
function lq() {
  return W_ || (W_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var yb = lq();
const dq = /* @__PURE__ */ R(yb), cq = /* @__PURE__ */ A({
  __proto__: null,
  default: dq
}, [yb]);
var yn = { exports: {} }, _q = yn.exports, V_;
function fq() {
  return V_ || (V_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var gb = fq();
const mq = /* @__PURE__ */ R(gb), pq = /* @__PURE__ */ A({
  __proto__: null,
  default: mq
}, [gb]);
var gn = { exports: {} }, hq = gn.exports, K_;
function vq() {
  return K_ || (K_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Mb = vq();
const yq = /* @__PURE__ */ R(Mb), gq = /* @__PURE__ */ A({
  __proto__: null,
  default: yq
}, [Mb]);
var Mn = { exports: {} }, Mq = Mn.exports, X_;
function bq() {
  return X_ || (X_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var bb = bq();
const Yq = /* @__PURE__ */ R(bb), wq = /* @__PURE__ */ A({
  __proto__: null,
  default: Yq
}, [bb]);
var bn = { exports: {} }, xq = bn.exports, Z_;
function Lq() {
  return Z_ || (Z_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Yb = Lq();
const kq = /* @__PURE__ */ R(Yb), Sq = /* @__PURE__ */ A({
  __proto__: null,
  default: kq
}, [Yb]);
var Yn = { exports: {} }, Dq = Yn.exports, Q_;
function Tq() {
  return Q_ || (Q_ = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var wb = Tq();
const $q = /* @__PURE__ */ R(wb), Hq = /* @__PURE__ */ A({
  __proto__: null,
  default: $q
}, [wb]);
var Lt = { exports: {} }, jq = Lt.exports, ef;
function Eq() {
...
var xb = Eq();
const qq = /* @__PURE__ */ R(xb), Cq = /* @__PURE__ */ A({
  __proto__: null,
  default: qq
}, [xb]);
var wn = { exports: {} }, Aq = wn.exports, tf;
function Rq() {
...
var Lb = Rq();
const Iq = /* @__PURE__ */ R(Lb), Pq = /* @__PURE__ */ A({
  __proto__: null,
  default: Iq
}, [Lb]);
var xn = { exports: {} }, Nq = xn.exports, rf;
function Oq() {
...
var kb = Oq();
const zq = /* @__PURE__ */ R(kb), Bq = /* @__PURE__ */ A({
  __proto__: null,
  default: zq
}, [kb]);
var Ln = { exports: {} }, Fq = Ln.exports, nf;
function Gq() {
...
var Sb = Gq();
const Jq = /* @__PURE__ */ R(Sb), Uq = /* @__PURE__ */ A({
  __proto__: null,
  default: Jq
}, [Sb]);
var kn = { exports: {} }, Wq = kn.exports, af;
function Vq() {
...
var Db = Vq();
const Kq = /* @__PURE__ */ R(Db), Xq = /* @__PURE__ */ A({
  __proto__: null,
  default: Kq
}, [Db]);
var Sn = { exports: {} }, Zq = Sn.exports, of;
function Qq() {
...
var Tb = Qq();
const eC = /* @__PURE__ */ R(Tb), tC = /* @__PURE__ */ A({
  __proto__: null,
  default: eC
}, [Tb]);
var Dn = { exports: {} }, rC = Dn.exports, sf;
function nC() {
...
var $b = nC();
const aC = /* @__PURE__ */ R($b), oC = /* @__PURE__ */ A({
  __proto__: null,
  default: aC
}, [$b]);
var Tn = { exports: {} }, sC = Tn.exports, uf;
function iC() {
...
var Hb = iC();
const uC = /* @__PURE__ */ R(Hb), lC = /* @__PURE__ */ A({
  __proto__: null,
  default: uC
}, [Hb]);
var $n = { exports: {} }, dC = $n.exports, lf;
function cC() {
...
var jb = cC();
const _C = /* @__PURE__ */ R(jb), fC = /* @__PURE__ */ A({
  __proto__: null,
  default: _C
}, [jb]);
var Hn = { exports: {} }, mC = Hn.exports, df;
function pC() {
...
var Eb = pC();
const hC = /* @__PURE__ */ R(Eb), vC = /* @__PURE__ */ A({
  __proto__: null,
  default: hC
}, [Eb]);
var jn = { exports: {} }, yC = jn.exports, cf;
function gC() {
...
var qb = gC();
const MC = /* @__PURE__ */ R(qb), bC = /* @__PURE__ */ A({
  __proto__: null,
  default: MC
}, [qb]);
var En = { exports: {} }, YC = En.exports, _f;
function wC() {
...
var Cb = wC();
const xC = /* @__PURE__ */ R(Cb), LC = /* @__PURE__ */ A({
  __proto__: null,
  default: xC
}, [Cb]);
var qn = { exports: {} }, kC = qn.exports, ff;
function SC() {
...
var Ab = SC();
const DC = /* @__PURE__ */ R(Ab), TC = /* @__PURE__ */ A({
  __proto__: null,
  default: DC
}, [Ab]);
var Cn = { exports: {} }, $C = Cn.exports, mf;
function HC() {
...
var Rb = HC();
const jC = /* @__PURE__ */ R(Rb), EC = /* @__PURE__ */ A({
  __proto__: null,
  default: jC
}, [Rb]);
var An = { exports: {} }, qC = An.exports, pf;
function CC() {
...
var Ib = CC();
const AC = /* @__PURE__ */ R(Ib), RC = /* @__PURE__ */ A({
  __proto__: null,
  default: AC
}, [Ib]);
var Rn = { exports: {} }, IC = Rn.exports, hf;
function PC() {
...
var Pb = PC();
const NC = /* @__PURE__ */ R(Pb), OC = /* @__PURE__ */ A({
  __proto__: null,
  default: NC
}, [Pb]);
var In = { exports: {} }, zC = In.exports, vf;
function BC() {
...
var Nb = BC();
const FC = /* @__PURE__ */ R(Nb), GC = /* @__PURE__ */ A({
  __proto__: null,
  default: FC
}, [Nb]);
var Pn = { exports: {} }, JC = Pn.exports, yf;
function UC() {
...
var Ob = UC();
const WC = /* @__PURE__ */ R(Ob), VC = /* @__PURE__ */ A({
  __proto__: null,
  default: WC
}, [Ob]);
var Nn = { exports: {} }, KC = Nn.exports, gf;
function XC() {
...
var zb = XC();
const ZC = /* @__PURE__ */ R(zb), QC = /* @__PURE__ */ A({
  __proto__: null,
  default: ZC
}, [zb]);
var On = { exports: {} }, eA = On.exports, Mf;
function tA() {
  return Mf || (Mf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Bb = tA();
const rA = /* @__PURE__ */ R(Bb), nA = /* @__PURE__ */ A({
  __proto__: null,
  default: rA
}, [Bb]);
var zn = { exports: {} }, aA = zn.exports, bf;
function oA() {
...
var Fb = oA();
const sA = /* @__PURE__ */ R(Fb), iA = /* @__PURE__ */ A({
  __proto__: null,
  default: sA
}, [Fb]);
var Bn = { exports: {} }, uA = Bn.exports, Yf;
function lA() {
  return Yf || (Yf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Gb = lA();
const dA = /* @__PURE__ */ R(Gb), cA = /* @__PURE__ */ A({
  __proto__: null,
  default: dA
}, [Gb]);
var Fn = { exports: {} }, _A = Fn.exports, wf;
function fA() {
...
var Jb = fA();
const mA = /* @__PURE__ */ R(Jb), pA = /* @__PURE__ */ A({
  __proto__: null,
  default: mA
}, [Jb]);
var Gn = { exports: {} }, hA = Gn.exports, xf;
function vA() {
...
var Ub = vA();
const yA = /* @__PURE__ */ R(Ub), gA = /* @__PURE__ */ A({
  __proto__: null,
  default: yA
}, [Ub]);
...
var Wb = bA();
const YA = /* @__PURE__ */ R(Wb), wA = /* @__PURE__ */ A({
  __proto__: null,
  default: YA
}, [Wb]);
var Un = { exports: {} }, xA = Un.exports, kf;
function LA() {
...
var Vb = LA();
const kA = /* @__PURE__ */ R(Vb), SA = /* @__PURE__ */ A({
  __proto__: null,
  default: kA
}, [Vb]);
var Wn = { exports: {} }, DA = Wn.exports, Sf;
function TA() {
  return Sf || (Sf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Kb = TA();
const $A = /* @__PURE__ */ R(Kb), HA = /* @__PURE__ */ A({
  __proto__: null,
  default: $A
}, [Kb]);
var Vn = { exports: {} }, jA = Vn.exports, Df;
function EA() {
  return Df || (Df = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Xb = EA();
const qA = /* @__PURE__ */ R(Xb), CA = /* @__PURE__ */ A({
  __proto__: null,
  default: qA
}, [Xb]);
var Kn = { exports: {} }, AA = Kn.exports, Tf;
function RA() {
  return Tf || (Tf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var Zb = RA();
const IA = /* @__PURE__ */ R(Zb), PA = /* @__PURE__ */ A({
  __proto__: null,
  default: IA
}, [Zb]);
var Xn = { exports: {} }, NA = Xn.exports, $f;
function OA() {
...
var Qb = OA();
const zA = /* @__PURE__ */ R(Qb), BA = /* @__PURE__ */ A({
  __proto__: null,
  default: zA
}, [Qb]);
var Zn = { exports: {} }, FA = Zn.exports, Hf;
function GA() {
  return Hf || (Hf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var eY = GA();
const JA = /* @__PURE__ */ R(eY), UA = /* @__PURE__ */ A({
  __proto__: null,
  default: JA
}, [eY]);
var Qn = { exports: {} }, WA = Qn.exports, jf;
function VA() {
...
var tY = VA();
const KA = /* @__PURE__ */ R(tY), XA = /* @__PURE__ */ A({
  __proto__: null,
  default: KA
}, [tY]);
var ea = { exports: {} }, ZA = ea.exports, Ef;
function QA() {
  return Ef || (Ef = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var rY = QA();
const eR = /* @__PURE__ */ R(rY), tR = /* @__PURE__ */ A({
  __proto__: null,
  default: eR
}, [rY]);
var ta = { exports: {} }, rR = ta.exports, qf;
function nR() {
...
var nY = nR();
const aR = /* @__PURE__ */ R(nY), oR = /* @__PURE__ */ A({
  __proto__: null,
  default: aR
}, [nY]);
var ra = { exports: {} }, sR = ra.exports, Cf;
function iR() {
  return Cf || (Cf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var aY = iR();
const uR = /* @__PURE__ */ R(aY), lR = /* @__PURE__ */ A({
  __proto__: null,
  default: uR
}, [aY]);
var na = { exports: {} }, dR = na.exports, Af;
function cR() {
  return Af || (Af = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var oY = cR();
const _R = /* @__PURE__ */ R(oY), fR = /* @__PURE__ */ A({
  __proto__: null,
  default: _R
}, [oY]);
var aa = { exports: {} }, mR = aa.exports, Rf;
function pR() {
  return Rf || (Rf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var sY = pR();
const hR = /* @__PURE__ */ R(sY), vR = /* @__PURE__ */ A({
  __proto__: null,
  default: hR
}, [sY]);
var oa = { exports: {} }, yR = oa.exports, If;
function gR() {
...
var iY = gR();
const MR = /* @__PURE__ */ R(iY), bR = /* @__PURE__ */ A({
  __proto__: null,
  default: MR
}, [iY]);
var sa = { exports: {} }, YR = sa.exports, Pf;
function wR() {
  return Pf || (Pf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var uY = wR();
const xR = /* @__PURE__ */ R(uY), LR = /* @__PURE__ */ A({
  __proto__: null,
  default: xR
}, [uY]);
var ia = { exports: {} }, kR = ia.exports, Nf;
function SR() {
  return Nf || (Nf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var lY = SR();
const DR = /* @__PURE__ */ R(lY), TR = /* @__PURE__ */ A({
  __proto__: null,
  default: DR
}, [lY]);
var ua = { exports: {} }, $R = ua.exports, Of;
function HR() {
  return Of || (Of = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var dY = HR();
const jR = /* @__PURE__ */ R(dY), ER = /* @__PURE__ */ A({
  __proto__: null,
  default: jR
}, [dY]);
var la = { exports: {} }, qR = la.exports, zf;
function CR() {
...
var cY = CR();
const AR = /* @__PURE__ */ R(cY), RR = /* @__PURE__ */ A({
  __proto__: null,
  default: AR
}, [cY]);
...
var _Y = PR();
const NR = /* @__PURE__ */ R(_Y), OR = /* @__PURE__ */ A({
  __proto__: null,
  default: NR
}, [_Y]);
var ca = { exports: {} }, zR = ca.exports, Ff;
function BR() {
  return Ff || (Ff = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var fY = BR();
const FR = /* @__PURE__ */ R(fY), GR = /* @__PURE__ */ A({
  __proto__: null,
  default: FR
}, [fY]);
var _a = { exports: {} }, JR = _a.exports, Gf;
function UR() {
  return Gf || (Gf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var mY = UR();
const WR = /* @__PURE__ */ R(mY), VR = /* @__PURE__ */ A({
  __proto__: null,
  default: WR
}, [mY]);
var fa = { exports: {} }, KR = fa.exports, Jf;
function XR() {
  return Jf || (Jf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var pY = XR();
const ZR = /* @__PURE__ */ R(pY), QR = /* @__PURE__ */ A({
  __proto__: null,
  default: ZR
}, [pY]);
var ma = { exports: {} }, eI = ma.exports, Uf;
function tI() {
  return Uf || (Uf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var hY = tI();
const rI = /* @__PURE__ */ R(hY), nI = /* @__PURE__ */ A({
  __proto__: null,
  default: rI
}, [hY]);
var pa = { exports: {} }, aI = pa.exports, Wf;
function oI() {
  return Wf || (Wf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var vY = oI();
const sI = /* @__PURE__ */ R(vY), iI = /* @__PURE__ */ A({
  __proto__: null,
  default: sI
}, [vY]);
var ha = { exports: {} }, uI = ha.exports, Vf;
function lI() {
  return Vf || (Vf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var yY = lI();
const dI = /* @__PURE__ */ R(yY), cI = /* @__PURE__ */ A({
  __proto__: null,
  default: dI
}, [yY]);
var va = { exports: {} }, _I = va.exports, Kf;
function fI() {
  return Kf || (Kf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var gY = fI();
const mI = /* @__PURE__ */ R(gY), pI = /* @__PURE__ */ A({
  __proto__: null,
  default: mI
}, [gY]);
var ya = { exports: {} }, hI = ya.exports, Xf;
function vI() {
  return Xf || (Xf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var MY = vI();
const yI = /* @__PURE__ */ R(MY), gI = /* @__PURE__ */ A({
  __proto__: null,
  default: yI
}, [MY]);
var ga = { exports: {} }, MI = ga.exports, Zf;
function bI() {
  return Zf || (Zf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var bY = bI();
const YI = /* @__PURE__ */ R(bY), wI = /* @__PURE__ */ A({
  __proto__: null,
  default: YI
}, [bY]);
var Ma = { exports: {} }, xI = Ma.exports, Qf;
function LI() {
  return Qf || (Qf = 1, (function(e, a) {
    (function(n, r) {
      e.exports = r(I());
...
var YY = LI();
const kI = /* @__PURE__ */ R(YY), SI = /* @__PURE__ */ A({
  __proto__: null,
  default: kI
}, [YY]);
var ba = { exports: {} }, DI = ba.exports, em;
function TI() {
...
var wY = TI();
const $I = /* @__PURE__ */ R(wY), HI = /* @__PURE__ */ A({
  __proto__: null,
  default: $I
}, [wY]);
var Ya = { exports: {} }, jI = Ya.exports, tm;
function EI() {
...
var xY = EI();
const qI = /* @__PURE__ */ R(xY), CI = /* @__PURE__ */ A({
  __proto__: null,
  default: qI
}, [xY]);
var wa = { exports: {} }, AI = wa.exports, rm;
function RI() {
...
var LY = RI();
const II = /* @__PURE__ */ R(LY), PI = /* @__PURE__ */ A({
  __proto__: null,
  default: II
}, [LY]);
var xa = { exports: {} }, NI = xa.exports, nm;
function OI() {
...
var kY = OI();
const zI = /* @__PURE__ */ R(kY), BI = /* @__PURE__ */ A({
  __proto__: null,
  default: zI
}, [kY]);
var La = { exports: {} }, FI = La.exports, am;
function GI() {
...
var SY = GI();
const JI = /* @__PURE__ */ R(SY), UI = /* @__PURE__ */ A({
  __proto__: null,
  default: JI
}, [SY]);
var ka = { exports: {} }, WI = ka.exports, om;
function VI() {
...
var DY = VI();
const KI = /* @__PURE__ */ R(DY), XI = /* @__PURE__ */ A({
  __proto__: null,
  default: KI
}, [DY]);
var Sa = { exports: {} }, ZI = Sa.exports, sm;
function QI() {
...
var TY = QI();
const eP = /* @__PURE__ */ R(TY), tP = /* @__PURE__ */ A({
  __proto__: null,
  default: eP
}, [TY]);
var Da = { exports: {} }, rP = Da.exports, im;
function nP() {
...
var $Y = nP();
const aP = /* @__PURE__ */ R($Y), oP = /* @__PURE__ */ A({
  __proto__: null,
  default: aP
}, [$Y]);
var Ta = { exports: {} }, sP = Ta.exports, um;
function iP() {
...
var HY = iP();
const uP = /* @__PURE__ */ R(HY), lP = /* @__PURE__ */ A({
  __proto__: null,
  default: uP
}, [HY]);
var $a = { exports: {} }, dP = $a.exports, lm;
function cP() {
...
var jY = cP();
const _P = /* @__PURE__ */ R(jY), fP = /* @__PURE__ */ A({
  __proto__: null,
  default: _P
}, [jY]);
var Ha = { exports: {} }, mP = Ha.exports, dm;
function pP() {
...
var EY = pP();
const hP = /* @__PURE__ */ R(EY), vP = /* @__PURE__ */ A({
  __proto__: null,
  default: hP
}, [EY]);
var ja = { exports: {} }, yP = ja.exports, cm;
function gP() {
...
var qY = gP();
const MP = /* @__PURE__ */ R(qY), bP = /* @__PURE__ */ A({
  __proto__: null,
  default: MP
}, [qY]);
var Ea = { exports: {} }, YP = Ea.exports, _m;
function wP() {
...
var CY = wP();
const xP = /* @__PURE__ */ R(CY), LP = /* @__PURE__ */ A({
  __proto__: null,
  default: xP
}, [CY]);
function Wd(e) {
...
function Be() {
  if (km) return qo;
  km = 1;
  var e = AY(), a = typeof self == "object" && self && self.Object === Object && self, n = e || a || Function("return this")();
  return qo = n, qo;
}
var Co, Sm;
function Mt() {
...
function lt() {
  if ($m) return Io;
  $m = 1;
  var e = Mt(), a = CP(), n = AP(), r = "[object Null]", o = "[object Undefined]", s = e ? e.toStringTag : void 0;
  function t(i) {
...
function Rt() {
  if (jm) return No;
  jm = 1;
  var e = lt(), a = Pe(), n = "[object AsyncFunction]", r = "[object Function]", o = "[object GeneratorFunction]", s = "[object Proxy]";
  function t(i) {
    if (!a(i))
      return !1;
    var u = e(i);
...
function RP() {
  if (Em) return Oo;
  Em = 1;
  var e = Be(), a = e["__core-js_shared__"];
  return Oo = a, Oo;
}
var zo, qm;
function IP() {
...
function PP() {
  if (Am) return Fo;
  Am = 1;
  var e = Rt(), a = IP(), n = Pe(), r = RY(), o = /[\\^$.*+?()[\]{}|]/g, s = /^\[object .+?Constructor\]$/, t = Function.prototype, i = Object.prototype, u = t.toString, l = i.hasOwnProperty, d = RegExp(
...
function eo() {
  if (rp) return ds;
  rp = 1;
  var e = Xa(), a = HP(), n = jP(), r = EP(), o = qP(), s = QP();
  function t(i) {
...
function Pt() {
  if (cp) return gs;
  cp = 1;
  var e = tN(), a = Je(), n = Object.prototype, r = n.hasOwnProperty, o = n.propertyIsEnumerable, s = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(t) {
...
function bt() {
  return mp || (mp = 1, (function(e, a) {
    var n = Be(), r = rN(), o = a && !a.nodeType && a, s = o && !0 && e && !e.nodeType && e, t = s && s.exports === o, i = t ? n.Buffer : void 0, u = i ? i.isBuffer : void 0, l = u || r;
    e.exports = l;
...
var gp;
function Qd() {
  return gp || (gp = 1, (function(e, a) {
    var n = AY(), r = a && !a.nodeType && a, o = r && !0 && e && !e.nodeType && e, s = o && o.exports === r, t = s && n.process, i = (function() {
      try {
...
function Nt() {
  if (Mp) return ks;
  Mp = 1;
  var e = nN(), a = ao(), n = Qd(), r = n && n.isTypedArray, o = r ? a(r) : e;
  return ks = o, ks;
}
var Ss, bp;
function PY() {
  if (bp) return Ss;
  bp = 1;
  var e = eN(), a = Pt(), n = xe(), r = bt(), o = no(), s = Nt(), t = Object.prototype, i = t.hasOwnProperty;
  function u(l, d) {
...
function aN() {
  if (xp) return $s;
  xp = 1;
  var e = NY(), a = e(Object.keys, Object);
  return $s = a, $s;
}
var Hs, Lp;
function ec() {
  if (Lp) return Hs;
  Lp = 1;
  var e = oo(), a = aN(), n = Object.prototype, r = n.hasOwnProperty;
  function o(s) {
    if (!e(s))
      return a(s);
    var t = [];
...
function iN() {
  if ($p) return As;
  $p = 1;
  var e = Pe(), a = oo(), n = sN(), r = Object.prototype, o = r.hasOwnProperty;
  function s(t) {
    if (!e(t))
      return n(t);
    var i = a(t), u = [];
...
var Ep;
function OY() {
  return Ep || (Ep = 1, (function(e, a) {
    var n = Be(), r = a && !a.nodeType && a, o = r && !0 && e && !e.nodeType && e, s = o && o.exports === r, t = s ? n.Buffer : void 0, i = t ? t.allocUnsafe : void 0;
    function u(l, d) {
      if (d)
        return l.slice();
...
function tc() {
  if (Rp) return zs;
  Rp = 1;
  var e = BY(), a = FY(), n = Object.prototype, r = n.propertyIsEnumerable, o = Object.getOwnPropertySymbols, s = o ? function(t) {
...
function so() {
  if (Np) return Gs;
  Np = 1;
  var e = NY(), a = e(Object.getPrototypeOf, Object);
  return Gs = a, Gs;
}
var Js, Op;
function GY() {
  if (Op) return Js;
  Op = 1;
  var e = rc(), a = so(), n = tc(), r = FY(), o = Object.getOwnPropertySymbols, s = o ? function(t) {
    for (var i = []; t; )
      e(i, n(t)), t = a(t);
    return i;
  } : r;
...
function Yt() {
  if (Kp) return ti;
  Kp = 1;
  var e = _N(), a = Vd(), n = fN(), r = WY(), o = mN(), s = lt(), t = RY(), i = "[object Map]", u = "[object Object]", l = "[object Promise]", d = "[object Set]", c = "[object WeakMap]", _ = "[object DataView]", f = t(e), m = t(a), h = t(n), y = t(r), p = t(o), v = s;
...
function gN() {
  if (ah) return li;
  ah = 1;
  var e = nc(), a = hN(), n = vN(), r = yN(), o = KY(), s = "[object Boolean]", t = "[object Date]", i = "[object Map]", u = "[object Number]", l = "[object RegExp]", d = "[object Set]", c = "[object String]", _ = "[object Symbol]", f = "[object ArrayBuffer]", m = "[object DataView]", h = "[object Float32Array]", y = "[object Float64Array]", p = "[object Int8Array]", v = "[object Int16Array]", g = "[object Int32Array]", M = "[object Uint8Array]", w = "[object Uint8ClampedArray]", L = "[object Uint16Array]", D = "[object Uint32Array]";
  function Y(T, k, S) {
    var B = T.constructor;
    switch (k) {
      case f:
...
function XY() {
  if (oh) return di;
  oh = 1;
  var e = Pe(), a = Object.create, n = /* @__PURE__ */ (function() {
    function r() {
    }
    return function(o) {
      if (!e(o))
...
function bN() {
  if (uh) return fi;
  uh = 1;
  var e = MN(), a = ao(), n = Qd(), r = n && n.isMap, o = r ? a(r) : e;
  return fi = o, fi;
}
var mi, lh;
function YN() {
...
function wN() {
  if (dh) return pi;
  dh = 1;
  var e = YN(), a = ao(), n = Qd(), r = n && n.isSet, o = r ? a(r) : e;
  return pi = o, pi;
}
var hi, ch;
function QY() {
  if (ch) return hi;
  ch = 1;
  var e = eo(), a = Xd(), n = ro(), r = oN(), o = uN(), s = OY(), t = zY(), i = lN(), u = dN(), l = UY(), d = cN(), c = Yt(), _ = pN(), f = gN(), m = ZY(), h = xe(), y = bt(), p = bN(), v = Pe(), g = wN(), M = ot(), w = ct(), L = 1, D = 2, Y = 4, T = "[object Arguments]", k = "[object Array]", S = "[object Boolean]", B = "[object Date]", F = "[object Error]", $ = "[object Function]", x = "[object GeneratorFunction]", j = "[object Map]", G = "[object Number]", z = "[object Object]", W = "[object RegExp]", Z = "[object Set]", K = "[object String]", ne = "[object Symbol]", se = "[object WeakMap]", C = "[object ArrayBuffer]", O = "[object DataView]", U = "[object Float32Array]", V = "[object Float64Array]", oe = "[object Int8Array]", ce = "[object Int16Array]", le = "[object Int32Array]", he = "[object Uint8Array]", Ae = "[object Uint8ClampedArray]", be = "[object Uint16Array]", Se = "[object Uint32Array]", _e = {};
  _e[T] = _e[k] = _e[C] = _e[O] = _e[S] = _e[B] = _e[U] = _e[V] = _e[oe] = _e[ce] = _e[le] = _e[j] = _e[G] = _e[z] = _e[W] = _e[Z] = _e[K] = _e[ne] = _e[he] = _e[Ae] = _e[be] = _e[Se] = !0, _e[F] = _e[$] = _e[se] = !1;
  function Ue(fe, Ze, Qe, mo, ft, Fe) {
    var Te, mt = Ze & L, st = Ze & D, zt = Ze & Y;
    if (Qe && (Te = ft ? Qe(fe, mo, ft, Fe) : Qe(fe)), Te !== void 0)
      return Te;
    if (!v(fe))
      return fe;
    var Bt = h(fe);
    ...
    if (Gt)
      return Gt;
    Fe.set(fe, Te), g(fe) ? fe.forEach(function(Ge) {
      Te.add(Ue(Ge, Ze, Qe, Ge, fe, Fe));
    }) : p(fe) && fe.forEach(function(Ge, Oe) {
      Te.set(Oe, Ue(Ge, Ze, Qe, Oe, fe, Fe));
    });
    var po = zt ? st ? d : l : st ? w : M, Jt = Bt ? void 0 : po(fe);
    return a(Jt || fe, function(Ge, Oe) {
      Jt && (Oe = Ge, Ge = fe[Oe]), n(Te, Oe, Ue(Ge, Ze, Qe, Oe, fe, Fe));
    }), Te;
  }
  return hi = Ue, hi;
}
...
function jN() {
  if (jh) return Ri;
  jh = 1;
  var e = Mt(), a = VY(), n = gt(), r = ow(), o = HN(), s = ic(), t = 1, i = 2, u = "[object Boolean]", l = "[object Date]", d = "[object Error]", c = "[object Map]", _ = "[object Number]", f = "[object RegExp]", m = "[object Set]", h = "[object String]", y = "[object Symbol]", p = "[object ArrayBuffer]", v = "[object DataView]", g = e ? e.prototype : void 0, M = g ? g.valueOf : void 0;
  function w(L, D, Y, T, k, S, B) {
    switch (Y) {
      case v:
      ...
      case m:
        var $ = T & t;
        if (F || (F = s), L.size != D.size && !$)
          return !1;
        var x = B.get(L);
        if (x)
          return x == D;
        T |= i, B.set(L, D);
        var j = r(F(L), F(D), T, k, S, B);
        return B.delete(L), j;
      case y:
        if (M)
...
function EN() {
  if (Eh) return Ii;
  Eh = 1;
  var e = UY(), a = 1, n = Object.prototype, r = n.hasOwnProperty;
...
function qN() {
  if (qh) return Pi;
  qh = 1;
  var e = eo(), a = ow(), n = jN(), r = EN(), o = Yt(), s = xe(), t = bt(), i = Nt(), u = 1, l = "[object Arguments]", d = "[object Array]", c = "[object Object]", _ = Object.prototype, f = _.hasOwnProperty;
  function m(h, y, p, v, g, M) {
    ...
    if (!(p & u)) {
      var B = T && f.call(h, "__wrapped__"), F = k && f.call(y, "__wrapped__");
      if (B || F) {
        var $ = B ? h.value() : h, x = F ? y.value() : y;
...
function NN() {
  if (Gh) return Ki;
  Gh = 1;
  var e = PN(), a = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, n = /\\(\\)?/g, r = e(function(o) {
    var s = [];
...
function dw() {
  if (ev) return ou;
  ev = 1;
  var e = lo(), a = Pt(), n = xe(), r = no(), o = Zd(), s = Ot();
  function t(i, u, l) {
    u = e(u, i);
...
function FN() {
  if (rv) return iu;
  rv = 1;
  var e = sw(), a = zN(), n = cw(), r = uc(), o = iw(), s = uw(), t = Ot(), i = 1, u = 2;
  function l(d, c) {
...
function WN() {
  if (dv) return pu;
  dv = 1;
  var e = ec(), a = Yt(), n = Pt(), r = xe(), o = Ke(), s = bt(), t = oo(), i = Nt(), u = "[object Map]", l = "[object Set]", d = Object.prototype, c = d.hasOwnProperty;
  function _(f) {
    if (f == null)
      return !0;
...
function rO() {
  if (Yv) return Su;
  Yv = 1;
  var e = ec(), a = Yt(), n = Ke(), r = XN(), o = tO(), s = "[object Map]", t = "[object Set]";
  function i(u) {
    if (u == null)
      return 0;
    if (n(u))
...
function nO() {
  if (wv) return Du;
  wv = 1;
  var e = Xd(), a = XY(), n = sc(), r = Xe(), o = so(), s = xe(), t = bt(), i = Rt(), u = Pe(), l = Nt();
  function d(c, _, f) {
...
function aO() {
  if (xv) return Tu;
  xv = 1;
  var e = Mt(), a = Pt(), n = xe(), r = e ? e.isConcatSpreadable : void 0;
  function o(s) {
...
function mO() {
  if (Pv) return Fu;
  Pv = 1;
  var e = WY(), a = fO(), n = ic(), r = 1 / 0, o = e && 1 / n(new e([, -0]))[1] == r ? function(s) {
    return new e(s);
  } : a;
  return Fu = o, Fu;
}
...
function pO() {
  if (Nv) return Gu;
  Nv = 1;
  var e = nw(), a = cO(), n = _O(), r = aw(), o = mO(), s = ic(), t = 200;
  function i(u, l, d) {
...
function hO() {
  if (zv) return Uu;
  zv = 1;
  var e = lc(), a = _o(), n = pO(), r = Yw(), o = a(function(s) {
    return n(e(s, 1, r, !0));
  });
  return Uu = o, Uu;
}
...
function AO() {
  if (yy) return wl;
  yy = 1;
  var e = CO(), a = Pe(), n = wt(), r = NaN, o = /^[-+]0x[0-9a-f]+$/i, s = /^0b[01]+$/i, t = /^0o[0-7]+$/i, i = parseInt;
  function u(l) {
    if (typeof l == "number")
      return l;
    if (n(l))
...
function Tw() {
  if (gy) return xl;
  gy = 1;
  var e = AO(), a = 1 / 0, n = 17976931348623157e292;
  function r(o) {
    if (!o)
      return o === 0 ? o : 0;
    if (o = e(o), o === a || o === -a) {
...
function UO() {
  if (qy) return Pl;
  qy = 1;
  var e = Hw(), a = OY(), n = KY(), r = zY(), o = ZY(), s = Pt(), t = xe(), i = Yw(), u = bt(), l = Rt(), d = Pe(), c = GO(), _ = Nt(), f = jw(), m = JO();
  function h(y, p, v, g, M, w, L) {
    ...
    if (S) {
      var B = t(Y), F = !B && u(Y), $ = !B && !F && _(Y);
      k = Y, B || F || $ ? t(D) ? k = D : i(D) ? k = r(D) : F ? (S = !1, k = a(Y, !0)) : $ ? (S = !1, k = n(Y, !0)) : k = [] : c(Y) || s(Y) ? (k = D, s(D) ? k = m(D) : (!d(D) || l(D)) && (k = o(Y))) : S = !1;
    }
...
function WO() {
  if (Cy) return Nl;
  Cy = 1;
  var e = eo(), a = Hw(), n = oc(), r = UO(), o = Pe(), s = ct(), t = jw();
...
function KO() {
  if (Ry) return zl;
  Ry = 1;
  var e = WO(), a = VO(), n = a(function(r, o, s) {
    e(r, o, s);
  });
  return zl = n, zl;
}
...
function a3() {
  if (Jy) return Xl;
  Jy = 1;
  var e = r3(), a = n3(), n = a(function(r, o) {
    return r == null ? {} : e(r, o);
  });
  return Xl = n, Xl;
}
...
function c3() {
  if (Qy) return ad;
  Qy = 1;
  var e = uo(), a = co(), n = Xe(), r = hw(), o = u3(), s = ao(), t = d3(), i = _t(), u = xe();
  function l(d, c, _) {
...
function _3() {
  if (eg) return od;
  eg = 1;
  var e = lc(), a = c3(), n = _o(), r = fo(), o = n(function(s, t) {
    if (s == null)
      return [];
    var i = t.length;
...
function M3() {
  if (_g) return vd;
  _g = 1;
  var e = ge(), a = qw(), n = Ga().slack, r = Ga().longestPath, o = ze().alg.preorder, s = ze().alg.postorder, t = qe().simplify;
  ...
  function d(g, M, w) {
    ...
    return T || (Y = !1, T = M.edge(D, w)), k = T.weight, e.forEach(M.nodeEdges(w), function(S) {
      var B = S.v === w, F = B ? S.w : S.v;
      if (F !== D) {
        var $ = B === Y, x = M.edge(S).weight;
        if (k += $ ? x : -x, p(g, w, F)) {
          var j = g.edge(w, F).cutvalue;
          k += $ ? -j : j;
        }
      }
    }), k;
  ...
  function m(g, M, w) {
    ...
    Y.lim > T.lim && (k = T, S = !0);
    var B = e.filter(M.edges(), function(F) {
      return S === v(g, g.node(F.v), k) && S !== v(g, g.node(F.w), k);
    });
    return e.minBy(B, function(F) {
      return n(M, F);
    });
  }
  function h(g, M, w, L) {
...
function b3() {
  if (fg) return yd;
  fg = 1;
  var e = Ga(), a = e.longestPath, n = qw(), r = M3();
  yd = o;
  function o(u) {
...
function q3() {
  if (kg) return Hd;
  kg = 1;
  var e = ge(), a = k3(), n = S3(), r = H3(), o = j3(), s = E3(), t = ze().Graph, i = qe();
  Hd = u;
  function u(_) {
...
function C3() {
  ...
  function r(p, v) {
    ...
    function M(w, L) {
      ...
      return e.forEach(L, function(S, B) {
        var F = s(p, S), $ = F ? p.node(F).order : T;
        (F || S === k) && (e.forEach(L.slice(Y, B + 1), function(x) {
  ...
  function o(p, v) {
    ...
    function M(L, D, Y, T, k) {
      var S;
      e.forEach(e.range(D, Y), function(B) {
        S = L[B], p.node(S).dummy && e.forEach(p.predecessors(S), function(F) {
          var $ = p.node(F);
          $.dummy && ($.order < T || $.order > k) && t(g, F, S);
        });
      });
    }
    function w(L, D) {
      var Y = -1, T, k = 0;
      return e.forEach(D, function(S, B) {
        if (p.node(S).dummy === "border") {
          var F = p.predecessors(S);
          F.length && (T = p.node(F[0]).order, M(D, k, B, Y, T), k = B, Y = T);
        }
    ...
    return e.forEach(v, function(Y) {
      ...
      e.forEach(Y, function(k) {
        ...
        if (S.length) {
          ...
          for (var B = (S.length - 1) / 2, F = Math.floor(B), $ = Math.ceil(B); F <= $; ++F) {
            var x = S[F];
  ...
  function l(p, v, g, M, w) {
    ...
    function T(B, F) {
      for (var $ = D.nodes(), x = $.pop(), j = {}; x; )
        j[x] ? B(x) : (j[x] = !0, $.push(x), $ = $.concat(F(x))), x = $.pop();
    }
    function k(B) {
      L[B] = D.inEdges(B).reduce(function(F, $) {
        return Math.max(F, L[$.v] + D.edge($));
      }, 0);
    }
    function S(B) {
      var F = D.outEdges(B).reduce(function(x, j) {
        return Math.min(x, L[j.w] - D.edge(j));
      }, Number.POSITIVE_INFINITY), $ = p.node(B);
      F !== Number.POSITIVE_INFINITY && $.borderType !== Y && (L[B] = Math.max(L[B], F));
    }
    return T(k, D.predecessors.bind(D)), T(S, D.successors.bind(D)), e.forEach(M, function(B) {
      L[B] = L[g[B]];
    }), L;
  }
  function d(p, v, g, M) {
    ...
    return e.forEach(v, function(Y) {
      ...
      e.forEach(Y, function(k) {
        var S = g[k];
        if (w.setNode(S), T) {
          var B = g[T], F = w.edge(B, S);
          w.setEdge(B, S, Math.max(D(p, k, T), F || 0));
        }
        T = k;
      });
    }), w;
  ...
  function _(p, v) {
    ...
    e.forEach(["u", "d"], function(L) {
      e.forEach(["l", "r"], function(D) {
        ...
        if (T !== v) {
          var S = e.values(T);
          k = D === "l" ? M - e.min(S) : w - e.max(S), k && (p[Y] = e.mapValues(T, function(B) {
            return B + k;
          }));
        }
      });
  ...
  function m(p) {
    ...
    e.forEach(["u", "d"], function(D) {
      w = D === "u" ? v : e.values(v).reverse(), e.forEach(["l", "r"], function(Y) {
        ...
        Y === "r" && (S = e.mapValues(S, function(B) {
          return -B;
        })), M[D + Y] = S;
      });
    });
...
function R3() {
  if (Tg) return qd;
  Tg = 1;
  var e = ge(), a = y3(), n = g3(), r = b3(), o = qe().normalizeRanks, s = Y3(), t = qe().removeEmptyRanks, i = w3(), u = x3(), l = L3(), d = q3(), c = A3(), _ = qe(), f = ze().Graph;
  qd = m;
  function m(C, O) {
  ...
  function T(C) {
    var O = new f({ multigraph: !0, compound: !0 }), U = se(C.graph());
    return O.setGraph(e.merge(
      ...
      var oe = se(C.node(V));
      O.setNode(V, e.defaults(ne(oe, M), w)), O.setParent(V, C.parent(V));
  ...
  function k(C) {
    var O = C.graph();
    O.ranksep /= 2, e.forEach(C.edges(), function(U) {
      var V = C.edge(U);
      V.minlen *= 2, V.labelpos.toLowerCase() !== "c" && (O.rankdir === "TB" || O.rankdir === "BT" ? V.width += V.labeloffset : V.height += V.labeloffset);
    });
  }
  function S(C) {
    e.forEach(C.edges(), function(O) {
      var U = C.edge(O);
      if (U.width && U.height) {
        var V = C.node(O.v), oe = C.node(O.w), ce = { rank: (oe.rank - V.rank) / 2 + V.rank, e: O };
        _.addDummyNode(C, "edge-proxy", ce, "_ep");
      }
    });
  }
  function B(C) {
    ...
    e.forEach(C.nodes(), function(U) {
      var V = C.node(U);
      V.borderTop && (V.minRank = C.node(V.borderTop).rank, V.maxRank = C.node(V.borderBottom).rank, O = e.max(O, V.maxRank));
    }), C.graph().maxRank = O;
  }
  function F(C) {
    e.forEach(C.nodes(), function(O) {
      var U = C.node(O);
      U.dummy === "edge-proxy" && (C.edge(U.e).labelRank = U.rank, C.removeNode(O));
    });
  }
  function $(C) {
    var O = Number.POSITIVE_INFINITY, U = 0, V = Number.POSITIVE_INFINITY, oe = 0, ce = C.graph(), le = ce.marginx || 0, he = ce.marginy || 0;
    function Ae(be) {
    ...
    e.forEach(C.nodes(), function(be) {
      Ae(C.node(be));
    }), e.forEach(C.edges(), function(be) {
      var Se = C.edge(be);
      e.has(Se, "x") && Ae(Se);
    }), O -= le, V -= he, e.forEach(C.nodes(), function(be) {
      var Se = C.node(be);
      Se.x -= O, Se.y -= V;
    }), e.forEach(C.edges(), function(be) {
      var Se = C.edge(be);
  ...
  function x(C) {
    e.forEach(C.edges(), function(O) {
      var U = C.edge(O), V = C.node(O.v), oe = C.node(O.w), ce, le;
  ...
  function z(C) {
    e.forEach(C.nodes(), function(O) {
      if (C.children(O).length) {
        var U = C.node(O), V = C.node(U.borderTop), oe = C.node(U.borderBottom), ce = C.node(e.last(U.borderLeft)), le = C.node(e.last(U.borderRight));
        U.width = Math.abs(le.x - ce.x), U.height = Math.abs(oe.y - V.y), U.x = ce.x + U.width / 2, U.y = V.y + U.height / 2;
      }
    }), e.forEach(C.nodes(), function(O) {
      C.node(O).dummy === "border" && C.removeNode(O);
    });
  }
  function W(C) {
    e.forEach(C.edges(), function(O) {
      if (O.v === O.w) {
        var U = C.node(O.v);
        U.selfEdges || (U.selfEdges = []), U.selfEdges.push({ e: O, label: C.edge(O) }), C.removeEdge(O);
      }
    });
  }
  function Z(C) {
    var O = _.buildLayerMatrix(C);
    e.forEach(O, function(U) {
      var V = 0;
      e.forEach(U, function(oe, ce) {
        var le = C.node(oe);
        le.order = ce + V, e.forEach(le.selfEdges, function(he) {
          _.addDummyNode(C, "selfedge", {
  ...
  function K(C) {
    e.forEach(C.nodes(), function(O) {
      var U = C.node(O);
      if (U.dummy === "selfedge") {
        var V = C.node(U.e.v), oe = V.x + V.width / 2, ce = V.y, le = U.x - oe, he = V.height / 2;
        C.setEdge(U.e, U.label), C.removeNode(O), U.label.points = [
          { x: oe + 2 * le / 3, y: ce - he },
          { x: oe + 5 * le / 6, y: ce - he },
          { x: oe + le, y: ce },
          { x: oe + 5 * le / 6, y: ce + he },
  ...
  function ne(C, O) {
    return e.mapValues(e.pick(C, O), Number);
  }
  function se(C) {
    var O = {};
    return e.forEach(C, function(U, V) {
      O[V.toLowerCase()] = U;
    }), O;
  }
  return qd;
...
var Cw = N3();
const O3 = /* @__PURE__ */ R(Cw), z3 = /* @__PURE__ */ A({
  __proto__: null,
  default: O3
}, [Cw]);
export {
  ...
  lB as BezierEdge,
  bL as BpmnEndEvent,
  OL as BpmnExclusiveGateway,
  XL as BpmnInclusiveGateway,
  JL as BpmnParallelGateway,
  E1 as BpmnProcessEngine,
  HL as BpmnServiceTask,
  ...
  GD as EdgeEditPanel,
  cB as Flow,
  _B as FlowBackground,
  C1 as FlowCollaborationEngine,
  eB as GroupNode,
  Zz as InputNode,
  z1 as Minimap,
  q0 as NodeEditPanel,
  ...
  iB as SmoothEdge,
  uB as StepEdge,
  vz as angleToCanvasCoordinateSystem,
  zz as applyFlowTheme,
  oz as bfs,
  Iz as bpmnXmlToFlow,
  Aa as canvasToScreen,
  w1 as captureElement,
  Hz as clearCustomTypes,
  Rz as clearMemoCache,
  L1 as copyBlobToClipboard,
  Oz as createBpmnEngine,
  Fz as createCollaborationEngine,
  bz as createConnectionValidator,
  Ia as createControlsPlugin,
  go as createCustomTheme,
  Wz as createDefaultPluginSet,
  Oa as createExportPlugin,
  G3 as createFlowContext,
  Pa as createGridPlugin,
  Gg as createHistoryPlugin,
  Bg as createKeyboardPlugin,
  za as createLayoutPlugin,
  Ra as createMiniMapPlugin,
  c1 as createNodeFromTemplate,
  Fg as createNodeGroupPlugin,
  Gz as createPlugin,
  Na as createSnapPlugin,
  qz as debounce,
  Uz as defaultPlugins,
  _z as degToRad,
  u1 as detectCycles,
  sz as dfs,
  K3 as distanceBetweenPoints,
  v1 as exportFlowData,
  nz as findAllPaths,
  az as findConnectedComponents,
  Kz as flowEmits,
  Vz as flowProps,
  Pg as flowTheme,
  q1 as flowThemeDark,
  Bz as flowThemePresets,
  $1 as flowToBpmnXml,
  Ez as generateId,
  Nz as generateSampleBpmnXml,
  d1 as getAllCustomEdges,
  Lz as getAllCustomNodeTemplates,
  Sz as getAllCustomNodes,
  h1 as getAllEdgeTemplates,
  pz as getAngle,
  hz as getAngleBetweenPoints,
  vc as getBezierPath,
  i1 as getBoundingBox,
  l1 as getCustomEdge,
  _1 as getCustomNode,
  Rg as getCustomNodeTemplate,
  o1 as getEdgeCenter,
  Cg as getEdgePath,
  ez as getEdgePosition,
  $z as getEdgeTemplate,
  V3 as getElementCanvasPosition,
  Jw as getElementPosition,
  yt as getHandlePosition,
  mz as getLineIntersection,
  lz as getNodeBounds,
  m1 as getNodeChildren,
  p1 as getNodeParent,
  uz as getRectIntersection,
  a1 as getSmoothStepPath,
  n1 as getStepPath,
  r1 as getStraightPath,
  X3 as getVector,
  Uw as getVectorMagnitude,
  wz as hasCustomEdge,
  Dz as hasCustomNode,
  kz as hasCustomNodeTemplate,
  s1 as hasCycle,
  y1 as importFlowData,
  f1 as isNestedNode,
  yz as isPointInPolygon,
  iz as isPointInRect,
  gc as isValidConnection,
  Az as memo,
  Z3 as normalizeVector,
  dz as pointToLineDistance,
  cz as pointToPointDistance,
  gz as pointToRectDistance,
  W3 as projectNodePosition,
  U3 as provideFlowContext,
  fz as radToDeg,
  Ag as rectIntersect,
  oB as registerAiWorkflowNodes,
  aB as registerBpmnNodes,
  Yz as registerCustomEdge,
  $e as registerCustomNode,
  xz as registerCustomNodeTemplate,
  Tz as registerEdgeTemplate,
  Ht as screenToCanvas,
  tz as shortenEndpoint,
  Ww as snapPositionToGrid,
  hc as snapToGrid,
  Cz as throttle,
  rz as topologicalSort,
  x1 as triggerDownload,
  t1 as useAlignment,
  Xw as useEdges,
  J3 as useFlowContext,
  Qw as useHistory,
  e1 as useKeyboard,
  Q3 as useNodeDistribution,
  Kw as useNodes,
  Zw as useSelection,
  Vw as useViewport,
  Pz as validateBpmnXml,
  Mz as viewportIntersectsBounds,
  Jz as withHooks
};
