...
var W1 = (rt, Be, Ue) =>
  Be in rt
    ? j1(rt, Be, { enumerable: !0, configurable: !0, writable: !0, value: Ue })
    : (rt[Be] = Ue)
var nt = (rt, Be, Ue) => W1(rt, typeof Be != 'symbol' ? Be + '' : Be, Ue)
;(function () {
  'use strict'
  var qo, jo, Wo, Ho, me, J
  class rt {
    constructor() {
      ;((this.listeners = []),
...
` +
  ...
  function Gn(t) {
    if (t instanceof Error) {
      ...
      return {
        ...
        message: n,
        stack: i,
        noTelemetry: pt.isErrorNoTelemetry(t),
        cause: r ? Gn(r) : void 0,
        code: t.code
      }
    }
  ...
  const Jn = 'Canceled'
  function zo(t) {
    return t instanceof li ? !0 : t instanceof Error && t.name === Jn && t.message === Jn
  }
  ...
  ;(function (t) {
    ...
    function h(v, k) {
      let M = 0
      for (const V of v) if (k(V, M++)) return !0
      return !1
    }
    t.some = h
    function f(v, k) {
      let M = 0
      for (const V of v) if (!k(V, M++)) return !1
      return !0
    }
    t.every = f
    function m(v, k) {
      for (const M of v) if (k(M)) return M
    }
    t.find = m
    function* g(v, k) {
      for (const M of v) k(M) && (yield M)
    }
    t.filter = g
    function* d(v, k) {
      let M = 0
      for (const V of v) yield k(V, M++)
    }
    t.map = d
    function* p(v, k) {
      let M = 0
    ...
    t.flatMap = p
    function* y(...v) {
      for (const k of v) Qo(k) ? yield* k : yield k
    }
    t.concat = y
    function w(v, k, M) {
      let V = M
      for (const T of v) V = k(V, T)
      return V
    }
    t.reduce = w
    function N(v) {
    ...
    function* b(v, k, M = v.length) {
      for (
        k < -v.length && (k = 0),
          k < 0 && (k += v.length),
          M < 0 ? (M += v.length) : M > v.length && (M = v.length);
        k < M;
        k++
      )
        yield v[k]
    ...
    async function L(v) {
      const k = []
      for await (const M of v) k.push(M)
      return k
    }
    t.asyncToArray = L
    async function A(v) {
      let k = []
      for await (const M of v) k = k.concat(M)
      return k
    }
    t.asyncToArrayFlat = A
  })(mn || (mn = {}))
  function H1(t, e) {}
  function ci(t) {
    if (mn.is(t)) {
  ...
  const $n = class $n {
    ...
    add(e) {
      if (!e || e === it.None) return e
      if (e === this) throw new Error('Cannot register a disposable on itself!')
      return (
        this._isDisposed
          ? $n.DISABLE_DISPOSED_WARNING ||
            console.warn(
              new Error(
  ...
  const ai = class ai {
    constructor() {
      ;((this._store = new jt()), this._store)
    }
    dispose() {
      this._store.dispose()
    }
      ...
      if (e.prev !== Y.Undefined && e.next !== Y.Undefined) {
        ...
        e.prev === Y.Undefined && e.next === Y.Undefined
          ...
          : e.next === Y.Undefined
            ...
            : e.prev === Y.Undefined &&
              ((this._first = this._first.next), (this._first.prev = Y.Undefined))
      this._size -= 1
    }
    *[Symbol.iterator]() {
      let e = this._first
  ...
  const el = globalThis.performance.now.bind(globalThis.performance)
  class gn {
    static create(e) {
      return new gn(e)
    }
    constructor(e) {
      ;((this._now = e === !1 ? Date.now : el),
  ...
  ;(function (t) {
    t.None = () => it.None
    function e(x, S) {
      return m(x, () => {}, 0, void 0, !0, void 0, S)
    }
    t.defer = e
    function n(x) {
      return (S, C = null, I) => {
        ...
        return (
          (D = x(
            (B) => {
              if (!F) return (D ? D.dispose() : (F = !0), S.call(C, B))
            },
            null,
            I
          )),
    ...
    t.once = n
    function r(x, S) {
      return t.once(t.filter(x, S))
    }
    t.onceIf = r
    function i(x, S, C) {
      return h((I, F = null, D) => x((B) => I.call(F, S(B)), null, D), C)
    }
    t.map = i
    function s(x, S, C) {
      return h(
    ...
    t.forEach = s
    function a(x, S, C) {
      return h((I, F = null, D) => x((B) => S(B) && I.call(F, B), null, D), C)
    }
    t.filter = a
    function o(x) {
      return x
    ...
    function u(...x) {
      return (S, C = null, I) => {
        const F = Zo(...x.map((D) => D((B) => S.call(C, B))))
        return f(F, I)
      }
    }
    t.any = u
    ...
    function h(x, S) {
      ...
      const I = {
        ...
        F = new Ce(I)
      return (S == null || S.add(F), F.event)
    }
    function f(x, S) {
      return (S instanceof Array ? S.push(x) : S && S.add(x), x)
    }
    function m(x, S, C = 100, I = !1, F = !1, D, B) {
      let X,
        z,
        Ae,
        Wn = 0,
      ...
      const B1 = {
          ...
          onWillAddFirstListener() {
            X = x((U1) => {
              ;(Wn++,
                (z = S(z, U1)),
                I && !Ae && (Hn.fire(z), (z = void 0)),
                (dt = () => {
                  const q1 = z
                  ;((z = void 0), (Ae = void 0), (!I || Wn > 1) && Hn.fire(q1), (Wn = 0))
                }),
                typeof C == 'number'
                  ? (Ae && clearTimeout(Ae), (Ae = setTimeout(dt, C)))
                  : Ae === void 0 && ((Ae = null), queueMicrotask(dt)))
            })
          },
    ...
    t.debounce = m
    function g(x, S = 0, C) {
      return t.debounce(x, (I, F) => (I ? (I.push(F), I) : [F]), S, void 0, !0, void 0, C)
    }
    t.accumulate = g
    function d(x, S = (I, F) => I === F, C) {
      let I = !0,
        F
      return a(
        x,
    ...
    t.latch = d
    function p(x, S, C) {
      return [t.filter(x, S, C), t.filter(x, (I) => !S(I), C)]
    }
    t.split = p
    function y(x, S = !1, C = [], I) {
      let F = C.slice(),
        D = x((z) => {
          F ? F.push(z) : X.fire(z)
        })
      I && I.add(D)
      const B = () => {
          ;(F == null || F.forEach((z) => X.fire(z)), (F = null))
        },
        X = new Ce({
          onWillAddFirstListener() {
            D || ((D = x((z) => X.fire(z))), I && I.add(D))
          },
    ...
    class b {
      ...
      forEach(S) {
        return (this.steps.push((C) => (S(C), C)), this)
      }
      filter(S) {
        return (this.steps.push((C) => (S(C) ? C : N)), this)
      }
      reduce(S, C) {
        let I = C
        return (this.steps.push((F) => ((I = S(I, F)), I)), this)
      }
      latch(S = (C, I) => C === I) {
        let C = !0,
          I
      ...
      evaluate(S) {
        for (const C of this.steps) if (((S = C(S)), S === N)) break
        return S
      }
    }
    function _(x, S, C = (I) => I) {
      const I = (...X) => B.fire(C(...X)),
        F = () => x.on(S, I),
        D = () => x.removeListener(S, I),
        B = new Ce({ onWillAddFirstListener: F, onDidRemoveLastListener: D })
      return B.event
    }
    t.fromNodeEventEmitter = _
    function L(x, S, C = (I) => I) {
      const I = (...X) => B.fire(C(...X)),
        F = () => x.addEventListener(S, I),
        D = () => x.removeEventListener(S, I),
        B = new Ce({ onWillAddFirstListener: F, onDidRemoveLastListener: D })
      return B.event
    }
    t.fromDOMEventEmitter = L
    function A(x, S) {
      let C
      const I = new Promise((F, D) => {
        const B = n(x)(F, null, S)
        C = () => B.dispose()
      })
      return ((I.cancel = C), I)
    }
    ...
    class M {
      constructor(S, C) {
        ...
        ;((this.emitter = new Ce(I)), C && C.add(this.emitter))
      }
      beginUpdate(S) {
        this._counter++
      }
    ...
    function V(x, S) {
      return new M(x, S).emitter.event
    }
    t.fromObservable = V
    function T(x) {
      return (S, C, I) => {
        ...
        const B = {
          ...
          endUpdate() {
            ;(F--, F === 0 && (x.reportChanges(), D && ((D = !1), S.call(C))))
          },
        ...
        return (I instanceof jt ? I.add(X) : Array.isArray(I) && I.push(X), X)
      }
    }
  ...
  ;(($t.all = new Set()), ($t._idPool = 0))
  let Qn = $t,
    tl = -1
  const Bn = class Bn {
    constructor(e, n, r = (Bn._idPool++).toString(16).padStart(3, '0')) {
    ...
    check(e, n) {
      ...
      if (
        (this._stacks.set(e.value, i + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)
      ) {
    ...
    getMostFrequentStack() {
      ...
      let e,
        n = 0
      for (const [r, i] of this._stacks) (!e || n < i) && ((e = [r, i]), (n = i))
      return e
    }
  }
  Bn._idPool = 1
...
`)
  ...
  class Ce {
      ...
      ;((this._size = 0),
        ...
        (this._leakageMon =
          (n = this._options) != null && n.leakWarningThreshold
            ? new Zn(
                (e == null ? void 0 : e.onListenerError) ?? Ue,
                ((r = this._options) == null ? void 0 : r.leakWarningThreshold) ?? tl
              )
            : void 0),
        (this._perfMon =
          (i = this._options) != null && i._profName ? new Qn(this._options._profName) : void 0),
    ...
    dispose() {
      ...
      this._disposed ||
        ...
        (r = (n = this._options) == null ? void 0 : n.onDidRemoveLastListener) == null || r.call(n),
        (i = this._leakageMon) == null || i.dispose())
    }
    get event() {
      return (
        this._event ??
          (this._event = (e, n, r) => {
            ...
            if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
              ...
              const p = this._leakageMon.getMostFrequentStack() ?? ['UNKNOWN stack', -1],
                y = new rl(`${d}. HINT: Stack shows most frequent listener (${p[1]}-times)`, p[0])
              return (
                (((o = this._options) == null ? void 0 : o.onListenerError) || Ue)(y),
                it.None
              )
            }
            if (this._disposed) return it.None
            n && (e = e.bind(n))
            const i = new Kn(e)
            let s
            ;(this._leakageMon &&
              this._size >= Math.ceil(this._leakageMon.threshold * 0.2) &&
              ((i.stack = Yn.create()), (s = this._leakageMon.check(i.stack, this._size + 1))),
              this._listeners
                ? this._listeners instanceof Kn
                  ? (this._deliveryQueue ?? (this._deliveryQueue = new sl()),
                    (this._listeners = [this._listeners, i]))
                  : this._listeners.push(i)
                : ((l = (u = this._options) == null ? void 0 : u.onWillAddFirstListener) == null ||
                    l.call(u, this),
                  (this._listeners = i),
                  (f = (h = this._options) == null ? void 0 : h.onDidAddFirstListener) == null ||
                    f.call(h, this)),
              (g = (m = this._options) == null ? void 0 : m.onDidAddListener) == null ||
                g.call(m, this),
              this._size++)
            const a = dn(() => {
              ;(s == null || s(), this._removeListener(i))
            })
            return (r instanceof jt ? r.add(a) : Array.isArray(r) && r.push(a), a)
          }),
        this._event
      )
    }
    _removeListener(e) {
      ...
      if (this._size === 1) {
        ;((this._listeners = void 0),
          (u = (o = this._options) == null ? void 0 : o.onDidRemoveLastListener) == null ||
            u.call(o, this),
          (this._size = 0))
        return
      }
      ...
      if (this._size * il <= n.length) {
        ...
        for (let h = 0; h < n.length; h++)
          n[h]
            ? (n[l++] = n[h])
            : i &&
              l < this._deliveryQueue.end &&
              (this._deliveryQueue.end--, l < this._deliveryQueue.i && this._deliveryQueue.i--)
        n.length = l
      }
    }
    _deliver(e, n) {
      var i
      if (!e) return
      const r = ((i = this._options) == null ? void 0 : i.onListenerError) || Ue
      if (!r) {
        e.value(n)
        return
      }
    ...
    fire(e) {
      ...
      if (
        ((n = this._deliveryQueue) != null &&
          n.current &&
          (this._deliverQueue(this._deliveryQueue), (r = this._perfMon) == null || r.stop()),
        (i = this._perfMon) == null || i.start(this._size),
        this._listeners)
      )
  ...
  function hi(t, e) {
    ...
    return (
      ...
      ol && (n = '［' + n.replace(/[aouei]/g, '$&$&') + '］'),
      n
    )
  }
  function $(t, e, ...n) {
    return hi(typeof t == 'number' ? ll(t, e) : e, n)
  }
  function ll(t, e) {
    var r
    const n = (r = al()) == null ? void 0 : r[t]
    if (typeof n != 'string') {
  ...
  const st = globalThis
  let ae
  typeof st.vscode < 'u' && typeof st.vscode.process < 'u'
    ? (ae = st.vscode.process)
    : typeof process < 'u' &&
      typeof ((qo = process == null ? void 0 : process.versions) == null ? void 0 : qo.node) ==
        'string' &&
      (ae = process)
  const cl =
    typeof ((jo = ae == null ? void 0 : ae.versions) == null ? void 0 : jo.electron) == 'string' &&
    (ae == null ? void 0 : ae.type) === 'renderer'
  if (typeof ae == 'object') {
    ;((er = ae.platform === 'win32'),
      (tr = ae.platform === 'darwin'),
      (nr = ae.platform === 'linux'),
      nr && ae.env.SNAP && ae.env.SNAP_REVISION,
    ...
    if (t)
      try {
        ...
        ;((pn = e.userLocale),
          (mi = e.osLocale),
          (rr = e.resolvedLanguage || bt),
          (ul = (Wo = e.languagePack) == null ? void 0 : Wo.translationsConfigFile))
      } catch {}
  } else
    typeof navigator == 'object' && !cl
      ? ((ke = navigator.userAgent),
        (er = ke.indexOf('Windows') >= 0),
        (tr = ke.indexOf('Macintosh') >= 0),
        (ke.indexOf('Macintosh') >= 0 || ke.indexOf('iPad') >= 0 || ke.indexOf('iPhone') >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (nr = ke.indexOf('Linux') >= 0),
        (ke == null ? void 0 : ke.indexOf('Mobi')) >= 0,
        (rr = fi() || bt),
        (pn = navigator.language.toLowerCase()),
        (mi = pn))
      : console.error('Unable to resolve platform.')
  const Wt = er,
    fl = tr,
    Ie = ke,
    hl = typeof st.postMessage == 'function' && !st.importScripts
  ;(() => {
    if (hl) {
      const t = []
      ...
      return (n) => {
        const r = ++e
        ;(t.push({ id: r, callback: n }), st.postMessage({ vscodeScheduleAsyncWork: r }, '*'))
      }
    }
    return (t) => setTimeout(t)
  })()
  const ml = !!(Ie && Ie.indexOf('Chrome') >= 0)
  ;(Ie && Ie.indexOf('Firefox') >= 0,
    !ml && Ie && Ie.indexOf('Safari') >= 0,
    Ie && Ie.indexOf('Edg/') >= 0,
  ...
  class gl {
    constructor(e, n) {
      ;((this.lastCache = void 0),
        ...
        typeof e == 'function'
          ? ((this._fn = e), (this._computeKey = dl))
  ...
  class ir {
    constructor(e) {
      ;((this.executor = e), (this._state = at.Uninitialized))
    }
    get value() {
      if (this._state === at.Uninitialized) {
        this._state = at.Running
        try {
          this._value = this.executor()
        } catch (e) {
          this._error = e
        } finally {
          this._state = at.Completed
        }
      } else if (this._state === at.Running)
  ...
  function Ll(t, e) {
    ...
    const i = t.length - 1,
      s = e.length - 1
    for (r = 0; r < n; r++) if (t.charCodeAt(i - r) !== e.charCodeAt(s - r)) return r
    return n
  }
  function sr(t) {
  ...
  const $e = class $e {
    static getInstance(e) {
      return $e.cache.get(Array.from(e))
    }
    static getLocales() {
  ...
  ;(($e.ambiguousCharacterData = new ir(() =>
    JSON.parse(
    ...
    ($e.cache = new gl({ getCacheKey: JSON.stringify }, (e) => {
      function n(h) {
        const f = new Map()
      ...
      const s = $e.ambiguousCharacterData.value
    ...
    ($e._locales = new ir(() =>
      Object.keys($e.ambiguousCharacterData.value).filter((e) => !e.startsWith('_'))
    )))
  let Ht = $e
  const Bt = class Bt {
    static getRawData() {
    ...
    static getData() {
      return (
        this._data || (this._data = new Set([...Object.values(Bt.getRawData())].flat())),
        this._data
      )
    }
    static isInvisibleCharacter(e) {
      return Bt.getData().has(e)
    }
  ...
  class Cl {
    ...
    async sendMessage(e, n, r) {
      ...
      return new Promise((s, a) => {
        ;((this._pendingReplies[i] = { resolve: s, reject: a }),
          this._send(new El(this._workerId, i, e, n, r)))
      })
    }
    listen(e, n, r) {
      let i = null
      const s = new Ce({
        onWillAddFirstListener: () => {
          ;((i = String(++this._lastSentReq)),
            ...
            this._send(new Ml(this._workerId, i, e, n, r)))
        },
        onDidRemoveLastListener: () => {
          ;(this._pendingEmitters.delete(i), this._send(new Pl(this._workerId, i)), (i = null))
        }
      })
      return s.event
    }
    ...
    _handleReplyMessage(e) {
      ...
      if ((delete this._pendingReplies[e.seq], e.err)) {
        ...
        if (e.err.$isError) {
          const i = new Error()
          ;((i.name = e.err.name), (i.message = e.err.message), (i.stack = e.err.stack), (r = i))
        }
        n.reject(r)
        return
      }
    ...
    _handleRequestMessage(e) {
      ...
      this._handler.handleMessage(e.channel, e.method, e.args).then(
        (i) => {
          this._send(new gi(this._workerId, n, i, void 0))
        },
        (i) => {
          ;(i.detail instanceof Error && (i.detail = Gn(i.detail)),
            this._send(new gi(this._workerId, n, void 0, Gn(i))))
        }
      )
    }
    _handleSubscribeEventMessage(e) {
      const n = e.req,
        r = this._handler.handleEvent(
          ...
          this._send(new Tl(this._workerId, n, i))
        })
  ...
  function pi(t) {
    return t[0] === 'o' && t[1] === 'n' && di(t.charCodeAt(2))
  }
  function bi(t) {
    return /^onDynamic/.test(t) && di(t.charCodeAt(9))
  }
  class Il {
    constructor(e, n) {
      ;((this._localChannels = new Map()),
        (this._remoteChannels = new Map()),
        (this._protocol = new Cl({
          sendMessage: (r, i) => {
            e(r, i)
          },
    ...
    _handleMessage(e, n, r) {
      if (e === ar && n === Rl) return this.initialize(r[0])
      const i = e === ar ? this.requestHandler : this._localChannels.get(e)
      if (!i) return Promise.reject(new Error(`Missing channel ${e} on worker thread`))
      const s = i[n]
  ...
  let yi = !1
  function Fl(t) {
    if (yi) throw new Error('WebWorker already initialized!')
    yi = !0
    const e = new Il(
  ...
  new ir(() => new Uint8Array(256))
  function wi(t, e) {
    return ((e << 5) - e + t) | 0
  }
  function Vl(t, e) {
    e = wi(149417, e)
    for (let n = 0, r = t.length; n < r; n++) e = wi(t.charCodeAt(n), e)
    return e
  }
  class xi {
    constructor(e) {
  ...
  function Dl(t, e, n) {
    return new Xe(new xi(t), new xi(e)).ComputeDiff(n).changes
  }
  class yt {
    static Assert(e, n) {
  ...
  class Xe {
    constructor(e, n, r = null) {
      ...
      const [i, s, a] = Xe._getElements(e),
        [o, u, l] = Xe._getElements(n)
    ...
    ElementsAreStrictEqual(e, n) {
      ...
      const r = Xe._getStrictElement(this._originalSequence, e),
        i = Xe._getStrictElement(this._modifiedSequence, n)
      return r === i
    }
    ...
    ComputeDiffRecursive(e, n, r, i, s) {
      for (s[0] = !1; e <= n && r <= i && this.ElementsAreEqual(e, r); ) (e++, r++)
      for (; n >= e && i >= r && this.ElementsAreEqual(n, i); ) (n--, i--)
      if (e > n || r > i) {
        let f
        return (
          r <= i
            ? (yt.Assert(e === n + 1, 'originalStart should only be one more than originalEnd'),
              (f = [new Je(e, 0, r, i - r + 1)]))
            : e <= n
              ? (yt.Assert(r === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (f = [new Je(e, n - e + 1, r, 0)]))
              : (yt.Assert(e === n + 1, 'originalStart should only be one more than originalEnd'),
                yt.Assert(r === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
                (f = [])),
          f
      ...
      if (!s[0]) {
        ...
        return (
          s[0]
            ? (m = [new Je(l + 1, n - (l + 1) + 1, h + 1, i - (h + 1) + 1)])
            : (m = this.ComputeDiffRecursive(l + 1, n, h + 1, i, s)),
          this.ConcatenateChanges(f, m)
        )
      }
      return [new Je(e, n - e + 1, r, i - r + 1)]
    }
    WALKTRACE(e, n, r, i, s, a, o, u, l, h, f, m, g, d, p, y, w, N) {
      let b = null,
        _ = null,
        L = new vi(),
        A = n,
      ...
      do {
        ...
        ;(T === A || (T < v && l[T - 1] < l[T + 1])
          ? ((f = l[T + 1]),
            (d = f - k - i),
            f < M && L.MarkNextChange(),
            (M = f),
            L.AddModifiedElement(f + 1, d),
            (k = T + 1 - e))
          : ((f = l[T - 1] + 1),
            (d = f - k - i),
            f < M && L.MarkNextChange(),
            (M = f - 1),
            L.AddOriginalElement(f, d + 1),
            (k = T - 1 - e)),
          V >= 0 && ((l = this.m_forwardHistory[V]), (e = l[0]), (A = 1), (v = l.length - 1)))
      } while (--V >= -1)
      if (((b = L.getReverseChanges()), N[0])) {
        ...
        if (b !== null && b.length > 0) {
          ...
          ;((T = Math.max(T, S.getOriginalEnd())), (x = Math.max(x, S.getModifiedEnd())))
        }
        _ = [new Je(T, m - T + 1, x, p - x + 1)]
      } else {
        ;((L = new vi()),
          (A = a),
          (v = o),
          (k = g[0] - y[0] - u),
          (M = 1073741824),
          (V = w ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2))
        do {
          const T = k + s
          ;(T === A || (T < v && h[T - 1] >= h[T + 1])
            ? ((f = h[T + 1] - 1),
              ...
              f > M && L.MarkNextChange(),
              (M = f + 1),
              L.AddOriginalElement(f + 1, d + 1),
              (k = T + 1 - s))
            : ((f = h[T - 1]),
              (d = f - k - u),
              f > M && L.MarkNextChange(),
              (M = f),
              L.AddModifiedElement(f + 1, d + 1),
              (k = T - 1 - s)),
            V >= 0 && ((h = this.m_reverseHistory[V]), (s = h[0]), (A = 1), (v = h.length - 1)))
        } while (--V >= -1)
        _ = L.getChanges()
      }
    ...
    ComputeRecursionPoint(e, n, r, i, s, a, o) {
      ...
      const d = n - e + (i - r),
        ...
        v = (b - N) % 2 === 0
      ;((y[N] = e), (w[b] = n), (o[0] = !1))
      for (let k = 1; k <= d / 2 + 1; k++) {
        let M = 0,
          V = 0
        ;((h = this.ClipDiagonalBound(N - k, k, N, p)),
          (f = this.ClipDiagonalBound(N + k, k, N, p)))
        for (let x = h; x <= f; x += 2) {
          ;(x === h || (x < f && y[x - 1] < y[x + 1]) ? (u = y[x + 1]) : (u = y[x - 1] + 1),
            (l = u - (x - N) - _))
          const S = u
          ...
          if (
            ((y[x] = u),
            u + l > M + V && ((M = u), (V = l)),
            !v && Math.abs(x - b) <= k - 1 && u >= w[x])
          )
            return (
              (s[0] = u),
              (a[0] = l),
              S <= w[x] && k <= 1448
                ? this.WALKTRACE(N, h, f, _, b, m, g, L, y, w, u, n, s, l, i, a, v, o)
                : null
            )
        }
        const T = (M - e + (V - r) - k) / 2
        if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(M, T))
          return (
            ...
            T > 0 && k <= 1448
              ? this.WALKTRACE(N, h, f, _, b, m, g, L, y, w, u, n, s, l, i, a, v, o)
              : (e++, r++, [new Je(e, n - e + 1, r, i - r + 1)])
          )
        ;((m = this.ClipDiagonalBound(b - k, k, b, p)),
          (g = this.ClipDiagonalBound(b + k, k, b, p)))
        for (let x = m; x <= g; x += 2) {
          ;(x === m || (x < g && w[x - 1] >= w[x + 1]) ? (u = w[x + 1] - 1) : (u = w[x - 1]),
            (l = u - (x - b) - L))
          const S = u
          for (; u > e && l > r && this.ElementsAreEqual(u, l); ) (u--, l--)
          if (((w[x] = u), v && Math.abs(x - N) <= k && u <= y[x]))
            return (
              (s[0] = u),
              (a[0] = l),
              S >= y[x] && k <= 1448
        ...
        if (k <= 1447) {
          ...
          ;((x[0] = N - h + 1),
            wt.Copy2(y, h, x, 1, f - h + 1),
            this.m_forwardHistory.push(x),
            (x = new Int32Array(g - m + 2)),
            (x[0] = b - m + 1),
            wt.Copy2(w, m, x, 1, g - m + 1),
            this.m_reverseHistory.push(x))
        }
      }
      return this.WALKTRACE(N, h, f, _, b, m, g, L, y, w, u, n, s, l, i, a, v, o)
    }
    PrettifyChanges(e) {
      for (let n = 0; n < e.length; n++) {
        const r = e[n],
          i = n < e.length - 1 ? e[n + 1].originalStart : this._originalElementsOrHash.length,
    ...
    ConcatenateChanges(e, n) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
        ...
        return (
          wt.Copy(e, 0, i, 0, e.length - 1),
          (i[e.length - 1] = r[0]),
          wt.Copy(n, 1, i, e.length, n.length - 1),
          i
        )
      } else {
        const i = new Array(e.length + n.length)
        return (wt.Copy(e, 0, i, 0, e.length), wt.Copy(n, 0, i, e.length, n.length), i)
      }
    }
      ...
      static plusRange(e, n) {
        ...
        return (
          n.startLineNumber < e.startLineNumber
            ...
            : n.startLineNumber === e.startLineNumber
              ? ((r = n.startLineNumber), (i = Math.min(n.startColumn, e.startColumn)))
  ...
  class or {
    constructor(e) {
      const n = Li(e)
      ;((this._defaultValue = n), (this._asciiMap = or._createAsciiMap(n)), (this._map = new Map()))
    }
  ...
  function Ul() {
    if (Gt === null) {
      Gt = new or(0)
      const t = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`
      for (let n = 0; n < t.length; n++) Gt.set(t.charCodeAt(n), 1)
      const e = '.,;:'
      for (let n = 0; n < e.length; n++) Gt.set(e.charCodeAt(n), 2)
    }
    return Gt
  }
  class bn {
      ...
      for (let s = 1, a = e.getLineCount(); s <= a; s++) {
        ...
        for (; l < u; ) {
          ...
          if (m === 13) {
            ...
            b === 1 && (i.push(bn._createLink(r, o, s, h, l)), (w = !0))
          } else if (m === 12) {
            let b
            ;(N === 91 ? ((d = !0), (b = 0)) : (b = r.get(N)), b === 1 ? (w = !0) : (m = 13))
          } else ((m = n.nextState(m, N)), m === 0 && (w = !0))
          ;(w && ((m = 1), (g = !1), (d = !1), (y = !1), (h = l + 1), (f = N)), l++)
        }
        m === 13 && i.push(bn._createLink(r, o, s, h, u))
      }
      return i
    }
  }
  ...
  const Un = class Un {
    ...
    valueSetsReplace(e, n, r) {
      let i = null
      for (let s = 0, a = e.length; i === null && s < a; s++) i = this.valueSetReplace(e[s], n, r)
      return i
    }
  ...
  Un.INSTANCE = new Un()
  let ur = Un
  const Ni = Object.freeze(function (t, e) {
  ...
  ;(function (t) {
    function e(n) {
      return n === t.None || n === t.Cancelled || n instanceof wn
        ? !0
        : !n || typeof n != 'object'
          ? !1
    ...
    ;((t.isCancellationToken = e),
      (t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: Xn.None })),
      (t.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: Ni })))
  })(yn || (yn = {}))
  class wn {
    constructor() {
    ...
    get onCancellationRequested() {
      return this._isCancelled
        ? Ni
        : (this._emitter || (this._emitter = new Ce()), this._emitter.event)
    }
    dispose() {
  ...
  class jl {
    ...
    cancel() {
      this._token ? this._token instanceof wn && this._token.cancel() : (this._token = yn.Cancelled)
    }
    dispose(e = !1) {
      var n
      ;(e && this.cancel(),
        (n = this._parentListener) == null || n.dispose(),
        this._token ? this._token instanceof wn && this._token.dispose() : (this._token = yn.None))
    }
  }
  class cr {
    constructor() {
  ...
  ;(function () {
    ...
    for (const i of e) {
      ...
      if ((r[a] || ((r[a] = !0), (Hl[o] = a), (zl[o.toLowerCase()] = a)), !n[u])) {
        if (((n[u] = !0), !l))
          throw new Error(`String representation missing for key code ${u} around scan code ${o}`)
        ;(xn.define(u, l), fr.define(u, m || l), hr.define(u, g || m || l))
      }
      h && (Wl[h] = u)
    }
  })()
  ...
  ;(function (t) {
    ...
    function s(o) {
      return fr.strToKeyCode(o) || hr.strToKeyCode(o)
    }
  ...
  let vt
  const mr = globalThis.vscode
  if (typeof mr < 'u' && typeof mr.process < 'u') {
    const t = mr.process
    vt = {
      get platform() {
        return t.platform
    ...
    typeof process < 'u' &&
    typeof ((Ho = process == null ? void 0 : process.versions) == null ? void 0 : Ho.node) ==
      'string'
      ? (vt = {
          get platform() {
      ...
      : (vt = {
          get platform() {
            return Wt ? 'win32' : fl ? 'darwin' : 'linux'
          },
          get arch() {},
          get env() {
            return {}
  ...
  function tu(t, e) {
    if (t === null || typeof t != 'object') throw new Si(e, 'Object', t)
  }
  function te(t, e) {
    if (typeof t != 'string') throw new Si(e, 'string', t)
  }
  const Qe = Xl === 'win32'
  function q(t) {
    return t === oe || t === de
        ...
        if (!(a === l - 1 || o === 1))
          if (o === 2) {
            if (
              i.length < 2 ||
              s !== 2 ||
              i.charCodeAt(i.length - 1) !== ot ||
              i.charCodeAt(i.length - 2) !== ot
            ) {
              if (i.length > 2) {
                const h = i.lastIndexOf(n)
                ;(h === -1
                  ? ((i = ''), (s = 0))
                  : ((i = i.slice(0, h)), (s = i.length - 1 - i.lastIndexOf(n))),
                  (a = l),
                  (o = 0))
                continue
              } else if (i.length !== 0) {
            ...
            (i.length > 0 ? (i += `${n}${t.slice(a + 1, l)}`) : (i = t.slice(a + 1, l)),
              (s = l - a - 1))
        ;((a = l), (o = 0))
      } else u === ot && o !== -1 ? ++o : (o = -1)
    }
  ...
  const he = {
      resolve(...t) {
        ...
        for (let i = t.length - 1; i >= -1; i--) {
          ...
          if (a === 1) q(h) && ((o = 1), (l = !0))
            ...
            if (((l = !0), q(s.charCodeAt(1)))) {
              let f = 2,
                m = f
              for (; f < a && !q(s.charCodeAt(f)); ) f++
              if (f < a && f !== m) {
                const g = s.slice(m, f)
                for (m = f; f < a && q(s.charCodeAt(f)); ) f++
                if (f < a && f !== m) {
                  for (m = f; f < a && !q(s.charCodeAt(f)); ) f++
                  ;(f === a || f !== m) && ((u = `\\\\${g}\\${s.slice(m, f)}`), (o = f))
                }
              }
            } else o = 1
          else
            je(h) &&
              s.charCodeAt(1) === qe &&
              ((u = s.slice(0, 2)), (o = 2), a > 2 && q(s.charCodeAt(2)) && ((l = !0), (o = 3)))
          if (u.length > 0)
            if (e.length > 0) {
          ...
          if (r) {
            if (e.length > 0) break
          } else if (((n = `${s.slice(o)}\\${n}`), (r = l), l && e.length > 0)) break
        }
        return ((n = Ln(n, !r, '\\', q)), r ? `${e}\\${n}` : `${e}${n}` || '.')
      },
      normalize(t) {
        te(t, 'path')
        const e = t.length
        ...
        if (e === 1) return dr(s) ? '\\' : t
        if (q(s))
          if (((i = !0), q(t.charCodeAt(1)))) {
            let o = 2,
              u = o
            for (; o < e && !q(t.charCodeAt(o)); ) o++
            if (o < e && o !== u) {
              const l = t.slice(u, o)
              for (u = o; o < e && q(t.charCodeAt(o)); ) o++
              if (o < e && o !== u) {
                for (u = o; o < e && !q(t.charCodeAt(o)); ) o++
          ...
          je(s) &&
            t.charCodeAt(1) === qe &&
            ((r = t.slice(0, 2)), (n = 2), e > 2 && q(t.charCodeAt(2)) && ((i = !0), (n = 3)))
        let a = n < e ? Ln(t.slice(n), !i, '\\', q) : ''
        if (
          (a.length === 0 && !i && (a = '.'),
          a.length > 0 && q(t.charCodeAt(e - 1)) && (a += '\\'),
          !i && r === void 0 && t.includes(':'))
        ) {
          if (a.length >= 2 && je(a.charCodeAt(0)) && a.charCodeAt(1) === qe) return `.\\${a}`
          let o = t.indexOf(':')
          do if (o === e - 1 || q(t.charCodeAt(o + 1))) return `.\\${a}`
      ...
      isAbsolute(t) {
        ...
        return q(n) || (e > 2 && je(n) && t.charCodeAt(1) === qe && q(t.charCodeAt(2)))
      },
      join(...t) {
        ...
        if (r) {
          for (; i < e.length && q(e.charCodeAt(i)); ) i++
          i >= 2 && (e = `\\${e.slice(i)}`)
        }
      ...
      relative(t, e) {
        ...
        const n = he.resolve(t),
          r = he.resolve(e)
        if (n === r || ((t = n.toLowerCase()), (e = r.toLowerCase()), t === e)) return ''
        ...
        let g = ''
        for (m = i + f + 1; m <= s; ++m)
          (m === s || t.charCodeAt(m) === de) && (g += g.length === 0 ? '..' : '\\..')
        return (
          (o += f),
          g.length > 0 ? `${g}${r.slice(o, u)}` : (r.charCodeAt(o) === de && ++o, r.slice(o, u))
        )
      },
      toNamespacedPath(t) {
        if (typeof t != 'string' || t.length === 0) return t
        const e = he.resolve(t)
        if (e.length <= 2) return t
        if (e.charCodeAt(0) === de) {
          if (e.charCodeAt(1) === de) {
            const n = e.charCodeAt(2)
            if (n !== eu && n !== ot) return `\\\\?\\UNC\\${e.slice(2)}`
          }
        } else if (je(e.charCodeAt(0)) && e.charCodeAt(1) === qe && e.charCodeAt(2) === de)
          return `\\\\?\\${e}`
        return e
      },
      dirname(t) {
        ...
        if (q(i)) {
          ...
          je(i) && t.charCodeAt(1) === qe && ((n = e > 2 && q(t.charCodeAt(2)) ? 3 : 2), (r = n))
        let s = -1,
          a = !0
        for (let o = e - 1; o >= r; --o)
          if (q(t.charCodeAt(o))) {
      ...
      basename(t, e) {
        ...
        let n = 0,
          ...
          s
        if (
          (t.length >= 2 && je(t.charCodeAt(0)) && t.charCodeAt(1) === qe && (n = 2),
          ...
          for (s = t.length - 1; s >= n; --s) {
            ...
            if (q(u)) {
              ...
              (o === -1 && ((i = !1), (o = s + 1)),
                a >= 0 && (u === e.charCodeAt(a) ? --a === -1 && (r = s) : ((a = -1), (r = o))))
          }
          return (n === r ? (r = o) : r === -1 && (r = t.length), t.slice(n, r))
        }
        for (s = t.length - 1; s >= n; --s)
          if (q(t.charCodeAt(s))) {
            if (!i) {
      ...
      extname(t) {
        ...
        let e = 0,
          ...
          s = !0,
          a = 0
        t.length >= 2 && t.charCodeAt(1) === qe && je(t.charCodeAt(0)) && (e = r = 2)
        for (let o = t.length - 1; o >= e; --o) {
          ...
          ;(i === -1 && ((s = !1), (i = o + 1)),
            u === ot ? (n === -1 ? (n = o) : a !== 1 && (a = 1)) : n !== -1 && (a = -1))
        }
        return n === -1 || i === -1 || a === 0 || (a === 1 && n === i - 1 && n === r + 1)
          ? ''
          : t.slice(n, i)
      },
      format: Ai.bind(null, '\\'),
      parse(t) {
        ...
        let r = 0,
          i = t.charCodeAt(0)
        if (n === 1) return q(i) ? ((e.root = e.dir = t), e) : ((e.base = e.name = t), e)
        if (q(i)) {
          if (((r = 1), q(t.charCodeAt(1)))) {
            let f = 2,
              m = f
            for (; f < n && !q(t.charCodeAt(f)); ) f++
            if (f < n && f !== m) {
              for (m = f; f < n && q(t.charCodeAt(f)); ) f++
              if (f < n && f !== m) {
                for (m = f; f < n && !q(t.charCodeAt(f)); ) f++
                f === n ? (r = f) : f !== m && (r = f + 1)
              }
        ...
        } else if (je(i) && t.charCodeAt(1) === qe) {
    ...
    ge = {
      resolve(...t) {
        ...
        for (let r = t.length - 1; r >= 0 && !n; r--) {
          const i = t[r]
          ;(te(i, `paths[${r}]`),
            i.length !== 0 && ((e = `${i}/${e}`), (n = i.charCodeAt(0) === oe)))
        }
        if (!n) {
          const r = ru()
          ;((e = `${r}/${e}`), (n = r.charCodeAt(0) === oe))
        }
        return ((e = Ln(e, !n, '/', dr)), n ? `/${e}` : e.length > 0 ? e : '.')
      },
      normalize(t) {
      ...
      isAbsolute(t) {
        return (te(t, 'path'), t.length > 0 && t.charCodeAt(0) === oe)
      },
      join(...t) {
        if (t.length === 0) return '.'
        const e = []
      ...
      relative(t, e) {
        ...
        if (l === o)
          if (a > o) {
            if (e.charCodeAt(s + l) === oe) return e.slice(s + l + 1)
            if (l === 0) return e.slice(s + l)
          } else i > o && (t.charCodeAt(n + l) === oe ? (u = l) : l === 0 && (u = 0))
        let h = ''
        for (l = n + u + 1; l <= r; ++l)
          (l === r || t.charCodeAt(l) === oe) && (h += h.length === 0 ? '..' : '/..')
      ...
      extname(t) {
        ...
        for (let a = t.length - 1; a >= 0; --a) {
          ...
          ;(r === -1 && ((i = !1), (r = a + 1)),
            o === '.' ? (e === -1 ? (e = a) : s !== 1 && (s = 1)) : e !== -1 && (s = -1))
        }
        return e === -1 || r === -1 || s === 0 || (s === 1 && e === r - 1 && e === n + 1)
          ? ''
          : t.slice(e, r)
      },
      format: Ai.bind(null, '/'),
      parse(t) {
        ...
        for (; u >= r; --u) {
          ...
          ;(a === -1 && ((o = !1), (a = u + 1)),
            h === ot ? (i === -1 ? (i = u) : l !== 1 && (l = 1)) : i !== -1 && (l = -1))
        }
        if (a !== -1) {
          const h = s === 0 && n ? 1 : s
          i === -1 || l === 0 || (l === 1 && i === a - 1 && i === s + 1)
            ? (e.base = e.name = t.slice(h, a))
            : ((e.name = t.slice(h, i)), (e.base = t.slice(h, a)), (e.ext = t.slice(i, a)))
        }
  ...
  ;((ge.win32 = he.win32 = he),
    (ge.posix = he.posix = ge),
    Qe ? he.normalize : ge.normalize,
    Qe ? he.resolve : ge.resolve,
    Qe ? he.relative : ge.relative,
    Qe ? he.dirname : ge.dirname,
    Qe ? he.basename : ge.basename,
    Qe ? he.extname : ge.extname,
    Qe ? he.sep : ge.sep)
  const iu = /^\w[\w\d+.-]*$/,
    su = /^\//,
    au = /^\/\//
  ...
  let gr = class zn {
    ...
    static parse(e, n = !1) {
      const r = cu.exec(e)
      return r
        ? new Lt(r[2] || Z, Nn(r[4] || Z), Nn(r[5] || Z), Nn(r[7] || Z), Nn(r[9] || Z), n)
        : new Lt(Z, Z, Z, Z, Z)
    }
    static file(e) {
      let n = Z
      if ((Wt && (e = e.replace(/\\/g, Re)), e[0] === Re && e[1] === Re)) {
        const r = e.indexOf(Re, 2)
        r === -1
          ? ((n = e.substring(2)), (e = Re))
          : ((n = e.substring(2, r)), (e = e.substring(r) || Re))
      }
      return new Lt('file', n, e, Z, Z)
    }
    static from(e, n) {
      return new Lt(e.scheme, e.authority, e.path, e.query, e.fragment, n)
    }
    static joinPath(e, ...n) {
      ...
      return (
        Wt && e.scheme === 'file'
          ? (r = zn.file(he.join(pr(e, !0), ...n)).path)
          : (r = ge.join(e.path, ...n)),
        e.with({ path: r })
      )
    }
      ...
      if (e) {
        if (e instanceof zn) return e
        {
          ...
          return (
            ...
            (n._fsPath = e._sep === ki ? (e.fsPath ?? null) : null),
            n
          )
        }
      } else return e
  ...
  class Lt extends gr {
    ...
    toString(e = !1) {
      return e
        ? br(this, !0)
        : (this._formatted || (this._formatted = br(this, !1)), this._formatted)
    }
    toJSON() {
      const e = { $mid: 1 }
      return (
        this._fsPath && ((e.fsPath = this._fsPath), (e._sep = ki)),
  ...
  function Ei(t, e, n) {
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      if (
        ...
        const o = Ri[a]
        o !== void 0
          ? (i !== -1 && ((r += encodeURIComponent(t.substring(i, s))), (i = -1)), (r += o))
          : i === -1 && (i = s)
      }
    }
  ...
  function fu(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const r = t.charCodeAt(n)
      r === 35 || r === 63
        ? (e === void 0 && (e = t.substr(0, n)), (e += Ri[r]))
        : e !== void 0 && (e += t[n])
    }
    return e !== void 0 ? e : t
  }
    ...
    if ((i && ((r += i), (r += ':')), (s || i === 'file') && ((r += Re), (r += Re)), s)) {
      ...
      if (l !== -1) {
        ...
        ;((s = s.substr(l + 1)),
          ...
          l === -1
            ? (r += n(h, !1, !1))
            : ((r += n(h.substr(0, l), !1, !1)), (r += ':'), (r += n(h.substr(l + 1), !1, !0))),
          (r += '@'))
      }
      ;((s = s.toLowerCase()),
        (l = s.lastIndexOf(':')),
  ...
  function Mi(t) {
    try {
      ...
      return t.length > 3 ? t.substr(0, 3) + Mi(t.substr(3)) : t
    }
  }
  const Ti = /(%[0-9A-Za-z][0-9A-Za-z])+/g
  function Nn(t) {
    return t.match(Ti) ? t.replace(Ti, (e) => Mi(e)) : t
  }
  class be extends U {
    constructor(e, n, r, i) {
      ;(super(e, n, r, i),
    ...
    static fromRange(e, n) {
      return n === 0
        ...
        : new be(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn)
    }
    ...
    static selectionsArrEqual(e, n) {
      ...
      for (let r = 0, i = e.length; r < i; r++) if (!this.selectionsEqual(e[r], n[r])) return !1
      return !0
    }
  ...
  class du {
    ...
    registerFactory(e, n) {
      var i
      ;(i = this._factories.get(e)) == null || i.dispose()
      const r = new gu(this, e, n)
      return (
  ...
  ;(function (t) {
    ...
    function n(a) {
      let o = e.get(a)
      return (
        o || (console.info('No codicon found for CompletionItemKind ' + a), (o = O.symbolProperty)),
        o
      )
    }
    t.toIcon = n
  ...
  ;(function (t) {
    ...
    function n(s) {
      let a = e.get(s)
      return (
        a || (console.info('No codicon found for SymbolKind ' + s), (a = O.symbolProperty)),
        a
      )
    }
    t.toIcon = n
  ...
  let G1 =
    ...
    (me.Comment = new me('comment')),
    (me.Imports = new me('imports')),
    (me.Region = new me('region')),
    me)
  var qi
  ;(function (t) {
  ...
  function Su(t, e, n, r, i) {
    return Nu(t, e, n, r, i) && _u(t, e, n, r, i)
  }
  class Au {
    constructor(e, n) {
    ...
    next(e) {
      ...
      do {
        ...
        if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            Sl(e, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Su(this._wordSeparators, e, n, i, s))
        )
          return r
      } while (r)
      return null
  ...
  function Ru(t = '') {
    let e = '(-?\\d*\\.\\d\\w*)|([^'
    for (const n of ku) t.indexOf(n) >= 0 || (e += '\\' + n)
  ...
  const js = new Ko()
  js.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
  function Nr(t, e, n, r, i) {
    if (((e = qs(e)), i || (i = mn.first(js)), n.length > i.maxLen)) {
      let l = t - i.maxLen / 2
      return (l < 0 ? (l = 0) : (r += l), (n = n.substring(l, t + i.maxLen / 2)), Nr(t, e, n, r, i))
    }
    const s = Date.now(),
      a = t - 1 - r
    let o = -1,
  ...
  class Mu {
    static computeUnicodeHighlights(e, n, r) {
      ...
      o === 'allNonBasicAscii'
        ? (u = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
        : (u = new RegExp(`${Tu(Array.from(o))}`, 'g'))
      const l = new Au(null, u),
        h = []
      let f = !1,
        m,
        g = 0,
        d = 0,
        p = 0
      e: for (let y = i, w = s; y <= w; y++) {
        const N = e.getLineContent(y),
          b = N.length
        l.reset(0)
        do
          if (((m = l.next(N)), m)) {
            ...
            const A = N.substring(_, L)
            let v = Nr(_ + 1, Us, N, 0)
            v && v.endColumn <= _ + 1 && (v = null)
            const k = a.shouldHighlightNonBasicASCII(A, v ? v.word : null)
            if (k !== 0) {
              if ((k === 3 ? g++ : k === 2 ? d++ : k === 1 ? p++ : Go(), h.length >= 1e3)) {
                f = !0
                break e
              }
              h.push(new U(y, _ + 1, y, L + 1))
            }
          }
        while (m)
      }
      ...
      switch (r.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const s = e.codePointAt(0),
            ...
            o = Ht.getLocales().filter(
              (u) => !Ht.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(s)
            )
  ...
  function Tu(t, e) {
    return `[${pl(t.map((r) => String.fromCodePoint(r)).join(''))}]`
  }
  class Ws {
    constructor(e) {
      ;((this.options = e),
        (this.allowedCodePoints = new Set(e.allowedCodePoints)),
        (this.ambiguousCharacters = Ht.getInstance(new Set(e.allowedLocales))))
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return 'allNonBasicAscii'
      const e = new Set()
      if (this.options.invisibleCharacters)
        for (const n of zt.codePoints) Hs(String.fromCodePoint(n)) || e.add(n)
        ...
        for (const a of n) {
          ...
          ;((i = i || u),
            !u &&
              ...
              !zt.isInvisibleCharacter(o) &&
              (s = !0))
        }
      return !i && s
        ? 0
        : this.options.invisibleCharacters && !Hs(e) && zt.isInvisibleCharacter(r)
          ? 2
...
` ||
  ...
  function* Iu(t, e) {
    let n, r
    for (const i of t) (r !== void 0 && e(r, i) ? n.push(i) : (n && (yield n), (n = [i])), (r = i))
    n && (yield n)
  }
  function Fu(t, e) {
    for (let n = 0; n <= t.length; n++)
  ...
  const qt = class qt {
    ...
    filter(e) {
      return new qt((n) => this.iterate((r) => (e(r) ? n(r) : !0)))
    }
    map(e) {
      return new qt((n) => this.iterate((r) => n(e(r))))
    }
    findLast(e) {
      let n
    ...
    findLastMaxBy(e) {
      let n,
        r = !0
      return (this.iterate((i) => ((r || _r.isGreaterThan(e(i, n))) && ((r = !1), (n = i)), !0)), n)
    }
  }
  qt.empty = new qt((e) => {})
  let zs = qt
  class j {
    ...
    join(e) {
      return new j(Math.min(this.start, e.start), Math.max(this.endExclusive, e.endExclusive))
    }
    intersect(e) {
  ...
  function _t(t, e, n = 0, r = t.length) {
    let i = n,
      s = r
    for (; i < s; ) {
  ...
  function Sr(t, e, n = 0, r = t.length) {
    let i = n,
      s = r
    for (; i < s; ) {
      const a = Math.floor((i + s) / 2)
  ...
  const qn = class qn {
    ...
    findLastMonotonous(e) {
      ...
      const n = _t(this._array, e, this._findLastMonotonousLastIdx)
  ...
  const ve = class ve {
    ...
    static joinMany(e) {
      ...
      let n = new Fe(e[0].slice())
      for (let r = 1; r < e.length; r++) n = n.getUnion(new Fe(e[r].slice()))
      return n.ranges
    }
    static join(e) {
    ...
    toInclusiveRange() {
      return this.isEmpty
        ? null
        : new U(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
    }
    toExclusiveRange() {
    ...
    mapToLineArray(e) {
      const n = []
      for (let r = this.startLineNumber; r < this.endLineNumberExclusive; r++) n.push(e(r))
      return n
    }
    forEach(e) {
  ...
  ve.compareByStart = Jt((e) => e.startLineNumber, Xt)
  let H = ve
  class Fe {
    constructor(e = []) {
    ...
    addRange(e) {
      if (e.length === 0) return
      const n = Sr(this._normalizedRanges, (i) => i.endLineNumberExclusive >= e.startLineNumber),
        r = _t(this._normalizedRanges, (i) => i.startLineNumber <= e.endLineNumberExclusive) + 1
    ...
    contains(e) {
      const n = Nt(this._normalizedRanges, (r) => r.startLineNumber <= e)
      return !!n && n.endLineNumberExclusive > e
    }
    intersects(e) {
      const n = Nt(this._normalizedRanges, (r) => r.startLineNumber < e.endLineNumberExclusive)
    ...
    subtractFrom(e) {
      const n = Sr(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber),
        r = _t(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1
      if (n === r) return new Fe([e])
      const i = []
      ...
      return (s < e.endLineNumberExclusive && i.push(new H(s, e.endLineNumberExclusive)), new Fe(i))
    }
    toString() {
    ...
    getWithDelta(e) {
      return new Fe(this._normalizedRanges.map((n) => n.delta(e)))
    }
  }
  const Pe = class Pe {
    static betweenPositions(e, n) {
      return e.lineNumber === n.lineNumber
        ? new Pe(0, n.column - e.column)
        : new Pe(n.lineNumber - e.lineNumber, n.column - 1)
    }
...
`
    ...
    add(e) {
      return e.lineCount === 0
        ? new Pe(this.lineCount, this.columnCount + e.columnCount)
        : new Pe(this.lineCount + e.lineCount, e.columnCount)
    }
    createRange(e) {
      return this.lineCount === 0
        ? new U(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount)
        : new U(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1)
    }
    toRange() {
  ...
  class Bu {
    ...
    getStringReplacement(e) {
      return new St.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
    }
    getTextReplacement(e) {
      return new St.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
    }
    getTextEdit(e) {
      const n = e.replacements.map((r) => this.getTextReplacement(r))
      return new St.deps.TextEdit(n)
    }
  }
  const oi = class oi {
    static get deps() {
...
` &&
    ...
    getPosition(e) {
      const n = _t(this.lineStartOffsetByLineIdx, (s) => s <= e),
        r = n + 1,
    ...
    get textLength() {
      ...
      return new St.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
    }
    getLineLength(e) {
  ...
  class qu {
    ...
    getTransformer() {
      return (this._transformer || (this._transformer = new Uu(this.getValue())), this._transformer)
    }
    getLineAt(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1)),
    ...
    get length() {
      ...
      return new Qt(this._lineCount - 1, e.length)
    }
  }
  class An extends ju {
    constructor(e) {
  ...
  class Ze {
    static joinReplacements(e, n) {
      ...
      return new Ze(U.fromPositions(r, i), s)
    }
    static fromStringReplacement(e, n) {
      return new Ze(n.getTransformer().getRange(e.replaceRange), e.newText)
    }
    static delete(e) {
      return new Ze(e, '')
    }
...
`
        ...
        i = vl(n, r),
        s = Qt.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()),
        a = r.substring(i),
        o = U.fromPositions(s, this.range.getEndPosition())
      return new Ze(o, a)
    }
...
`
        ...
        i = Ll(n, r),
        s = Qt.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()),
        a = r.substring(0, r.length - i),
        o = U.fromPositions(this.range.getStartPosition(), s)
      return new Ze(o, a)
    }
    toString() {
  ...
  class Le {
    static inverse(e, n, r) {
      ...
      let s = 1,
        a = 1
      for (const u of e) {
        const l = new Le(new H(s, u.original.startLineNumber), new H(a, u.modified.startLineNumber))
    ...
    join(e) {
      return new Le(this.original.join(e.original), this.modified.join(e.modified))
    }
    toRangeMapping() {
      ...
      if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
        ...
        return new Ne(
          new U(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new U(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1)
        )
      } else
        return new Ne(
          new U(
      ...
      if (!this.original.isEmpty && !this.modified.isEmpty)
        return new Ne(
          U.fromPositions(
            ...
            At(new Q(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          U.fromPositions(
            new Q(this.modified.startLineNumber, 1),
            At(new Q(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
        return new Ne(
          U.fromPositions(
            At(new Q(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e),
            At(new Q(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          U.fromPositions(
            At(new Q(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
            At(new Q(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      throw new ue()
  ...
  function At(t, e) {
    ...
    if (t.lineNumber > e.length) return new Q(e.length, e[e.length - 1].length + 1)
  ...
  class Ne {
    ...
    static assertSorted(e) {
      for (let n = 1; n < e.length; n++) {
        ...
        if (
          !(
            r.originalRange.getEndPosition().isBeforeOrEqual(i.originalRange.getStartPosition()) &&
  ...
  function Js(t, e, n, r = !1) {
    const i = []
    for (const s of Iu(
      t.map((a) => Wu(a, e, n)),
      (a, o) =>
        a.original.intersectsOrTouches(o.original) || a.modified.intersectsOrTouches(o.modified)
    )) {
      const a = s[0],
        o = s[s.length - 1]
      i.push(
    ...
    return (
      hn(() =>
        ...
        (i[0].modified.startLineNumber !== i[0].original.startLineNumber ||
          n.length.lineCount - i[i.length - 1].modified.endLineNumberExclusive !==
            e.length.lineCount - i[i.length - 1].original.endLineNumberExclusive)
          ? !1
          : ui(
              i,
              (s, a) =>
  ...
  function Wu(t, e, n) {
    ...
    ;(t.modifiedRange.endColumn === 1 &&
      ...
      t.modifiedRange.startColumn - 1 >= n.getLineLength(t.modifiedRange.startLineNumber) &&
        ...
        (r = 1))
    const s = new H(t.originalRange.startLineNumber + r, t.originalRange.endLineNumber + 1 + i),
      a = new H(t.modifiedRange.startLineNumber + r, t.modifiedRange.endLineNumber + 1 + i)
    return new We(s, a, [t])
  }
  const Hu = 3
  class zu {
    computeDiff(e, n, r) {
      ...
      for (const l of s.changes) {
        ...
        l.originalEndLineNumber === 0
          ? (h = new H(l.originalStartLineNumber + 1, l.originalStartLineNumber + 1))
          : (h = new H(l.originalStartLineNumber, l.originalEndLineNumber + 1))
        let f
        l.modifiedEndLineNumber === 0
          ? (f = new H(l.modifiedStartLineNumber + 1, l.modifiedStartLineNumber + 1))
          : (f = new H(l.modifiedStartLineNumber, l.modifiedEndLineNumber + 1))
        let m = new We(
          h,
          f,
          (u = l.charChanges) == null
            ? void 0
            : u.map(
                (g) =>
                  new Ne(
        ...
        ;(o &&
          (o.modified.endLineNumberExclusive === m.modified.startLineNumber ||
            o.original.endLineNumberExclusive === m.original.startLineNumber) &&
          ((m = new We(
      ...
      return (
        hn(() =>
          ui(
            a,
            (l, h) =>
              h.original.startLineNumber - l.original.endLineNumberExclusive ===
                h.modified.startLineNumber - l.modified.endLineNumberExclusive &&
              l.original.endLineNumberExclusive < h.original.startLineNumber &&
              l.modified.endLineNumberExclusive < h.modified.startLineNumber
          )
        ),
        new _n(a, [], s.quitEarly)
      )
    }
  }
  function Xs(t, e, n, r) {
    return new Xe(t, e, n).ComputeDiff(r)
  }
  let Qs = class {
    constructor(e) {
      const n = [],
        r = []
      for (let i = 0, s = e.length; i < s; i++) ((n[i] = Ar(e[i], 1)), (r[i] = kr(e[i], 1)))
    ...
    createCharSequence(e, n, r) {
      ...
      for (let u = n; u <= r; u++) {
        ...
        for (let m = h; m < f; m++) ((i[o] = l.charCodeAt(m - 1)), (s[o] = u + 1), (a[o] = m), o++)
        !e && u < r && ((i[o] = 10), (s[o] = u + 1), (a[o] = l.length + 1), o++)
      }
      return new Gu(i, s, a)
    }
  }
  ...
  class Zt {
    ...
    static createFromDiffResult(e, n, r, i, s, a, o) {
      ...
      if (
        ...
        const g = r.createCharSequence(e, n.originalStart, n.originalStart + n.originalLength - 1),
          d = i.createCharSequence(e, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1)
        if (g.getElements().length > 0 && d.getElements().length > 0) {
          let p = Xs(g, d, s, !0).changes
          ;(o && (p = Ju(p)), (m = []))
          for (let y = 0, w = p.length; y < w; y++) m.push(kt.createFromDiffChange(p[y], g, d))
        }
      }
  ...
  class Xu {
    constructor(e, n, r) {
      ;((this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.original = new Qs(e)),
        (this.modified = new Qs(n)),
        (this.continueLineDiff = Zs(r.maxComputationTime)),
        (this.continueCharDiff = Zs(
    ...
    computeDiff() {
      ...
      const e = Xs(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
        n = e.changes,
        r = e.quitEarly
          ...
          if (m !== g) {
            ...
            }
            {
              ...
              const y = m.length + 1,
                w = g.length + 1
              for (; d < y && p < w; ) {
                const N = m.charCodeAt(d - 1),
                  b = m.charCodeAt(p - 1)
                if (N !== b) break
                ;(d++, p++)
              }
              ;(d < y || p < w) && this._pushTrimWhitespaceCharChange(i, s + 1, d, y, a + 1, p, w)
            }
          }
          ;(s++, a++)
        }
    ...
    _pushTrimWhitespaceCharChange(e, n, r, i, s, a, o) {
      ...
      let u
      ;(this.shouldComputeCharChanges && (u = [new kt(n, r, n, i, s, a, s, o)]),
    ...
    _mergeTrimWhitespaceCharChange(e, n, r, i, s, a, o) {
      ...
      return l.originalEndLineNumber === 0 || l.modifiedEndLineNumber === 0
        ...
        : l.originalEndLineNumber === n && l.modifiedEndLineNumber === s
          ? (this.shouldComputeCharChanges &&
              l.charChanges &&
              l.charChanges.push(new kt(n, r, n, i, s, a, s, o)),
            !0)
  ...
  class He {
    static trivial(e, n) {
      return new He([new K(j.ofLength(e.length), j.ofLength(n.length))], !1)
    }
    static trivialTimedOut(e, n) {
      return new He([new K(j.ofLength(e.length), j.ofLength(n.length))], !0)
    }
    constructor(e, n) {
    ...
    static invert(e, n) {
      ...
      return (
        Fu(e, (i, s) => {
          r.push(
            K.fromOffsetPairs(
              i ? i.getEndExclusives() : ze.zero,
              s
                ? s.getStarts()
                : new ze(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n)
            )
          )
        }),
        r
  ...
  const ht = class ht {
    ...
    delta(e) {
      return e === 0 ? this : new ht(this.offset1 + e, this.offset2 + e)
    }
    equals(e) {
...
`)
    ...
    computeSimilarity(e) {
      ...
      for (let i = 0; i < r; i++) n += Math.abs((this.histogram[i] ?? 0) - (e.histogram[i] ?? 0))
  ...
  let kn = cn
  class Zu {
    compute(e, n, r = Yt.instance, i) {
      if (e.length === 0 || n.length === 0) return He.trivial(e, n)
      const s = new Rr(e.length, n.length),
        a = new Rr(e.length, n.length),
        o = new Rr(e.length, n.length)
      for (let d = 0; d < e.length; d++)
        for (let p = 0; p < n.length; p++) {
          if (!r.isValid()) return He.trivialTimedOut(e, n)
          const y = d === 0 ? 0 : s.get(d - 1, p),
            w = p === 0 ? 0 : s.get(d, p - 1)
          let N
          e.getElement(d) === n.getElement(p)
            ? (d === 0 || p === 0 ? (N = 0) : (N = s.get(d - 1, p - 1)),
              d > 0 && p > 0 && a.get(d - 1, p - 1) === 3 && (N += o.get(d - 1, p - 1)),
              (N += i ? i(d, p) : 1))
            : (N = -1)
          const b = Math.max(y, w, N)
          if (b === N) {
            const _ = d > 0 && p > 0 ? o.get(d - 1, p - 1) : 0
            ;(o.set(d, p, _ + 1), a.set(d, p, 3))
          } else
            b === y ? (o.set(d, p, 0), a.set(d, p, 1)) : b === w && (o.set(d, p, 0), a.set(d, p, 2))
          s.set(d, p, b)
        }
      const u = []
      let l = e.length,
        h = n.length
      function f(d, p) {
        ;((d + 1 !== l || p + 1 !== h) && u.push(new K(new j(d + 1, l), new j(p + 1, h))),
          (l = d),
          (h = p))
      }
      let m = e.length - 1,
      ...
      return (f(-1, -1), u.reverse(), new He(u, !1))
    }
  }
  class Ys {
    compute(e, n, r = Yt.instance) {
      if (e.length === 0 || n.length === 0) return He.trivial(e, n)
      const i = e,
        s = n
      function a(p, y) {
        for (; p < i.length && y < s.length && i.getElement(p) === s.getElement(y); ) (p++, y++)
        return p
      }
      let o = 0
      const u = new Yu()
      u.set(0, a(0, 0))
      const l = new Ku()
      l.set(0, u.get(0) === 0 ? null : new Ks(null, 0, 0, u.get(0)))
      let h = 0
      e: for (;;) {
        if ((o++, !r.isValid())) return He.trivialTimedOut(i, s)
        const p = -Math.min(o, s.length + (o % 2)),
          y = Math.min(o, i.length + (o % 2))
        for (h = p; h <= y; h += 2) {
          const w = h === y ? -1 : u.get(h + 1),
            N = h === p ? -1 : u.get(h - 1) + 1,
            b = Math.min(Math.max(w, N), i.length),
            _ = b - h
          if (b > i.length || _ > s.length) continue
          const L = a(b, _)
          u.set(h, L)
          const A = b === w ? l.get(h + 1) : l.get(h - 1)
          if (
            (l.set(h, L !== b ? new Ks(A, b, _, L - b) : A),
      ...
      for (;;) {
        const p = f ? f.x + f.length : 0,
          y = f ? f.y + f.length : 0
        if (((p !== g || y !== d) && m.push(new K(new j(p, g), new j(y, d))), !f)) break
  ...
  class Rn {
    ...
    getBoundaryScore(e) {
      const n = na(e > 0 ? this.elements[e - 1] : -1),
        r = na(e < this.elements.length ? this.elements[e] : -1)
      if (n === 7 && r === 8) return 0
      if (n === 8) return 150
      let i = 0
      return (n !== r && ((i += 10), n === 0 && r === 1 && (i += 1)), (i += ta(n)), (i += ta(r)), i)
    }
    translateOffset(e, n = 'right') {
      const r = _t(this.firstElementOffsetByLineIdx, (s) => s <= e),
    ...
    translateRange(e) {
      ...
      return r.isBefore(n) ? U.fromPositions(r, r) : U.fromPositions(n, r)
    }
    findWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !Rt(this.elements[e])) return
      let n = e
      for (; n > 0 && Rt(this.elements[n - 1]); ) n--
      let r = e
      for (; r < this.elements.length && Rt(this.elements[r]); ) r++
      return new j(n, r)
    }
    findSubWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !Rt(this.elements[e])) return
      let n = e
      for (; n > 0 && Rt(this.elements[n - 1]) && !ea(this.elements[n]); ) n--
      let r = e
      for (; r < this.elements.length && Rt(this.elements[r]) && !ea(this.elements[r]); ) r++
      return new j(n, r)
    }
    countLinesIn(e) {
      return (
    ...
    extendToFullLines(e) {
      const n = Nt(this.firstElementOffsetByLineIdx, (i) => i <= e.start) ?? 0,
        r = $u(this.firstElementOffsetByLineIdx, (i) => e.endExclusive <= i) ?? this.elements.length
      return new j(n, r)
    }
  }
  function Rt(t) {
  ...
  const ec = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
  function ta(t) {
    return ec[t]
  }
  function na(t) {
  ...
  function tc(t, e, n, r, i, s) {
    let { moves: a, excludedChanges: o } = rc(t, e, n, s)
    if (!s.isValid()) return []
...
`).length >= 15 && nc(f, (g) => g.length >= 2) >= 2
  ...
  function rc(t, e, n, r) {
    const i = [],
      s = t
        ...
        .map((u) => new kn(u.original, e, u)),
      a = new Set(
        t
          .filter((u) => u.original.isEmpty && u.modified.length >= 3)
          .map((u) => new kn(u.modified, n, u))
      ),
      o = new Set()
    for (const u of s) {
      let l = -1,
      ...
      if (
        (l > 0.9 &&
          h &&
          (a.delete(h), i.push(new Le(u.range, h.range)), o.add(u.source), o.add(h.source)),
        !r.isValid())
      )
  ...
  function ic(t, e, n, r, i, s) {
    ...
    const u = []
    t.sort(Jt((m) => m.modified.startLineNumber, Xt))
    for (const m of t) {
      let g = []
      for (let d = m.modified.startLineNumber; d < m.modified.endLineNumberExclusive - 2; d++) {
        ...
        ;(o.forEach(p, ({ range: N }) => {
          for (const _ of g)
            if (
              _.originalLineRange.endLineNumberExclusive + 1 === N.endLineNumberExclusive &&
              _.modifiedLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive
            ) {
          ...
          const b = { modifiedLineRange: y, originalLineRange: N }
          ;(u.push(b), w.push(b))
        }),
          (g = w))
      }
    ...
    u.sort(Ou(Jt((m) => m.modifiedLineRange.length, Xt)))
    const l = new Fe(),
      h = new Fe()
    for (const m of u) {
      const g = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber,
        d = l.subtractFrom(m.modifiedLineRange),
        p = h.subtractFrom(m.originalLineRange).getWithDelta(g),
        y = d.getIntersection(p)
      for (const w of y.ranges) {
        if (w.length < 3) continue
        const N = w,
          b = w.delta(-g)
        ;(a.push(new Le(b, N)), l.addRange(N), h.addRange(b))
      }
    }
    a.sort(Jt((m) => m.original.startLineNumber, Xt))
    const f = new Sn(t)
    for (let m = 0; m < a.length; m++) {
      const g = a[m],
        d = f.findLastMonotonous((A) => A.original.startLineNumber <= g.original.startLineNumber),
        p = Nt(t, (A) => A.modified.startLineNumber <= g.modified.startLineNumber),
        y = Math.max(
          g.original.startLineNumber - d.original.startLineNumber,
          g.modified.startLineNumber - p.modified.startLineNumber
        ),
        w = f.findLastMonotonous(
          (A) => A.original.startLineNumber < g.original.endLineNumberExclusive
        ),
        N = Nt(t, (A) => A.modified.startLineNumber < g.modified.endLineNumberExclusive),
        b = Math.max(
          w.original.endLineNumberExclusive - g.original.endLineNumberExclusive,
          N.modified.endLineNumberExclusive - g.modified.endLineNumberExclusive
        )
      let _
      for (_ = 0; _ < y; _++) {
        const A = g.original.startLineNumber - _ - 1,
          v = g.modified.startLineNumber - _ - 1
        if (
          A > r.length ||
          v > i.length ||
          l.contains(v) ||
      ...
      _ > 0 &&
        (h.addRange(new H(g.original.startLineNumber - _, g.original.startLineNumber)),
        l.addRange(new H(g.modified.startLineNumber - _, g.modified.startLineNumber)))
      let L
      for (L = 0; L < b; L++) {
        const A = g.original.endLineNumberExclusive + L,
          v = g.modified.endLineNumberExclusive + L
        if (
          A > r.length ||
          v > i.length ||
          l.contains(v) ||
      ...
      ;(L > 0 &&
        (h.addRange(
          new H(g.original.endLineNumberExclusive, g.original.endLineNumberExclusive + L)
        ),
        l.addRange(
          new H(g.modified.endLineNumberExclusive, g.modified.endLineNumberExclusive + L)
        )),
        (_ > 0 || L > 0) &&
          (a[m] = new Le(
            new H(g.original.startLineNumber - _, g.original.endLineNumberExclusive + L),
            new H(g.modified.startLineNumber - _, g.modified.endLineNumberExclusive + L)
          )))
    }
    return a
  }
  function ra(t, e, n) {
    ...
    const i = new Ys().compute(
      new Rn([t], new U(1, 1, 1, t.length), !1),
      new Rn([e], new U(1, 1, 1, e.length), !1),
      n
    )
    let s = 0
    ...
    function o(h) {
      let f = 0
      for (let m = 0; m < t.length; m++) Er(h.charCodeAt(m)) || f++
      return f
    }
  ...
  function sc(t) {
    ...
    t.sort(Jt((n) => n.original.startLineNumber, Xt))
    const e = [t[0]]
      ...
      (e = e.filter((r) => {
        const i =
            n.findLastMonotonous(
              (o) => o.original.startLineNumber < r.original.endLineNumberExclusive
            ) || new Le(new H(1, 1), new H(1, 1)),
          s = Nt(t, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive)
        return i !== s
      })),
      e
    )
  ...
  function ia(t, e, n) {
    let r = n
    return ((r = sa(t, e, r)), (r = sa(t, e, r)), (r = oc(t, e, r)), r)
  }
  function sa(t, e, n) {
    ...
    for (let s = 1; s < n.length; s++) {
      ...
      if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
        ...
        for (
          ...
          l <= u &&
          !(
            t.getElement(o.seq1Range.start - l) !== t.getElement(o.seq1Range.endExclusive - l) ||
            e.getElement(o.seq2Range.start - l) !== e.getElement(o.seq2Range.endExclusive - l)
          );
          l++
        );
        if ((l--, l === u)) {
    ...
    for (let s = 0; s < r.length - 1; s++) {
      ...
      if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
        ...
        for (
          ...
          l < u &&
          !(
            !t.isStronglyEqual(o.seq1Range.start + l, o.seq1Range.endExclusive + l) ||
            !e.isStronglyEqual(o.seq2Range.start + l, o.seq2Range.endExclusive + l)
          );
          l++
        );
        if (l === u) {
  ...
  function oc(t, e, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      const i = r > 0 ? n[r - 1] : void 0,
        ...
        o = new j(i ? i.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : t.length),
        u = new j(i ? i.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : e.length)
      s.seq1Range.isEmpty
        ? (n[r] = aa(s, t, e, o, u))
        : s.seq2Range.isEmpty && (n[r] = aa(s.swap(), e, t, u, o).swap())
    }
    return n
  }
  function aa(t, e, n, r, i) {
    ...
    for (let h = -a; h <= o; h++) {
      const f = t.seq2Range.start + h,
        ...
        d = e.getBoundaryScore(g) + n.getBoundaryScore(f) + n.getBoundaryScore(m)
      d > l && ((l = d), (u = h))
    }
    return t.delta(u)
  }
  function lc(t, e, n) {
    ...
    for (const i of n) {
      ...
      i.seq2Range.start - s.seq2Range.endExclusive <= 2
        ? (r[r.length - 1] = new K(s.seq1Range.join(i.seq1Range), s.seq2Range.join(i.seq2Range)))
        : r.push(i)
    }
    return r
  }
  function oa(t, e, n, r, i = !1) {
    ...
    function u(h, f) {
      ...
      let y = p.seq1Range.length,
        w = p.seq2Range.length
      for (; s.length > 0; ) {
        const N = s[0]
        if (!(N.seq1Range.intersects(d.seq1Range) || N.seq2Range.intersects(d.seq2Range))) break
        const _ = r(t, N.seq1Range.start),
          L = r(e, N.seq2Range.start),
          A = new K(_, L),
          v = A.intersect(N)
        if (
          ((y += v.seq1Range.length),
          (w += v.seq2Range.length),
          (d = d.join(A)),
      ...
      ;(((i && y + w < d.seq1Range.length + d.seq2Range.length) ||
        y + w < ((d.seq1Range.length + d.seq2Range.length) * 2) / 3) &&
        a.push(d),
  ...
  function uc(t, e) {
    ...
    for (; t.length > 0 || e.length > 0; ) {
      const r = t[0],
        i = e[0]
      let s
      ;(r && (!i || r.seq1Range.start < i.seq1Range.start) ? (s = t.shift()) : (s = e.shift()),
  ...
  function cc(t, e, n) {
    ...
    do {
      ...
      for (let o = 1; o < r.length; o++) {
        ...
        const u = r[o],
          l = a[a.length - 1]
        h(l, u) ? ((s = !0), (a[a.length - 1] = a[a.length - 1].join(u))) : a.push(u)
      }
      r = a
    } while (i++ < 10 && s)
    return r
  ...
  function fc(t, e, n) {
    ...
    do {
      ...
      for (let u = 1; u < r.length; u++) {
        let f = function (g, d) {
          ...
          const w = t.getText(p).trim()
          if (w.length > 20 || w.split(/\r\n|\r|\n/).length > 1) return !1
          const N = t.countLinesIn(g.seq1Range),
            b = g.seq1Range.length,
            _ = e.countLinesIn(g.seq2Range),
            L = g.seq2Range.length,
            A = t.countLinesIn(d.seq1Range),
            v = d.seq1Range.length,
            k = e.countLinesIn(d.seq2Range),
            M = d.seq2Range.length,
            V = 130
          function T(x) {
            return Math.min(x, V)
          }
          return (
            Math.pow(Math.pow(T(N * 40 + b), 1.5) + Math.pow(T(_ * 40 + L), 1.5), 1.5) +
              Math.pow(Math.pow(T(A * 40 + v), 1.5) + Math.pow(T(k * 40 + M), 1.5), 1.5) >
            (V ** 1.5) ** 1.5 * 1.3
          )
        }
        const l = r[u],
    ...
    return (
      Vu(r, (o, u, l) => {
        ...
        function f(w) {
          return (
            w.length > 0 && w.trim().length <= 3 && u.seq1Range.length + u.seq2Range.length > 100
          )
        }
        ...
        const p = K.fromOffsetPairs(o ? o.getEndExclusives() : ze.zero, l ? l.getStarts() : ze.max),
          y = h.intersect(p)
  ...
  class la {
    ...
    getBoundaryScore(e) {
      const n = e === 0 ? 0 : ua(this.lines[e - 1]),
        r = e === this.lines.length ? 0 : ua(this.lines[e])
      return 1e3 - (n + r)
    }
    getText(e) {
...
`)
  ...
  class hc {
    constructor() {
      ;((this.dynamicProgrammingDiffing = new Zu()), (this.myersDiffingAlgorithm = new Ys()))
    }
    computeDiff(e, n, r) {
      if (e.length <= 1 && Cu(e, n, (v, k) => v === k)) return new _n([], [], !1)
      if ((e.length === 1 && e[0].length === 0) || (n.length === 1 && n[0].length === 0))
        return new _n(
          [
            new We(new H(1, e.length + 1), new H(1, n.length + 1), [
              new Ne(
                new U(1, 1, e.length, e[e.length - 1].length + 1),
                new U(1, 1, n.length, n[n.length - 1].length + 1)
              )
            ])
          ],
          [],
      ...
      const i = r.maxComputationTimeMs === 0 ? Yt.instance : new Qu(r.maxComputationTimeMs),
      ...
      const u = e.map((v) => o(v.trim())),
        l = n.map((v) => o(v.trim())),
        h = new la(u, e),
        f = new la(l, n),
        m =
          h.length + f.length < 1700
            ? this.dynamicProgrammingDiffing.compute(h, f, i, (v, k) =>
                e[v] === n[k] ? (n[k].length === 0 ? 0.1 : 1 + Math.log(1 + n[k].length)) : 0.99
              )
            : this.myersDiffingAlgorithm.compute(h, f, i)
      let g = m.diffs,
        d = m.hitTimeout
      ;((g = ia(h, f, g)), (g = cc(h, f, g)))
      const p = [],
        y = (v) => {
          if (s)
            for (let k = 0; k < v; k++) {
              const M = w + k,
                V = N + k
              if (e[M] !== n[V]) {
                const T = this.refineDiff(e, n, new K(new j(M, M + 1), new j(V, V + 1)), i, s, r)
                for (const x of T.mappings) p.push(x)
                T.hitTimeout && (d = !0)
              }
            }
        }
      let w = 0,
        N = 0
      for (const v of g) {
        hn(() => v.seq1Range.start - w === v.seq2Range.start - N)
        const k = v.seq1Range.start - w
        ;(y(k), (w = v.seq1Range.endExclusive), (N = v.seq2Range.endExclusive))
        const M = this.refineDiff(e, n, v, i, s, r)
        M.hitTimeout && (d = !0)
        for (const V of M.mappings) p.push(V)
      }
      y(e.length - w)
      const b = new An(e),
        _ = new An(n),
      ...
      let A = []
      return (
        r.computeMoves && (A = this.computeMoves(L, e, n, u, l, i, s, r)),
        hn(() => {
          function v(M, V) {
            if (M.lineNumber < 1 || M.lineNumber > V.length) return !1
          ...
          function k(M, V) {
            return !(
              M.startLineNumber < 1 ||
              M.startLineNumber > V.length + 1 ||
              M.endLineNumberExclusive < 1 ||
              M.endLineNumberExclusive > V.length + 1
            )
          }
          for (const M of L) {
            ...
            for (const V of M.innerChanges)
              if (
                !(
                  v(V.modifiedRange.getStartPosition(), n) &&
                  v(V.modifiedRange.getEndPosition(), n) &&
                  v(V.originalRange.getStartPosition(), e) &&
                  v(V.originalRange.getEndPosition(), e)
                )
              )
                return !1
            if (!k(M.modified, n) || !k(M.original, e)) return !1
          }
          return !0
        }),
        new _n(L, A, d)
    ...
    computeMoves(e, n, r, i, s, a, o, u) {
      return tc(e, n, r, i, s, a).map((f) => {
        const m = this.refineDiff(
          ...
          g = Js(m.mappings, new An(n), new An(r), !0)
        return new Pu(f, g)
      })
    }
    refineDiff(e, n, r, i, s, a) {
      const u = mc(r).toRangeMapping2(e, n),
        l = new Rn(e, u.originalRange, s),
        h = new Rn(n, u.modifiedRange, s),
        f =
      ...
      return (
        (m = ia(l, h, m)),
        (m = oa(l, h, m, (d, p) => d.findWordContaining(p))),
        a.extendToSubwords && (m = oa(l, h, m, (d, p) => d.findSubWordContaining(p), !0)),
        (m = lc(l, h, m)),
        (m = fc(l, h, m)),
        {
          mappings: m.map(
            (d) => new Ne(l.translateRange(d.seq1Range), h.translateRange(d.seq2Range))
          ),
  ...
  const ca = { getLegacy: () => new zu(), getDefault: () => new hc() }
  function Ye(t, e) {
  ...
  class R {
    constructor(e, n, r, i = 1) {
      ;((this._rgbaBrand = void 0),
        ...
        (this.a = Ye(Math.max(Math.min(1, i), 0), 3)))
    }
    static equals(e, n) {
  ...
  class _e {
    constructor(e, n, r, i) {
      ;((this._hslaBrand = void 0),
        ...
        (this.s = Ye(Math.max(Math.min(1, n), 0), 3)),
        (this.l = Ye(Math.max(Math.min(1, r), 0), 3)),
        (this.a = Ye(Math.max(Math.min(1, i), 0), 3)))
    }
    static equals(e, n) {
  ...
  class Et {
    constructor(e, n, r, i) {
      ;((this._hsvaBrand = void 0),
        (this.h = Math.max(Math.min(360, e), 0) | 0),
        (this.s = Ye(Math.max(Math.min(1, n), 0), 3)),
        (this.v = Ye(Math.max(Math.min(1, r), 0), 3)),
        (this.a = Ye(Math.max(Math.min(1, i), 0), 3)))
    }
    static equals(e, n) {
        ...
        o === 0
          ...
          : s === n
            ...
            : s === r
              ? (l = (i - n) / o + 2)
              : (l = (n - r) / o + 4),
        new Et(Math.round(l * 60), u, s, e.a)
      )
    }
    static toRGBA(e) {
  ...
  let En =
    ((J = class {
      ...
      get hsva() {
        return this._hsva ? this._hsva : Et.fromRGBA(this.rgba)
      }
      constructor(e) {
        if (e)
          if (e instanceof R) this.rgba = e
          else if (e instanceof _e) ((this._hsla = e), (this.rgba = _e.toRGBA(e)))
          else if (e instanceof Et) ((this._hsva = e), (this.rgba = Et.toRGBA(e)))
      ...
      equals(e) {
        return (
          !!e &&
          R.equals(this.rgba, e.rgba) &&
          _e.equals(this.hsla, e.hsla) &&
          Et.equals(this.hsva, e.hsva)
        )
      }
      ...
      lighten(e) {
        return new J(new _e(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * e, this.hsla.a))
      }
      darken(e) {
        return new J(new _e(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * e, this.hsla.a))
      }
    ...
    (J.white = new J(new R(255, 255, 255, 1))),
    (J.black = new J(new R(0, 0, 0, 1))),
    (J.red = new J(new R(255, 0, 0, 1))),
    (J.blue = new J(new R(0, 0, 255, 1))),
    (J.green = new J(new R(0, 255, 0, 1))),
    (J.cyan = new J(new R(0, 255, 255, 1))),
    (J.lightgrey = new J(new R(211, 211, 211, 1))),
    (J.transparent = new J(new R(0, 0, 0, 0))),
    J)
  ;(function (t) {
    ;(function (e) {
      ;(function (n) {
        ...
        function f(p) {
          ...
          if (p.startsWith('rgba(')) {
            ...
            const k = parseInt(((y = v.groups) == null ? void 0 : y.r) ?? '0'),
              M = parseInt(((w = v.groups) == null ? void 0 : w.g) ?? '0'),
              V = parseInt(((N = v.groups) == null ? void 0 : N.b) ?? '0'),
              T = parseFloat(((b = v.groups) == null ? void 0 : b.a) ?? '0')
            return new t(new R(k, M, V, T))
          }
          if (p.startsWith('rgb(')) {
            const v = p.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/)
            if (!v) throw new Error('Invalid color format ' + p)
            const k = parseInt(((_ = v.groups) == null ? void 0 : _.r) ?? '0'),
              M = parseInt(((L = v.groups) == null ? void 0 : L.g) ?? '0'),
              V = parseInt(((A = v.groups) == null ? void 0 : A.b) ?? '0')
            return new t(new R(k, M, V))
          }
          return m(p)
        }
        n.parse = f
        function m(p) {
          switch (p) {
            case 'aliceblue':
              return new t(new R(240, 248, 255, 1))
            case 'antiquewhite':
              return new t(new R(250, 235, 215, 1))
            case 'aqua':
              return new t(new R(0, 255, 255, 1))
            case 'aquamarine':
              return new t(new R(127, 255, 212, 1))
            case 'azure':
              return new t(new R(240, 255, 255, 1))
            case 'beige':
              return new t(new R(245, 245, 220, 1))
            case 'bisque':
              return new t(new R(255, 228, 196, 1))
            case 'black':
              return new t(new R(0, 0, 0, 1))
            case 'blanchedalmond':
              return new t(new R(255, 235, 205, 1))
            case 'blue':
              return new t(new R(0, 0, 255, 1))
            case 'blueviolet':
              return new t(new R(138, 43, 226, 1))
            case 'brown':
              return new t(new R(165, 42, 42, 1))
            case 'burlywood':
              return new t(new R(222, 184, 135, 1))
            case 'cadetblue':
              return new t(new R(95, 158, 160, 1))
            case 'chartreuse':
              return new t(new R(127, 255, 0, 1))
            case 'chocolate':
              return new t(new R(210, 105, 30, 1))
            case 'coral':
              return new t(new R(255, 127, 80, 1))
            case 'cornflowerblue':
              return new t(new R(100, 149, 237, 1))
            case 'cornsilk':
              return new t(new R(255, 248, 220, 1))
            case 'crimson':
              return new t(new R(220, 20, 60, 1))
            case 'cyan':
              return new t(new R(0, 255, 255, 1))
            case 'darkblue':
              return new t(new R(0, 0, 139, 1))
            case 'darkcyan':
              return new t(new R(0, 139, 139, 1))
            case 'darkgoldenrod':
              return new t(new R(184, 134, 11, 1))
            case 'darkgray':
              return new t(new R(169, 169, 169, 1))
            case 'darkgreen':
              return new t(new R(0, 100, 0, 1))
            case 'darkgrey':
              return new t(new R(169, 169, 169, 1))
            case 'darkkhaki':
              return new t(new R(189, 183, 107, 1))
            case 'darkmagenta':
              return new t(new R(139, 0, 139, 1))
            case 'darkolivegreen':
              return new t(new R(85, 107, 47, 1))
            case 'darkorange':
              return new t(new R(255, 140, 0, 1))
            case 'darkorchid':
              return new t(new R(153, 50, 204, 1))
            case 'darkred':
              return new t(new R(139, 0, 0, 1))
            case 'darksalmon':
              return new t(new R(233, 150, 122, 1))
            case 'darkseagreen':
              return new t(new R(143, 188, 143, 1))
            case 'darkslateblue':
              return new t(new R(72, 61, 139, 1))
            case 'darkslategray':
              return new t(new R(47, 79, 79, 1))
            case 'darkslategrey':
              return new t(new R(47, 79, 79, 1))
            case 'darkturquoise':
              return new t(new R(0, 206, 209, 1))
            case 'darkviolet':
              return new t(new R(148, 0, 211, 1))
            case 'deeppink':
              return new t(new R(255, 20, 147, 1))
            case 'deepskyblue':
              return new t(new R(0, 191, 255, 1))
            case 'dimgray':
              return new t(new R(105, 105, 105, 1))
            case 'dimgrey':
              return new t(new R(105, 105, 105, 1))
            case 'dodgerblue':
              return new t(new R(30, 144, 255, 1))
            case 'firebrick':
              return new t(new R(178, 34, 34, 1))
            case 'floralwhite':
              return new t(new R(255, 250, 240, 1))
            case 'forestgreen':
              return new t(new R(34, 139, 34, 1))
            case 'fuchsia':
              return new t(new R(255, 0, 255, 1))
            case 'gainsboro':
              return new t(new R(220, 220, 220, 1))
            case 'ghostwhite':
              return new t(new R(248, 248, 255, 1))
            case 'gold':
              return new t(new R(255, 215, 0, 1))
            case 'goldenrod':
              return new t(new R(218, 165, 32, 1))
            case 'gray':
              return new t(new R(128, 128, 128, 1))
            case 'green':
              return new t(new R(0, 128, 0, 1))
            case 'greenyellow':
              return new t(new R(173, 255, 47, 1))
            case 'grey':
              return new t(new R(128, 128, 128, 1))
            case 'honeydew':
              return new t(new R(240, 255, 240, 1))
            case 'hotpink':
              return new t(new R(255, 105, 180, 1))
            case 'indianred':
              return new t(new R(205, 92, 92, 1))
            case 'indigo':
              return new t(new R(75, 0, 130, 1))
            case 'ivory':
              return new t(new R(255, 255, 240, 1))
            case 'khaki':
              return new t(new R(240, 230, 140, 1))
            case 'lavender':
              return new t(new R(230, 230, 250, 1))
            case 'lavenderblush':
              return new t(new R(255, 240, 245, 1))
            case 'lawngreen':
              return new t(new R(124, 252, 0, 1))
            case 'lemonchiffon':
              return new t(new R(255, 250, 205, 1))
            case 'lightblue':
              return new t(new R(173, 216, 230, 1))
            case 'lightcoral':
              return new t(new R(240, 128, 128, 1))
            case 'lightcyan':
              return new t(new R(224, 255, 255, 1))
            case 'lightgoldenrodyellow':
              return new t(new R(250, 250, 210, 1))
            case 'lightgray':
              return new t(new R(211, 211, 211, 1))
            case 'lightgreen':
              return new t(new R(144, 238, 144, 1))
            case 'lightgrey':
              return new t(new R(211, 211, 211, 1))
            case 'lightpink':
              return new t(new R(255, 182, 193, 1))
            case 'lightsalmon':
              return new t(new R(255, 160, 122, 1))
            case 'lightseagreen':
              return new t(new R(32, 178, 170, 1))
            case 'lightskyblue':
              return new t(new R(135, 206, 250, 1))
            case 'lightslategray':
              return new t(new R(119, 136, 153, 1))
            case 'lightslategrey':
              return new t(new R(119, 136, 153, 1))
            case 'lightsteelblue':
              return new t(new R(176, 196, 222, 1))
            case 'lightyellow':
              return new t(new R(255, 255, 224, 1))
            case 'lime':
              return new t(new R(0, 255, 0, 1))
            case 'limegreen':
              return new t(new R(50, 205, 50, 1))
            case 'linen':
              return new t(new R(250, 240, 230, 1))
            case 'magenta':
              return new t(new R(255, 0, 255, 1))
            case 'maroon':
              return new t(new R(128, 0, 0, 1))
            case 'mediumaquamarine':
              return new t(new R(102, 205, 170, 1))
            case 'mediumblue':
              return new t(new R(0, 0, 205, 1))
            case 'mediumorchid':
              return new t(new R(186, 85, 211, 1))
            case 'mediumpurple':
              return new t(new R(147, 112, 219, 1))
            case 'mediumseagreen':
              return new t(new R(60, 179, 113, 1))
            case 'mediumslateblue':
              return new t(new R(123, 104, 238, 1))
            case 'mediumspringgreen':
              return new t(new R(0, 250, 154, 1))
            case 'mediumturquoise':
              return new t(new R(72, 209, 204, 1))
            case 'mediumvioletred':
              return new t(new R(199, 21, 133, 1))
            case 'midnightblue':
              return new t(new R(25, 25, 112, 1))
            case 'mintcream':
              return new t(new R(245, 255, 250, 1))
            case 'mistyrose':
              return new t(new R(255, 228, 225, 1))
            case 'moccasin':
              return new t(new R(255, 228, 181, 1))
            case 'navajowhite':
              return new t(new R(255, 222, 173, 1))
            case 'navy':
              return new t(new R(0, 0, 128, 1))
            case 'oldlace':
              return new t(new R(253, 245, 230, 1))
            case 'olive':
              return new t(new R(128, 128, 0, 1))
            case 'olivedrab':
              return new t(new R(107, 142, 35, 1))
            case 'orange':
              return new t(new R(255, 165, 0, 1))
            case 'orangered':
              return new t(new R(255, 69, 0, 1))
            case 'orchid':
              return new t(new R(218, 112, 214, 1))
            case 'palegoldenrod':
              return new t(new R(238, 232, 170, 1))
            case 'palegreen':
              return new t(new R(152, 251, 152, 1))
            case 'paleturquoise':
              return new t(new R(175, 238, 238, 1))
            case 'palevioletred':
              return new t(new R(219, 112, 147, 1))
            case 'papayawhip':
              return new t(new R(255, 239, 213, 1))
            case 'peachpuff':
              return new t(new R(255, 218, 185, 1))
            case 'peru':
              return new t(new R(205, 133, 63, 1))
            case 'pink':
              return new t(new R(255, 192, 203, 1))
            case 'plum':
              return new t(new R(221, 160, 221, 1))
            case 'powderblue':
              return new t(new R(176, 224, 230, 1))
            case 'purple':
              return new t(new R(128, 0, 128, 1))
            case 'rebeccapurple':
              return new t(new R(102, 51, 153, 1))
            case 'red':
              return new t(new R(255, 0, 0, 1))
            case 'rosybrown':
              return new t(new R(188, 143, 143, 1))
            case 'royalblue':
              return new t(new R(65, 105, 225, 1))
            case 'saddlebrown':
              return new t(new R(139, 69, 19, 1))
            case 'salmon':
              return new t(new R(250, 128, 114, 1))
            case 'sandybrown':
              return new t(new R(244, 164, 96, 1))
            case 'seagreen':
              return new t(new R(46, 139, 87, 1))
            case 'seashell':
              return new t(new R(255, 245, 238, 1))
            case 'sienna':
              return new t(new R(160, 82, 45, 1))
            case 'silver':
              return new t(new R(192, 192, 192, 1))
            case 'skyblue':
              return new t(new R(135, 206, 235, 1))
            case 'slateblue':
              return new t(new R(106, 90, 205, 1))
            case 'slategray':
              return new t(new R(112, 128, 144, 1))
            case 'slategrey':
              return new t(new R(112, 128, 144, 1))
            case 'snow':
              return new t(new R(255, 250, 250, 1))
            case 'springgreen':
              return new t(new R(0, 255, 127, 1))
            case 'steelblue':
              return new t(new R(70, 130, 180, 1))
            case 'tan':
              return new t(new R(210, 180, 140, 1))
            case 'teal':
              return new t(new R(0, 128, 128, 1))
            case 'thistle':
              return new t(new R(216, 191, 216, 1))
            case 'tomato':
              return new t(new R(255, 99, 71, 1))
            case 'turquoise':
              return new t(new R(64, 224, 208, 1))
            case 'violet':
              return new t(new R(238, 130, 238, 1))
            case 'wheat':
              return new t(new R(245, 222, 179, 1))
            case 'white':
              return new t(new R(255, 255, 255, 1))
            case 'whitesmoke':
              return new t(new R(245, 245, 245, 1))
            case 'yellow':
              return new t(new R(255, 255, 0, 1))
            case 'yellowgreen':
              return new t(new R(154, 205, 50, 1))
            default:
              return null
          }
        }
        function g(p) {
          ...
          if (y === 7) {
            const w = 16 * d(p.charCodeAt(1)) + d(p.charCodeAt(2)),
              N = 16 * d(p.charCodeAt(3)) + d(p.charCodeAt(4)),
              b = 16 * d(p.charCodeAt(5)) + d(p.charCodeAt(6))
            return new t(new R(w, N, b, 1))
          }
          if (y === 9) {
            const w = 16 * d(p.charCodeAt(1)) + d(p.charCodeAt(2)),
              N = 16 * d(p.charCodeAt(3)) + d(p.charCodeAt(4)),
            ...
            return new t(new R(w, N, b, _ / 255))
          }
          if (y === 4) {
            const w = d(p.charCodeAt(1)),
              N = d(p.charCodeAt(2)),
              b = d(p.charCodeAt(3))
            return new t(new R(16 * w + w, 16 * N + N, 16 * b + b))
          }
          if (y === 5) {
            const w = d(p.charCodeAt(1)),
              N = d(p.charCodeAt(2)),
              b = d(p.charCodeAt(3)),
              _ = d(p.charCodeAt(4))
            return new t(new R(16 * w + w, 16 * N + N, 16 * b + b, (16 * _ + _) / 255))
          }
          return null
        }
        n.parseHex = g
  ...
  function dc(t, e) {
    if (!t) return
    const n = En.Format.CSS.parseHex(e)
    if (n) return { range: t, color: Mr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function ha(t, e, n) {
    if (!t || e.length !== 1) return
    const i = e[0].values(),
      s = fa(i)
    return { range: t, color: Mr(s[0], s[1], s[2], n ? s[3] : 1) }
  }
  function ma(t, e, n) {
    if (!t || e.length !== 1) return
    const i = e[0].values(),
      s = fa(i),
      a = new En(new _e(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1))
    return { range: t, color: Mr(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) }
  }
  function en(t, e) {
  ...
  function wc(t, e) {
    var r
    let n = []
    if (e.findRegionSectionHeaders && (r = e.foldingRules) != null && r.markers) {
      const i = xc(t, e)
      n = n.concat(i)
    }
    ...
    for (let i = 1; i <= r; i++) {
      ...
      if (a) {
        ...
        if (o.endColumn > o.startColumn) {
          const u = { range: o, ...Lc(s.substring(a[0].length)), shouldBeInComments: !1 }
  ...
  function vc(t, e) {
    ...
    const i = Lu(e.markSectionHeaderRegex),
      s = new RegExp(e.markSectionHeaderRegex, `gdm${i ? 's' : ''}`)
    if (bl(s)) return n
    for (let a = 1; a <= r; a += da - yc) {
      const o = Math.min(a + da - 1, r),
        u = []
...
`) + 1,
          N = h.index - w + 1,
          b = d[d.length - 1],
          _ = p === 1 ? N + h[0].length : b.length + 1,
          L = { startLineNumber: g, startColumn: N, endLineNumber: y, endColumn: _ },
          A = (h.groups ?? {}).label ?? '',
          v = ((h.groups ?? {}).separator ?? '') !== '',
          k = { range: L, text: A, hasSeparatorLine: v, shouldBeInComments: !0 }
        ;((k.text || k.hasSeparatorLine) &&
          (n.length === 0 || n[n.length - 1].range.endLineNumber < k.range.startLineNumber) &&
          n.push(k),
  ...
  function Lc(t) {
    ...
    return ((t = t.replace(bc, '')), { text: t, hasSeparatorLine: e })
  }
  class Nc {
    get isRejected() {
      var e
  ...
  const pe = class pe {
    constructor(e, n) {
      ;((this._onReturn = n),
        (this._producerConsumer = new _c()),
        (this._iterator = {
          next: () => this._producerConsumer.consume(),
          return: () => {
            var r
            return (
              (r = this._onReturn) == null || r.call(this),
  ...
  class Sc {
    ...
    _getPrefixSum(e) {
      ...
      for (let r = n; r <= e; r++) this.prefixSum[r] = this.prefixSum[r - 1] + this.values[r]
      return (
    ...
    getIndexOf(e) {
      ...
      let n = 0,
        ...
        a = 0
      for (; n <= r; )
        if (((i = (n + (r - n) / 2) | 0), (s = this.prefixSum[i]), (a = s - this.values[i]), e < a))
          r = i - 1
        else if (e >= s) n = i + 1
        else break
      return new Ac(i, e - a)
  ...
  class kc {
    ...
    onEvents(e) {
      ...
      for (const r of n)
        (this._acceptDeleteRange(r.range),
          this._acceptInsertText(new Q(r.range.startLineNumber, r.range.startColumn), r.text))
    ...
    _acceptInsertText(e, n) {
      ...
      ;((r[r.length - 1] += this._lines[e.lineNumber - 1].substring(e.column - 1)),
        this._setLineText(
          e.lineNumber - 1,
  ...
  class Rc {
    ...
    $acceptNewModel(e) {
      this._models[e.url] = new Ec(gr.parse(e.url), e.lines, e.EOL, e.versionId)
    }
  ...
  class Ec extends kc {
    ...
    findMatches(e) {
      ...
      for (let r = 0; r < this._lines.length; r++) {
        const i = this._lines[r],
          ...
          a = i.matchAll(e)
        for (const o of a) ((o.index || o.index === 0) && (o.index = o.index + s), n.push(o))
      }
      return n
    }
    getLinesContent() {
    ...
    getWordAtPosition(e, n) {
      const r = Nr(e.column, qs(n), this._lines[e.lineNumber - 1], 0)
      return r ? new U(e.lineNumber, r.startColumn, e.lineNumber, r.endColumn) : null
    }
    words(e) {
      const n = this._lines,
        ...
        *[Symbol.iterator]() {
          for (;;)
            if (a < o.length) {
              ...
              ;((a += 1), yield u)
            } else if (i < n.length) ((s = n[i]), (o = r(s, e)), (a = 0), (i += 1))
            else break
        }
      }
    }
  ...
  const mt = class mt {
    constructor(e = null) {
      ;((this._foreignModule = e),
        ...
        (this._workerTextModelSyncServer = new Rc()))
    }
    dispose() {}
    async $ping() {
      return 'pong'
    ...
    async $computeUnicodeHighlights(e, n, r) {
      ...
      return i
        ? Mu.computeUnicodeHighlights(i, n, r)
        : {
            ranges: [],
            hasMore: !1,
    ...
    static computeDiff(e, n, r, i) {
      const s = i === 'advanced' ? ca.getDefault() : ca.getLegacy(),
        a = e.getLinesContent(),
        o = n.getLinesContent(),
    ...
    async $computeMoreMinimalEdits(e, n, r) {
      ...
      n = n.slice(0).sort((u, l) => {
        if (u.range && l.range) return U.compareRangesUsingStarts(u.range, l.range)
        const h = u.range ? 0 : 1,
          f = l.range ? 0 : 1
        return h - f
      })
      ...
      for (let u = 1; u < n.length; u++)
        U.getEndPosition(n[o].range).equals(U.getStartPosition(n[u].range))
          ? ((n[o].range = U.fromPositions(
              U.getStartPosition(n[o].range),
              U.getEndPosition(n[u].range)
            )),
            (n[o].text += n[u].text))
          : (o++, (n[o] = n[u]))
      n.length = o + 1
      for (let { range: u, text: l, eol: h } of n) {
        if ((typeof h == 'number' && (a = h), U.isEmpty(u) && !l)) continue
        const f = i.getValueInRange(u)
        if (((l = l.replace(/\r\n|\n|\r/g, i.eol)), f === l)) continue
        if (Math.max(l.length, f.length) > mt._diffLimit) {
          s.push({ range: u, text: l })
          continue
        }
        const m = Dl(f, l, r),
          g = i.offsetAt(U.lift(u).getStartPosition())
        for (const d of m) {
    ...
    async $navigateValueSet(e, n, r, i, s) {
      ...
      const u = a.getValueInRange(n),
        l = a.getWordAtPosition({ lineNumber: n.startLineNumber, column: n.startColumn }, o)
      if (!l) return null
      const h = a.getValueInRange(l)
      return ur.INSTANCE.navigateValueSet(n, u, l, h, r)
    }
    $fmr(e, n) {
  ...
  function Cr(t, e = !1) {
    ...
    function m(b, _) {
      ...
      for (; L < b; ) {
        ...
        if (v >= 48 && v <= 57) A = A * 16 + v - 48
        else if (v >= 65 && v <= 70) A = A * 16 + v - 65 + 10
        else if (v >= 97 && v <= 102) A = A * 16 + v - 97 + 10
        else break
        ;(r++, L++)
      }
      return (L < b && (A = -1), A)
    ...
    function d() {
      ...
      else for (r++; r < t.length && Mt(t.charCodeAt(r)); ) r++
      if (r < t.length && t.charCodeAt(r) === 46)
        if ((r++, r < t.length && Mt(t.charCodeAt(r))))
          for (r++; r < t.length && Mt(t.charCodeAt(r)); ) r++
        else return ((f = 3), t.substring(b, r))
      let _ = r
      if (r < t.length && (t.charCodeAt(r) === 69 || t.charCodeAt(r) === 101))
        if (
          (r++,
          ((r < t.length && t.charCodeAt(r) === 43) || t.charCodeAt(r) === 45) && r++,
          r < t.length && Mt(t.charCodeAt(r)))
        ) {
          for (r++; r < t.length && Mt(t.charCodeAt(r)); ) r++
          _ = r
        } else f = 3
...
`
    ...
    function y() {
      if (((i = ''), (f = 0), (s = r), (u = o), (h = l), r >= n)) return ((s = n), (a = 17))
...
`)),
      ...
      switch (b) {
        ...
        case 47:
          ...
          if (t.charCodeAt(r + 1) === 47) {
            for (r += 2; r < n && !tn(t.charCodeAt(r)); ) r++
          ...
          if (t.charCodeAt(r + 1) === 42) {
            ...
            for (; r < L; ) {
              ...
              if (v === 42 && t.charCodeAt(r + 1) === 47) {
                ;((r += 2), (A = !0))
                break
              }
              ;(r++, tn(v) && (v === 13 && t.charCodeAt(r) === 10 && r++, o++, (l = r)))
            }
            return (A || (r++, (f = 1)), (i = t.substring(_, r)), (a = 13))
          }
          return ((i += String.fromCharCode(b)), r++, (a = 16))
        case 45:
          if (((i += String.fromCharCode(b)), r++, r === n || !Mt(t.charCodeAt(r)))) return (a = 16)
        case 48:
        case 49:
        case 50:
        case 51:
        ...
        case 57:
          return ((i += d()), (a = 11))
        default:
          for (; r < n && w(b); ) (r++, (b = t.charCodeAt(r)))
          if (s !== r) {
  ...
  const Se = new Array(20).fill(0).map((t, e) => ' '.repeat(e)),
    ...
    ya = {
      ' ': {
        '\n': new Array(Tt).fill(0).map(
          (t, e) =>
            `
` + ' '.repeat(e)
        ),
        '\r': new Array(Tt).fill(0).map((t, e) => '\r' + ' '.repeat(e)),
        '\r\n': new Array(Tt).fill(0).map(
          (t, e) =>
            `\r
` + ' '.repeat(e)
...
`
  ...
  function Cc(t, e, n) {
    let r, i, s, a, o
    if (e) {
      for (a = e.offset, o = a + e.length, s = a; s > 0 && !wa(t, s - 1); ) s--
      let L = o
      for (; L < t.length && !wa(t, L); ) L++
      ;((i = t.substring(s, L)), (r = Ic(i, n)))
    ...
    let h = 0,
      f = 0,
      m
    n.insertSpaces ? (m = Se[n.tabSize || 4] ?? Pt(Se[1], n.tabSize || 4)) : (m = '	')
    const g = m === '	' ? '	' : ' '
    let d = Cr(i, !1),
      p = !1
    function y() {
      if (h > 1) return Pt(u, h) + Pt(m, r + f)
      const L = m.length * (r + f)
      return !l || L > ya[g][u].length ? u + Pt(m, r + f) : L <= 0 ? u : ya[g][u][L]
    }
    function w() {
      let L = d.scan()
      for (h = 0; L === 15 || L === 14; )
        (L === 14 && n.keepLines ? (h += 1) : L === 14 && (h = 1), (L = d.scan()))
      return ((p = L === 16 || d.getTokenError() !== 0), L)
    }
    const N = []
    function b(L, A, v) {
      !p &&
        (!e || (A < o && v > a)) &&
        t.substring(A, v) !== L &&
        N.push({ offset: A, length: v - A, content: L })
    }
    let _ = w()
    if ((n.keepLines && h > 0 && b(Pt(u, h), 0, 0), _ !== 17)) {
      let L = d.getTokenOffset() + s,
        A = m.length * r < 20 && n.insertSpaces ? Se[m.length * r] : Pt(m, r)
      b(A, s, L)
    }
    for (; _ !== 17; ) {
      let L = d.getTokenOffset() + d.getTokenLength() + s,
        A = w(),
        v = '',
        k = !1
      for (; h === 0 && (A === 12 || A === 13); ) {
        ...
        ;(b(Se[1], L, V),
          (L = d.getTokenOffset() + d.getTokenLength() + s),
          (k = A === 12),
          (v = k ? y() : ''),
          (A = w()))
      }
      if (A === 2)
        ...
        switch (_) {
          case 3:
          case 1:
            ;(f++, (n.keepLines && h > 0) || !n.keepLines ? (v = y()) : (v = Se[1]))
            break
          case 5:
            ;(n.keepLines && h > 0) || !n.keepLines ? (v = y()) : (v = Se[1])
            break
          case 12:
            v = y()
            break
          case 13:
            ...
            break
          case 6:
            n.keepLines && h > 0 ? (v = y()) : k || (v = Se[1])
            break
          case 10:
            n.keepLines && h > 0 ? (v = y()) : A === 6 && !k && (v = '')
            break
          case 7:
          case 8:
          case 9:
      ...
      A === 17 && (n.keepLines && h > 0 ? (v = y()) : (v = n.insertFinalNewline ? u : ''))
      const M = d.getTokenOffset() + s
      ;(b(v, L, M), (_ = A))
    }
    return N
  }
...
`.indexOf(t.charAt(e)) !== -1
  ...
  function Fr(t) {
    switch (t.type) {
      case 'array':
        return t.children.map(Fr)
      case 'object':
        const e = Object.create(null)
        for (let n of t.children) {
          const r = n.children[1]
          r && (e[n.children[0].value] = Fr(r))
        }
        return e
      case 'null':
      case 'string':
  ...
  function Oc(t, e, n = Mn.DEFAULT) {
    ...
    function k() {
      return r.getToken() !== 10
        ? (L(3, [], [2, 5]), !1)
        : (A(!1),
          r.getToken() === 6 ? (p(':'), _(), T() || L(4, [], [2, 5])) : L(5, [], [2, 5]),
          i.pop(),
          !0)
    }
    function M() {
      ...
      for (; r.getToken() !== 2 && r.getToken() !== 17; ) {
        if (r.getToken() === 5) {
          if ((x || L(4, [], []), p(','), _(), r.getToken() === 2 && b)) break
        } else x && L(6, [], [])
        ;(k() || L(4, [], [2, 5]), (x = !0))
      }
      return (f(), r.getToken() !== 2 ? L(7, [2], []) : _(), !0)
    }
    function V() {
      ;(m(), _())
      let x = !0,
      ...
      for (; r.getToken() !== 4 && r.getToken() !== 17; ) {
        if (r.getToken() === 5) {
          if ((S || L(4, [], []), p(','), _(), r.getToken() === 4 && b)) break
        } else S && L(6, [], [])
        ;(x ? (i.push(0), (x = !1)) : i[i.length - 1]++, T() || L(4, [], [4, 5]), (S = !0))
      }
      return (g(), x || i.pop(), r.getToken() !== 4 ? L(8, [4], []) : _(), !0)
    }
    function T() {
      switch (r.getToken()) {
        case 3:
  ...
  function Ct(t, e) {
    ...
    if (Array.isArray(t)) {
      ...
      for (n = 0; n < t.length; n++) if (!Ct(t[n], e[n])) return !1
    } else {
      const i = []
      for (r in t) i.push(r)
      i.sort()
      const s = []
      for (r in e) s.push(r)
      if ((s.sort(), !Ct(i, s))) return !1
      for (n = 0; n < i.length; n++) if (!Ct(t[i[n]], e[i[n]])) return !1
    }
    return !0
  }
  function ce(t) {
  ...
  ;(function (t) {
    function e(r, i) {
      return (
        r === Number.MAX_VALUE && (r = Pn.MAX_VALUE),
        i === Number.MAX_VALUE && (i = Pn.MAX_VALUE),
        { line: r, character: i }
      )
    }
    t.create = e
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        E.objectLiteral(i) &&
        W.is(i.targetRange) &&
        E.string(i.targetUri) &&
        W.is(i.targetSelectionRange) &&
        (W.is(i.originSelectionRange) || E.undefined(i.originSelectionRange))
      )
    }
    t.is = n
  })(Ea || (Ea = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        E.objectLiteral(i) &&
        E.numberRange(i.red, 0, 1) &&
        E.numberRange(i.green, 0, 1) &&
        E.numberRange(i.blue, 0, 1) &&
        E.numberRange(i.alpha, 0, 1)
      )
    }
    t.is = n
  })(Dr || (Dr = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      const i = r
      return E.objectLiteral(i) && W.is(i.range) && Dr.is(i.color)
    }
    t.is = n
  })(Ma || (Ma = {}))
  var Ta
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        E.objectLiteral(i) &&
        E.string(i.label) &&
        (E.undefined(i.textEdit) || De.is(i)) &&
        (E.undefined(i.additionalTextEdits) || E.typedArray(i.additionalTextEdits, De.is))
      )
    }
    t.is = n
  })(Ta || (Ta = {}))
  ...
  ;(function (t) {
    function e(r, i, s, a, o, u) {
      ...
      return (
        E.defined(s) && (l.startCharacter = s),
        E.defined(a) && (l.endCharacter = a),
        E.defined(o) && (l.kind = o),
        E.defined(u) && (l.collapsedText = u),
        l
      )
    }
    t.create = e
    function n(r) {
      ...
      return (
        E.objectLiteral(i) &&
        E.uinteger(i.startLine) &&
        E.uinteger(i.startLine) &&
        (E.undefined(i.startCharacter) || E.uinteger(i.startCharacter)) &&
        (E.undefined(i.endCharacter) || E.uinteger(i.endCharacter)) &&
        (E.undefined(i.kind) || E.string(i.kind))
      )
    }
    t.is = n
  })(Pa || (Pa = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return E.defined(i) && It.is(i.location) && E.string(i.message)
    }
    t.is = n
  })(Or || (Or = {}))
  var ye
  ...
  ;(function (t) {
    function e(r, i, s, a, o, u) {
      ...
      return (
        E.defined(s) && (l.severity = s),
        E.defined(a) && (l.code = a),
        E.defined(o) && (l.source = o),
        E.defined(u) && (l.relatedInformation = u),
        l
      )
    }
    t.create = e
    function n(r) {
      ...
      return (
        ...
        W.is(s.range) &&
        E.string(s.message) &&
        (E.number(s.severity) || E.undefined(s.severity)) &&
        (E.integer(s.code) || E.string(s.code) || E.undefined(s.code)) &&
        (E.undefined(s.codeDescription) ||
          E.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) &&
        (E.string(s.source) || E.undefined(s.source)) &&
        (E.undefined(s.relatedInformation) || E.typedArray(s.relatedInformation, Or.is))
      )
    }
    t.is = n
  })(Ge || (Ge = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        E.objectLiteral(i) &&
        E.string(i.label) &&
        (E.boolean(i.needsConfirmation) || i.needsConfirmation === void 0) &&
        (E.string(i.description) || i.description === void 0)
      )
    }
    t.is = n
  })($r || ($r = {}))
  ...
  ;(function (t) {
    ...
    function i(s) {
      const a = s
      return De.is(a) && ($r.is(a.annotationId) || Vt.is(a.annotationId))
    }
    t.is = i
  })(Fa || (Fa = {}))
  var Br
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return E.defined(i) && Hr.is(i.textDocument) && Array.isArray(i.edits)
    }
    t.is = n
  })(Br || (Br = {}))
  var Ur
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        ...
        E.string(i.uri) &&
        (i.options === void 0 ||
          ((i.options.overwrite === void 0 || E.boolean(i.options.overwrite)) &&
            (i.options.ignoreIfExists === void 0 || E.boolean(i.options.ignoreIfExists)))) &&
        (i.annotationId === void 0 || Vt.is(i.annotationId))
      )
    }
    t.is = n
  })(Ur || (Ur = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        ...
        E.string(i.uri) &&
        (i.options === void 0 ||
          ((i.options.recursive === void 0 || E.boolean(i.options.recursive)) &&
            (i.options.ignoreIfNotExists === void 0 || E.boolean(i.options.ignoreIfNotExists)))) &&
        (i.annotationId === void 0 || Vt.is(i.annotationId))
      )
    }
    t.is = n
      ...
      return (
        ...
        (r.documentChanges === void 0 ||
          r.documentChanges.every((i) =>
            E.string(i.kind) ? Ur.is(i) || qr.is(i) || jr.is(i) : Br.is(i)
          ))
      )
    }
    t.is = e
  ...
  ;(function (t) {
    function e(n) {
      const r = n
      return E.objectLiteral(n) && ut.is(r.kind) && E.string(r.value)
    }
    t.is = e
  })(sn || (sn = {}))
  var we
  ...
  ;(function (t) {
    function e(n) {
      ...
      return (
        r &&
        (E.string(r.detail) || r.detail === void 0) &&
        (E.string(r.description) || r.description === void 0)
      )
    }
    t.is = e
  })(qa || (qa = {}))
  ...
  ;(function (t) {
    function e(n) {
      ...
      return (
        !!r &&
        E.objectLiteral(r) &&
        (sn.is(r.contents) || Cn.is(r.contents) || E.typedArray(r.contents, Cn.is)) &&
  ...
  ;(function (t) {
    function e(n, r, ...i) {
      let s = { label: n }
      return (
        E.defined(r) && (s.documentation = r),
        E.defined(i) ? (s.parameters = i) : (s.parameters = []),
        s
      )
    }
    t.create = e
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        ...
        (i.detail === void 0 || E.string(i.detail)) &&
        (i.deprecated === void 0 || E.boolean(i.deprecated)) &&
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        E.defined(i) &&
        E.typedArray(i.diagnostics, Ge.is) &&
        (i.only === void 0 || E.typedArray(i.only, E.string)) &&
        (i.triggerKind === void 0 || i.triggerKind === In.Invoked || i.triggerKind === In.Automatic)
      )
    }
    t.is = n
  })(eo || (eo = {}))
  ...
  ;(function (t) {
    function e(r, i, s) {
      let a = { title: r },
        o = !0
      return (
        typeof i == 'string' ? ((o = !1), (a.kind = i)) : Ft.is(i) ? (a.command = i) : (a.edit = i),
        o && s !== void 0 && (a.kind = s),
        a
      )
    }
    ...
    function n(r) {
      ...
      return (
        i &&
        E.string(i.title) &&
        (i.diagnostics === void 0 || E.typedArray(i.diagnostics, Ge.is)) &&
        (i.kind === void 0 || E.string(i.kind)) &&
        (i.edit !== void 0 || i.command !== void 0) &&
        (i.command === void 0 || Ft.is(i.command)) &&
        (i.isPreferred === void 0 || E.boolean(i.isPreferred)) &&
        (i.edit === void 0 || Wr.is(i.edit))
      )
    }
    t.is = n
  })(to || (to = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return E.defined(i) && W.is(i.range) && (E.undefined(i.command) || Ft.is(i.command))
    }
    t.is = n
  })(no || (no = {}))
  var ro
  ...
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return E.objectLiteral(i) && W.is(i.range) && (i.parent === void 0 || t.is(i.parent))
    }
    t.is = n
  })(Fn || (Fn = {}))
  var so
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        i != null &&
        W.is(i.range) &&
        E.boolean(i.caseSensitiveLookup) &&
        (E.string(i.variableName) || i.variableName === void 0)
      )
    }
    t.is = n
  })(uo || (uo = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        E.objectLiteral(i) &&
        (i.tooltip === void 0 || E.string(i.tooltip) || sn.is(i.tooltip)) &&
        (i.location === void 0 || It.is(i.location)) &&
        (i.command === void 0 || Ft.is(i.command))
      )
    }
    t.is = n
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        (E.objectLiteral(i) &&
          ee.is(i.position) &&
          (E.string(i.label) || E.typedArray(i.label, Jr.is)) &&
          (i.kind === void 0 || Gr.is(i.kind)) &&
          i.textEdits === void 0) ||
        (E.typedArray(i.textEdits, De.is) &&
          (i.tooltip === void 0 || E.string(i.tooltip) || sn.is(i.tooltip)) &&
          (i.paddingLeft === void 0 || E.boolean(i.paddingLeft)) &&
          (i.paddingRight === void 0 || E.boolean(i.paddingRight)))
      )
    }
    t.is = n
  })(ho || (ho = {}))
  ...
  ;(function (t) {
    function e(n) {
      const r = n
      return E.objectLiteral(r) && Vr.is(r.uri) && E.string(r.name)
    }
    t.is = e
  })(xo || (xo = {}))
  var vo
  ;(function (t) {
    ...
    function n(s) {
      ...
      return !!(
        E.defined(a) &&
        E.string(a.uri) &&
        (E.undefined(a.languageId) || E.string(a.languageId)) &&
        E.uinteger(a.lineCount) &&
        E.func(a.getText) &&
        E.func(a.positionAt) &&
        E.func(a.offsetAt)
      )
    ...
    function r(s, a) {
      ...
      for (let h = u.length - 1; h >= 0; h--) {
        ...
        if (g <= l) o = o.substring(0, m) + f.newText + o.substring(g, o.length)
...
` &&
    ...
    update(e, n) {
      for (let r of e)
        if (an.isIncremental(r)) {
          ...
          if (u - o === h.length) for (let m = 0, g = h.length; m < g; m++) l[m + o + 1] = h[m]
          else
            h.length < 1e4
              ? l.splice(o + 1, u - o, ...h)
              : (this._lineOffsets = l = l.slice(0, o + 1).concat(h, l.slice(u + 1)))
          const f = r.text.length - (a - s)
          if (f !== 0) for (let m = o + 1 + h.length, g = l.length; m < g; m++) l[m] = l[m] + f
        } else if (an.isFull(r)) ((this._content = r.text), (this._lineOffsets = void 0))
        else throw new Error('Unknown change event received')
      this._version = n
    }
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 && (this._lineOffsets = Lo(this._content, !0)),
        this._lineOffsets
      )
    }
    positionAt(e) {
  ...
  ;(function (t) {
    function e(i, s, a, o) {
      return new an(i, s, a, o)
    }
    t.create = e
    function n(i, s, a) {
      if (i instanceof an) return (i.update(s, a), i)
  ...
  function Lo(t, e, n = 0) {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      ;(s === 13 || s === 10) &&
        (s === 13 && i + 1 < t.length && t.charCodeAt(i + 1) === 10 && i++, r.push(n + i + 1))
    }
    return r
  }
  function No(t) {
  ...
  ;(function (t) {
    ;((t[(t.Undefined = 0)] = 'Undefined'),
      ...
      (t[(t.PropertyKeysMustBeDoublequoted = 528)] = 'PropertyKeysMustBeDoublequoted'),
  ...
  ;(function (t) {
    t.LATEST = {
      textDocument: {
        completion: {
          completionItem: {
            documentationFormat: [ut.Markdown, ut.PlainText],
  ...
  var Gc = /{([^}]+)}/g
  function Jc(t, e) {
    return Object.keys(e).length === 0 ? t : t.replace(Gc, (n, r) => e[r] ?? n)
  }
  const Xc = {
    'color-hex': {
      errorMessage: P('Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA.'),
      pattern: /^#([0-9A-Fa-f]{3,4}|([0-9A-Fa-f]{2}){3,4})$/
    },
    'date-time': {
      errorMessage: P('String is not a RFC3339 date-time.'),
      pattern:
        /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i
    },
    date: {
      errorMessage: P('String is not a RFC3339 date.'),
      pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i
    },
    time: {
      errorMessage: P('String is not a RFC3339 time.'),
      pattern:
        /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i
    },
    email: {
      errorMessage: P('String is not an e-mail address.'),
      pattern:
        /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}))$/
    },
    hostname: {
      errorMessage: P('String is not a hostname.'),
      pattern:
        /^(?=.{1,253}\.?$)[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?(?:\.[a-z0-9](?:[-0-9a-z]{0,61}[0-9a-z])?)*\.?$/i
    },
    ipv4: {
      errorMessage: P('String is not an IPv4 address.'),
      pattern: /^(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)$/
    },
    ipv6: {
      errorMessage: P('String is not an IPv6 address.'),
      pattern:
  ...
  class Yr {
    ...
    include(e) {
      return (this.focusOffset === -1 || ko(e, this.focusOffset)) && e !== this.exclude
    }
    newSub() {
      return new Yr(-1, this.exclude)
    }
  }
  class on {
    constructor() {}
  ...
  class fe {
    ...
    mergePropertyMatch(e) {
      ;((this.problems = this.problems.concat(e.problems)),
        ...
        e.enumValueMatch && e.enumValues && e.enumValues.length === 1 && this.primaryValueMatches++)
    }
  ...
  class Ro {
    ...
    getNodeFromOffset(e, n = !1) {
      if (this.root) return Bc(this.root, e, n)
    }
    visit(e) {
      if (this.root) {
        const n = (r) => {
          let i = e(r)
          const s = r.children
          if (Array.isArray(s)) for (let a = 0; a < s.length && i; a++) i = n(s[a])
          return i
        }
        n(this.root)
      }
    ...
    validate(e, n, r = ye.Warning, i) {
      if (this.root && n) {
        const s = new fe()
        return (
          le(this.root, n, s, on.instance, new Ao(i ?? Eo(n))),
          s.problems.map((a) => {
            const o = W.create(
              e.positionAt(a.location.offset),
              e.positionAt(a.location.offset + a.location.length)
            )
            return Ge.create(o, a.message, a.severity ?? r, a.code)
          })
        )
      }
    }
    getMatchingSchemas(e, n = -1, r) {
      if (this.root && e) {
        const i = new Yr(n, r),
          s = Eo(e),
          a = new Ao(s)
        return (le(this.root, e, new fe(), i, a), i.schemas)
      }
      return []
    }
  }
  function Eo(t, e = Te.v2020_12) {
    let n = t.$schema
    return n ? (t1[n] ?? e) : e
  }
  function le(t, e, n, r, i) {
    if (!t || !r.include(t)) return
    if (t.type === 'property') return le(t.valueNode, e, n, r, i)
    const s = t
    switch ((a(), s.type)) {
      case 'object':
        h(s)
        ...
        (Array.isArray(e.type)
          ? e.type.some(f) ||
            n.problems.push({
              ...
              message:
                e.errorMessage || P('Incorrect type. Expected one of {0}.', e.type.join(', '))
            })
          : e.type &&
            (f(e.type) ||
              n.problems.push({
                location: { offset: s.offset, length: s.length },
                message: e.errorMessage || P('Incorrect type. Expected "{0}".', e.type)
              })),
        Array.isArray(e.allOf))
      )
        for (const b of e.allOf) {
          const _ = new fe(),
            L = r.newSub()
          ;(le(s, xe(b), _, L, i), n.merge(_), r.merge(L))
        }
      const m = xe(e.not)
      if (m) {
        const b = new fe(),
        ...
        ;(le(s, m, b, _, i),
          b.hasProblems() ||
            n.problems.push({
              location: { offset: s.offset, length: s.length },
              message: e.errorMessage || P('Matches a schema that is not allowed.')
            }))
        for (const L of _.schemas) ((L.inverted = !L.inverted), r.add(L))
      }
      const g = (b, _) => {
        const L = []
        let A
        for (const v of b) {
          const k = xe(v),
            M = new fe(),
            V = r.newSub()
          if ((le(s, k, M, V, i), M.hasProblems() || L.push(k), !A))
            A = { schema: k, validationResult: M, matchingSchemas: V }
          else if (!_ && !M.hasProblems() && !A.validationResult.hasProblems())
            (A.matchingSchemas.merge(V),
              (A.validationResult.propertiesMatches += M.propertiesMatches),
              (A.validationResult.propertiesValueMatches += M.propertiesValueMatches),
              A.validationResult.mergeProcessedProperties(M))
          else {
            const T = M.compare(A.validationResult)
            T > 0
              ? (A = { schema: k, validationResult: M, matchingSchemas: V })
              : T === 0 && (A.matchingSchemas.merge(V), A.validationResult.mergeEnumValues(M))
          }
        }
        return (
          L.length > 1 &&
          ...
          A && (n.merge(A.validationResult), r.merge(A.matchingSchemas)),
          L.length
        )
      }
      ;(Array.isArray(e.anyOf) && g(e.anyOf, !1), Array.isArray(e.oneOf) && g(e.oneOf, !0))
      const d = (b) => {
          const _ = new fe(),
            L = r.newSub()
          ;(le(s, xe(b), _, L, i), n.merge(_), r.merge(L))
        ...
        p = (b, _, L) => {
          ...
          ;(le(s, A, v, k, i),
            r.merge(k),
            n.mergeProcessedProperties(v),
            v.hasProblems() ? L && d(L) : _ && d(_))
        },
        y = xe(e.if)
      if ((y && p(y, xe(e.then), xe(e.else)), Array.isArray(e.enum))) {
        const b = ft(s)
        let _ = !1
        for (const L of e.enum)
          if (Ct(b, L)) {
            _ = !0
            break
          }
          ...
          _ ||
            n.problems.push({
              ...
              message:
                ...
                P(
                  'Value is not accepted. Valid values: {0}.',
                  e.enum.map((L) => JSON.stringify(L)).join(', ')
                )
            }))
      }
      if (Ee(e.const)) {
        ...
        ;(Ct(b, e.const)
          ...
          : (n.problems.push({
              location: { offset: s.offset, length: s.length },
              code: G.EnumValueMismatch,
              message: e.errorMessage || P('Value must be {0}.', JSON.stringify(e.const))
            }),
            (n.enumValueMatch = !1)),
          (n.enumValues = [e.const]))
      }
      let w = e.deprecationMessage
      if (w || e.deprecated) {
        w = w || P('Value is deprecated')
    ...
    function o(f) {
      ...
      function g(_) {
        ...
        return (
          L && {
            ...
            multiplier: (((A = L[2]) == null ? void 0 : A.length) || 0) - (parseInt(L[3]) || 0)
          }
        )
      }
      if (ce(e.multipleOf)) {
        ...
        if (Number.isInteger(e.multipleOf)) _ = m % e.multipleOf
          ...
          let L = g(e.multipleOf),
            A = g(m)
          if (L && A) {
            const v = 10 ** Math.abs(A.multiplier - L.multiplier)
            ;(A.multiplier < L.multiplier ? (A.value *= v) : (L.value *= v),
              (_ = A.value % L.value))
          }
        }
        _ !== 0 &&
          n.problems.push({
            ...
            message: P('Value is not divisible by {0}.', e.multipleOf)
          })
      }
      function d(_, L) {
        if (ce(L)) return L
      ...
      ce(y) &&
        ...
        n.problems.push({
          location: { offset: f.offset, length: f.length },
          message: P('Value is below the exclusive minimum of {0}.', y)
        })
      const w = d(e.maximum, e.exclusiveMaximum)
      ce(w) &&
        m >= w &&
        n.problems.push({
          location: { offset: f.offset, length: f.length },
          message: P('Value is above the exclusive maximum of {0}.', w)
        })
      const N = p(e.minimum, e.exclusiveMinimum)
      ce(N) &&
        m < N &&
        n.problems.push({
          location: { offset: f.offset, length: f.length },
    ...
    function u(f) {
      if (
        (ce(e.minLength) &&
          Aa(f.value) < e.minLength &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: P('String is shorter than the minimum length of {0}.', e.minLength)
          }),
        ce(e.maxLength) &&
          Aa(f.value) > e.maxLength &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: P('String is longer than the maximum length of {0}.', e.maxLength)
          }),
        Sa(e.pattern))
      ) {
        const m = Tn(e.pattern)
        ;(m != null && m.test(f.value)) ||
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message:
              e.patternErrorMessage ||
              e.errorMessage ||
              P('String does not match the pattern of "{0}".', e.pattern)
          })
      }
      if (e.format)
        switch (e.format) {
          ...
          case 'uri-reference':
            {
              let g
              if (!f.value) g = P('URI expected.')
              else {
                const d = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(
                  f.value
                )
                d
                  ? !d[2] && e.format === 'uri' && (g = P('URI with a scheme is expected.'))
                  : (g = P('URI is expected.'))
              }
              g &&
                n.problems.push({
                  location: { offset: f.offset, length: f.length },
                  message:
                    e.patternErrorMessage || e.errorMessage || P('String is not a URI: {0}', g)
                })
            }
            break
          case 'color-hex':
    ...
    function l(f) {
      ...
      let d = 0
      if (m !== void 0) {
        const w = Math.min(m.length, f.items.length)
        for (; d < w; d++) {
          const N = m[d],
            b = xe(N),
            _ = new fe(),
            L = f.items[d]
          ;(L && (le(L, b, _, r, i), n.mergePropertyMatch(_)), n.processedProperties.add(String(d)))
        }
      }
      if (g !== void 0 && d < f.items.length)
        if (typeof g == 'boolean')
          for (
            ...
            n.problems.push({
              location: { offset: f.offset, length: f.length },
              message: P('Array has too many items according to schema. Expected {0} or fewer.', d)
            });
            d < f.items.length;
            d++
          )
          ...
          for (; d < f.items.length; d++) {
            const w = new fe()
            ;(le(f.items[d], g, w, r, i),
              n.mergePropertyMatch(w),
      ...
      if (p) {
        ...
        for (let N = 0; N < f.items.length; N++) {
          const b = f.items[N],
            _ = new fe()
          ;(le(b, p, _, on.instance, i),
            _.hasProblems() ||
              (w++, i.schemaDraft >= Te.v2020_12 && n.processedProperties.add(String(N))))
        }
        ;(w === 0 &&
          !ce(e.minContains) &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: e.errorMessage || P('Array does not contain required item.')
          }),
          ce(e.minContains) &&
            w < e.minContains &&
            n.problems.push({
        ...
        for (let w = 0; w < f.items.length; w++) {
          if (!n.processedProperties.has(String(w)))
            if (y === !1)
              ...
              const N = new fe()
              ;(le(f.items[w], e.unevaluatedItems, N, r, i), n.mergePropertyMatch(N))
            }
      ...
      if (
        (ce(e.minItems) &&
          ...
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: P('Array has too few items. Expected {0} or more.', e.minItems)
          }),
        ce(e.maxItems) &&
          f.items.length > e.maxItems &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: P('Array has too many items. Expected {0} or fewer.', e.maxItems)
          }),
        e.uniqueItems === !0)
      ) {
        let N = function () {
          for (let b = 0; b < w.length - 1; b++) {
            const _ = w[b]
            for (let L = b + 1; L < w.length; L++) if (Ct(_, w[L])) return !0
          }
          return !1
        }
        const w = ft(f)
    ...
    function h(f) {
      ...
      if (Array.isArray(e.required)) {
        for (const b of e.required)
          if (!m[b]) {
            const _ = f.parent && f.parent.type === 'property' && f.parent.keyNode,
              L = _ ? { offset: _.offset, length: _.length } : { offset: f.offset, length: 1 }
            n.problems.push({ location: L, message: P('Missing property "{0}".', b) })
          }
      }
      const d = (b) => {
            ...
            if (Ve(_))
              if (_) (n.propertiesMatches++, n.propertiesValueMatches++)
                ...
                n.problems.push({
                  ...
                  message: e.errorMessage || P('Property {0} is not allowed.', b)
                })
              }
            else {
              const A = new fe()
              ;(le(L, _, A, r, i), n.mergePropertyMatch(A))
            }
        }
          ...
          if (_) {
            ...
            for (const A of g)
              if (_.test(A)) {
                ...
                const v = m[A]
                if (v) {
                  const k = e.patternProperties[b]
                  if (Ve(k))
                    if (k) (n.propertiesMatches++, n.propertiesValueMatches++)
                    else {
                      const M = v.parent
                      n.problems.push({
                        location: { offset: M.keyNode.offset, length: M.keyNode.length },
                        message: e.errorMessage || P('Property {0} is not allowed.', A)
                      })
                    }
                  else {
                    const M = new fe()
                    ;(le(v, k, M, r, i), n.mergePropertyMatch(M))
                  }
                }
              }
            L.forEach(d)
        ...
        for (const b of g) {
          ...
          if (_) {
            if (p === !1) {
              ...
              const L = new fe()
              ;(le(_, p, L, r, i), n.mergePropertyMatch(L))
            }
          }
        }
          ...
          if (!n.processedProperties.has(_)) {
            ...
            if (L) {
              if (y === !1) {
                ...
                n.problems.push({
                  location: { offset: A.keyNode.offset, length: A.keyNode.length },
                  message: e.errorMessage || P('Property {0} is not allowed.', _)
                })
              } else if (y !== !0) {
                const A = new fe()
                ;(le(L, y, A, r, i), n.mergePropertyMatch(A))
              }
            }
          }
        b.forEach(d)
      ...
      if (
        (ce(e.maxProperties) &&
          ...
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: P('Object has more properties than limit of {0}.', e.maxProperties)
          }),
        ce(e.minProperties) &&
        ...
        for (const b in e.dependentRequired) {
          const _ = m[b],
            L = e.dependentRequired[b]
          _ && Array.isArray(L) && N(b, L)
        }
      if (e.dependentSchemas)
        for (const b in e.dependentSchemas) {
          const _ = m[b],
            L = e.dependentSchemas[b]
          _ && Ke(L) && N(b, L)
        }
      if (e.dependencies) for (const b in e.dependencies) m[b] && N(b, e.dependencies[b])
      const w = xe(e.propertyNames)
      if (w)
        for (const b of f.properties) {
          const _ = b.keyNode
          _ && le(_, w, n, on.instance, i)
        }
      function N(b, _) {
        if (Array.isArray(_))
          for (const L of _)
          ...
          if (L) {
            const A = new fe()
            ;(le(f, L, A, r, i), n.mergePropertyMatch(A))
          }
        }
      }
    }
  ...
  function r1(t, e) {
    ...
    function u(A, v, k, M, V = ye.Error) {
      if (n.length === 0 || k !== r) {
        const T = W.create(t.positionAt(k), t.positionAt(M))
        ;(n.push(Ge.create(T, A, V, v, t.languageId)), (r = k))
      }
    }
    function l(A, v, k = void 0, M = [], V = []) {
      let T = s.getTokenOffset(),
        x = s.getTokenOffset() + s.getTokenLength()
      if (T === x && T > 0) {
        for (T--; T > 0 && /\s/.test(i.charAt(T)); ) T--
        x = T + 1
      }
      if ((u(A, v, T, x), k && f(k, !1), M.length + V.length > 0)) {
        let S = s.getToken()
        for (; S !== 17; ) {
          if (M.indexOf(S) !== -1) {
            o()
            break
          } else if (V.indexOf(S) !== -1) break
          S = o()
        }
      }
      return k
    ...
    function h() {
      switch (s.getTokenError()) {
        ...
        case 6:
          return (
            l(
              P('Invalid characters in string. Control characters must be escaped.'),
              G.InvalidCharacter
            ),
            !0
          )
    ...
    function f(A, v) {
      return ((A.length = s.getTokenOffset() + s.getTokenLength() - A.offset), v && o(), A)
    }
    function m(A) {
      if (s.getToken() !== 3) return
      const v = new Zc(A, s.getTokenOffset())
      o()
      let k = !1
      for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
        ...
        const M = b(v)
        ;(M ? v.items.push(M) : l(P('Value expected'), G.ValueExpected, void 0, [], [4, 5]),
          (k = !0))
      }
      return s.getToken() !== 4
        ? l(P('Expected comma or closing bracket'), G.CommaOrCloseBacketExpected, v)
        : f(v, !0)
    }
    const g = new Zr(void 0, 0, 0)
    function d(A, v) {
      const k = new Kc(A, s.getTokenOffset(), g)
      let M = y(k)
      if (!M)
        if (s.getToken() === 16) {
          l(P('Property keys must be doublequoted'), G.PropertyKeysMustBeDoublequoted)
          const T = new Zr(k, s.getTokenOffset(), s.getTokenLength())
      ...
      if (((k.keyNode = M), M.value !== '//')) {
        ...
        T
          ? (u(
              P('Duplicate object key'),
              G.DuplicateKey,
              k.keyNode.offset,
              k.keyNode.offset + k.keyNode.length,
              ye.Warning
            ),
            Ke(T) &&
              u(
      ...
      if (s.getToken() === 6) ((k.colonOffset = s.getTokenOffset()), o())
      else if (
        (l(P('Colon expected'), G.ColonExpected),
        s.getToken() === 10 &&
          t.positionAt(M.offset + M.length).line < t.positionAt(s.getTokenOffset()).line)
      )
        return ((k.length = M.length), k)
      const V = b(k)
      return V
        ? ((k.valueNode = V), (k.length = V.offset + V.length - k.offset), k)
        : l(P('Value expected'), G.ValueExpected, k, [], [2, 5])
    }
    function p(A) {
      if (s.getToken() !== 1) return
      const v = new e1(A, s.getTokenOffset()),
      ...
      for (; s.getToken() !== 2 && s.getToken() !== 17; ) {
        ...
        ;(V
          ? v.properties.push(V)
          : l(P('Property expected'), G.PropertyExpected, void 0, [], [2, 5]),
          (M = !0))
      }
      return s.getToken() !== 2
        ? l(P('Expected comma or closing brace'), G.CommaOrCloseBraceExpected, v)
        : f(v, !0)
    }
    function y(A) {
      if (s.getToken() !== 10) return
      const v = new Zr(A, s.getTokenOffset())
      return ((v.value = s.getTokenValue()), f(v, !0))
    }
    function w(A) {
      if (s.getToken() !== 11) return
      const v = new Yc(A, s.getTokenOffset())
      if (s.getTokenError() === 0) {
        const k = s.getTokenValue()
        try {
          const M = JSON.parse(k)
          if (!ce(M)) return l(P('Invalid number format.'), G.Undefined, v)
          v.value = M
        } catch {
    ...
    function N(A) {
      switch (s.getToken()) {
        case 7:
          return f(new Qc(A, s.getTokenOffset()), !0)
        case 8:
          return f(new _o(A, !0, s.getTokenOffset()), !0)
        case 9:
          return f(new _o(A, !1, s.getTokenOffset()), !0)
        default:
          return
      }
    }
    function b(A) {
      return m(A) || p(A) || y(A) || w(A) || N(A)
    }
    let _
    return (
      o() !== 17 &&
        ((_ = b(_)),
        _
          ? s.getToken() !== 17 && l(P('End of file expected.'), G.Undefined)
          : l(P('Expected a JSON object, array or literal.'), G.Undefined)),
      new Ro(_, n, a)
    )
  }
  function ei(t, e, n) {
...
`
        for (let a = 0; a < i.length; a++) {
          const o = i[a]
          ;((s += r + JSON.stringify(o) + ': ' + ei(t[o], r, n)),
            a < i.length - 1 && (s += ','),
            (s += `
`))
        }
  ...
  class i1 {
    ...
    doComplete(e, n, r) {
      ...
      if (o && a === o.offset + o.length && a > 0) {
        const m = s[a - 1]
        ;((o.type === 'object' && m === '}') || (o.type === 'array' && m === ']')) && (o = o.parent)
      }
      const u = this.getCurrentWord(e, a)
      let l
      if (
        o &&
        (o.type === 'string' || o.type === 'number' || o.type === 'boolean' || o.type === 'null')
      )
        ...
        f = {
          add: (m) => {
            ...
            if (d)
              ...
              ;((m.textEdit = De.replace(l, m.insertText)),
                (m.label = g),
                h.set(g, m),
                i.items.push(m))
            }
      ...
      return this.schemaService.getSchemaForResource(e.uri, r).then((m) => {
        ...
        if (o && o.type === 'object') {
          ...
          o.properties.forEach((L) => {
            ;(!y || y !== L) && h.set(L.keyNode.value, zr.create('__'))
          })
          let b = ''
          ...
          ;(this.contributions.forEach((L) => {
            const A = L.collectPropertyCompletions(e.uri, _, u, d, b === '', f)
            A && g.push(A)
          }),
            !m &&
              u.length > 0 &&
        ...
        return (
          m
            ? this.getValueCompletions(m, r, o, a, e, f, w)
            : this.getSchemaLessValueCompletions(r, o, a, e, f),
          this.contributions.length > 0 && this.getContributedValueCompletions(r, o, a, e, f, g),
            ...
            if (f.getNumberOfProposals() === 0) {
              ...
              o &&
                (o.type === 'string' ||
                  ...
                  o.type === 'null') &&
                (N = o.offset + o.length)
              const b = this.evaluateSeparatorAfter(e, N)
              this.addFillerValueCompletions(w, b, f)
            }
            return i
          })
        )
            ...
            Object.keys(l).forEach((f) => {
              ...
              if (typeof m == 'object' && !m.deprecationMessage && !m.doNotSuggest) {
                const g = {
                  ...
                  documentation: this.fromMarkup(m.markdownDescription) || m.description || ''
                }
                ;(m.suggestSortText !== void 0 && (g.sortText = m.suggestSortText),
                  g.insertText &&
                    nn(g.insertText, `$1${s}`) &&
                    (g.command = { title: 'Suggest', command: 'editor.action.triggerSuggest' }),
                  a.add(g))
              }
            })
          ...
          if (typeof h == 'object' && !h.deprecationMessage && !h.doNotSuggest) {
            const f = (m, g = void 0) => {
              const d = {
                ...
                documentation: g || this.fromMarkup(h.markdownDescription) || h.description || ''
              }
              ;(h.suggestSortText !== void 0 && (d.sortText = h.suggestSortText),
                d.insertText &&
                  nn(d.insertText, `$1${s}`) &&
                  (d.command = { title: 'Suggest', command: 'editor.action.triggerSuggest' }),
                a.add(d))
            }
            if (h.enum)
              for (let m = 0; m < h.enum.length; m++) {
                let g
                ;(h.markdownEnumDescriptions && m < h.markdownEnumDescriptions.length
    ...
    getSchemaLessValueCompletions(e, n, r, i, s) {
      ...
      if (n.type === 'property' && r > (n.colonOffset || 0)) {
        const l = n.valueNode
        if (l && (r > l.offset + l.length || l.type === 'object' || l.type === 'array')) return
        const h = n.keyNode.value
        ;(e.visit(
          (f) => (
            f.type === 'property' && f.keyNode.value === h && f.valueNode && u(f.valueNode),
            !0
          )
        ),
          h === '$schema' && n.parent && !n.parent.parent && this.addDollarSchemaCompletions(o, s))
      }
      if (n.type === 'array')
    ...
    getValueCompletions(e, n, r, i, s, a, o) {
      ...
      if (r && (l !== void 0 || r.type === 'array')) {
            ...
            if (r.type === 'array' && g.schema.items) {
              ...
              if (g.schema.uniqueItems) {
                ...
                ;(r.children.forEach((y) => {
                  y.type !== 'array' && y.type !== 'object' && p.add(this.getLabelForValue(ft(y)))
                }),
                  (d = {
                    ...a,
                    add(y) {
            ...
            if (l !== void 0) {
              ...
              if (g.schema.patternProperties && !d)
                for (const p of Object.keys(g.schema.patternProperties)) {
                  ...
                  if (y != null && y.test(l)) {
                    d = !0
                    const w = g.schema.patternProperties[p]
                    this.addSchemaValueCompletions(w, f, a, o)
                  }
                }
        ...
        ;(l === '$schema' && !r.parent && this.addDollarSchemaCompletions(f, a),
          o.boolean &&
            (this.addBooleanValueCompletion(!0, f, a), this.addBooleanValueCompletion(!1, f, a)),
    ...
    addDefaultValueCompletions(e, n, r, i = 0) {
      ...
      if (Ee(e.default)) {
        ...
        ;(this.doesSupportsLabelDetails()
          ? (u.labelDetails = { description: P('Default value') })
          : (u.detail = P('Default value')),
          r.add(u),
          (s = !0))
      }
...
` + d
      ...
      if (
        ...
        for (let i = 0, s = e.enum.length; i < s; i++) {
          ...
          this.doesSupportMarkdown()
            ...
            : e.enumDescriptions && i < e.enumDescriptions.length && (o = e.enumDescriptions[i]),
            r.add({
              kind: this.getSuggestionKind(e.type),
    ...
    collectTypes(e, n) {
      if (Array.isArray(e.enum) || Ee(e.const)) return
      const r = e.type
    ...
    getInsertTextForSnippetValue(e, n) {
      return (
        ei(e, '', (i) => (typeof i == 'string' && i[0] === '^' ? i.substr(1) : JSON.stringify(i))) +
        n
      )
    }
      ...
      if (n) {
        if (Array.isArray(n.defaultSnippets)) {
          if (n.defaultSnippets.length === 1) {
            ...
            Ee(l) && (o = this.getInsertTextForSnippetValue(l, ''))
          }
          u += n.defaultSnippets.length
        }
        if (
          (n.enum &&
            (!o && n.enum.length === 1 && (o = this.getInsertTextForGuessedValue(n.enum[0], '')),
            (u += n.enum.length)),
          Ee(n.const) && (o || (o = this.getInsertTextForGuessedValue(n.const, '')), u++),
          Ee(n.default) && (o || (o = this.getInsertTextForGuessedValue(n.default, '')), u++),
...
\r\v":{[,]}`.indexOf(i.charAt(r)) === -1;
      ...
      for (let a = s.length - 1; a >= 0; a--) {
        ...
        if (r > o.offset + o.length)
          return (
            ...
            i.scan() === 5 && r >= i.getTokenOffset() + i.getTokenLength() ? a + 1 : a
          )
    ...
    isInComment(e, n, r) {
      const i = lt(e.getText(), !1)
      i.setPosition(n)
      let s = i.scan()
      for (; s !== 17 && i.getTokenOffset() + i.getTokenLength() < r; ) s = i.scan()
      return (s === 12 || s === 13) && i.getTokenOffset() <= r
    }
    fromMarkup(e) {
      if (e && this.doesSupportMarkdown()) return { kind: ut.Markdown, value: e }
    }
    doesSupportMarkdown() {
      var e, n, r
      if (!Ee(this.supportsMarkdown)) {
        const i =
          (r =
            (n = (e = this.clientCapabilities.textDocument) == null ? void 0 : e.completion) == null
              ? void 0
              : n.completionItem) == null
            ? void 0
            : r.documentationFormat
        this.supportsMarkdown = Array.isArray(i) && i.indexOf(ut.Markdown) !== -1
      }
    ...
    doesSupportsCommitCharacters() {
      var e, n, r
      return (
        Ee(this.supportsCommitCharacters) ||
          (this.labelDetailsSupport =
            (r =
              (n = (e = this.clientCapabilities.textDocument) == null ? void 0 : e.completion) ==
              null
                ? void 0
                : n.completionItem) == null
              ? void 0
              : r.commitCharactersSupport),
  ...
  class s1 {
    ...
    doHover(e, n, r) {
      ...
      const o = W.create(e.positionAt(a.offset), e.positionAt(a.offset + a.length)),
        ...
        if (h && s) {
          ...
          f.every((w) => {
            if (
              ...
              w.schema &&
              ((m = m || w.schema.title),
              (g = g || w.schema.markdownDescription || ti(w.schema.description)),
              w.schema.enum)
            ) {
              const N = w.schema.enum.indexOf(ft(s))
              ;(w.schema.markdownEnumDescriptions
                ? (d = w.schema.markdownEnumDescriptions[N])
                : w.schema.enumDescriptions && (d = ti(w.schema.enumDescriptions[N])),
                d && ((p = w.schema.enum[N]), typeof p != 'string' && (p = JSON.stringify(p))))
            }
            return !0
          })
          let y = ''
...
$3`
  ...
  class o1 {
    ...
    doValidation(e, n, r, i) {
      ...
      const s = [],
        ...
        u = (l) => {
          let h = r != null && r.trailingCommas ? Vn(r.trailingCommas) : ye.Error,
            f = r != null && r.comments ? Vn(r.comments) : this.commentSeverity,
            m = r != null && r.schemaValidation ? Vn(r.schemaValidation) : ye.Warning,
            g = r != null && r.schemaRequest ? Vn(r.schemaRequest) : ye.Warning
          if (l) {
            const d = (p, y) => {
              if (n.root && g) {
                const w = n.root,
                  N = w.type === 'object' ? w.properties[0] : void 0
                if (N && N.keyNode.value === '$schema') {
                  const b = N.valueNode || N,
                    _ = W.create(e.positionAt(b.offset), e.positionAt(b.offset + b.length))
                  o(Ge.create(_, p, g, y))
                } else {
                  const b = W.create(e.positionAt(w.offset), e.positionAt(w.offset + 1))
                  o(Ge.create(b, p, g, y))
                }
              }
            }
            if (l.errors.length) d(l.errors[0], G.SchemaResolveError)
              ...
              const p = n.validate(e, l.schema, m, r == null ? void 0 : r.schemaDraft)
              p && p.forEach(o)
            }
            ;(Mo(l.schema) && (f = void 0), To(l.schema) && (h = void 0))
          }
          ...
          if (typeof f == 'number') {
            ...
            n.comments.forEach((p) => {
              o(Ge.create(p, d, f, G.CommentNotPermitted))
            })
          }
          return s
        }
      if (i) {
        const l = i.id || 'schemaservice://untitled/' + l1++
        return this.jsonSchemaService
          .registerExternalSchema({ uri: l, schema: i })
          .getResolvedSchema()
          .then((f) => u(f))
      }
      return this.jsonSchemaService.getSchemaForResource(e.uri, n).then((l) => u(l))
    }
  ...
  function Mo(t) {
    if (t && typeof t == 'object') {
      if (Ve(t.allowComments)) return t.allowComments
      if (t.allOf)
  ...
  function To(t) {
    if (t && typeof t == 'object') {
      if (Ve(t.allowTrailingCommas)) return t.allowTrailingCommas
      const e = t
      if (Ve(e.allowsTrailingCommas)) return e.allowsTrailingCommas
      if (t.allOf)
  ...
  function ne(t) {
    return t < Po
      ...
      : t <= u1
        ? t - Po
        : (t < Dn && (t += Dn - c1), t >= Dn && t <= f1 ? t - Dn + 10 : 0)
  }
  function h1(t) {
    if (t[0] === '#')
      switch (t.length) {
  ...
  class m1 {
    ...
    findDocumentSymbols(e, n, r = { resultLimit: Number.MAX_VALUE }) {
      ...
      if (
        (a === 'vscode://defaultsettings/keybindings.json' ||
          nn(a.toLowerCase(), '/user/keybindings.json')) &&
        i.type === 'array'
      ) {
        const m = []
          ...
          if (g.type === 'object') {
            for (const d of g.properties)
              if (d.keyNode.value === 'key' && d.valueNode) {
                const p = It.create(e.uri, et(e, g))
                if (
                  (m.push({ name: Co(d.valueNode), kind: Oe.Function, location: p }), s--, s <= 0)
                )
                  return (r && r.onResultLimitExceeded && r.onResultLimitExceeded(a), m)
              }
          }
        return m
      }
            ...
            : m.type === 'object' &&
              m.properties.forEach((d) => {
                ...
                if (p)
                  if (s > 0) {
                    s--
                    const y = It.create(e.uri, et(e, d)),
                      w = g ? g + '.' + d.keyNode.value : d.keyNode.value
                    ;(h.push({
            ...
            m.properties.forEach((d) => {
              ...
              if (p)
                if (s > 0) {
                  ...
                  ;(g.push(b), u.push({ result: N, node: p }))
                } else h = !0
            })
      }
      for (; l < u.length; ) {
        ...
        if (i) {
          ...
          for (const l of o)
            if (
              !l.inverted &&
              l.schema &&
              (l.schema.format === 'color' || l.schema.format === 'color-hex') &&
              l.node &&
              l.node.type === 'string'
            ) {
              const h = String(l.node.offset)
              if (!u[h]) {
                const f = h1(ft(l.node))
                if (f) {
                  const m = et(e, l.node)
                  s.push({ color: f, range: m })
                }
                if (((u[h] = !0), a--, a <= 0))
                  return (r && r.onResultLimitExceeded && r.onResultLimitExceeded(e.uri), s)
              }
            }
        }
        return s
    ...
    getColorPresentations(e, n, r, i) {
      ...
      return (
        ...
        s.push({ label: h, textEdit: De.replace(i, JSON.stringify(h)) }),
        s
      )
    }
  }
  ...
  for (const t in ni.schemas) {
    const e = ni.schemas[t]
  ...
  ;(() => {
    var t = {
        470: (i) => {
          ...
          function a(u, l) {
            for (var h, f = '', m = 0, g = -1, d = 0, p = 0; p <= u.length; ++p) {
              ...
              if (h === 47) {
                if (!(g === p - 1 || d === 1))
                  if (g !== p - 1 && d === 2) {
                    if (
                      ...
                      if (f.length > 2) {
                        ...
                        if (y !== f.length - 1) {
                          ;(y === -1
                            ? ((f = ''), (m = 0))
                            : (m = (f = f.slice(0, y)).length - 1 - f.lastIndexOf('/')),
                            (g = p),
                            (d = 0))
                          continue
                        }
                    ...
                    (f.length > 0 ? (f += '/' + u.slice(g + 1, p)) : (f = u.slice(g + 1, p)),
                      (m = p - g - 1))
                ;((g = p), (d = 0))
              } else h === 46 && d !== -1 ? ++d : (d = -1)
            }
          ...
          var o = {
            resolve: function () {
              for (var u, l = '', h = !1, f = arguments.length - 1; f >= -1 && !h; f--) {
                var m
                ;(f >= 0 ? (m = arguments[f]) : (u === void 0 && (u = process.cwd()), (m = u)),
                  s(m),
                  m.length !== 0 && ((l = m + '/' + l), (h = m.charCodeAt(0) === 47)))
              }
            ...
            relative: function (u, l) {
              ...
              for (var f = u.length, m = f - h, g = 1; g < l.length && l.charCodeAt(g) === 47; ++g);
              for (var d = l.length - g, p = m < d ? m : d, y = -1, w = 0; w <= p; ++w) {
                if (w === p) {
                  if (d > p) {
                    if (l.charCodeAt(g + w) === 47) return l.slice(g + w + 1)
                    if (w === 0) return l.slice(g + w)
                  } else m > p && (u.charCodeAt(h + w) === 47 ? (y = w) : w === 0 && (y = 0))
                  break
                }
                var N = u.charCodeAt(h + w)
                if (N !== l.charCodeAt(g + w)) break
                N === 47 && (y = w)
              }
              var b = ''
              for (w = h + y + 1; w <= f; ++w)
                (w !== f && u.charCodeAt(w) !== 47) || (b.length === 0 ? (b += '..') : (b += '/..'))
              return b.length > 0
                ? b + l.slice(g + y)
            ...
            dirname: function (u) {
              if ((s(u), u.length === 0)) return '.'
              for (
                var l = u.charCodeAt(0), h = l === 47, f = -1, m = !0, g = u.length - 1;
                g >= 1;
                --g
              )
              ...
              if (l !== void 0 && l.length > 0 && l.length <= u.length) {
                ...
                for (h = u.length - 1; h >= 0; --h) {
                  ...
                  if (y === 47) {
                    ...
                    (p === -1 && ((g = !1), (p = h + 1)),
                      d >= 0 &&
                        (y === l.charCodeAt(d) ? --d == -1 && (m = h) : ((d = -1), (m = p))))
                }
                return (f === m ? (m = p) : m === -1 && (m = u.length), u.slice(f, m))
              }
              for (h = u.length - 1; h >= 0; --h)
            ...
            extname: function (u) {
              s(u)
              for (var l = -1, h = 0, f = -1, m = !0, g = 0, d = u.length - 1; d >= 0; --d) {
                var p = u.charCodeAt(d)
                if (p !== 47)
                  (f === -1 && ((m = !1), (f = d + 1)),
                    p === 46 ? (l === -1 ? (l = d) : g !== 1 && (g = 1)) : l !== -1 && (g = -1))
                else if (!m) {
                  h = d + 1
                  break
                }
              }
              return l === -1 || f === -1 || g === 0 || (g === 1 && l === f - 1 && l === h + 1)
                ? ''
                : u.slice(l, f)
            },
            format: function (u) {
            ...
            parse: function (u) {
              ...
              var h,
                ...
                m = f === 47
              m ? ((l.root = '/'), (h = 1)) : (h = 0)
              for (var g = -1, d = 0, p = -1, y = !0, w = u.length - 1, N = 0; w >= h; --w)
                if ((f = u.charCodeAt(w)) !== 47)
                  (p === -1 && ((y = !1), (p = w + 1)),
                    f === 46 ? (g === -1 ? (g = w) : N !== 1 && (N = 1)) : g !== -1 && (N = -1))
                else if (!y) {
                  d = w + 1
                  break
                }
              return (
                g === -1 || p === -1 || N === 0 || (N === 1 && g === p - 1 && g === d + 1)
                  ? p !== -1 && (l.base = l.name = d === 0 && m ? u.slice(1, p) : u.slice(d, p))
                  : (d === 0 && m
    ...
    ;((() => {
      ...
      class m {
        constructor(x, S, C, I, F, D = !1) {
          ...
          nt(this, 'fragment')
          typeof x == 'object'
            ? ((this.scheme = x.scheme || l),
              (this.authority = x.authority || l),
              (this.path = x.path || l),
              (this.query = x.query || l),
              (this.fragment = x.fragment || l))
            : ((this.scheme = (function (B, X) {
                return B || X ? B : 'file'
              })(x, D)),
              (this.authority = S || l),
              (this.path = (function (B, X) {
                switch (B) {
                  case 'https':
                  case 'http':
                  case 'file':
        ...
        static isUri(x) {
          return (
            x instanceof m ||
            (!!x &&
              typeof x.authority == 'string' &&
              typeof x.fragment == 'string' &&
              typeof x.path == 'string' &&
              typeof x.query == 'string' &&
              typeof x.scheme == 'string' &&
              typeof x.fsPath == 'string' &&
              typeof x.with == 'function' &&
        ...
        with(x) {
          if (!x) return this
          let { scheme: S, authority: C, path: I, query: F, fragment: D } = x
          return (
            S === void 0 ? (S = this.scheme) : S === null && (S = l),
            C === void 0 ? (C = this.authority) : C === null && (C = l),
            I === void 0 ? (I = this.path) : I === null && (I = l),
            F === void 0 ? (F = this.query) : F === null && (F = l),
            D === void 0 ? (D = this.fragment) : D === null && (D = l),
            S === this.scheme &&
            C === this.authority &&
            I === this.path &&
            F === this.query &&
        ...
        static parse(x, S = !1) {
          const C = f.exec(x)
          return C
            ? new d(C[2] || l, A(C[4] || l), A(C[5] || l), A(C[7] || l), A(C[9] || l), S)
            : new d(l, l, l, l, l)
        }
        static file(x) {
          let S = l
          if ((i && (x = x.replace(/\\/g, h)), x[0] === h && x[1] === h)) {
            ...
            C === -1
              ? ((S = x.substring(2)), (x = h))
              : ((S = x.substring(2, C)), (x = x.substring(C) || h))
          }
          return new d('file', S, x, l, l)
        }
        static from(x) {
          const S = new d(x.scheme, x.authority, x.path, x.query, x.fragment)
          return (u(S, !0), S)
        }
        toString(x = !1) {
          return b(this, x)
        ...
        static revive(x) {
          if (x) {
            if (x instanceof m) return x
            {
              const S = new d(x)
              return ((S._formatted = x.external), (S._fsPath = x._sep === g ? x.fsPath : null), S)
            }
          }
          return x
        }
      ...
      class d extends m {
        ...
        toString(S = !1) {
          return S
            ? b(this, !0)
            : (this._formatted || (this._formatted = b(this, !1)), this._formatted)
        }
        toJSON() {
          const S = { $mid: 1 }
          return (
            this._fsPath && ((S.fsPath = this._fsPath), (S._sep = g)),
            this._formatted && (S.external = this._formatted),
            this.path && (S.path = this.path),
            this.scheme && (S.scheme = this.scheme),
            this.authority && (S.authority = this.authority),
            this.query && (S.query = this.query),
            this.fragment && (S.fragment = this.fragment),
            S
          )
        }
      }
      ...
      function y(T, x, S) {
        ...
        for (let F = 0; F < T.length; F++) {
          ...
          if (
            ...
            (I !== -1 && ((C += encodeURIComponent(T.substring(I, F))), (I = -1)),
              C !== void 0 && (C += T.charAt(F)))
          else {
            C === void 0 && (C = T.substr(0, F))
            const B = p[D]
            B !== void 0
              ? (I !== -1 && ((C += encodeURIComponent(T.substring(I, F))), (I = -1)), (C += B))
              : I === -1 && (I = F)
          }
        }
      ...
      function b(T, x) {
        const S = x ? w : y
        let C = '',
          { scheme: I, authority: F, path: D, query: B, fragment: X } = T
        if ((I && ((C += I), (C += ':')), (F || I === 'file') && ((C += h), (C += h)), F)) {
          ...
          if (z !== -1) {
            ...
            ;((F = F.substr(z + 1)),
              ...
              z === -1
                ? (C += S(Ae, !1, !1))
                : ((C += S(Ae.substr(0, z), !1, !1)),
                  (C += ':'),
                  (C += S(Ae.substr(z + 1), !1, !0))),
              (C += '@'))
          }
          ;((F = F.toLowerCase()),
            (z = F.lastIndexOf(':')),
            z === -1 ? (C += S(F, !1, !0)) : ((C += S(F.substr(0, z), !1, !0)), (C += F.substr(z))))
        }
        if (D) {
      ...
      var V
      ;(function (T) {
        ;((T.joinPath = function (x, ...S) {
          return x.with({ path: k.join(x.path, ...S) })
        }),
          (T.resolvePath = function (x, ...S) {
            let C = x.path,
              I = !1
            C[0] !== M && ((C = M + C), (I = !0))
            let F = k.resolve(C, ...S)
          ...
          (T.dirname = function (x) {
            ...
            let S = k.dirname(x.path)
            return (S.length === 1 && S.charCodeAt(0) === 46 && (S = ''), x.with({ path: S }))
          }),
        ...
        case '*':
          ...
          s
            ? m > 1 &&
              ...
              ? (g === '/'
                  ? l++
                  : f === '/' && r.endsWith('\\/') && (r = r.substr(0, r.length - 2)),
                (r += '((?:[^/]*(?:/|$))*)'))
              : (r += '([^/]*)')
            : (r += '.*')
          break
  ...
  class y1 {
    constructor(e, n, r) {
      ...
      try {
        for (let i of e) {
          ...
          ;(s || (i = i.substring(1)),
            i.length > 0 &&
              (i[0] === b1 && (i = i.substring(1)),
              this.globWrappers.push({
                regexp: g1('**/' + i, { extended: !0, globstar: !0 }),
                include: s
              })))
        }
        n && ((n = Vo(n)), n.endsWith('/') || (n = n + '/'), (this.folderUri = n))
      } catch {
    ...
    matchesPattern(e) {
      ...
      let n = !1
      for (const { regexp: r, include: i } of this.globWrappers) r.test(e) && (n = i)
      return n
    }
    getURIs() {
      return this.uris
  ...
  class w1 {
    constructor(e, n, r) {
      ;((this.service = e),
        ...
        (this.anchors = void 0),
        r && (this.unresolvedSchema = this.service.promise.resolve(new ln(r))))
    }
    getUnresolvedSchema() {
      return (
  ...
  class Fo {
    constructor(e, n = [], r = [], i) {
      ;((this.schema = e), (this.errors = n), (this.warnings = r), (this.schemaDraft = i))
    }
    getSection(e) {
    ...
    getSectionRecursive(e, n) {
      ...
      if (n.patternProperties)
        for (const i of Object.keys(n.patternProperties)) {
          const s = Tn(i)
          if (s != null && s.test(r)) return this.getSectionRecursive(e, n.patternProperties[i])
        }
      else {
        ...
        if (r.match('[0-9]+')) {
          if (Array.isArray(n.items)) {
            ...
            if (!isNaN(i) && n.items[i]) return this.getSectionRecursive(e, n.items[i])
  ...
  class x1 {
      ...
      for (; r.length; ) {
        ...
        for (let a = 0; a < i.length; a++) {
          ...
          o &&
            ...
            (o.uri !== s && r.push(o.uri), o.clearSchema() && (n = !0), (i[a] = void 0))
        }
      }
      return n
    }
    ...
    registerExternalSchema(e) {
      ...
      return (
        ...
        e.schema ? this.addSchemaHandle(n, e.schema) : this.getOrAddSchemaHandle(n)
      )
    }
    ...
    loadSchema(e) {
      if (!this.requestService) {
        const n = P("Unable to load schema from '{0}'. No schema request service available", un(e))
        return this.promise.resolve(new ln({}, [n]))
      }
      return (
        e.startsWith('http://json-schema.org/') && (e = 'https' + e.substring(4)),
        this.requestService(e).then(
          (n) => {
            if (!n) {
              const a = P("Unable to load schema from '{0}': No content.", un(e))
              return new ln({}, [a])
            }
            const r = []
          ...
          (n) => {
            ...
            return (
              i.length > 1 && (r = i[1]),
              nn(r, '.') && (r = r.substr(0, r.length - 1)),
              new ln({}, [P("Unable to load schema from '{0}': {1}.", un(e), r)])
            )
          }
        )
      )
    ...
    resolveSchemaContent(e, n) {
      const r = e.errors.slice(0),
        i = e.schema
      let s = i.$schema ? tt(i.$schema) : void 0
      if (s === 'http://json-schema.org/draft-03/schema')
        return this.promise.resolve(new Fo({}, [P('Draft-03 schemas are not supported.')], [], s))
      let a = new Set()
      const o = this.contextService,
        u = (p, y) => {
          ...
          return (
            ...
            y
              .split('/')
              .some((N) => ((N = N.replace(/~1/g, '/').replace(/~0/g, '~')), (w = w[N]), !w)),
            w
          )
        },
        l = (p, y, w) => (y.anchors || (y.anchors = d(p)), y.anchors.get(w)),
        h = (p, y) => {
          for (const w in y) y.hasOwnProperty(w) && w !== 'id' && w !== '$id' && (p[w] = y[w])
        },
        f = (p, y, w, N) => {
          let b
          ;(N === void 0 || N.length === 0
            ...
            : N.charAt(0) === '/'
              ? (b = u(y, N))
              : (b = l(y, w, N)),
            b ? h(p, b) : r.push(P("$ref '{0}' in '{1}' can not be resolved.", N || '', w.uri)))
        },
        m = (p, y, w, N) => {
          ;(o &&
            !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(y) &&
            (y = o.resolveRelativePath(y, N.uri)),
            (y = tt(y)))
          const b = this.getOrAddSchemaHandle(y)
          return b.getUnresolvedSchema().then((_) => {
            if ((N.dependencies.add(y), _.errors.length)) {
              const L = w ? y + '#' + w : y
              r.push(P("Problems loading reference '{0}': {1}", L, _.errors[0]))
            }
            return (f(p, _.schema, b, w), g(p, _.schema, b))
          })
        },
        g = (p, y, w) => {
          const N = []
        ...
        d = (p) => {
          const y = new Map()
          return (
            this.traverseNodes(p, (w) => {
              const N = w.$id || w.id,
                b = Sa(N) && N.charAt(0) === '#' ? N.substring(1) : w.$anchor
              ;(b && (y.has(b) ? r.push(P("Duplicate anchor declaration: '{0}'", b)) : y.set(b, w)),
                w.$recursiveAnchor && a.add('$recursiveAnchor'),
                w.$dynamicAnchor && a.add('$dynamicAnchor'))
            }),
            y
          )
        }
    ...
    traverseNodes(e, n) {
      ...
      const r = new Set(),
        i = (...h) => {
          for (const f of h) Ke(f) && u.push(f)
        },
        s = (...h) => {
          for (const f of h)
            if (Ke(f))
        ...
        a = (...h) => {
          for (const f of h) if (Array.isArray(f)) for (const m of f) Ke(m) && u.push(m)
        },
        o = (h) => {
          if (Array.isArray(h)) for (const f of h) Ke(f) && u.push(f)
          else Ke(h) && u.push(h)
        },
        u = [e]
      let l = u.pop()
    ...
    getSchemaFromProperty(e, n) {
      ...
      if (((r = n.root) == null ? void 0 : r.type) === 'object') {
        for (const s of n.root.properties)
          if (
            s.keyNode.value === '$schema' &&
            ((i = s.valueNode) == null ? void 0 : i.type) === 'string'
          ) {
    ...
    getAssociatedSchemas(e) {
      ...
      for (const s of this.filePatternAssociations)
        if (s.matchesPattern(i)) for (const a of s.getURIs()) n[a] || (r.push(a), (n[a] = !0))
      return r
    }
    ...
    getMatchingSchemas(e, n, r) {
      if (r) {
        const i = r.id || 'schemaservice://untitled/matchingSchemas/' + v1++
        return this.addSchemaHandle(i, r)
          .getResolvedSchema()
          .then((a) => n.getMatchingSchemas(a.schema).filter((o) => !o.inverted))
      }
  ...
  function Vo(t) {
    try {
      return Dt.parse(t).with({ fragment: null, query: null }).toString(!0)
    } catch {
      return t
    }
  }
      ...
      switch (o) {
        ...
        case 3: {
          const d = t.positionAt(a.getTokenOffset()).line,
            p = { startLine: d, endLine: d, kind: o === 1 ? 'object' : 'array' }
          i.push(p)
          break
        }
        case 2:
        ...
        case 13: {
          ...
          a.getTokenError() === 1 && d + 1 < t.lineCount
            ...
            : d < p && (u({ startLine: d, endLine: p, kind: rn.Comment }), (s = d))
          break
        }
        case 12: {
          const p = t
          ...
          if (p) {
            ...
            if (p[1]) {
              const w = { startLine: y, endLine: y, kind: rn.Region }
              i.push(w)
            } else {
              let w = i.length - 1
              for (; w >= 0 && i[w].kind !== rn.Region; ) w--
              if (w >= 0) {
                const N = i[w]
                ;((i.length = w),
                  y > N.startLine &&
                    s !== N.startLine &&
                    ((N.endLine = y), u(N), (s = N.startLine)))
              }
            }
          }
          break
  ...
  function N1(t, e, n) {
    function r(o) {
      ...
      let f
      for (let m = h.length - 1; m >= 0; m--) f = Fn.create(h[m], f)
      return (f || (f = Fn.create(W.create(o, o))), f)
    }
    function i(o, u) {
      return W.create(t.positionAt(o), t.positionAt(u))
    }
    const s = lt(t.getText(), !0)
    function a(o, u) {
...
`,
    ...
    return jc(t.getText(), r, i).map((s) =>
      De.replace(W.create(t.positionAt(s.offset), t.positionAt(s.offset + s.length)), s.content)
    )
  }
  var se
  ;(function (t) {
    ...
    addChildProperty(e) {
      if (((e.parent = this), this.childrenProperties.length > 0)) {
        ...
        ;(e.noKeyName
          ...
          : (n = S1(this.childrenProperties, e, _1)),
          n < 0 && (n = n * -1 - 1),
  ...
  function A1(t, e) {
    const n = { ...e, keepLines: !1 },
      r = Me.applyEdits(t, ri(t, n, void 0)),
      i = Me.create('test://test.json', 'json', 0, r),
      s = k1(i),
      a = R1(i, s),
      o = ri(a, n, void 0),
      u = Me.applyEdits(a, o)
    return [De.replace(W.create(ee.create(0, 0), t.positionAt(t.getText().length)), u)]
  }
  function k1(t) {
    const e = t.getText(),
      n = lt(e, !1)
    let r = new On(),
      ...
      N = !1
    for (; (o = n.scan()) !== 17; ) {
      if (w === !0 && o !== 14 && o !== 15 && o !== 12 && o !== 13 && s.endLineNumber === void 0) {
        let b = n.getTokenStartLine()
        ;(f === 2 || f === 4 ? (a.endLineNumber = b - 1) : (s.endLineNumber = b - 1),
          (d = b),
          (w = !1))
      }
      if (
        (N === !0 &&
          ...
          o !== 12 &&
          o !== 13 &&
          ((d = n.getTokenStartLine()), (N = !1)),
        n.getTokenStartLine() !== u)
      ) {
        for (let b = u; b < n.getTokenStartLine(); b++) {
          const _ = t.getText(W.create(ee.create(b, 0), ee.create(b + 1, 0))).length
          l = l + _
        }
      ...
      switch (o) {
        case 10: {
          if (h === void 0 || h === 1 || (h === 5 && y[y.length - 1] === se.Object)) {
            const b = new On(n.getTokenValue(), d)
        ...
        case 3: {
          if (
            (r.beginningLineNumber === void 0 && (r.beginningLineNumber = n.getTokenStartLine()),
        ...
        case 5: {
          ;((p = n.getTokenStartLine()),
            s.endLineNumber === void 0 &&
              ...
              ((s.endLineNumber = p), (s.commaIndex = n.getTokenOffset() - l), (s.commaLine = p)),
            (h === 2 || h === 4) && ((a = s), (s = s ? s.parent : void 0), (i = s)),
            (d = p + 1))
          break
        }
        case 13: {
          ;(h === 5 &&
            ...
            ((y[y.length - 1] === se.Array && (f === 2 || f === 4)) ||
              y[y.length - 1] === se.Object) &&
            ((s.endLineNumber = void 0), (w = !0)),
            (h === 1 || h === 3) && m === n.getTokenStartLine() && (N = !0))
          break
        }
      }
      o !== 14 &&
  ...
  function R1(t, e) {
    ...
    const n = Me.create('test://test.json', 'json', 0, t.getText()),
      r = []
    for (Do(r, e, e.beginningLineNumber); r.length > 0; ) {
      const i = r.shift(),
        s = i.propertyTreeArray
      let a = i.beginningLineNumber
      for (let o = 0; o < s.length; o++) {
        const u = s[o],
          l = W.create(ee.create(u.beginningLineNumber, 0), ee.create(u.endLineNumber + 1, 0)),
          h = t.getText(l),
          f = Me.create('test://test.json', 'json', 0, h)
        if (u.lastProperty === !0 && o !== s.length - 1) {
          const d = u.lineWhereToAddComma - u.beginningLineNumber,
            p = u.indexWhereToAddComa,
            y = { range: W.create(ee.create(d, p), ee.create(d, p)), text: ',' }
          Me.update(f, [y], 1)
        } else if (u.lastProperty === !1 && o === s.length - 1) {
          const d = u.commaIndex,
            y = u.commaLine - u.beginningLineNumber,
            w = { range: W.create(ee.create(y, d), ee.create(y, d + 1)), text: '' }
          Me.update(f, [w], 1)
        }
        const m = u.endLineNumber - u.beginningLineNumber + 1,
          g = { range: W.create(ee.create(a, 0), ee.create(a + m, 0)), text: f.getText() }
        ;(Me.update(n, [g], 1), Do(r, u, a), (a = a + m))
      }
    }
    return n
  }
  function Do(t, e, n) {
    if (e.childrenProperties.length !== 0)
      if (e.type === se.Object) {
        ...
        ;((n = n + i), t.push(new $o(n, e.childrenProperties)))
      } else e.type === se.Array && Oo(t, e, n)
  }
  function Oo(t, e, n) {
    for (const r of e.childrenProperties) {
      if (r.type === se.Object) {
        ...
        t.push(new $o(n + r.beginningLineNumber - e.beginningLineNumber + s, r.childrenProperties))
      }
      r.type === se.Array && Oo(t, r, n + r.beginningLineNumber - e.beginningLineNumber)
    }
  }
  class $o {
    constructor(e, n) {
    ...
    return (
      e.visit((r) => {
        ...
        if (
          r.type === 'property' &&
          r.keyNode.value === '$ref' &&
          ((i = r.valueNode) == null ? void 0 : i.type) === 'string'
        ) {
          const s = r.valueNode.value,
            a = T1(e, s)
          if (a) {
            const o = t.positionAt(a.offset)
            n.push({
              target: `${t.uri}#${o.line + 1},${o.character + 1}`,
              range: M1(t, r.valueNode)
            })
          }
        }
        return !0
  ...
  function M1(t, e) {
    return W.create(t.positionAt(e.offset + 1), t.positionAt(e.offset + e.length - 1))
  }
  function T1(t, e) {
    const n = P1(e)
    return n ? ii(n, t.root) : null
  }
  function ii(t, e) {
    if (!e) return null
    if (t.length === 0) return e
    ...
    if (e && e.type === 'object') {
      ...
      return r ? ii(t, r.valueNode) : null
    } else if (e && e.type === 'array' && n.match(/^(0|[1-9][0-9]*)$/)) {
      const r = Number.parseInt(n),
        i = e.items[r]
      return i ? ii(t, i) : null
    }
    return null
  }
  function P1(t) {
    return t === '#' ? [] : t[0] !== '#' || t[1] !== '/' ? null : t.substring(2).split(/\//).map(C1)
  }
  function C1(t) {
  ...
  function I1(t) {
    const e = t.promiseConstructor || Promise,
      n = new x1(t.schemaRequestService, t.workspaceContext, e)
    n.setSchemaContributions(ni)
    const r = new i1(n, t.contributions, e, t.clientCapabilities),
      i = new s1(n, t.contributions, e),
      s = new m1(n),
      a = new o1(n, e)
    return {
      configure: (o) => {
        ...
        ;(n.clearExternalSchemas(),
          (u = o.schemas) == null || u.forEach(n.registerExternalSchema.bind(n)),
          a.configure(o))
      },
      resetSchema: (o) => n.onResourceChange(o),
      doValidation: a.doValidation.bind(a),
      getLanguageStatus: a.getLanguageStatus.bind(a),
      parseJSONDocument: (o) => r1(o, { collectComments: !0 }),
      newJSONDocument: (o, u) => n1(o, u),
      ...
      getFoldingRanges: L1,
      getSelectionRanges: N1,
      findDefinition: () => Promise.resolve([]),
      findLinks: E1,
      format: (o, u, l) => ri(o, l, u),
      sort: (o, u) => A1(o, u)
    }
  }
  let Bo
  ...
  class F1 {
    constructor(e, n) {
      ;((this._ctx = e),
        ...
        (this._languageService = I1({
          ...
          schemaRequestService: n.enableSchemaRequest ? Bo : void 0,
          clientCapabilities: Qr.LATEST
        })),
    ...
    _getTextDocument(e) {
      ...
      for (let r of n)
        if (r.uri.toString() === e) return Me.create(e, this._languageId, r.version, r.getValue())
      return null
    }
  }
  const V1 = 47,
  ...
  function Uo(t) {
    ...
    for (const r of t)
      r.length === 0 ||
        (r.length === 1 && r.charCodeAt(0) === si) ||
        (r.length === 2 && r.charCodeAt(0) === si && r.charCodeAt(1) === si ? e.pop() : e.push(r))
