...
` +
  ...
  function $t(t) {
    if (t instanceof Error) {
      ...
      return {
        ...
        message: n,
        stack: s,
        noTelemetry: Ve.isErrorNoTelemetry(t),
        cause: r ? $t(r) : void 0,
        code: t.code
      }
    }
  ...
  const Ht = 'Canceled'
  function Gs(t) {
    return t instanceof En ? !0 : t instanceof Error && t.name === Ht && t.message === Ht
  }
  ...
  function js(t, e = 'Unreachable') {
    throw new Error(e)
  }
  function Os(t, e = 'unexpected state') {
    if (!t) throw typeof e == 'string' ? new Z(`Assertion Failed: ${e}`) : e
  }
  function pt(t) {
    if (!t()) {
      debugger
      ;(t(), bt(new Z('Assertion Failed')))
    }
  }
  function kn(t, e) {
    let n = 0
  ...
  ;(function (t) {
    ...
    t.from = l
    function* o(w) {
      for (let x = w.length - 1; x >= 0; x--) yield w[x]
    }
    t.reverse = o
    function u(w) {
    ...
    function h(w, x) {
      let A = 0
      for (const D of w) if (x(D, A++)) return !0
      return !1
    }
    t.some = h
    function f(w, x) {
      let A = 0
      for (const D of w) if (!x(D, A++)) return !1
      return !0
    }
    t.every = f
    function m(w, x) {
      for (const A of w) if (x(A)) return A
    }
    t.find = m
    function* p(w, x) {
      for (const A of w) x(A) && (yield A)
    }
    t.filter = p
    function* g(w, x) {
      let A = 0
      for (const D of w) yield x(D, A++)
    }
    t.map = g
    function* d(w, x) {
      let A = 0
    ...
    t.flatMap = d
    function* _(...w) {
      for (const x of w) Qs(x) ? yield* x : yield x
    }
    t.concat = _
    function N(w, x, A) {
      let D = A
      for (const V of w) D = x(D, V)
      return D
    }
    t.reduce = N
    function v(w) {
    ...
    t.slice = L
    function E(w, x = Number.POSITIVE_INFINITY) {
      const A = []
      if (x === 0) return [A, w]
      const D = w[Symbol.iterator]()
      for (let V = 0; V < x; V++) {
        const y = D.next()
        if (y.done) return [A, t.empty()]
        A.push(y.value)
      }
      return [
        A,
    ...
    async function P(w) {
      const x = []
      for await (const A of w) x.push(A)
      return x
    }
    t.asyncToArray = P
    async function I(w) {
      let x = []
      for await (const A of w) x = x.concat(A)
      return x
    }
    t.asyncToArrayFlat = I
  })(wt || (wt = {}))
  function F1(t, e) {}
  function Mn(t) {
    if (wt.is(t)) {
  ...
  const Ye = class Ye {
    constructor(e) {
      ;((this.element = e), (this.next = Ye.Undefined), (this.prev = Ye.Undefined))
    }
  }
  Ye.Undefined = new Ye(void 0)
  let j = Ye
  class Zs {
    constructor() {
      ...
      if (e.prev !== j.Undefined && e.next !== j.Undefined) {
        ...
        e.prev === j.Undefined && e.next === j.Undefined
          ...
          : e.next === j.Undefined
            ...
            : e.prev === j.Undefined &&
              ((this._first = this._first.next), (this._first.prev = j.Undefined))
      this._size -= 1
    }
    *[Symbol.iterator]() {
      let e = this._first
  ...
  const Ks = globalThis.performance.now.bind(globalThis.performance)
  class yt {
    static create(e) {
      return new yt(e)
    }
    constructor(e) {
      ;((this._now = e === !1 ? Date.now : Ks),
  ...
  ;(function (t) {
    t.None = () => Re.None
    function e(y, S) {
      return m(y, () => {}, 0, void 0, !0, void 0, S)
    }
    t.defer = e
    function n(y) {
      return (S, k = null, R) => {
    ...
    t.once = n
    function r(y, S) {
      return t.once(t.filter(y, S))
    }
    t.onceIf = r
    function s(y, S, k) {
      return h((R, F = null, U) => y((W) => R.call(F, S(W)), null, U), k)
    }
    t.map = s
    function i(y, S, k) {
      return h(
    ...
    t.forEach = i
    function l(y, S, k) {
      return h((R, F = null, U) => y((W) => S(W) && R.call(F, W), null, U), k)
    }
    t.filter = l
    function o(y) {
      return y
    ...
    function u(...y) {
      return (S, k = null, R) => {
        const F = Js(...y.map((U) => U((W) => S.call(k, W))))
        return f(F, R)
      }
    }
    t.any = u
    ...
    function f(y, S) {
      return (S instanceof Array ? S.push(y) : S && S.add(y), y)
    }
    function m(y, S, k = 100, R = !1, F = !1, U, W) {
      let Y,
        K,
        Te,
        qt = 0,
      ...
      const k1 = {
          ...
          onWillAddFirstListener() {
            Y = y((M1) => {
              ;(qt++,
                (K = S(K, M1)),
                R && !Te && (Ut.fire(K), (K = void 0)),
                (De = () => {
                  const P1 = K
                  ;((K = void 0), (Te = void 0), (!R || qt > 1) && Ut.fire(P1), (qt = 0))
                }),
                typeof k == 'number'
                  ? (Te && clearTimeout(Te), (Te = setTimeout(De, k)))
                  : Te === void 0 && ((Te = null), queueMicrotask(De)))
            })
          },
        ...
        Ut = new me(k1)
      return (W == null || W.add(Ut), Ut.event)
    }
    t.debounce = m
    function p(y, S = 0, k) {
      return t.debounce(y, (R, F) => (R ? (R.push(F), R) : [F]), S, void 0, !0, void 0, k)
    }
    t.accumulate = p
    function g(y, S = (R, F) => R === F, k) {
      let R = !0,
        F
      return l(
        y,
    ...
    t.latch = g
    function d(y, S, k) {
      return [t.filter(y, S, k), t.filter(y, (R) => !S(R), k)]
    }
    t.split = d
    function _(y, S = !1, k = [], R) {
      let F = k.slice(),
        U = y((K) => {
          F ? F.push(K) : Y.fire(K)
        })
    ...
    function E(y, S, k = (R) => R) {
      const R = (...Y) => W.fire(k(...Y)),
        F = () => y.on(S, R),
        U = () => y.removeListener(S, R),
        W = new me({ onWillAddFirstListener: F, onDidRemoveLastListener: U })
      return W.event
    }
    t.fromNodeEventEmitter = E
    function P(y, S, k = (R) => R) {
      const R = (...Y) => W.fire(k(...Y)),
        F = () => y.addEventListener(S, R),
        U = () => y.removeEventListener(S, R),
        W = new me({ onWillAddFirstListener: F, onDidRemoveLastListener: U })
      return W.event
    }
    t.fromDOMEventEmitter = P
    function I(y, S) {
      let k
      const R = new Promise((F, U) => {
        const W = n(y)(F, null, S)
        k = () => W.dispose()
      })
      return ((R.cancel = k), R)
    }
    ...
    class A {
      constructor(S, k) {
        ...
        ;((this.emitter = new me(R)), k && k.add(this.emitter))
      }
      beginUpdate(S) {
        this._counter++
      }
    ...
    function D(y, S) {
      return new A(y, S).emitter.event
    }
    t.fromObservable = D
    function V(y) {
      return (S, k, R) => {
        ...
        const W = {
          ...
          endUpdate() {
            ;(F--, F === 0 && (y.reportChanges(), U && ((U = !1), S.call(k))))
          },
        ...
        ;(y.addObserver(W), y.reportChanges())
        const Y = {
          dispose() {
            y.removeObserver(W)
          }
        }
        return (R instanceof nt ? R.add(Y) : Array.isArray(R) && R.push(Y), Y)
      }
    }
  ...
  const Dt = class Dt {
    ...
    check(e, n) {
      ...
      if (
        (this._stacks.set(e.value, s + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)
      ) {
    ...
    getMostFrequentStack() {
      ...
      let e,
        n = 0
      for (const [r, s] of this._stacks) (!e || n < s) && ((e = [r, s]), (n = s))
      return e
    }
  }
  Dt._idPool = 1
...
`)
  ...
  class me {
      ...
      ;((this._size = 0),
        ...
        (this._leakageMon =
          (n = this._options) != null && n.leakWarningThreshold
            ? new Gt(
                (e == null ? void 0 : e.onListenerError) ?? bt,
                ((r = this._options) == null ? void 0 : r.leakWarningThreshold) ?? ei
              )
            : void 0),
        (this._perfMon =
          (s = this._options) != null && s._profName ? new zt(this._options._profName) : void 0),
        (this._deliveryQueue = (i = this._options) == null ? void 0 : i.deliveryQueue))
    }
    dispose() {
      var e, n, r, s
      this._disposed ||
        ...
        (s = this._leakageMon) == null || s.dispose())
    }
    get event() {
      return (
        this._event ??
          (this._event = (e, n, r) => {
            ...
            if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
              ...
              console.warn(g)
              const d = this._leakageMon.getMostFrequentStack() ?? ['UNKNOWN stack', -1],
                _ = new ni(`${g}. HINT: Stack shows most frequent listener (${d[1]}-times)`, d[0])
              return (
                (((o = this._options) == null ? void 0 : o.onListenerError) || bt)(_),
                Re.None
              )
            }
            ...
            ;(this._leakageMon &&
              ...
              ((s.stack = jt.create()), (i = this._leakageMon.check(s.stack, this._size + 1))),
              this._listeners
                ? this._listeners instanceof Ot
                  ? (this._deliveryQueue ?? (this._deliveryQueue = new si()),
                    (this._listeners = [this._listeners, s]))
                  : this._listeners.push(s)
                : ((c = (u = this._options) == null ? void 0 : u.onWillAddFirstListener) == null ||
                    c.call(u, this),
                  (this._listeners = s),
                  (f = (h = this._options) == null ? void 0 : h.onDidAddFirstListener) == null ||
                    f.call(h, this)),
              (p = (m = this._options) == null ? void 0 : m.onDidAddListener) == null ||
                p.call(m, this),
              this._size++)
            const l = xt(() => {
              ;(i == null || i(), this._removeListener(s))
            })
            return (r instanceof nt ? r.add(l) : Array.isArray(r) && r.push(l), l)
          }),
        this._event
      )
    }
    _removeListener(e) {
      var i, l, o, u
      if (
        ((l = (i = this._options) == null ? void 0 : i.onWillRemoveListener) == null ||
          l.call(i, this),
        !this._listeners)
      )
        return
      ...
      if (this._size * ri <= n.length) {
        let c = 0
        for (let h = 0; h < n.length; h++)
          n[h]
            ? (n[c++] = n[h])
            : s &&
              c < this._deliveryQueue.end &&
              (this._deliveryQueue.end--, c < this._deliveryQueue.i && this._deliveryQueue.i--)
        n.length = c
      }
    }
    _deliver(e, n) {
      var s
      if (!e) return
      const r = ((s = this._options) == null ? void 0 : s.onListenerError) || bt
      if (!r) {
        e.value(n)
        return
      }
    ...
    fire(e) {
      ...
      if (
        ...
        (s = this._perfMon) == null || s.start(this._size),
        this._listeners)
      )
        if (this._listeners instanceof Ot) this._deliver(this._listeners, e)
        else {
          const l = this._deliveryQueue
          ;(l.enqueue(this, e, this._listeners.length), this._deliverQueue(l))
        }
      ...
      e.length === 0
        ...
        : (n = t.replace(/\{(\d+)\}/g, (r, s) => {
            ...
            return (
              typeof l == 'string'
                ? (o = l)
                : (typeof l == 'number' || typeof l == 'boolean' || l === void 0 || l === null) &&
                  (o = String(l)),
              o
            )
          })),
      ai && (n = '［' + n.replace(/[aouei]/g, '$&$&') + '］'),
      n
    )
  }
  function T(t, e, ...n) {
    return Fn(typeof t == 'number' ? li(t, e) : e, n)
  }
  function li(t, e) {
    var r
    const n = (r = ii()) == null ? void 0 : r[t]
    if (typeof n != 'string') {
  ...
  typeof Ce.vscode < 'u' && typeof Ce.vscode.process < 'u'
    ? (Q = Ce.vscode.process)
    : typeof process < 'u' &&
      typeof ((qs = process == null ? void 0 : process.versions) == null ? void 0 : qs.node) ==
        'string' &&
      (Q = process)
  const ui =
    typeof ((Us = Q == null ? void 0 : Q.versions) == null ? void 0 : Us.electron) == 'string' &&
    (Q == null ? void 0 : Q.type) === 'renderer'
  if (typeof Q == 'object') {
    ;((Xt = Q.platform === 'win32'),
      (Qt = Q.platform === 'darwin'),
      (Jt = Q.platform === 'linux'),
      Jt && Q.env.SNAP && Q.env.SNAP_REVISION,
      Q.env.CI || Q.env.BUILD_ARTIFACTSTAGINGDIRECTORY || Q.env.GITHUB_WORKSPACE,
      (_t = Ie),
      (Yt = Ie))
    const t = Q.env.VSCODE_NLS_CONFIG
    if (t)
      try {
        const e = JSON.parse(t)
        ;((_t = e.userLocale),
          (Tn = e.osLocale),
          (Yt = e.resolvedLanguage || Ie),
          (oi = ($s = e.languagePack) == null ? void 0 : $s.translationsConfigFile))
      } catch {}
  } else
    typeof navigator == 'object' && !ui
      ? ((ce = navigator.userAgent),
        (Xt = ce.indexOf('Windows') >= 0),
        (Qt = ce.indexOf('Macintosh') >= 0),
        (ce.indexOf('Macintosh') >= 0 || ce.indexOf('iPad') >= 0 || ce.indexOf('iPhone') >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (Jt = ce.indexOf('Linux') >= 0),
        (ce == null ? void 0 : ce.indexOf('Mobi')) >= 0,
        (Yt = Pn() || Ie),
  ...
  const rt = Xt,
    ci = Qt,
    de = ce,
    hi = typeof Ce.postMessage == 'function' && !Ce.importScripts
  ;(() => {
    if (hi) {
      const t = []
      ...
      return (n) => {
        const r = ++e
        ;(t.push({ id: r, callback: n }), Ce.postMessage({ vscodeScheduleAsyncWork: r }, '*'))
      }
    }
    return (t) => setTimeout(t)
  })()
  const fi = !!(de && de.indexOf('Chrome') >= 0)
  ;(de && de.indexOf('Firefox') >= 0,
    !fi && de && de.indexOf('Safari') >= 0,
    de && de.indexOf('Edg/') >= 0,
  ...
  class di {
    constructor(e, n) {
      ;((this.lastCache = void 0),
        ...
        typeof e == 'function'
          ? ((this._fn = e), (this._computeKey = mi))
  ...
  function _i(t, e) {
    ...
    const s = t.length - 1,
      i = e.length - 1
    for (r = 0; r < n; r++) if (t.charCodeAt(s - r) !== e.charCodeAt(i - r)) return r
    return n
  }
  function Kt(t) {
  ...
  const be = class be {
    static getInstance(e) {
      return be.cache.get(Array.from(e))
    }
    static getLocales() {
  ...
  ;((be.ambiguousCharacterData = new Zt(() =>
    JSON.parse(
    ...
    (be.cache = new di({ getCacheKey: JSON.stringify }, (e) => {
      function n(h) {
        const f = new Map()
      ...
      function r(h, f) {
        const m = new Map(h)
        for (const [p, g] of f) m.set(p, g)
        return m
      }
      function s(h, f) {
        if (!h) return f
        const m = new Map()
        for (const [p, g] of h) f.has(p) && m.set(p, g)
        return m
      }
      const i = be.ambiguousCharacterData.value
    ...
    (be._locales = new Zt(() =>
      Object.keys(be.ambiguousCharacterData.value).filter((e) => !e.startsWith('_'))
    )))
  let st = be
  const Ke = class Ke {
    static getRawData() {
    ...
    static getData() {
      return (
        this._data || (this._data = new Set([...Object.values(Ke.getRawData())].flat())),
        this._data
      )
    }
    static isInvisibleCharacter(e) {
      return Ke.getData().has(e)
    }
    ...
    async sendMessage(e, n, r) {
      ...
      return new Promise((i, l) => {
        ;((this._pendingReplies[s] = { resolve: i, reject: l }),
          this._send(new Ci(this._workerId, s, e, n, r)))
      })
    }
    listen(e, n, r) {
      let s = null
      const i = new me({
        onWillAddFirstListener: () => {
          ;((s = String(++this._lastSentReq)),
            ...
            this._send(new Ei(this._workerId, s, e, n, r)))
        },
        onDidRemoveLastListener: () => {
          ;(this._pendingEmitters.delete(s), this._send(new Mi(this._workerId, s)), (s = null))
        }
      })
      return i.event
    }
    ...
    _handleSubscribeEventMessage(e) {
      const n = e.req,
        r = this._handler.handleEvent(
          ...
          this._send(new ki(this._workerId, n, s))
        })
  ...
  class Fi {
    ...
    _handleMessage(e, n, r) {
      if (e === en && n === Ri) return this.initialize(r[0])
      const s = e === en ? this.requestHandler : this._localChannels.get(e)
      if (!s) return Promise.reject(new Error(`Missing channel ${e} on worker thread`))
      const i = s[n]
    ...
    _handleEvent(e, n, r) {
      ...
      if (In(n)) {
        const i = s[n]
        if (typeof i != 'function') throw new Error(`Missing event ${n} on request handler.`)
        return i
      }
  ...
  class ve {
    ...
    static _getElements(e) {
      ...
      if (ve._isStringArray(n)) {
        ...
        for (let s = 0, i = n.length; s < i; s++) r[s] = Di(n[s], 0)
        return [n, r, !0]
      }
    ...
    ComputeDiffRecursive(e, n, r, s, i) {
      for (i[0] = !1; e <= n && r <= s && this.ElementsAreEqual(e, r); ) (e++, r++)
      for (; n >= e && s >= r && this.ElementsAreEqual(n, s); ) (n--, s--)
      if (e > n || r > s) {
        let f
        return (
          r <= s
            ? (Be.Assert(e === n + 1, 'originalStart should only be one more than originalEnd'),
    ...
    WALKTRACE(e, n, r, s, i, l, o, u, c, h, f, m, p, g, d, _, N, v) {
      let L = null,
        E = null,
        P = new Hn(),
        I = n,
      ...
      do {
        ...
        ;(V === I || (V < w && c[V - 1] < c[V + 1])
          ? ((f = c[V + 1]),
            (g = f - x - s),
            f < A && P.MarkNextChange(),
            (A = f),
            P.AddModifiedElement(f + 1, g),
            (x = V + 1 - e))
          : ((f = c[V - 1] + 1),
            (g = f - x - s),
            f < A && P.MarkNextChange(),
            (A = f - 1),
            P.AddOriginalElement(f, g + 1),
            (x = V - 1 - e)),
          D >= 0 && ((c = this.m_forwardHistory[D]), (e = c[0]), (I = 1), (w = c.length - 1)))
      } while (--D >= -1)
      if (((L = P.getReverseChanges()), v[0])) {
        let V = p[0] + 1,
          y = _[0] + 1
        if (L !== null && L.length > 0) {
          const S = L[L.length - 1]
          ;((V = Math.max(V, S.getOriginalEnd())), (y = Math.max(y, S.getModifiedEnd())))
        }
        E = [new Le(V, m - V + 1, y, d - y + 1)]
      } else {
        ;((P = new Hn()),
          (I = l),
          (w = o),
          (x = p[0] - _[0] - u),
          (A = 1073741824),
          (D = N ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2))
        do {
          const V = x + i
          ;(V === I || (V < w && h[V - 1] >= h[V + 1])
            ? ((f = h[V + 1] - 1),
              ...
              f > A && P.MarkNextChange(),
              (A = f + 1),
              P.AddOriginalElement(f + 1, g + 1),
              (x = V + 1 - i))
            : ((f = h[V - 1]),
              (g = f - x - u),
              f > A && P.MarkNextChange(),
              (A = f),
              P.AddModifiedElement(f + 1, g + 1),
              (x = V - 1 - i)),
            D >= 0 && ((h = this.m_reverseHistory[D]), (i = h[0]), (I = 1), (w = h.length - 1)))
        } while (--D >= -1)
        E = P.getChanges()
      }
    ...
    ComputeRecursionPoint(e, n, r, s, i, l, o) {
      ...
      for (let x = 1; x <= g / 2 + 1; x++) {
        let A = 0,
          D = 0
        ;((h = this.ClipDiagonalBound(v - x, x, v, d)),
          (f = this.ClipDiagonalBound(v + x, x, v, d)))
        for (let y = h; y <= f; y += 2) {
          ;(y === h || (y < f && _[y - 1] < _[y + 1]) ? (u = _[y + 1]) : (u = _[y - 1] + 1),
            (c = u - (y - v) - E))
          const S = u
          ...
          if (
            ((_[y] = u),
            u + c > A + D && ((A = u), (D = c)),
            !w && Math.abs(y - L) <= x - 1 && u >= N[y])
          )
            return (
              (i[0] = u),
              (l[0] = c),
              S <= N[y] && x <= 1448
                ? this.WALKTRACE(v, h, f, E, L, m, p, P, _, N, u, n, i, c, s, l, w, o)
                : null
            )
        }
        const V = (A - e + (D - r) - x) / 2
        if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(A, V))
          return (
            (o[0] = !0),
            (i[0] = A),
            (l[0] = D),
        ...
        ;((m = this.ClipDiagonalBound(L - x, x, L, d)),
          (p = this.ClipDiagonalBound(L + x, x, L, d)))
        for (let y = m; y <= p; y += 2) {
          ;(y === m || (y < p && N[y - 1] >= N[y + 1]) ? (u = N[y + 1] - 1) : (u = N[y - 1]),
            (c = u - (y - L) - P))
          const S = u
          for (; u > e && c > r && this.ElementsAreEqual(u, c); ) (u--, c--)
          if (((N[y] = u), w && Math.abs(y - v) <= x && u <= _[y]))
            return (
              (i[0] = u),
              (l[0] = c),
              S >= _[y] && x <= 1448
        ...
        if (x <= 1447) {
          let y = new Int32Array(f - h + 2)
          ;((y[0] = v - h + 1),
            qe.Copy2(_, h, y, 1, f - h + 1),
            this.m_forwardHistory.push(y),
            (y = new Int32Array(p - m + 2)),
            (y[0] = L - m + 1),
            qe.Copy2(N, m, y, 1, p - m + 1),
            this.m_reverseHistory.push(y))
        }
      }
      return this.WALKTRACE(v, h, f, E, L, m, p, P, _, N, u, n, i, c, s, l, w, o)
    }
    PrettifyChanges(e) {
      for (let n = 0; n < e.length; n++) {
        const r = e[n],
          s = n < e.length - 1 ? e[n + 1].originalStart : this._originalElementsOrHash.length,
          i = n < e.length - 1 ? e[n + 1].modifiedStart : this._modifiedElementsOrHash.length,
    ...
    ConcatenateChanges(e, n) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
        ...
        return (
          qe.Copy(e, 0, s, 0, e.length - 1),
          (s[e.length - 1] = r[0]),
          qe.Copy(n, 1, s, e.length, n.length - 1),
          s
        )
      } else {
        const s = new Array(e.length + n.length)
        return (qe.Copy(e, 0, s, 0, e.length), qe.Copy(n, 0, s, e.length, n.length), s)
      }
    }
  ...
  class C {
    ...
    static plusRange(e, n) {
      ...
      return (
        n.startLineNumber < e.startLineNumber
          ...
          : n.startLineNumber === e.startLineNumber
            ? ((r = n.startLineNumber), (s = Math.min(n.startColumn, e.startColumn)))
    ...
    static collapseToStart(e) {
      return new C(e.startLineNumber, e.startColumn, e.startLineNumber, e.startColumn)
    }
    collapseToEnd() {
    ...
    static lift(e) {
      return e ? new C(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : null
    }
    static isIRange(e) {
      return (
        !!e &&
  ...
  class tn {
    constructor(e) {
      const n = Wn(e)
      ;((this._defaultValue = n), (this._asciiMap = tn._createAsciiMap(n)), (this._map = new Map()))
    }
  ...
  function Ui() {
    if (at === null) {
      at = new tn(0)
      const t = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`
      for (let n = 0; n < t.length; n++) at.set(t.charCodeAt(n), 1)
      const e = '.,;:'
      for (let n = 0; n < e.length; n++) at.set(e.charCodeAt(n), 2)
    }
    return at
  }
  class Lt {
        ...
        for (; c < u; ) {
          ...
          if (m === 13) {
            ...
            switch (v) {
              ...
              case 34:
              case 96:
                f === v ? (L = 1) : f === 39 || f === 34 || f === 96 ? (L = 0) : (L = 1)
                break
              case 42:
                L = f === 42 ? 1 : 0
                break
            ...
            let L
            ;(v === 91 ? ((g = !0), (L = 0)) : (L = r.get(v)), L === 1 ? (N = !0) : (m = 13))
          } else ((m = n.nextState(m, v)), m === 0 && (N = !0))
          ;(N && ((m = 1), (p = !1), (g = !1), (_ = !1), (h = c + 1), (f = v)), c++)
        }
  ...
  const Vt = class Vt {
    ...
    valueSetsReplace(e, n, r) {
      let s = null
      for (let i = 0, l = e.length; s === null && i < l; i++) s = this.valueSetReplace(e[i], n, r)
      return s
    }
  ...
  ;(function (t) {
    ...
    ;((t.isCancellationToken = e),
      (t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: Wt.None })),
      (t.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: zn })))
  })(vt || (vt = {}))
  class Nt {
    constructor() {
    ...
    get onCancellationRequested() {
      return this._isCancelled
        ? zn
        : (this._emitter || (this._emitter = new me()), this._emitter.event)
    }
    dispose() {
  ...
  class Hi {
    ...
    cancel() {
      this._token ? this._token instanceof Nt && this._token.cancel() : (this._token = vt.Cancelled)
    }
    dispose(e = !1) {
      var n
      ;(e && this.cancel(),
        (n = this._parentListener) == null || n.dispose(),
        this._token ? this._token instanceof Nt && this._token.dispose() : (this._token = vt.None))
    }
  }
  class sn {
    constructor() {
  ...
  ;(function () {
    ...
    for (const s of e) {
      ...
      if ((r[l] || ((r[l] = !0), (zi[o] = l), (Gi[o.toLowerCase()] = l)), !n[u])) {
        if (((n[u] = !0), !c))
  ...
  if (typeof on < 'u' && typeof on.process < 'u') {
    ...
    typeof process < 'u' &&
    typeof ((Hs = process == null ? void 0 : process.versions) == null ? void 0 : Hs.node) ==
      'string'
      ? ($e = {
          get platform() {
      ...
      : ($e = {
          get platform() {
            return rt ? 'win32' : ci ? 'darwin' : 'linux'
          },
          get arch() {},
          get env() {
            return {}
          ...
          if (o === 2) {
            if (
              ...
              if (s.length > 2) {
                ...
                ;(h === -1
                  ? ((s = ''), (i = 0))
                  : ((s = s.slice(0, h)), (i = s.length - 1 - s.lastIndexOf(n))),
                  (l = c),
                  (o = 0))
                continue
              } else if (s.length !== 0) {
            ...
            (s.length > 0 ? (s += `${n}${t.slice(l + 1, c)}`) : (s = t.slice(l + 1, c)),
              (i = c - l - 1))
        ;((l = c), (o = 0))
      } else u === ke && o !== -1 ? ++o : (o = -1)
    }
  ...
  const ee = {
        ...
        for (let s = t.length - 1; s >= -1; s--) {
          ...
          if (s >= 0) {
            ...
            e.length === 0
              ...
              : ((i = Oi[`=${e}`] || At()),
                (i === void 0 ||
                  (i.slice(0, 2).toLowerCase() !== e.toLowerCase() && i.charCodeAt(2) === te)) &&
                  (i = `${e}\\`))
          const l = i.length
          let o = 0,
            u = '',
          ...
          if (l === 1) B(h) && ((o = 1), (c = !0))
            ...
            if (((c = !0), B(i.charCodeAt(1)))) {
              let f = 2,
                m = f
              for (; f < l && !B(i.charCodeAt(f)); ) f++
              if (f < l && f !== m) {
                const p = i.slice(m, f)
                for (m = f; f < l && B(i.charCodeAt(f)); ) f++
                if (f < l && f !== m) {
                  for (m = f; f < l && !B(i.charCodeAt(f)); ) f++
                  ;(f === l || f !== m) && ((u = `\\\\${p}\\${i.slice(m, f)}`), (o = f))
                }
              }
            } else o = 1
          else
            we(h) &&
              i.charCodeAt(1) === pe &&
              ((u = i.slice(0, 2)), (o = 2), l > 2 && B(i.charCodeAt(2)) && ((c = !0), (o = 3)))
          if (u.length > 0)
            if (e.length > 0) {
          ...
          if (r) {
            if (e.length > 0) break
          } else if (((n = `${i.slice(o)}\\${n}`), (r = c), c && e.length > 0)) break
        }
        return ((n = Rt(n, !r, '\\', B)), r ? `${e}\\${n}` : `${e}${n}` || '.')
      },
      normalize(t) {
        X(t, 'path')
        const e = t.length
        ...
        if (B(i))
          if (((s = !0), B(t.charCodeAt(1)))) {
            let o = 2,
              u = o
            for (; o < e && !B(t.charCodeAt(o)); ) o++
            if (o < e && o !== u) {
              const c = t.slice(u, o)
              for (u = o; o < e && B(t.charCodeAt(o)); ) o++
              if (o < e && o !== u) {
                for (u = o; o < e && !B(t.charCodeAt(o)); ) o++
          ...
          we(i) &&
            t.charCodeAt(1) === pe &&
            ((r = t.slice(0, 2)), (n = 2), e > 2 && B(t.charCodeAt(2)) && ((s = !0), (n = 3)))
        let l = n < e ? Rt(t.slice(n), !s, '\\', B) : ''
        if (
          (l.length === 0 && !s && (l = '.'),
          l.length > 0 && B(t.charCodeAt(e - 1)) && (l += '\\'),
          !s && r === void 0 && t.includes(':'))
        ) {
          if (l.length >= 2 && we(l.charCodeAt(0)) && l.charCodeAt(1) === pe) return `.\\${l}`
          let o = t.indexOf(':')
          do if (o === e - 1 || B(t.charCodeAt(o + 1))) return `.\\${l}`
      ...
      isAbsolute(t) {
        ...
        return B(n) || (e > 2 && we(n) && t.charCodeAt(1) === pe && B(t.charCodeAt(2)))
      },
      join(...t) {
        ...
        for (let i = 0; i < t.length; ++i) {
          const l = t[i]
          ;(X(l, 'path'), l.length > 0 && (e === void 0 ? (e = n = l) : (e += `\\${l}`)))
        }
        if (e === void 0) return '.'
        let r = !0,
          s = 0
        if (typeof n == 'string' && B(n.charCodeAt(0))) {
          ++s
          const i = n.length
          i > 1 && B(n.charCodeAt(1)) && (++s, i > 2 && (B(n.charCodeAt(2)) ? ++s : (r = !1)))
        }
        if (r) {
          for (; s < e.length && B(e.charCodeAt(s)); ) s++
          s >= 2 && (e = `\\${e.slice(s)}`)
        }
      ...
      relative(t, e) {
        ...
        if (n.length !== t.length || r.length !== e.length) {
          ...
          const _ = g.length,
            ...
            v = _ < N ? _ : N
          let L
          for (L = 0; L < v && g[L].toLowerCase() === d[L].toLowerCase(); L++);
          return L === 0
            ? r
            : L === v
              ? N > v
        ...
        let f = -1,
          m = 0
        for (; m < h; m++) {
          const g = t.charCodeAt(s + m)
          if (g !== e.charCodeAt(o + m)) break
          g === te && (f = m)
        }
        if (m !== h) {
          if (f === -1) return r
        ...
        let p = ''
        for (m = s + f + 1; m <= i; ++m)
          (m === i || t.charCodeAt(m) === te) && (p += p.length === 0 ? '..' : '\\..')
        return (
          (o += f),
          p.length > 0 ? `${p}${r.slice(o, u)}` : (r.charCodeAt(o) === te && ++o, r.slice(o, u))
        )
      },
      toNamespacedPath(t) {
        if (typeof t != 'string' || t.length === 0) return t
        const e = ee.resolve(t)
        if (e.length <= 2) return t
        if (e.charCodeAt(0) === te) {
          if (e.charCodeAt(1) === te) {
            const n = e.charCodeAt(2)
            if (n !== Ki && n !== ke) return `\\\\?\\UNC\\${e.slice(2)}`
          }
        } else if (we(e.charCodeAt(0)) && e.charCodeAt(1) === pe && e.charCodeAt(2) === te)
          return `\\\\?\\${e}`
        return e
      },
      dirname(t) {
        ...
        if (B(s)) {
          ...
          we(s) && t.charCodeAt(1) === pe && ((n = e > 2 && B(t.charCodeAt(2)) ? 3 : 2), (r = n))
        let i = -1,
          l = !0
        for (let o = e - 1; o >= r; --o)
          if (B(t.charCodeAt(o))) {
      ...
      basename(t, e) {
        ...
        let n = 0,
          ...
          i
        if (
          (t.length >= 2 && we(t.charCodeAt(0)) && t.charCodeAt(1) === pe && (n = 2),
          ...
          for (i = t.length - 1; i >= n; --i) {
            ...
            if (B(u)) {
              ...
              (o === -1 && ((s = !1), (o = i + 1)),
                l >= 0 && (u === e.charCodeAt(l) ? --l === -1 && (r = i) : ((l = -1), (r = o))))
          }
      ...
      extname(t) {
        ...
        let e = 0,
          ...
          i = !0,
          l = 0
        t.length >= 2 && t.charCodeAt(1) === pe && we(t.charCodeAt(0)) && (e = r = 2)
        for (let o = t.length - 1; o >= e; --o) {
          ...
          ;(s === -1 && ((i = !1), (s = o + 1)),
            u === ke ? (n === -1 ? (n = o) : l !== 1 && (l = 1)) : n !== -1 && (l = -1))
        }
        return n === -1 || s === -1 || l === 0 || (l === 1 && n === s - 1 && n === r + 1)
          ? ''
          : t.slice(n, s)
      },
      format: On.bind(null, '\\'),
      parse(t) {
        ...
        let r = 0,
          s = t.charCodeAt(0)
        if (n === 1) return B(s) ? ((e.root = e.dir = t), e) : ((e.base = e.name = t), e)
        if (B(s)) {
          if (((r = 1), B(t.charCodeAt(1)))) {
            let f = 2,
              m = f
            for (; f < n && !B(t.charCodeAt(f)); ) f++
            if (f < n && f !== m) {
              for (m = f; f < n && B(t.charCodeAt(f)); ) f++
              if (f < n && f !== m) {
                for (m = f; f < n && !B(t.charCodeAt(f)); ) f++
                f === n ? (r = f) : f !== m && (r = f + 1)
              }
        ...
        for (; c >= r; --c) {
          ...
          ;(o === -1 && ((u = !1), (o = c + 1)),
            s === ke ? (i === -1 ? (i = c) : h !== 1 && (h = 1)) : i !== -1 && (h = -1))
        }
        return (
          o !== -1 &&
            (i === -1 || h === 0 || (h === 1 && i === o - 1 && i === l + 1)
              ? (e.base = e.name = t.slice(l, o))
              : ((e.name = t.slice(l, i)), (e.base = t.slice(l, o)), (e.ext = t.slice(i, o)))),
    ...
    ne = {
      ...
      normalize(t) {
        ...
        const e = t.charCodeAt(0) === J,
          n = t.charCodeAt(t.length - 1) === J
        return (
          (t = Rt(t, !e, '/', un)),
      ...
      relative(t, e) {
        if (
          (X(t, 'from'), X(e, 'to'), t === e || ((t = ne.resolve(t)), (e = ne.resolve(e)), t === e))
        )
          return ''
        const n = 1,
          r = t.length,
        ...
        if (c === o)
          if (l > o) {
            if (e.charCodeAt(i + c) === J) return e.slice(i + c + 1)
            if (c === 0) return e.slice(i + c)
          } else s > o && (t.charCodeAt(n + c) === J ? (u = c) : c === 0 && (u = 0))
        let h = ''
        for (c = n + u + 1; c <= r; ++c)
          (c === r || t.charCodeAt(c) === J) && (h += h.length === 0 ? '..' : '/..')
      ...
      extname(t) {
        ...
        for (let l = t.length - 1; l >= 0; --l) {
          ...
          ;(r === -1 && ((s = !1), (r = l + 1)),
            o === '.' ? (e === -1 ? (e = l) : i !== 1 && (i = 1)) : e !== -1 && (i = -1))
        }
        return e === -1 || r === -1 || i === 0 || (i === 1 && e === r - 1 && e === n + 1)
          ? ''
          : t.slice(e, r)
      },
      format: On.bind(null, '/'),
      parse(t) {
        ...
        for (; u >= r; --u) {
          ...
          ;(l === -1 && ((o = !1), (l = u + 1)),
            h === ke ? (s === -1 ? (s = u) : c !== 1 && (c = 1)) : s !== -1 && (c = -1))
        }
        if (l !== -1) {
          const h = i === 0 && n ? 1 : i
          s === -1 || c === 0 || (c === 1 && s === l - 1 && s === i + 1)
            ? (e.base = e.name = t.slice(h, l))
            : ((e.name = t.slice(h, s)), (e.base = t.slice(h, l)), (e.ext = t.slice(s, l)))
        }
  ...
  ;((ne.win32 = ee.win32 = ee),
    (ne.posix = ee.posix = ne),
    Ne ? ee.normalize : ne.normalize,
    Ne ? ee.resolve : ne.resolve,
    Ne ? ee.relative : ne.relative,
    Ne ? ee.dirname : ne.dirname,
    Ne ? ee.basename : ne.basename,
    Ne ? ee.extname : ne.extname,
    Ne ? ee.sep : ne.sep)
  const ra = /^\w[\w\d+.-]*$/,
    sa = /^\//,
    ia = /^\/\//
  ...
  class Me {
    ...
    static parse(e, n = !1) {
      const r = ua.exec(e)
      return r
        ? new He(r[2] || G, Ct(r[4] || G), Ct(r[5] || G), Ct(r[7] || G), Ct(r[9] || G), n)
        : new He(G, G, G, G, G)
    }
    static file(e) {
      let n = G
      if ((rt && (e = e.replace(/\\/g, he)), e[0] === he && e[1] === he)) {
        const r = e.indexOf(he, 2)
        r === -1
          ? ((n = e.substring(2)), (e = he))
          : ((n = e.substring(2, r)), (e = e.substring(r) || he))
      }
      return new He('file', n, e, G, G)
    }
    static from(e, n) {
    ...
    static joinPath(e, ...n) {
      ...
      return (
        rt && e.scheme === 'file'
          ? (r = Me.file(ee.join(cn(e, !0), ...n)).path)
          : (r = ne.join(e.path, ...n)),
        e.with({ path: r })
      )
    }
  ...
  class He extends Me {
    ...
    toString(e = !1) {
      return e
        ? hn(this, !0)
        : (this._formatted || (this._formatted = hn(this, !1)), this._formatted)
    }
    toJSON() {
      const e = { $mid: 1 }
      return (
  ...
  function Jn(t, e, n) {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      if (
        ...
        const o = Qn[l]
        o !== void 0
          ? (s !== -1 && ((r += encodeURIComponent(t.substring(s, i))), (s = -1)), (r += o))
          : s === -1 && (s = i)
      }
    }
  ...
  function hn(t, e) {
    ...
    if ((s && ((r += s), (r += ':')), (i || s === 'file') && ((r += he), (r += he)), i)) {
      let c = i.indexOf('@')
      if (c !== -1) {
        ...
        ;((i = i.substr(c + 1)),
          ...
          c === -1
            ? (r += n(h, !1, !1))
            : ((r += n(h.substr(0, c), !1, !1)), (r += ':'), (r += n(h.substr(c + 1), !1, !0))),
          (r += '@'))
      }
      ;((i = i.toLowerCase()),
        (c = i.lastIndexOf(':')),
        c === -1 ? (r += n(i, !1, !0)) : ((r += n(i.substr(0, c), !1, !0)), (r += i.substr(c))))
    }
    if (l) {
  ...
  class se extends C {
    ...
    static fromRange(e, n) {
      return n === 0
        ...
        : new se(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn)
    }
    ...
    static selectionsArrEqual(e, n) {
      ...
      for (let r = 0, s = e.length; r < s; r++) if (!this.selectionsEqual(e[r], n[r])) return !1
      return !0
    }
  ...
  class ma {
    ...
    registerFactory(e, n) {
      var s
      ;(s = this._factories.get(e)) == null || s.dispose()
      const r = new da(this, e, n)
      return (
  ...
  ;(function (t) {
    ...
    function n(l) {
      let o = e.get(l)
      return (
        o || (console.info('No codicon found for CompletionItemKind ' + l), (o = M.symbolProperty)),
        o
      )
    }
    t.toIcon = n
    function r(l) {
      switch (l) {
        case 0:
          return T(728, 'Method')
        case 1:
          return T(729, 'Function')
        case 2:
          return T(730, 'Constructor')
        case 3:
          return T(731, 'Field')
        case 4:
          return T(732, 'Variable')
        case 5:
          return T(733, 'Class')
        case 6:
          return T(734, 'Struct')
        case 7:
          return T(735, 'Interface')
        case 8:
          return T(736, 'Module')
        case 9:
          return T(737, 'Property')
        case 10:
          return T(738, 'Event')
        case 11:
          return T(739, 'Operator')
        case 12:
          return T(740, 'Unit')
        case 13:
          return T(741, 'Value')
        case 14:
          return T(742, 'Constant')
        case 15:
          return T(743, 'Enum')
        case 16:
          return T(744, 'Enum Member')
        case 17:
          return T(745, 'Keyword')
        case 18:
          return T(746, 'Text')
        case 19:
          return T(747, 'Color')
        case 20:
          return T(748, 'File')
        case 21:
          return T(749, 'Reference')
        case 22:
          return T(750, 'Custom Color')
        case 23:
          return T(751, 'Folder')
        case 24:
          return T(752, 'Type Parameter')
        case 25:
          return T(753, 'User')
        case 26:
          return T(754, 'Issue')
  ...
  ;(function (t) {
    ...
    function n(i) {
      let l = e.get(i)
      return (
        l || (console.info('No codicon found for SymbolKind ' + i), (l = M.symbolProperty)),
        l
      )
    }
    t.toIcon = n
    ...
    function s(i) {
      let l = r.get(i)
      return (
        l === void 0 && (console.info('No completion kind found for SymbolKind ' + i), (l = 20)),
        l
      )
    }
  ...
  ;((et.CtrlCmd = 2048), (et.Shift = 1024), (et.Alt = 512), (et.WinCtrl = 256))
  let bn = et
  function ba() {
    return {
      editor: void 0,
    ...
    next(e) {
      ...
      do {
        ...
        if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
          if (i === 0) {
            Ni(e, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Na(this._wordSeparators, e, n, s, i))
        )
          return r
      } while (r)
      return null
  ...
  function Ra(t = '') {
    let e = '(-?\\d*\\.\\d\\w*)|([^'
    for (const n of Aa) t.indexOf(n) >= 0 || (e += '\\' + n)
  ...
  class Ea {
    static computeUnicodeHighlights(e, n, r) {
      ...
      o === 'allNonBasicAscii'
        ? (u = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
        : (u = new RegExp(`${ka(Array.from(o))}`, 'g'))
      const c = new Sa(null, u),
        h = []
      let f = !1,
        m,
        p = 0,
        g = 0,
        d = 0
      e: for (let _ = s, N = i; _ <= N; _++) {
        const v = e.getLineContent(_),
          L = v.length
        c.reset(0)
        do
          if (((m = c.next(v)), m)) {
            ...
            if (P + 1 < L) {
              const A = v.charCodeAt(P - 1)
              Kt(A) && P++
            }
            const I = v.substring(E, P)
            let w = pn(E + 1, us, v, 0)
            w && w.endColumn <= E + 1 && (w = null)
            const x = l.shouldHighlightNonBasicASCII(I, w ? w.word : null)
            if (x !== 0) {
              if ((x === 3 ? p++ : x === 2 ? g++ : x === 1 ? d++ : js(), h.length >= 1e3)) {
                f = !0
                break e
              }
              h.push(new C(_, E + 1, _, P + 1))
            }
          }
        while (m)
      }
      ...
      switch (r.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const i = e.codePointAt(0),
            ...
            o = st
              .getLocales()
              .filter((u) => !st.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(i))
  ...
  function ka(t, e) {
    return `[${gi(t.map((r) => String.fromCodePoint(r)).join(''))}]`
  }
  class fs {
    constructor(e) {
      ;((this.options = e),
        (this.allowedCodePoints = new Set(e.allowedCodePoints)),
        (this.ambiguousCharacters = st.getInstance(new Set(e.allowedLocales))))
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return 'allNonBasicAscii'
      const e = new Set()
      if (this.options.invisibleCharacters)
        for (const n of it.codePoints) ms(String.fromCodePoint(n)) || e.add(n)
        ...
        for (const l of n) {
          ...
          ;((s = s || u),
            !u &&
              ...
              !it.isInvisibleCharacter(o) &&
              (i = !0))
        }
      return !s && i
        ? 0
        : this.options.invisibleCharacters && !ms(e) && it.isInvisibleCharacter(r)
          ? 2
...
` ||
  ...
  function* Fa(t, e) {
    let n, r
    for (const s of t) (r !== void 0 && e(r, s) ? n.push(s) : (n && (yield n), (n = [s])), (r = s))
    n && (yield n)
  }
  function Ta(t, e) {
    for (let n = 0; n <= t.length; n++)
  ...
  const tt = class tt {
    ...
    filter(e) {
      return new tt((n) => this.iterate((r) => (e(r) ? n(r) : !0)))
    }
    map(e) {
      return new tt((n) => this.iterate((r) => n(e(r))))
    }
    findLast(e) {
      let n
    ...
    findLastMaxBy(e) {
      let n,
        r = !0
      return (this.iterate((s) => ((r || wn.isGreaterThan(e(s, n))) && ((r = !1), (n = s)), !0)), n)
    }
  }
  tt.empty = new tt((e) => {})
  let ds = tt
  class q {
    ...
    static addRange(e, n) {
      ...
      if (r === s) n.splice(r, 0, e)
        ...
        n.splice(r, s - r, new q(i, l))
      }
    }
    static tryCreate(e, n) {
      if (!(e > n)) return new q(e, n)
    }
    static ofLength(e) {
      return new q(0, e)
    }
    ...
    constructor(e, n) {
      if (((this.start = e), (this.endExclusive = n), e > n))
        throw new Z(`Invalid range: ${this.toString()}`)
    }
    get isEmpty() {
      return this.start === this.endExclusive
    }
    delta(e) {
      return new q(this.start + e, this.endExclusive + e)
    }
    deltaStart(e) {
      return new q(this.start + e, this.endExclusive)
    }
    deltaEnd(e) {
      return new q(this.start, this.endExclusive + e)
    }
    get length() {
    ...
    join(e) {
      return new q(Math.min(this.start, e.start), Math.max(this.endExclusive, e.endExclusive))
    }
    intersect(e) {
      const n = Math.max(this.start, e.start),
        r = Math.min(this.endExclusive, e.endExclusive)
      if (n <= r) return new q(n, r)
    }
    ...
    joinRightTouching(e) {
      if (this.endExclusive !== e.start)
        throw new Z(`Invalid join: ${this.toString()} and ${e.toString()}`)
      return new q(this.start, e.endExclusive)
    }
  }
  function We(t, e) {
    const n = ze(t, e)
  ...
  function ze(t, e, n = 0, r = t.length) {
    let s = n,
      i = r
    for (; s < i; ) {
  ...
  const It = class It {
    ...
    findLastMonotonous(e) {
      ...
      const n = ze(this._array, e, this._findLastMonotonousLastIdx)
  ...
  const ie = class ie {
    ...
    static joinMany(e) {
      ...
      let n = new ge(e[0].slice())
      for (let r = 1; r < e.length; r++) n = n.getUnion(new ge(e[r].slice()))
      return n.ranges
    }
    static join(e) {
    ...
    constructor(e, n) {
      if (e > n) throw new Z(`startLineNumber ${e} cannot be after endLineNumberExclusive ${n}`)
    ...
    toInclusiveRange() {
      return this.isEmpty
        ? null
        : new C(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
    }
    toExclusiveRange() {
  ...
  ie.compareByStart = lt((e) => e.startLineNumber, ot)
  let $ = ie
  class ge {
    constructor(e = []) {
    ...
    addRange(e) {
      if (e.length === 0) return
      const n = xn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= e.startLineNumber),
        r = ze(this._normalizedRanges, (s) => s.startLineNumber <= e.endLineNumberExclusive) + 1
    ...
    contains(e) {
      const n = We(this._normalizedRanges, (r) => r.startLineNumber <= e)
      return !!n && n.endLineNumberExclusive > e
    }
    intersects(e) {
      const n = We(this._normalizedRanges, (r) => r.startLineNumber < e.endLineNumberExclusive)
    ...
    subtractFrom(e) {
      const n = xn(this._normalizedRanges, (l) => l.endLineNumberExclusive >= e.startLineNumber),
        r = ze(this._normalizedRanges, (l) => l.startLineNumber <= e.endLineNumberExclusive) + 1
      if (n === r) return new ge([e])
      const s = []
      ...
      return (i < e.endLineNumberExclusive && s.push(new $(i, e.endLineNumberExclusive)), new ge(s))
    }
    toString() {
    ...
    getWithDelta(e) {
      return new ge(this._normalizedRanges.map((n) => n.delta(e)))
    }
  }
  const fe = class fe {
    static betweenPositions(e, n) {
      return e.lineNumber === n.lineNumber
        ? new fe(0, n.column - e.column)
        : new fe(n.lineNumber - e.lineNumber, n.column - 1)
    }
    static fromPosition(e) {
      return new fe(e.lineNumber - 1, e.column - 1)
    }
    static ofRange(e) {
...
`
    ...
    add(e) {
      return e.lineCount === 0
        ? new fe(this.lineCount, this.columnCount + e.columnCount)
        : new fe(this.lineCount + e.lineCount, e.columnCount)
    }
    createRange(e) {
      return this.lineCount === 0
        ? new C(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount)
        : new C(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1)
    }
    toRange() {
  ...
  class qa {
    ...
    getRange(e) {
      return C.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive))
    }
    getStringReplacement(e) {
      return new Ge.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
    }
    getTextReplacement(e) {
      return new Ge.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
    }
    getTextEdit(e) {
      const n = e.replacements.map((r) => this.getTextReplacement(r))
      return new Ge.deps.TextEdit(n)
    }
  }
  const Cn = class Cn {
    static get deps() {
...
` &&
    ...
    getPosition(e) {
      const n = ze(this.lineStartOffsetByLineIdx, (i) => i <= e),
        r = n + 1,
    ...
    get textLength() {
      ...
      return new Ge.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
    }
    getLineLength(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1)),
    ...
    get length() {
      ...
      return new ut(this._lineCount - 1, e.length)
    }
  }
  class Mt extends Ha {
    constructor(e) {
    ...
    static joinReplacements(e, n) {
      ...
      for (let l = 0; l < e.length; l++) {
        ...
        if (((i += o.text), l < e.length - 1)) {
          const u = e[l + 1],
            c = C.fromPositions(o.range.getEndPosition(), u.range.getStartPosition()),
...
`
        ...
        s = yi(n, r),
        i = ut.ofText(n.substring(0, s)).addToPosition(this.range.getStartPosition()),
        l = r.substring(s),
...
`
        ...
        s = _i(n, r),
        i = ut.ofText(n.substring(0, n.length - s)).addToPosition(this.range.getStartPosition()),
  ...
  class ae {
    static inverse(e, n, r) {
      ...
      let i = 1,
        l = 1
      for (const u of e) {
        const c = new ae(new $(i, u.original.startLineNumber), new $(l, u.modified.startLineNumber))
    ...
    join(e) {
      return new ae(this.original.join(e.original), this.modified.join(e.modified))
    }
    toRangeMapping() {
      ...
      if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
        if (!(this.modified.startLineNumber === 1 && this.original.startLineNumber === 1))
          throw new Z('not a valid diff')
        return new le(
          new C(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new C(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1)
        )
      } else
        return new le(
          new C(
      ...
      if (!this.original.isEmpty && !this.modified.isEmpty)
        return new le(
          C.fromPositions(
            ...
            je(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          C.fromPositions(
            new H(this.modified.startLineNumber, 1),
            je(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
        return new le(
          C.fromPositions(
            je(new H(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e),
            je(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          C.fromPositions(
            je(new H(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
            je(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      throw new Z()
  ...
  function je(t, e) {
    ...
    if (t.lineNumber > e.length) return new H(e.length, e[e.length - 1].length + 1)
  ...
  class le {
    ...
    static assertSorted(e) {
      for (let n = 1; n < e.length; n++) {
        ...
        if (
          !(
            r.originalRange.getEndPosition().isBeforeOrEqual(s.originalRange.getStartPosition()) &&
            r.modifiedRange.getEndPosition().isBeforeOrEqual(s.modifiedRange.getStartPosition())
          )
        )
          throw new Z('Range mappings must be sorted')
      }
    }
    constructor(e, n) {
  ...
  function bs(t, e, n, r = !1) {
    ...
    for (const i of Fa(
      t.map((l) => Wa(l, e, n)),
      (l, o) =>
        l.original.intersectsOrTouches(o.original) || l.modified.intersectsOrTouches(o.modified)
    )) {
      const l = i[0],
        o = i[i.length - 1]
      s.push(
    ...
    return (
      pt(() =>
        ...
        (s[0].modified.startLineNumber !== s[0].original.startLineNumber ||
          n.length.lineCount - s[s.length - 1].modified.endLineNumberExclusive !==
            e.length.lineCount - s[s.length - 1].original.endLineNumberExclusive)
          ? !1
          : kn(
              s,
              (i, l) =>
                l.original.startLineNumber - i.original.endLineNumberExclusive ===
                  l.modified.startLineNumber - i.modified.endLineNumberExclusive &&
  ...
  function Wa(t, e, n) {
    ...
    ;(t.modifiedRange.endColumn === 1 &&
      ...
      t.modifiedRange.startColumn - 1 >= n.getLineLength(t.modifiedRange.startLineNumber) &&
        ...
        (r = 1))
    const i = new $(t.originalRange.startLineNumber + r, t.originalRange.endLineNumber + 1 + s),
      l = new $(t.modifiedRange.startLineNumber + r, t.modifiedRange.endLineNumber + 1 + s)
    return new xe(i, l, [t])
  }
  const za = 3
  class Ga {
    computeDiff(e, n, r) {
      ...
      for (const c of i.changes) {
        ...
        c.originalEndLineNumber === 0
          ? (h = new $(c.originalStartLineNumber + 1, c.originalStartLineNumber + 1))
          : (h = new $(c.originalStartLineNumber, c.originalEndLineNumber + 1))
        let f
        c.modifiedEndLineNumber === 0
          ? (f = new $(c.modifiedStartLineNumber + 1, c.modifiedStartLineNumber + 1))
          : (f = new $(c.modifiedStartLineNumber, c.modifiedEndLineNumber + 1))
        let m = new xe(
          h,
          f,
          (u = c.charChanges) == null
            ? void 0
            : u.map(
                (p) =>
                  new le(
      ...
      return (
        pt(() =>
          kn(
            l,
            (c, h) =>
              h.original.startLineNumber - c.original.endLineNumberExclusive ===
                h.modified.startLineNumber - c.modified.endLineNumberExclusive &&
              c.original.endLineNumberExclusive < h.original.startLineNumber &&
              c.modified.endLineNumberExclusive < h.modified.startLineNumber
          )
        ),
  ...
  let ws = class {
    constructor(e) {
      const n = [],
        r = []
      for (let s = 0, i = e.length; s < i; s++) ((n[s] = yn(e[s], 1)), (r[s] = _n(e[s], 1)))
    ...
    createCharSequence(e, n, r) {
      ...
      for (let u = n; u <= r; u++) {
        ...
        for (let m = h; m < f; m++) ((s[o] = c.charCodeAt(m - 1)), (i[o] = u + 1), (l[o] = m), o++)
        !e && u < r && ((s[o] = 10), (i[o] = u + 1), (l[o] = c.length + 1), o++)
      }
      return new ja(s, i, l)
    }
  }
  ...
  class ct {
    ...
    static createFromDiffResult(e, n, r, s, i, l, o) {
      ...
      if (
        ...
        const p = r.createCharSequence(e, n.originalStart, n.originalStart + n.originalLength - 1),
          g = s.createCharSequence(e, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1)
        if (p.getElements().length > 0 && g.getElements().length > 0) {
          let d = ps(p, g, i, !0).changes
          ;(o && (d = Oa(d)), (m = []))
          for (let _ = 0, N = d.length; _ < N; _++) m.push(Oe.createFromDiffChange(d[_], p, g))
        }
      }
      return new ct(u, c, h, f, m)
    }
  }
  class Xa {
    constructor(e, n, r) {
    ...
    computeDiff() {
      ...
      const e = ps(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
        n = e.changes,
        r = e.quitEarly
          ...
          if (m !== p) {
            {
              let g = yn(m, 1),
                d = yn(p, 1)
              for (; g > 1 && d > 1; ) {
                const _ = m.charCodeAt(g - 2),
                  N = p.charCodeAt(d - 2)
                if (_ !== N) break
                ;(g--, d--)
              }
              ;(g > 1 || d > 1) && this._pushTrimWhitespaceCharChange(s, i + 1, 1, g, l + 1, 1, d)
            }
            {
              let g = _n(m, 1),
                d = _n(p, 1)
              const _ = m.length + 1,
                N = p.length + 1
              for (; g < _ && d < N; ) {
                const v = m.charCodeAt(g - 1),
                  L = m.charCodeAt(d - 1)
                if (v !== L) break
                ;(g++, d++)
              }
              ;(g < _ || d < N) && this._pushTrimWhitespaceCharChange(s, i + 1, g, _, l + 1, d, N)
            }
          }
          ;(i++, l++)
        }
    ...
    _pushTrimWhitespaceCharChange(e, n, r, s, i, l, o) {
      ...
      let u
      ;(this.shouldComputeCharChanges && (u = [new Oe(n, r, n, s, i, l, i, o)]),
        e.push(new ct(n, n, i, i, u)))
    }
    _mergeTrimWhitespaceCharChange(e, n, r, s, i, l, o) {
      ...
      return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
        ...
        : c.originalEndLineNumber === n && c.modifiedEndLineNumber === i
          ? (this.shouldComputeCharChanges &&
              c.charChanges &&
              c.charChanges.push(new Oe(n, r, n, s, i, l, i, o)),
            !0)
  ...
  class ye {
    static trivial(e, n) {
      return new ye([new O(q.ofLength(e.length), q.ofLength(n.length))], !1)
    }
    static trivialTimedOut(e, n) {
      return new ye([new O(q.ofLength(e.length), q.ofLength(n.length))], !0)
    }
    constructor(e, n) {
  ...
  class O {
        ...
        Ta(e, (s, i) => {
          r.push(
            O.fromOffsetPairs(
              ...
              i
                ? i.getStarts()
                : new _e(n, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + n)
            )
          )
        }),
        r
    ...
    static fromOffsetPairs(e, n) {
      return new O(new q(e.offset1, n.offset1), new q(e.offset2, n.offset2))
    }
    static assertSorted(e) {
      let n
      for (const r of e) {
        if (
          ...
          throw new Z('Sequence diffs must be sorted')
        n = r
      }
    }
    constructor(e, n) {
    ...
    join(e) {
      return new O(this.seq1Range.join(e.seq1Range), this.seq2Range.join(e.seq2Range))
    }
    delta(e) {
      return e === 0 ? this : new O(this.seq1Range.delta(e), this.seq2Range.delta(e))
    }
    deltaStart(e) {
      return e === 0 ? this : new O(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e))
    }
    deltaEnd(e) {
      return e === 0 ? this : new O(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e))
    }
    intersect(e) {
...
`)
    ...
    computeSimilarity(e) {
      ...
      for (let s = 0; s < r; s++) n += Math.abs((this.histogram[s] ?? 0) - (e.histogram[s] ?? 0))
    ...
    compute(e, n, r = ht.instance, s) {
      ...
      for (let g = 0; g < e.length; g++)
        for (let d = 0; d < n.length; d++) {
          ...
          const _ = g === 0 ? 0 : i.get(g - 1, d),
            N = d === 0 ? 0 : i.get(g, d - 1)
          let v
          e.getElement(g) === n.getElement(d)
            ? (g === 0 || d === 0 ? (v = 0) : (v = i.get(g - 1, d - 1)),
              g > 0 && d > 0 && l.get(g - 1, d - 1) === 3 && (v += o.get(g - 1, d - 1)),
              (v += s ? s(g, d) : 1))
            : (v = -1)
          const L = Math.max(_, N, v)
          if (L === v) {
            const E = g > 0 && d > 0 ? o.get(g - 1, d - 1) : 0
            ;(o.set(g, d, E + 1), l.set(g, d, 3))
          } else
            L === _ ? (o.set(g, d, 0), l.set(g, d, 1)) : L === N && (o.set(g, d, 0), l.set(g, d, 2))
          i.set(g, d, L)
        }
      const u = []
      let c = e.length,
        h = n.length
      function f(g, d) {
        ;((g + 1 !== c || d + 1 !== h) && u.push(new O(new q(g + 1, c), new q(d + 1, h))),
          (c = g),
          (h = d))
      }
      let m = e.length - 1,
  ...
  class ys {
    compute(e, n, r = ht.instance) {
      if (e.length === 0 || n.length === 0) return ye.trivial(e, n)
      const s = e,
        i = n
      function l(d, _) {
        for (; d < s.length && _ < i.length && s.getElement(d) === i.getElement(_); ) (d++, _++)
        return d
      }
      let o = 0
      const u = new Ya()
      ...
      e: for (;;) {
        ...
        const d = -Math.min(o, i.length + (o % 2)),
          _ = Math.min(o, s.length + (o % 2))
        for (h = d; h <= _; h += 2) {
          const N = h === _ ? -1 : u.get(h + 1),
            v = h === d ? -1 : u.get(h - 1) + 1,
          ...
          const P = l(L, E)
          u.set(h, P)
          const I = L === N ? c.get(h + 1) : c.get(h - 1)
          if (
            (c.set(h, P !== L ? new _s(I, L, E, P - L) : I),
      ...
      for (;;) {
        const d = f ? f.x + f.length : 0,
          _ = f ? f.y + f.length : 0
        if (((d !== p || _ !== g) && m.push(new O(new q(d, p), new q(_, g))), !f)) break
  ...
  class Ft {
    ...
    getBoundaryScore(e) {
      ...
      if (n === 8) return 150
      let s = 0
      return (n !== r && ((s += 10), n === 0 && r === 1 && (s += 1)), (s += vs(n)), (s += vs(r)), s)
    }
    translateOffset(e, n = 'right') {
      const r = ze(this.firstElementOffsetByLineIdx, (i) => i <= e),
    ...
    findWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !Xe(this.elements[e])) return
      let n = e
      for (; n > 0 && Xe(this.elements[n - 1]); ) n--
      let r = e
      for (; r < this.elements.length && Xe(this.elements[r]); ) r++
      return new q(n, r)
    }
    findSubWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !Xe(this.elements[e])) return
      let n = e
      for (; n > 0 && Xe(this.elements[n - 1]) && !Ls(this.elements[n]); ) n--
      let r = e
      for (; r < this.elements.length && Xe(this.elements[r]) && !Ls(this.elements[r]); ) r++
      return new q(n, r)
    }
    countLinesIn(e) {
      return (
    ...
    extendToFullLines(e) {
      const n = We(this.firstElementOffsetByLineIdx, (s) => s <= e.start) ?? 0,
        r = Ba(this.firstElementOffsetByLineIdx, (s) => e.endExclusive <= s) ?? this.elements.length
      return new q(n, r)
    }
  }
  function Xe(t) {
  ...
  const Ka = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
  function vs(t) {
    return Ka[t]
  }
  function Ns(t) {
  ...
  function e1(t, e, n, r, s, i) {
    let { moves: l, excludedChanges: o } = n1(t, e, n, i)
    if (!i.isValid()) return []
...
`).length >= 15 && t1(f, (p) => p.length >= 2) >= 2
  ...
  function n1(t, e, n, r) {
    ...
    for (const u of i) {
      ...
      if (
        (c > 0.9 &&
          h &&
          (l.delete(h), s.push(new ae(u.range, h.range)), o.add(u.source), o.add(h.source)),
        !r.isValid())
      )
  ...
  function r1(t, e, n, r, s, i) {
    ...
    for (const m of t)
      for (let p = m.original.startLineNumber; p < m.original.endLineNumberExclusive - 2; p++) {
        const g = `${e[p - 1]}:${e[p + 1 - 1]}:${e[p + 2 - 1]}`
        o.add(g, { range: new $(p, p + 3) })
      }
    const u = []
    t.sort(lt((m) => m.modified.startLineNumber, ot))
    for (const m of t) {
      let p = []
      for (let g = m.modified.startLineNumber; g < m.modified.endLineNumberExclusive - 2; g++) {
        const d = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`,
          _ = new $(g, g + 3),
          N = []
        ;(o.forEach(d, ({ range: v }) => {
          for (const E of p)
            if (
              E.originalLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive &&
              E.modifiedLineRange.endLineNumberExclusive + 1 === _.endLineNumberExclusive
            ) {
          ...
          const L = { modifiedLineRange: _, originalLineRange: v }
          ;(u.push(L), N.push(L))
        }),
          (p = N))
      }
    ...
    u.sort(Ia(lt((m) => m.modifiedLineRange.length, ot)))
    const c = new ge(),
      h = new ge()
    for (const m of u) {
      const p = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber,
        g = c.subtractFrom(m.modifiedLineRange),
        d = h.subtractFrom(m.originalLineRange).getWithDelta(p),
        _ = g.getIntersection(d)
    ...
    l.sort(lt((m) => m.original.startLineNumber, ot))
    const f = new kt(t)
    for (let m = 0; m < l.length; m++) {
      const p = l[m],
        g = f.findLastMonotonous((I) => I.original.startLineNumber <= p.original.startLineNumber),
        d = We(t, (I) => I.modified.startLineNumber <= p.modified.startLineNumber),
        _ = Math.max(
          p.original.startLineNumber - g.original.startLineNumber,
          p.modified.startLineNumber - d.modified.startLineNumber
        ),
        N = f.findLastMonotonous(
          (I) => I.original.startLineNumber < p.original.endLineNumberExclusive
        ),
        v = We(t, (I) => I.modified.startLineNumber < p.modified.endLineNumberExclusive),
        L = Math.max(
      ...
      let E
      for (E = 0; E < _; E++) {
        const I = p.original.startLineNumber - E - 1,
      ...
      E > 0 &&
        (h.addRange(new $(p.original.startLineNumber - E, p.original.startLineNumber)),
        c.addRange(new $(p.modified.startLineNumber - E, p.modified.startLineNumber)))
      let P
      for (P = 0; P < L; P++) {
        const I = p.original.endLineNumberExclusive + P,
          w = p.modified.endLineNumberExclusive + P
        if (
          I > r.length ||
          w > s.length ||
          c.contains(w) ||
      ...
      ;(P > 0 &&
        (h.addRange(
          new $(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + P)
        ),
        c.addRange(
          new $(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + P)
        )),
        (E > 0 || P > 0) &&
          (l[m] = new ae(
            new $(p.original.startLineNumber - E, p.original.endLineNumberExclusive + P),
            new $(p.modified.startLineNumber - E, p.modified.endLineNumberExclusive + P)
          )))
    }
    return l
  }
  ...
  function s1(t) {
    ...
    t.sort(lt((n) => n.original.startLineNumber, ot))
    const e = [t[0]]
    ...
    return (
      (e = e.filter((r) => {
        const s =
          ...
          i = We(t, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive)
        return s !== i
      })),
      e
    )
  ...
  function As(t, e, n) {
    let r = n
    return ((r = Rs(t, e, r)), (r = Rs(t, e, r)), (r = a1(t, e, r)), r)
  }
  function Rs(t, e, n) {
    ...
    for (let i = 1; i < n.length; i++) {
      ...
      if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
        ...
        for (
          ...
          c <= u &&
          !(
            t.getElement(o.seq1Range.start - c) !== t.getElement(o.seq1Range.endExclusive - c) ||
            e.getElement(o.seq2Range.start - c) !== e.getElement(o.seq2Range.endExclusive - c)
          );
          c++
        );
        if ((c--, c === u)) {
          r[r.length - 1] = new O(
            new q(l.seq1Range.start, o.seq1Range.endExclusive - u),
            new q(l.seq2Range.start, o.seq2Range.endExclusive - u)
          )
          continue
        }
        o = o.delta(-c)
    ...
    for (let i = 0; i < r.length - 1; i++) {
      ...
      if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
        ...
        for (
          ...
          c < u &&
          !(
            !t.isStronglyEqual(o.seq1Range.start + c, o.seq1Range.endExclusive + c) ||
            !e.isStronglyEqual(o.seq2Range.start + c, o.seq2Range.endExclusive + c)
          );
          c++
        );
        if (c === u) {
          r[i + 1] = new O(
            new q(o.seq1Range.start + u, l.seq1Range.endExclusive),
            new q(o.seq2Range.start + u, l.seq2Range.endExclusive)
          )
          continue
        }
        c > 0 && (o = o.delta(c))
  ...
  function a1(t, e, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      const s = r > 0 ? n[r - 1] : void 0,
        ...
        o = new q(s ? s.seq1Range.endExclusive + 1 : 0, l ? l.seq1Range.start - 1 : t.length),
        u = new q(s ? s.seq2Range.endExclusive + 1 : 0, l ? l.seq2Range.start - 1 : e.length)
      i.seq1Range.isEmpty
        ? (n[r] = Cs(i, t, e, o, u))
  ...
  function Cs(t, e, n, r, s) {
    ...
    for (let h = -l; h <= o; h++) {
      const f = t.seq2Range.start + h,
        ...
        g = e.getBoundaryScore(p) + n.getBoundaryScore(f) + n.getBoundaryScore(m)
      g > c && ((c = g), (u = h))
    }
    return t.delta(u)
  }
  function l1(t, e, n) {
    ...
    for (const s of n) {
      ...
      s.seq2Range.start - i.seq2Range.endExclusive <= 2
        ? (r[r.length - 1] = new O(i.seq1Range.join(s.seq1Range), i.seq2Range.join(s.seq2Range)))
        : r.push(s)
    }
    return r
  }
  function Es(t, e, n, r, s = !1) {
    ...
    function u(h, f) {
      ...
      let _ = d.seq1Range.length,
        N = d.seq2Range.length
      for (; i.length > 0; ) {
        const v = i[0]
        if (!(v.seq1Range.intersects(g.seq1Range) || v.seq2Range.intersects(g.seq2Range))) break
        const E = r(t, v.seq1Range.start),
          P = r(e, v.seq2Range.start),
          I = new O(E, P),
          w = I.intersect(v)
        if (
          ((_ += w.seq1Range.length),
          (N += w.seq2Range.length),
          (g = g.join(I)),
          g.seq1Range.endExclusive >= v.seq1Range.endExclusive)
        )
          i.shift()
        else break
      }
      ;(((s && _ + N < g.seq1Range.length + g.seq2Range.length) ||
        _ + N < ((g.seq1Range.length + g.seq2Range.length) * 2) / 3) &&
        l.push(g),
        (o = g.getEndExclusives()))
    }
    for (; i.length > 0; ) {
      const h = i.shift()
  ...
  function o1(t, e) {
    ...
    for (; t.length > 0 || e.length > 0; ) {
      const r = t[0],
        s = e[0]
      let i
      ;(r && (!s || r.seq1Range.start < s.seq1Range.start) ? (i = t.shift()) : (i = e.shift()),
        n.length > 0 && n[n.length - 1].seq1Range.endExclusive >= i.seq1Range.start
  ...
  function u1(t, e, n) {
    ...
    do {
      ...
      for (let o = 1; o < r.length; o++) {
        let h = function (m, p) {
          const g = new q(c.seq1Range.endExclusive, u.seq1Range.start)
          return (
            t.getText(g).replace(/\s/g, '').length <= 4 &&
  ...
  function c1(t, e, n) {
    ...
    do {
      ...
      for (let u = 1; u < r.length; u++) {
        let f = function (p, g) {
          const d = new q(h.seq1Range.endExclusive, c.seq1Range.start)
          ...
          const v = t.countLinesIn(p.seq1Range),
            ...
            P = p.seq2Range.length,
            I = t.countLinesIn(g.seq1Range),
            w = g.seq1Range.length,
            x = e.countLinesIn(g.seq2Range),
            A = g.seq2Range.length,
            D = 130
          function V(y) {
            return Math.min(y, D)
          }
          return (
            Math.pow(Math.pow(V(v * 40 + L), 1.5) + Math.pow(V(E * 40 + P), 1.5), 1.5) +
              Math.pow(Math.pow(V(I * 40 + w), 1.5) + Math.pow(V(x * 40 + A), 1.5), 1.5) >
            (D ** 1.5) ** 1.5 * 1.3
          )
        }
        const c = r[u],
    ...
    return (
      Da(r, (o, u, c) => {
        ...
        function f(N) {
          return (
            N.length > 0 && N.trim().length <= 3 && u.seq1Range.length + u.seq2Range.length > 100
          )
        }
        const m = t.extendToFullLines(u.seq1Range),
          p = t.getText(new q(m.start, u.seq1Range.start))
        f(p) && (h = h.deltaStart(-p.length))
        const g = t.getText(new q(u.seq1Range.endExclusive, m.endExclusive))
        f(g) && (h = h.deltaEnd(g.length))
        const d = O.fromOffsetPairs(o ? o.getEndExclusives() : _e.zero, c ? c.getStarts() : _e.max),
          _ = h.intersect(d)
        l.length > 0 && _.getStarts().equals(l[l.length - 1].getEndExclusives())
          ? (l[l.length - 1] = l[l.length - 1].join(_))
          : l.push(_)
      }),
      l
    )
...
`)
  ...
  class h1 {
    constructor() {
      ;((this.dynamicProgrammingDiffing = new Ja()), (this.myersDiffingAlgorithm = new ys()))
    }
    computeDiff(e, n, r) {
      if (e.length <= 1 && Pa(e, n, (w, x) => w === x)) return new Et([], [], !1)
      ...
      const s = r.maxComputationTimeMs === 0 ? ht.instance : new Qa(r.maxComputationTimeMs),
        i = !r.ignoreTrimWhitespace,
        l = new Map()
      function o(w) {
        let x = l.get(w)
        return (x === void 0 && ((x = l.size), l.set(w, x)), x)
      }
      const u = e.map((w) => o(w.trim())),
        ...
        m =
          h.length + f.length < 1700
            ? this.dynamicProgrammingDiffing.compute(h, f, s, (w, x) =>
                e[w] === n[x] ? (n[x].length === 0 ? 0.1 : 1 + Math.log(1 + n[x].length)) : 0.99
              )
            : this.myersDiffingAlgorithm.compute(h, f, s)
      let p = m.diffs,
        g = m.hitTimeout
      ;((p = As(h, f, p)), (p = u1(h, f, p)))
      const d = [],
        _ = (w) => {
          if (i)
            for (let x = 0; x < w; x++) {
              const A = N + x,
                D = v + x
              if (e[A] !== n[D]) {
                const V = this.refineDiff(e, n, new O(new q(A, A + 1), new q(D, D + 1)), s, i, r)
                for (const y of V.mappings) d.push(y)
                V.hitTimeout && (g = !0)
              }
            }
        }
      ...
      for (const w of p) {
        ...
        const x = w.seq1Range.start - N
        ;(_(x), (N = w.seq1Range.endExclusive), (v = w.seq2Range.endExclusive))
      ...
      let I = []
      return (
        r.computeMoves && (I = this.computeMoves(P, e, n, u, c, s, i, r)),
        pt(() => {
          function w(A, D) {
          ...
          for (const A of P) {
            ...
            for (const D of A.innerChanges)
              if (
                ...
                return !1
            if (!x(A.modified, n) || !x(A.original, e)) return !1
          }
          return !0
        }),
        new Et(P, I, g)
    ...
    refineDiff(e, n, r, s, i, l) {
      const u = f1(r).toRangeMapping2(e, n),
      ...
      return (
        (m = As(c, h, m)),
        (m = Es(c, h, m, (g, d) => g.findWordContaining(d))),
        l.extendToSubwords && (m = Es(c, h, m, (g, d) => g.findSubWordContaining(d), !0)),
        (m = l1(c, h, m)),
        (m = c1(c, h, m)),
        {
          mappings: m.map(
            (g) => new le(c.translateRange(g.seq1Range), h.translateRange(g.seq2Range))
          ),
  ...
  const Ps = { getLegacy: () => new Ga(), getDefault: () => new h1() }
  function Ae(t, e) {
  ...
  class oe {
    ...
    static toRGBA(e) {
      ...
      return new b(Math.round(l * 255), Math.round(o * 255), Math.round(u * 255), i)
    }
  }
  class Qe {
    constructor(e, n, r, s) {
        ...
        o === 0
          ...
          : i === n
            ...
            : i === r
              ? (c = (s - n) / o + 2)
              : (c = (n - r) / o + 4),
        new Qe(Math.round(c * 60), u, i, e.a)
      )
    }
    static toRGBA(e) {
  ...
  const z = class z {
    ...
    get hsva() {
      return this._hsva ? this._hsva : Qe.fromRGBA(this.rgba)
    }
    constructor(e) {
      if (e)
        if (e instanceof b) this.rgba = e
        else if (e instanceof oe) ((this._hsla = e), (this.rgba = oe.toRGBA(e)))
        else if (e instanceof Qe) ((this._hsva = e), (this.rgba = Qe.toRGBA(e)))
    ...
    equals(e) {
      return (
        !!e &&
        b.equals(this.rgba, e.rgba) &&
        oe.equals(this.hsla, e.hsla) &&
        Qe.equals(this.hsva, e.hsva)
      )
    }
    ...
    lighten(e) {
      return new z(new oe(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * e, this.hsla.a))
    }
    darken(e) {
      return new z(new oe(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * e, this.hsla.a))
    }
    ...
    opposite() {
      return new z(new b(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a))
    }
    mix(e, n = 0.5) {
  ...
  ;((z.white = new z(new b(255, 255, 255, 1))),
    (z.black = new z(new b(0, 0, 0, 1))),
    (z.red = new z(new b(255, 0, 0, 1))),
    (z.blue = new z(new b(0, 0, 255, 1))),
    (z.green = new z(new b(0, 255, 0, 1))),
    (z.cyan = new z(new b(0, 255, 255, 1))),
    (z.lightgrey = new z(new b(211, 211, 211, 1))),
    (z.transparent = new z(new b(0, 0, 0, 0))))
  let Je = z
  ;(function (t) {
    ;(function (e) {
      ;(function (n) {
        ...
        function f(d) {
          ...
          if (d.startsWith('rgba(')) {
            ...
            if (!w) throw new Error('Invalid color format ' + d)
            const x = parseInt(((_ = w.groups) == null ? void 0 : _.r) ?? '0'),
              A = parseInt(((N = w.groups) == null ? void 0 : N.g) ?? '0'),
              D = parseInt(((v = w.groups) == null ? void 0 : v.b) ?? '0'),
              V = parseFloat(((L = w.groups) == null ? void 0 : L.a) ?? '0')
            return new t(new b(x, A, D, V))
          }
          if (d.startsWith('rgb(')) {
            const w = d.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/)
            if (!w) throw new Error('Invalid color format ' + d)
            const x = parseInt(((E = w.groups) == null ? void 0 : E.r) ?? '0'),
              A = parseInt(((P = w.groups) == null ? void 0 : P.g) ?? '0'),
              D = parseInt(((I = w.groups) == null ? void 0 : I.b) ?? '0')
            return new t(new b(x, A, D))
          }
          return m(d)
        }
        n.parse = f
        function m(d) {
          switch (d) {
            case 'aliceblue':
              return new t(new b(240, 248, 255, 1))
            case 'antiquewhite':
              return new t(new b(250, 235, 215, 1))
            case 'aqua':
              return new t(new b(0, 255, 255, 1))
            case 'aquamarine':
              return new t(new b(127, 255, 212, 1))
            case 'azure':
              return new t(new b(240, 255, 255, 1))
            case 'beige':
              return new t(new b(245, 245, 220, 1))
            case 'bisque':
              return new t(new b(255, 228, 196, 1))
            case 'black':
              return new t(new b(0, 0, 0, 1))
            case 'blanchedalmond':
              return new t(new b(255, 235, 205, 1))
            case 'blue':
              return new t(new b(0, 0, 255, 1))
            case 'blueviolet':
              return new t(new b(138, 43, 226, 1))
            case 'brown':
              return new t(new b(165, 42, 42, 1))
            case 'burlywood':
              return new t(new b(222, 184, 135, 1))
            case 'cadetblue':
              return new t(new b(95, 158, 160, 1))
            case 'chartreuse':
              return new t(new b(127, 255, 0, 1))
            case 'chocolate':
              return new t(new b(210, 105, 30, 1))
            case 'coral':
              return new t(new b(255, 127, 80, 1))
            case 'cornflowerblue':
              return new t(new b(100, 149, 237, 1))
            case 'cornsilk':
              return new t(new b(255, 248, 220, 1))
            case 'crimson':
              return new t(new b(220, 20, 60, 1))
            case 'cyan':
              return new t(new b(0, 255, 255, 1))
            case 'darkblue':
              return new t(new b(0, 0, 139, 1))
            case 'darkcyan':
              return new t(new b(0, 139, 139, 1))
            case 'darkgoldenrod':
              return new t(new b(184, 134, 11, 1))
            case 'darkgray':
              return new t(new b(169, 169, 169, 1))
            case 'darkgreen':
              return new t(new b(0, 100, 0, 1))
            case 'darkgrey':
              return new t(new b(169, 169, 169, 1))
            case 'darkkhaki':
              return new t(new b(189, 183, 107, 1))
            case 'darkmagenta':
              return new t(new b(139, 0, 139, 1))
            case 'darkolivegreen':
              return new t(new b(85, 107, 47, 1))
            case 'darkorange':
              return new t(new b(255, 140, 0, 1))
            case 'darkorchid':
              return new t(new b(153, 50, 204, 1))
            case 'darkred':
              return new t(new b(139, 0, 0, 1))
            case 'darksalmon':
              return new t(new b(233, 150, 122, 1))
            case 'darkseagreen':
              return new t(new b(143, 188, 143, 1))
            case 'darkslateblue':
              return new t(new b(72, 61, 139, 1))
            case 'darkslategray':
              return new t(new b(47, 79, 79, 1))
            case 'darkslategrey':
              return new t(new b(47, 79, 79, 1))
            case 'darkturquoise':
              return new t(new b(0, 206, 209, 1))
            case 'darkviolet':
              return new t(new b(148, 0, 211, 1))
            case 'deeppink':
              return new t(new b(255, 20, 147, 1))
            case 'deepskyblue':
              return new t(new b(0, 191, 255, 1))
            case 'dimgray':
              return new t(new b(105, 105, 105, 1))
            case 'dimgrey':
              return new t(new b(105, 105, 105, 1))
            case 'dodgerblue':
              return new t(new b(30, 144, 255, 1))
            case 'firebrick':
              return new t(new b(178, 34, 34, 1))
            case 'floralwhite':
              return new t(new b(255, 250, 240, 1))
            case 'forestgreen':
              return new t(new b(34, 139, 34, 1))
            case 'fuchsia':
              return new t(new b(255, 0, 255, 1))
            case 'gainsboro':
              return new t(new b(220, 220, 220, 1))
            case 'ghostwhite':
              return new t(new b(248, 248, 255, 1))
            case 'gold':
              return new t(new b(255, 215, 0, 1))
            case 'goldenrod':
              return new t(new b(218, 165, 32, 1))
            case 'gray':
              return new t(new b(128, 128, 128, 1))
            case 'green':
              return new t(new b(0, 128, 0, 1))
            case 'greenyellow':
              return new t(new b(173, 255, 47, 1))
            case 'grey':
              return new t(new b(128, 128, 128, 1))
            case 'honeydew':
              return new t(new b(240, 255, 240, 1))
            case 'hotpink':
              return new t(new b(255, 105, 180, 1))
            case 'indianred':
              return new t(new b(205, 92, 92, 1))
            case 'indigo':
              return new t(new b(75, 0, 130, 1))
            case 'ivory':
              return new t(new b(255, 255, 240, 1))
            case 'khaki':
              return new t(new b(240, 230, 140, 1))
            case 'lavender':
              return new t(new b(230, 230, 250, 1))
            case 'lavenderblush':
              return new t(new b(255, 240, 245, 1))
            case 'lawngreen':
              return new t(new b(124, 252, 0, 1))
            case 'lemonchiffon':
              return new t(new b(255, 250, 205, 1))
            case 'lightblue':
              return new t(new b(173, 216, 230, 1))
            case 'lightcoral':
              return new t(new b(240, 128, 128, 1))
            case 'lightcyan':
              return new t(new b(224, 255, 255, 1))
            case 'lightgoldenrodyellow':
              return new t(new b(250, 250, 210, 1))
            case 'lightgray':
              return new t(new b(211, 211, 211, 1))
            case 'lightgreen':
              return new t(new b(144, 238, 144, 1))
            case 'lightgrey':
              return new t(new b(211, 211, 211, 1))
            case 'lightpink':
              return new t(new b(255, 182, 193, 1))
            case 'lightsalmon':
              return new t(new b(255, 160, 122, 1))
            case 'lightseagreen':
              return new t(new b(32, 178, 170, 1))
            case 'lightskyblue':
              return new t(new b(135, 206, 250, 1))
            case 'lightslategray':
              return new t(new b(119, 136, 153, 1))
            case 'lightslategrey':
              return new t(new b(119, 136, 153, 1))
            case 'lightsteelblue':
              return new t(new b(176, 196, 222, 1))
            case 'lightyellow':
              return new t(new b(255, 255, 224, 1))
            case 'lime':
              return new t(new b(0, 255, 0, 1))
            case 'limegreen':
              return new t(new b(50, 205, 50, 1))
            case 'linen':
              return new t(new b(250, 240, 230, 1))
            case 'magenta':
              return new t(new b(255, 0, 255, 1))
            case 'maroon':
              return new t(new b(128, 0, 0, 1))
            case 'mediumaquamarine':
              return new t(new b(102, 205, 170, 1))
            case 'mediumblue':
              return new t(new b(0, 0, 205, 1))
            case 'mediumorchid':
              return new t(new b(186, 85, 211, 1))
            case 'mediumpurple':
              return new t(new b(147, 112, 219, 1))
            case 'mediumseagreen':
              return new t(new b(60, 179, 113, 1))
            case 'mediumslateblue':
              return new t(new b(123, 104, 238, 1))
            case 'mediumspringgreen':
              return new t(new b(0, 250, 154, 1))
            case 'mediumturquoise':
              return new t(new b(72, 209, 204, 1))
            case 'mediumvioletred':
              return new t(new b(199, 21, 133, 1))
            case 'midnightblue':
              return new t(new b(25, 25, 112, 1))
            case 'mintcream':
              return new t(new b(245, 255, 250, 1))
            case 'mistyrose':
              return new t(new b(255, 228, 225, 1))
            case 'moccasin':
              return new t(new b(255, 228, 181, 1))
            case 'navajowhite':
              return new t(new b(255, 222, 173, 1))
            case 'navy':
              return new t(new b(0, 0, 128, 1))
            case 'oldlace':
              return new t(new b(253, 245, 230, 1))
            case 'olive':
              return new t(new b(128, 128, 0, 1))
            case 'olivedrab':
              return new t(new b(107, 142, 35, 1))
            case 'orange':
              return new t(new b(255, 165, 0, 1))
            case 'orangered':
              return new t(new b(255, 69, 0, 1))
            case 'orchid':
              return new t(new b(218, 112, 214, 1))
            case 'palegoldenrod':
              return new t(new b(238, 232, 170, 1))
            case 'palegreen':
              return new t(new b(152, 251, 152, 1))
            case 'paleturquoise':
              return new t(new b(175, 238, 238, 1))
            case 'palevioletred':
              return new t(new b(219, 112, 147, 1))
            case 'papayawhip':
              return new t(new b(255, 239, 213, 1))
            case 'peachpuff':
              return new t(new b(255, 218, 185, 1))
            case 'peru':
              return new t(new b(205, 133, 63, 1))
            case 'pink':
              return new t(new b(255, 192, 203, 1))
            case 'plum':
              return new t(new b(221, 160, 221, 1))
            case 'powderblue':
              return new t(new b(176, 224, 230, 1))
            case 'purple':
              return new t(new b(128, 0, 128, 1))
            case 'rebeccapurple':
              return new t(new b(102, 51, 153, 1))
            case 'red':
              return new t(new b(255, 0, 0, 1))
            case 'rosybrown':
              return new t(new b(188, 143, 143, 1))
            case 'royalblue':
              return new t(new b(65, 105, 225, 1))
            case 'saddlebrown':
              return new t(new b(139, 69, 19, 1))
            case 'salmon':
              return new t(new b(250, 128, 114, 1))
            case 'sandybrown':
              return new t(new b(244, 164, 96, 1))
            case 'seagreen':
              return new t(new b(46, 139, 87, 1))
            case 'seashell':
              return new t(new b(255, 245, 238, 1))
            case 'sienna':
              return new t(new b(160, 82, 45, 1))
            case 'silver':
              return new t(new b(192, 192, 192, 1))
            case 'skyblue':
              return new t(new b(135, 206, 235, 1))
            case 'slateblue':
              return new t(new b(106, 90, 205, 1))
            case 'slategray':
              return new t(new b(112, 128, 144, 1))
            case 'slategrey':
              return new t(new b(112, 128, 144, 1))
            case 'snow':
              return new t(new b(255, 250, 250, 1))
            case 'springgreen':
              return new t(new b(0, 255, 127, 1))
            case 'steelblue':
              return new t(new b(70, 130, 180, 1))
            case 'tan':
              return new t(new b(210, 180, 140, 1))
            case 'teal':
              return new t(new b(0, 128, 128, 1))
            case 'thistle':
              return new t(new b(216, 191, 216, 1))
            case 'tomato':
              return new t(new b(255, 99, 71, 1))
            case 'turquoise':
              return new t(new b(64, 224, 208, 1))
            case 'violet':
              return new t(new b(238, 130, 238, 1))
            case 'wheat':
              return new t(new b(245, 222, 179, 1))
            case 'white':
              return new t(new b(255, 255, 255, 1))
            case 'whitesmoke':
              return new t(new b(245, 245, 245, 1))
            case 'yellow':
              return new t(new b(255, 255, 0, 1))
            case 'yellowgreen':
              return new t(new b(154, 205, 50, 1))
            default:
              return null
          }
        }
        function p(d) {
          const _ = d.length
          if (_ === 0 || d.charCodeAt(0) !== 35) return null
          if (_ === 7) {
            const N = 16 * g(d.charCodeAt(1)) + g(d.charCodeAt(2)),
              v = 16 * g(d.charCodeAt(3)) + g(d.charCodeAt(4)),
              L = 16 * g(d.charCodeAt(5)) + g(d.charCodeAt(6))
            return new t(new b(N, v, L, 1))
          }
          if (_ === 9) {
            const N = 16 * g(d.charCodeAt(1)) + g(d.charCodeAt(2)),
              v = 16 * g(d.charCodeAt(3)) + g(d.charCodeAt(4)),
              L = 16 * g(d.charCodeAt(5)) + g(d.charCodeAt(6)),
              E = 16 * g(d.charCodeAt(7)) + g(d.charCodeAt(8))
            return new t(new b(N, v, L, E / 255))
          }
          if (_ === 4) {
            const N = g(d.charCodeAt(1)),
              v = g(d.charCodeAt(2)),
              L = g(d.charCodeAt(3))
            return new t(new b(16 * N + N, 16 * v + v, 16 * L + L))
          }
          if (_ === 5) {
            const N = g(d.charCodeAt(1)),
              v = g(d.charCodeAt(2)),
              L = g(d.charCodeAt(3)),
              E = g(d.charCodeAt(4))
            return new t(new b(16 * N + N, 16 * v + v, 16 * L + L, (16 * E + E) / 255))
          }
          return null
        }
        n.parseHex = p
  ...
  function m1(t, e) {
    if (!t) return
    const n = Je.Format.CSS.parseHex(e)
    if (n) return { range: t, color: Nn(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function Ts(t, e, n) {
  ...
  function Ds(t, e, n) {
    ...
    const s = e[0].values(),
      i = Fs(s),
      l = new Je(new oe(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1))
    ...
    for (let s = 1; s <= r; s++) {
      ...
      if (l) {
        ...
        if (o.endColumn > o.startColumn) {
          const u = { range: o, ..._1(i.substring(l[0].length)), shouldBeInComments: !1 }
  ...
  function y1(t, e) {
    ...
    const s = _a(e.markSectionHeaderRegex),
      i = new RegExp(e.markSectionHeaderRegex, `gdm${s ? 's' : ''}`)
    if (bi(i)) return n
    for (let l = 1; l <= r; l += Vs - p1) {
...
`) + 1,
          ...
          P = { startLineNumber: p, startColumn: v, endLineNumber: _, endColumn: E },
          I = (h.groups ?? {}).label ?? '',
          w = ((h.groups ?? {}).separator ?? '') !== '',
          x = { range: P, text: I, hasSeparatorLine: w, shouldBeInComments: !0 }
        ;((x.text || x.hasSeparatorLine) &&
          (n.length === 0 || n[n.length - 1].range.endLineNumber < x.range.startLineNumber) &&
          n.push(x),
  ...
  function _1(t) {
    ...
    return ((t = t.replace(b1, '')), { text: t, hasSeparatorLine: e })
  }
  class L1 {
    get isRejected() {
      var e
  ...
  class v1 {
    ...
    _ensureNoFinalValue() {
      if (this._finalValue)
        throw new Z('ProducerConsumer: cannot produce after final value has been set')
    }
  ...
  class N1 {
    ...
    getPrefixSum(e) {
      return e < 0 ? 0 : ((e = Ue(e)), this._getPrefixSum(e))
    }
    _getPrefixSum(e) {
    ...
    getIndexOf(e) {
      ...
      let n = 0,
        ...
        l = 0
      for (; n <= r; )
        if (((s = (n + (r - n) / 2) | 0), (i = this.prefixSum[s]), (l = i - this.values[s]), e < l))
          r = s - 1
        else if (e >= i) n = s + 1
        else break
      return new S1(s, e - l)
    ...
    onEvents(e) {
      ...
      for (const r of n)
        (this._acceptDeleteRange(r.range),
          this._acceptInsertText(new H(r.range.startLineNumber, r.range.startColumn), r.text))
    ...
    findMatches(e) {
      ...
      for (let r = 0; r < this._lines.length; r++) {
        const s = this._lines[r],
          ...
          l = s.matchAll(e)
        for (const o of l) ((o.index || o.index === 0) && (o.index = o.index + i), n.push(o))
      }
      return n
    }
    getLinesContent() {
        ...
        *[Symbol.iterator]() {
          for (;;)
            if (l < o.length) {
              ...
              ;((l += 1), yield u)
            } else if (s < n.length) ((i = n[s]), (o = r(i, e)), (l = 0), (s += 1))
            else break
        }
      }
    }
  ...
  const Fe = class Fe {
    constructor(e = null) {
      ;((this._foreignModule = e),
        ...
        (this._workerTextModelSyncServer = new R1()))
    }
    dispose() {}
    async $ping() {
      return 'pong'
    ...
    async $computeUnicodeHighlights(e, n, r) {
      ...
      return s
        ? Ea.computeUnicodeHighlights(s, n, r)
        : {
            ranges: [],
            hasMore: !1,
    ...
    async $computeMoreMinimalEdits(e, n, r) {
      ...
      n = n.slice(0).sort((u, c) => {
        if (u.range && c.range) return C.compareRangesUsingStarts(u.range, c.range)
        const h = u.range ? 0 : 1,
          f = c.range ? 0 : 1
        return h - f
      })
      ...
      for (let { range: u, text: c, eol: h } of n) {
        ...
        for (const g of m) {
          const d = s.positionAt(p + g.originalStart),
            _ = s.positionAt(p + g.originalStart + g.originalLength),
            N = {
      ...
      e: for (const u of e) {
        ...
        if (c) {
          for (const h of c.words(l))
            if (!(h === n || !isNaN(Number(h))) && (o.add(h), o.size > Fe._suggestionsLimit))
              break e
        }
      }
    ...
    async $navigateValueSet(e, n, r, s, i) {
      ...
      const u = l.getValueInRange(n),
        c = l.getWordAtPosition({ lineNumber: n.startLineNumber, column: n.startColumn }, o)
      if (!c) return null
  ...
  let Sn = Fe
  typeof importScripts == 'function' && (globalThis.monaco = ba())
  const gt = class gt {
    static getChannel(e) {
      return e.getChannel(gt.CHANNEL_NAME)
    }
    static setChannel(e, n) {
      e.setChannel(gt.CHANNEL_NAME, n)
    }
  }
  gt.CHANNEL_NAME = 'editorWorkerHost'
  let An = gt
  function E1(t) {
    let e
    const n = Ti((r) => {
