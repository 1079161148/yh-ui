  ...
  yh: {
    ...
    ai: {
      ...
      codeRunner: {
        ...
        clear: 'Limpiar',
        reset: 'Reiniciar',
        placeholder: 'Haz clic en Ejecutar para ejecutar el código...'
      },
      sender: {
      ...
      welcome: {
        ...
        description:
          'Puedo ayudarte con programación, traducción de documentos o escritura creativa. ¿Qué puedo hacer por ti hoy?'
      },
      action: {
        copy: 'Copiar',
