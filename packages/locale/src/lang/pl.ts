...
export const pl: Language = {
  ...
  yh: {
    ...
    couponcard: {
      ...
      expired: 'Wygasło',
      received: 'Otrzymano',
      limit: 'Zamówienia powyżej {threshold}',
    ...
    smartaddress: {
      ...
      province: 'Województwo/Miasto/Dzielnica',
      city: 'Miasto',
      district: 'Dzielnica/Powiat',
      street: 'Ulica/Miejscowość',
      detail: 'Szczegółowy adres',
      phone: 'Telefon',
      name: 'Odbiorca',
      ...
      provinceKeywords: ['Województwo', 'Region'],
    ...
    ai: {
      ...
      welcome: {
        ...
        description:
          'Mogę pomóc Ci w programowaniu, tłumaczeniu dokumentów lub pisaniu kreatywnym. Co mogę dla Ciebie zrobić?'
      },
      action: {
        copy: 'Kopiuj',
      ...
      sources: {
        ...
        referencedSources: 'Źródła Referencyjne',
        relevant: 'Trafność',
