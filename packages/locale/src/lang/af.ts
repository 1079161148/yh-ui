...
export const af: Language = {
  ...
  yh: {
    ...
    ai: {
      ...
      attachments: {
        dropTip: 'Laat lê lêers hier om op te laai',
        clickToUpload: 'Klik of sleep lêers om op te laai',
        uploadSuccess: 'Oplaai suksesvol',
        uploadError: 'Oplaai het misluk',
        deleteConfirm: 'Is jy seker jy wil hierdie lêer skrap?',
        fileTooLarge: 'Lêergrootte mag nie {size} oorskry nie',
        invalidFileType: 'Ongeldige lêertipe'
      },
      mermaid: {
        image: 'Beeld',
        code: 'Kode',
