...
const contrastInfo = computed(() => {
  ...
  return {
    isDark: l < 0.5,
    suggestion: l < 0.5 ? '白色文字最佳' : '黑色文字最佳'
  }
})
      ...
      <Transition name="yh-fade">
        <div v-if="visible" ref="popperRef" :class="[ns.e('panel'), popperClass]" :style="popperStyle" @click.stop>
          <div :class="ns.e('main')">
            ...
            <div :class="ns.e('contrast-advisor')" :title="`建议: ${contrastInfo.suggestion}`">
          ...
          <div :class="ns.e('footer')">
            <div :class="ns.e('tools')">
              <div v-if="isEyeDropperSupported" :class="ns.e('eye-dropper')" @click="handleEyeDropper" title="吸色器">
            ...
            <div :class="ns.e('btns')">
              <button :class="ns.e('btn-clear')" @click="handleClear">清空</button>
              <button :class="ns.e('btn-confirm')" @click="handleConfirm">确定</button>
            </div>
          </div>
        </div>
      </Transition>
